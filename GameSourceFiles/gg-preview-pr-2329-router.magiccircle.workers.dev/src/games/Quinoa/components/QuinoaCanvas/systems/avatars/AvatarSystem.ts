...
export class AvatarSystem implements QuinoaSystem, AvatarDataProvider {
   ...
   * @param petDataProvider - Provider for pet data to check for obscuring pets
   * @param batchRenderer - The Rive batch renderer for avatar sprites
   * @param cameraContainer - Camera container for position transforms
   */
  constructor(
