...
import { FutureGardenObjectIcon } from '@/Quinoa/utils/FutureGardenObjectIcon';
...
export function waterPlant() {
  ...
  const icon = (
    <FutureGardenObjectIcon
      tileObject={currentGardenObject}
      millisecondsInTheFuture={waterPlantSecondsReduction * 1000}
    />
  );
  sendQuinoaToast({
    variant: 'success',
