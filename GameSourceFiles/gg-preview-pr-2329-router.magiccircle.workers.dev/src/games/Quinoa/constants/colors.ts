...
export const getAbilityColor = (abilityId: FaunaAbilityId | FloraAbilityId) => {
  switch (abilityId) {
    ...
    case 'RainDance':
      // Using darkened Wet color (95*0.8, 255*0.8, 255*0.8)
      return {
        bg: 'rgba(76, 204, 204, 0.9)',
        hover: 'rgba(76, 204, 204, 1)',
      };
    case 'SnowGranter':
      // Using darkened Chilled color (180*0.8, 230*0.8, 255*0.8)
      return {
        bg: 'rgba(144, 184, 204, 0.9)',
        hover: 'rgba(144, 184, 204, 1)',
      };
    case 'FrostGranter':
      // Using darkened Frozen color (185*0.8, 200*0.8, 255*0.8)
      return {
        bg: 'rgba(148, 160, 204, 0.9)',
        hover: 'rgba(148, 160, 204, 1)',
      };
    case 'SeedFinderI':
    case 'SeedFinderII':
    case 'SeedFinderIII':
