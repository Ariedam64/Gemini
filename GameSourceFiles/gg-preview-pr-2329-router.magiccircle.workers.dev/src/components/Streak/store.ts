...
/**
 * Tracks whether the initial streak animation has been shown.
 * This persists across rerenders to prevent the animation from playing
 * multiple times during the same session.
 */
export const hasShownInitialAnimationAtom = atom(false);
