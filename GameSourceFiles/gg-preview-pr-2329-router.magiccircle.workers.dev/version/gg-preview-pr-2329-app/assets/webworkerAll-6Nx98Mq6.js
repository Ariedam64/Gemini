import{aq as p,am as Le,al as Q,b7 as We,b9 as de,ba as he,ce as Ye,aQ as C,aO as R,aJ as fe,bd as v,aW as P,bx as pe,aY as X,as as L,K as me,aF as q,aC as A,U as k,cf as He,cg as j,bg as W,ch as G,aI as J,aH as D,aV as N,bq as Ke,bp as Y,ci as Xe,aR as ge,aU as xe,bz as _e,bC as be,cj as ye,aS as qe,aT as je,bA as Ne,bB as $e,bD as Qe,ck as Je,cl as Ze,cm as et,cn as H,S as tt,co as rt,aP as Te,bu as Z,cp as ee,cq as E,at as m,cr as nt}from"./main-gdTUkVO1.js";import{c as I,a as st,b as at,B as ve}from"./colorToUniform-BXaCBwVl.js";import"./index-BmYt7i_E.js";class Ce{static init(e){Object.defineProperty(this,"resizeTo",{configurable:!0,set(t){globalThis.removeEventListener("resize",this.queueResize),this._resizeTo=t,t&&(globalThis.addEventListener("resize",this.queueResize),this.resize())},get(){return this._resizeTo}}),this.queueResize=()=>{this._resizeTo&&(this._cancelResize(),this._resizeId=requestAnimationFrame(()=>this.resize()))},this._cancelResize=()=>{this._resizeId&&(cancelAnimationFrame(this._resizeId),this._resizeId=null)},this.resize=()=>{if(!this._resizeTo)return;this._cancelResize();let t,r;if(this._resizeTo===globalThis.window)t=globalThis.innerWidth,r=globalThis.innerHeight;else{const{clientWidth:n,clientHeight:s}=this._resizeTo;t=n,r=s}this.renderer.resize(t,r),this.render()},this._resizeId=null,this._resizeTo=null,this.resizeTo=e.resizeTo||null}static destroy(){globalThis.removeEventListener("resize",this.queueResize),this._cancelResize(),this._cancelResize=null,this.queueResize=null,this.resizeTo=null,this.resize=null}}Ce.extension=p.Application;class Pe{static init(e){e=Object.assign({autoStart:!0,sharedTicker:!1},e),Object.defineProperty(this,"ticker",{configurable:!0,set(t){this._ticker&&this._ticker.remove(this.render,this),this._ticker=t,t&&t.add(this.render,this,Le.LOW)},get(){return this._ticker}}),this.stop=()=>{this._ticker.stop()},this.start=()=>{this._ticker.start()},this._ticker=null,this.ticker=e.sharedTicker?Q.shared:new Q,e.autoStart&&this.start()}static destroy(){if(this._ticker){const e=this._ticker;this.ticker=null,e.destroy()}}}Pe.extension=p.Application;var it=`in vec2 vTextureCoord;
out vec4 finalColor;
...
//# sourceMappingURL=webworkerAll-6Nx98Mq6.js.map
