...
import type { FaunaAbilityId } from '../fauna/faunaAbilitiesDex';
import type { StatBlueprint } from './stats-blueprint';
...
export const petAbilitiesStatsDex = {
  ...
  SnowyCoinFinder: {
    ...
    description: 'Number of times Snowy Coin Finder triggered',
  },
  HungerRestore: {
  ...
  HungerRestoreIII: {
    ...
    description: 'Number of times Hunger Restore III triggered',
  },
  SnowyHungerRestore: {
    name: 'Snowy Hunger Restore',
    description: 'Number of times Snowy Hunger Restore triggered',
  },
  DoubleHarvest: {
    name: 'Double Harvest',
  ...
  PetXpBoostIII: {
    name: 'XP Boost III',
    description: 'Number of times XP Boost III triggered',
  },
  SnowyPetXpBoost: {
    name: 'Snowy Pet XP Boost',
    description: 'Number of times Snowy Pet XP Boost triggered',
  },
  ...
  HungerBoostIII: {
    ...
    description: 'Number of times Hunger Boost III triggered',
    isHidden: true,
  },
  SnowyHungerBoost: {
    name: 'Snowy Hunger Boost',
    description: 'Number of times Snowy Hunger Boost triggered',
    isHidden: true,
  },
  PetRefund: {
    name: 'Pet Refund I',
  ...
  PetAgeBoostIII: {
    ...
    description: 'Number of times Hatch XP Boost III triggered',
  },
  EggGrowthBoost: {
  ...
  SnowyEggGrowthBoost: {
    ...
    description: 'Number of times Snowy Egg Growth Boost triggered',
  },
  PetHatchSizeBoost: {
  ...
  PetHatchSizeBoostIII: {
    ...
    description: 'Number of times Max Strength Boost III triggered',
  },
  Copycat: {
    name: 'Copycat',
  ...
  ProduceScaleBoostIII: {
    ...
    description: 'Number of times Crop Size Boost III triggered',
  },
  SnowyCropSizeBoost: {
    name: 'Snowy Crop Size Boost',
    description: 'Number of times Snowy Crop Size Boost triggered',
  },
  PlantGrowthBoost: {
  ...
  PlantGrowthBoostIII: {
    ...
    description: 'Number of times Plant Growth Boost III triggered',
  },
  SnowyPlantGrowthBoost: {
    name: 'Snowy Plant Growth Boost',
    description: 'Number of times Snowy Plant Growth Boost triggered',
  },
  GoldGranter: {
    name: 'Gold Granter',
