...
export const floraSpeciesDex = {
  ...
  Poinsettia: {
    ...
    plant: {
      tileRef: PlantsTile.Shrub,
      name: 'Poinsettia Bush',
      harvestType: HarvestType.Multiple,
      slotOffsets: [
        { x: 0.05, y: -0.4, rotation: 0 },
        { x: -0.3, y: -0.15, rotation: 0 },
        { x: 0.3, y: -0.1, rotation: 0 },
        { x: -0.02, y: 0.17, rotation: 0 },
      ],
      secondsToMature: 3 * 60 * 60, // 3 hours
      baseTileScale: 1,
      rotateSlotOffsetsRandomly: true,
    },
    crop: {
      tileRef: PlantsTile.Poinsettia,
      name: 'Poinsettia',
