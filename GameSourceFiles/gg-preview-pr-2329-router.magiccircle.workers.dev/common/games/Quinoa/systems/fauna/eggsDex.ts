...
import { winterDecorExpiryDate } from '../expiryDates';
...
export const EggsDex = {
  ...
  WinterEgg: {
    ...
    expiryDate: winterDecorExpiryDate,
  },
  LegendaryEgg: {
  ...
  MythicalEgg: {
    ...
    faunaSpawnWeights: { Butterfly: 75, Peacock: 20, Capybara: 5 },
  },
