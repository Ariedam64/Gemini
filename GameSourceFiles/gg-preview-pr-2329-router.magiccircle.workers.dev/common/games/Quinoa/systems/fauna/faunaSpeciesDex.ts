...
export const faunaSpeciesDex = {
  ...
  SnowFox: {
    tileRef: PetTiles.SnowFox,
    name: 'Snow Fox',
    coinsToFullyReplenishHunger: 14_000,
    innateAbilityWeights: {
      SnowGranter: 30,
      SnowyCoinFinder: 30,
      SnowyPetXpBoost: 30,
  ...
  Stoat: {
    tileRef: PetTiles.Stoat,
    name: 'Stoat',
    coinsToFullyReplenishHunger: 10_000,
    innateAbilityWeights: {
      SnowGranter: 40,
      SnowyHungerBoost: 40,
  ...
  WhiteCaribou: {
    tileRef: PetTiles.WhiteCaribou,
    name: 'Caribou',
    coinsToFullyReplenishHunger: 30_000,
    innateAbilityWeights: {
      FrostGranter: 50,
    ...
    maxScale: 2.5,
    maturitySellPrice: 15_000_000,
    matureWeight: 300,
    moveProbability: 0.2,
    moveTweenDurationMs: 1000,
    hoursToMature: 100,
    rarity: Rarity.Legendary,
