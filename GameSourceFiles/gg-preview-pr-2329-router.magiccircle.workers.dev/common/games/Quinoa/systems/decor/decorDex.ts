...
import {
  halloweenDecorExpiryDate,
  winterDecorExpiryDate,
} from '../expiryDates';
...
export const decorDex = {
  ...
  StringLights: {
    tileRef: DecorTile.StringLights,
    rotationVariants: {
      90: {
        tileRef: DecorTile.StringLightsSideways,
        flipH: true,
      },
      180: {
        tileRef: DecorTile.StringLights,
  ...
  ColoredStringLights: {
    tileRef: DecorTile.ColoredStringLights,
    rotationVariants: {
      90: {
        tileRef: DecorTile.ColoredStringLightsSideways,
        flipH: true,
      },
      180: {
        tileRef: DecorTile.ColoredStringLights,
  ...
  StoneCaribou: {
    tileRef: DecorTile.StoneCaribou,
    name: 'Stone Caribou',
    coinPrice: 750_000,
    creditPrice: 72,
    rarity: Rarity.Uncommon,
  ...
  MarbleCaribou: {
    tileRef: DecorTile.MarbleCaribou,
    name: 'Marble Caribou',
    coinPrice: 50_000_000,
    creditPrice: 299,
    rarity: Rarity.Rare,
