...
export type PetAbilityToastData = {
  ...
  SnowyCoinFinder: { coinsFound: number };
  ...
  HungerRestoreIII: { petName: string; hungerRestoreAmount: number };
  SnowyHungerRestore: { petName: string; hungerRestoreAmount: number };
  ...
  PetHatchSizeBoostIII: { petName: string; strengthIncrease: number };
  PetAgeBoost: { petName: string; bonusXp: number };
  PetAgeBoostII: { petName: string; bonusXp: number };
  PetAgeBoostIII: { petName: string; bonusXp: number };
  ...
  SnowGranter: { growSlot: GrowSlot };
  FrostGranter: { growSlot: GrowSlot };
  PetXpBoost: { bonusXp: number };
  PetXpBoostII: { bonusXp: number };
  PetXpBoostIII: { bonusXp: number };
  SnowyPetXpBoost: { bonusXp: number };
  EggGrowthBoost: { minutesReduced: number };
  EggGrowthBoostII_NEW: { minutesReduced: number };
  EggGrowthBoostII: { minutesReduced: number };
  SnowyEggGrowthBoost: { minutesReduced: number };
  PlantGrowthBoost: { minutesReduced: number };
  PlantGrowthBoostII: { minutesReduced: number };
  PlantGrowthBoostIII: { minutesReduced: number };
  SnowyPlantGrowthBoost: { minutesReduced: number };
  ProduceScaleBoost: { scaleIncreasePercentage: number };
  ProduceScaleBoostII: { scaleIncreasePercentage: number };
  ProduceScaleBoostIII: { scaleIncreasePercentage: number };
  SnowyCropSizeBoost: { scaleIncreasePercentage: number };
  ProduceMutationBoost: Record<string, never>;
  ProduceMutationBoostII: Record<string, never>;
  ProduceMutationBoostIII: Record<string, never>;
  SnowyCropMutationBoost: Record<string, never>;
  PetMutationBoost: Record<string, never>;
  PetMutationBoostII: Record<string, never>;
  PetMutationBoostIII: Record<string, never>;
  Copycat: Record<string, never>;
  HungerBoost: Record<string, never>;
  HungerBoostII: Record<string, never>;
  HungerBoostIII: Record<string, never>;
  SnowyHungerBoost: Record<string, never>;
};
