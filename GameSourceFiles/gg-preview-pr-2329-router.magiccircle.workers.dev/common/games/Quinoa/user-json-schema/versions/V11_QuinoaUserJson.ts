...
const ActivityLogSchema = v.variant('action', [
  ...
  v.object({
    action: v.union([
      v.literal('HungerRestore'),
      v.literal('HungerRestoreII'),
      v.literal('HungerRestoreIII'),
      v.literal('SnowyHungerRestore'),
    ]),
    timestamp: UnixTimestampSchema,
    parameters: v.object({
      pet: PetSlotSchema,
  ...
  v.object({
    action: v.union([
      v.literal('PetXpBoost'),
      v.literal('PetXpBoostII'),
      v.literal('PetXpBoostIII'),
      v.literal('SnowyPetXpBoost'),
    ]),
    timestamp: UnixTimestampSchema,
    parameters: v.object({
      pet: PetSlotSchema,
  ...
  v.object({
    action: v.union([
      v.literal('PetAgeBoost'),
      v.literal('PetAgeBoostII'),
      v.literal('PetAgeBoostIII'),
    ]),
    timestamp: UnixTimestampSchema,
    parameters: v.object({
      pet: PetSlotSchema,
  ...
  v.object({
    action: v.union([
      ...
      v.literal('PetHatchSizeBoostIII'),
    ]),
    timestamp: UnixTimestampSchema,
    parameters: v.object({
      pet: PetSlotSchema,
  ...
  v.object({
    action: v.union([
      ...
      v.literal('ProduceScaleBoostIII'),
      v.literal('SnowyCropSizeBoost'),
    ]),
    timestamp: UnixTimestampSchema,
    parameters: v.object({
      pet: PetSlotSchema,
  ...
  v.object({
    action: v.union([
      ...
      v.literal('PlantGrowthBoostIII'),
      v.literal('SnowyPlantGrowthBoost'),
    ]),
    timestamp: UnixTimestampSchema,
    parameters: v.object({
      pet: PetSlotSchema,
  ...
  // Gold/Rainbow Granter/RainDance/SnowGranter/FrostGranter
  v.object({
    action: v.union([
      v.literal('GoldGranter'),
      v.literal('RainbowGranter'),
      v.literal('RainDance'),
      v.literal('SnowGranter'),
      v.literal('FrostGranter'),
    ]),
    timestamp: UnixTimestampSchema,
    parameters: v.object({
      pet: PetSlotSchema,
...
type EggInventoryItem = v.InferOutput<typeof EggInventoryItemSchema>;
...
export {
  ...
  type EggInventoryItem as V11_EggInventoryItem,
