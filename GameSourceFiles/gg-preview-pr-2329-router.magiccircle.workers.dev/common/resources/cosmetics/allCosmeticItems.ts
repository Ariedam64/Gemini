...
export const allCosmeticItems = [
  ...
  {
    id: 'Top_CozyAntlers.png',
    filename: 'Top_CozyAntlers.png',
    type: 'Top',
    availability: 'purchasable',
    displayName: 'Cozy Antlers',
    price: PurchaseablePriceTier.A,
  },
  {
    id: 'Top_PomPomBeanie.png',
    filename: 'Top_PomPomBeanie.png',
    type: 'Top',
    availability: 'purchasable',
    displayName: 'Pom Pom Beanie',
    price: PurchaseablePriceTier.B,
  },
  {
    id: 'Top_SnowBeanie.png',
    filename: 'Top_SnowBeanie.png',
    type: 'Top',
    availability: 'purchasable',
