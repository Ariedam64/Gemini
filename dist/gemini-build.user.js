...
`,Z_={size:"md",closeOnBackdrop:true,closeOnEscape:true};function hu(e){const t={...Z_,...e};let n=false,r=null,o=null,i=null,a=null,l=null;function u(){v(),t.onClose?.();}function f($){t.closeOnBackdrop&&$.target===o&&u();}function p($){t.closeOnEscape&&$.key==="Escape"&&u();}function m(){if(!i)return;const $=["a[href]","button:not([disabled])","textarea:not([disabled])","input:not([disabled])","select:not([disabled])",'[tabindex]:not([tabindex="-1"])'].join(","),M=Array.from(i.querySelectorAll($));if(M.length===0)return;const R=M[0],L=M[M.length-1];R.focus();const k=_=>{_.key==="Tab"&&(_.shiftKey?document.activeElement===R&&(_.preventDefault(),L.focus()):document.activeElement===L&&(_.preventDefault(),R.focus()));};i.addEventListener("keydown",k),a=()=>{i?.removeEventListener("keydown",k);};}function b(){r=w("div",{className:"modal-container"}),r.setAttribute("role","dialog"),r.setAttribute("aria-modal","true"),r.setAttribute("aria-labelledby","modal-title");const $=w("style");$.textContent=J_,r.appendChild($),o=w("div",{className:"modal-backdrop"}),o.addEventListener("click",f),r.appendChild(o),i=w("div",{className:`modal-dialog modal-dialog--${t.size}`});const M=w("div",{className:"modal-header"}),R=w("h2",{className:"modal-title",id:"modal-title"},t.title);if(t.subtitle){const _=w("div",{className:"modal-title-group"});_.appendChild(R),_.appendChild(w("p",{className:"modal-subtitle"},t.subtitle)),M.appendChild(_);}else M.appendChild(R);const L=w("button",{className:"modal-close",type:"button","aria-label":"Close modal"},"×");L.addEventListener("click",u),M.appendChild(L),i.appendChild(M);const k=w("div",{className:"modal-body"});if(k.appendChild(t.content),i.appendChild(k),t.footer){const _=w("div",{className:"modal-footer"});_.appendChild(t.footer),i.appendChild(_);}return o.appendChild(i),r}function y(){if(!r)return;const $=r.getBoundingClientRect(),M=window.innerWidth,R=window.innerHeight;Math.abs($.left)>1||Math.abs($.top)>1||Math.abs($.width-M)>1||Math.abs($.height-R)>1?(r.style.left=`${-$.left}px`,r.style.top=`${-$.top}px`,r.style.width=`${M}px`,r.style.height=`${R}px`):(r.style.left="0px",r.style.top="0px",r.style.width="100%",r.style.height="100%");}function v(){!n||!r||(r.classList.remove("is-open"),n=false,a&&(a(),a=null),document.removeEventListener("keydown",p),l?.(),l=null,setTimeout(()=>{r?.remove();},200));}function A(){n&&v(),o?.removeEventListener("click",f),a&&(a(),a=null),document.removeEventListener("keydown",p),l?.(),l=null,r?.remove(),r=null,o=null,i=null;}const P=b();((document.querySelector("#gemini-hud-root")||document.querySelector("#gemini-root")||document.querySelector("#gemini-hud-container"))?.shadowRoot||document.body||document.documentElement).appendChild(P),requestAnimationFrame(y);const O=()=>y();return window.addEventListener("resize",O),l=()=>{window.removeEventListener("resize",O);},requestAnimationFrame(()=>{r?.classList.add("is-open"),n=true,m(),document.addEventListener("keydown",p);}),{root:P,close:v,destroy:A}}function mu(e={}){const{id:t,min:n=0,max:r=100,step:o=1,value:i=n,label:a,showValue:l=true,disabled:u=false,onInput:f,onChange:p}=e,m=w("div",{className:"slider"}),b=w("div",{className:"slider-row"}),y=w("div",{className:"slider-track"}),v=w("div",{className:"slider-range"});y.appendChild(v);const A=w("input",{id:t,type:"range",min:String(n),max:String(r),step:String(o),value:String(i),disabled:u});A.addEventListener("input",R=>{I(),f?.(D(),R);}),A.addEventListener("change",R=>p?.(D(),R));function P(){const R=r-n;return R===0?0:(D()-n)/R}function I(){const R=Math.max(0,Math.min(1,P()));v.style.width=`${R*100}%`,M&&(M.textContent=String(D()));}function T(R){A.value=String(R),I();}function D(){return Number(A.value)}function O(R){A.disabled=!!R;}let $=null,M=null;return a&&($=w("span",{className:"slider-label"},a),b.appendChild($)),y.appendChild(A),b.appendChild(y),l&&(M=w("span",{className:"slider-value"},String(i)),b.appendChild(M)),m.append(b),I(),{root:m,input:A,setValue:T,getValue:D,setDisabled:O}}const Sf=`
...
`;function ZP(e){return /^I-\d+-GC-\d+-\d+$/.test(e)?"discord":"web"}function eL(e){const t=w("span",{className:`rooms-list__badge rooms-list__badge--${e}`});return t.textContent=e==="discord"?"Discord":"Web",t}function tL(e,t=16){return e.length<=t?e:`${e.slice(0,t)}...`}function nL(){const e=document.createElementNS("http://www.w3.org/2000/svg","svg");return e.setAttribute("viewBox","0 0 24 24"),e.setAttribute("width","14"),e.setAttribute("height","14"),e.setAttribute("fill","none"),e.setAttribute("stroke","currentColor"),e.setAttribute("stroke-width","2"),e.setAttribute("stroke-linecap","round"),e.setAttribute("stroke-linejoin","round"),e.innerHTML=`
  ...
  `,e}function aL(e={}){const{rooms:t=[],onJoinRoom:n,onCopyRoomId:r,onRefresh:o,emptyMessage:i="No rooms available",joinEnabled:a=false,initialFilter:l="5-6",onFilterChange:u}=e;let f=l,p=t;const m=w("div",{className:"rooms-list"}),b=w("style");b.textContent=JP,m.appendChild(b);const y=w("div",{className:"rooms-list__header-bar"}),A=Fr({options:[{value:"5-6",label:"5-6 players"},{value:"4",label:"4 players"},{value:"1-3",label:"1-3 players"},{value:"all",label:"All"}],value:l,onChange:V=>{f=V,u?.(f),z(p);}});y.appendChild(A.root);const P=kt({label:"Refresh rooms",variant:"default",size:"sm",iconLeft:"",onClick:()=>{o?.();}});y.appendChild(P),m.appendChild(y);const I=w("div",{style:"position: relative;"}),T=w("div",{className:"rooms-list__container"});I.appendChild(T);const D=w("div",{className:"rooms-list__loading-overlay"});D.style.display="none";const O=iL();D.appendChild(O),I.appendChild(D),m.appendChild(I);const $=w("div",{className:"rooms-list__footer"}),M=w("div",{className:"rooms-list__aries-badge"});M.textContent="Powered by Aries",$.appendChild(M);const R=w("div",{className:"rooms-list__timestamp"});R.style.display="none",$.appendChild(R),m.appendChild($);const L=[A,{remove:()=>P.remove()}],k=[];function _(V){const U=ZP(V.id),ce=w("div",{className:"rooms-list__item"}),Y=w("div",{className:"rooms-list__top-row"}),ie=eL(U);Y.appendChild(ie);const se=w("span",{className:"rooms-list__id"});se.textContent=tL(V.id,20),se.title=V.id,Y.appendChild(se);const ae=nL(),ne=w("button",{className:"rooms-list__copy-btn"});ne.type="button",ne.title="Copy room ID",ne.appendChild(ae),ne.addEventListener("click",le=>{le.stopPropagation(),r?.(V.id);}),Y.appendChild(ne),ce.appendChild(Y);const q=w("div",{className:"rooms-list__bottom-row"}),Z=w("div",{className:"rooms-list__bottom-left"}),F=w("div",{className:"rooms-list__avatars"});for(let le=0;le<V.maxPlayers;le++){const ve=w("div",{className:`rooms-list__avatar ${le<V.playerCount?"rooms-list__avatar--filled":"rooms-list__avatar--empty"}`});if(V.playerAvatars&&V.playerAvatars[le]){const _e=V.playerAvatars[le];if(_e.avatarUrl){const $e=w("img",{src:_e.avatarUrl,alt:_e.name});$e.style.width="100%",$e.style.height="100%",$e.style.objectFit="cover",ve.appendChild($e);}else ve.textContent="👤";ve.title=_e.name;}else le<V.playerCount&&(ve.textContent="👤");F.appendChild(ve);}Z.appendChild(F);const B=w("span",{className:"rooms-list__count"});B.textContent=`${V.playerCount}/${V.maxPlayers}`,Z.appendChild(B),q.appendChild(Z);const Q=V.playerCount>=V.maxPlayers,re=kt({label:"Join",variant:"primary",size:"sm",disabled:!a||Q,onClick:()=>{n?.(V.id);}});return k.push(re),q.appendChild(re),ce.appendChild(q),ce}function z(V){T.innerHTML="",k.forEach(ce=>{ce.destroy?ce.destroy():ce.remove&&ce.remove();}),k.length=0;const U=rL(V,f);if(U.length===0){const ce=w("div",{className:"rooms-list__empty"});ce.textContent=i,T.appendChild(ce);}else U.forEach(ce=>{const Y=_(ce);T.appendChild(Y);});}return z(t),{root:m,setRooms(V){p=V,z(V);},setFilter(V){f=V,A.setValue(V),z(p);},setLastUpdated(V){R.textContent=oL(V),R.style.display="block";},setLoading(V){V?(D.style.display="flex",D.style.opacity="0",D.offsetWidth,D.style.opacity="1"):(D.style.opacity="0",setTimeout(()=>{D.style.display="none";},300));},destroy(){k.forEach(V=>{V.destroy?V.destroy():V.remove&&V.remove();}),k.length=0,L.forEach(V=>{V.destroy?V.destroy():V.remove&&V.remove();}),L.length=0,m.remove();}}}async function sL(e){const{state:t,defaultExpanded:n=true,onExpandChange:r}=e;let o=null,i=false;const a=!Rt.isDiscord(),l=Rt.isDiscord(),f=Rt.detect().origin;async function p(){try{return (await Ps.fetchRooms(1e3)).map(A=>({id:A.id,playerCount:A.playersCount,maxPlayers:6,playerAvatars:A.userSlots?.map(P=>({name:P.name,avatarUrl:P.avatarUrl}))}))}catch(v){return console.error("[Room] Failed to fetch rooms:",v),[]}}async function m(){if(!(i||!o)){i=true,o.setLoading(true);try{const v=await p(),A=new Date;o.setRooms(v),o.setLastUpdated(A),console.log(`[Room] Fetched ${v.length} rooms from Aries API`);}catch(v){console.error("[Room] Failed to refresh rooms:",v);}finally{i=false,o.setLoading(false);}}}const b=w("div",{style:"display: flex; flex-direction: column; gap: 12px;"});o=aL({rooms:[],joinEnabled:a,onJoinRoom:v=>{const A=`${f}/r/${v}`;window.open(A,"_blank"),console.log(`[Room] Opening room: ${A}`);},onCopyRoomId:v=>{navigator.clipboard.writeText(v).then(()=>{console.log(`[Room] Room ID copied to clipboard: ${v}`);}).catch(A=>{console.error("[Room] Failed to copy room ID:",A);});},onRefresh:()=>{m();},emptyMessage:"No public rooms available",initialFilter:"5-6"}),b.appendChild(o.root);const y=pt({title:"Public",subtitle:l?"List of available public rooms (view only on Discord)":"List of available public rooms",padding:"lg",expandable:true,defaultExpanded:n,onExpandChange:v=>{r?.(v),t.setCardExpanded("public",v),v&&!i&&m();}},b);return n&&m(),{root:y,destroy(){o&&(o.destroy(),o=null);}}}class lL extends Br{constructor(n){super({id:"tab-room",label:"Room"});xe(this,"publicCardHandle",null);this.deps=n;}destroy(){this.publicCardHandle&&(this.publicCardHandle.destroy(),this.publicCardHandle=null);}async build(n){const r=this.createGrid("12px");r.id="room",n.appendChild(r);let o;try{o=await QP();}catch{o={get:()=>pd,set:()=>{},save:()=>{},setUI:()=>{},setCardExpanded:()=>{},toggleCard:()=>{}};}const i=o.get();this.publicCardHandle=await sL({state:o,defaultExpanded:!!i.ui.expandedCards.public}),r.appendChild(this.publicCardHandle.root);}}const cL=10,dL=16;function uL(e){const{selectedSpecies:t,onChange:n,placeholder:r="Search plants...",speciesRuleCount:o={},onSearchChange:i}=e;let a=t??null,l=[],u=[];const f=[],p=new Map;let m=null;const b=w("div",{className:"plant-selector"}),y=js({placeholder:r,blockGameKeys:true,withClear:true,debounceMs:150,onChange:k=>D(k)});b.appendChild(y.root),f.push(()=>{const k=y.root.__cleanup;k&&k();});const v=w("div",{className:"plant-selector__grid"});b.appendChild(v),f.push(()=>{m!==null&&(cancelAnimationFrame(m),m=null),p.clear();});async function A(k,_){if(Qe.isReady())try{const z=await Qe.toCanvas(k,{boundsMode:"padded"});z&&(z.style.maxWidth="40px",z.style.maxHeight="40px",z.style.width="auto",z.style.height="auto",z.style.display="block",_.replaceChildren(z));}catch(z){console.warn("[PlantSelector] Failed to load sprite:",z);}}function P(){if(p.size===0){m=null;return}const k=[],_=p.entries();for(let z=0;z<cL;z++){const j=_.next();if(j.done)break;k.push(j.value);}for(const[z,j]of k)A(j,z),p.delete(z);p.size>0?m=requestAnimationFrame(()=>{setTimeout(P,dL);}):m=null;}function I(){m===null&&(m=requestAnimationFrame(()=>{P();}));}function T(){try{const k=Oe.get("plants");if(!k){console.warn("[PlantSelector] No plants data available");return}l=Object.entries(k).filter(([,_])=>_&&typeof _=="object"&&"crop"in _).map(([_,z])=>({name:_,spriteId:z.crop?.spriteId||null})),u=[...l],O();}catch(k){console.error("[PlantSelector] Failed to load plants:",k);}}function D(k){if(!k.trim())u=[...l];else {const _=k.toLowerCase();u=l.filter(z=>z.name.toLowerCase().includes(_));}i?.(k),O();}function O(){const k=v.scrollTop;if(m!==null&&(cancelAnimationFrame(m),m=null),p.clear(),v.replaceChildren(),u.length===0){const z=w("div",{className:"plant-selector__empty"},"No plants found");v.appendChild(z);return}const _=document.createDocumentFragment();u.forEach(z=>{const j=$(z);_.appendChild(j);}),v.appendChild(_),v.scrollTop=k,p.size>0&&I();}function $(k){const _=o[k.name]??0,z=w("div",{className:`plant-selector__item ${a===k.name?"plant-selector__item--selected":""}`});if(_>0){const ce=w("div",{className:"plant-selector__badge"},String(_));z.appendChild(ce);}z.addEventListener("click",()=>{a=k.name,n(k.name),O();});const j=w("div",{className:"plant-selector__sprite"}),V=w("div",{style:"width: 40px; height: 40px; background: color-mix(in oklab, var(--fg) 8%, transparent); border-radius: 4px;"});j.appendChild(V),k.spriteId&&Qe.isReady()&&p.set(j,k.spriteId),z.appendChild(j);const U=w("div",{className:"plant-selector__name"},k.name);return z.appendChild(U),z}T();function M(){return a}function R(k){a=k,O();}function L(){f.forEach(k=>k()),f.length=0;}return {root:b,getSelected:M,setSelected:R,destroy:L}}async function fl(e,t,n){const{size:r,mutations:o}=n;if(!Qe.isReady()){t.appendChild(li(r));return}try{const l=Oe.get("plants")?.[e]?.crop?.spriteId;if(!l){t.appendChild(li(r));return}const u=await Qe.toCanvas(l,{mutations:o&&o.length>0?o:void 0,boundsMode:"padded"});u?(Yb(u,r),t.appendChild(u)):t.appendChild(li(r));}catch(i){console.warn(`[SpriteRenderer] Failed to render plant sprite for ${e}:`,i),t.appendChild(li(r));}}async function pL(e,t,n){if(!Qe.isReady()){t.appendChild(za(e,n));return}try{const i=`sprite/ui/Mutation${{Ambershine:"Amberlit"}[e]??e}`;if(!Qe.has(i)){t.appendChild(za(e,n));return}const a=await Qe.toCanvas(i);a?(Yb(a,n),t.appendChild(a)):t.appendChild(za(e,n));}catch(r){console.warn(`[SpriteRenderer] Failed to render mutation sprite for ${e}:`,r),t.appendChild(za(e,n));}}function li(e){return w("div",{style:`
        ...
        `},f);l.appendChild(p);function m(){i?(l.style.background="color-mix(in oklab, var(--accent) 20%, transparent)",l.style.border="1px solid var(--accent)"):(l.style.background="color-mix(in oklab, var(--fg) 5%, transparent)",l.style.border="1px solid color-mix(in oklab, var(--fg) 10%, transparent)");}function b(v){i=v,m();}function y(v){a=v,l.style.opacity=a?"0.35":"1",l.style.pointerEvents=a?"none":"",l.style.cursor=a?"default":"pointer";}return {root:l,setSelected:b,setDisabled:y}}function vL(e){const{enabled:t,percentage:n,sizeMode:r,ruleMode:o,onEnabledChange:i,onPercentageChange:a,onSizeModeChange:l,expanded:u=false,onExpandChange:f}=e;let p=t,m=n,b=r,y=o,v=null,A=null,P=null;const I=w("div",{style:"display: flex; flex-direction: column; gap: 12px;"}),T=w("div",{style:`
            ...
            padding: 1px 6px;
            display: none;
        `},"Enabled");O();const D=pt({title:"Size",subtitle:"Growth size threshold",actions:[T],variant:"soft",padding:"md",expandable:true,defaultExpanded:u,onExpandChange:f},I);function O(){I.replaceChildren(),T.style.display=p?"":"none";const L=w("div",{style:"display: flex; align-items: center; gap: 12px;"}),k=nl({checked:p,label:"Enable",size:"md",onChange:Y=>{p=Y,i(Y),O();}});L.appendChild(k.root),p&&(v=w("div",{style:"font-size: 12px; color: color-mix(in oklab, var(--fg) 70%, transparent); line-height: 1.4;"},$()),L.appendChild(v)),I.appendChild(L);const _=w("div",{style:p?"":"opacity: 0.4; pointer-events: none; transition: opacity 0.2s ease;"}),z=w("div",{style:"display: flex; justify-content: center;"}),j=Ro({segments:[{id:"min",label:"Minimum"},{id:"max",label:"Maximum"}],selected:b,onChange:Y=>{b=Y,l(b),O();}});z.appendChild(j),_.appendChild(z),P=w("div",{style:"display: flex; flex-direction: column; gap: 4px;"});const V=w("div",{style:"display: flex; justify-content: space-between; align-items: center;"}),U=w("div",{style:"font-size: 12px; color: var(--fg); font-weight: 500;"},"Size Threshold");A=w("span",{style:"font-size: 12px; font-weight: 600; color: var(--accent);"},`${m}%`),V.appendChild(U),V.appendChild(A),P.appendChild(V);const ce=mu({min:50,max:100,step:1,value:m,showValue:false,onInput:Y=>{m=Y,A&&(A.textContent=`${Y}%`),v&&(v.textContent=$());},onChange:Y=>{m=Y,a(Y);}});P.appendChild(ce.root),_.appendChild(P),I.appendChild(_);}function $(){const L=b==="min"?"at most":"at least";return y==="lock"?`Lock plants ${L} ${m}% grown`:`Allow plants ${L} ${m}% grown`}function M(L){y=L,v&&(v.textContent=$());}function R(){v=null,A=null,P=null;}return {root:D,setRuleMode:M,destroy:R}}function yL(e){const{enabled:t,selected:n,ruleMode:r,onEnabledChange:o,onSelectionChange:i,expanded:a=false,onExpandChange:l}=e;let u=t,f=[...n],p=r,m=null;const b=[],y=w("div",{style:"display: flex; flex-direction: column; gap: 12px;"}),v=w("div",{style:`
            font-size: 10px;
            font-weight: 600;
            color: var(--accent);
            background: color-mix(in oklab, var(--accent) 12%, transparent);
            ...
            padding: 1px 6px;
            display: none;
        `},"Enabled");P();const A=pt({title:"Color Mutation",subtitle:"Gold / Rainbow color variants",actions:[v],variant:"soft",padding:"md",expandable:true,defaultExpanded:a,onExpandChange:l},y);function P(){y.replaceChildren(),b.length=0,v.style.display=u?"":"none";const L=w("div",{style:"display: flex; align-items: center; gap: 12px;"}),k=nl({checked:u,label:"Enable",size:"md",onChange:j=>{u=j,o(j),P();}});L.appendChild(k.root),u&&(m=w("div",{style:"font-size: 12px; color: color-mix(in oklab, var(--fg) 70%, transparent); line-height: 1.4;"},O()),L.appendChild(m)),y.appendChild(L);const _=w("div",{style:u?"":"opacity: 0.4; pointer-events: none; transition: opacity 0.2s ease;"}),z=w("div",{style:`
                display: grid;
                grid-template-columns: repeat(auto-fill, minmax(70px, 1fr));
                gap: 8px;
            `});or.forEach(j=>{const V=f.includes(j),U=Qb({mutationId:j,isSelected:V,onToggle:()=>I(j)});b.push(U),z.appendChild(U.root);}),_.appendChild(z),y.appendChild(_);}function I(L){if(f.includes(L)){const _=f.filter(z=>z!==L);if(_.length===0)return;f=_;}else {if(f.length>=3)return;f=[...f,L];}i(f),T(),D();}function T(){m&&(m.textContent=O());}function D(){or.forEach((L,k)=>{const _=b[k];_&&_.setSelected(f.includes(L));});}function O(){const L=f.map(k=>k==="none"?"normal":k.toLowerCase()).join(", ");return p==="lock"?`Lock ${L} plants`:`Allow ${L} plants`}function $(L){p=L,T();}function M(){return [...f]}function R(){m=null,b.length=0;}return {root:A,setRuleMode:$,getSelection:M,destroy:R}}function xL(e){const{enabled:t,selected:n,matchMode:r,ruleMode:o,onEnabledChange:i,onSelectionChange:a,onMatchModeChange:l,expanded:u=false,onExpandChange:f}=e;let p=t,m=[...n],b=r,y=o,v=null;const A=new Map,P=w("div",{style:"display: flex; flex-direction: column; gap: 12px;"}),I=w("div",{style:`
            font-size: 10px;
            font-weight: 600;
            color: var(--accent);
            background: color-mix(in oklab, var(--accent) 12%, transparent);
            ...
            padding: 1px 6px;
            display: none;
        `},"Enabled");D();const T=pt({title:"Weather Mutation",subtitle:"Weather-based mutation variants",actions:[I],variant:"soft",padding:"md",expandable:true,defaultExpanded:u,onExpandChange:f},P);function D(){P.replaceChildren(),A.clear(),I.style.display=p?"":"none";const j=w("div",{style:"display: flex; align-items: center; gap: 12px;"}),V=nl({checked:p,label:"Enable",size:"md",onChange:ne=>{p=ne,i(ne),D();}});j.appendChild(V.root),p&&(v=w("div",{style:"font-size: 12px; color: color-mix(in oklab, var(--fg) 70%, transparent); line-height: 1.4;"}),m.length>0&&(v.textContent=R()),j.appendChild(v)),P.appendChild(j);const U=w("div",{style:(p?"":"opacity: 0.4; pointer-events: none;")+" display: flex; flex-direction: column; gap: 12px; transition: opacity 0.2s ease;"}),ce=w("div",{style:"display: flex; justify-content: center;"}),Y=Ro({segments:[{id:"any",label:"Any"},{id:"all",label:"All"}],selected:b,onChange:ne=>{b=ne,ne==="all"&&(m=gL(m),a(m)),l(b),D();}});ce.appendChild(Y),U.appendChild(ce);const se=["none",...qb()],ae=w("div",{style:`
                display: grid;
                grid-template-columns: repeat(auto-fit, minmax(85px, 1fr));
                gap: 8px;
                max-height: 300px;
                overflow-y: auto;
            `});se.forEach(ne=>{const q=m.includes(ne),Z=Qb({mutationId:ne,isSelected:q,onToggle:()=>O(ne),label:ne==="none"?"None":void 0});A.set(ne,Z),ae.appendChild(Z.root);}),U.appendChild(ae),P.appendChild(U);}function O(j){if(b==="all")if(j==="none")m.length===1&&m[0]==="none"?m=[]:m=["none"];else {if(m.includes("none"))return;m.includes(j)?m=m.filter(V=>V!==j):(fd(j)?m=m.filter(V=>!fd(V)):hd(j)&&(m=m.filter(V=>!hd(V))),m=[...m,j]);}else m.includes(j)?m=m.filter(V=>V!==j):m=[...m,j];a(m),$(),M();}function $(){v&&(v.textContent=m.length>0?R():"");}function M(){const j=b==="all"&&m.includes("none");A.forEach((V,U)=>{V.setSelected(m.includes(U)),V.setDisabled(j&&U!=="none");});}function R(){const j=hL(m),V=b==="all"?"AND":"OR";return y==="lock"?`Lock ${j} plants (${V})`:`Allow ${j} plants (${V})`}function L(j){y=j,$();}function k(){return [...m]}function _(){return b}function z(){v=null,A.clear();}return {root:T,setRuleMode:L,getSelection:k,getMatchMode:_,destroy:z}}const wL=60;function CL(e){let t={...e},n=null,r=null;const o=w("div",{style:"display: flex; flex-direction: column; gap: 8px;"}),i=w("div",{style:"display: flex; justify-content: center;"}),a=w("div",{className:"harvest-locker-preview-grid"});o.appendChild(i),o.appendChild(a);const l=w("div",{style:`
            font-size: 10px;
            font-weight: 600;
            color: var(--accent);
            background: color-mix(in oklab, var(--accent) 12%, transparent);
            ...
            padding: 1px 6px;
            display: none;
        `});t.sizeEnabled&&t.sizePercentage!==void 0&&(l.textContent=`size ${(t.sizeMode??"max")==="max"?"≥":"≤"} ${t.sizePercentage}%`,l.style.display="");const u=pt({title:"Preview",subtitle:p(),actions:[l],variant:"soft",padding:"md",expandable:true,defaultExpanded:true},o),f=u.querySelector(".card-subtitle");m();function p(){return t.ruleMode==="lock"?"Preview of plants that will be blocked from harvesting":"Preview of plants that will be harvestable"}function m(){n!==null&&(cancelAnimationFrame(n),n=null),f&&(f.textContent=p()),t.sizeEnabled&&t.sizePercentage!==void 0?(l.textContent=`size ${(t.sizeMode??"max")==="max"?"≥":"≤"} ${t.sizePercentage}%`,l.style.display=""):l.style.display="none";const I=t.colorEnabled?or.filter(T=>t.colorMutations.includes(T)):[];if(I.length>=2){r&&!I.includes(r)&&(r=I[0]),r||(r=I[0]),i.replaceChildren();const T=Ro({segments:I.map(D=>({id:D,label:D==="none"?"Normal":D})),selected:r,onChange:D=>{r=D,m();}});i.appendChild(T);}else r=null,i.replaceChildren();a.replaceChildren(),n=requestAnimationFrame(()=>{b().forEach(D=>{a.appendChild(D);});});}function b(){const I=[],T=t.species||"Starweaver";if(!(t.sizeEnabled||t.colorEnabled||t.weatherEnabled))return I.push(v(T,[])),I;const O=y();if(O.sort((M,R)=>{const L=Math.max(0,...M.map(j=>or.indexOf(j))),k=Math.max(0,...R.map(j=>or.indexOf(j)));if(L!==k)return L-k;const _=M.filter(j=>!or.includes(j)).sort((j,V)=>Qr(j)-Qr(V)),z=R.filter(j=>!or.includes(j)).sort((j,V)=>Qr(j)-Qr(V));if(_.length!==z.length)return _.length-z.length;for(let j=0;j<_.length;j++){const V=Qr(_[j])-Qr(z[j]);if(V!==0)return V}return 0}),O.length===0){const M=w("div",{style:"padding: 12px; text-align: center; color: #ef4444; font-size: 12px;"},"Invalid mutation combination");return I.push(M),I}return (r?O.filter(M=>{const R=M.filter(L=>or.includes(L)&&L!=="none");return r==="none"?R.length===0:R.includes(r)}):O).forEach(M=>{I.push(v(T,M));}),I}function y(){const I=[],T=t.weatherEnabled?t.weatherMutations.filter(j=>j!=="none"):[],D=t.colorEnabled?t.colorMutations.filter(j=>j!=="none"):[],O=t.weatherEnabled&&t.weatherMutations.includes("none"),$=t.colorEnabled&&t.colorMutations.includes("none");if(T.length===0&&D.length===0||!t.weatherEnabled&&!t.colorEnabled)return I.push([]),I;const M=T.filter(j=>$s.wet.includes(j)),R=T.filter(j=>$s.lunar.includes(j)),L=(j,V)=>{j.length===0&&V.length===0?I.push([]):j.length===0?V.forEach(U=>{I.push([...U]);}):V.length===0?j.forEach(U=>{I.push([...U]);}):j.forEach(U=>{V.forEach(ce=>{I.push([...U,...ce]);});});},k=[];if(O&&k.push([]),t.weatherMatchMode==="all"&&T.length>0){const j=M.length>1,V=R.length>1;if(j||V)return [];k.push(T);}else t.weatherMatchMode==="any"&&T.length>0&&(T.forEach(j=>{k.push([j]);}),M.forEach(j=>{R.forEach(V=>{k.push([j,V]);});}));const _=[];return $&&_.push([]),D.forEach(j=>{_.push([j]);}),L(k,_),Array.from(new Set(I.map(j=>j.sort().join(",")))).map(j=>j.split(",").filter(Boolean))}function v(I,T){const D=w("div",{style:"flex-shrink: 0;"});return fl(I,D,{size:wL,mutations:T}),D}function A(I){t={...t,...I},m();}function P(){n!==null&&(cancelAnimationFrame(n),n=null),a.replaceChildren();}return {root:u,update:A,destroy:P}}function Hf(e){const{mode:t,species:n,ruleId:r,initialData:o,onSave:i,onDelete:a,onCancel:l}=e;let u=o?.name??"",f=o?.ruleMode??"lock",p=o?.sizeCondition?.enabled??false,m=o?.sizeCondition?.minPercentage??75,b=o?.sizeCondition?.sizeMode??"max";const y=o?.mutationCondition?.mutations??[],v=y.filter(F=>["none","Gold","Rainbow"].includes(F));let A=v.length>0,P=v.length>0?v:["none"];const I=y.filter(F=>!["none","Gold","Rainbow"].includes(F));let T=I.length>0,D=I.length>0?I:["none"],O=o?.mutationCondition?.matchMode??"any",$=null,M=null,R=null,L=null,k=null,_=null,z=null;const j=ce(),V=ie();z=hu({title:U(),content:j,footer:V,size:"lg",closeOnBackdrop:true,closeOnEscape:true,onClose:()=>{l?.();}});function U(){if(t!=="species"||!n)return r?"Edit Overall Rule":"Create Overall Rule";const F=w("div",{style:"display: flex; align-items: center; gap: 10px;"}),B=w("div",{style:"width: 24px; height: 24px; display: flex; align-items: center; justify-content: center; flex-shrink: 0;"});fl(n,B,{size:24}),F.appendChild(B);const Q=w("span",{},`${n} — Override Rule`);return F.appendChild(Q),F}function ce(){const F=w("div",{style:"display: flex; flex-direction: column; gap: 16px;"});if(t==="species"){const B=w("div",{style:"font-size: 12px; color: color-mix(in oklab, var(--fg) 60%, transparent); padding: 8px 10px; background: color-mix(in oklab, var(--accent) 8%, transparent); border-radius: 6px; border-left: 3px solid var(--accent);"},"Global rules still apply. This override takes priority for this species only.");F.appendChild(B);}return F.appendChild(Y()),$=vL({enabled:p,percentage:m,sizeMode:b,ruleMode:f,onEnabledChange:B=>{p=B,ae(),ne();},onPercentageChange:B=>{m=B,ne();},onSizeModeChange:B=>{b=B,ne();}}),F.appendChild($.root),M=yL({enabled:A,selected:P,ruleMode:f,onEnabledChange:B=>{A=B,ae(),ne();},onSelectionChange:B=>{P=B,ne();}}),F.appendChild(M.root),R=xL({enabled:T,selected:D,matchMode:O,ruleMode:f,onEnabledChange:B=>{T=B,ae(),ne();},onSelectionChange:B=>{D=B,ne();},onMatchModeChange:B=>{O=B,ne();}}),F.appendChild(R.root),L=CL({species:t==="overall"?"Carrot":n,ruleMode:f,sizeEnabled:p,sizePercentage:m,sizeMode:b,colorEnabled:A,colorMutations:P,weatherEnabled:T,weatherMutations:D,weatherMatchMode:O}),F.appendChild(L.root),F}function Y(){const F=w("div",{style:"display: flex; flex-direction: column; gap: 12px;"}),B=w("div",{style:"display: flex; gap: 12px; align-items: flex-start;"}),Q=w("div",{style:"flex: 1; display: flex; flex-direction: column; gap: 6px;"}),re=w("label",{style:"font-size: 12px; font-weight: 500; color: var(--fg);"},"Rule Name");Q.appendChild(re),k=zs({placeholder:"e.g., Lock Large Frozen",value:u,maxLength:30,blockGameKeys:true,onChange:$e=>{u=$e,ae();}}),Q.appendChild(k.root),B.appendChild(Q);const le=w("div",{style:"display: flex; flex-direction: column; gap: 6px;"}),ve=w("label",{style:"font-size: 12px; font-weight: 500; color: var(--fg);"},"Mode");le.appendChild(ve);const _e=Ro({segments:[{id:"lock",label:"Lock"},{id:"allow",label:"Allow"}],selected:f,onChange:$e=>{f=$e,$?.setRuleMode(f),M?.setRuleMode(f),R?.setRuleMode(f),ne();}});return le.appendChild(_e),B.appendChild(le),F.appendChild(B),F}function ie(){const F=w("div",{style:"display: flex; gap: 8px; justify-content: space-between; width: 100%;"}),B=w("div",{style:"display: flex; gap: 8px;"});if(r&&a){const ve=kt({label:"Delete Rule",variant:"danger",onClick:()=>{a(),Z();}});B.appendChild(ve);}F.appendChild(B);const Q=w("div",{style:"display: flex; gap: 8px;"}),re=kt({label:"Cancel",variant:"default",onClick:()=>{l?.(),Z();}});Q.appendChild(re);const le=kt({label:"Save",variant:"primary",disabled:!se(),onClick:q});return _=le,Q.appendChild(le),F.appendChild(Q),F}function se(){return !(!u.trim()||!p&&!A&&!T)}function ae(){_&&(_.disabled=!se());}function ne(){L?.update({ruleMode:f,sizeEnabled:p,sizePercentage:m,sizeMode:b,colorEnabled:A,colorMutations:P,weatherEnabled:T,weatherMutations:D,weatherMatchMode:O});}function q(){if(!se())return;const F={name:u.trim(),ruleMode:f};p&&(F.sizeCondition={enabled:true,minPercentage:m,sizeMode:b});const B=[];T&&B.push(...D),A&&B.push(...P),B.length>0&&(F.mutationCondition={enabled:true,mutations:B,matchMode:O}),i(F),Z();}function Z(){$?.destroy(),M?.destroy(),R?.destroy(),L?.destroy(),k?.destroy(),z?.destroy(),$=null,M=null,R=null,L=null,k=null,_=null,z=null;}return {root:z.root,destroy:Z}}function kL(e){const{species:t,existingRules:n,onSelect:r}=e;let o=null;const i=u(),a=f();o=hu({title:l(),subtitle:"Select a rule to assign to this species",content:i,footer:a,size:"md",closeOnBackdrop:true,closeOnEscape:true,onClose:()=>{}});function l(){const v=w("div",{style:"display: flex; align-items: center; gap: 10px;"}),A=w("div",{style:"width: 24px; height: 24px; display: flex; align-items: center; justify-content: center; flex-shrink: 0;"});return fl(t,A,{size:24}),v.appendChild(A),v.appendChild(w("span",{},`${t} — Assign Rule`)),v}function u(){const v=w("div",{style:"display: flex; flex-direction: column; gap: 8px;"});if(n.length===0){const A=w("div",{style:"padding: 20px; text-align: center; color: var(--muted); font-size: 14px;"},"No overall rules available");v.appendChild(A);}else n.forEach(A=>{v.appendChild(p(A));});return v}function f(){const v=w("div",{style:"display: flex; gap: 8px; justify-content: flex-end;"}),A=kt({label:"Cancel",variant:"default",onClick:()=>{y();}});return v.appendChild(A),v}function p(v){const A=w("div",{className:"harvest-locker-rule-item",style:"flex-direction: column; align-items: flex-start; gap: 8px;"});A.addEventListener("click",()=>{zt.cloneRuleToSpecies(v.id,t),r(v.id),y();});const P=w("div",{style:"display: flex; align-items: center; justify-content: space-between; width: 100%;"});P.appendChild(w("div",{className:"harvest-locker-rule-item__name"},v.name)),P.appendChild(w("div",{className:"harvest-locker-rule-item__badge"},v.mode)),A.appendChild(P);const I=m(v);return I.childNodes.length>0&&A.appendChild(I),A}function m(v){const A=w("div",{style:"display: flex; flex-wrap: wrap; gap: 4px;"});return v.sizeCondition?.enabled&&A.appendChild(b(`Size ≥ ${v.sizeCondition.minPercentage}%`)),v.mutationCondition?.enabled&&v.mutationCondition.mutations.forEach(P=>{A.appendChild(b(P==="none"?"Normal":P));}),A}function b(v){return w("div",{style:`
                padding: 2px 8px;
                border-radius: 10px;
                font-size: 11px;
                font-weight: 500;
