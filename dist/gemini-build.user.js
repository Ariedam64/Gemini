...
(function () {
  ...
  var Xf=Object.defineProperty;var qf=(e,t,n)=>t in e?Xf(e,t,{enumerable:true,configurable:true,writable:true,value:n}):e[t]=n;var L=(e,t,n)=>qf(e,typeof t!="symbol"?t+"":t,n);function x(e,t=null,...n){const r=document.createElement(e);for(const[o,a]of Object.entries(t||{}))a!=null&&(o==="style"?typeof a=="string"?r.setAttribute("style",a):typeof a=="object"&&Object.assign(r.style,a):o.startsWith("on")&&typeof a=="function"?r[o.toLowerCase()]=a:o in r?r[o]=a:r.setAttribute(o,String(a)));for(const o of n)o==null||o===false||r.appendChild(typeof o=="string"||typeof o=="number"?document.createTextNode(String(o)):o);return r}const eo="https://i.imgur.com/k5WuC32.png",Tl="gemini-loader-style",jt="gemini-loader",ad=80;function Kf(){if(document.getElementById(Tl))return;const e=document.createElement("style");e.id=Tl,e.textContent=`
    /* ===== Loader Variables ===== */
    #${jt} {
  ...
  `;const t=document.head||document.documentElement||document.body;if(t){t.appendChild(e);return}const n=()=>{(document.head||document.documentElement||document.body)?.appendChild(e);};document.readyState==="loading"?document.addEventListener("DOMContentLoaded",n,{once:true}):setTimeout(n,0);}function to(e,t,n){const r=x("div",{className:`gemini-loader__log ${n}`},x("div",{className:"gemini-loader__dot"}),x("div",{textContent:t}));for(e.appendChild(r);e.childElementCount>ad;)e.firstElementChild?.remove();e.scrollTop=e.scrollHeight;}function Yf(){return new Promise(e=>{if(typeof GM_xmlhttpRequest>"u"){e(eo);return}GM_xmlhttpRequest({method:"GET",url:eo,responseType:"blob",onload:t=>{const n=t.response,r=new FileReader;r.onloadend=()=>e(r.result),r.onerror=()=>e(eo),r.readAsDataURL(n);},onerror:()=>e(eo)});})}function Jf(e={}){const t=Number.isFinite(e.blurPx)?Math.max(4,Number(e.blurPx)):14;Kf();const n=x("div",{className:"gemini-loader__subtitle",textContent:e.subtitle??"Initializing the mod..."}),r=x("div",{className:"gemini-loader__logs"}),o=x("img",{className:"gemini-loader__spinner-icon",alt:"Gemini"}),a=x("div",{className:"gemini-loader__spinner"},o);Yf().then(h=>{o.src=h;});const i=x("div",{className:"gemini-loader__card"},x("div",{className:"gemini-loader__header"},a,x("div",{className:"gemini-loader__titles"},x("div",{className:"gemini-loader__title",textContent:e.title??"Gemini is loading"}),n)),r),s=x("div",{id:jt},i);(document.body||document.documentElement).appendChild(s);const l=x("div",{className:"gemini-loader__actions"},x("button",{className:"gemini-loader__button",textContent:"Close loader",onclick:()=>s.remove()}));i.appendChild(l),s.style.setProperty("--loader-blur",`${t}px`);const d=h=>{n.textContent=h;},c=new Map,u=(h,b)=>{h.className=`gemini-loader__log ${b}`;};return {log:(h,b="info")=>to(r,h,b),logStep:(h,b,w="info")=>{const C=String(h||"").trim();if(!C){to(r,b,w);return}const v=c.get(C);if(v){v.el.lastElementChild&&(v.el.lastElementChild.textContent=b),v.tone!==w&&(u(v.el,w),v.tone=w);return}const _=x("div",{className:`gemini-loader__log ${w}`},x("div",{className:"gemini-loader__dot"}),x("div",{textContent:b}));for(c.set(C,{el:_,tone:w}),r.appendChild(_);r.childElementCount>ad;){const y=r.firstElementChild;if(!y)break;const S=Array.from(c.entries()).find(([,T])=>T.el===y)?.[0];S&&c.delete(S),y.remove();}r.scrollTop=r.scrollHeight;},setSubtitle:d,succeed:(h,b=600)=>{h&&to(r,h,"success"),s.classList.add("gemini-loader--closing"),setTimeout(()=>s.remove(),b);},fail:(h,b)=>{to(r,h,"error"),d("Something went wrong. Check the console for details."),s.classList.add("gemini-loader--error"),console.error("[Gemini loader]",h,b);}}}const Pl=150,Qf=30;function Zf(e,t,n){const r=x("div",{className:"lg-pill",id:"pill"}),o=e.map(k=>{const P=x("button",{className:"lg-tab"},k.label);return P.setAttribute("data-target",k.id),P}),a=x("div",{className:"lg-tabs",id:"lg-tabs-row"},r,...o),i=new Map(e.map(k=>[k.id,true])),s=new Map(o.map((k,P)=>[e[P].id,k]));function l(k){const P=document.createElementNS("http://www.w3.org/2000/svg","svg");P.setAttribute("viewBox","0 0 24 24"),P.setAttribute("fill","none"),P.setAttribute("stroke","currentColor"),P.setAttribute("stroke-width","2"),P.setAttribute("stroke-linecap","round"),P.setAttribute("stroke-linejoin","round");const E=document.createElementNS("http://www.w3.org/2000/svg","polyline");return E.setAttribute("points",k==="left"?"15 18 9 12 15 6":"9 18 15 12 9 6"),P.appendChild(E),P}const d=x("button",{className:"lg-tabs-arrow lg-tabs-arrow-left",ariaLabel:"Scroll left"});d.appendChild(l("left"));const c=x("button",{className:"lg-tabs-arrow lg-tabs-arrow-right",ariaLabel:"Scroll right"});c.appendChild(l("right"));const p=x("div",{className:"lg-tabs-wrapper"},d,a,c);let f=0,g=0,m=false;function h(){const k=a.scrollLeft>0,P=a.scrollLeft<a.scrollWidth-a.clientWidth-1;d.classList.toggle("disabled",!k),c.classList.toggle("disabled",!P);}d.addEventListener("click",()=>{a.scrollBy({left:-Pl,behavior:"smooth"}),setTimeout(h,300);}),c.addEventListener("click",()=>{a.scrollBy({left:Pl,behavior:"smooth"}),setTimeout(h,300);}),a.addEventListener("wheel",k=>{Math.abs(k.deltaY)>Math.abs(k.deltaX)&&(k.preventDefault(),a.scrollLeft+=k.deltaY,h());},{passive:false});let b=0;a.addEventListener("touchstart",k=>{const P=k.touches[0];f=P.clientX,g=P.clientY,m=false,b=a.scrollLeft;},{passive:true}),a.addEventListener("touchmove",k=>{if(m)return;const P=k.touches[0],E=P.clientX-f,B=P.clientY-g;if(Math.abs(B)>Math.abs(E)){m=true;return}Math.abs(E)>Qf&&(k.preventDefault(),a.scrollLeft=b-E);},{passive:false}),a.addEventListener("touchend",()=>{h();},{passive:true}),a.addEventListener("scroll",h,{passive:true});function w(k){const P=o.find(E=>E.dataset.target===k)||o[0];P&&requestAnimationFrame(()=>{const E=P.offsetLeft,B=P.offsetWidth;r.style.width=`${B}px`,r.style.transform=`translateX(${E}px)`;const Z=a.scrollLeft,H=Z,D=Z+a.clientWidth,Y=E-12,O=E+B+12;Y<H?a.scrollTo({left:Y,behavior:"smooth"}):O>D&&a.scrollTo({left:O-a.clientWidth,behavior:"smooth"}),setTimeout(h,300);});}function C(){for(const[k,P]of i)if(P)return k;return null}function v(k){const P=s.get(k);if(P)if(i.set(k,false),P.style.display="none",S===k){const E=C();E&&T(E);}else y();}function _(k){const P=s.get(k);P&&(i.set(k,true),P.style.display="",y());}function y(){w(S),h();}let S=t||(e[0]?.id??"");function T(k){i.get(k)&&(S=k,o.forEach(P=>P.classList.toggle("active",P.dataset.target===k)),w(k),n(k));}return o.forEach(k=>k.addEventListener("click",()=>T(k.dataset.target))),queueMicrotask(()=>{w(S),h();}),{root:p,activate:T,recalc:y,getActive:()=>S,showTab:_,hideTab:v,isTabVisible:k=>i.get(k)??false,getVisibleTabs:()=>[...i.entries()].filter(([k,P])=>P).map(([k])=>k)}}class nn{constructor(t){L(this,"id");L(this,"label");L(this,"container",null);L(this,"cleanupFunctions",[]);L(this,"preloadedContent",null);L(this,"preloadPromise",null);this.id=t.id,this.label=t.label;}destroy(){}async preload(){if(this.preloadedContent||this.preloadPromise)return;const t=x("div");this.preloadPromise=(async()=>{const n=this.build(t);n instanceof Promise&&await n,this.preloadedContent=t,this.preloadPromise=null;})(),await this.preloadPromise;}isPreloaded(){return this.preloadedContent!==null}render(t){for(this.unmount();t.firstChild;)t.removeChild(t.firstChild);if(this.container=t,this.preloadedContent){for(;this.preloadedContent.firstChild;)t.appendChild(this.preloadedContent.firstChild);this.preloadedContent=null;}else {const r=this.build(t);r instanceof Promise&&r.catch(o=>{console.error(`[Gemini] Error building section ${this.id}:`,o);});}const n=t.firstElementChild;n&&n.classList.contains("gemini-section")&&n.classList.add("active");}unmount(){const t=this.destroy();t instanceof Promise&&t.catch(n=>{console.error(`[Gemini] Destroy error in section ${this.id}:`,n);}),this.executeCleanup(),this.container=null;}createContainer(t,n){const r=n?`gemini-section ${n}`:"gemini-section";return x("section",{id:t,className:r})}addCleanup(t){this.cleanupFunctions.push(t);}createGrid(t="12px"){const n=x("div");return n.style.display="grid",n.style.gap=t,n}executeCleanup(){for(const t of this.cleanupFunctions)try{t();}catch(n){console.error(`[Gemini] Cleanup error in section ${this.id}:`,n);}this.cleanupFunctions=[];}}class eg{constructor(t,n,r){L(this,"sections");L(this,"activeId",null);L(this,"container");L(this,"theme");this.sections=new Map(t.map(o=>[o.id,o])),this.container=n,this.theme=r;}get ids(){return Array.from(this.sections.keys())}get all(){return Array.from(this.sections.values())}get active(){return this.activeId}activate(t){if(this.activeId!==t){if(!this.sections.has(t))throw new Error(`[Gemini] Unknown section: ${t}`);if(this.activeId&&this.sections.get(this.activeId).unmount(),this.activeId=t,this.sections.get(t).render(this.container),this.theme){const n=this.theme.getCurrentTheme();this.theme.applyTheme(n);}}}}const Lt="gemini:",tg={STATE:"hud:state",THEME:"hud:theme"},ng={ALL:"sections",SETTINGS:"sections:settings",TEST:"sections:test"},rg={AUDIO_CUSTOM_SOUNDS:"module:audio:customSounds"},og={MY_PETS_ABILITY_LOGS:"global:myPets:abilityLogs"},we={AUTO_FAVORITE:"feature:autoFavorite:config",AUTO_FAVORITE_UI:"feature:autoFavorite:ui",JOURNAL_CHECKER:"feature:journalChecker:config",BULK_FAVORITE:"feature:bulkFavorite:config",ACHIEVEMENTS:"feature:achievements:data",TRACKER_STATS:"feature:tracker:stats",ANTI_AFK:"feature:antiAfk:config",CONFIG:"feature:config",PET_TEAM:"feature:petTeam:config",XP_TRACKER:"feature:xpTracker:config",CROP_VALUE_INDICATOR:"feature:cropValueIndicator:config",CROP_SIZE_INDICATOR:"feature:cropSizeIndicator:config",SHOP_NOTIFIER:"feature:shopNotifier:config"},ag={AUTO_RELOAD:"dev:auto-reload"},da={HUD:tg,SECTION:ng,MODULE:rg,GLOBAL:og,FEATURE:we,DEV:ag},Il={STORAGE_CHANGE:"gemini:storage:change"};function ve(e,t){try{const n=e.startsWith(Lt)?e:Lt+e,r=GM_getValue(n);return r==null?t:typeof r=="string"?JSON.parse(r):r}catch(n){return console.error(`[Gemini Storage] Failed to read key "${e}":`,n),t}}function Pe(e,t){try{const n=e.startsWith(Lt)?e:Lt+e,r=e.startsWith(Lt)?e.slice(Lt.length):e,o=JSON.stringify(t);GM_setValue(n,o),window.dispatchEvent(new CustomEvent("gemini:storage:change",{detail:{key:r,value:t}}));}catch(n){console.error(`[Gemini Storage] Failed to write key "${e}":`,n);}}function ig(e){try{const t=e.startsWith(Lt)?e:Lt+e;GM_setValue(t,void 0);}catch(t){console.error(`[Gemini Storage] Failed to remove key "${e}":`,t);}}function sg(){try{const e="gemini:",t=[];for(let o=0;o<localStorage.length;o++){const a=localStorage.key(o);a&&a.startsWith(e)&&t.push(a);}for(const o of t)try{const a=localStorage.getItem(o);if(a!==null){const i=JSON.parse(a),s=o.slice(e.length);Pe(s,i),console.log(`[Gemini Storage] Migrated key: ${o}`);}}catch(a){console.warn(`[Gemini Storage] Failed to migrate key "${o}":`,a);}const n="gemini.sections",r=GM_getValue(n);r!=null&&(Pe("sections",r),GM_setValue(n,void 0),console.log("[Gemini Storage] Migrated: gemini.sections → gemini:sections")),t.length>0&&console.log(`[Gemini Storage] Migration complete. ${t.length} keys migrated from localStorage to GM_* storage.`);}catch(e){console.error("[Gemini Storage] Migration failed:",e);}}const id="gemini.sections";function sd(){const e=ve(id,{});return e&&typeof e=="object"&&!Array.isArray(e)?e:{}}function lg(e){Pe(id,e);}async function cg(e){return sd()[e]}function dg(e,t){const n=sd();lg({...n,[e]:t});}function Al(e,t){return {...e,...t??{}}}async function ug(e){const t=await cg(e.path);let n;e.migrate?n=e.migrate(t):n=t??{},n=Object.assign((d=>JSON.parse(JSON.stringify(d)))(e.defaults),n),e.sanitize&&(n=e.sanitize(n));function o(){dg(e.path,n);}function a(){return n}function i(d){n=e.sanitize?e.sanitize(d):d,o();}function s(d){const u=Object.assign((p=>JSON.parse(JSON.stringify(p)))(n),{});typeof d=="function"?d(u):Object.assign(u,d),n=e.sanitize?e.sanitize(u):u,o();}function l(){o();}return {get:a,set:i,update:s,save:l}}async function Dr(e,t){const{path:n=e,...r}=t;return ug({path:n,...r})}let pg=0;const no=new Map;function We(e={},...t){const{id:n,className:r,variant:o="default",padding:a="md",interactive:i=false,expandable:s=false,defaultExpanded:l=true,onExpandChange:d,mediaTop:c,title:u,subtitle:p,badge:f,actions:g,footer:m,divider:h=false,tone:b="neutral",stateKey:w}=e,C=x("div",{className:"card",id:n,tabIndex:i?0:void 0});C.classList.add(`card--${o}`,`card--p-${a}`),i&&C.classList.add("card--interactive"),b!=="neutral"&&C.classList.add(`card--tone-${b}`),r&&C.classList.add(...r.split(" ").filter(Boolean)),s&&C.classList.add("card--expandable");const v=s?w??n??(typeof u=="string"?`title:${u}`:null):null;let _=!s||l;v&&no.has(v)&&(_=!!no.get(v));let y=null,S=null,T=null,k=null,P=null;const E=n?`${n}-collapse`:`card-collapse-${++pg}`,B=()=>{if(k!==null&&(cancelAnimationFrame(k),k=null),P){const z=P;P=null,z();}},Z=(z,G)=>{if(!T)return;B();const $=T;if($.setAttribute("aria-hidden",String(!z)),!G){$.classList.remove("card-collapse--animating"),$.style.display=z?"":"none",$.style.height="",$.style.opacity="";return}if($.classList.add("card-collapse--animating"),$.style.display="",z){$.style.height="auto";const U=$.scrollHeight;if(!U){$.classList.remove("card-collapse--animating"),$.style.display="",$.style.height="",$.style.opacity="";return}$.style.height="0px",$.style.opacity="0",$.offsetHeight,k=requestAnimationFrame(()=>{k=null,$.style.height=`${U}px`,$.style.opacity="1";});}else {const U=$.scrollHeight;if(!U){$.classList.remove("card-collapse--animating"),$.style.display="none",$.style.height="",$.style.opacity="";return}$.style.height=`${U}px`,$.style.opacity="1",$.offsetHeight,k=requestAnimationFrame(()=>{k=null,$.style.height="0px",$.style.opacity="0";});}const A=()=>{$.classList.remove("card-collapse--animating"),$.style.height="",z||($.style.display="none"),$.style.opacity="";};let R=null;const N=U=>{U.target===$&&(R!==null&&(clearTimeout(R),R=null),$.removeEventListener("transitionend",N),$.removeEventListener("transitioncancel",N),P=null,A());};P=()=>{R!==null&&(clearTimeout(R),R=null),$.removeEventListener("transitionend",N),$.removeEventListener("transitioncancel",N),P=null,A();},$.addEventListener("transitionend",N),$.addEventListener("transitioncancel",N),R=window.setTimeout(()=>{P?.();},420);};function H(z){const G=document.createElementNS("http://www.w3.org/2000/svg","svg");return G.setAttribute("viewBox","0 0 24 24"),G.setAttribute("width","16"),G.setAttribute("height","16"),G.innerHTML=z==="up"?'<path d="M7 14l5-5 5 5" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"/>':'<path d="M7 10l5 5 5-5" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"/>',G}function D(z,G=true,$=true){_=z,C.classList.toggle("card--collapsed",!_),C.classList.toggle("card--expanded",_),y&&(y.dataset.expanded=String(_),y.setAttribute("aria-expanded",String(_))),S&&(S.setAttribute("aria-expanded",String(_)),S.classList.toggle("card-toggle--collapsed",!_),S.setAttribute("aria-label",_?"Replier le contenu":"Deplier le contenu"),S.replaceChildren(H(_?"up":"down"))),s?Z(_,$):T&&(T.style.display="",T.style.height="",T.style.opacity="",T.setAttribute("aria-hidden","false")),G&&d&&d(_),v&&no.set(v,_);}if(c){const z=x("div",{className:"card-media"});z.append(c),C.appendChild(z);}const Y=!!(u||p||f||g&&g.length||s);if(Y){y=x("div",{className:"card-header"});const z=x("div",{className:"card-headline",style:"min-width:0;display:flex;flex-direction:column;gap:2px;"});if(u){const A=x("h3",{className:"card-title",style:"margin:0;font-size:15px;font-weight:700;line-height:1.25;white-space:nowrap;overflow:hidden;text-overflow:ellipsis;display:flex;align-items:center;gap:8px;color:var(--fg);"},u);f&&A.append(typeof f=="string"?x("span",{className:"badge"},f):f),z.appendChild(A);}if(p){const A=x("div",{className:"card-subtitle",style:"opacity:.85;font-size:12px;color:color-mix(in oklab, var(--fg) 80%, #9ca3af)"},p);z.appendChild(A);}(z.childNodes.length||s)&&y.appendChild(z);const G=x("div",{className:"card-header-right",style:"display:flex;gap:8px;flex:0 0 auto;align-items:center;"}),$=x("div",{className:"card-actions",style:"display:flex;gap:8px;flex:0 0 auto;align-items:center;"});g?.forEach(A=>$.appendChild(A)),$.childNodes.length&&G.appendChild($),s&&(S=x("button",{className:"card-toggle",type:"button",ariaExpanded:String(_),ariaControls:E,ariaLabel:_?"Replier le contenu":"Deplier le contenu"}),S.textContent=_?"▲":"▼",S.addEventListener("click",A=>{A.preventDefault(),A.stopPropagation(),D(!_);}),G.appendChild(S),y.classList.add("card-header--expandable"),y.addEventListener("click",A=>{const R=A.target;R?.closest(".card-actions")||R?.closest(".card-toggle")||D(!_);})),G.childNodes.length&&y.appendChild(G),C.appendChild(y);}T=x("div",{className:"card-collapse",id:E,ariaHidden:s?String(!_):"false"}),C.appendChild(T),h&&Y&&T.appendChild(x("div",{className:"card-divider"}));const O=x("div",{className:"card-body"});if(O.append(...t),T.appendChild(O),m){h&&T.appendChild(x("div",{className:"card-divider"}));const z=x("div",{className:"card-footer"});z.append(m),T.appendChild(z);}return S&&S.setAttribute("aria-controls",E),D(_,false,false),v&&no.set(v,_),C}let qo=false;const Ko=new Set,Je=e=>{const t=document.activeElement;for(const n of Ko)if(t&&(t===n||n.contains(t))){e.stopImmediatePropagation(),e.stopPropagation();return}};function fg(){qo||(qo=true,window.addEventListener("keydown",Je,true),window.addEventListener("keypress",Je,true),window.addEventListener("keyup",Je,true),document.addEventListener("keydown",Je,true),document.addEventListener("keypress",Je,true),document.addEventListener("keyup",Je,true));}function gg(){qo&&(Ko.size>0||(qo=false,window.removeEventListener("keydown",Je,true),window.removeEventListener("keypress",Je,true),window.removeEventListener("keyup",Je,true),document.removeEventListener("keydown",Je,true),document.removeEventListener("keypress",Je,true),document.removeEventListener("keyup",Je,true)));}function mg(e){const{id:t,value:n=null,options:r,placeholder:o="Select...",size:a="md",disabled:i=false,blockGameKeys:s=true,onChange:l,onOpenChange:d}=e,c=x("div",{className:"select",id:t}),u=x("button",{className:"select-trigger",type:"button"}),p=x("span",{className:"select-value"},o),f=x("span",{className:"select-caret"},"▾");u.append(p,f);const g=x("div",{className:"select-menu",role:"listbox",tabindex:"-1","aria-hidden":"true"});c.classList.add(`select--${a}`);let m=false,h=n,b=null,w=!!i;function C(A){return A==null?o:(e.options||r).find(N=>N.value===A)?.label??o}function v(A){p.textContent=C(A),g.querySelectorAll(".select-option").forEach(R=>{const N=R.dataset.value,U=A!=null&&N===A;R.classList.toggle("selected",U),R.setAttribute("aria-selected",String(U));});}function _(A){g.replaceChildren(),A.forEach(R=>{const N=x("button",{className:"select-option"+(R.disabled?" disabled":""),type:"button",role:"option","data-value":R.value,"aria-selected":String(R.value===h),tabindex:"-1"},R.label);R.value===h&&N.classList.add("selected"),R.disabled||N.addEventListener("pointerdown",U=>{U.preventDefault(),U.stopPropagation(),E(R.value,{notify:true}),k();},{capture:true}),g.appendChild(N);});}function y(){u.setAttribute("aria-expanded",String(m)),g.setAttribute("aria-hidden",String(!m));}function S(){const A=u.getBoundingClientRect();Object.assign(g.style,{minWidth:`${A.width}px`});}function T(){m||w||(m=true,c.classList.add("open"),y(),S(),document.addEventListener("mousedown",Y,true),document.addEventListener("scroll",O,true),window.addEventListener("resize",z),g.focus({preventScroll:true}),s&&(fg(),Ko.add(c),b=()=>{Ko.delete(c),gg();}),d?.(true));}function k(){m&&(m=false,c.classList.remove("open"),y(),document.removeEventListener("mousedown",Y,true),document.removeEventListener("scroll",O,true),window.removeEventListener("resize",z),u.focus({preventScroll:true}),b?.(),b=null,d?.(false));}function P(){m?k():T();}function E(A,R={}){const N=h;h=A,v(h),R.notify!==false&&N!==A&&l?.(A);}function B(){return h}function Z(A){const R=Array.from(g.querySelectorAll(".select-option:not(.disabled)"));if(!R.length)return;const N=R.findIndex(xe=>xe.classList.contains("active")),U=R[(N+(A===1?1:R.length-1))%R.length];R.forEach(xe=>xe.classList.remove("active")),U.classList.add("active"),U.focus({preventScroll:true}),U.scrollIntoView({block:"nearest"});}function H(A){(A.key===" "||A.key==="Enter"||A.key==="ArrowDown")&&(A.preventDefault(),T());}function D(A){if(A.key==="Escape"){A.preventDefault(),k();return}if(A.key==="Enter"||A.key===" "){const R=g.querySelector(".select-option.active")||g.querySelector(".select-option.selected");R&&!R.classList.contains("disabled")&&(A.preventDefault(),E(R.dataset.value,{notify:true}),k());return}if(A.key==="ArrowDown"){A.preventDefault(),Z(1);return}if(A.key==="ArrowUp"){A.preventDefault(),Z(-1);return}}function Y(A){c.contains(A.target)||k();}function O(){m&&S();}function z(){m&&S();}function G(A){w=!!A,u.disabled=w,c.classList.toggle("disabled",w),w&&k();}function $(A){e.options=A,_(A),A.some(R=>R.value===h)||(h=null,v(null));}return c.append(u,g),u.addEventListener("pointerdown",A=>{A.preventDefault(),A.stopPropagation(),P();},{capture:true}),u.addEventListener("keydown",H),g.addEventListener("keydown",D),_(r),n!=null?(h=n,v(h)):v(null),y(),G(w),{root:c,open:T,close:k,toggle:P,getValue:B,setValue:E,setOptions:$,setDisabled:G,destroy(){document.removeEventListener("mousedown",Y,true),document.removeEventListener("scroll",O,true),window.removeEventListener("resize",z),b?.(),b=null;}}}function ld(e={}){const{id:t,text:n="",htmlFor:r,tone:o="default",size:a="md",layout:i="inline",variant:s="text",required:l=false,disabled:d=false,tooltip:c,hint:u,icon:p,suffix:f,onClick:g}=e,m=x("div",{className:"lg-label-wrap",id:t}),h=x("label",{className:"lg-label",...r?{htmlFor:r}:{},...c?{title:c}:{}});if(p){const E=typeof p=="string"?x("span",{className:"lg-label-ico"},p):p;E.classList?.add?.("lg-label-ico"),h.appendChild(E);}const b=x("span",{className:"lg-label-text"},n);h.appendChild(b);const w=x("span",{className:"lg-label-req",ariaHidden:"true"}," *");l&&h.appendChild(w);let C=null;if(f!=null){C=typeof f=="string"?document.createTextNode(f):f;const E=x("span",{className:"lg-label-suffix"});E.appendChild(C),h.appendChild(E);}const v=u?x("div",{className:"lg-label-hint"},u):null;m.classList.add(`lg-label--${i}`),m.classList.add(`lg-label--${a}`),s==="title"&&m.classList.add("lg-label--title"),_(o),d&&m.classList.add("is-disabled"),m.appendChild(h),v&&m.appendChild(v),g&&h.addEventListener("click",g);function _(E){m.classList.remove("lg-label--default","lg-label--muted","lg-label--info","lg-label--success","lg-label--warning","lg-label--danger"),m.classList.add(`lg-label--${E}`);}function y(E){b.textContent=E;}function S(E){_(E);}function T(E){E&&!w.isConnected&&h.appendChild(w),!E&&w.isConnected&&w.remove(),E?h.setAttribute("aria-required","true"):h.removeAttribute("aria-required");}function k(E){m.classList.toggle("is-disabled",!!E);}function P(E){!E&&v&&v.isConnected?v.remove():E&&v?v.textContent=E:E&&!v&&m.appendChild(x("div",{className:"lg-label-hint"},E));}return {root:m,labelEl:h,hintEl:v,setText:y,setTone:S,setRequired:T,setDisabled:k,setHint:P}}function Jn(e){return e==null?null:typeof e=="string"?document.createTextNode(e):e}function ro(e,t){const n=document.createElement("span");n.className=`btn-ico btn-ico--${t}`;const r=Jn(e);return r&&n.appendChild(r),n}function hg(){const e="http://www.w3.org/2000/svg",t=document.createElementNS(e,"svg");t.setAttribute("viewBox","0 0 24 24"),t.setAttribute("width","16"),t.setAttribute("height","16"),t.setAttribute("aria-hidden","true"),t.style.marginRight="6px",t.style.display="none",t.style.flexShrink="0";const n=document.createElementNS(e,"circle");n.setAttribute("cx","12"),n.setAttribute("cy","12"),n.setAttribute("r","9"),n.setAttribute("fill","none"),n.setAttribute("stroke","currentColor"),n.setAttribute("stroke-width","3"),n.setAttribute("stroke-linecap","round");const r=document.createElementNS(e,"animate");r.setAttribute("attributeName","stroke-dasharray"),r.setAttribute("values","1,150;90,150;90,150"),r.setAttribute("dur","1.5s"),r.setAttribute("repeatCount","indefinite");const o=document.createElementNS(e,"animateTransform");return o.setAttribute("attributeName","transform"),o.setAttribute("attributeType","XML"),o.setAttribute("type","rotate"),o.setAttribute("from","0 12 12"),o.setAttribute("to","360 12 12"),o.setAttribute("dur","1s"),o.setAttribute("repeatCount","indefinite"),n.appendChild(r),n.appendChild(o),t.appendChild(n),t}function Wt(e={}){const{label:t="",id:n,variant:r="default",size:o="md",iconLeft:a,iconRight:i,loading:s=false,tooltip:l,type:d="button",onClick:c,disabled:u=false,fullWidth:p=false}=e,f=x("button",{className:"btn",id:n});f.type=d,r==="primary"&&f.classList.add("primary"),r==="danger"&&f.classList.add("danger"),o==="sm"&&f.classList.add("btn--sm"),l&&(f.title=l),p&&(f.style.width="100%");const g=hg(),m=a?ro(a,"left"):null,h=i?ro(i,"right"):null,b=document.createElement("span");b.className="btn-label";const w=Jn(t);w&&b.appendChild(w),!w&&(m||h)&&f.classList.add("btn--icon"),f.appendChild(g),m&&f.appendChild(m),f.appendChild(b),h&&f.appendChild(h);const C=u||s;f.disabled=C,f.setAttribute("aria-busy",String(!!s)),g.style.display=s?"inline-block":"none",c&&f.addEventListener("click",c);const v=f;return v.setLoading=_=>{f.setAttribute("aria-busy",String(!!_)),g.style.display=_?"inline-block":"none",f.disabled=_||u;},v.setDisabled=_=>{f.disabled=_||f.getAttribute("aria-busy")==="true";},v.setLabel=_=>{b.replaceChildren();const y=Jn(_);y&&b.appendChild(y),!y&&(m||h)?f.classList.add("btn--icon"):f.classList.remove("btn--icon");},v.setIconLeft=_=>{if(_==null){m?.remove();return}m?m.replaceChildren(Jn(_)):f.insertBefore(ro(_,"left"),b);},v.setIconRight=_=>{if(_==null){h?.remove();return}h?h.replaceChildren(Jn(_)):f.appendChild(ro(_,"right"));},v.setVariant=_=>{f.classList.remove("primary","danger"),_==="primary"&&f.classList.add("primary"),_==="danger"&&f.classList.add("danger");},v}function kr(e={}){const{id:t,checked:n=false,disabled:r=false,size:o="md",label:a,labelSide:i="right",onChange:s}=e,l=x("div",{className:"lg-switch-wrap"}),d=x("button",{className:`lg-switch lg-switch--${o}`,id:t,type:"button",role:"switch","aria-checked":String(!!n),"aria-disabled":String(!!r),title:a??"Basculer"}),c=x("span",{className:"lg-switch-track"}),u=x("span",{className:"lg-switch-thumb"});d.append(c,u);let p=null;a&&i!=="none"&&(p=x("span",{className:"lg-switch-label"},a)),p&&i==="left"?l.append(p,d):p&&i==="right"?l.append(d,p):l.append(d);let f=!!n,g=!!r;function m(){d.classList.toggle("on",f),d.setAttribute("aria-checked",String(f)),d.disabled=g,d.setAttribute("aria-disabled",String(g));}function h(k=false){g||(f=!f,m(),k||s?.(f));}function b(k){k.preventDefault(),h();}function w(k){g||((k.key===" "||k.key==="Enter")&&(k.preventDefault(),h()),k.key==="ArrowLeft"&&(k.preventDefault(),v(false)),k.key==="ArrowRight"&&(k.preventDefault(),v(true)));}d.addEventListener("click",b),d.addEventListener("keydown",w);function C(){return f}function v(k,P=false){f=!!k,m(),P||s?.(f);}function _(k){g=!!k,m();}function y(k){if(!k){p&&(p.remove(),p=null);return}p?p.textContent=k:(p=x("span",{className:"lg-switch-label"},k),l.append(p));}function S(){d.focus();}function T(){d.removeEventListener("click",b),d.removeEventListener("keydown",w);}return m(),{root:l,button:d,isChecked:C,setChecked:v,setDisabled:_,setLabel:y,focus:S,destroy:T}}let cd=null,ls=null;function bg(){return cd}function xg(e){cd=e,ls=null;}function dd(){return ls}function yg(e){ls=e;}function vg(){try{const e=window.visualViewport,t=Math.round((e?.width??window.innerWidth)||0),n=Math.round((e?.height??window.innerHeight)||0);if(t&&n)return t>=n?"landscape":"portrait"}catch{}return "unknown"}function ud(){const e=navigator.userAgent||"",t=navigator.platform||"",n=navigator.userAgentData;if(n&&typeof n.platform=="string"){const o=n.platform.toLowerCase();if(o.includes("windows"))return "windows";if(o.includes("mac"))return "mac";if(o.includes("android"))return "android";if(o.includes("chrome os")||o.includes("cros"))return "chromeos";if(o.includes("linux"))return "linux";if(o.includes("ios"))return "ios"}return /iPhone|iPad|iPod/i.test(e)||t==="MacIntel"&&(navigator.maxTouchPoints??0)>1?"ios":/Android/i.test(e)?"android":/CrOS/i.test(e)?"chromeos":/Win/i.test(e)?"windows":/Mac/i.test(e)?"mac":/Linux/i.test(e)?"linux":"unknown"}function pd(){const e=navigator.userAgent||"",t=navigator.userAgentData;if(t&&Array.isArray(t.brands)){const n=t.brands.map(i=>String(i.brand||i.brandName||i.brandVersion||i)),r=n.some(i=>/Edge/i.test(i)||/Microsoft Edge/i.test(i)),o=n.some(i=>/Opera/i.test(i)||/OPR/i.test(i)),a=n.some(i=>/Chrome|Chromium/i.test(i));if(r)return "Edge";if(o)return "Opera";if(a)return "Chrome";if(navigator.brave)return "Brave"}return /FxiOS/i.test(e)?"Firefox":/CriOS/i.test(e)?"Chrome":/EdgiOS/i.test(e)?"Edge":/OPiOS|OPR|Opera Mini|Opera/i.test(e)?"Opera":/Edg\//i.test(e)?"Edge":/OPR\//i.test(e)||/Opera/i.test(e)?"Opera":/Firefox/i.test(e)?"Firefox":/Safari/i.test(e)&&!/Chrome|Chromium|Edg|OPR/i.test(e)?"Safari":/Brave/i.test(e)||window.Brave||navigator.brave?"Brave":/Chrome|Chromium/i.test(e)?"Chrome":"Unknown"}function wg(){const e=bg();if(e)return e;const t=navigator.userAgent||"",n=navigator.userAgentData;return n&&typeof n.mobile=="boolean"?n.mobile?"mobile":"desktop":/Android|iPhone|iPad|iPod|Mobile/i.test(t)?"mobile":"desktop"}function Sg(e){if(!e)return null;try{return new URL(e).hostname}catch{return null}}function fd(){try{return window.top!==window.self}catch{return  true}}function Cg(){const e=fd(),t=Sg(document.referrer);return e&&!!t&&/(^|\.)discord(app)?\.com$/i.test(t)?"discord":"web"}function ua(){const e=dd();if(e)return e;const t=Cg(),n=wg(),r=ud(),o=pd(),a=fd(),i=window.screen||{},s=window.visualViewport,l=Math.round(window.innerWidth||document.documentElement.clientWidth||0),d=Math.round(window.innerHeight||document.documentElement.clientHeight||0),c=Math.round(s?.width??l),u=Math.round(s?.height??d),p=Math.round(i.width||0),f=Math.round(i.height||0),g=Math.round(i.availWidth||p),m=Math.round(i.availHeight||f),h=Number.isFinite(window.devicePixelRatio)?window.devicePixelRatio:1,b={surface:t,host:location.hostname,origin:location.origin,isInIframe:a,platform:n,browser:o,os:r,viewportWidth:l,viewportHeight:d,visualViewportWidth:c,visualViewportHeight:u,screenWidth:p,screenHeight:f,availScreenWidth:g,availScreenHeight:m,dpr:h,orientation:vg()};return yg(b),b}function kg(){return ua().surface==="discord"}function _g(){return ua().platform==="mobile"}function Tg(){ua();}function Pg(){return dd()!==null}const Ve={init:Tg,isReady:Pg,detect:ua,isDiscord:kg,isMobile:_g,detectOS:ud,detectBrowser:pd,setPlatformOverride:xg};let Yo=false;const Qn=new Set;function Ig(e=document){let t=e.activeElement||null;for(;t&&t.shadowRoot&&t.shadowRoot.activeElement;)t=t.shadowRoot.activeElement;return t}const Qe=e=>{const t=Ig();if(t){for(const n of Qn)if(t===n||n.contains(t)){e.stopImmediatePropagation(),e.stopPropagation();return}}};function Ag(){Yo||(Yo=true,window.addEventListener("keydown",Qe,true),window.addEventListener("keypress",Qe,true),window.addEventListener("keyup",Qe,true),document.addEventListener("keydown",Qe,true),document.addEventListener("keypress",Qe,true),document.addEventListener("keyup",Qe,true));}function Eg(){Yo&&(Yo=false,window.removeEventListener("keydown",Qe,true),window.removeEventListener("keypress",Qe,true),window.removeEventListener("keyup",Qe,true),document.removeEventListener("keydown",Qe,true),document.removeEventListener("keypress",Qe,true),document.removeEventListener("keyup",Qe,true));}function Mg(e){return Qn.size===0&&Ag(),Qn.add(e),()=>{Qn.delete(e),Qn.size===0&&Eg();}}function Rg(e,t,n,r){let o;switch(e){case "digits":o="0-9";break;case "alpha":o="\\p{L}";break;case "alphanumeric":o="\\p{L}0-9";break;default:return null}return t&&(o+=" "),n&&(o+="\\-"),r&&(o+="_"),new RegExp(`[^${o}]`,"gu")}function Lg(e,t){return t?e.replace(t,""):e}function Fg(e,t=0){if(!t)return e;let n;return((...r)=>{clearTimeout(n),n=setTimeout(()=>e(...r),t);})}function gd(e={}){const{id:t,placeholder:n="",value:r="",mode:o="any",allowSpaces:a=false,allowDashes:i=false,allowUnderscore:s=false,maxLength:l,blockGameKeys:d=true,debounceMs:c=0,onChange:u,onEnter:p,label:f}=e,g=x("div",{className:"lg-input-wrap"}),m=x("input",{className:"input",id:t,placeholder:n});if(typeof l=="number"&&l>0&&(m.maxLength=l),r&&(m.value=r),f){const E=x("div",{className:"lg-input-label"},f);g.appendChild(E);}g.appendChild(m);const h=Rg(o,a,i,s),b=()=>{const E=m.selectionStart??m.value.length,B=m.value.length,Z=Lg(m.value,h);if(Z!==m.value){m.value=Z;const H=B-Z.length,D=Math.max(0,E-H);m.setSelectionRange(D,D);}},w=Fg(()=>u?.(m.value),c);m.addEventListener("input",()=>{b(),w();}),m.addEventListener("paste",()=>queueMicrotask(()=>{b(),w();})),m.addEventListener("keydown",E=>{E.key==="Enter"&&p?.(m.value);});const C=d?Mg(m):()=>{};function v(){return m.value}function _(E){m.value=E??"",b(),w();}function y(){m.focus();}function S(){m.blur();}function T(E){m.disabled=!!E;}function k(){return document.activeElement===m}function P(){C();}return {root:g,input:m,getValue:v,setValue:_,focus:y,blur:S,setDisabled:T,isFocused:k,destroy:P}}function Ie(e,t,n){return Math.min(n,Math.max(t,e))}function ur({h:e,s:t,v:n,a:r}){const o=(e%360+360)%360/60,a=n*t,i=a*(1-Math.abs(o%2-1));let s=0,l=0,d=0;switch(Math.floor(o)){case 0:s=a,l=i;break;case 1:s=i,l=a;break;case 2:l=a,d=i;break;case 3:l=i,d=a;break;case 4:s=i,d=a;break;default:s=a,d=i;break}const u=n-a,p=Math.round((s+u)*255),f=Math.round((l+u)*255),g=Math.round((d+u)*255);return {r:Ie(p,0,255),g:Ie(f,0,255),b:Ie(g,0,255),a:Ie(r,0,1)}}function md({r:e,g:t,b:n,a:r}){const o=Ie(e,0,255)/255,a=Ie(t,0,255)/255,i=Ie(n,0,255)/255,s=Math.max(o,a,i),l=Math.min(o,a,i),d=s-l;let c=0;d!==0&&(s===o?c=60*((a-i)/d%6):s===a?c=60*((i-o)/d+2):c=60*((o-a)/d+4)),c<0&&(c+=360);const u=s===0?0:d/s;return {h:c,s:u,v:s,a:Ie(r,0,1)}}function cs({r:e,g:t,b:n}){const r=o=>Ie(Math.round(o),0,255).toString(16).padStart(2,"0");return `#${r(e)}${r(t)}${r(n)}`.toUpperCase()}function Ng({r:e,g:t,b:n,a:r}){const o=Ie(Math.round(r*255),0,255);return `${cs({r:e,g:t,b:n})}${o.toString(16).padStart(2,"0")}`.toUpperCase()}function Zn({r:e,g:t,b:n,a:r}){const o=Math.round(r*1e3)/1e3;return `rgba(${e}, ${t}, ${n}, ${o})`}function mn(e){let t=e.trim();if(!t||(t.startsWith("#")&&(t=t.slice(1)),![3,4,6,8].includes(t.length))||!/^[0-9a-fA-F]+$/.test(t))return null;(t.length===3||t.length===4)&&(t=t.split("").map(i=>i+i).join(""));let n=255;t.length===8&&(n=parseInt(t.slice(6,8),16),t=t.slice(0,6));const r=parseInt(t.slice(0,2),16),o=parseInt(t.slice(2,4),16),a=parseInt(t.slice(4,6),16);return {r,g:o,b:a,a:n/255}}function yi(e){if(!e)return null;const t=e.trim();if(t.startsWith("#"))return mn(t);const n=t.match(/^rgba?\(([^)]+)\)$/i);if(n){const r=n[1].split(",").map(l=>l.trim());if(r.length<3)return null;const o=Number(r[0]),a=Number(r[1]),i=Number(r[2]),s=r[3]!=null?Number(r[3]):1;return [o,a,i,s].some(l=>Number.isNaN(l))?null:{r:o,g:a,b:i,a:s}}return null}function Og(e,t){const n=yi(e)??mn(e??"")??{r:244,g:67,b:54,a:1};return typeof t=="number"&&(n.a=Ie(t,0,1)),md(n)}function $g(e){return `#${e.trim().replace(/[^0-9a-fA-F#]/g,"").replace(/#/g,"")}`.slice(0,9).toUpperCase()}function Bg(e){let t=e.trim();return t&&(/^rgba?\s*\(/i.test(t)?t=t.replace(/^rgba?/i,"rgba"):(t=t.replace(/^\(?(.*)\)?$/,"$1"),t=`rgba(${t})`),t=t.replace(/\s*\(\s*/,"("),t=t.replace(/\s*\)\s*$/,")"),t=t.replace(/\s*,\s*/g,", "),t)}function $t(e){const t=ur(e),n=ur({...e,a:1});return {hsva:{...e},hex:cs(n),hexa:Ng(t),rgba:Zn(t),alpha:e.a}}function Dg(e={}){const{id:t,label:n="Color",value:r,alpha:o,defaultExpanded:a=false,detectMobile:i,onInput:s,onChange:l}=e,c=i?i():Ve.detect().platform==="mobile";let u=Og(r,o);const p=We({id:t,className:"color-picker",title:n,padding:c?"md":"lg",variant:"soft",expandable:!c,defaultExpanded:!c&&a});p.classList.add(c?"color-picker--mobile":"color-picker--desktop");const f=p.querySelector(".card-header");f&&f.classList.add("color-picker__header");const g=f?.querySelector(".card-title"),m=x("button",{className:"color-picker__preview",type:"button",title:`Preview ${n}`,"aria-label":`Change ${n}`});g?g.prepend(m):f?f.prepend(m):p.prepend(m);const h=p.querySelector(".card-toggle");!c&&h&&m.addEventListener("click",()=>{p.classList.contains("card--collapsed")&&h.click();});const b=p.querySelector(".card-collapse");let w=null,C=null,v=null,_=null,y=null,S=null,T=null,k=null,P=null,E="hex";function B(O){const z=$t(u);O==="input"?s?.(z):l?.(z);}function Z(){const O=$t(u);if(m.style.setProperty("--cp-preview-color",O.rgba),m.setAttribute("aria-label",`${n}: ${O.hexa}`),!c&&w&&C&&v&&_&&y&&S&&T){const z=ur({...u,s:1,v:1,a:1}),G=Zn(z);w.style.setProperty("--cp-palette-hue",G),C.style.left=`${u.s*100}%`,C.style.top=`${(1-u.v)*100}%`,v.style.setProperty("--cp-alpha-gradient",`linear-gradient(180deg, ${Zn({...z,a:1})} 0%, ${Zn({...z,a:0})} 100%)`),_.style.top=`${(1-u.a)*100}%`,y.style.setProperty("--cp-hue-color",Zn(ur({...u,v:1,s:1,a:1}))),S.style.left=`${u.h/360*100}%`;const $=u.a===1?O.hex:O.hexa,A=O.rgba,R=E==="hex"?$:A;T!==document.activeElement&&(T.value=R),T.setAttribute("aria-label",`${E.toUpperCase()} code for ${n}`),T.placeholder=E==="hex"?"#RRGGBB or #RRGGBBAA":"rgba(0, 0, 0, 1)",E==="hex"?T.maxLength=9:T.removeAttribute("maxLength"),T.dataset.mode=E,k&&(k.textContent=E.toUpperCase(),k.setAttribute("aria-label",E==="hex"?"Passer en saisie RGBA":"Revenir en saisie HEX"),k.setAttribute("aria-pressed",E==="rgba"?"true":"false"),k.classList.toggle("is-alt",E==="rgba"));}P&&P!==document.activeElement&&(P.value=O.hex);}function H(O,z=null){u={h:(O.h%360+360)%360,s:Ie(O.s,0,1),v:Ie(O.v,0,1),a:Ie(O.a,0,1)},Z(),z&&B(z);}function D(O,z=null){H(md(O),z);}function Y(O,z,G){O.addEventListener("pointerdown",$=>{$.preventDefault();const A=$.pointerId,R=U=>{U.pointerId===A&&z(U);},N=U=>{U.pointerId===A&&(document.removeEventListener("pointermove",R),document.removeEventListener("pointerup",N),document.removeEventListener("pointercancel",N),G?.(U));};z($),document.addEventListener("pointermove",R),document.addEventListener("pointerup",N),document.addEventListener("pointercancel",N);});}if(!c&&b){const O=b.querySelector(".card-body");if(O){O.classList.add("color-picker__body"),C=x("div",{className:"color-picker__palette-cursor"}),w=x("div",{className:"color-picker__palette"},C),_=x("div",{className:"color-picker__alpha-thumb"}),v=x("div",{className:"color-picker__alpha"},_),S=x("div",{className:"color-picker__hue-thumb"}),y=x("div",{className:"color-picker__hue"},S);const z=x("div",{className:"color-picker__main"},w,v),G=x("div",{className:"color-picker__hue-row"},y),$=gd({blockGameKeys:true});T=$.input,T.classList.add("color-picker__hex-input"),T.value="",T.maxLength=9,T.spellcheck=false,T.inputMode="text",T.setAttribute("aria-label",`Hex code for ${n}`),k=x("button",{type:"button",className:"color-picker__mode-btn",textContent:"HEX","aria-pressed":"false","aria-label":"Passer en saisie RGBA"}),$.root.classList.add("color-picker__hex-wrap");const A=x("div",{className:"color-picker__hex-row"},k,$.root);O.replaceChildren(z,G,A),Y(w,N=>{if(!w||!C)return;const U=w.getBoundingClientRect(),xe=Ie((N.clientX-U.left)/U.width,0,1),J=Ie((N.clientY-U.top)/U.height,0,1);H({...u,s:xe,v:1-J},"input");},()=>B("change")),Y(v,N=>{if(!v)return;const U=v.getBoundingClientRect(),xe=Ie((N.clientY-U.top)/U.height,0,1);H({...u,a:1-xe},"input");},()=>B("change")),Y(y,N=>{if(!y)return;const U=y.getBoundingClientRect(),xe=Ie((N.clientX-U.left)/U.width,0,1);H({...u,h:xe*360},"input");},()=>B("change")),k.addEventListener("click",()=>{if(E=E==="hex"?"rgba":"hex",T){const N=$t(u);T.value=E==="hex"?u.a===1?N.hex:N.hexa:N.rgba;}Z(),T?.focus(),T?.select();}),T.addEventListener("input",()=>{if(E==="hex"){const N=$g(T.value);if(N!==T.value){const U=T.selectionStart??N.length;T.value=N,T.setSelectionRange(U,U);}}});const R=()=>{const N=T.value;if(E==="hex"){const U=mn(N);if(!U){T.value=u.a===1?$t(u).hex:$t(u).hexa;return}const xe=N.startsWith("#")?N.slice(1):N,J=xe.length===4||xe.length===8;U.a=J?U.a:u.a,D(U,"change");}else {const U=Bg(N),xe=yi(U);if(!xe){T.value=$t(u).rgba;return}D(xe,"change");}};T.addEventListener("change",R),T.addEventListener("blur",R),T.addEventListener("keydown",N=>{N.key==="Enter"&&(R(),T.blur());});}}return c&&(b&&b.remove(),P=x("input",{className:"color-picker__native",type:"color",value:cs(ur({...u,a:1}))}),m.addEventListener("click",()=>P.click()),P.addEventListener("input",()=>{const O=mn(P.value);O&&(O.a=u.a,D(O,"input"),B("change"));}),p.appendChild(P)),Z(),{root:p,isMobile:c,getValue:()=>$t(u),setValue:(O,z)=>{const G=yi(O)??mn(O)??mn("#FFFFFF");G&&(typeof z=="number"&&(G.a=z),D(G,null));}}}const Gg=window;function zg(){if(typeof unsafeWindow<"u"&&unsafeWindow)return unsafeWindow;const e=window.wrappedJSObject;return e&&e!==window?e:Gg}const Hg=zg(),F=Hg;function jg(e){try{return !!e.isSecureContext}catch{return  false}}function ds(e){const t=e?.getRootNode?.();return t&&(t instanceof Document||t.host)?t:document}function hd(){const e=navigator.platform||"",t=navigator.userAgent||"";return /Mac|iPhone|iPad|iPod/i.test(e)||/Mac OS|iOS/i.test(t)}async function Ug(){try{const e=await navigator.permissions?.query?.({name:"clipboard-write"});return e?e.state==="granted"||e.state==="prompt":!0}catch{return  true}}function Wg(e,t){const n=document.createElement("textarea");return n.value=e,n.setAttribute("readonly","true"),n.style.position="fixed",n.style.opacity="0",n.style.pointerEvents="none",n.style.top="0",t.appendChild?t.appendChild(n):document.body.appendChild(n),n}function Vg(e){try{const t=window.getSelection?.();if(!t)return !1;const n=document.createRange();return n.selectNodeContents(e),t.removeAllRanges(),t.addRange(n),!0}catch{return  false}}async function Xg(e){if(!("clipboard"in navigator))return {ok:false,method:"clipboard-write"};if(!jg(F))return {ok:false,method:"clipboard-write"};if(!await Ug())return {ok:false,method:"clipboard-write"};try{return await navigator.clipboard.writeText(e),{ok:!0,method:"clipboard-write"}}catch{return {ok:false,method:"clipboard-write"}}}function qg(e,t){try{const n=t||ds(),r=Wg(e,n);r.focus(),r.select(),r.setSelectionRange(0,r.value.length);let o=!1;try{o=document.execCommand("copy");}catch{o=!1;}return r.remove(),{ok:o,method:"execCommand"}}catch{return {ok:false,method:"execCommand"}}}function Kg(e,t){if(!t)return {ok:false,method:"selection"};const n=t.textContent??"";let r=false;if(n!==e)try{t.textContent=e,r=!0;}catch{}const o=Vg(t);r&&setTimeout(()=>{try{t.textContent=n;}catch{}},80);const a=hd()?"⌘C pour copier":"Ctrl+C pour copier";return {ok:o,method:"selection",hint:a}}async function Yg(e,t={}){const n=(e??"").toString();if(!n.length)return {ok:false,method:"noop"};const r=await Xg(n);if(r.ok)return r;const o=t.injectionRoot||ds(t.valueNode||void 0),a=qg(n,o);if(a.ok)return a;const i=Kg(n,t.valueNode||null);if(i.ok)return i;if(!t.disablePromptFallback)try{return window.prompt(Ve.isDiscord()?"Copie manuelle (Discord bloque clipboard):":"Copie manuelle:",n),{ok:!0,method:"prompt"}}catch{}return {ok:false,method:"noop"}}function Jg(e,t,n={}){const r=o=>{if(n.showTip){n.showTip(o);return}try{e.setAttribute("aria-label",o);const a=document.createElement("div");a.textContent=o,a.style.position="absolute",a.style.top="-28px",a.style.right="0",a.style.padding="4px 8px",a.style.borderRadius="8px",a.style.fontSize="12px",a.style.background="color-mix(in oklab, var(--bg) 85%, transparent)",a.style.border="1px solid var(--border)",a.style.color="var(--fg)",a.style.pointerEvents="none",a.style.opacity="0",a.style.transition="opacity .12s";const i=ds(e);i.appendChild?i.appendChild(a):document.body.appendChild(a);const s=e.getBoundingClientRect();a.style.left=`${s.right-8}px`,a.style.top=`${s.top-28}px`,requestAnimationFrame(()=>a.style.opacity="1"),setTimeout(()=>{a.style.opacity="0",setTimeout(()=>a.remove(),150);},1200);}catch{}};e.addEventListener("click",async o=>{o.stopPropagation();const a=(t()??"").toString(),i=await Yg(a,{valueNode:n.valueNode??null,injectionRoot:n.injectionRoot??null,disablePromptFallback:n.disablePromptFallback??false});n.onResult?.(i),i.ok?i.method==="clipboard-write"||i.method==="execCommand"||i.method==="prompt"?r("Copié"):i.method==="selection"&&r(i.hint||(hd()?"⌘C pour copier":"Ctrl+C pour copier")):r("Impossible de copier");});}const pr={light:{"--bg":"rgba(255,255,255,0.7)","--fg":"#0f172a","--muted":"rgba(15,23,42,0.06)","--soft":"rgba(15,23,42,0.04)","--accent":"#2563eb","--border":"rgba(15,23,42,0.12)","--shadow":"rgba(2,6,23,.2)","--paper":"#FDFBF7","--tab-bg":"#ffffff","--tab-fg":"#0f172a","--pill-from":"#4f46e5","--pill-to":"#06b6d4","--low":"#dc2626","--medium":"#f59e0b","--high":"#16a34a","--complete":"#15803d","--info":"#2563eb","--xp-fill":"#0febff","--accent-1":"#16a34a","--accent-2":"#7c3aed","--mut-rainbow":"#FF00FF","--mut-gold":"#EBC800","--mut-wet":"#5FFFFF","--mut-chilled":"#B4E6FF","--mut-frozen":"#B9C8FF","--mut-dawnlit":"#F59BE1","--mut-dawncharged":"#C896FF","--mut-ambershine":"#FFB478","--mut-ambercharged":"#FA8C4B","--rarity-common":"#E7E7E7","--rarity-uncommon":"#67BD4D","--rarity-rare":"#0071C6","--rarity-legendary":"#FFC734","--rarity-mythical":"#9944A7","--rarity-divine":"#FF7835","--rarity-celestial":"#FF00FF","--rainbow-text-gradient":"linear-gradient(90deg, #b000b0, #d00000, #b08000, #008000, #0000b0, #4b0082, #9400d3)","--switch-thumb":"#ffffff","--journal-ink":"#333333"},dark:{"--bg":"rgba(10,12,18,0.6)","--fg":"#e5e7eb","--muted":"rgba(229,231,235,0.08)","--soft":"rgba(229,231,235,0.05)","--accent":"#60a5fa","--border":"rgba(148,163,184,0.2)","--shadow":"rgba(0,0,0,.45)","--paper":"#1a1d24","--tab-bg":"rgba(255,255,255,0.08)","--tab-fg":"#e5e7eb","--pill-from":"#6366f1","--pill-to":"#06b6d4","--low":"#ef4444","--medium":"#f59e0b","--high":"#22c55e","--complete":"#16a34a","--info":"#3b82f6","--xp-fill":"#0febff","--accent-1":"#22c55e","--accent-2":"#a855f7","--mut-rainbow":"#FF00FF","--mut-gold":"#EBC800","--mut-wet":"#5FFFFF","--mut-chilled":"#B4E6FF","--mut-frozen":"#B9C8FF","--mut-dawnlit":"#F59BE1","--mut-dawncharged":"#C896FF","--mut-ambershine":"#FFB478","--mut-ambercharged":"#FA8C4B","--rarity-common":"#E7E7E7","--rarity-uncommon":"#67BD4D","--rarity-rare":"#0071C6","--rarity-legendary":"#FFC734","--rarity-mythical":"#9944A7","--rarity-divine":"#FF7835","--rarity-celestial":"#FF00FF","--rainbow-text-gradient":"linear-gradient(90deg, #ff0000, #ff7f00, #ffff00, #00ff00, #00ffff, #ff00ff)","--switch-thumb":"#ffffff","--journal-ink":"#ffffff"},sepia:{"--bg":"rgba(247,242,231,0.72)","--fg":"#3b2f2f","--muted":"rgba(59,47,47,0.06)","--soft":"rgba(59,47,47,0.04)","--accent":"#b07d62","--border":"rgba(59,47,47,0.14)","--shadow":"rgba(0,0,0,.18)","--paper":"#F5E6D3","--tab-bg":"#fff","--tab-fg":"#3b2f2f","--pill-from":"#b07d62","--pill-to":"#d4a373","--low":"#c2410c","--medium":"#d97706","--high":"#15803d","--complete":"#166534","--info":"#1d4ed8","--accent-1":"#15803d","--accent-2":"#6b21a8","--mut-rainbow":"#FF00FF","--mut-gold":"#EBC800","--mut-wet":"#5FFFFF","--mut-chilled":"#B4E6FF","--mut-frozen":"#B9C8FF","--mut-dawnlit":"#F59BE1","--mut-dawncharged":"#C896FF","--mut-ambershine":"#FFB478","--mut-ambercharged":"#FA8C4B","--rarity-common":"#E7E7E7","--rarity-uncommon":"#67BD4D","--rarity-rare":"#0071C6","--rarity-legendary":"#FFC734","--rarity-mythical":"#9944A7","--rarity-divine":"#FF7835","--rarity-celestial":"#FF00FF","--rainbow-text-gradient":"linear-gradient(90deg, #b000b0, #d00000, #b08000, #008000, #0000b0, #4b0082, #9400d3)","--switch-thumb":"#ffffff","--journal-ink":"#3b2f2f"},forest:{"--bg":"rgba(14,24,18,0.62)","--fg":"#e7f5e9","--muted":"rgba(231,245,233,0.08)","--soft":"rgba(231,245,233,0.05)","--accent":"#34d399","--border":"rgba(231,245,233,0.16)","--shadow":"rgba(0,0,0,.5)","--paper":"#1e2820","--tab-bg":"rgba(255,255,255,0.06)","--tab-fg":"#e7f5e9","--pill-from":"#10b981","--pill-to":"#84cc16","--low":"#dc2626","--medium":"#eab308","--high":"#22c55e","--complete":"#16a34a","--info":"#06b6d4","--accent-1":"#22c55e","--accent-2":"#8b5cf6","--mut-rainbow":"#FF00FF","--mut-gold":"#EBC800","--mut-wet":"#5FFFFF","--mut-chilled":"#B4E6FF","--mut-frozen":"#B9C8FF","--mut-dawnlit":"#F59BE1","--mut-dawncharged":"#C896FF","--mut-ambershine":"#FFB478","--mut-ambercharged":"#FA8C4B","--rarity-common":"#E7E7E7","--rarity-uncommon":"#67BD4D","--rarity-rare":"#0071C6","--rarity-legendary":"#FFC734","--rarity-mythical":"#9944A7","--rarity-divine":"#FF7835","--rarity-celestial":"#FF00FF","--rainbow-text-gradient":"linear-gradient(90deg, #ff0000, #ff7f00, #ffff00, #00ff00, #00ffff, #ff00ff)","--switch-thumb":"#ffffff","--journal-ink":"#ffffff"},violet:{"--bg":"rgba(23, 16, 42, 0.68)","--fg":"#f5f3ff","--muted":"rgba(245,243,255,0.08)","--soft":"rgba(245,243,255,0.05)","--accent":"#a855f7","--border":"rgba(216,180,254,0.22)","--shadow":"rgba(12,3,30,.55)","--paper":"#1a1424","--tab-bg":"rgba(255,255,255,0.08)","--tab-fg":"#ede9fe","--pill-from":"#a855f7","--pill-to":"#f472b6","--low":"#f43f5e","--medium":"#fbbf24","--high":"#4ade80","--complete":"#22c55e","--info":"#60a5fa","--accent-1":"#4ade80","--accent-2":"#c084fc","--mut-rainbow":"#FF00FF","--mut-gold":"#EBC800","--mut-wet":"#5FFFFF","--mut-chilled":"#B4E6FF","--mut-frozen":"#B9C8FF","--mut-dawnlit":"#F59BE1","--mut-dawncharged":"#C896FF","--mut-ambershine":"#FFB478","--mut-ambercharged":"#FA8C4B","--rarity-common":"#E7E7E7","--rarity-uncommon":"#67BD4D","--rarity-rare":"#0071C6","--rarity-legendary":"#FFC734","--rarity-mythical":"#9944A7","--rarity-divine":"#FF7835","--rarity-celestial":"#FF00FF","--rainbow-text-gradient":"linear-gradient(90deg, #ff0000, #ff7f00, #ffff00, #00ff00, #00ffff, #ff00ff)","--switch-thumb":"#ffffff","--journal-ink":"#ffffff"},ocean:{"--bg":"rgba(10, 34, 46, 0.66)","--fg":"#e0f7ff","--muted":"rgba(224,247,255,0.07)","--soft":"rgba(224,247,255,0.05)","--accent":"#38bdf8","--border":"rgba(125, 211, 252, 0.22)","--shadow":"rgba(0, 16, 32, .52)","--paper":"#0f2027","--tab-bg":"rgba(56,189,248,0.14)","--tab-fg":"#e0f7ff","--pill-from":"#0ea5e9","--pill-to":"#14b8a6","--low":"#f43f5e","--medium":"#fbbf24","--high":"#34d399","--complete":"#10b981","--info":"#38bdf8","--accent-1":"#22c55e","--accent-2":"#a78bfa","--mut-rainbow":"#FF00FF","--mut-gold":"#EBC800","--mut-wet":"#5FFFFF","--mut-chilled":"#B4E6FF","--mut-frozen":"#B9C8FF","--mut-dawnlit":"#F59BE1","--mut-dawncharged":"#C896FF","--mut-ambershine":"#FFB478","--mut-ambercharged":"#FA8C4B","--rarity-common":"#E7E7E7","--rarity-uncommon":"#67BD4D","--rarity-rare":"#0071C6","--rarity-legendary":"#FFC734","--rarity-mythical":"#9944A7","--rarity-divine":"#FF7835","--rarity-celestial":"#FF00FF","--rainbow-text-gradient":"linear-gradient(90deg, #ff0000, #ff7f00, #ffff00, #00ff00, #00ffff, #ff00ff)","--switch-thumb":"#ffffff","--journal-ink":"#ffffff"},ember:{"--bg":"rgba(34,18,10,0.64)","--fg":"#fff7ed","--muted":"rgba(255,247,237,0.08)","--soft":"rgba(255,247,237,0.05)","--accent":"#f97316","--border":"rgba(255, 159, 92, 0.24)","--shadow":"rgba(16,6,2,.52)","--paper":"#1a1210","--tab-bg":"rgba(255,247,237,0.09)","--tab-fg":"#fff7ed","--pill-from":"#fb923c","--pill-to":"#facc15","--low":"#dc2626","--medium":"#f59e0b","--high":"#22c55e","--complete":"#16a34a","--info":"#38bdf8","--accent-1":"#22c55e","--accent-2":"#c084fc","--mut-rainbow":"#FF00FF","--mut-gold":"#EBC800","--mut-wet":"#5FFFFF","--mut-chilled":"#B4E6FF","--mut-frozen":"#B9C8FF","--mut-dawnlit":"#F59BE1","--mut-dawncharged":"#C896FF","--mut-ambershine":"#FFB478","--mut-ambercharged":"#FA8C4B","--rarity-common":"#E7E7E7","--rarity-uncommon":"#67BD4D","--rarity-rare":"#0071C6","--rarity-legendary":"#FFC734","--rarity-mythical":"#9944A7","--rarity-divine":"#FF7835","--rarity-celestial":"#FF00FF","--rainbow-text-gradient":"linear-gradient(90deg, #ff0000, #ff7f00, #ffff00, #00ff00, #00ffff, #ff00ff)","--switch-thumb":"#ffffff","--journal-ink":"#ffffff"},magicGarden:{"--bg":"#201D1D","--fg":"#F5F5F5","--muted":"rgba(255,255,255,0.6)","--soft":"rgba(0,0,0,0.3)","--accent":"#FFF27D","--border":"rgba(255,255,255,0.1)","--border-accent":"#4A3B2E","--shadow":"rgba(0,0,0,0.5)","--paper":"#FDFBF7","--card-shadow":"0 4px 10px rgba(0, 0, 0, 0.5)","--tab-bg":"#10725A","--tab-fg":"#F5F5F5","--section-title":"#10725A","--group-title":"#5EB292","--item-label":"#F5F5F5","--item-desc":"rgba(255,255,255,0.6)","--item-value":"#FFF27D","--card-bg":"rgba(0,0,0,0.3)","--card-radius":"12px","--card-border":"#4A3B2E","--pill-from":"#FFF27D","--pill-to":"#5EB292","--scrollbar-thumb":"rgba(255,255,255,0.2)","--scrollbar-thumb-hover":"rgba(255,255,255,0.3)","--low":"#F98B4B","--medium":"#F3D32B","--high":"#5EAC46","--complete":"#0B893F","--info":"#38bdf8","--accent-1":"#4caf50","--accent-2":"#9c27b0","--mut-rainbow":"#FF00FF","--mut-gold":"#EBC800","--mut-wet":"#5FFFFF","--mut-chilled":"#B4E6FF","--mut-frozen":"#B9C8FF","--mut-dawnlit":"#F59BE1","--mut-dawncharged":"#C896FF","--mut-ambershine":"#FFB478","--mut-ambercharged":"#FA8C4B","--rarity-common":"#E7E7E7","--rarity-uncommon":"#67BD4D","--rarity-rare":"#0071C6","--rarity-legendary":"#FFC734","--rarity-mythical":"#9944A7","--rarity-divine":"#FF7835","--rarity-celestial":"#FF00FF","--rainbow-text-gradient":"linear-gradient(90deg, #ff0000, #ff7f00, #ffff00, #00ff00, #00ffff, #ff00ff)","--switch-thumb":"#ffffff","--journal-ink":"#000000"}};function Qg(e){const{host:t,themes:n,initialTheme:r,onThemeChange:o}=e;let a=r,i=null,s=false;function l(c){const u=n[c]||n[a]||{};t.setAttribute("data-theme",c),s&&t.classList.add("theme-anim");for(const[p,f]of Object.entries(u))t.style.setProperty(p,f);s?(i!==null&&clearTimeout(i),i=F.setTimeout(()=>{t.classList.remove("theme-anim"),i=null;},320)):s=true,a=c,o?.(c);}function d(){return a}return l(r),{applyTheme:l,getCurrentTheme:d}}const vi={ui:{expandedCards:{style:false,hudSections:false,enhancements:false,system:false}}};async function Zg(){const e=await Dr("tab-settings",{version:1,defaults:vi,sanitize:o=>({ui:{expandedCards:Al(vi.ui.expandedCards,o.ui?.expandedCards)}})});function t(o){const a=e.get();e.update({ui:{...a.ui,...o,expandedCards:Al(a.ui.expandedCards,o.expandedCards)}});}function n(o,a){const i=e.get();e.update({ui:{...i.ui,expandedCards:{...i.ui.expandedCards,[o]:!!a}}});}function r(o){const a=e.get();n(o,!a.ui.expandedCards[o]);}return {get:e.get,set:e.set,save:e.save,setUI:t,setCardExpanded:n,toggleCard:r}}class em{constructor(){L(this,"injections",new Map);L(this,"state",{});L(this,"initialized",false);}register(t){if(this.injections.has(t.id)){console.warn(`[InjectionRegistry] ${t.id} already registered`);return}this.injections.set(t.id,t),this.loadState(t.id),console.log(`[InjectionRegistry] Registered: ${t.name}`);}initAll(){if(!this.initialized){for(const[t,n]of this.injections)if(this.state[t]??n.defaultEnabled??false)try{n.injection.init();}catch(o){console.error(`[InjectionRegistry] Failed to init ${t}:`,o);}this.initialized=true,console.log("[InjectionRegistry] All injections initialized");}}destroyAll(){for(const[,t]of this.injections)try{t.injection.destroy();}catch(n){console.error(`[InjectionRegistry] Failed to destroy ${t.id}:`,n);}this.initialized=false,console.log("[InjectionRegistry] All injections destroyed");}setEnabled(t,n){const r=this.injections.get(t);if(!r){console.warn(`[InjectionRegistry] Unknown injection: ${t}`);return}this.state[t]=n,this.saveState(t),n?r.injection.init():r.injection.destroy(),console.log(`[InjectionRegistry] ${r.name} ${n?"enabled":"disabled"}`);}getAll(){return Array.from(this.injections.values())}isEnabled(t){return this.state[t]??false}loadState(t){const n=this.injections.get(t);if(!n)return;const r=ve(n.storageKey,n.defaultEnabled??false);this.state[t]=r;}saveState(t){const n=this.injections.get(t);n&&Pe(n.storageKey,this.state[t]);}}let Ga=null;function bd(){return Ga||(Ga=new em),Ga}function xd(e){return e.replace(/[_-]+/g," ").replace(/^\w/,t=>t.toUpperCase())}function tm(){return Object.keys(pr).map(e=>({value:e,label:xd(e)}))}const nm=["--bg","--fg","--accent","--muted","--soft","--border","--shadow","--paper","--tab-bg","--tab-fg","--pill-from","--pill-to","--low","--medium","--high","--complete","--info","--accent-1","--accent-2","--accent-3"];function rm(e){return xd(e.replace(/^--/,""))}function om(e){return e.alpha<1?e.rgba:e.hex}const Pt={pets:{enabled:true},journalChecker:{enabled:true},autoFavorite:{enabled:true},bulkFavorite:{enabled:false},cropSizeIndicator:{enabled:false},eggProbabilityIndicator:{enabled:false},cropValueIndicator:{enabled:true}};class am extends nn{constructor(n){super({id:"tab-settings",label:"Settings"});L(this,"featureConfig",Pt);this.deps=n;}async build(n){const r=this.createGrid("12px");r.id="settings",n.appendChild(r);let o;try{o=await Zg();}catch{o={get:()=>vi,set:()=>{},save:()=>{},setUI:()=>{},setCardExpanded:()=>{},toggleCard:()=>{}};}const a=o.get(),i=ve(we.CONFIG,{});this.featureConfig=this.mergeFeatureConfig(i);const s=Object.keys(pr),l=this.deps.getCurrentTheme?.()??this.deps.initialTheme,d=s.includes(l)?l:s[0]??"dark";let c=d;const u=ld({text:"Theme",tone:"muted",size:"lg"}),p=mg({options:tm(),value:d,onChange:w=>{c=w,this.deps.applyTheme(w),this.renderThemePickers(w,f,c);}}),f=x("div",{className:"settings-theme-grid"}),g=We({title:"Style",padding:"lg",expandable:true,defaultExpanded:!!a.ui.expandedCards.style,onExpandChange:w=>o.setCardExpanded("style",w)},x("div",{className:"kv settings-theme-row"},u.root,p.root),f);this.renderThemePickers(d,f,c);const m=this.createHUDSectionsCard({defaultExpanded:!!a.ui.expandedCards.hudSections,onExpandChange:w=>o.setCardExpanded("hudSections",w)}),h=this.createEnhancementsCard({defaultExpanded:!!a.ui.expandedCards.enhancements,onExpandChange:w=>o.setCardExpanded("enhancements",w)}),b=this.createEnvCard({defaultExpanded:!!a.ui.expandedCards.system,onExpandChange:w=>o.setCardExpanded("system",w)});r.appendChild(g),r.appendChild(m),r.appendChild(h),r.appendChild(b);}mergeFeatureConfig(n){return {pets:{...Pt.pets,...n.pets},journalChecker:{...Pt.journalChecker,...n.journalChecker},autoFavorite:{...Pt.autoFavorite,...n.autoFavorite},bulkFavorite:{...Pt.bulkFavorite,...n.bulkFavorite},cropSizeIndicator:{...Pt.cropSizeIndicator,...n.cropSizeIndicator},eggProbabilityIndicator:{...Pt.eggProbabilityIndicator,...n.eggProbabilityIndicator},cropValueIndicator:{...Pt.cropValueIndicator,...n.cropValueIndicator}}}saveFeatureConfig(){Pe(we.CONFIG,this.featureConfig),console.log("[Settings] Feature config saved:",this.featureConfig);}createHUDSectionsCard(n){const r=(o,a,i,s,l=false,d=false)=>{const c=x("div",{style:`
        ...
        transition: opacity 0.2s ease;
        opacity: ${r?"1":"0.5"};
      `}),d=x("div"),c=x("div",{style:"font-weight: 500; margin-bottom: 4px;"},n),u=x("div",{style:"font-size: 12px; color: var(--fg); opacity: 0.7;"},a);d.append(c,u);const p=kr({checked:r,onChange:f=>{l.style.opacity=f?"1":"0.5",o(f);}});return l.append(d,p.root),l}createEnhancementsCard(n){const r=bd(),a=[...r.getAll()].sort((s,l)=>s.name.localeCompare(l.name)),i=a.map((s,l)=>{const d=l===0,c=l===a.length-1,u=r.isEnabled(s.id);return this.createSectionRow(s.name,u,p=>{r.setEnabled(s.id,p),this.saveFeatureConfig();},s.description,d,c)});return We({title:"In-Game Enhancements",variant:"soft",padding:"lg",expandable:true,defaultExpanded:n?.defaultExpanded??false,onExpandChange:n?.onExpandChange},x("div",{},...i))}renderThemePickers(n,r,o){const a=pr[n];if(r.replaceChildren(),!!a)for(const i of nm){const s=a[i];if(s==null)continue;const l=Dg({label:rm(i),value:s,defaultExpanded:false,onInput:d=>this.updateThemeVar(n,i,d,o),onChange:d=>this.updateThemeVar(n,i,d,o)});r.appendChild(l.root);}}updateThemeVar(n,r,o,a){const i=pr[n];i&&(i[r]=om(o),a===n&&this.deps.applyTheme(n));}createEnvCard(n){const r=n?.defaultExpanded??false,o=n?.onExpandChange,a=(b,w)=>{const C=x("div",{className:"kv kv--inline-mobile"}),v=x("label",{},b),_=x("div",{className:"ro"});return typeof w=="string"?_.textContent=w:_.append(w),C.append(v,_),C},i=x("code",{},"—"),s=x("span",{},"—"),l=x("span",{},"—"),d=x("span",{},"—"),c=x("span",{},"—"),u=x("span",{},"—"),p=()=>{const b=Ve.detect();l.textContent=b.surface,d.textContent=b.platform,c.textContent=b.browser??"Unknown",u.textContent=b.os??"Unknown",i.textContent=b.host,s.textContent=b.isInIframe?"Yes":"No";},f=Wt({label:"Copy JSON",variant:"primary",size:"sm"});Jg(f,()=>{const b=Ve.detect();return JSON.stringify(b,null,2)});const g=x("div",{style:"width:100%;display:flex;justify-content:center;"},f),m=We({title:"System",variant:"soft",padding:"lg",footer:g,expandable:true,defaultExpanded:r,onExpandChange:o},a("Surface",l),a("Platform",d),a("Browser",c),a("OS",u),a("Host",i),a("Iframe",s)),h=()=>{document.hidden||p();};return document.addEventListener("visibilitychange",h),p(),this.addCleanup(()=>document.removeEventListener("visibilitychange",h)),m}}function us(e){const{id:t,columns:n,data:r,pageSize:o=0,stickyHeader:a=true,zebra:i=true,animations:s=true,respectReducedMotion:l=true,compact:d=false,maxHeight:c,selectable:u=false,selectionType:p="switch",selectOnRowClick:f=false,initialSelection:g=[],hideHeaderCheckbox:m=false,getRowId:h=(X,ee)=>String(ee),onSortChange:b,onSelectionChange:w,onRowClick:C}=e;let v=n.slice(),_=r.slice(),y=r.slice(),S=null,T=null,k=1;const P=typeof window<"u"&&typeof window.matchMedia=="function"?window.matchMedia("(prefers-reduced-motion: reduce)").matches:false,E=!!s&&!(l&&P),B=x("div",{className:"lg-table-wrap",id:t});if(c!=null){const X=typeof c=="number"?`${c}px`:c;B.style.setProperty("--tbl-max-h",X);}const Z=x("div",{className:"lg-table"}),H=x("div",{className:"lg-thead"}),D=x("div",{className:"lg-tbody"}),Y=x("div",{className:"lg-tfoot"});a&&B.classList.add("sticky"),i&&B.classList.add("zebra"),d&&B.classList.add("compact"),u&&B.classList.add("selectable");const O=p==="switch"?"52px":"36px";B.style.setProperty("--check-w",O);function z(X){return X==="center"?"center":X==="right"?"flex-end":"flex-start"}function G(){const X=v.map(se=>{const ue=(se.width||"1fr").trim();return /\bfr$/.test(ue)?`minmax(0, ${ue})`:ue}),ee=(u?[O,...X]:X).join(" ");B.style.setProperty("--lg-cols",ee);}G();function $(){return o?Math.max(1,Math.ceil(_.length/o)):1}function A(){if(!o)return _;const X=(k-1)*o;return _.slice(X,X+o)}function R(){if(!S||!T)return;const X=v.find(ue=>String(ue.key)===S),ee=T==="asc"?1:-1,se=X?.sortFn?(ue,he)=>ee*X.sortFn(ue,he):(ue,he)=>{const oe=ue[S],ie=he[S];return oe==null&&ie==null?0:oe==null?-1*ee:ie==null?1*ee:typeof oe=="number"&&typeof ie=="number"?ee*(oe-ie):ee*String(oe).localeCompare(String(ie),void 0,{numeric:true,sensitivity:"base"})};_.sort(se);}const N=new Set(g);function U(){return Array.from(N)}const xe=new Map;function J(X){N.clear(),X.forEach(ee=>N.add(ee)),Se(),xe.forEach((ee,se)=>{ee.setChecked(N.has(se),true);}),Dn(),w?.(U());}function V(){N.clear(),Se(),xe.forEach(X=>X.setChecked(false,true)),Dn(),w?.(U());}let pe=null;function Se(){if(!pe)return;const X=A();if(!X.length){pe.indeterminate=false,pe.checked=false;return}const ee=X.map((ue,he)=>h(ue,(k-1)*(o||0)+he)),se=ee.reduce((ue,he)=>ue+(N.has(he)?1:0),0);pe.checked=se===ee.length,pe.indeterminate=se>0&&se<ee.length;}function Ot(){const X=D.offsetWidth-D.clientWidth;H.style.paddingRight=X>0?`${X}px`:"0px";}function Oa(){requestAnimationFrame(Ot);}const $a=new ResizeObserver(()=>Ot()),Sl=()=>Ot();function zf(){H.replaceChildren();const X=x("div",{className:"lg-tr lg-tr-head"});if(u){const ee=x("div",{className:"lg-th lg-th-check"});m||(pe=x("input",{type:"checkbox"}),pe.addEventListener("change",()=>{const se=A(),ue=pe.checked;se.forEach((he,oe)=>{const ie=h(he,(k-1)*(o||0)+oe);ue?N.add(ie):N.delete(ie);}),w?.(U()),Dn();}),ee.appendChild(pe)),X.appendChild(ee);}v.forEach(ee=>{const se=x("button",{className:"lg-th",type:"button",title:ee.title||ee.header});se.textContent=ee.header,ee.align&&se.style.setProperty("--col-justify",z(ee.align)),ee.sortable&&se.classList.add("sortable"),S===String(ee.key)&&T?se.setAttribute("data-sort",T):se.removeAttribute("data-sort"),ee.sortable&&se.addEventListener("click",()=>{const ue=String(ee.key);S!==ue?(S=ue,T="asc"):(T=T==="asc"?"desc":T==="desc"?null:"asc",T||(S=null,_=y.slice())),b?.(S,T),S&&T&&R(),Zr();}),X.appendChild(se);}),H.appendChild(X);try{$a.disconnect();}catch{}$a.observe(D),Oa();}function Ba(X){return Array.from(X.querySelectorAll(":scope > .lg-td, :scope > .lg-td-check"))}function Cl(X){return X.querySelector(".lg-td, .lg-td-check")}function kl(X){const ee=Cl(X);return ee?ee.getBoundingClientRect():null}function Dn(){const X=A(),ee=new Map;Array.from(D.children).forEach(oe=>{const ie=oe,$e=ie.getAttribute("data-id");if(!$e)return;const qe=kl(ie);qe&&ee.set($e,qe);});const se=new Map;Array.from(D.children).forEach(oe=>{const ie=oe,$e=ie.getAttribute("data-id");$e&&se.set($e,ie);});const ue=[];for(let oe=0;oe<X.length;oe++){const ie=X[oe],$e=(o?(k-1)*o:0)+oe,qe=h(ie,$e);ue.push(qe);let Ce=se.get(qe);Ce||(Ce=Hf(ie,$e),E&&Ba(Ce).forEach(Gn=>{Gn.style.transform="translateY(6px)",Gn.style.opacity="0";})),D.appendChild(Ce);}const he=[];if(se.forEach((oe,ie)=>{ue.includes(ie)||he.push(oe);}),!E){he.forEach(oe=>oe.remove()),Se(),Oa();return}ue.forEach(oe=>{const ie=D.querySelector(`.lg-tr-body[data-id="${oe}"]`);if(!ie)return;const $e=kl(ie),qe=ee.get(oe),Ce=Ba(ie);if(qe&&$e){const ft=qe.left-$e.left,cn=qe.top-$e.top;Ce.forEach(Tt=>{Tt.style.transition="none",Tt.style.transform=`translate(${ft}px, ${cn}px)`,Tt.style.opacity="1";}),Cl(ie)?.getBoundingClientRect(),Ce.forEach(Tt=>{Tt.style.willChange="transform, opacity",Tt.style.transition="transform .18s ease, opacity .18s ease";}),requestAnimationFrame(()=>{Ce.forEach(Tt=>{Tt.style.transform="translate(0,0)";});});}else Ce.forEach(ft=>{ft.style.transition="transform .18s ease, opacity .18s ease";}),requestAnimationFrame(()=>{Ce.forEach(ft=>{ft.style.transform="translate(0,0)",ft.style.opacity="1";});});const Da=ft=>{(ft.propertyName==="transform"||ft.propertyName==="opacity")&&(Ce.forEach(cn=>{cn.style.willChange="",cn.style.transition="",cn.style.transform="",cn.style.opacity="";}),ft.currentTarget.removeEventListener("transitionend",Da));},Gn=Ce[0];Gn&&Gn.addEventListener("transitionend",Da);}),he.forEach(oe=>{const ie=Ba(oe);ie.forEach(Ce=>{Ce.style.willChange="transform, opacity",Ce.style.transition="transform .18s ease, opacity .18s ease",Ce.style.opacity="0",Ce.style.transform="translateY(-6px)";});const $e=Ce=>{Ce.propertyName==="opacity"&&(Ce.currentTarget.removeEventListener("transitionend",$e),oe.remove());},qe=ie[0];qe?qe.addEventListener("transitionend",$e):oe.remove();}),Se(),Oa();}function Hf(X,ee){const se=h(X,ee),ue=x("div",{className:"lg-tr lg-tr-body","data-id":se});if(u){const he=x("div",{className:"lg-td lg-td-check"});if(p==="switch"){const oe=kr({size:"sm",checked:N.has(se),onChange:ie=>{ie?N.add(se):N.delete(se),Se(),w?.(U());}});xe.set(se,oe),he.appendChild(oe.root);}else {const oe=x("input",{type:"checkbox",className:"lg-row-check"});oe.checked=N.has(se),oe.addEventListener("change",ie=>{ie.stopPropagation(),oe.checked?N.add(se):N.delete(se),Se(),w?.(U());}),oe.addEventListener("click",ie=>ie.stopPropagation()),he.appendChild(oe);}ue.appendChild(he);}return v.forEach(he=>{const oe=x("div",{className:"lg-td"});he.align&&oe.style.setProperty("--col-justify",z(he.align));let ie=he.render?he.render(X,ee):String(X[he.key]??"");typeof ie=="string"?oe.textContent=ie:oe.appendChild(ie),ue.appendChild(oe);}),(C||u&&f)&&(ue.classList.add("clickable"),ue.addEventListener("click",he=>{if(!he.target.closest(".lg-td-check")){if(u&&f){const oe=!N.has(se);if(oe?N.add(se):N.delete(se),Se(),p==="switch"){const ie=xe.get(se);ie&&ie.setChecked(oe,true);}else {const ie=ue.querySelector(".lg-row-check");ie&&(ie.checked=oe);}w?.(U());}C?.(X,ee,he);}})),ue}function _l(){if(Y.replaceChildren(),!o)return;const X=$(),ee=x("div",{className:"lg-pager"}),se=x("button",{className:"btn",type:"button"},"←"),ue=x("button",{className:"btn",type:"button"},"→"),he=x("span",{className:"lg-pager-info"},`${k} / ${X}`);se.disabled=k<=1,ue.disabled=k>=X,se.addEventListener("click",()=>Qr(k-1)),ue.addEventListener("click",()=>Qr(k+1)),ee.append(se,he,ue),Y.appendChild(ee);}function Qr(X){const ee=$();k=Math.min(Math.max(1,X),ee),Dn(),_l();}function Zr(){G(),zf(),Dn(),_l();}function jf(X){y=X.slice(),_=X.slice(),S&&T&&R(),Qr(1);}function Uf(X){v=X.slice(),Zr();}function Wf(X,ee="asc"){S=X,T=X?ee:null,S&&T?R():_=y.slice(),Zr();}function Vf(){try{$a.disconnect();}catch{}window.removeEventListener("resize",Sl);}return Z.append(H,D,Y),B.appendChild(Z),window.addEventListener("resize",Sl),Zr(),{root:B,setData:jf,setColumns:Uf,sortBy:Wf,getSelection:U,setSelection:J,clearSelection:V,setPage:Qr,getState:()=>({page:k,pageCount:$(),sortKey:S,sortDir:T}),destroy:Vf}}let Jo=false;const er=new Set;function im(e=document){let t=e.activeElement||null;for(;t&&t.shadowRoot&&t.shadowRoot.activeElement;)t=t.shadowRoot.activeElement;return t}const Ze=e=>{const t=im();if(t){for(const n of er)if(t===n||n.contains(t)){e.stopImmediatePropagation(),e.stopPropagation();return}}};function sm(){Jo||(Jo=true,window.addEventListener("keydown",Ze,true),window.addEventListener("keypress",Ze,true),window.addEventListener("keyup",Ze,true),document.addEventListener("keydown",Ze,true),document.addEventListener("keypress",Ze,true),document.addEventListener("keyup",Ze,true));}function lm(){Jo&&(Jo=false,window.removeEventListener("keydown",Ze,true),window.removeEventListener("keypress",Ze,true),window.removeEventListener("keyup",Ze,true),document.removeEventListener("keydown",Ze,true),document.removeEventListener("keypress",Ze,true),document.removeEventListener("keyup",Ze,true));}function cm(e){return er.size===0&&sm(),er.add(e),()=>{er.delete(e),er.size===0&&lm();}}function oo(e){return e==null?null:typeof e=="string"?document.createTextNode(e):e}function dm(){const e="http://www.w3.org/2000/svg",t=document.createElementNS(e,"svg");t.setAttribute("viewBox","0 0 24 24"),t.setAttribute("width","16"),t.setAttribute("height","16"),t.setAttribute("aria-hidden","true"),t.style.display="none",t.style.flexShrink="0";const n=document.createElementNS(e,"circle");n.setAttribute("cx","12"),n.setAttribute("cy","12"),n.setAttribute("r","9"),n.setAttribute("fill","none"),n.setAttribute("stroke","currentColor"),n.setAttribute("stroke-width","3"),n.setAttribute("stroke-linecap","round");const r=document.createElementNS(e,"animate");r.setAttribute("attributeName","stroke-dasharray"),r.setAttribute("values","1,150;90,150;90,150"),r.setAttribute("dur","1.5s"),r.setAttribute("repeatCount","indefinite");const o=document.createElementNS(e,"animateTransform");return o.setAttribute("attributeName","transform"),o.setAttribute("attributeType","XML"),o.setAttribute("type","rotate"),o.setAttribute("from","0 12 12"),o.setAttribute("to","360 12 12"),o.setAttribute("dur","1s"),o.setAttribute("repeatCount","indefinite"),n.append(r,o),t.appendChild(n),t}function ps(e={}){const{id:t,placeholder:n="Rechercher…",value:r="",size:o="md",disabled:a=false,autoFocus:i=false,onChange:s,onSearch:l,autoSearch:d=false,debounceMs:c=0,focusKey:u="/",iconLeft:p,iconRight:f,withClear:g=true,clearTitle:m="Effacer",ariaLabel:h,submitLabel:b,loading:w=false,blockGameKeys:C=true}=e,v=x("div",{className:"search"+(o?` search--${o}`:""),id:t}),_=x("span",{className:"search-ico search-ico--left"});if(p){const V=oo(p);V&&_.appendChild(V);}else _.textContent="🔎",_.style.opacity=".9";const y=x("input",{className:"input search-input",type:"text",placeholder:n,value:r,"aria-label":h||n}),S=x("span",{className:"search-ico search-ico--right"});if(f){const V=oo(f);V&&S.appendChild(V);}const T=dm();T.classList.add("search-spinner");const k=g?x("button",{className:"search-clear",type:"button",title:m},"×"):null,P=b!=null?x("button",{className:"btn search-submit",type:"button"},b):null,E=x("div",{className:"search-field"},_,y,S,T,...k?[k]:[]);v.append(E,...P?[P]:[]);let B=!!a,Z=null;function H(V){T.style.display=V?"inline-block":"none",v.classList.toggle("is-loading",V);}function D(){Z!=null&&(window.clearTimeout(Z),Z=null);}function Y(V){D(),c>0?Z=window.setTimeout(()=>{Z=null,V();},c):V();}function O(){s?.(y.value),d&&l&&l(y.value);}y.addEventListener("input",()=>{Y(O);}),y.addEventListener("keydown",V=>{V.key==="Enter"?(V.preventDefault(),D(),l?.(y.value)):V.key==="Escape"&&(y.value.length>0?$("",{notify:true}):y.blur());}),k&&k.addEventListener("click",()=>$("",{notify:true})),P&&P.addEventListener("click",()=>l?.(y.value));let z=()=>{};if(C&&(z=cm(y)),u){const V=pe=>{if(pe.key===u&&!pe.ctrlKey&&!pe.metaKey&&!pe.altKey){const Se=document.activeElement;Se&&(Se.tagName==="INPUT"||Se.tagName==="TEXTAREA"||Se.isContentEditable)||(pe.preventDefault(),y.focus());}};window.addEventListener("keydown",V,true),v.__cleanup=()=>{window.removeEventListener("keydown",V,true),z();};}else v.__cleanup=()=>{z();};function G(V){B=!!V,y.disabled=B,k&&(k.disabled=B),P&&(P.disabled=B),v.classList.toggle("disabled",B);}function $(V,pe={}){const Se=y.value;y.value=V??"",pe.notify&&Se!==V&&Y(O);}function A(){return y.value}function R(){y.focus();}function N(){y.blur();}function U(V){y.placeholder=V;}function xe(V){$("",V);}return G(B),H(w),i&&R(),{root:v,input:y,getValue:A,setValue:$,focus:R,blur:N,setDisabled:G,setPlaceholder:U,clear:xe,setLoading:H,setIconLeft(V){_.replaceChildren();const pe=oo(V??"🔎");pe&&_.appendChild(pe);},setIconRight(V){S.replaceChildren();const pe=oo(V??"");pe&&S.appendChild(pe);}}}const pa=e=>new Promise(t=>setTimeout(t,e)),ct=e=>{try{return e()}catch{return}},xt=(e,t,n)=>Math.max(t,Math.min(n,e)),um=e=>xt(e,0,1);async function El(e,t,n){const r=performance.now();for(;performance.now()-r<t;){const o=await Promise.race([e,pa(50).then(()=>null)]);if(o!==null)return o}throw new Error(`${n} timeout`)}let fs=null;function yd(){return fs}function pm(e){fs=e;}function vd(){return fs!==null}const fm=/\/(?:r\/\d+\/)?version\/([^/]+)/,gm=15e3,mm=50;function hm(){return F?.document??(typeof document<"u"?document:null)}function gs(e={}){if(vd())return;const t=e.doc??hm();if(!t)return;const n=t.scripts;for(let r=0;r<n.length;r++){const a=n.item(r)?.src;if(!a)continue;const i=a.match(fm);if(i?.[1]){pm(i[1]);return}}}function bm(){return gs(),yd()}function xm(){return vd()}async function ym(e={}){const t=e.timeoutMs??gm,n=performance.now();for(;performance.now()-n<t;){gs();const r=yd();if(r)return r;await pa(mm);}throw new Error("MGVersion timeout (gameVersion not found)")}const ms={init:gs,isReady:xm,get:bm,wait:ym},vm=F?.location?.origin||"https://magicgarden.gg";function wd(){return typeof GM_xmlhttpRequest=="function"}function Sd(e,t="text"){return new Promise((n,r)=>{GM_xmlhttpRequest({method:"GET",url:e,responseType:t,onload:o=>o.status>=200&&o.status<300?n(o):r(new Error(`HTTP ${o.status} for ${e}`)),onerror:()=>r(new Error(`Network error for ${e}`)),ontimeout:()=>r(new Error(`Timeout for ${e}`))});})}async function hs(e){if(wd())return JSON.parse((await Sd(e,"text")).responseText);const t=await fetch(e);if(!t.ok)throw new Error(`HTTP ${t.status} for ${e}`);return t.json()}async function Cd(e){if(wd())return (await Sd(e,"blob")).response;const t=await fetch(e);if(!t.ok)throw new Error(`HTTP ${t.status} for ${e}`);return t.blob()}function wm(e){return new Promise((t,n)=>{const r=URL.createObjectURL(e),o=F?.Image||Image,a=new o;a.decoding="async",a.onload=()=>{URL.revokeObjectURL(r),t(a);},a.onerror=()=>{URL.revokeObjectURL(r),n(new Error("Image decode failed"));},a.src=r;})}const St=(e,t)=>e.replace(/\/?$/,"/")+String(t||"").replace(/^\//,""),Sm=e=>e.lastIndexOf("/")>=0?e.slice(0,e.lastIndexOf("/")+1):"",Ml=(e,t)=>String(t||"").startsWith("/")?String(t).slice(1):Sm(e)+String(t||"");let bs=null,kd=null;function Cm(){return bs}function km(){return kd}function _m(e){bs=e;}function Tm(e){kd=e;}function _d(){return bs!==null}const Pm=15e3;async function Im(e={}){_d()||await xs(e);}async function xs(e={}){const t=Cm();if(t)return t;const n=km();if(n)return n;const r=(async()=>{const o=e.gameVersion??await ms.wait({timeoutMs:Pm}),a=`${vm}/version/${o}/assets/`;return _m(a),a})();return Tm(r),r}async function Am(e){const t=await xs();return St(t,e)}function Em(){return _d()}const rn={init:Im,isReady:Em,base:xs,url:Am},Td=new Map;function Mm(e){return Td.get(e)}function Rm(e,t){Td.set(e,t);}const Pd="manifest.json";let wi=null;async function Lm(){wi||(wi=await Id());}function Fm(){return wi!==null}async function Id(e={}){const t=e.baseUrl??await rn.base(),n=Mm(t);if(n)return n;const r=hs(St(t,Pd));return Rm(t,r),r}function Nm(e,t){return e.bundles.find(n=>n.name===t)??null}function Om(e){if(!e)return [];const t=new Set;for(const n of e.assets)for(const r of n.src??[])typeof r=="string"&&r.endsWith(".json")&&r!==Pd&&t.add(r);return Array.from(t)}const Ct={init:Lm,isReady:Fm,load:Id,getBundle:Nm,listJsonFromBundle:Om},$m=F,lt=$m.Object??Object,fa=lt.keys,Qo=lt.values,Zo=lt.entries,Rl=new WeakSet;function Bm(){return {data:{items:null,decor:null,mutations:null,eggs:null,pets:null,abilities:null,plants:null,weather:null},isHookInstalled:false,scanInterval:null,scanAttempts:0,weatherPollingTimer:null,weatherPollAttempts:0,colorPollingTimer:null,colorPollAttempts:0}}const Q=Bm(),Bt={items:["WateringCan","PlanterPot","Shovel"],decor:["SmallRock","MediumRock","LargeRock","WoodBench","StoneBench","MarbleBench"],mutations:["Gold","Rainbow","Wet","Chilled","Frozen"],eggs:["CommonEgg","UncommonEgg","RareEgg"],pets:["Worm","Snail","Bee","Chicken","Bunny"],abilities:["ProduceScaleBoost","DoubleHarvest","SeedFinderI","CoinFinderI"],plants:["Carrot","Strawberry","Aloe","Blueberry","Apple"]},Dm=["Rain","Frost","Dawn","AmberMoon"],Ll=/main-[^/]+\.js(\?|$)/,Gm=6,zm=150,Hm=2e3,jm=200,Um=50,Wm=10,Vm=1e3,Si="ProduceScaleBoost",Dt=(e,t)=>t.every(n=>e.includes(n));function Gt(e,t){Q.data[e]==null&&(Q.data[e]=t,ea()&&Md());}function ea(){return Object.values(Q.data).every(e=>e!=null)}function Ad(e,t){if(!e||typeof e!="object"||Rl.has(e))return;Rl.add(e);let n;try{n=fa(e);}catch{return}if(!n||n.length===0)return;const r=e;let o;if(!Q.data.items&&Dt(n,Bt.items)&&(o=r.WateringCan,o&&typeof o=="object"&&"coinPrice"in o&&"creditPrice"in o&&Gt("items",r)),!Q.data.decor&&Dt(n,Bt.decor)&&(o=r.SmallRock,o&&typeof o=="object"&&"coinPrice"in o&&"creditPrice"in o&&Gt("decor",r)),!Q.data.mutations&&Dt(n,Bt.mutations)&&(o=r.Gold,o&&typeof o=="object"&&"baseChance"in o&&"coinMultiplier"in o&&Gt("mutations",r)),!Q.data.eggs&&Dt(n,Bt.eggs)&&(o=r.CommonEgg,o&&typeof o=="object"&&"faunaSpawnWeights"in o&&"secondsToHatch"in o&&Gt("eggs",r)),!Q.data.pets&&Dt(n,Bt.pets)&&(o=r.Worm,o&&typeof o=="object"&&"coinsToFullyReplenishHunger"in o&&"diet"in o&&Array.isArray(o.diet)&&Gt("pets",r)),!Q.data.abilities&&Dt(n,Bt.abilities)&&(o=r.ProduceScaleBoost,o&&typeof o=="object"&&"trigger"in o&&"baseParameters"in o&&Gt("abilities",r)),!Q.data.plants&&Dt(n,Bt.plants)&&(o=r.Carrot,o&&typeof o=="object"&&"seed"in o&&"plant"in o&&"crop"in o&&Gt("plants",r)),!(t>=Gm))for(const a of n){let i;try{i=r[a];}catch{continue}i&&typeof i=="object"&&Ad(i,t+1);}}function $o(e){try{Ad(e,0);}catch{}}function Ed(){if(!Q.isHookInstalled){if(lt.__MG_HOOKED__){Q.isHookInstalled=true;return}lt.__MG_HOOKED__=true,Q.isHookInstalled=true;try{lt.keys=function(t){return $o(t),fa.apply(this,arguments)},Qo&&(lt.values=function(t){return $o(t),Qo.apply(this,arguments)}),Zo&&(lt.entries=function(t){return $o(t),Zo.apply(this,arguments)});}catch{}}}function Md(){if(Q.isHookInstalled){try{lt.keys=fa,Qo&&(lt.values=Qo),Zo&&(lt.entries=Zo);}catch{}Q.isHookInstalled=false;}}function Xm(){if(Q.scanInterval||ea())return;const e=()=>{if(ea()||Q.scanAttempts>zm){Rd();return}Q.scanAttempts++;try{fa(F).forEach(t=>{try{$o(F[t]);}catch{}});}catch{}};e(),Q.scanInterval=setInterval(e,Hm);}function Rd(){Q.scanInterval&&(clearInterval(Q.scanInterval),Q.scanInterval=null);}const Fl=F;function qm(){try{for(const e of Fl.document?.scripts||[]){const t=e?.src?String(e.src):"";if(Ll.test(t))return t}}catch{}try{for(const e of Fl.performance?.getEntriesByType?.("resource")||[]){const t=e?.name?String(e.name):"";if(Ll.test(t))return t}}catch{}return null}function Km(e,t){const n=[];let r=e.indexOf(t);for(;r!==-1;)n.push(r),r=e.indexOf(t,r+t.length);return n}function ys(e,t){let n=0,r="",o=false;for(let a=t;a<e.length;a++){const i=e[a];if(r){if(o){o=false;continue}if(i==="\\"){o=true;continue}i===r&&(r="");continue}if(i==='"'||i==="'"||i==="`"){r=i;continue}if(i==="{")n++;else if(i==="}"&&--n===0)return e.slice(t,a+1)}return null}function Ym(e,t){const n=Math.max(e.lastIndexOf("const ",t),e.lastIndexOf("let ",t),e.lastIndexOf("var ",t));if(n<0)return null;const r=e.indexOf("=",n);if(r<0||r>t)return null;const o=e.indexOf("{",r);return o<0||o>t?null:ys(e,o)}let za=null,zn=null;async function Ld(){return za||zn||(zn=(async()=>{const e=qm();if(!e)return null;try{const t=await fetch(e,{credentials:"include"});if(!t.ok)return null;const n=await t.text();return za=n,n}catch{return null}finally{zn=null;}})(),zn)}function Jm(e){const t={};let n=false;for(const r of Dm){const o=e?.[r];if(!o||typeof o!="object")continue;const a=o.iconSpriteKey||null,{iconSpriteKey:i,...s}=o;t[r]={weatherId:r,spriteId:a,...s},n=true;}return t.Sunny||(t.Sunny={weatherId:"Sunny",name:"Sunny",spriteId:"sprite/ui/SunnyIcon",type:"primary"}),!n||t.Rain&&t.Rain.mutator?.mutation!=="Wet"?null:t}async function Qm(){if(Q.data.weather)return  true;const e=await Ld();if(!e)return  false;let t=e.indexOf("fixedTimeSlots:[0,48,96,144,192,240]");if(t<0&&(t=e.indexOf('name:"Amber Moon"')),t<0)return  false;const n=Ym(e,t);if(!n)return  false;const r=n.replace(/\b[A-Za-z_$][\w$]*\.(Rain|Frost|Dawn|AmberMoon)\b/g,'"$1"');let o;try{o=Function('"use strict";return('+r+")")();}catch{return  false}const a=Jm(o);return a?(Q.data.weather=a,true):false}function Zm(){if(Q.weatherPollingTimer)return;Q.weatherPollAttempts=0;const e=setInterval(async()=>{(await Qm()||++Q.weatherPollAttempts>jm)&&(clearInterval(e),Q.weatherPollingTimer=null);},Um);Q.weatherPollingTimer=e;}function eh(){Q.weatherPollingTimer&&(clearInterval(Q.weatherPollingTimer),Q.weatherPollingTimer=null);}const th={bg:"rgba(100, 100, 100, 0.9)",hover:"rgba(150, 150, 150, 1)"};function nh(e){const t=Km(e,Si);if(!t.length)return null;for(const n of t){const r=Math.max(0,n-4e3),o=Math.min(e.length,n+4e3),i=e.slice(r,o).lastIndexOf("switch(");if(i===-1)continue;const s=r+i,l=e.indexOf("{",s);if(l===-1)continue;const d=ys(e,l);if(d&&d.includes(Si)&&(d.includes('bg:"')||d.includes("bg:'")))return d}return null}function rh(e){const t={},n=[],r=/case\s*(['"])([^'"]+)\1\s*:|default\s*:|return\s*\{/g,o=(i,s)=>{const l=new RegExp(`${s}\\s*:\\s*(['"])([\\s\\S]*?)\\1`),d=i.match(l);return d?d[2]:null};let a;for(;(a=r.exec(e))!==null;){if(a[2]){n.push(a[2]);continue}const i=a[0];if(i.startsWith("default")){n.length=0;continue}if(!i.startsWith("return"))continue;const s=e.indexOf("{",a.index);if(s===-1){n.length=0;continue}const l=ys(e,s);if(!l){n.length=0;continue}const d=o(l,"bg");if(!d){n.length=0;continue}const c=o(l,"hover")||d;for(const u of n)t[u]||(t[u]={bg:d,hover:c});n.length=0;}return Object.keys(t).length?t:null}async function oh(){const e=await Ld();if(!e)return null;const t=nh(e);return t?rh(t):null}function ah(e){const t=e[Si];return t!=null&&typeof t=="object"&&"color"in t}async function ih(){if(!Q.data.abilities)return  false;const e=Q.data.abilities;if(ah(e))return  true;const t=await oh();if(!t)return  false;const n={};for(const[r,o]of Object.entries(e)){const a=t[r]||th;n[r]={...o,color:{bg:a.bg,hover:a.hover}};}return Q.data.abilities=n,console.log("[MGData] Enriched abilities with colors"),true}function sh(){if(Q.colorPollingTimer)return;Q.colorPollAttempts=0;const e=setInterval(async()=>{(await ih()||++Q.colorPollAttempts>Wm)&&(clearInterval(e),Q.colorPollingTimer=null);},Vm);Q.colorPollingTimer=e;}function lh(){Q.colorPollingTimer&&(clearInterval(Q.colorPollingTimer),Q.colorPollingTimer=null);}function ch(){return {ready:false,app:null,renderer:null,ctors:null,baseUrl:null,textures:new Map,animations:new Map,live:new Set,defaultParent:null,overlay:null,categoryIndex:null}}function dh(){return {lru:new Map,cost:0,srcCanvas:new Map}}function uh(){return {cache:new Map,maxEntries:200}}const ph={enabled:true,maxEntries:200,maxCost:800,srcCanvasMax:100},fh={enabled:true,maxEntries:200},Le=ch(),gh=dh(),mh={...ph},hh=uh(),bh={...fh};function Ge(){return Le}function Pn(){return gh}function _r(){return mh}function Tr(){return hh}function Ci(){return bh}function Fd(){return Le.ready}const Nl=Function.prototype.bind,fe={_bindPatched:false,engine:null,tos:null,app:null,renderer:null,ticker:null,stage:null};let Nd,Od,$d;const xh=new Promise(e=>{Nd=e;}),yh=new Promise(e=>{Od=e;}),vh=new Promise(e=>{$d=e;});function wh(e){return !!(e&&typeof e=="object"&&typeof e.start=="function"&&typeof e.destroy=="function"&&e.app&&e.app.stage&&e.app.renderer&&e.systems&&typeof e.systems.values=="function")}function Sh(e){try{for(const t of e.systems.values()){const n=t?.system;if(n?.name==="tileObject")return n}}catch{}return null}function Ch(e){fe.engine=e,fe.tos=Sh(e)||null,fe.app=e.app||null,fe.renderer=e.app?.renderer||null,fe.ticker=e.app?.ticker||null,fe.stage=e.app?.stage||null;try{Nd(e);}catch{}try{fe.app&&Od(fe.app);}catch{}try{fe.renderer&&$d(fe.renderer);}catch{}}function vs(){return fe.engine?true:(fe._bindPatched||(fe._bindPatched=true,Function.prototype.bind=function(e,...t){const n=Nl.call(this,e,...t);try{!fe.engine&&wh(e)&&(Function.prototype.bind=Nl,fe._bindPatched=!1,Ch(e));}catch{}return n}),false)}vs();async function kh(e=15e3){const t=performance.now();for(;performance.now()-t<e;){if(fe.engine)return  true;vs(),await pa(50);}throw new Error("MGPixiHooks: engine capture timeout")}async function _h(e=15e3){return fe.engine||await kh(e),true}function Th(){return fe.engine&&fe.app?{ok:true,engine:fe.engine,tos:fe.tos,app:fe.app}:(vs(),{ok:false,engine:fe.engine,tos:fe.tos,app:fe.app,note:"Not captured. Wait for room, or reload."})}const et={engineReady:xh,appReady:yh,rendererReady:vh,engine:()=>fe.engine,tos:()=>fe.tos,app:()=>fe.app,renderer:()=>fe.renderer,ticker:()=>fe.ticker,stage:()=>fe.stage,PIXI:()=>F.PIXI||null,init:_h,hook:Th,ready:()=>!!fe.engine};function ta(e){const t=String(e||"").trim();return t?t.startsWith("sprite/")||t.startsWith("sprites/")?t:t.includes("/")?`sprite/${t}`:t:""}function Gr(e,t){const n=String(e||"").trim().replace(/^sprites?\//,"").replace(/^\/+|\/+$/g,""),r=String(t||"").trim();return r.includes("/")||!n?ta(r):`sprite/${n}/${r}`}function Pr(e,t,n,r){const o=Gr(e,t);if(n.has(o)||r.has(o))return o;const a=String(t||"").trim();if(n.has(a)||r.has(a))return a;const i=ta(a);return n.has(i)||r.has(i)?i:o}function Ph(e,t,n=25e3){const r=[e],o=new Set;let a=0;for(;r.length&&a++<n;){const i=r.pop();if(!i||o.has(i))continue;if(o.add(i),t(i))return i;const s=i.children;if(Array.isArray(s))for(let l=s.length-1;l>=0;l--)r.push(s[l]);}return null}function Ih(e){const t=F.PIXI;if(t?.Texture&&t?.Sprite&&t?.Container&&t?.Rectangle)return {Container:t.Container,Sprite:t.Sprite,Texture:t.Texture,Rectangle:t.Rectangle,AnimatedSprite:t.AnimatedSprite||null};const n=e?.stage,r=Ph(n,o=>o?.texture?.frame&&o?.constructor&&o?.texture?.constructor&&o?.texture?.frame?.constructor);if(!r)throw new Error("No Sprite found yet (constructors).");return {Container:n.constructor,Sprite:r.constructor,Texture:r.texture.constructor,Rectangle:r.texture.frame.constructor,AnimatedSprite:t?.AnimatedSprite||null}}async function Ah(e,t=15e3){const n=performance.now();for(;performance.now()-n<t;)try{return Ih(e)}catch{await pa(50);}throw new Error("Constructors timeout")}const zt=(...e)=>{try{console.log("[MGSprite]",...e);}catch{}};function Eh(e){return e&&typeof e=="object"&&e.frames&&e.meta&&typeof e.meta.image=="string"}function Ha(e,t,n,r,o){return new e(t,n,r,o)}function Mh(e,t,n,r,o,a,i){let s;try{s=new e({source:t.source,frame:n,orig:r,trim:o||void 0,rotate:a||0});}catch{s=new e(t.baseTexture||t,n,r,o||void 0,a||0);}if(i)if(s.defaultAnchor?.set)try{s.defaultAnchor.set(i.x,i.y);}catch{}else s.defaultAnchor?(s.defaultAnchor.x=i.x,s.defaultAnchor.y=i.y):s.defaultAnchor={x:i.x,y:i.y};try{s.updateUvs?.();}catch{}return s}function Rh(e,t,n,r){const{Texture:o,Rectangle:a}=r;for(const[i,s]of Object.entries(e.frames)){const l=s.frame,d=!!s.rotated,c=d?2:0,u=d?l.h:l.w,p=d?l.w:l.h,f=Ha(a,l.x,l.y,u,p),g=s.sourceSize||{w:l.w,h:l.h},m=Ha(a,0,0,g.w,g.h);let h=null;if(s.trimmed&&s.spriteSourceSize){const b=s.spriteSourceSize;h=Ha(a,b.x,b.y,b.w,b.h);}n.set(i,Mh(o,t,f,m,h,c,s.anchor||null));}}function Lh(e,t,n){if(!(!e.animations||typeof e.animations!="object"))for(const[r,o]of Object.entries(e.animations)){if(!Array.isArray(o))continue;const a=o.map(i=>t.get(i)).filter(Boolean);a.length>=2&&n.set(r,a);}}function Fh(e,t){const n=(r,o)=>{const a=String(r||"").trim(),i=String(o||"").trim();!a||!i||(t.has(a)||t.set(a,new Set),t.get(a).add(i));};for(const r of Object.keys(e.frames||{})){const o=/^sprite\/([^/]+)\/(.+)$/.exec(r);o&&n(o[1],o[2]);}}async function Nh(e,t){const n=await Ct.load({baseUrl:e}),r=Ct.getBundle(n,"default");if(!r)throw new Error("No default bundle in manifest");const o=Ct.listJsonFromBundle(r),a=new Set,i=new Map,s=new Map,l=new Map;async function d(c){if(a.has(c))return;a.add(c);const u=await hs(St(e,c));if(!Eh(u))return;const p=u.meta?.related_multi_packs;if(Array.isArray(p))for(const h of p)await d(Ml(c,h));const f=Ml(c,u.meta.image),g=await wm(await Cd(St(e,f))),m=t.Texture.from(g);Rh(u,m,i,t),Lh(u,i,s),Fh(u,l);}for(const c of o)await d(c);return {textures:i,animations:s,categoryIndex:l}}let ao=null;async function Oh(){return Le.ready?true:ao||(ao=(async()=>{const e=performance.now();zt("init start");const t=await El(et.appReady,15e3,"PIXI app");zt("app ready");const n=await El(et.rendererReady,15e3,"PIXI renderer");zt("renderer ready"),Le.app=t,Le.renderer=n||t?.renderer||null,Le.ctors=await Ah(t),zt("constructors resolved"),Le.baseUrl=await rn.base(),zt("base url",Le.baseUrl);const{textures:r,animations:o,categoryIndex:a}=await Nh(Le.baseUrl,Le.ctors);return Le.textures=r,Le.animations=o,Le.categoryIndex=a,zt("atlases loaded","textures",Le.textures.size,"animations",Le.animations.size,"categories",Le.categoryIndex?.size??0),Le.ready=true,zt("ready in",Math.round(performance.now()-e),"ms"),true})(),ao)}const In={Gold:{overlayTall:null,tallIconOverride:null},Rainbow:{overlayTall:null,tallIconOverride:null,angle:130,angleTall:0},Wet:{overlayTall:"sprite/mutation-overlay/WetTallPlant",tallIconOverride:"sprite/mutation/Puddle"},Chilled:{overlayTall:"sprite/mutation-overlay/ChilledTallPlant",tallIconOverride:null},Frozen:{overlayTall:"sprite/mutation-overlay/FrozenTallPlant",tallIconOverride:null},Dawnlit:{overlayTall:null,tallIconOverride:null},Ambershine:{overlayTall:null,tallIconOverride:null},Dawncharged:{overlayTall:null,tallIconOverride:null},Ambercharged:{overlayTall:null,tallIconOverride:null}},Bd=Object.keys(In),$h=["Gold","Rainbow","Wet","Chilled","Frozen","Ambershine","Dawnlit","Dawncharged","Ambercharged"],Ol=new Map($h.map((e,t)=>[e,t]));function na(e){return [...new Set(e.filter(Boolean))].sort((n,r)=>(Ol.get(n)??1/0)-(Ol.get(r)??1/0))}const Bh=["Wet","Chilled","Frozen"],Dh=new Set(["Dawnlit","Ambershine","Dawncharged","Ambercharged"]),Gh={Banana:.6,Carrot:.6,Sunflower:.5,Starweaver:.5,FavaBean:.25,BurrosTail:.2},zh={Pepper:.5,Banana:.6},Hh=256,jh=.5,Uh=2;function Dd(e){if(!e.length)return {muts:[],overlayMuts:[],selectedMuts:[],sig:""};const t=na(e),n=Wh(e),r=Vh(e);return {muts:n,overlayMuts:r,selectedMuts:t,sig:`${t.join(",")}|${n.join(",")}|${r.join(",")}`}}function Wh(e){const t=e.filter((o,a,i)=>In[o]&&i.indexOf(o)===a);if(!t.length)return [];if(t.includes("Gold"))return ["Gold"];if(t.includes("Rainbow"))return ["Rainbow"];const n=["Ambershine","Dawnlit","Dawncharged","Ambercharged"];return t.some(o=>n.includes(o))?na(t.filter(o=>!Bh.includes(o))):na(t)}function Vh(e){const t=e.filter((n,r,o)=>In[n]?.overlayTall&&o.indexOf(n)===r);return na(t)}function ja(e,t){return e.map(n=>({name:n,meta:In[n],overlayTall:In[n]?.overlayTall??null,isTall:t}))}const Xh={Gold:{op:"source-atop",colors:["rgb(235,200,0)"],a:.7},Rainbow:{op:"color",colors:["#FF1744","#FF9100","#FFEA00","#00E676","#2979FF","#D500F9"],ang:130,angTall:0,masked:true},Wet:{op:"source-atop",colors:["rgb(50,180,200)"],a:.25},Chilled:{op:"source-atop",colors:["rgb(100,160,210)"],a:.45},Frozen:{op:"source-atop",colors:["rgb(100,130,220)"],a:.5},Dawnlit:{op:"source-atop",colors:["rgb(209,70,231)"],a:.5},Ambershine:{op:"source-atop",colors:["rgb(190,100,40)"],a:.5},Dawncharged:{op:"source-atop",colors:["rgb(140,80,200)"],a:.5},Ambercharged:{op:"source-atop",colors:["rgb(170,60,25)"],a:.5}},io=(()=>{try{const t=document.createElement("canvas").getContext("2d");if(!t)return new Set;const n=["color","hue","saturation","luminosity","overlay","screen","lighter","source-atop"],r=new Set;for(const o of n)t.globalCompositeOperation=o,t.globalCompositeOperation===o&&r.add(o);return r}catch{return new Set}})();function qh(e){return io.has(e)?e:io.has("overlay")?"overlay":io.has("screen")?"screen":io.has("lighter")?"lighter":"source-atop"}function Kh(e,t,n,r,o=false){const a=(r-90)*Math.PI/180,i=t/2,s=n/2;if(!o){const u=Math.min(t,n)/2;return e.createLinearGradient(i-Math.cos(a)*u,s-Math.sin(a)*u,i+Math.cos(a)*u,s+Math.sin(a)*u)}const l=Math.cos(a),d=Math.sin(a),c=Math.abs(l)*t/2+Math.abs(d)*n/2;return e.createLinearGradient(i-l*c,s-d*c,i+l*c,s+d*c)}function $l(e,t,n,r,o=false){const a=r.colors?.length?r.colors:["#fff"],i=r.ang!=null?Kh(e,t,n,r.ang,o):e.createLinearGradient(0,0,0,n);a.length===1?(i.addColorStop(0,a[0]),i.addColorStop(1,a[0])):a.forEach((s,l)=>i.addColorStop(l/(a.length-1),s)),e.fillStyle=i,e.fillRect(0,0,t,n);}function Yh(e,t,n,r){const o=Xh[n];if(!o)return;const a={...o};n==="Rainbow"&&r&&a.angTall!=null&&(a.ang=a.angTall);const i=n==="Rainbow"&&r,s=t.width,l=t.height;e.save();const d=a.masked?qh(a.op):"source-in";if(e.globalCompositeOperation=d,a.a!=null&&(e.globalAlpha=a.a),a.masked){const c=document.createElement("canvas");c.width=s,c.height=l;const u=c.getContext("2d");u.imageSmoothingEnabled=false,$l(u,s,l,a,i),u.globalCompositeOperation="destination-in",u.drawImage(t,0,0),e.drawImage(c,0,0);}else $l(e,s,l,a,i);e.restore();}function Jh(e){return /tallplant/i.test(e)}function ws(e){const t=String(e||"").split("/");return t[t.length-1]||""}function Gd(e){switch(e){case "Ambershine":return ["Ambershine","Amberlit"];case "Dawncharged":return ["Dawncharged","Dawnbound"];case "Ambercharged":return ["Ambercharged","Amberbound"];default:return [e]}}function Qh(e,t){const n=String(e||"").toLowerCase();for(const r of t.keys()){const o=/sprite\/mutation-overlay\/([A-Za-z0-9]+)TallPlant/i.exec(String(r));if(!o||!o[1])continue;if(o[1].toLowerCase()===n){const i=t.get(r);if(i)return {tex:i,key:r}}}return null}function Zh(e,t,n,r){if(!t)return null;const o=ws(e),a=Gd(t);for(const i of a){const s=[`sprite/mutation/${i}${o}`,`sprite/mutation/${i}-${o}`,`sprite/mutation/${i}_${o}`,`sprite/mutation/${i}/${o}`,`sprite/mutation/${i}`];for(const l of s){const d=n.get(l);if(d)return {tex:d,key:l}}{const l=`sprite/mutation-overlay/${i}TallPlant`,d=n.get(l);if(d)return {tex:d,key:l};const c=`sprite/mutation-overlay/${i}`,u=n.get(c);if(u)return {tex:u,key:c};const p=Qh(t,n);if(p)return p}}return null}function eb(e,t,n,r){if(!t)return null;const o=In[t];if(n&&o?.tallIconOverride){const s=r.get(o.tallIconOverride);if(s)return s}const a=ws(e),i=Gd(t);for(const s of i){const l=[`sprite/mutation/${s}Icon`,`sprite/mutation/${s}`,`sprite/mutation/${s}${a}`,`sprite/mutation/${s}-${a}`,`sprite/mutation/${s}_${a}`,`sprite/mutation/${s}/${a}`];for(const d of l){const c=r.get(d);if(c)return c}if(n){const d=`sprite/mutation-overlay/${s}TallPlantIcon`,c=r.get(d);if(c)return c;const u=`sprite/mutation-overlay/${s}TallPlant`,p=r.get(u);if(p)return p}}return null}function tb(e,t,n){const r=e?.orig?.width??e?.frame?.width??e?.width??1,o=e?.orig?.height??e?.frame?.height??e?.height??1,a=e?.defaultAnchor?.x??0,i=e?.defaultAnchor?.y??0;let s=zh[t]??a;const l=o>r*1.5;let d=Gh[t]??(l?i:.4);const c={x:(s-a)*r,y:(d-i)*o},u=Math.min(r,o),p=Math.min(1.5,u/Hh);let f=jh*p;return n&&(f*=Uh),{width:r,height:o,anchorX:a,anchorY:i,offset:c,iconScale:f}}function zd(e,t){return `${t.sig}::${e}`}function Hd(e){return e?e.isAnim?e.frames?.length||0:e.tex?1:0:0}function nb(e,t,n){e.lru.delete(t),e.lru.set(t,n);}function rb(e,t){if(t.enabled)for(;e.lru.size>t.maxEntries||e.cost>t.maxCost;){const n=e.lru.keys().next().value;if(n===void 0)break;const r=e.lru.get(n);e.lru.delete(n),e.cost=Math.max(0,e.cost-Hd(r??null));}}function jd(e,t){const n=e.lru.get(t);return n?(nb(e,t,n),n):null}function Ud(e,t,n,r){e.lru.set(t,n),e.cost+=Hd(n),rb(e,r);}function ob(e){e.lru.clear(),e.cost=0,e.srcCanvas.clear();}function ab(e,t){return e.srcCanvas.get(t)??null}function ib(e,t,n,r){if(e.srcCanvas.set(t,n),e.srcCanvas.size>r.srcCanvasMax){const o=e.srcCanvas.keys().next().value;o!==void 0&&e.srcCanvas.delete(o);}}function ga(e,t,n,r,o){const a=ab(r,e);if(a)return a;let i=null;const s=t?.resolution??1;try{if(t?.extract?.canvas){const l=new n.Sprite(e),d=t.extract.canvas(l);if(l.destroy?.({children:!0,texture:!1,baseTexture:!1}),s>1&&d){const c=Math.round(d.width/s),u=Math.round(d.height/s);i=document.createElement("canvas"),i.width=c,i.height=u;const p=i.getContext("2d");p&&(p.imageSmoothingEnabled=!1,p.drawImage(d,0,0,c,u));}else i=d;}}catch{}if(!i){const l=e?.frame||e?._frame,d=e?.orig||e?._orig,c=e?.trim||e?._trim,u=e?.rotate||e?._rotate||0,p=e?.baseTexture?.resource?.source||e?.baseTexture?.resource||e?.source?.resource?.source||e?.source?.resource||e?._source?.resource?.source||null;if(!l||!p)throw new Error("textureToCanvas fail");i=document.createElement("canvas");const f=Math.max(1,(d?.width??l.width)|0),g=Math.max(1,(d?.height??l.height)|0),m=c?.x??0,h=c?.y??0;i.width=f,i.height=g;const b=i.getContext("2d");b.imageSmoothingEnabled=false,u===true||u===2||u===8?(b.save(),b.translate(m+l.height/2,h+l.width/2),b.rotate(-Math.PI/2),b.drawImage(p,l.x,l.y,l.width,l.height,-l.width/2,-l.height/2,l.width,l.height),b.restore()):b.drawImage(p,l.x,l.y,l.width,l.height,m,h,l.width,l.height);}return ib(r,e,i,o),i}function sb(e,t,n,r,o,a,i,s){const{w:l,h:d,aX:c,aY:u,basePos:p}=t,f=[];for(const g of n){const m=new r.Sprite(e);m.anchor?.set?.(c,u),m.position.set(p.x,p.y),m.zIndex=1;const h=document.createElement("canvas");h.width=l,h.height=d;const b=h.getContext("2d");b.imageSmoothingEnabled=false,b.save(),b.translate(l*c,d*u),b.drawImage(ga(e,o,r,a,i),-l*c,-d*u),b.restore(),Yh(b,h,g.name,g.isTall);const w=r.Texture.from(h,{resolution:e.resolution??1});s.push(w),m.texture=w,f.push(m);}return f}function lb(e,t,n,r,o,a,i,s,l,d){const{aX:c,basePos:u}=t,p=[];for(const f of n){const g=f.overlayTall&&r.get(f.overlayTall)&&{tex:r.get(f.overlayTall),key:f.overlayTall}||Zh(e,f.name,r);if(!g?.tex)continue;const m=ga(g.tex,a,o,i,s);if(!m)continue;const h=m.width,b={x:0,y:0},w={x:u.x-c*h,y:0},C=document.createElement("canvas");C.width=h,C.height=m.height;const v=C.getContext("2d");if(!v)continue;v.imageSmoothingEnabled=false,v.drawImage(m,0,0),v.globalCompositeOperation="destination-in",v.drawImage(l,-w.x,-0);const _=o.Texture.from(C,{resolution:g.tex.resolution??1});d.push(_);const y=new o.Sprite(_);y.anchor?.set?.(b.x,b.y),y.position.set(w.x,w.y),y.scale.set(1),y.alpha=1,y.zIndex=3,p.push(y);}return p}function cb(e,t,n,r,o,a){const{basePos:i}=t,s=[];for(const l of n){if(l.name==="Gold"||l.name==="Rainbow")continue;const d=eb(e,l.name,l.isTall,r);if(!d)continue;const c=new o.Sprite(d),u=d?.defaultAnchor?.x??.5,p=d?.defaultAnchor?.y??.5;c.anchor?.set?.(u,p),c.position.set(i.x+a.offset.x,i.y+a.offset.y),c.scale.set(a.iconScale),l.isTall&&(c.zIndex=-1),Dh.has(l.name)&&(c.zIndex=10),c.zIndex||(c.zIndex=2),s.push(c);}return s}function Wd(e,t,n,r){try{if(!e||!r.renderer||!r.ctors?.Container||!r.ctors?.Sprite||!r.ctors?.Texture)return null;const{Container:o,Sprite:a,Texture:i}=r.ctors,s=e?.orig?.width??e?.frame?.width??e?.width??1,l=e?.orig?.height??e?.frame?.height??e?.height??1,d=e?.defaultAnchor?.x??.5,c=e?.defaultAnchor?.y??.5,u={x:s*d,y:l*c},p=ga(e,r.renderer,r.ctors,r.cacheState,r.cacheConfig),f=new o;f.sortableChildren=!0;const g=new a(e);g.anchor?.set?.(d,c),g.position.set(u.x,u.y),g.zIndex=0,f.addChild(g);const m=Jh(t),h=ja(n.muts,m),b=ja(n.overlayMuts,m),w=ja(n.selectedMuts,m),C=[],v={w:s,h:l,aX:d,aY:c,basePos:u},_=ws(t),y=tb(e,_,m);sb(e,v,h,r.ctors,r.renderer,r.cacheState,r.cacheConfig,C).forEach(H=>f.addChild(H)),m&&lb(t,v,b,r.textures,r.ctors,r.renderer,r.cacheState,r.cacheConfig,p,C).forEach(D=>f.addChild(D)),cb(t,v,w,r.textures,r.ctors,y).forEach(H=>f.addChild(H));let k={x:0,y:0,width:s,height:l};try{const H=f.getLocalBounds?.()||f.getBounds?.(!0);H&&Number.isFinite(H.width)&&Number.isFinite(H.height)&&(k={x:H.x,y:H.y,width:H.width,height:H.height});}catch{}const{Rectangle:P}=r.ctors,E=P?new P(0,0,s,l):void 0;let B=null;if(typeof r.renderer.generateTexture=="function"?B=r.renderer.generateTexture(f,{resolution:1,region:E}):r.renderer.textureGenerator?.generateTexture&&(B=r.renderer.textureGenerator.generateTexture({target:f,resolution:1,region:E})),!B)throw new Error("no render texture");const Z=B instanceof i?B:i.from(r.renderer.extract.canvas(B));try{Z.__mg_base={baseX:-k.x,baseY:-k.y,baseW:s,baseH:l,texW:k.width,texH:k.height};}catch{}B&&B!==Z&&B.destroy?.(!0),f.destroy({children:!0,texture:!1,baseTexture:!1});try{Z.__mg_gen=!0,Z.label=`${t}|${n.sig}`;}catch{}return Z}catch{return null}}function db(e,t,n,r){if(!e||e.length<2)return null;const o=[];for(const a of e){const i=Wd(a,t,n,r);i&&o.push(i);}return o.length>=2?o:null}function Vd(e,t,n,r,o){const a=t.scale??1,i=t.frameIndex??0,s=t.mutations?.slice().sort().join(",")||"",l=t.anchorX??.5,d=t.anchorY??.5;return `${e}|s${a}|f${i}|m${s}|ax${l}|ay${d}|bm${n}|bp${o}|p${r}`}function ub(e,t){const n=e.cache.get(t);return n?(n.lastAccess=performance.now(),n.canvas):null}function pb(e,t,n,r){if(t.enabled){if(e.cache.size>=t.maxEntries){let o=null,a=1/0;for(const[i,s]of e.cache)s.lastAccess<a&&(a=s.lastAccess,o=i);o&&e.cache.delete(o);}e.cache.set(n,{canvas:r,lastAccess:performance.now()});}}function Bl(e){const t=document.createElement("canvas");t.width=e.width,t.height=e.height;const n=t.getContext("2d");return n&&n.drawImage(e,0,0),t}function fb(e){e.cache.clear();}function gb(e){return {size:e.cache.size,maxEntries:e.maxEntries}}function mb(){return new Promise(e=>{typeof requestIdleCallback<"u"?requestIdleCallback(()=>e(),{timeout:50}):setTimeout(e,0);})}async function hb(e,t,n,r,o,a,i,s=5,l=0){if(!t.ready||!a.enabled)return 0;const d=e.length;let c=0;i?.(0,d);for(let u=0;u<d;u+=s){const p=e.slice(u,u+s);for(const f of p)try{const g=Pr(null,f,t.textures,t.animations),m={scale:1},h=qd(m),b=Kd(h,m),w=Jd(h,m.boundsPadding),C=Vd(g,m,h,b,w);o.cache.has(C)||ki(t,n,r,null,f,m,o,a),c++;}catch{c++;}i?.(c,d),u+s<d&&await mb();}return c}function bb(e){if(e.overlay)return e.overlay;const t=new e.ctors.Container;t.sortableChildren=true,t.zIndex=99999999;try{e.app.stage.sortableChildren=!0;}catch{}return e.app.stage.addChild(t),e.overlay=t,t}function xb(e){const t=e.defaultParent;if(!t)return null;try{return typeof t=="function"?t():t}catch{return null}}function Ss(e,t,n,r,o,a){if(!n.length)return t;const i=Dd(n);if(!i.sig)return t;const s=zd(e,i),l=jd(o,s);if(l?.tex)return l.tex;const d=Wd(t,e,i,{renderer:r.renderer,ctors:r.ctors,textures:r.textures,cacheState:o,cacheConfig:a});return d?(Ud(o,s,{isAnim:false,tex:d},a),d):t}function Xd(e,t,n,r,o,a){if(!n.length)return t;const i=Dd(n);if(!i.sig)return t;const s=zd(e,i),l=jd(o,s);if(l?.isAnim&&l.frames?.length)return l.frames;const d=db(t,e,i,{renderer:r.renderer,ctors:r.ctors,textures:r.textures,cacheState:o,cacheConfig:a});return d?(Ud(o,s,{isAnim:true,frames:d},a),d):t}function Dl(e,t,n,r,o,a={}){if(!e.ready)throw new Error("MGSprite not ready yet");const i=Pr(r,o,e.textures,e.animations),s=a.mutations||[],l=a.parent||xb(e)||bb(e),d=e.renderer?.width||e.renderer?.view?.width||innerWidth,c=e.renderer?.height||e.renderer?.view?.height||innerHeight,u=a.center?d/2:a.x??d/2,p=a.center?c/2:a.y??c/2;let f;const g=e.animations.get(i);if(g&&g.length>=2){const b=Xd(i,g,s,e,t,n),w=e.ctors.AnimatedSprite;if(w)f=new w(b),f.animationSpeed=a.fps?a.fps/60:a.speed??.15,f.loop=a.loop??true,f.play();else {const C=new e.ctors.Sprite(b[0]),_=1e3/Math.max(1,a.fps||8);let y=0,S=0;const T=k=>{const P=e.app.ticker?.deltaMS??k*16.666666666666668;if(y+=P,y<_)return;const E=y/_|0;y%=_,S=(S+E)%b.length,C.texture=b[S];};C.__mgTick=T,e.app.ticker?.add?.(T),f=C;}}else {const b=e.textures.get(i);if(!b)throw new Error(`Unknown sprite/anim key: ${i}`);const w=Ss(i,b,s,e,t,n);f=new e.ctors.Sprite(w);}const m=a.anchorX??f.texture?.defaultAnchor?.x??.5,h=a.anchorY??f.texture?.defaultAnchor?.y??.5;return f.anchor?.set?.(m,h),f.position.set(u,p),f.scale.set(a.scale??1),f.alpha=a.alpha??1,f.rotation=a.rotation??0,f.zIndex=a.zIndex??999999,l.addChild(f),e.live.add(f),f.__mgDestroy=()=>{try{f.__mgTick&&e.app.ticker?.remove?.(f.__mgTick);}catch{}try{f.destroy?.({children:!0,texture:!1,baseTexture:!1});}catch{try{f.destroy?.();}catch{}}e.live.delete(f);},f}function yb(e,t){const n=e.renderer;if(n?.extract?.canvas)return n.extract.canvas(t);if(n?.plugins?.extract?.canvas)return n.plugins.extract.canvas(t);throw new Error("No extract.canvas available on renderer")}const Gl=new Map;function qd(e){return e.boundsMode?e.boundsMode:e.mutations&&e.mutations.length>0?"base":"mutations"}function Kd(e,t){return e==="mutations"?t.pad??2:t.pad??0}function Hn(e){return Number.isFinite(e)?Math.max(0,e):0}function Yd(e){if(typeof e=="number"){const t=Hn(e);return {top:t,right:t,bottom:t,left:t}}return e?{top:Hn(e.top??0),right:Hn(e.right??0),bottom:Hn(e.bottom??0),left:Hn(e.left??0)}:{top:0,right:0,bottom:0,left:0}}function Jd(e,t){if(e==="mutations")return "0,0,0,0";if(e==="padded"&&t==null)return "auto";const n=Yd(t);return `${n.top},${n.right},${n.bottom},${n.left}`}function Qd(e){const t=e?.orig?.width??e?.frame?.width??e?.width??1,n=e?.orig?.height??e?.frame?.height??e?.height??1;return {w:t,h:n}}function Zd(e,t,n){const r=e?.__mg_base;return r&&Number.isFinite(r.baseX)&&Number.isFinite(r.baseY)&&Number.isFinite(r.baseW)&&Number.isFinite(r.baseH)&&Number.isFinite(r.texW)&&Number.isFinite(r.texH)?r:{baseX:0,baseY:0,baseW:t,baseH:n,texW:t,texH:n}}function vb(e,t,n,r,o,a){const i=`${e}|f${t}`,s=Gl.get(i);if(s)return s;const l=Qd(n),d={top:0,right:0,bottom:0,left:0};for(const c of Bd){const u=Ss(e,n,[c],r,o,a),p=Zd(u,l.w,l.h),f=Math.max(0,p.baseX),g=Math.max(0,p.baseY),m=Math.max(0,p.texW-p.baseX-p.baseW),h=Math.max(0,p.texH-p.baseY-p.baseH);f>d.left&&(d.left=f),g>d.top&&(d.top=g),m>d.right&&(d.right=m),h>d.bottom&&(d.bottom=h);}return Gl.set(i,d),d}function ki(e,t,n,r,o,a={},i,s){if(!e.ready)throw new Error("MGSprite not ready yet");const l=Pr(r,o,e.textures,e.animations),d=qd(a),c=Kd(d,a),u=Jd(d,a.boundsPadding),p=i&&s?.enabled?Vd(l,a,d,c,u):null;if(p&&i&&s?.enabled){const C=ub(i,p);if(C)return Bl(C)}const f=a.mutations||[],g=e.animations.get(l),m=Math.max(0,(a.frameIndex??0)|0);let h,b;if(g?.length)if(h=g[m%g.length],f.length){const C=Xd(l,g,f,e,t,n);b=C[m%C.length];}else b=h;else {const C=e.textures.get(l);if(!C)throw new Error(`Unknown sprite/anim key: ${l}`);h=C,b=Ss(l,C,f,e,t,n);}let w;if(d==="mutations"){const C=new e.ctors.Sprite(b),v=a.anchorX??C.texture?.defaultAnchor?.x??.5,_=a.anchorY??C.texture?.defaultAnchor?.y??.5;C.anchor?.set?.(v,_),C.scale.set(a.scale??1);const y=new e.ctors.Container;y.addChild(C);try{y.updateTransform?.();}catch{}const S=C.getBounds?.(true)||{x:0,y:0,width:C.width,height:C.height};C.position.set(-S.x+c,-S.y+c),w=yb(e,y);try{y.destroy?.({children:!0});}catch{}}else {const C=a.scale??1;let v=Yd(a.boundsPadding);d==="padded"&&a.boundsPadding==null&&(v=vb(l,m,h,e,t,n)),c&&(v={top:v.top+c,right:v.right+c,bottom:v.bottom+c,left:v.left+c});const _=Qd(h),y=Zd(b,_.w,_.h),S=Math.max(1,Math.ceil((_.w+v.left+v.right)*C)),T=Math.max(1,Math.ceil((_.h+v.top+v.bottom)*C));w=document.createElement("canvas"),w.width=S,w.height=T;const k=w.getContext("2d");if(k){k.imageSmoothingEnabled=false;const P=ga(b,e.renderer,e.ctors,t,n),E=(v.left-y.baseX)*C,B=(v.top-y.baseY)*C;k.drawImage(P,E,B,P.width*C,P.height*C);}}return p&&i&&s?.enabled?(pb(i,s,p,w),Bl(w)):w}function wb(e){for(const t of Array.from(e.live))t.__mgDestroy?.();}function Sb(e,t){return e.defaultParent=t,true}function Cb(e,t){return e.defaultParent=t,true}function on(){if(!Fd())throw new Error("MGSprite not ready yet")}function kb(e,t,n){return typeof t=="string"?Dl(Ge(),Pn(),_r(),e,t,n||{}):Dl(Ge(),Pn(),_r(),null,e,t||{})}function _b(e,t,n){return typeof t=="string"?ki(Ge(),Pn(),_r(),e,t,n||{},Tr(),Ci()):ki(Ge(),Pn(),_r(),null,e,t||{},Tr(),Ci())}function Tb(){wb(Ge());}function Pb(e){return Sb(Ge(),e)}function Ib(e){return Cb(Ge(),e)}function Ab(e,t){const n=Ge(),r=typeof t=="string"?Pr(e,t,n.textures,n.animations):Pr(null,e,n.textures,n.animations);return n.textures.has(r)||n.animations.has(r)}function Eb(){on();const e=Ge().categoryIndex;return e?Array.from(e.keys()).sort((t,n)=>t.localeCompare(n)):[]}function Mb(e){on();const t=String(e||"").trim();if(!t)return [];const n=Ge().categoryIndex;return n?Array.from(n.get(t)?.values()||[]):[]}function Rb(e,t){on();const n=String(e||"").trim(),r=String(t||"").trim();if(!n||!r)return  false;const o=Ge().categoryIndex;if(!o)return  false;const a=n.toLowerCase(),i=r.toLowerCase();for(const[s,l]of o.entries())if(s.toLowerCase()===a){for(const d of l.values())if(d.toLowerCase()===i)return  true}return  false}function Lb(e){on();const t=Ge().categoryIndex;if(!t)return [];const n=String(e||"").trim().toLowerCase(),r=[];for(const[o,a]of t.entries())for(const i of a.values()){const s=Gr(o,i);(!n||s.toLowerCase().startsWith(n))&&r.push(s);}return r.sort((o,a)=>o.localeCompare(a))}function Fb(e){on();const t=String(e||"").trim();if(!t)return null;const n=ta(t),r=/^sprite\/([^/]+)\/(.+)$/.exec(n);if(!r)return null;const o=r[1],a=r[2],i=Ge().categoryIndex,s=o.toLowerCase(),l=a.toLowerCase();let d=o,c=a;if(i){const u=Array.from(i.keys()).find(g=>g.toLowerCase()===s);if(!u)return null;d=u;const p=i.get(u);if(!p)return null;const f=Array.from(p.values()).find(g=>g.toLowerCase()===l);if(!f)return null;c=f;}return {category:d,id:c,key:Gr(d,c)}}function Nb(e,t){on();const n=String(e||"").trim(),r=String(t||"").trim();if(!n||!r)throw new Error("getIdPath(category, id) requires both category and id");const o=Ge().categoryIndex;if(!o)throw new Error("Sprite categories not indexed");const a=n.toLowerCase(),i=r.toLowerCase(),s=Array.from(o.keys()).find(c=>c.toLowerCase()===a)||n,l=o.get(s);if(!l)throw new Error(`Unknown sprite category: ${n}`);const d=Array.from(l.values()).find(c=>c.toLowerCase()===i)||r;if(!l.has(d))throw new Error(`Unknown sprite id: ${n}/${r}`);return Gr(s,d)}function Ob(){ob(Pn());}function $b(){fb(Tr());}function Bb(){return gb(Tr())}function Db(){return [...Bd]}async function Gb(e,t,n=10,r=0){return on(),hb(e,Ge(),Pn(),_r(),Tr(),Ci(),t,n,r)}const j={init:Oh,isReady:Fd,show:kb,toCanvas:_b,clear:Tb,attach:Pb,attachProvider:Ib,has:Ab,key:(e,t)=>Gr(e,t),getCategories:Eb,getCategoryId:Mb,hasId:Rb,listIds:Lb,getIdInfo:Fb,getIdPath:Nb,clearMutationCache:Ob,clearToCanvasCache:$b,getToCanvasCacheStats:Bb,getMutationNames:Db,warmup:Gb};function zb(e){return String(e||"").normalize("NFD").replace(/[\u0300-\u036f]/g,"").replace(/[^A-Za-z0-9]/g,"").trim()}function Hb(e,t=[]){const n=new Set,r=o=>{const a=String(o||"").trim();a&&n.add(a);};r(e);for(const o of t)r(o);for(const o of Array.from(n.values()))o.endsWith("s")?r(o.slice(0,-1)):r(`${o}s`),o.endsWith("es")&&r(o.slice(0,-2));return Array.from(n.values()).filter(Boolean)}function eu(e,t,n,r=[],o=[]){if(!j)return console.warn("[MGData] MGSprite not available in pickSpriteId"),null;const a=Hb(e,r);if(!a.length)return null;const i=[t,...o].filter(c=>typeof c=="string"),s=c=>{const u=String(c||"").trim();if(!u)return null;for(const p of a)try{if(j.has(p,u))return j.getIdPath(p,u)}catch{}return null};for(const c of i){const u=s(c);if(u)return u}const l=zb(n||""),d=s(l||n||"");if(d)return d;try{for(const c of a){const u=j.listIds(`sprite/${c}/`),p=i.map(g=>String(g||"").toLowerCase()),f=String(n||l||"").toLowerCase();for(const g of u){const h=(g.split("/").pop()||"").toLowerCase();if(p.some(b=>b&&b===h)||h===f)return g}for(const g of u){const h=(g.split("/").pop()||"").toLowerCase();if(p.some(b=>b&&(h.includes(b)||b.includes(h)))||f&&(h.includes(f)||f.includes(h)))return g}}}catch{}return null}function Ye(e,t,n,r,o=[],a=[]){if(!e||typeof e!="object")return;const i=e.tileRef;if(!i||typeof i!="object")return;const s=String(i.spritesheet||t||"").trim(),l=eu(s,n,r,o,a);if(l)try{e.spriteId=l;}catch{}const d=e.rotationVariants;if(d&&typeof d=="object")for(const c of Object.values(d))Ye(c,s,n,r);if(e.immatureTileRef){const c={tileRef:e.immatureTileRef};Ye(c,s,n,r),c.spriteId&&(e.immatureSpriteId=c.spriteId);}if(e.topmostLayerTileRef){const c={tileRef:e.topmostLayerTileRef};Ye(c,s,n,r),c.spriteId&&(e.topmostLayerSpriteId=c.spriteId);}e.activeState&&typeof e.activeState=="object"&&Ye(e.activeState,s,n,e.activeState?.name||r);}function jb(e,t,n,r=[]){if(!Array.isArray(t)||t.length===0)return null;const o=t[0],a=t.slice(1);return eu(e,o,n??null,r,a)}function Ub(e){for(const[t,n]of Object.entries(e.items||{}))Ye(n,"items",t,n?.name,["item"]);for(const[t,n]of Object.entries(e.decor||{}))Ye(n,"decor",t,n?.name);for(const[t,n]of Object.entries(e.mutations||{})){Ye(n,"mutations",t,n?.name,["mutation"]);const r=jb("mutation-overlay",[`${t}TallPlant`,`${t}TallPlantIcon`,t],n?.name,["mutation-overlay"]);if(r)try{n.overlaySpriteId=r;}catch{}}for(const[t,n]of Object.entries(e.eggs||{}))Ye(n,"pets",t,n?.name,["pet"]);for(const[t,n]of Object.entries(e.pets||{}))Ye(n,"pets",t,n?.name,["pet"]);for(const[t,n]of Object.entries(e.plants||{})){const r=n;r.seed&&Ye(r.seed,r.seed?.tileRef?.spritesheet||"seeds",`${t}Seed`,r.seed?.name||`${t} Seed`,["seed","plant","plants"],[t]),r.plant&&Ye(r.plant,r.plant?.tileRef?.spritesheet||"plants",`${t}Plant`,r.plant?.name||`${t} Plant`,["plant","plants","tallplants"],[t]),r.crop&&Ye(r.crop,r.crop?.tileRef?.spritesheet||"plants",t,r.crop?.name||t,["plant","plants"],[`${t}Crop`]);}}function Wb(){try{console.log("[MGData] Resolving sprites..."),Ub(Q.data),console.log("[MGData] Sprite resolution complete");}catch(e){try{console.warn("[MGData] sprite resolution failed",e);}catch{}}}const tu=1e4,nu=50;function ru(e){return new Promise(t=>setTimeout(t,e))}function Vb(e){return Q.data[e]}function Xb(){return {...Q.data}}function qb(e){return Q.data[e]!=null}async function Kb(e,t=tu,n=nu){const r=Date.now();for(;Date.now()-r<t;){const o=Q.data[e];if(o!=null)return o;await ru(n);}throw new Error(`MGData.waitFor: timeout waiting for "${e}"`)}async function Yb(e=tu,t=nu){const n=Date.now();for(;Date.now()-n<e;){if(Object.values(Q.data).some(r=>r!=null))return {...Q.data};await ru(t);}throw new Error("MGData.waitForAnyData: timeout")}const ou=["CoinFinderI","CoinFinderII","CoinFinderIII","SeedFinderI","SeedFinderII","SeedFinderIII","SeedFinderIV","HungerRestore","HungerRestoreII","DoubleHarvest","DoubleHatch","ProduceEater","PetHatchSizeBoost","PetHatchSizeBoostII","PetAgeBoost","PetAgeBoostII","PetRefund","PetRefundII","ProduceRefund","SellBoostI","SellBoostII","SellBoostIII","SellBoostIV","GoldGranter","RainbowGranter","RainDance","PetXpBoost","PetXpBoostII","EggGrowthBoost","EggGrowthBoostII_NEW","EggGrowthBoostII","PlantGrowthBoost","PlantGrowthBoostII","ProduceScaleBoost","ProduceScaleBoostII"];function au(e){return ou.includes(e)}function iu(e){return e.filter(t=>au(t.action))}function zl(e){const t=Math.floor(e/3600),n=Math.floor(e%3600/60),r=Math.floor(e%60);return t>0?`${t}h ${n}m`:n>0?`${n}m ${r}s`:`${r}s`}function Ua(e){return e?.name||e?.petSpecies||"Unknown Pet"}function su(e){const{action:t,parameters:n}=e,r=n;switch(t){case "CoinFinderI":case "CoinFinderII":case "CoinFinderIII":return `Found ${r.coinsFound||0} coins`;case "SeedFinderI":case "SeedFinderII":case "SeedFinderIII":case "SeedFinderIV":return `Found 1× ${r.speciesId||"Unknown"} seed`;case "HungerRestore":case "HungerRestoreII":{const o=Ua(r.targetPet),a=r.hungerRestoreAmount||0,s=r.pet?.id===r.targetPet?.id?"itself":o;return `Restored ${a} hunger to ${s}`}case "DoubleHarvest":return `Double harvested ${r.harvestedCrop?.species||"Unknown"}`;case "DoubleHatch":return `Double hatched ${r.extraPet?.petSpecies||"Unknown"}`;case "ProduceEater":{const o=r.growSlot?.species||"Unknown",a=r.sellPrice||0;return `Ate ${o} for ${a} coins`}case "PetHatchSizeBoost":case "PetHatchSizeBoostII":{const o=Ua(r.targetPet),a=r.strengthIncrease||0;return `Boosted ${o}'s size by +${a.toFixed(0)}`}case "PetAgeBoost":case "PetAgeBoostII":{const o=Ua(r.targetPet);return `Gave +${r.bonusXp||0} XP to ${o}`}case "PetRefund":case "PetRefundII":return `Refunded 1× ${r.eggId||"Unknown Egg"}`;case "ProduceRefund":{const o=r.cropsRefunded?.length||0;return `Refunded ${o} ${o===1?"crop":"crops"}`}case "SellBoostI":case "SellBoostII":case "SellBoostIII":case "SellBoostIV":return `Gave +${r.bonusCoins||0} bonus coins`;case "GoldGranter":case "RainbowGranter":case "RainDance":{const o=r.mutation||"Unknown";return `Made ${r.growSlot?.species||"Unknown"} turn ${o}`}case "PetXpBoost":case "PetXpBoostII":{const o=r.bonusXp||0,a=r.petsAffected?.length||0;return `Gave +${o} XP to ${a} ${a===1?"pet":"pets"}`}case "EggGrowthBoost":case "EggGrowthBoostII_NEW":case "EggGrowthBoostII":{const o=r.secondsReduced||0,a=r.eggsAffected?.length||0,i=zl(o);return `Reduced ${a} ${a===1?"egg":"eggs"} growth by ${i}`}case "PlantGrowthBoost":case "PlantGrowthBoostII":{const o=r.secondsReduced||0,a=r.numPlantsAffected||0,i=zl(o);return `Reduced ${a} ${a===1?"plant":"plants"} growth by ${i}`}case "ProduceScaleBoost":case "ProduceScaleBoostII":{const o=r.scaleIncreasePercentage||0,a=r.numPlantsAffected||0;return `Boosted ${a} ${a===1?"crop":"crops"} size by +${o.toFixed(0)}%`}default:return `Unknown ability: ${t}`}}const K={async init(){Ed(),Xm(),Zm(),sh();},isReady:ea,get:Vb,getAll:Xb,has:qb,waitFor:Kb,waitForAny:Yb,resolveSprites:Wb,cleanup(){Md(),Rd(),eh(),lh();}},Jb=new Map;function Qb(){return Jb}function _i(){return F.jotaiAtomCache?.cache}function Nt(e){const t=Qb(),n=t.get(e);if(n)return n;const r=_i();if(!r)return null;for(const o of r.values())if((o?.debugLabel||o?.label||"")===e)return t.set(e,o),o;return null}function Zb(){const e=F;if(e.__REACT_DEVTOOLS_GLOBAL_HOOK__)return;const t=new Map,n=new Map;e.__REACT_DEVTOOLS_GLOBAL_HOOK__={renderers:t,supportsFiber:true,inject:r=>{const o=t.size+1;return t.set(o,r),n.set(o,new Set),o},onCommitFiberRoot:(r,o)=>{const a=n.get(r);a&&a.add(o);},onCommitFiberUnmount:()=>{},onPostCommitFiberRoot:()=>{},getFiberRoots:r=>n.get(r),checkDCE:()=>{},isDisabled:false};}const ex={baseStore:null,captureInProgress:false,captureError:null,lastCapturedVia:null,mirror:void 0};function En(){return ex}const tx="__JOTAI_STORE_READY__";let Hl=false;const Ti=new Set;function so(){if(!Hl){Hl=true;for(const e of Ti)try{e();}catch{}try{const e=F.CustomEvent||CustomEvent;F.dispatchEvent?.(new e(tx));}catch{}}}function nx(e){Ti.add(e);const t=Ii();if(t.via&&!t.polyfill)try{e();}catch{}return ()=>{Ti.delete(e);}}async function rx(e={}){const{timeoutMs:t=6e3,intervalMs:n=50}=e,r=Ii();if(!(r.via&&!r.polyfill))return new Promise((o,a)=>{let i=false;const s=nx(()=>{i||(i=true,s(),o());}),l=Date.now();(async()=>{for(;!i&&Date.now()-l<t;){const c=Ii();if(c.via&&!c.polyfill){if(i)return;i=true,s(),o();return}await Ir(n);}i||(i=true,s(),a(new Error("Store not captured within timeout")));})();})}const Ir=e=>new Promise(t=>setTimeout(t,e));function lu(){try{const e=F.Event||Event;F.dispatchEvent?.(new e("visibilitychange"));}catch{}}function Pi(e){return e&&typeof e=="object"&&typeof e.get=="function"&&typeof e.set=="function"&&typeof e.sub=="function"}function Wa(e,t=0,n=new WeakSet){if(t>3||!e||typeof e!="object"||n.has(e))return null;try{n.add(e);}catch{return null}if(Pi(e))return e;const r=["store","value","current","state","s","baseStore"];for(const o of r)try{const a=e[o];if(Pi(a))return a}catch{}return null}function cu(){const e=En(),t=F.__REACT_DEVTOOLS_GLOBAL_HOOK__;if(!t?.renderers?.size)return null;let n=0;for(const[r]of t.renderers){const o=t.getFiberRoots?.(r);o&&(n+=o.size||0);}if(n===0)return null;for(const[r]of t.renderers){const o=t.getFiberRoots?.(r);if(o)for(const a of o){const i=new Set,s=[a.current];for(;s.length;){const l=s.pop();if(!(!l||i.has(l))){i.add(l);try{const d=l?.pendingProps?.value;if(Pi(d))return e.lastCapturedVia="fiber",d}catch{}try{let d=l?.memoizedState,c=0;for(;d&&c<15;){c++;const u=Wa(d);if(u)return e.lastCapturedVia="fiber",u;const p=Wa(d.memoizedState);if(p)return e.lastCapturedVia="fiber",p;d=d.next;}}catch{}try{if(l?.stateNode){const d=Wa(l.stateNode);if(d)return e.lastCapturedVia="fiber",d}}catch{}l.child&&s.push(l.child),l.sibling&&s.push(l.sibling),l.alternate&&s.push(l.alternate);}}}}return null}function du(){return {get:()=>{throw new Error("Store not captured: get unavailable")},set:()=>{throw new Error("Store not captured: set unavailable")},sub:()=>()=>{},__polyfill:true}}async function ox(e=5e3){const t=Date.now();let n=_i();for(;!n&&Date.now()-t<e;)await Ir(100),n=_i();if(!n)throw new Error("jotaiAtomCache.cache not found");const r=En();let o=null,a=null;const i=[],s=()=>{for(const d of i)try{d.__origWrite&&(d.write=d.__origWrite,delete d.__origWrite);}catch{}};for(const d of n.values()){if(!d||typeof d.write!="function"||d.__origWrite)continue;const c=d.write;d.__origWrite=c,d.write=function(u,p,...f){return a||(o=u,a=p,s()),c.call(this,u,p,...f)},i.push(d);}lu();const l=Date.now();for(;!a&&Date.now()-l<e;)await Ir(50);return a?(r.lastCapturedVia="write",{get:d=>o(d),set:(d,c)=>a(d,c),sub:(d,c)=>{let u;try{u=o(d);}catch{}const p=setInterval(()=>{let f;try{f=o(d);}catch{return}if(f!==u){u=f;try{c();}catch{}}},100);return ()=>clearInterval(p)}}):(s(),r.lastCapturedVia="polyfill",du())}async function ax(e=1e4){const t=En();lu();const n=Date.now();for(;Date.now()-n<e;){const r=cu();if(r)return r;await Ir(50);}return t.lastCapturedVia="polyfill",du()}async function Cs(){const e=En();if(e.baseStore&&!e.baseStore.__polyfill)return so(),e.baseStore;if(e.captureInProgress){const t=Date.now(),n=2500;for(;!e.baseStore&&Date.now()-t<n;)await Ir(25);if(e.baseStore)return e.baseStore.__polyfill||so(),e.baseStore}e.captureInProgress=true;try{const t=cu();if(t)return e.baseStore=t,so(),t;try{const r=await ox(5e3);return e.baseStore=r,r.__polyfill||so(),r}catch(r){e.captureError=r;}const n=await ax();return e.baseStore=n,n}catch(t){throw e.captureError=t,t}finally{e.captureInProgress=false;}}function Ii(){const e=En();return {via:e.lastCapturedVia,polyfill:!!e.baseStore?.__polyfill,error:e.captureError}}async function ix(){const e=await Cs(),t=new WeakMap,n=async o=>{let a=t.get(o);if(a)return a;a={last:void 0,has:false,subs:new Set},t.set(o,a);try{a.last=e.get(o),a.has=!0;}catch{}const i=e.sub(o,()=>{let s;try{s=e.get(o);}catch{return}const l=a.last,d=!Object.is(s,l)||!a.has;if(a.last=s,a.has=true,d)for(const c of a.subs)try{c(s,l);}catch{}});return a.unsubUpstream=i,a};return {async get(o){const a=await n(o);if(a.has)return a.last;const i=e.get(o);return a.last=i,a.has=true,i},async set(o,a){await e.set(o,a);const i=await n(o);i.last=a,i.has=true;},async sub(o,a){const i=await n(o);if(i.subs.add(a),i.has)try{a(i.last,i.last);}catch{}return ()=>{i.subs.delete(a);}},getShadow(o){return t.get(o)?.last},hasShadow(o){return !!t.get(o)?.has},async ensureWatch(o){await n(o);},async asStore(){return {get:o=>this.get(o),set:(o,a)=>this.set(o,a),sub:(o,a)=>{let i=null;return this.sub(o,()=>a()).then(s=>i=s),()=>i?.()}}}}}async function Bo(){const e=En();return e.mirror||(e.mirror=await ix()),e.mirror}const ge={async select(e){const t=await Bo(),n=Nt(e);if(!n)throw new Error(`[Store] Atom not found: "${e}"`);return t.get(n)},async set(e,t){const n=await Bo(),r=Nt(e);if(!r)throw new Error(`[Store] Atom not found: "${e}"`);await n.set(r,t);},async subscribe(e,t){const n=await Bo(),r=Nt(e);if(!r)throw new Error(`[Store] Atom not found: "${e}"`);return n.sub(r,o=>{try{t(o);}catch{}})},async subscribeImmediate(e,t){const n=await ge.select(e);try{t(n);}catch{}return ge.subscribe(e,t)}};async function sx(){await Bo();}function ks(e){return e?Array.isArray(e)?e.slice():e.split(".").map(t=>t.match(/^\d+$/)?Number(t):t):[]}function Ar(e,t){const n=ks(t);let r=e;for(const o of n){if(r==null)return;r=r[o];}return r}function lx(e,t,n){const r=ks(t);if(!r.length)return n;const o=Array.isArray(e)?[...e]:{...e??{}};let a=o;for(let i=0;i<r.length-1;i++){const s=r[i],l=a[s],d=typeof l=="object"&&l!==null?Array.isArray(l)?[...l]:{...l}:{};a[s]=d,a=d;}return a[r[r.length-1]]=n,o}function jl(e,t){const n={};for(const r of t)n[r]=r.includes(".")?Ar(e,r):e?.[r];try{return JSON.stringify(n)}catch{return String(n)}}function cx(e,t,n){const r=n.mode??"auto";function o(d){const c=t?Ar(d,t):d,u=new Map;if(c==null)return {signatures:u,keys:[]};const p=Array.isArray(c);if((r==="array"||r==="auto"&&p)&&p)for(let g=0;g<c.length;g++){const m=c[g],h=n.key?n.key(m,g,d):g,b=n.sig?n.sig(m,g,d):n.fields?jl(m,n.fields):JSON.stringify(m);u.set(h,b);}else for(const[g,m]of Object.entries(c)){const h=n.key?n.key(m,g,d):g,b=n.sig?n.sig(m,g,d):n.fields?jl(m,n.fields):JSON.stringify(m);u.set(h,b);}return {signatures:u,keys:Array.from(u.keys())}}function a(d,c){if(d===c)return  true;if(!d||!c||d.size!==c.size)return  false;for(const[u,p]of d)if(c.get(u)!==p)return  false;return  true}async function i(d){let c=null;return ge.subscribeImmediate(e,u=>{const p=t?Ar(u,t):u,{signatures:f}=o(p);if(!a(c,f)){const g=new Set([...c?Array.from(c.keys()):[],...Array.from(f.keys())]),m=[];for(const h of g){const b=c?.get(h)??"__NONE__",w=f.get(h)??"__NONE__";b!==w&&m.push(h);}c=f,d({value:p,changedKeys:m});}})}async function s(d,c){return i(({value:u,changedKeys:p})=>{p.includes(d)&&c({value:u});})}async function l(d,c){const u=new Set(d);return i(({value:p,changedKeys:f})=>{const g=f.filter(m=>u.has(m));g.length&&c({value:p,changedKeys:g});})}return {sub:i,subKey:s,subKeys:l}}const hn=new Map;function dx(e,t){const n=hn.get(e);if(n)try{n();}catch{}return hn.set(e,t),()=>{try{t();}catch{}hn.get(e)===t&&hn.delete(e);}}function me(e,t={}){const{path:n,write:r="replace"}=t,o=n?`${e}:${ks(n).join(".")}`:e;async function a(){const u=await ge.select(e);return n?Ar(u,n):u}async function i(u){if(typeof r=="function"){const g=await ge.select(e),m=r(u,g);return ge.set(e,m)}const p=await ge.select(e),f=n?lx(p,n,u):u;return r==="merge-shallow"&&!n&&p&&typeof p=="object"&&typeof u=="object"?ge.set(e,{...p,...u}):ge.set(e,f)}async function s(u){const p=await a(),f=u(p);return await i(f),f}async function l(u,p,f){let g;const m=b=>{const w=n?Ar(b,n):b;if(typeof g>"u"||!f(g,w)){const C=g;g=w,p(w,C);}},h=u?await ge.subscribeImmediate(e,m):await ge.subscribe(e,m);return dx(o,h)}function d(){const u=hn.get(o);if(u){try{u();}catch{}hn.delete(o);}}function c(u){return cx(e,u?.path??n,u)}return {label:o,get:a,set:i,update:s,onChange:(u,p=Object.is)=>l(false,u,p),onChangeNow:(u,p=Object.is)=>l(true,u,p),asSignature:c,stopOnChange:d}}function I(e){return me(e)}I("positionAtom");I("lastPositionInMyGardenAtom");I("playerDirectionAtom");I("stateAtom");I("quinoaDataAtom");I("currentTimeAtom");I("actionAtom");I("isPressAndHoldActionAtom");I("mapAtom");I("tileSizeAtom");me("mapAtom",{path:"cols"});me("mapAtom",{path:"rows"});me("mapAtom",{path:"spawnTiles"});me("mapAtom",{path:"locations.seedShop.spawnTileIdx"});me("mapAtom",{path:"locations.eggShop.spawnTileIdx"});me("mapAtom",{path:"locations.toolShop.spawnTileIdx"});me("mapAtom",{path:"locations.decorShop.spawnTileIdx"});me("mapAtom",{path:"locations.sellCropsShop.spawnTileIdx"});me("mapAtom",{path:"locations.sellPetShop.spawnTileIdx"});me("mapAtom",{path:"locations.collectorsClub.spawnTileIdx"});me("mapAtom",{path:"locations.wishingWell.spawnTileIdx"});me("mapAtom",{path:"locations.shopsCenter.spawnTileIdx"});I("playerAtom");I("myDataAtom");I("myUserSlotIdxAtom");I("isSpectatingAtom");I("myCoinsCountAtom");I("numPlayersAtom");me("playerAtom",{path:"id"});me("myDataAtom",{path:"activityLogs"});I("userSlotsAtom");I("filteredUserSlotsAtom");I("myUserSlotAtom");I("spectatorsAtom");me("stateAtom",{path:"child"});me("stateAtom",{path:"child.data"});me("stateAtom",{path:"child.data.shops"});const ux=me("stateAtom",{path:"child.data.userSlots"}),px=me("stateAtom",{path:"data.players"}),fx=me("stateAtom",{path:"data.hostPlayerId"});I("myInventoryAtom");I("myInventoryItemsAtom");I("isMyInventoryAtMaxLengthAtom");I("myFavoritedItemIdsAtom");I("myCropInventoryAtom");I("mySeedInventoryAtom");I("myToolInventoryAtom");I("myEggInventoryAtom");I("myDecorInventoryAtom");I("myPetInventoryAtom");me("myInventoryAtom",{path:"favoritedItemIds"});I("itemTypeFiltersAtom");I("myItemStoragesAtom");I("myPetHutchStoragesAtom");I("myPetHutchItemsAtom");I("myPetHutchPetItemsAtom");I("myNumPetHutchItemsAtom");I("myValidatedSelectedItemIndexAtom");I("isSelectedItemAtomSuspended");I("mySelectedItemAtom");I("mySelectedItemNameAtom");I("mySelectedItemRotationsAtom");I("mySelectedItemRotationAtom");I("setSelectedIndexToEndAtom");I("myPossiblyNoLongerValidSelectedItemIndexAtom");I("myCurrentGlobalTileIndexAtom");I("myCurrentGardenTileAtom");I("myCurrentGardenObjectAtom");I("myOwnCurrentGardenObjectAtom");I("myOwnCurrentDirtTileIndexAtom");I("myCurrentGardenObjectNameAtom");I("isInMyGardenAtom");I("myGardenBoardwalkTileObjectsAtom");const gx=me("myDataAtom",{path:"garden"});me("myDataAtom",{path:"garden.tileObjects"});me("myOwnCurrentGardenObjectAtom",{path:"objectType"});I("myCurrentStablePlantObjectInfoAtom");I("myCurrentSortedGrowSlotIndicesAtom");I("myCurrentGrowSlotIndexAtom");I("myCurrentGrowSlotsAtom");I("myCurrentGrowSlotAtom");I("secondsUntilCurrentGrowSlotMaturesAtom");I("isCurrentGrowSlotMatureAtom");I("numGrowSlotsAtom");I("myCurrentEggAtom");I("petInfosAtom");I("myPetInfosAtom");I("myPetSlotInfosAtom");I("myPrimitivePetSlotsAtom");I("myNonPrimitivePetSlotsAtom");I("expandedPetSlotIdAtom");I("myPetsProgressAtom");I("myActiveCropMutationPetsAtom");I("totalPetSellPriceAtom");I("selectedPetHasNewVariantsAtom");const mx=I("shopsAtom"),hx=I("myShopPurchasesAtom");I("seedShopAtom");I("seedShopInventoryAtom");I("seedShopRestockSecondsAtom");I("seedShopCustomRestockInventoryAtom");I("eggShopAtom");I("eggShopInventoryAtom");I("eggShopRestockSecondsAtom");I("eggShopCustomRestockInventoryAtom");I("toolShopAtom");I("toolShopInventoryAtom");I("toolShopRestockSecondsAtom");I("toolShopCustomRestockInventoryAtom");I("decorShopAtom");I("decorShopInventoryAtom");I("decorShopRestockSecondsAtom");I("decorShopCustomRestockInventoryAtom");I("isDecorShopAboutToRestockAtom");me("shopsAtom",{path:"seed"});me("shopsAtom",{path:"tool"});me("shopsAtom",{path:"egg"});me("shopsAtom",{path:"decor"});I("myCropItemsAtom");I("myCropItemsToSellAtom");I("totalCropSellPriceAtom");I("friendBonusMultiplierAtom");I("myJournalAtom");I("myCropJournalAtom");I("myPetJournalAtom");I("myStatsAtom");I("myActivityLogsAtom");I("newLogsAtom");I("hasNewLogsAtom");I("newCropLogsFromSellingAtom");I("hasNewCropLogsFromSellingAtom");I("myCompletedTasksAtom");I("myActiveTasksAtom");I("isWelcomeToastVisibleAtom");I("shouldCloseWelcomeToastAtom");I("isInitialMoveToDirtPatchToastVisibleAtom");I("isFirstPlantSeedActiveAtom");I("isThirdSeedPlantActiveAtom");I("isThirdSeedPlantCompletedAtom");I("isDemoTouchpadVisibleAtom");I("areShopAnnouncersEnabledAtom");I("arePresentablesEnabledAtom");I("isEmptyDirtTileHighlightedAtom");I("isPlantTileHighlightedAtom");I("isItemHiglightedInHotbarAtom");I("isItemHighlightedInModalAtom");I("isMyGardenButtonHighlightedAtom");I("isSellButtonHighlightedAtom");I("isShopButtonHighlightedAtom");I("isInstaGrowButtonHiddenAtom");I("isActionButtonHighlightedAtom");I("isGardenItemInfoCardHiddenAtom");I("isSeedPurchaseButtonHighlightedAtom");I("isFirstSeedPurchaseActiveAtom");I("isFirstCropHarvestActiveAtom");I("isWeatherStatusHighlightedAtom");const bx=I("weatherAtom"),_s=I("activeModalAtom");I("hotkeyBeingPressedAtom");I("avatarTriggerAnimationAtom");I("avatarDataAtom");I("emoteDataAtom");I("otherUserSlotsAtom");I("otherPlayerPositionsAtom");I("otherPlayerSelectedItemsAtom");I("otherPlayerLastActionsAtom");I("traderBunnyPlayerId");I("npcPlayersAtom");I("npcQuinoaUsersAtom");I("numNpcAvatarsAtom");I("traderBunnyEmoteTimeoutAtom");I("traderBunnyEmoteAtom");I("unsortedLeaderboardAtom");I("currentGardenNameAtom");I("quinoaEngineAtom");I("quinoaInitializationErrorAtom");I("avgPingAtom");I("serverClientTimeOffsetAtom");I("isEstablishingShotRunningAtom");I("isEstablishingShotCompleteAtom");const ce={initialized:false,activeModal:null,isCustom:false,shadow:null,patchedAtoms:new Set,originalReads:new Map,unsubscribes:[],listeners:{onOpen:new Set,onClose:new Set}};function ma(){return ce}function xx(){return ce.initialized}function an(){return ce.isCustom&&ce.activeModal!==null}function Qt(){return ce.activeModal}function uu(e){return !ce.shadow||ce.shadow.modal!==e?null:ce.shadow.data}function yx(e){ce.initialized=e;}function Ts(e){ce.activeModal=e;}function Ps(e){ce.isCustom=e;}function pu(e,t){ce.shadow={modal:e,data:t,timestamp:Date.now()};}function fu(){ce.shadow=null;}function Ul(e,t){ce.patchedAtoms.add(e),ce.originalReads.set(e,t);}function vx(e){return ce.originalReads.get(e)}function Ai(e){return ce.patchedAtoms.has(e)}function wx(e){ce.patchedAtoms.delete(e),ce.originalReads.delete(e);}function Sx(e){ce.unsubscribes.push(e);}function Cx(){for(const e of ce.unsubscribes)try{e();}catch{}ce.unsubscribes.length=0;}function kx(e){return ce.listeners.onOpen.add(e),()=>ce.listeners.onOpen.delete(e)}function gu(e){return ce.listeners.onClose.add(e),()=>ce.listeners.onClose.delete(e)}function mu(e){for(const t of Array.from(ce.listeners.onOpen))try{t(e);}catch{}}function Is(e){for(const t of Array.from(ce.listeners.onClose))try{t(e);}catch{}}function _x(){Cx(),ce.initialized=false,ce.activeModal=null,ce.isCustom=false,ce.shadow=null,ce.patchedAtoms.clear(),ce.originalReads.clear(),ce.listeners.onOpen.clear(),ce.listeners.onClose.clear();}const As={inventory:{atoms:[{atomLabel:"myInventoryAtom",dataKey:"_full",transform:e=>{const t=e;return {items:t.items??[],storages:t.storages??[],favoritedItemIds:t.favoritedItemIds??[]}}}],derivedAtoms:[{atomLabel:"myCropInventoryAtom",sourceKey:"items",deriveFn:e=>Array.isArray(e)?e.filter(t=>t.itemType==="Produce"):[]},{atomLabel:"mySeedInventoryAtom",sourceKey:"items",deriveFn:e=>Array.isArray(e)?e.filter(t=>t.itemType==="Seed"):[]},{atomLabel:"myToolInventoryAtom",sourceKey:"items",deriveFn:e=>Array.isArray(e)?e.filter(t=>t.itemType==="Tool"):[]},{atomLabel:"myEggInventoryAtom",sourceKey:"items",deriveFn:e=>Array.isArray(e)?e.filter(t=>t.itemType==="Egg"):[]},{atomLabel:"myDecorInventoryAtom",sourceKey:"items",deriveFn:e=>Array.isArray(e)?e.filter(t=>t.itemType==="Decor"):[]},{atomLabel:"myPetInventoryAtom",sourceKey:"items",deriveFn:e=>Array.isArray(e)?e.filter(t=>t.itemType==="Pet"):[]}]},journal:{atoms:[{atomLabel:"myJournalAtom",dataKey:"_full"}],derivedAtoms:[{atomLabel:"myCropJournalAtom",sourceKey:"produce",deriveFn:e=>e??{}},{atomLabel:"myPetJournalAtom",sourceKey:"pets",deriveFn:e=>e??{}}]},stats:{atoms:[{atomLabel:"myStatsAtom",dataKey:"_full"}]},activityLog:{atoms:[{atomLabel:"myActivityLogsAtom",dataKey:"logs"}]},seedShop:{atoms:[{atomLabel:"seedShopInventoryAtom",dataKey:"inventory"},{atomLabel:"seedShopRestockSecondsAtom",dataKey:"secondsUntilRestock",transform:e=>e??0}]},eggShop:{atoms:[{atomLabel:"eggShopInventoryAtom",dataKey:"inventory"},{atomLabel:"eggShopRestockSecondsAtom",dataKey:"secondsUntilRestock",transform:e=>e??0}]},toolShop:{atoms:[{atomLabel:"toolShopInventoryAtom",dataKey:"inventory"},{atomLabel:"toolShopRestockSecondsAtom",dataKey:"secondsUntilRestock",transform:e=>e??0}]},decorShop:{atoms:[{atomLabel:"decorShopInventoryAtom",dataKey:"inventory"},{atomLabel:"decorShopRestockSecondsAtom",dataKey:"secondsUntilRestock",transform:e=>e??0}]},leaderboard:{atoms:[{atomLabel:"unsortedLeaderboardAtom",dataKey:"entries"}]},petHutch:{atoms:[{atomLabel:"myPetHutchItemsAtom",dataKey:"items"},{atomLabel:"myPetHutchPetItemsAtom",dataKey:"petItems"}]}};function hu(e){return As[e]}function Tx(e){const t=As[e],n=[];for(const r of t.atoms)n.push(r.atomLabel);if(t.derivedAtoms)for(const r of t.derivedAtoms)n.push(r.atomLabel);return n}const Px=new Set(["inventory","journal","stats","activityLog","petHutch"]),Ix=new Set(["seedShop","eggShop","toolShop","decorShop"]),Ax=new Set(["leaderboard"]);function Ex(e,t,n,r){return function(a){const i=an(),s=Qt();if(i&&s===r){const l=uu(r);if(l!==null){let d;if(n.dataKey==="_full"?d=l:d=l[n.dataKey],d!==void 0)return t(a),n.transform?n.transform(d):d}}return t(a)}}function Mx(e,t,n,r,o){return function(i){if(an()&&Qt()===o){const s=uu(o);if(s!==null){const l=s[n];if(l!==void 0)return t(i),r(l)}}return t(i)}}function Rx(e){const t=hu(e);for(const n of t.atoms){const r=Nt(n.atomLabel);if(!r||Ai(n.atomLabel))continue;const o=r.read;if(typeof o!="function")continue;const a=Ex(n.atomLabel,o,n,e);r.read=a,Ul(n.atomLabel,o);}if(t.derivedAtoms)for(const n of t.derivedAtoms){const r=Nt(n.atomLabel);if(!r||Ai(n.atomLabel))continue;const o=r.read;if(typeof o!="function")continue;const a=Mx(n.atomLabel,o,n.sourceKey,n.deriveFn,e);r.read=a,Ul(n.atomLabel,o);}}async function ha(e){const t=hu(e);for(const r of t.atoms)Wl(r.atomLabel);if(t.derivedAtoms)for(const r of t.derivedAtoms)Wl(r.atomLabel);const n=await Cs();await bu(n,e);}async function Lx(e){const t=await Cs();await bu(t,e);const n=Tx(e);for(const r of n){const o=Nt(r);if(o)try{t.get(o);}catch{}}}function Wl(e){if(!Ai(e))return;const t=Nt(e),n=vx(e);t&&n&&(t.read=n),wx(e);}async function bu(e,t){const n=Px.has(t),r=Ix.has(t),o=Ax.has(t);if(!n&&!r&&!o)return;const a=Nt("stateAtom");if(a)try{const i=e.get(a);if(!i||typeof i!="object")return;let s=null;if(n||r){const l=i.child,d=l?.data;if(l&&d&&typeof d=="object"){let c=null;if(n&&Array.isArray(d.userSlots)){const u=d.userSlots.map(p=>{if(!p||typeof p!="object")return p;const f=p,g=f.data,m=g&&typeof g=="object"?{...g}:g;return {...f,data:m}});c={...c??d,userSlots:u};}if(r&&d.shops&&typeof d.shops=="object"&&(c={...c??d,shops:{...d.shops}}),c){const u={...l,data:c};s={...i,child:u};}}}if(o){const l=i.data;if(l&&Array.isArray(l.players)){const d={...l,players:[...l.players]};s={...s??i,data:d};}}if(!s)return;await e.set(a,s);}catch{}}async function Fx(){for(const e of Object.keys(As))await ha(e);}let lo=null,fr=null;async function Nx(){if(ma().initialized)return;fr=await ge.select("activeModalAtom"),lo=setInterval(async()=>{try{const n=await ge.select("activeModalAtom"),r=fr;r!==n&&(fr=n,Ox(n,r));}catch{}},50),Sx(()=>{lo&&(clearInterval(lo),lo=null);}),yx(true);}function Ox(e,t){const n=an(),r=Qt();e===null&&t!==null&&(n&&r===t?$x("native"):n||Is({modal:t,wasCustom:false,closedBy:"native"})),e!==null&&!n&&mu({modal:e,isCustom:false});}async function $x(e){const t=Qt();t&&(fu(),Ps(false),Ts(null),await ha(t),Is({modal:t,wasCustom:true,closedBy:e}));}async function Bx(e,t){if(!ma().initialized)throw new Error("[MGCustomModal] Not initialized. Call init() first.");an()&&await xu(),pu(e,t),Ps(true),Ts(e),Rx(e),await Lx(e),await _s.set(e),fr=e,mu({modal:e,isCustom:true});}function Dx(e,t){const n=ma();if(!n.isCustom||n.activeModal!==e||!n.shadow)return;const o={...n.shadow.data,...t};pu(e,o);}async function xu(){const e=ma();if(!e.isCustom||!e.activeModal)return;const t=e.activeModal;fu(),Ps(false),Ts(null),await _s.set(null),fr=null,await ha(t),Is({modal:t,wasCustom:true,closedBy:"api"});}function Gx(){return new Promise(e=>{if(!an()){e();return}const t=gu(()=>{t(),e();});})}async function zx(){if(an()){const e=Qt();e&&await ha(e);}await Fx(),_x();}const bn={async init(){return Nx()},isReady(){return xx()},async show(e,t){return Bx(e,t)},update(e,t){return Dx(e,t)},async close(){return xu()},isOpen(){return Qt()!==null},isCustomOpen(){return an()},getActiveModal(){return Qt()},waitForClose(){return Gx()},onOpen(e){return kx(e)},onClose(e){return gu(e)},async destroy(){return zx()}};function Hx(){return {ready:false,xform:null,xformAt:0}}const tt=Hx();function yu(){return tt.ready}function Mn(e){try{if(typeof structuredClone=="function")return structuredClone(e)}catch{}try{return JSON.parse(JSON.stringify(e))}catch{}return e}function zr(){return et.tos()}function Es(){return et.engine()}function jx(){const e=zr()?.map?.cols;return Number.isFinite(e)&&e>0?e:null}function Ms(e,t){const n=jx();return n?t*n+e|0:null}let co=null;async function Ux(e=15e3){return tt.ready?true:co||(co=(async()=>{if(await et.init(e),!zr())throw new Error("MGTile: engine captured but tileObject system not found");return tt.ready=true,true})(),co)}function Yt(e,t,n=true){const r=zr(),o=Ms(e,t);if(!r||o==null)return {gidx:null,tv:null};let a=r.tileViews?.get?.(o)||null;if(!a&&n&&typeof r.getOrCreateTileView=="function")try{a=r.getOrCreateTileView(o);}catch{}return {gidx:o,tv:a||null}}function Va(e,t){if("startTime"in t&&(e.startTime=Number(t.startTime)),"endTime"in t&&(e.endTime=Number(t.endTime)),"targetScale"in t&&(e.targetScale=Number(t.targetScale)),"mutations"in t){if(!Array.isArray(t.mutations))throw new Error("MGTile: mutations must be an array of strings");e.mutations=t.mutations.slice();}}function Rs(e,t){if(!e)throw new Error("MGTile: no tileObject on this tile");if(e.objectType!==t)throw new Error(`MGTile: expected objectType "${t}", got "${e.objectType}"`)}function xn(e,t,n,r={}){const o=r.ensureView!==false,a=r.forceUpdate!==false,i=Es(),{gidx:s,tv:l}=Yt(Number(e),Number(t),o);if(s==null)throw new Error("MGTile: cols unavailable (engine/TOS not ready)");if(!l)throw new Error("MGTile: TileView unavailable (not instantiated)");const d=l.tileObject;if(typeof l.onDataChanged!="function")throw new Error("MGTile: tileView.onDataChanged not found (different API?)");if(l.onDataChanged(n),a&&i?.reusableContext&&typeof l.update=="function")try{l.update(i.reusableContext);}catch{}return {ok:true,tx:Number(e),ty:Number(t),gidx:s,before:d,after:l.tileObject}}function ba(e,t,n={}){const r=n.ensureView!==false,o=n.clone!==false,{gidx:a,tv:i}=Yt(Number(e),Number(t),r);if(a==null)throw new Error("MGTile: cols unavailable (engine not ready)");if(!i)return {tx:Number(e),ty:Number(t),gidx:a,tileView:null,tileObject:void 0};const s=i.tileObject;return {tx:Number(e),ty:Number(t),gidx:a,tileView:i,tileObject:o?Mn(s):s}}function Wx(e,t,n={}){return xn(e,t,null,n)}function Vx(e,t,n,r={}){const a=ba(e,t,{...r,clone:false}).tileView?.tileObject;Rs(a,"plant");const i=Mn(a);if(Array.isArray(i.slots)||(i.slots=[]),"plantedAt"in n&&(i.plantedAt=Number(n.plantedAt)),"maturedAt"in n&&(i.maturedAt=Number(n.maturedAt)),"species"in n&&(i.species=String(n.species)),"slotIdx"in n&&"slotPatch"in n){const s=Number(n.slotIdx)|0;if(!i.slots[s])throw new Error(`MGTile: plant slot ${s} doesn't exist`);return Va(i.slots[s],n.slotPatch),xn(e,t,i,r)}if("slots"in n){const s=n.slots;if(Array.isArray(s)){for(let l=0;l<s.length;l++)if(s[l]!=null){if(!i.slots[l])throw new Error(`MGTile: plant slot ${l} doesn't exist`);Va(i.slots[l],s[l]);}}else if(s&&typeof s=="object")for(const l of Object.keys(s)){const d=Number(l)|0;if(Number.isFinite(d)){if(!i.slots[d])throw new Error(`MGTile: plant slot ${d} doesn't exist`);Va(i.slots[d],s[d]);}}else throw new Error("MGTile: patch.slots must be array or object map");return xn(e,t,i,r)}return xn(e,t,i,r)}function Xx(e,t,n,r={}){const a=ba(e,t,{...r,clone:false}).tileView?.tileObject;Rs(a,"decor");const i=Mn(a);return "rotation"in n&&(i.rotation=Number(n.rotation)),xn(e,t,i,r)}function qx(e,t,n,r={}){const a=ba(e,t,{...r,clone:false}).tileView?.tileObject;Rs(a,"egg");const i=Mn(a);return "plantedAt"in n&&(i.plantedAt=Number(n.plantedAt)),"maturedAt"in n&&(i.maturedAt=Number(n.maturedAt)),xn(e,t,i,r)}function Kx(e,t,n,r={}){const o=r.ensureView!==false,a=r.forceUpdate!==false,i=Es(),{gidx:s,tv:l}=Yt(Number(e),Number(t),o);if(s==null)throw new Error("MGTile: cols unavailable (engine not ready)");if(!l)throw new Error("MGTile: TileView unavailable");const d=l.tileObject,c=typeof n=="function"?n(Mn(d)):n;if(l.onDataChanged(c),a&&i?.reusableContext&&typeof l.update=="function")try{l.update(i.reusableContext);}catch{}return {ok:true,tx:Number(e),ty:Number(t),gidx:s,before:d,after:l.tileObject}}function Yx(e,t,n={}){const r=n.ensureView!==false,{gidx:o,tv:a}=Yt(Number(e),Number(t),r);if(o==null)throw new Error("MGTile: cols unavailable");if(!a)return {ok:true,tx:Number(e),ty:Number(t),gidx:o,tv:null,tileObject:void 0};const i=n.clone!==false,s=a.tileObject;return {ok:true,tx:Number(e),ty:Number(t),gidx:o,objectType:s?.objectType??null,tileObject:i?Mn(s):s,tvKeys:Object.keys(a||{}).sort(),tileView:a}}function Xa(e){if(!e)return null;const t=o=>o&&(typeof o.getGlobalPosition=="function"||typeof o.toGlobal=="function"),n=["container","root","view","tile","ground","base","floor","bg","background","baseSprite","tileSprite","displayObject","gfx","graphics","sprite"];for(const o of n)if(t(e[o]))return e[o];if(t(e))return e;const r=[e.container,e.root,e.view,e.displayObject,e.tileSprite,e.gfx,e.graphics,e.sprite];for(const o of r)if(t(o))return o;try{for(const o of Object.keys(e))if(t(e[o]))return e[o]}catch{}return null}function Do(e){const t=ct(()=>e?.getGlobalPosition?.());if(t&&Number.isFinite(t.x)&&Number.isFinite(t.y))return {x:t.x,y:t.y};const n=ct(()=>e?.toGlobal?.({x:0,y:0}));return n&&Number.isFinite(n.x)&&Number.isFinite(n.y)?{x:n.x,y:n.y}:null}function Jx(e){try{if(!e?.getBounds)return "center";const t=e.getBounds(),n=Do(e);if(!n||!t||!Number.isFinite(t.width)||!Number.isFinite(t.height))return "center";const r=t.x+t.width/2,o=t.y+t.height/2;return Math.hypot(n.x-r,n.y-o)<Math.hypot(n.x-t.x,n.y-t.y)?"center":"topleft"}catch{return "center"}}function Qx(){const e=zr(),t=e?.map?.cols,n=e?.map?.rows;if(!e||!Number.isFinite(t)||t<=1)return null;const r=Number.isFinite(n)&&n>1?n:null,o=[[0,0],[1,1],[Math.min(2,t-2),0],[0,1]];r&&r>2&&o.push([Math.floor(t/2),Math.floor(r/2)]);for(const[a,i]of o){if(a<0||i<0||a>=t||r&&i>=r)continue;const s=Yt(a,i,true).tv,l=a+1<t?Yt(a+1,i,true).tv:null,d=Yt(a,i+1,true).tv,c=Xa(s),u=Xa(l),p=Xa(d);if(!c||!u||!p)continue;const f=Do(c),g=Do(u),m=Do(p);if(!f||!g||!m)continue;const h={x:g.x-f.x,y:g.y-f.y},b={x:m.x-f.x,y:m.y-f.y},w=h.x*b.y-h.y*b.x;if(!Number.isFinite(w)||Math.abs(w)<1e-6)continue;const C=1/w,v={a:b.y*C,b:-b.x*C,c:-h.y*C,d:h.x*C},_={x:f.x-a*h.x-i*b.x,y:f.y-a*h.y-i*b.y},y=Jx(c),S=y==="center"?_:{x:_.x+.5*(h.x+b.x),y:_.y+.5*(h.y+b.y)};return {ok:true,cols:t,rows:r,vx:h,vy:b,inv:v,anchorMode:y,originCenter:S}}return null}function vu(){return tt.xform=Qx(),tt.xformAt=Date.now(),{ok:!!tt.xform?.ok,xform:tt.xform}}function Zx(e,t={}){if(!e||!Number.isFinite(e.x)||!Number.isFinite(e.y))return null;const n=Number.isFinite(t.maxAgeMs)?Number(t.maxAgeMs):1500;(!tt.xform?.ok||t.forceRebuild||Date.now()-tt.xformAt>n)&&vu();const r=tt.xform;if(!r?.ok)return null;const o=e.x-r.originCenter.x,a=e.y-r.originCenter.y,i=r.inv.a*o+r.inv.b*a,s=r.inv.c*o+r.inv.d*a,l=Math.floor(i),d=Math.floor(s),c=[[l,d],[l+1,d],[l,d+1],[l+1,d+1]];let u=null,p=1/0;for(const[f,g]of c){if(f<0||g<0||f>=r.cols||Number.isFinite(r.rows)&&r.rows!==null&&g>=r.rows)continue;const m=r.originCenter.x+f*r.vx.x+g*r.vy.x,h=r.originCenter.y+f*r.vx.y+g*r.vy.y,b=(e.x-m)**2+(e.y-h)**2;b<p&&(p=b,u={tx:f,ty:g,fx:i,fy:s,x:e.x,y:e.y,gidx:null});}return u?(u.gidx=Ms(u.tx,u.ty),u):null}function e0(e,t){const n=tt.xform;return n?.ok?{x:n.originCenter.x+e*n.vx.x+t*n.vy.x,y:n.originCenter.y+e*n.vx.y+t*n.vy.y}:null}function ot(){if(!yu())throw new Error("MGTile: not ready. Call MGTile.init() first.")}function t0(){return ["MGTile.init()","MGTile.hook()","MGTile.getTileObject(tx,ty) / inspect(tx,ty)","MGTile.setTileEmpty(tx,ty)","MGTile.setTilePlant(tx,ty,{...}) / setTileDecor / setTileEgg","MGTile.setTileObjectRaw(tx,ty,objOrFn)","MGTile.rebuildTransform() / pointToTile({x,y})","MGTile.tileToPoint(tx,ty)"].join(`
`)}const kt={init:Ux,isReady:yu,hook:et.hook,engine:Es,tos:zr,gidx:(e,t)=>Ms(Number(e),Number(t)),getTileObject:(e,t,n={})=>(ot(),ba(e,t,n)),inspect:(e,t,n={})=>(ot(),Yx(e,t,n)),setTileEmpty:(e,t,n={})=>(ot(),Wx(e,t,n)),setTilePlant:(e,t,n,r={})=>(ot(),Vx(e,t,n,r)),setTileDecor:(e,t,n,r={})=>(ot(),Xx(e,t,n,r)),setTileEgg:(e,t,n,r={})=>(ot(),qx(e,t,n,r)),setTileObjectRaw:(e,t,n,r={})=>(ot(),Kx(e,t,n,r)),rebuildTransform:()=>(ot(),vu()),pointToTile:(e,t={})=>(ot(),Zx(e,t)),tileToPoint:(e,t)=>(ot(),e0(e,t)),getTransform:()=>(ot(),tt.xform),help:t0};function n0(){return {ready:false,app:null,renderer:null,stage:null,ticker:null,tileSets:new Map,highlights:new Map,watches:new Map,fades:new Map,fadeWatches:new Map}}const q=n0();function wu(){return q.ready}async function r0(e=15e3){if(q.ready)return Ei(),true;if(await et.init(e),q.app=et.app(),q.ticker=et.ticker(),q.renderer=et.renderer(),q.stage=et.stage(),!q.app||!q.ticker)throw new Error("MGPixi: PIXI app/ticker not found");return q.ready=true,Ei(),true}function Ei(){const e=F;return e.$PIXI=e.PIXI||null,e.$app=q.app||null,e.$renderer=q.renderer||null,e.$stage=q.stage||null,e.$ticker=q.ticker||null,e.__MG_PIXI__={PIXI:e.$PIXI,app:e.$app,renderer:e.$renderer,stage:e.$stage,ticker:e.$ticker,ready:q.ready},e.__MG_PIXI__}function Ls(e){return !!e&&typeof e=="object"&&!Array.isArray(e)}function Mi(e){return !!(e&&typeof e.getBounds=="function"&&("parent"in e||"children"in e))}function ra(e){return !!(e&&typeof e.tint=="number")}function Zt(e){return !!(e&&typeof e.alpha=="number")}function Go(e,t,n){return e+(t-e)*n}function o0(e,t,n){const r=e>>16&255,o=e>>8&255,a=e&255,i=t>>16&255,s=t>>8&255,l=t&255,d=Go(r,i,n)|0,c=Go(o,s,n)|0,u=Go(a,l,n)|0;return d<<16|c<<8|u}function a0(e,t=900){const n=[],r=[e];for(;r.length&&n.length<t;){const o=r.pop();if(!o)continue;ra(o)&&n.push(o);const a=o.children;if(Array.isArray(a))for(let i=a.length-1;i>=0;i--)r.push(a[i]);}return n}function i0(e,t=25e3){const n=[],r=[e];let o=0;for(;r.length&&o++<t;){const a=r.pop();if(!a)continue;Zt(a)&&n.push(a);const i=a.children;if(Array.isArray(i))for(let s=i.length-1;s>=0;s--)r.push(i[s]);}return n}const s0=["plantVisual","cropVisual","slotVisual","slotView","displayObject","view","container","root","sprite","gfx","graphics"];function Ri(e){if(!e)return null;if(Mi(e))return e;if(!Ls(e))return null;for(const t of s0){const n=e[t];if(Mi(n))return n}return null}function l0(e,t){const n=[{o:e,d:0}],r=new Set,o=6;for(;n.length;){const{o:a,d:i}=n.shift();if(!(!a||i>o)&&!r.has(a)){if(r.add(a),Array.isArray(a)){if(a.length===t){const s=new Array(t);let l=true;for(let d=0;d<t;d++){const c=Ri(a[d]);if(!c){l=false;break}s[d]=c;}if(l)return s}for(const s of a)n.push({o:s,d:i+1});continue}if(Ls(a)){const s=a;for(const l of Object.keys(s))n.push({o:s[l],d:i+1});}}}return null}function Su(e){if(!Array.isArray(e))return [];const t=new Set,n=[];for(const r of e){let o,a;if(Array.isArray(r))o=r[0],a=r[1];else if(Ls(r))o=r.x??r.tx,a=r.y??r.ty;else continue;if(o=Number(o),a=Number(a),!Number.isFinite(o)||!Number.isFinite(a))continue;o|=0,a|=0;const i=`${o},${a}`;t.has(i)||(t.add(i),n.push({x:o,y:a}));}return n}function c0(e,t){const n=String(e||"").trim();if(!n)throw new Error("MGPixi.defineTileSet: empty name");const r=Su(t);return q.tileSets.set(n,r),{ok:true,name:n,count:r.length}}function d0(e){return q.tileSets.delete(String(e||"").trim())}function u0(){return Array.from(q.tileSets.keys()).sort((e,t)=>e.localeCompare(t))}function Cu(e){return !!(e&&(e.tileSet!=null||Array.isArray(e.tiles)))}function Fs(e){const n=kt.tos?.()?.tileViews;if(!n?.entries)throw new Error("MGPixi: TOS.tileViews not found");if(!Cu(e))return {entries:Array.from(n.entries()),gidxSet:null};let r=[];if(e.tileSet!=null){const a=String(e.tileSet||"").trim(),i=q.tileSets.get(a);if(!i)throw new Error(`MGPixi: tileSet not found "${a}"`);r=i;}else r=Su(e.tiles||[]);const o=new Map;for(const a of r){const i=kt.getTileObject(a.x,a.y,{ensureView:true,clone:false});i?.tileView&&i.gidx!=null&&o.set(i.gidx,i.tileView);}return {entries:Array.from(o.entries()),gidxSet:new Set(o.keys())}}function Ns(e){const t=q.highlights.get(e);if(!t)return  false;ct(()=>q.ticker?.remove(t.tick)),t.root&&t.baseAlpha!=null&&Zt(t.root)&&ct(()=>{t.root.alpha=t.baseAlpha;});for(const n of t.tint)n.o&&ra(n.o)&&ct(()=>{n.o.tint=n.baseTint;});return q.highlights.delete(e),true}function ku(e=null){for(const t of Array.from(q.highlights.keys()))e&&!String(t).startsWith(e)||Ns(t);return  true}function _u(e,t={}){if(!Mi(e))throw new Error("MGPixi.highlightPulse: invalid root");const n=String(t.key||`hl:${Math.random().toString(16).slice(2)}`);if(q.highlights.has(n))return n;const r=Zt(e)?Number(e.alpha):null,o=xt(Number(t.minAlpha??.12),0,1),a=xt(Number(t.maxAlpha??1),0,1),i=Number(t.speed??1.25),s=(t.tint??8386303)>>>0,l=xt(Number(t.tintMix??.85),0,1),d=t.deepTint!==false,c=[];if(d)for(const f of a0(e))c.push({o:f,baseTint:f.tint});else ra(e)&&c.push({o:e,baseTint:e.tint});const u=performance.now(),p=()=>{const f=(performance.now()-u)/1e3,g=(Math.sin(f*Math.PI*2*i)+1)/2,m=g*g*(3-2*g);r!=null&&Zt(e)&&(e.alpha=xt(Go(o,a,m)*r,0,1));const h=m*l;for(const b of c)b.o&&ra(b.o)&&(b.o.tint=o0(b.baseTint,s,h));};return q.ticker?.add(p),q.highlights.set(n,{root:e,tick:p,baseAlpha:r,tint:c}),n}function p0(e,t){const n=e?.mutations;if(!Array.isArray(n))return  false;for(const r of n)if(String(r||"").toLowerCase()===t)return  true;return  false}function Tu(e,t={}){const n=String(e||"").trim().toLowerCase();if(!n)throw new Error("MGPixi.highlightMutation: empty mutation");const{entries:r,gidxSet:o}=Fs(t),a=`hlmut:${n}:`;if(t.clear===true)if(!o)ku(a);else for(const u of Array.from(q.highlights.keys())){if(!u.startsWith(a))continue;const p=u.split(":"),f=Number(p[2]);o.has(f)&&Ns(u);}const i={tint:(t.tint??8386303)>>>0,minAlpha:Number(t.minAlpha??.12),maxAlpha:Number(t.maxAlpha??1),speed:Number(t.speed??1.25),tintMix:Number(t.tintMix??.85),deepTint:t.deepTint!==false};let s=0,l=0,d=0,c=0;for(const[u,p]of r){const f=p?.tileObject;if(!f||f.objectType!=="plant")continue;const g=f.slots;if(!Array.isArray(g)||g.length===0)continue;let m=false;const h=[];for(let C=0;C<g.length;C++)p0(g[C],n)&&(h.push(C),m=true);if(!m)continue;s++,l+=h.length;const b=p?.childView?.plantVisual||p?.childView||p,w=l0(b,g.length);if(!w){c+=h.length;continue}for(const C of h){const v=w[C];if(!v){c++;continue}const _=`${a}${u}:${C}`;q.highlights.has(_)||(_u(v,{key:_,...i}),d++);}}return {ok:true,mutation:n,filtered:!!o,plantsMatched:s,matchedSlots:l,newHighlights:d,failedSlots:c}}function f0(e,t={}){const n=String(e||"").trim().toLowerCase();if(!n)throw new Error("MGPixi.watchMutation: empty mutation");const r=`watchmut:${n}:${t.tileSet?`set:${t.tileSet}`:t.tiles?"tiles":"all"}`,o=Number.isFinite(t.intervalMs)?t.intervalMs:1e3,a=q.watches.get(r);a&&clearInterval(a);const i=setInterval(()=>{ct(()=>Tu(n,{...t,clear:!1}));},o);return q.watches.set(r,i),{ok:true,key:r,mutation:n,intervalMs:o}}function g0(e){const t=String(e||"").trim();if(!t)return  false;if(!t.startsWith("watchmut:")){const r=t.toLowerCase();let o=0;for(const[a,i]of Array.from(q.watches.entries()))a.startsWith(`watchmut:${r}:`)&&(clearInterval(i),q.watches.delete(a),o++);return o>0}const n=q.watches.get(t);return n?(clearInterval(n),q.watches.delete(t),true):false}function m0(e){const t=e?.childView?.plantVisual||e?.childView?.cropVisual||e?.childView||e?.displayObject||e;return Ri(t)||Ri(e?.displayObject)||null}function Pu(e){const t=q.fades.get(e);if(!t)return  false;for(const n of t.targets)n.o&&Zt(n.o)&&Number.isFinite(n.baseAlpha)&&ct(()=>{n.o.alpha=n.baseAlpha;});return q.fades.delete(e),true}function Li(e=null){for(const t of Array.from(q.fades.keys()))e&&!String(t).startsWith(e)||Pu(t);return  true}function Iu(e,t={}){const n=String(e||"").trim().toLowerCase();if(!n)throw new Error("MGPixi.clearSpeciesFade: empty species");const r=`fade:${n}:`;if(!Cu(t))return Li(r);const{gidxSet:o}=Fs(t);if(!o)return Li(r);for(const a of Array.from(q.fades.keys())){if(!a.startsWith(r))continue;const i=Number(a.slice(r.length));o.has(i)&&Pu(a);}return  true}function Au(e,t={}){const n=String(e||"").trim().toLowerCase();if(!n)throw new Error("MGPixi.fadeSpecies: empty species");const r=xt(Number(t.alpha??.2),0,1),o=t.deep===true,{entries:a,gidxSet:i}=Fs(t),s=`fade:${n}:`;t.clear===true&&Iu(n,t);let l=0,d=0,c=0,u=0;for(const[p,f]of a){const g=f?.tileObject;if(!g||g.objectType!=="plant")continue;l++;const m=String(g.species||"").trim().toLowerCase();if(!m||m!==n)continue;d++;const h=m0(f);if(!h||!Zt(h)){u++;continue}const b=`${s}${p}`;if(q.fades.has(b)){ct(()=>{h.alpha=r;}),c++;continue}const w=o?i0(h):[h],C=[];for(const v of w)Zt(v)&&C.push({o:v,baseAlpha:Number(v.alpha)});for(const v of C)ct(()=>{v.o.alpha=r;});q.fades.set(b,{targets:C}),c++;}return {ok:true,species:n,alpha:r,deep:o,filtered:!!i,plantsSeen:l,matchedPlants:d,applied:c,failed:u,totalFades:q.fades.size}}function h0(e,t={}){const n=String(e||"").trim().toLowerCase();if(!n)throw new Error("MGPixi.watchFadeSpecies: empty species");const r=`watchfade:${n}:${t.tileSet?`set:${t.tileSet}`:t.tiles?"tiles":"all"}`,o=Number.isFinite(t.intervalMs)?t.intervalMs:1e3,a=q.fadeWatches.get(r);a&&clearInterval(a);const i=setInterval(()=>{ct(()=>Au(n,{...t,clear:!1}));},o);return q.fadeWatches.set(r,i),{ok:true,key:r,species:n,intervalMs:o}}function b0(e){const t=String(e||"").trim();if(!t)return  false;if(!t.startsWith("watchfade:")){const r=t.toLowerCase();let o=0;for(const[a,i]of Array.from(q.fadeWatches.entries()))a.startsWith(`watchfade:${r}:`)&&(clearInterval(i),q.fadeWatches.delete(a),o++);return o>0}const n=q.fadeWatches.get(t);return n?(clearInterval(n),q.fadeWatches.delete(t),true):false}function x0(e){const t=Array.isArray(e?.slots)?e.slots:[];return {objectType:"plant",species:e?.species??null,plantedAt:e?.plantedAt??null,maturedAt:e?.maturedAt??null,slotCount:t.length,slots:t.map((n,r)=>({idx:r,mutations:Array.isArray(n?.mutations)?n.mutations.slice():[]}))}}function y0(e,t,n={}){const r=Number(e)|0,o=Number(t)|0,a=n.ensureView!==false,i=kt.getTileObject(r,o,{ensureView:a,clone:false}),s=i?.tileView||null,l=s?.tileObject,d={ok:true,tx:r,ty:o,gidx:i?.gidx??kt.gidx?.(r,o)??null,hasTileView:!!s,objectType:l?.objectType??null,tileObject:l??null,summary:l?.objectType==="plant"?x0(l):l?{objectType:l.objectType??null}:null,display:s?s.childView?.plantVisual||s.childView||s.displayObject||s:null};return n.log!==false&&ct(()=>console.log("[MGPixi.inspectTile]",d)),d}function v0(e,t,n){const r=F.PIXI;if(!r)return;let o=q.stage.getChildByName("gemini-overlay");o||(o=new r.Container,o.name="gemini-overlay",q.stage.addChild(o));const a=n.key;let i=o.getChildByName(a);i||(i=new r.Graphics,i.name=a,o.addChild(i));const s=kt.tileToPoint(e,t);if(!s)return;i.clear(),i.lineStyle(2,n.tint??65280,n.alpha??1),i.beginFill(n.tint??65280,(n.alpha??1)*.2);const l=kt.getTransform(),d=l?Math.hypot(l.vx.x,l.vx.y):32,c=l?Math.hypot(l.vy.x,l.vy.y):32;i.drawRect(0,0,d,c),i.endFill(),i.x=s.x,i.y=s.y,l&&(i.rotation=Math.atan2(l.vx.y,l.vx.x));}function w0(e){const t=q.stage?.getChildByName("gemini-overlay");if(!t)return  false;const n=t.getChildByName(e);return n?(t.removeChild(n),n.destroy?.(),true):false}function Me(){if(!wu())throw new Error("MGPixi: call MGPixi.init() first")}const xa={init:r0,isReady:wu,expose:Ei,get app(){return q.app},get renderer(){return q.renderer},get stage(){return q.stage},get ticker(){return q.ticker},get PIXI(){return F.PIXI||null},defineTileSet:(e,t)=>(Me(),c0(e,t)),deleteTileSet:e=>(Me(),d0(e)),listTileSets:()=>(Me(),u0()),highlightPulse:(e,t)=>(Me(),_u(e,t)),stopHighlight:e=>(Me(),Ns(e)),clearHighlights:e=>(Me(),ku(e)),drawOverlayBox:(e,t,n)=>(Me(),v0(e,t,n)),stopOverlay:e=>(Me(),w0(e)),highlightMutation:(e,t)=>(Me(),Tu(e,t)),watchMutation:(e,t)=>(Me(),f0(e,t)),stopWatchMutation:e=>(Me(),g0(e)),inspectTile:(e,t,n)=>(Me(),y0(e,t,n)),fadeSpecies:(e,t)=>(Me(),Au(e,t)),clearSpeciesFade:(e,t)=>(Me(),Iu(e,t)),clearFades:e=>(Me(),Li(e)),watchFadeSpecies:(e,t)=>(Me(),h0(e,t)),stopWatchFadeSpecies:e=>(Me(),b0(e))};function S0(){return {ready:false,baseUrl:null,urls:{ambience:new Map,music:new Map},sfx:{mp3Url:null,atlasUrl:null,atlas:null,groups:new Map,buffer:null},tracks:{ambience:null,music:null},customAudio:{current:null,onEnd:void 0},ctx:null}}const te=S0();function Eu(){return te.ready}const Vl=F??window;async function Mu(){const e=te.ctx;if(e)return e;const t=Vl.AudioContext||Vl.webkitAudioContext;if(!t)throw new Error("WebAudio not supported");const n=new t;return te.ctx=n,n}async function Ru(){if(te.ctx&&te.ctx.state==="suspended")try{await te.ctx.resume();}catch{}}const C0={sfx:"soundEffectsVolume",music:"musicVolume",ambience:"ambienceVolume"},k0={sfx:"soundEffectsVolumeAtom",music:"musicVolumeAtom",ambience:"ambienceVolumeAtom"},gr=.001,mr=.2;function Xl(e,t=NaN){try{const n=localStorage.getItem(e);if(n==null)return t;let r;try{r=JSON.parse(n);}catch{r=n;}if(typeof r=="number"&&Number.isFinite(r))return r;if(typeof r=="string"){const o=parseFloat(r);if(Number.isFinite(o))return o}}catch{}return t}function Er(e){const t=C0[e],n=k0[e];if(!t)return {atom:mr,vol100:uo(mr)};const r=Xl(t,NaN);if(Number.isFinite(r)){const a=xt(r,0,1);return {atom:a,vol100:uo(a)}}if(n){const a=Xl(n,NaN);if(Number.isFinite(a)){const i=xt(a,0,1);return {atom:i,vol100:uo(i)}}}const o=mr;return {atom:o,vol100:uo(o)}}function _0(e){const t=Number(e);if(!Number.isFinite(t))return null;if(t<=0)return 0;const r=(xt(t,1,100)-1)/99;return gr+r*(mr-gr)}function uo(e){const t=xt(Number(e),0,1);if(t<=gr)return 0;const n=(t-gr)/(mr-gr);return Math.round(1+n*99)}function Lu(e,t){if(t==null)return Er(e).atom;const n=_0(t);return n===null?Er(e).atom:um(n)}function T0(e){const t=new Map,n=(r,o)=>{t.has(r)||t.set(r,[]),t.get(r).push(o);};for(const r of Object.keys(e||{})){const o=/^(.*)_([A-Z])$/.exec(r);o?.[1]?n(o[1],r):n(r,r);}for(const[r,o]of Array.from(t.entries()))o.sort((a,i)=>a.localeCompare(i)),t.set(r,o);te.sfx.groups=t;}function P0(e){const t=te.sfx.atlas;if(!t)throw new Error("SFX atlas not loaded");if(t[e])return e;const n=te.sfx.groups.get(e);if(n?.length)return n[Math.random()*n.length|0];throw new Error(`Unknown sfx/group: ${e}`)}async function I0(){if(te.sfx.buffer)return te.sfx.buffer;if(!te.sfx.mp3Url)throw new Error("SFX mp3 url missing");const e=await Mu();await Ru();const n=await(await Cd(te.sfx.mp3Url)).arrayBuffer(),r=await new Promise((o,a)=>{const i=e.decodeAudioData(n,o,a);i?.then&&i.then(o,a);});return te.sfx.buffer=r,r}async function A0(e,t={}){if(!te.ready)throw new Error("MGAudio not ready yet");const n=String(e||"").trim();if(!n)throw new Error("Missing sfx name");const r=P0(n),o=te.sfx.atlas[r];if(!o)throw new Error(`Missing segment for sfx: ${r}`);const a=await Mu();await Ru();const i=await I0(),s=Math.max(0,+o.start||0),l=Math.max(s,+o.end||s),d=Math.max(.01,l-s),c=Lu("sfx",t.volume),u=a.createGain();u.gain.value=c,u.connect(a.destination);const p=a.createBufferSource();return p.buffer=i,p.connect(u),p.start(0,s,d),{name:r,source:p,start:s,end:l,duration:d,volume:c}}const E0=(function(){const t=typeof document<"u"&&document.createElement("link").relList;return t&&t.supports&&t.supports("modulepreload")?"modulepreload":"preload"})(),M0=function(e){return "/"+e},ql={},Rn=function(t,n,r){let o=Promise.resolve();if(n&&n.length>0){let l=function(d){return Promise.all(d.map(c=>Promise.resolve(c).then(u=>({status:"fulfilled",value:u}),u=>({status:"rejected",reason:u}))))};document.getElementsByTagName("link");const i=document.querySelector("meta[property=csp-nonce]"),s=i?.nonce||i?.getAttribute("nonce");o=l(n.map(d=>{if(d=M0(d),d in ql)return;ql[d]=true;const c=d.endsWith(".css"),u=c?'[rel="stylesheet"]':"";if(document.querySelector(`link[href="${d}"]${u}`))return;const p=document.createElement("link");if(p.rel=c?"stylesheet":E0,c||(p.as="script"),p.crossOrigin="",p.href=d,s&&p.setAttribute("nonce",s),document.head.appendChild(p),c)return new Promise((f,g)=>{p.addEventListener("load",f),p.addEventListener("error",()=>g(new Error(`Unable to preload CSS for ${d}`)));})}));}function a(i){const s=new Event("vite:preloadError",{cancelable:true});if(s.payload=i,window.dispatchEvent(s),!s.defaultPrevented)throw i}return o.then(i=>{for(const s of i||[])s.status==="rejected"&&a(s.reason);return t().catch(a)})},ya={MAX_SOUNDS:50,MAX_SIZE_BYTES:250*1024},R0={sounds:[],version:1};class Os extends Error{constructor(t){super(t),this.name="CustomSoundError";}}class L0 extends Os{constructor(){super(`Maximum number of sounds reached (${ya.MAX_SOUNDS})`),this.name="SoundLimitError";}}class F0 extends Os{constructor(t){super(`Sound size (${Math.round(t/1024)}KB) exceeds limit (${ya.MAX_SIZE_BYTES/1024}KB)`),this.name="SoundSizeError";}}class N0 extends Os{constructor(t){super(`Sound not found: ${t}`),this.name="SoundNotFoundError";}}function O0(){return ve(da.MODULE.AUDIO_CUSTOM_SOUNDS,R0)}function $0(e){Pe(da.MODULE.AUDIO_CUSTOM_SOUNDS,e);}function Kl(){return O0().sounds}function va(e){$0({sounds:e,version:1});}const B0="https://cdn.pixabay.com/audio/2025/05/31/audio_b2dfcd42bb.mp3",Fu=[{id:"default-notification",name:"Default",source:B0,type:"upload",createdAt:0}];function D0(e){const t=new Set(e.map(r=>r.id)),n=Fu.filter(r=>!t.has(r.id));return n.length===0?e:[...e,...n]}function Nu(e){return Fu.some(t=>t.id===e)}function G0(e){if(!e.startsWith("data:"))return 0;const n=e.indexOf(",");if(n===-1)return 0;const o=e.slice(n+1).length*3/4;return Math.round(o)}function Ou(e){if(!e||!e.trim())throw new Error("Sound source cannot be empty");const t=G0(e);if(t>0&&t>ya.MAX_SIZE_BYTES)throw new F0(t)}function $u(e){if(!e||!e.trim())throw new Error("Sound name cannot be empty");if(e.length>100)throw new Error("Sound name too long (max 100 characters)")}function z0(e){if(e>=ya.MAX_SOUNDS)throw new L0}let rt=[],Fi=false;function Ln(){Fi||Bu();}function H0(){return "xxxxxxxx-xxxx-4xxx-yxxx-xxxxxxxxxxxx".replace(/[xy]/g,e=>{const t=Math.random()*16|0;return (e==="x"?t:t&3|8).toString(16)})}function Bu(){if(Fi)return;let e=Kl();e=D0(e),e.length!==Kl().length&&va(e),rt=e,Fi=true,console.log(`[CustomSounds] Initialized with ${rt.length} sounds`);}function j0(){return Ln(),[...rt]}function Du(e){return Ln(),rt.find(t=>t.id===e)}function U0(e,t,n){Ln(),$u(e),Ou(t),z0(rt.length);const r={id:H0(),name:e.trim(),source:t.trim(),type:n,createdAt:Date.now()};return rt.push(r),va(rt),console.log(`[CustomSounds] Added sound: ${r.name} (${r.id})`),r}function W0(e){if(Ln(),Nu(e))throw new Error("Cannot remove default sounds");const t=rt.findIndex(r=>r.id===e);if(t===-1)return  false;const n=rt.splice(t,1)[0];return va(rt),console.log(`[CustomSounds] Removed sound: ${n.name} (${n.id})`),true}function V0(e,t){if(Ln(),Nu(e))throw new Error("Cannot update default sounds");const n=rt.find(r=>r.id===e);return n?(t.name!==void 0&&($u(t.name),n.name=t.name.trim()),t.source!==void 0&&(Ou(t.source),n.source=t.source.trim()),va(rt),console.log(`[CustomSounds] Updated sound: ${n.name} (${n.id})`),true):false}async function X0(e,t={}){Ln();const n=Du(e);if(!n)throw new N0(e);const{MGAudio:r}=await Rn(async()=>{const{MGAudio:o}=await Promise.resolve().then(()=>ju);return {MGAudio:o}},void 0);try{await r.playCustom(n.source,{volume:t.volume??.5,loop:t.loop??!1}),console.log(`[CustomSounds] Playing: ${n.name} (${n.id})`);}catch(o){throw console.error(`[CustomSounds] Failed to play ${n.name}:`,o),o}}function q0(){Rn(async()=>{const{MGAudio:e}=await Promise.resolve().then(()=>ju);return {MGAudio:e}},void 0).then(({MGAudio:e})=>{e.stopCustom(),console.log("[CustomSounds] Stopped current sound");});}const Gu={init:Bu,getAll:j0,getById:Du,add:U0,remove:W0,update:V0,play:X0,stop:q0};let po=null;async function K0(){return te.ready?true:po||(po=(async()=>{te.baseUrl=await rn.base();const e=await Ct.load({baseUrl:te.baseUrl}),t=Ct.getBundle(e,"audio");if(!t)throw new Error("No audio bundle in manifest");for(const n of t.assets||[])for(const r of n.src||[]){if(typeof r!="string")continue;const o=/^audio\/(ambience|music)\/(.+)\.mp3$/i.exec(r);if(o){const a=o[1].toLowerCase(),i=o[2];te.urls[a].set(i,St(te.baseUrl,r));continue}/^audio\/sfx\/sfx\.mp3$/i.test(r)&&(te.sfx.mp3Url=St(te.baseUrl,r)),/^audio\/sfx\/sfx\.json$/i.test(r)&&(te.sfx.atlasUrl=St(te.baseUrl,r));}if(!te.sfx.atlasUrl)throw new Error("Missing audio/sfx/sfx.json in manifest");return te.sfx.atlas=await hs(te.sfx.atlasUrl),T0(te.sfx.atlas),Gu.init(),te.ready=true,true})(),po)}function zu(e){if(e!=="music"&&e!=="ambience")return  false;const t=te.tracks[e];if(t){try{t.pause();}catch{}try{t.src="";}catch{}}return te.tracks[e]=null,true}function Y0(e,t,n={}){if(!te.ready)throw new Error("MGAudio not ready yet");if(e!=="music"&&e!=="ambience")throw new Error(`Invalid category: ${e}`);const r=te.urls[e].get(t);if(!r)throw new Error(`Unknown ${e}: ${t}`);zu(e);const o=new Audio(r);return o.loop=!!n.loop,o.volume=Lu(e,n.volume),o.preload="auto",o.play().catch(()=>{}),te.tracks[e]=o,o}function J0(e,t={}){const n=String(e||"").trim();return n==="music"||n==="ambience"?Array.from(te.urls[n].keys()).sort():n==="sfx"?te.sfx.atlas?t.groups?Array.from(te.sfx.groups.keys()).sort():Object.keys(te.sfx.atlas).sort():[]:[]}function Q0(){return ["sfx","music","ambience"]}function Z0(){return Array.from(te.sfx.groups.keys()).sort((e,t)=>e.localeCompare(t))}function ey(e,t){const n=String(e||"").trim().toLowerCase(),r=String(t||"").trim();if(!r||n!=="music"&&n!=="ambience")return  false;const o=te.urls[n],a=r.toLowerCase();for(const i of Array.from(o.keys()))if(i.toLowerCase()===a)return  true;return  false}function ty(e){const t=String(e||"").trim();if(!t)return  false;const n=t.toLowerCase();for(const r of Array.from(te.sfx.groups.keys()))if(r.toLowerCase()===n)return  true;return  false}function ny(e,t){const n=String(e||"").trim().toLowerCase(),r=String(t||"").trim();if(!r)throw new Error("getTrackUrl(category, name) missing name");if(n!=="music"&&n!=="ambience")throw new Error(`Invalid category: ${e}`);const o=te.urls[n],a=r.toLowerCase();for(const[i,s]of Array.from(o.entries()))if(i.toLowerCase()===a)return s;return null}function ry(){return te.tracks.music&&(te.tracks.music.volume=Er("music").atom),te.tracks.ambience&&(te.tracks.ambience.volume=Er("ambience").atom),true}let Ue=null;async function oy(e,t={}){Hu();const n=new Audio(e);n.volume=t.volume??1,n.loop=t.loop??false,n.preload="auto";const r={audio:n,url:e,stop:()=>{n.loop?n.loop=false:(n.pause(),n.currentTime=0,Ue?.audio===n&&(Ue=null));},setVolume:o=>{n.volume=Math.max(0,Math.min(1,o));},isPlaying:()=>!n.paused&&!n.ended};Ue=r;try{await new Promise((o,a)=>{const i=setTimeout(()=>{a(new Error("Audio load timeout"));},5e3),s=()=>{clearTimeout(i),n.removeEventListener("canplay",l),n.removeEventListener("error",d);},l=()=>{s(),o();},d=()=>{s(),a(new Error(`Audio load error: ${n.error?.message}`));};n.readyState>=2?(clearTimeout(i),o()):(n.addEventListener("canplay",l,{once:!0}),n.addEventListener("error",d,{once:!0}));}),await n.play();}catch(o){throw Ue=null,o}return n.addEventListener("ended",()=>{Ue?.audio===n&&(Ue=null);}),r}function Hu(){return Ue?(Ue.stop(),Ue=null,true):false}function ay(e){return Ue?(Ue.setVolume(e),true):false}function iy(){return Ue?.isPlaying()??false}function sy(){return Ue}function ze(){if(!Eu())throw new Error("MGAudio not ready yet")}async function ly(e,t,n={}){const r=String(e||"").trim(),o=String(t||"").trim();if(!r||!o)throw new Error("play(category, asset) missing args");if(r==="sfx")return A0(o,n);if(r==="music"||r==="ambience")return Y0(r,o,n);throw new Error(`Unknown category: ${r}`)}const wa={init:K0,isReady:Eu,play:ly,stop:e=>(ze(),zu(e)),list:(e,t)=>(ze(),J0(e,t)),refreshVolumes:()=>(ze(),ry()),categoryVolume:e=>(ze(),Er(e)),getCategories:()=>(ze(),Q0()),getGroups:()=>(ze(),Z0()),hasTrack:(e,t)=>(ze(),ey(e,t)),hasGroup:e=>(ze(),ty(e)),getTrackUrl:(e,t)=>(ze(),ny(e,t)),playCustom:async(e,t)=>(ze(),oy(e,t)),stopCustom:()=>(ze(),Hu()),setCustomVolume:e=>(ze(),ay(e)),isCustomPlaying:()=>(ze(),iy()),getCustomHandle:()=>(ze(),sy()),CustomSounds:Gu},ju=Object.freeze(Object.defineProperty({__proto__:null,MGAudio:wa},Symbol.toStringTag,{value:"Module"}));function cy(){return {ready:false,baseUrl:null,byCat:new Map,byBase:new Map,overlay:null,live:new Set,defaultParent:null}}const be=cy();function Uu(){return be.ready}let fo=null;async function dy(){return be.ready?true:fo||(fo=(async()=>{be.baseUrl=await rn.base();const e=await Ct.load({baseUrl:be.baseUrl}),t=Ct.getBundle(e,"cosmetic");if(!t)throw new Error("No 'cosmetic' bundle in manifest");be.byCat.clear(),be.byBase.clear();for(const n of t.assets||[])for(const r of n.src||[]){if(typeof r!="string"||!/^cosmetic\/.+\.png$/i.test(r))continue;const a=r.split("/").pop().replace(/\.png$/i,""),i=a.indexOf("_");if(i<0)continue;const s=a.slice(0,i),l=a.slice(i+1),d=St(be.baseUrl,r);be.byBase.set(a,d),be.byCat.has(s)||be.byCat.set(s,new Map),be.byCat.get(s).set(l,d);}return be.ready=true,true})(),fo)}function Ni(e){let t=String(e||"").trim();return t?(t=t.replace(/^cosmetic\//i,""),t=t.replace(/\.png$/i,""),t):""}function uy(e,t){if(t===void 0){const a=Ni(e),i=a.indexOf("_");return i<0?{cat:"",asset:a,base:a}:{cat:a.slice(0,i),asset:a.slice(i+1),base:a}}const n=String(e||"").trim(),r=Ni(t),o=r.includes("_")?r:`${n}_${r}`;if(r.includes("_")&&!n){const a=r.indexOf("_");return {cat:r.slice(0,a),asset:r.slice(a+1),base:r}}return {cat:n,asset:r.replace(/^.+?_/,""),base:o}}function py(){return Array.from(be.byCat.keys()).sort((e,t)=>e.localeCompare(t))}function fy(e){const t=be.byCat.get(String(e||"").trim());return t?Array.from(t.keys()).sort((n,r)=>n.localeCompare(r)):[]}function Oi(e,t){const{cat:n,asset:r,base:o}=uy(e,t),a=be.byBase.get(o);if(a)return a;const s=be.byCat.get(n)?.get(r);if(s)return s;if(!be.baseUrl)throw new Error("MGCosmetic not initialized");if(!o)throw new Error("Invalid cosmetic name");return St(be.baseUrl,`cosmetic/${o}.png`)}const Yl=F?.document??document;function gy(){if(be.overlay)return be.overlay;const e=Yl.createElement("div");return e.id="MG_COSMETIC_OVERLAY",e.style.cssText=["position:fixed","left:0","top:0","width:100vw","height:100vh","pointer-events:none","z-index:99999999"].join(";"),Yl.documentElement.appendChild(e),be.overlay=e,e}function my(){const e=be.defaultParent;if(!e)return null;try{return typeof e=="function"?e():e}catch{return null}}function hy(e){return be.defaultParent=e,true}const by=F?.document??document;function $i(e,t,n){if(!be.ready)throw new Error("MGCosmetic not ready yet");let r,o;typeof t=="object"&&t!==null?(r=t,o=void 0):typeof t=="string"?(o=t,r=n||{}):(o=void 0,r=n||{});const a=o!==void 0?Oi(e,o):Oi(e),i=by.createElement("img");if(i.decoding="async",i.loading="eager",i.src=a,i.alt=r.alt!=null?String(r.alt):Ni(o??e),r.className&&(i.className=String(r.className)),r.width!=null&&(i.style.width=String(r.width)),r.height!=null&&(i.style.height=String(r.height)),r.opacity!=null&&(i.style.opacity=String(r.opacity)),r.style&&typeof r.style=="object")for(const[s,l]of Object.entries(r.style))try{i.style[s]=String(l);}catch{}return i}function xy(e,t,n){let r,o;typeof t=="object"&&t!==null?(r=t,o=void 0):typeof t=="string"?(o=t,r=n||{}):(o=void 0,r=n||{});const a=r.parent||my()||gy(),i=o!==void 0?$i(e,o,r):$i(e,r);if(a===be.overlay||r.center||r.x!=null||r.y!=null||r.absolute){i.style.position="absolute",i.style.pointerEvents="none",i.style.zIndex=String(r.zIndex??999999);const l=r.scale??1,d=r.rotation??0;if(r.center)i.style.left="50%",i.style.top="50%",i.style.transform=`translate(-50%, -50%) scale(${l}) rotate(${d}rad)`;else {const c=r.x??innerWidth/2,u=r.y??innerHeight/2;i.style.left=`${c}px`,i.style.top=`${u}px`,i.style.transform=`scale(${l}) rotate(${d}rad)`,r.anchor==="center"&&(i.style.transform=`translate(-50%, -50%) scale(${l}) rotate(${d}rad)`);}}return a.appendChild(i),be.live.add(i),i.__mgDestroy=()=>{try{i.remove();}catch{}be.live.delete(i);},i}function yy(){for(const e of Array.from(be.live))e.__mgDestroy?.();}function Ht(){if(!Uu())throw new Error("MGCosmetic not ready yet")}const $s={init:dy,isReady:Uu,categories:()=>(Ht(),py()),list:e=>(Ht(),fy(e)),url:((e,t)=>(Ht(),Oi(e,t))),create:((e,t,n)=>(Ht(),$i(e,t,n))),show:((e,t,n)=>(Ht(),xy(e,t,n))),attach:e=>(Ht(),hy(e)),clear:()=>(Ht(),yy())},tr={Gold:25,Rainbow:50,Wet:2,Chilled:2,Frozen:10,Dawnlit:2,Dawnbound:3,Amberlit:5,Amberbound:6},vy=new Set(["Gold","Rainbow"]),wy=new Set(["Wet","Chilled","Frozen","Dawnlit","Dawnbound","Amberlit","Amberbound"]);function Wu(e){let t=1,n=0,r=0;for(const o of e)o==="Gold"||o==="Rainbow"?o==="Rainbow"?t=tr.Rainbow:t===1&&(t=tr.Gold):o in tr&&(n+=tr[o],r++);return t*(1+n-r)}function Sy(e){return tr[e]??null}function Cy(e){return vy.has(e)}function ky(e){return wy.has(e)}function _y(e){return ky(e)}function Bs(e,t){const n=Sa(e);if(!n)return 50;const r=n.maxScale;if(t<=1)return 50;if(t>=r)return 100;const o=(t-1)/(r-1);return Math.floor(50+50*o)}function dt(e,t,n){const r=Sa(e);if(!r)return 0;const o=r.baseSellPrice,a=Wu(n);return Math.round(o*t*a)}function Ty(e,t,n){if(n>=t)return 100;if(n<=e)return 0;const r=t-e,o=n-e;return Math.floor(o/r*100)}function Py(e,t){return t>=e}function Sa(e){const t=K.get("plants");if(!t)return null;const n=t[e];return n?.crop?{baseSellPrice:n.crop.baseSellPrice??0,maxScale:n.crop.maxScale??1,growTime:n.crop.growTime??0}:null}const Vu=3600,qa=80,Iy=100,nr=30;function Ca(e){return e/Vu}function ka(e,t){const n=Hr(e);if(!n)return qa;const r=n.maxScale;if(t<=1)return qa;if(t>=r)return Iy;const o=(t-1)/(r-1);return Math.floor(qa+20*o)}function _a(e,t,n){const r=Hr(e);if(!r)return n-nr;const o=r.hoursToMature,a=t/Vu,i=nr/o,s=Math.min(i*a,nr),l=n-nr;return Math.floor(l+s)}function Ta(e,t){const n=Hr(e);return n?t>=n.hoursToMature:false}function Xu(e){const t=Hr(e);return t?nr/t.hoursToMature:0}function Ay(e,t,n){const r=t-e;return r<=0||n<=0?0:r/n}function Hr(e){const t=K.get("pets");if(!t)return null;const n=t[e];return n?{hoursToMature:n.hoursToMature??0,maxScale:n.maxScale??1,abilities:n.abilities??[]}:null}function Ey(e,t){return t<=0?1:Math.min(1,e/t)}const Ae=3600,go=80,Jl=100,yt=30,My={Worm:30,Snail:60,Bee:15,Chicken:60,Bunny:45,Dragonfly:15,Pig:60,Cow:75,Turkey:60,SnowFox:45,Stoat:60,WhiteCaribou:75,Squirrel:30,Turtle:90,Goat:60,Butterfly:30,Peacock:60,Capybara:60};function jr(e){const t=K.get("pets");if(!t)return null;const n=t[e];return n?{hoursToMature:n.hoursToMature??0,maxScale:n.maxScale??1}:null}function Ry(e){return e/Ae}function Ur(e,t){const n=jr(e);if(!n)return go;const{maxScale:r}=n;if(t<=1)return go;if(t>=r)return Jl;const o=(t-1)/(r-1);return Math.floor(go+(Jl-go)*o)}function Ly(e){return e-yt}function Fy(e){const t=jr(e);return !t||t.hoursToMature<=0?0:yt/t.hoursToMature}function Wr(e,t,n){const r=jr(e);if(!r)return n-yt;const o=t/Ae,a=yt/r.hoursToMature,i=Math.min(a*o,yt),s=n-yt;return Math.floor(s+i)}function qu(e,t,n){const r=jr(e);if(!r)return 0;const o=n-yt,a=t-o;if(a<=0)return 0;const i=yt/r.hoursToMature;return i<=0?0:a/i*Ae}function Ds(e,t,n,r,o=Ae){const i=qu(e,n,r)-t;return i<=0?0:o<=0?1/0:i/o}function Pa(e,t,n,r=Ae){return Ds(e,t,n,n,r)}function Gs(e,t,n,r,o=Ae){if(n>=r)return 0;const a=n+1;return Ds(e,t,a,r,o)}function Ny(e,t){return e>=t}function Oy(e,t){const n=t-yt,o=(e-n)/yt*100;return Math.min(100,Math.max(0,o))}const $y=Object.freeze(Object.defineProperty({__proto__:null,calculateAge:Ry,calculateCurrentStrength:Wr,calculateHoursToMaxStrength:Pa,calculateHoursToNextStrength:Gs,calculateHoursToStrength:Ds,calculateMaxStrength:Ur,calculateStartingStrength:Ly,calculateStrengthPerHour:Fy,calculateStrengthProgress:Oy,calculateXpForStrength:qu,getSpeciesData:jr,isPetMature:Ny},Symbol.toStringTag,{value:"Module"}));function zs(e){const t=K.get("pets");if(!t)return 100/24;const n=t[e];if(!n?.coinsToFullyReplenishHunger)return 100/24;const r=My[e];return r?n.coinsToFullyReplenishHunger/r*60:(console.warn(`[Feed] Unknown species "${e}", using 60min default`),n.coinsToFullyReplenishHunger/60*60)}function By(e,t){return e<=0?0:t<=0?1/0:e/t}function Hs(e,t,n,r){if(e<=0||n<=0)return 0;const o=t/n;if(o>=e)return 0;const a=e-o,i=r/n;return Math.ceil(a/i)}function js(e,t,n){const r=K.get("pets");if(!r)return 0;const o=r[e];if(!o?.coinsToFullyReplenishHunger)return 0;const a=o.coinsToFullyReplenishHunger,i=zs(e);return Hs(n,t,i,a)}function Mr(e,t,n){const r=K.get("pets");if(!r)return 0;const o=r[e];if(!o?.coinsToFullyReplenishHunger)return 0;const a=o.coinsToFullyReplenishHunger,i=zs(e);return Hs(n,t,i,a)}function Us(e,t,n,r,o,a){return e?t&&a>0?Mr(n,r,a):0:Mr(n,r,o)}const Dy=Object.freeze(Object.defineProperty({__proto__:null,calculateAdjustedFeedsToMax:Us,calculateFeedsForDuration:Hs,calculateFeedsToMaxStrength:Mr,calculateFeedsToNextStrength:js,calculateHoursUntilStarving:By,getHungerDrainPerHour:zs},Symbol.toStringTag,{value:"Module"})),Ku={init(){},isReady(){return  true},crop:{calculateSize:Bs,calculateSellPrice:dt,calculateProgress:Ty,isReady:Py,getData:Sa},pet:{calculateAge:Ca,calculateMaxStrength:ka,calculateCurrentStrength:_a,isMature:Ta,calculateStrengthPerHour:Xu,getData:Hr},mutation:{calculateMultiplier:Wu,getValue:Sy,isGrowth:Cy,isEnvironmental:_y},xp:$y,feed:Dy};async function Yu(e){const t=[{name:"Data",init:()=>K.init()},{name:"CustomModal",init:()=>bn.init()},{name:"Sprites",init:()=>j.init()},{name:"TileObjectSystem",init:()=>kt.init()},{name:"Pixi",init:()=>xa.init()},{name:"Audio",init:()=>wa.init()},{name:"Cosmetics",init:()=>$s.init()}];await Promise.all(t.map(async n=>{e?.({status:"start",name:n.name});try{await n.init(),e?.({status:"success",name:n.name});}catch(r){console.error(`[${n.name}] failed`,r),e?.({status:"error",name:n.name,error:r});}})),console.log("[Gemini] Modules ready. Access via Gemini.Modules in console.");}const Ws=Object.freeze(Object.defineProperty({__proto__:null,MGAssets:rn,MGAudio:wa,MGCalculators:Ku,MGCosmetic:$s,MGCustomModal:bn,MGData:K,MGEnvironment:Ve,MGManifest:Ct,MGPixi:xa,MGPixiHooks:et,MGSprite:j,MGTile:kt,MGVersion:ms,PET_ABILITY_ACTIONS:ou,filterPetAbilityLogs:iu,formatAbilityLog:su,initAllModules:Yu,isPetAbilityAction:au},Symbol.toStringTag,{value:"Module"}));function Gy(e){const t=String(e??"").trim().toLowerCase();return t?t==="common"?"Common":t==="uncommon"?"Uncommon":t==="rare"?"Rare":t==="legendary"?"Legendary":t==="mythical"?"Mythical":t==="divine"?"Divine":t==="celestial"?"Celestial":t==="unknown"||t==="unknow"?"Unknown":null:null}function zy(e){return e.toLowerCase()}function Vr(e={}){const{id:t,label:n="",type:r="neutral",tone:o="soft",border:a,withBorder:i,pill:s=true,size:l="md",onClick:d,variant:c="default",rarity:u=null,abilityId:p="",abilityName:f=""}=e,g=x("span",{className:"badge",id:t});s&&g.classList.add("badge--pill"),l==="sm"?g.classList.add("badge--sm"):l==="lg"?g.classList.add("badge--lg"):g.classList.add("badge--md"),d&&g.addEventListener("click",d);let m=false,h=i;function b(){m||(h===false?g.style.border="none":g.style.border="");}function w(k,P=o){g.classList.remove("badge--neutral","badge--info","badge--success","badge--warning","badge--danger","badge--soft","badge--outline","badge--solid"),g.classList.add(`badge--${k}`,`badge--${P}`),b();}function C(k){const P=(k??"").trim();P?(g.style.border=P,m=true):(m=false,b());}function v(k){h=k,b();}function _(k){g.textContent=k;}function y(k,P=o){w(k,P);}function S(k){g.classList.remove("badge--rarity","badge--rarity-common","badge--rarity-uncommon","badge--rarity-rare","badge--rarity-legendary","badge--rarity-mythical","badge--rarity-divine","badge--rarity-celestial","badge--rarity-unknown"),g.style.background="",g.style.backgroundSize="",g.style.animation="",g.style.color="",g.style.webkitTextStroke="";const P=Gy(k);if(!P){g.textContent=String(k??"—");return}g.textContent=P,g.classList.add("badge--rarity",`badge--rarity-${zy(P)}`);}function T(k,P){const B=K.get("abilities")?.[k],Z=B?.color,H=Z?.bg||"rgba(100, 100, 100, 0.9)",D=Z?.hover||"rgba(150, 150, 150, 1)";g.classList.remove("badge--neutral","badge--info","badge--success","badge--warning","badge--danger","badge--soft","badge--outline","badge--solid","badge--rarity","badge--rarity-common","badge--rarity-uncommon","badge--rarity-rare","badge--rarity-legendary","badge--rarity-mythical","badge--rarity-divine","badge--rarity-celestial","badge--rarity-unknown"),g.classList.add("badge--ability"),g.textContent=P||B?.name||k||"Unknown Ability",g.style.background=H,g.style.color="white",g.style.border="none",g.style.webkitTextStroke="",g.style.animation="",g.style.backgroundSize="";const Y=()=>{g.style.background=D;},O=()=>{g.style.background=H;};g.removeEventListener("mouseenter",Y),g.removeEventListener("mouseleave",O),g.addEventListener("mouseenter",Y),g.addEventListener("mouseleave",O);}return c==="rarity"?S(u):c==="ability"?T(p,f):(g.textContent=n,w(r,o),typeof i=="boolean"&&v(i),a&&C(a)),{root:g,setLabel:_,setType:y,setBorder:C,setWithBorder:v,setRarity:S,setAbility:T}}const Hy={expanded:false,sort:{key:null,dir:null},search:""},jy={categories:{}};async function Uy(){const e=await Dr("tab-test",{version:2,defaults:jy,sanitize:a=>({categories:a.categories&&typeof a.categories=="object"?a.categories:{}})});function t(a){return e.get().categories[a]||{...Hy}}function n(a,i){const s=e.get(),l=t(a);e.update({categories:{...s.categories,[a]:{...l,expanded:i}}});}function r(a,i,s){const l=e.get(),d=t(a);e.update({categories:{...l.categories,[a]:{...d,sort:{key:i,dir:s}}}});}function o(a,i){const s=e.get(),l=t(a);e.update({categories:{...s.categories,[a]:{...l,search:i}}});}return {get:e.get,set:e.set,save:e.save,getCategoryState:t,setCategoryExpanded:n,setCategorySort:r,setCategorySearch:o}}const Wy={Common:1,Uncommon:2,Rare:3,Legendary:4,Mythical:5,Divine:6,Celestial:7};function mo(e){return e?Wy[e]??0:0}class Vy extends nn{constructor(){super({id:"tab-test",label:"Test"});L(this,"stateCtrl",null);}async build(n){this.stateCtrl=await Uy();const r=this.createContainer("test-section");r.style.display="flex",r.style.flexDirection="column",r.style.gap="12px",n.appendChild(r),await this.buildSpriteTables(r);}renderSprite(n){const r=x("div",{style:"display:flex;align-items:center;justify-content:center;width:32px;height:32px;"});if(n.spriteId){const o=n.spriteId;requestAnimationFrame(()=>{try{const a=j.toCanvas(o,{scale:1});a.style.maxWidth="32px",a.style.maxHeight="32px",a.style.objectFit="contain",r.appendChild(a);}catch{r.textContent="-";}});}else r.textContent="-";return r}renderRarity(n){if(!n.rarity){const o=x("span",{style:"opacity:0.5;"});return o.textContent="—",o}return Vr({variant:"rarity",rarity:n.rarity,size:"sm"}).root}createDataCard(n,r,o,a){const i=this.stateCtrl.getCategoryState(n),s=p=>{if(!p)return o;const f=p.toLowerCase();return o.filter(g=>g.name.toLowerCase().includes(f))},l=us({columns:a,data:s(i.search),pageSize:0,compact:true,maxHeight:"calc(var(--lg-row-h, 40px) * 6)",getRowId:p=>p.spriteId,onSortChange:(p,f)=>{this.stateCtrl.setCategorySort(n,p,f);}});i.sort.key&&i.sort.dir&&l.sortBy(i.sort.key,i.sort.dir);const d=ps({placeholder:"Search...",value:i.search,debounceMs:150,withClear:true,size:"sm",focusKey:"",onChange:p=>{const f=p.trim();this.stateCtrl.setCategorySearch(n,f),l.setData(s(f));}}),c=x("div",{style:"margin-bottom:8px;"});c.appendChild(d.root);const u=x("div");return u.appendChild(c),u.appendChild(l.root),We({title:r,subtitle:`${o.length} entries`,variant:"soft",padding:"sm",expandable:true,defaultExpanded:i.expanded,onExpandChange:p=>{this.stateCtrl.setCategoryExpanded(n,p);}},u)}formatCategoryName(n){return n.split("-").map(r=>r.charAt(0).toUpperCase()+r.slice(1)).join(" ")}findPlantBySprite(n,r){const o=K.get("plants");if(!o)return null;for(const i of Object.values(o))if(i?.seed?.spriteId===n||i?.plant?.spriteId===n||i?.crop?.spriteId===n)return i;const a=r.toLowerCase();for(const i of Object.values(o)){const s=(i?.seed?.name||"").toLowerCase();if(s===a||s===`${a} seed`)return i}return null}findPetBySpriteId(n){const r=K.get("pets");if(!r)return null;for(const o of Object.values(r))if(o?.spriteId===n)return o;return null}findItemBySpriteId(n){const r=K.get("items");if(!r)return null;for(const o of Object.values(r))if(o?.spriteId===n)return o;return null}findDecorBySpriteId(n){const r=K.get("decor");if(!r)return null;for(const o of Object.values(r))if(o?.spriteId===n)return o;return null}findEggBySpriteId(n){const r=K.get("eggs");if(!r)return null;for(const o of Object.values(r))if(o?.spriteId===n)return o;return null}getRarityForSprite(n,r,o){const a=n.toLowerCase();if(a==="plant"||a==="seed"||a==="tallplant"){const i=this.findPlantBySprite(r,o);if(i?.seed?.rarity)return i.seed.rarity}if(a==="pet"){const i=this.findPetBySpriteId(r);if(i?.rarity)return i.rarity}if(a==="item"){const i=this.findItemBySpriteId(r);if(i?.rarity)return i.rarity}if(a==="decor"){const i=this.findDecorBySpriteId(r);if(i?.rarity)return i.rarity}if(a==="egg"){const i=this.findEggBySpriteId(r);if(i?.rarity)return i.rarity}return null}yieldToMain(n=0){return new Promise(r=>{n>0?setTimeout(r,n):typeof requestIdleCallback<"u"?requestIdleCallback(()=>r(),{timeout:50}):setTimeout(r,4);})}async buildSpriteTables(n){const r=[{key:"name",header:"Name",sortable:true,width:"1fr",sortFn:(a,i)=>a.name.localeCompare(i.name,void 0,{numeric:true,sensitivity:"base"})},{key:"rarity",header:"Rarity",sortable:true,width:"100px",align:"center",render:a=>this.renderRarity(a),sortFn:(a,i)=>mo(a.rarity)-mo(i.rarity)},{key:"sprite",header:"Sprite",width:"60px",align:"center",render:a=>this.renderSprite(a)}];if(!j.isReady())try{await j.init();}catch{return}const o=j.getCategories();for(let a=0;a<o.length;a++){await this.yieldToMain(8);const i=o[a],l=j.getCategoryId(i).map(d=>{const c=`sprite/${i}/${d}`;return {name:d,spriteId:c,rarity:this.getRarityForSprite(i,c,d)}});if(l.sort((d,c)=>mo(d.rarity)-mo(c.rarity)),l.length>0){const d=this.createDataCard(i,this.formatCategoryName(i),l,r);n.appendChild(d);}}}}function ye(e,t,n){if(e.querySelector(`style[data-style-id="${n}"]`))return;const r=document.createElement("style");r.setAttribute("data-style-id",n),r.textContent=t,e.appendChild(r);}const Ju=`
...
`,Xy={enabled:false,favoriteProduceList:[],favoritePetsList:[],favoriteMutations:[]};let Ut=null;async function qy(){if(Ut)return Ut;Ut=await Dr("tab-auto-favorite",{version:1,defaults:Xy});const e=ve(we.AUTO_FAVORITE_UI,null);return e&&(await Ut.set(e),ig(we.AUTO_FAVORITE_UI),console.log("[AutoFavoriteSettings] Migrated old storage to new state")),Ut}function at(){if(!Ut)throw new Error("[AutoFavoriteSettings] Section state not initialized. Call initSectionState() first.");return Ut}const Vs=we.AUTO_FAVORITE,Qu={enabled:false,mode:"simple",simple:{enabled:false,favoriteSpecies:[],favoriteMutations:[]}};function en(){return ve(Vs,Qu)}function Xs(e){Pe(Vs,e);}function Zu(e){const n={...en(),...e};return Xs(n),n}function qs(e){const t=en();return t.mode="simple",t.simple={...t.simple,...e},Xs(t),t}function Ky(e){qs({favoriteSpecies:e});}function Yy(e){qs({favoriteMutations:e});}function Ql(){return en().enabled}function ut(e,t){if(e===t)return  true;if(e===null||t===null)return e===t;if(typeof e!=typeof t)return  false;if(typeof e!="object")return e===t;if(Array.isArray(e)&&Array.isArray(t)){if(e.length!==t.length)return  false;for(let i=0;i<e.length;i++)if(!ut(e[i],t[i]))return  false;return  true}if(Array.isArray(e)||Array.isArray(t))return  false;const n=e,r=t,o=Object.keys(n),a=Object.keys(r);if(o.length!==a.length)return  false;for(const i of o)if(!Object.prototype.hasOwnProperty.call(r,i)||!ut(n[i],r[i]))return  false;return  true}const Zl={currentGardenTile:"myCurrentGardenTileAtom",globalTileIndex:"myCurrentGlobalTileIndexAtom",gardenObject:"myCurrentGardenObjectAtom",isMature:"isGardenObjectMatureAtom",isInMyGarden:"isInMyGardenAtom",gardenName:"currentGardenNameAtom",sortedSlotIndices:"myCurrentSortedGrowSlotIndicesAtom",currentGrowSlotIndex:"myCurrentGrowSlotIndexAtom"},ec={position:{globalIndex:null,localIndex:null},tile:{type:null,isEmpty:true},garden:{name:null,isOwner:false,playerSlotIndex:null},object:{type:null,data:null,isMature:false},plant:null};function Jy(e){const t=e.currentGardenTile;return {globalIndex:e.globalTileIndex,localIndex:t?.localTileIndex??null}}function Qy(e){return {type:e.currentGardenTile?.tileType??null,isEmpty:e.gardenObject===null}}function Zy(e){const t=e.currentGardenTile;return {name:e.gardenName,isOwner:e.isInMyGarden??false,playerSlotIndex:t?.userSlotIdx??null}}function ev(e){const t=e.gardenObject;return t?{type:t.objectType,data:t,isMature:e.isMature??false}:{type:null,data:null,isMature:false}}function tv(e){const t=e.gardenObject;if(!t||t.objectType!=="plant")return null;const n=t,r=e.sortedSlotIndices??[];return {species:n.species,slots:n.slots??[],currentSlotIndex:e.currentGrowSlotIndex,sortedSlotIndices:r,nextHarvestSlotIndex:r.length>0?r[0]:null}}function tc(e){return {position:Jy(e),tile:Qy(e),garden:Zy(e),object:ev(e),plant:tv(e)}}function nc(e){return JSON.stringify({globalIndex:e.position.globalIndex,localIndex:e.position.localIndex,tileType:e.tile.type,isEmpty:e.tile.isEmpty,gardenName:e.garden.name,isOwner:e.garden.isOwner,playerSlotIndex:e.garden.playerSlotIndex,objectType:e.object.type,isMature:e.object.isMature,plantSpecies:e.plant?.species??null,slotCount:e.plant?.slots.length??0})}function nv(e,t){return e.type!==t.type||e.isMature!==t.isMature?true:e.data===null&&t.data===null?false:e.data===null||t.data===null?true:!ut(e.data,t.data)}function rv(e,t){return e===null&&t===null?false:e===null||t===null||e.species!==t.species||e.currentSlotIndex!==t.currentSlotIndex||e.nextHarvestSlotIndex!==t.nextHarvestSlotIndex||e.slots.length!==t.slots.length||!ut(e.sortedSlotIndices,t.sortedSlotIndices)?true:!ut(e.slots,t.slots)}function ov(e,t){return e.name!==t.name||e.isOwner!==t.isOwner||e.playerSlotIndex!==t.playerSlotIndex}function av(){let e=ec,t=ec,n=false;const r=[],o={all:new Set,stable:new Set,object:new Set,plantInfo:new Set,garden:new Set},a={},i=Object.keys(Zl),s=new Set;function l(){if(s.size<i.length)return;const c=tc(a);if(!ut(e,c)&&(t=e,e=c,!!n)){for(const u of o.all)u(e,t);if(nc(t)!==nc(e))for(const u of o.stable)u(e,t);if(nv(t.object,e.object)){const u={current:e.object,previous:t.object};for(const p of o.object)p(u);}if(rv(t.plant,e.plant)){const u={current:e.plant,previous:t.plant};for(const p of o.plantInfo)p(u);}if(ov(t.garden,e.garden)){const u={current:e.garden,previous:t.garden};for(const p of o.garden)p(u);}}}async function d(){if(n)return;const c=i.map(async u=>{const p=Zl[u],f=await ge.subscribe(p,g=>{a[u]=g,s.add(u),l();});r.push(f);});await Promise.all(c),n=true,s.size===i.length&&(e=tc(a));}return d(),{get(){return e},subscribe(c,u){return o.all.add(c),u?.immediate!==false&&n&&s.size===i.length&&c(e,e),()=>o.all.delete(c)},subscribeStable(c,u){return o.stable.add(c),u?.immediate!==false&&n&&s.size===i.length&&c(e,e),()=>o.stable.delete(c)},subscribeObject(c,u){return o.object.add(c),u?.immediate&&n&&s.size===i.length&&c({current:e.object,previous:e.object}),()=>o.object.delete(c)},subscribePlantInfo(c,u){return o.plantInfo.add(c),u?.immediate&&n&&s.size===i.length&&c({current:e.plant,previous:e.plant}),()=>o.plantInfo.delete(c)},subscribeGarden(c,u){return o.garden.add(c),u?.immediate&&n&&s.size===i.length&&c({current:e.garden,previous:e.garden}),()=>o.garden.delete(c)},destroy(){for(const c of r)c();r.length=0,o.all.clear(),o.stable.clear(),o.object.clear(),o.plantInfo.clear(),o.garden.clear(),n=false;}}}let Ka=null;function Xe(){return Ka||(Ka=av()),Ka}function iv(){let e=null;const t=[],n=new Set,r={},o=new Set,a=2;function i(u,p){return {x:p%u,y:Math.floor(p/u)}}function s(u,p,f){return f*u+p}function l(u,p){const{cols:f,rows:g}=u,m=f*g,h=new Set,b=new Set,w=new Map,C=[],v=u.userSlotIdxAndDirtTileIdxToGlobalTileIdx??[],_=u.userSlotIdxAndBoardwalkTileIdxToGlobalTileIdx??[],y=Math.max(v.length,_.length);for(let k=0;k<y;k++){const P=v[k]??[],E=_[k]??[],B=P.map((H,D)=>(h.add(H),w.set(H,k),{globalIndex:H,localIndex:D,position:i(f,H)})),Z=E.map((H,D)=>(b.add(H),w.set(H,k),{globalIndex:H,localIndex:D,position:i(f,H)}));C.push({userSlotIdx:k,dirtTiles:B,boardwalkTiles:Z,allTiles:[...B,...Z]});}const S=u.spawnTiles.map(k=>i(f,k)),T={};if(u.locations)for(const[k,P]of Object.entries(u.locations)){const E=P.spawnTileIdx??[];T[k]={name:k,spawnTiles:E,spawnPositions:E.map(B=>i(f,B))};}return {cols:f,rows:g,totalTiles:m,tileSize:p,spawnTiles:u.spawnTiles,spawnPositions:S,locations:T,userSlots:C,globalToXY(k){return i(f,k)},xyToGlobal(k,P){return s(f,k,P)},getTileOwner(k){return w.get(k)??null},isDirtTile(k){return h.has(k)},isBoardwalkTile(k){return b.has(k)}}}function d(){if(o.size<a||e)return;const u=r.map,p=r.tileSize??0;if(u){e=l(u,p);for(const f of n)f(e);n.clear();}}async function c(){const u=await ge.subscribe("mapAtom",f=>{r.map=f,o.add("map"),d();});t.push(u);const p=await ge.subscribe("tileSizeAtom",f=>{r.tileSize=f,o.add("tileSize"),d();});t.push(p);}return c(),{get(){return e},isReady(){return e!==null},onReady(u,p){return e?(p?.immediate!==false&&u(e),()=>{}):(n.add(u),()=>n.delete(u))},destroy(){for(const u of t)u();t.length=0,e=null,n.clear();}}}let Ya=null;function Bi(){return Ya||(Ya=iv()),Ya}function sv(){const e=K.get("mutations");return e?Object.keys(e):[]}function ep(){const e={};for(const t of sv())e[t]=[];return e}function Di(){return {garden:null,mySlotIndex:null,plants:{all:[],mature:[],growing:[],bySpecies:{},count:0},crops:{all:[],mature:[],growing:[],mutated:{all:[],byMutation:ep()}},eggs:{all:[],mature:[],growing:[],byType:{},count:0},decors:{tileObjects:[],boardwalk:[],all:[],byType:{},count:0},tiles:{tileObjects:[],boardwalk:[],empty:{tileObjects:[],boardwalk:[]}},counts:{plants:0,maturePlants:0,crops:0,matureCrops:0,eggs:0,matureEggs:0,decors:0,emptyTileObjects:0,emptyBoardwalk:0}}}function lv(e,t,n,r){const o=t.slots.filter(a=>r>=a.endTime).length;return {tileIndex:e,position:n,species:t.species,plantedAt:t.plantedAt,maturedAt:t.maturedAt,isMature:r>=t.maturedAt,slots:t.slots,slotsCount:t.slots.length,matureSlotsCount:o}}function cv(e,t,n,r,o){return {tileIndex:e,position:t,slotIndex:n,species:r.species,startTime:r.startTime,endTime:r.endTime,targetScale:r.targetScale,mutations:[...r.mutations],isMature:o>=r.endTime}}function dv(e,t,n,r){return {tileIndex:e,position:n,eggId:t.eggId,plantedAt:t.plantedAt,maturedAt:t.maturedAt,isMature:r>=t.maturedAt}}function rc(e,t,n,r){return {tileIndex:e,position:n,decorId:t.decorId,rotation:t.rotation,location:r}}function oc(e,t){const{garden:n,mySlotIndex:r}=e,o=Date.now();if(!n||r===null)return Di();const a=t().get(),i=a?.userSlots[r],s=i?.dirtTiles??[],l=i?.boardwalkTiles??[],d=[],c=[],u=[],p={},f=[],g=[],m=[],h=[],b=ep(),w=[],C=[],v=[],_={},y=[],S=[],T={},k=new Set,P=new Set;for(const[H,D]of Object.entries(n.tileObjects)){const Y=parseInt(H,10);k.add(Y);const O=a?a.globalToXY(Y):{x:0,y:0};if(D.objectType==="plant"){const z=D,G=lv(H,z,O,o);d.push(G),G.isMature?c.push(G):u.push(G),p[G.species]||(p[G.species]=[]),p[G.species].push(G);for(let $=0;$<z.slots.length;$++){const A=z.slots[$],R=cv(H,O,$,A,o);if(f.push(R),R.isMature?g.push(R):m.push(R),R.mutations.length>0){h.push(R);for(const N of R.mutations)b[N]||(b[N]=[]),b[N].push(R);}}}else if(D.objectType==="egg"){const G=dv(H,D,O,o);w.push(G),_[G.eggId]||(_[G.eggId]=[]),_[G.eggId].push(G),G.isMature?C.push(G):v.push(G);}else if(D.objectType==="decor"){const G=rc(H,D,O,"tileObjects");y.push(G),T[G.decorId]||(T[G.decorId]=[]),T[G.decorId].push(G);}}for(const[H,D]of Object.entries(n.boardwalkTileObjects)){const Y=parseInt(H,10);P.add(Y);const O=a?a.globalToXY(Y):{x:0,y:0},G=rc(H,D,O,"boardwalk");S.push(G),T[G.decorId]||(T[G.decorId]=[]),T[G.decorId].push(G);}const E=[...y,...S],B=s.filter(H=>!k.has(H.localIndex)),Z=l.filter(H=>!P.has(H.localIndex));return {garden:n,mySlotIndex:r,plants:{all:d,mature:c,growing:u,bySpecies:p,count:d.length},crops:{all:f,mature:g,growing:m,mutated:{all:h,byMutation:b}},eggs:{all:w,mature:C,growing:v,byType:_,count:w.length},decors:{tileObjects:y,boardwalk:S,all:E,byType:T,count:E.length},tiles:{tileObjects:s,boardwalk:l,empty:{tileObjects:B,boardwalk:Z}},counts:{plants:d.length,maturePlants:c.length,crops:f.length,matureCrops:g.length,eggs:w.length,matureEggs:C.length,decors:E.length,emptyTileObjects:B.length,emptyBoardwalk:Z.length}}}function ac(e){return JSON.stringify({plants:e.counts.plants,maturePlants:e.counts.maturePlants,crops:e.counts.crops,matureCrops:e.counts.matureCrops,eggs:e.counts.eggs,matureEggs:e.counts.matureEggs,decors:e.counts.decors,emptyTileObjects:e.counts.emptyTileObjects,emptyBoardwalk:e.counts.emptyBoardwalk})}function uv(e,t){const n=new Set(e.map(i=>i.tileIndex)),r=new Set(t.map(i=>i.tileIndex)),o=t.filter(i=>!n.has(i.tileIndex)),a=e.filter(i=>!r.has(i.tileIndex));return {added:o,removed:a}}function pv(e,t,n){const r=new Set(e.map(a=>a.tileIndex)),o=new Set(n.map(a=>a.tileIndex));return t.filter(a=>!r.has(a.tileIndex)&&o.has(a.tileIndex))}function fv(e,t,n){const r=new Set(e.map(a=>`${a.tileIndex}:${a.slotIndex}`)),o=new Set(n.map(a=>`${a.tileIndex}:${a.slotIndex}`));return t.filter(a=>{const i=`${a.tileIndex}:${a.slotIndex}`;return !r.has(i)&&o.has(i)})}function gv(e,t,n){const r=new Set(e.map(a=>a.tileIndex)),o=new Set(n.map(a=>a.tileIndex));return t.filter(a=>!r.has(a.tileIndex)&&o.has(a.tileIndex))}function mv(e,t){const n=[],r=new Map(e.map(o=>[o.tileIndex,o]));for(const o of t){const a=r.get(o.tileIndex);if(!a)continue;const i=Math.min(a.slots.length,o.slots.length);for(let s=0;s<i;s++){const l=new Set(a.slots[s].mutations),d=new Set(o.slots[s].mutations),c=[...d].filter(p=>!l.has(p)),u=[...l].filter(p=>!d.has(p));if(c.length>0||u.length>0){const p=Date.now(),f=o.slots[s],g={tileIndex:o.tileIndex,position:o.position,slotIndex:s,species:f.species,startTime:f.startTime,endTime:f.endTime,targetScale:f.targetScale,mutations:[...f.mutations],isMature:p>=f.endTime};n.push({crop:g,added:c,removed:u});}}}return n}function hv(e,t,n){const r=[],o=new Map(t.map(i=>[i.tileIndex,i])),a=new Map;for(const i of n)a.set(`${i.tileIndex}:${i.slotIndex}`,i);for(const i of e){const s=o.get(i.tileIndex);if(!s)continue;const l=Math.min(i.slots.length,s.slots.length);for(let d=0;d<l;d++){const c=i.slots[d],u=s.slots[d];if(c.startTime!==u.startTime){const p=a.get(`${i.tileIndex}:${d}`);if(!p||!p.isMature)continue;const f={tileIndex:i.tileIndex,position:i.position,slotIndex:d,species:c.species,startTime:c.startTime,endTime:c.endTime,targetScale:c.targetScale,mutations:[...c.mutations],isMature:true};r.push({crop:f,remainingSlots:s.slotsCount});}}if(s.slotsCount<i.slotsCount)for(let d=s.slotsCount;d<i.slotsCount;d++){const c=a.get(`${i.tileIndex}:${d}`);if(!c||!c.isMature)continue;const u=i.slots[d];if(!u)continue;const p={tileIndex:i.tileIndex,position:i.position,slotIndex:d,species:u.species,startTime:u.startTime,endTime:u.endTime,targetScale:u.targetScale,mutations:[...u.mutations],isMature:true};r.push({crop:p,remainingSlots:s.slotsCount});}}return r}function bv(e,t){const n=new Set(e.map(i=>i.tileIndex)),r=new Set(t.map(i=>i.tileIndex)),o=t.filter(i=>!n.has(i.tileIndex)),a=e.filter(i=>!r.has(i.tileIndex));return {added:o,removed:a}}function xv(e,t){const n=l=>`${l.tileIndex}:${l.location}`,r=l=>`${l.tileIndex}:${l.location}`,o=new Set(e.map(n)),a=new Set(t.map(r)),i=t.filter(l=>!o.has(r(l))),s=e.filter(l=>!a.has(n(l)));return {added:i,removed:s}}function yv(){let e=Di(),t=Di(),n=false;const r=[],o={all:new Set,stable:new Set,plantAdded:new Set,plantRemoved:new Set,plantMatured:new Set,cropMutated:new Set,cropMatured:new Set,cropHarvested:new Set,eggPlaced:new Set,eggRemoved:new Set,eggMatured:new Set,decorPlaced:new Set,decorRemoved:new Set},a={},i=new Set,s=2;function l(){if(i.size<s)return;const c=oc(a,Bi);if(ut(e,c)||(t=e,e=c,!n))return;for(const C of o.all)C(e,t);if(ac(t)!==ac(e))for(const C of o.stable)C(e,t);const u=uv(t.plants.all,e.plants.all);for(const C of u.added)for(const v of o.plantAdded)v({plant:C});for(const C of u.removed)for(const v of o.plantRemoved)v({plant:C,tileIndex:C.tileIndex});const p=pv(t.plants.mature,e.plants.mature,e.plants.all);for(const C of p)for(const v of o.plantMatured)v({plant:C});const f=mv(t.plants.all,e.plants.all);for(const C of f)for(const v of o.cropMutated)v(C);const g=fv(t.crops.mature,e.crops.mature,e.crops.all);for(const C of g)for(const v of o.cropMatured)v({crop:C});const m=hv(t.plants.all,e.plants.all,t.crops.all);for(const C of m)for(const v of o.cropHarvested)v(C);const h=bv(t.eggs.all,e.eggs.all);for(const C of h.added)for(const v of o.eggPlaced)v({egg:C});for(const C of h.removed)for(const v of o.eggRemoved)v({egg:C});const b=gv(t.eggs.mature,e.eggs.mature,e.eggs.all);for(const C of b)for(const v of o.eggMatured)v({egg:C});const w=xv(t.decors.all,e.decors.all);for(const C of w.added)for(const v of o.decorPlaced)v({decor:C});for(const C of w.removed)for(const v of o.decorRemoved)v({decor:C});}async function d(){if(n)return;const c=await gx.onChangeNow(p=>{a.garden=p,i.add("garden"),l();});r.push(c);const u=await ge.subscribe("myUserSlotIdxAtom",p=>{a.mySlotIndex=p,i.add("mySlotIndex"),l();});r.push(u),n=true,i.size===s&&(e=oc(a,Bi));}return d(),{get(){return e},subscribe(c,u){return o.all.add(c),u?.immediate!==false&&n&&i.size===s&&c(e,e),()=>o.all.delete(c)},subscribeStable(c,u){return o.stable.add(c),u?.immediate!==false&&n&&i.size===s&&c(e,e),()=>o.stable.delete(c)},subscribePlantAdded(c,u){if(o.plantAdded.add(c),u?.immediate&&n&&i.size===s)for(const p of e.plants.all)c({plant:p});return ()=>o.plantAdded.delete(c)},subscribePlantRemoved(c,u){return o.plantRemoved.add(c),()=>o.plantRemoved.delete(c)},subscribePlantMatured(c,u){if(o.plantMatured.add(c),u?.immediate&&n&&i.size===s)for(const p of e.plants.mature)c({plant:p});return ()=>o.plantMatured.delete(c)},subscribeCropMutated(c,u){if(o.cropMutated.add(c),u?.immediate&&n&&i.size===s)for(const p of e.crops.mutated.all)c({crop:p,added:p.mutations,removed:[]});return ()=>o.cropMutated.delete(c)},subscribeCropMatured(c,u){if(o.cropMatured.add(c),u?.immediate&&n&&i.size===s)for(const p of e.crops.mature)c({crop:p});return ()=>o.cropMatured.delete(c)},subscribeCropHarvested(c,u){return o.cropHarvested.add(c),()=>o.cropHarvested.delete(c)},subscribeEggPlaced(c,u){if(o.eggPlaced.add(c),u?.immediate&&n&&i.size===s)for(const p of e.eggs.all)c({egg:p});return ()=>o.eggPlaced.delete(c)},subscribeEggRemoved(c,u){return o.eggRemoved.add(c),()=>o.eggRemoved.delete(c)},subscribeEggMatured(c,u){if(o.eggMatured.add(c),u?.immediate&&n&&i.size===s)for(const p of e.eggs.mature)c({egg:p});return ()=>o.eggMatured.delete(c)},subscribeDecorPlaced(c,u){if(o.decorPlaced.add(c),u?.immediate&&n&&i.size===s)for(const p of e.decors.all)c({decor:p});return ()=>o.decorPlaced.delete(c)},subscribeDecorRemoved(c,u){return o.decorRemoved.add(c),()=>o.decorRemoved.delete(c)},destroy(){for(const c of r)c();r.length=0,o.all.clear(),o.stable.clear(),o.plantAdded.clear(),o.plantRemoved.clear(),o.plantMatured.clear(),o.cropMutated.clear(),o.cropMatured.clear(),o.cropHarvested.clear(),o.eggPlaced.clear(),o.eggRemoved.clear(),o.eggMatured.clear(),o.decorPlaced.clear(),o.decorRemoved.clear(),n=false;}}}let Ja=null;function tp(){return Ja||(Ja=yv()),Ja}const ic={inventory:"myPetInventoryAtom",hutch:"myPetHutchPetItemsAtom",active:"myPetInfosAtom",slotInfos:"myPetSlotInfosAtom",expandedPetSlotId:"expandedPetSlotIdAtom",myNumPetHutchItems:"myNumPetHutchItemsAtom",activityLogs:"myDataAtom"};function sc(e,t){const n=Ca(e.xp),r=ka(e.petSpecies,e.targetScale),o=_a(e.petSpecies,e.xp,r),a=Ta(e.petSpecies,n);return {id:e.id,petSpecies:e.petSpecies,name:e.name,xp:e.xp,hunger:e.hunger,mutations:[...e.mutations],targetScale:e.targetScale,abilities:[...e.abilities],location:t,position:null,lastAbilityTrigger:null,growthStage:n,currentStrength:o,maxStrength:r,isMature:a}}function vv(e,t){const r=t[e.slot.id]?.lastAbilityTrigger??null,o=Ca(e.slot.xp),a=ka(e.slot.petSpecies,e.slot.targetScale),i=_a(e.slot.petSpecies,e.slot.xp,a),s=Ta(e.slot.petSpecies,o);return {id:e.slot.id,petSpecies:e.slot.petSpecies,name:e.slot.name,xp:e.slot.xp,hunger:e.slot.hunger,mutations:[...e.slot.mutations],targetScale:e.slot.targetScale,abilities:[...e.slot.abilities],location:"active",position:e.position?{x:e.position.x,y:e.position.y}:null,lastAbilityTrigger:r,growthStage:o,currentStrength:i,maxStrength:a,isMature:s}}const lc=500;let gt=[],zo=0;function wv(){try{const e=ve(da.GLOBAL.MY_PETS_ABILITY_LOGS,[]);if(!Array.isArray(e))return [];const t=e.filter(n=>typeof n=="object"&&n!==null&&typeof n.petId=="string"&&typeof n.petName=="string"&&typeof n.petSpecies=="string"&&typeof n.abilityId=="string"&&typeof n.performedAt=="number");return t.length<e.length&&console.log(`[myPets] Migrated ability logs: removed ${e.length-t.length} old entries`),t.length>0&&(zo=Math.max(...t.map(n=>n.performedAt))),t}catch(e){return console.error("[myPets] Failed to load ability logs from storage:",e),[]}}function Sv(e){try{Pe(da.GLOBAL.MY_PETS_ABILITY_LOGS,e);}catch(t){console.error("[myPets] Failed to save ability logs to storage:",t);}}function Cv(e){try{const n=e.parameters.pet;return !n||!n.id||!n.petSpecies?null:{petId:n.id,petName:n.name||n.petSpecies,petSpecies:n.petSpecies,abilityId:e.action,data:e.parameters,performedAt:e.timestamp}}catch(t){return console.error("[myPets] Failed to convert activity log:",t),null}}function kv(e){if(!e||!Array.isArray(e))return;const t=iu(e),n=[];for(const r of t)if(r.timestamp>zo){const o=Cv(r);o&&n.push(o);}n.length!==0&&(zo=Math.max(...n.map(r=>r.performedAt),zo),gt=[...n,...gt],gt.length>lc&&(gt=gt.slice(0,lc)),Sv(gt),console.log(`[myPets] Processed ${n.length} new ability logs (total: ${gt.length})`));}function cc(e){const t=new Set,n=[];for(const f of e.active??[]){const g=vv(f,e.slotInfos??{});n.push(g),t.add(g.id);}const r=[];for(const f of e.inventory??[]){if(t.has(f.id))continue;const g=sc(f,"inventory");r.push(g),t.add(g.id);}const o=[];for(const f of e.hutch??[]){if(t.has(f.id))continue;const g=sc(f,"hutch");o.push(g),t.add(g.id);}const a=[...n,...r,...o],i=e.expandedPetSlotId??null,s=i?a.find(f=>f.id===i)??null:null,c=tp().get().decors.all.some(f=>f.decorId==="PetHutch"),u=e.myNumPetHutchItems??0;return {all:a,byLocation:{inventory:r,hutch:o,active:n},counts:{inventory:r.length,hutch:o.length,active:n.length,total:a.length},hutch:{hasHutch:c,currentItems:u,maxItems:25},expandedPetSlotId:i,expandedPet:s,abilityLogs:[...gt]}}const dc={all:[],byLocation:{inventory:[],hutch:[],active:[]},counts:{inventory:0,hutch:0,active:0,total:0},hutch:{hasHutch:false,currentItems:0,maxItems:25},expandedPetSlotId:null,expandedPet:null,abilityLogs:[]};function _v(e,t){if(e.length!==t.length)return  false;for(let n=0;n<e.length;n++)if(e[n]!==t[n])return  false;return  true}function uc(e){return JSON.stringify({id:e.id,petSpecies:e.petSpecies,name:e.name,mutations:e.mutations,abilities:e.abilities,location:e.location})}function Tv(e,t){if(e.all.length!==t.all.length)return  false;const n=e.all.map(uc),r=t.all.map(uc);return _v(n,r)}function Pv(e,t){const n=[],r=new Map(e.all.map(o=>[o.id,o]));for(const o of t.all){const a=r.get(o.id);a&&a.location!==o.location&&n.push({pet:o,from:a.location,to:o.location});}return n}function Iv(e,t){const n=[],r=new Map(e.all.map(o=>[o.id,o]));for(const o of t.all){if(!o.lastAbilityTrigger)continue;const i=r.get(o.id)?.lastAbilityTrigger;(!i||i.abilityId!==o.lastAbilityTrigger.abilityId||i.performedAt!==o.lastAbilityTrigger.performedAt)&&n.push({pet:o,trigger:o.lastAbilityTrigger});}return n}function Av(e,t){const n=new Set(e.all.map(i=>i.id)),r=new Set(t.all.map(i=>i.id)),o=t.all.filter(i=>!n.has(i.id)),a=e.all.filter(i=>!r.has(i.id));return o.length===0&&a.length===0?null:{added:o,removed:a,counts:t.counts}}function Ev(e,t){const n=[],r=new Map(e.all.map(o=>[o.id,o]));for(const o of t.all){const a=r.get(o.id);a&&o.growthStage>a.growthStage&&n.push({pet:o,previousStage:a.growthStage,newStage:o.growthStage});}return n}function Mv(e,t){const n=[],r=new Map(e.all.map(o=>[o.id,o]));for(const o of t.all){const a=r.get(o.id);a&&o.currentStrength>a.currentStrength&&n.push({pet:o,previousStrength:a.currentStrength,newStrength:o.currentStrength});}return n}function Rv(e,t){const n=[],r=new Map(e.all.map(o=>[o.id,o]));for(const o of t.all){const a=r.get(o.id);a&&o.currentStrength===o.maxStrength&&a.currentStrength<a.maxStrength&&n.push({pet:o});}return n}function Lv(){let e=dc,t=dc,n=false;const r=[],o={all:new Set,stable:new Set,location:new Set,ability:new Set,count:new Set,expandedPet:new Set,growth:new Set,strengthGain:new Set,maxStrength:new Set},a={},i=Object.keys(ic),s=new Set;function l(){if(s.size<i.length)return;if(a.activityLogs){const b=a.activityLogs?.activityLogs||a.activityLogs;Array.isArray(b)&&kv(b);}const c=cc(a);if(ut(e,c)||(t=e,e=c,!n))return;for(const b of o.all)b(e,t);if(!Tv(t,e))for(const b of o.stable)b(e,t);const u=Pv(t,e);for(const b of u)for(const w of o.location)w(b);const p=Iv(t,e);for(const b of p)for(const w of o.ability)w(b);const f=Av(t,e);if(f)for(const b of o.count)b(f);const g=Ev(t,e);for(const b of g)for(const w of o.growth)w(b);const m=Mv(t,e);for(const b of m)for(const w of o.strengthGain)w(b);const h=Rv(t,e);for(const b of h)for(const w of o.maxStrength)w(b);if(t.expandedPetSlotId!==e.expandedPetSlotId){const b={current:e.expandedPet,previous:t.expandedPet,currentId:e.expandedPetSlotId,previousId:t.expandedPetSlotId};for(const w of o.expandedPet)w(b);}}async function d(){if(n)return;gt=wv(),console.log(`[myPets] Loaded ${gt.length} ability logs from storage`);const c=i.map(async u=>{const p=ic[u],f=await ge.subscribe(p,g=>{a[u]=g,s.add(u),l();});r.push(f);});await Promise.all(c),n=true,s.size===i.length&&(e=cc(a));}return d(),{get(){return e},subscribe(c,u){return o.all.add(c),u?.immediate!==false&&n&&s.size===i.length&&c(e,e),()=>o.all.delete(c)},subscribeStable(c,u){return o.stable.add(c),u?.immediate!==false&&n&&s.size===i.length&&c(e,e),()=>o.stable.delete(c)},subscribeLocation(c,u){if(o.location.add(c),u?.immediate&&n&&s.size===i.length)for(const p of e.all)c({pet:p,from:p.location,to:p.location});return ()=>o.location.delete(c)},subscribeAbility(c,u){if(o.ability.add(c),u?.immediate&&n&&s.size===i.length)for(const p of e.all)p.lastAbilityTrigger&&c({pet:p,trigger:p.lastAbilityTrigger});return ()=>o.ability.delete(c)},subscribeCount(c,u){return o.count.add(c),u?.immediate&&n&&s.size===i.length&&c({added:e.all,removed:[],counts:e.counts}),()=>o.count.delete(c)},subscribeExpandedPet(c,u){return o.expandedPet.add(c),u?.immediate&&n&&s.size===i.length&&c({current:e.expandedPet,previous:e.expandedPet,currentId:e.expandedPetSlotId,previousId:e.expandedPetSlotId}),()=>o.expandedPet.delete(c)},subscribeGrowth(c,u){if(o.growth.add(c),u?.immediate&&n&&s.size===i.length)for(const p of e.all)c({pet:p,previousStage:p.growthStage,newStage:p.growthStage});return ()=>o.growth.delete(c)},subscribeStrengthGain(c,u){if(o.strengthGain.add(c),u?.immediate&&n&&s.size===i.length)for(const p of e.all)c({pet:p,previousStrength:p.currentStrength,newStrength:p.currentStrength});return ()=>o.strengthGain.delete(c)},subscribeMaxStrength(c,u){if(o.maxStrength.add(c),u?.immediate&&n&&s.size===i.length)for(const p of e.all)p.currentStrength===p.maxStrength&&c({pet:p});return ()=>o.maxStrength.delete(c)},destroy(){for(const c of r)c();r.length=0,o.all.clear(),o.stable.clear(),o.location.clear(),o.ability.clear(),o.count.clear(),o.expandedPet.clear(),o.growth.clear(),o.strengthGain.clear(),o.maxStrength.clear(),n=false;}}}let Qa=null;function Fn(){return Qa||(Qa=Lv()),Qa}const pc={inventory:"myInventoryAtom",isFull:"isMyInventoryAtMaxLengthAtom",selectedItemIndex:"myValidatedSelectedItemIndexAtom"},fc={items:[],favoritedItemIds:[],count:0,isFull:false,selectedItem:null};function gc(e){const t=e.inventory,n=t?.items??[],r=t?.favoritedItemIds??[],o=e.selectedItemIndex;let a=null;return o!==null&&o>=0&&o<n.length&&(a={index:o,item:n[o]}),{items:n,favoritedItemIds:r,count:n.length,isFull:e.isFull??false,selectedItem:a}}function mc(e){const t=e.items.map(n=>"id"in n?n.id:"species"in n&&n.itemType==="Seed"?`seed:${n.species}:${n.quantity}`:"toolId"in n?`tool:${n.toolId}:${n.quantity}`:"eggId"in n?`egg:${n.eggId}:${n.quantity}`:"decorId"in n?`decor:${n.decorId}:${n.quantity}`:JSON.stringify(n));return JSON.stringify({itemKeys:t,favoritedItemIds:e.favoritedItemIds,isFull:e.isFull,selectedItemIndex:e.selectedItem?.index??null})}function Fv(e,t){return mc(e)===mc(t)}function Nv(e,t){return e===null&&t===null?false:e===null||t===null?true:e.index!==t.index}function ho(e){return "id"in e?e.id:"species"in e&&e.itemType==="Seed"?`seed:${e.species}`:"toolId"in e?`tool:${e.toolId}`:"eggId"in e?`egg:${e.eggId}`:"decorId"in e?`decor:${e.decorId}`:JSON.stringify(e)}function Ov(e,t){const n=new Set(e.map(ho)),r=new Set(t.map(ho)),o=t.filter(i=>!n.has(ho(i))),a=e.filter(i=>!r.has(ho(i)));return o.length===0&&a.length===0?null:{added:o,removed:a,counts:{before:e.length,after:t.length}}}function $v(e,t){const n=new Set(e),r=new Set(t),o=t.filter(i=>!n.has(i)),a=e.filter(i=>!r.has(i));return o.length===0&&a.length===0?null:{added:o,removed:a,current:t}}function Bv(){let e=fc,t=fc,n=false;const r=[],o={all:new Set,stable:new Set,selection:new Set,items:new Set,favorites:new Set},a={},i=Object.keys(pc),s=new Set;function l(){if(s.size<i.length)return;const c=gc(a);if(ut(e,c)||(t=e,e=c,!n))return;for(const f of o.all)f(e,t);if(!Fv(t,e))for(const f of o.stable)f(e,t);if(Nv(t.selectedItem,e.selectedItem)){const f={current:e.selectedItem,previous:t.selectedItem};for(const g of o.selection)g(f);}const u=Ov(t.items,e.items);if(u)for(const f of o.items)f(u);const p=$v(t.favoritedItemIds,e.favoritedItemIds);if(p)for(const f of o.favorites)f(p);}async function d(){if(n)return;const c=i.map(async u=>{const p=pc[u],f=await ge.subscribe(p,g=>{a[u]=g,s.add(u),l();});r.push(f);});await Promise.all(c),n=true,s.size===i.length&&(e=gc(a));}return d(),{get(){return e},subscribe(c,u){return o.all.add(c),u?.immediate!==false&&n&&s.size===i.length&&c(e,e),()=>o.all.delete(c)},subscribeStable(c,u){return o.stable.add(c),u?.immediate!==false&&n&&s.size===i.length&&c(e,e),()=>o.stable.delete(c)},subscribeSelection(c,u){return o.selection.add(c),u?.immediate&&n&&s.size===i.length&&c({current:e.selectedItem,previous:e.selectedItem}),()=>o.selection.delete(c)},subscribeItems(c,u){return o.items.add(c),u?.immediate&&n&&s.size===i.length&&c({added:e.items,removed:[],counts:{before:0,after:e.count}}),()=>o.items.delete(c)},subscribeFavorites(c,u){return o.favorites.add(c),u?.immediate&&n&&s.size===i.length&&c({added:e.favoritedItemIds,removed:[],current:e.favoritedItemIds}),()=>o.favorites.delete(c)},destroy(){for(const c of r)c();r.length=0,o.all.clear(),o.stable.clear(),o.selection.clear(),o.items.clear(),o.favorites.clear(),n=false;}}}let Za=null;function sn(){return Za||(Za=Bv()),Za}const Gi={all:[],host:null,myPlayer:null,count:0};function Dv(e,t,n){const r=n.get(e.id),o=r?.slot,a=o?.data,i=o?.lastActionEvent;return {id:e.id,name:e.name,discordId:e.databaseUserId,discordAvatarUrl:e.discordAvatarUrl,guildId:e.guildId,isConnected:e.isConnected,isHost:e.id===t,slotIndex:r?.index??null,position:o?.position??null,cosmetic:{color:e.cosmetic?.color??"",avatar:e.cosmetic?.avatar?[...e.cosmetic.avatar]:[]},emote:{type:e.emoteData?.emoteType??-1},coins:a?.coinsCount??0,inventory:a?.inventory??null,shopPurchases:a?.shopPurchases??null,garden:a?.garden??null,pets:{slots:a?.petSlots??[],slotInfos:o?.petSlotInfos??null},journal:a?.journal??null,stats:a?.stats??null,tasksCompleted:a?.tasksCompleted??[],activityLogs:a?.activityLogs??[],customRestocks:{config:a?.customRestocks??null,inventories:o?.customRestockInventories??null},lastAction:i?{type:i.action,data:i.data,timestamp:i.timestamp}:null,selectedItemIndex:o?.notAuthoritative_selectedItemIndex??null,lastSlotMachineInfo:o?.lastSlotMachineInfo??null}}function hc(e){const t=e.players,n=e.hostPlayerId??"",r=e.userSlots??[],o=e.myUserSlotIndex;if(!t||!Array.isArray(t)||t.length===0)return Gi;const a=new Map;Array.isArray(r)&&r.forEach((d,c)=>{d?.type==="user"&&d?.playerId&&a.set(d.playerId,{slot:d,index:c});});const i=t.map(d=>Dv(d,n,a)),s=i.find(d=>d.isHost)??null,l=o!==null?i.find(d=>d.slotIndex===o)??null:null;return {all:i,host:s,myPlayer:l,count:i.length}}function bc(e){const t=e.all.map(n=>`${n.id}:${n.isConnected}:${n.isHost}`);return JSON.stringify({playerKeys:t,hostId:e.host?.id??null,count:e.count})}function Gv(e,t){const n=[],r=new Set(e.map(a=>a.id)),o=new Set(t.map(a=>a.id));for(const a of t)r.has(a.id)||n.push({player:a,type:"join"});for(const a of e)o.has(a.id)||n.push({player:a,type:"leave"});return n}function zv(e,t){const n=[],r=new Map(e.map(o=>[o.id,o]));for(const o of t){const a=r.get(o.id);a&&a.isConnected!==o.isConnected&&n.push({player:o,isConnected:o.isConnected});}return n}function Hv(){let e=Gi,t=Gi,n=false;const r=[],o={all:new Set,stable:new Set,joinLeave:new Set,connection:new Set,host:new Set},a={},i=new Set,s=4;function l(){if(i.size<s)return;const c=hc(a);if(ut(e,c)||(t=e,e=c,!n))return;for(const m of o.all)m(e,t);if(bc(t)!==bc(e))for(const m of o.stable)m(e,t);const u=Gv(t.all,e.all);for(const m of u)for(const h of o.joinLeave)h(m);const p=zv(t.all,e.all);for(const m of p)for(const h of o.connection)h(m);const f=t.host?.id??null,g=e.host?.id??null;if(f!==g){const m={current:e.host,previous:t.host};for(const h of o.host)h(m);}}async function d(){if(n)return;const c=await px.onChangeNow(g=>{a.players=g,i.add("players"),l();});r.push(c);const u=await fx.onChangeNow(g=>{a.hostPlayerId=g,i.add("hostPlayerId"),l();});r.push(u);const p=await ux.onChangeNow(g=>{a.userSlots=g,i.add("userSlots"),l();});r.push(p);const f=await ge.subscribe("myUserSlotIdxAtom",g=>{a.myUserSlotIndex=g,i.add("myUserSlotIndex"),l();});r.push(f),n=true,i.size===s&&(e=hc(a));}return d(),{get(){return e},subscribe(c,u){return o.all.add(c),u?.immediate!==false&&n&&i.size===s&&c(e,e),()=>o.all.delete(c)},subscribeStable(c,u){return o.stable.add(c),u?.immediate!==false&&n&&i.size===s&&c(e,e),()=>o.stable.delete(c)},subscribeJoinLeave(c,u){if(o.joinLeave.add(c),u?.immediate&&n&&i.size===s)for(const p of e.all)c({player:p,type:"join"});return ()=>o.joinLeave.delete(c)},subscribeConnection(c,u){if(o.connection.add(c),u?.immediate&&n&&i.size===s)for(const p of e.all)c({player:p,isConnected:p.isConnected});return ()=>o.connection.delete(c)},subscribeHost(c,u){return o.host.add(c),u?.immediate&&n&&i.size===s&&c({current:e.host,previous:e.host}),()=>o.host.delete(c)},destroy(){for(const c of r)c();r.length=0,o.all.clear(),o.stable.clear(),o.joinLeave.clear(),o.connection.clear(),o.host.clear(),n=false;}}}let ei=null;function np(){return ei||(ei=Hv()),ei}const Xr=["seed","tool","egg","decor"];function jv(e,t){switch(t){case "seed":return e.species??e.itemType;case "tool":return e.toolId??e.itemType;case "egg":return e.eggId??e.itemType;case "decor":return e.decorId??e.itemType;default:return e.itemType}}function Uv(e,t,n){const r=jv(e,t),o=n[r]??0,a=Math.max(0,e.initialStock-o);return {id:r,itemType:e.itemType,initialStock:e.initialStock,purchased:o,remaining:a,isAvailable:a>0}}function Wv(e,t,n){if(!t)return {type:e,items:[],availableCount:0,totalCount:0,secondsUntilRestock:0,restockAt:null};const o=n[e]?.purchases??{},a=(t.inventory??[]).map(d=>Uv(d,e,o)),i=a.filter(d=>d.isAvailable).length,s=t.secondsUntilRestock??0,l=s>0?Date.now()+s*1e3:null;return {type:e,items:a,availableCount:i,totalCount:a.length,secondsUntilRestock:s,restockAt:l}}function xc(e){const t=e.shops,n=e.purchases??{},r=Xr.map(s=>Wv(s,t?.[s],n)),o={seed:r[0],tool:r[1],egg:r[2],decor:r[3]},a=r.filter(s=>s.restockAt!==null);let i=null;if(a.length>0){const l=a.sort((d,c)=>(d.restockAt??0)-(c.restockAt??0))[0];i={shop:l.type,seconds:l.secondsUntilRestock,at:l.restockAt};}return {all:r,byType:o,nextRestock:i}}const yc={all:Xr.map(e=>({type:e,items:[],availableCount:0,totalCount:0,secondsUntilRestock:0,restockAt:null})),byType:{seed:{type:"seed",items:[],availableCount:0,totalCount:0,secondsUntilRestock:0,restockAt:null},tool:{type:"tool",items:[],availableCount:0,totalCount:0,secondsUntilRestock:0,restockAt:null},egg:{type:"egg",items:[],availableCount:0,totalCount:0,secondsUntilRestock:0,restockAt:null},decor:{type:"decor",items:[],availableCount:0,totalCount:0,secondsUntilRestock:0,restockAt:null}},nextRestock:null};function vc(e){return JSON.stringify({shops:e.all.map(t=>({type:t.type,itemCount:t.items.length,availableCount:t.availableCount}))})}function Vv(e,t){const n=e.secondsUntilRestock,r=t.secondsUntilRestock;return n>0&&n<=5&&r>n||n>0&&r===0&&t.items.some(a=>a.purchased===0)?{shop:t,previousItems:e.items}:null}function Xv(e,t){const n=[];for(const r of Xr){const o=e.byType[r],a=t.byType[r],i=new Map(o.items.map(s=>[s.id,s]));for(const s of a.items){const l=i.get(s.id);l&&s.purchased>l.purchased&&n.push({shopType:r,itemId:s.id,quantity:s.purchased-l.purchased,newPurchased:s.purchased,remaining:s.remaining});}}return n}function qv(e,t){const n=[];for(const r of Xr){const o=e.byType[r],a=t.byType[r],i=new Map(o.items.map(s=>[s.id,s]));for(const s of a.items){const l=i.get(s.id);l&&l.isAvailable!==s.isAvailable&&n.push({shopType:r,itemId:s.id,wasAvailable:l.isAvailable,isAvailable:s.isAvailable});}}return n}function Kv(){let e=yc,t=yc,n=false;const r=[],o={all:new Set,stable:new Set,seedRestock:new Set,toolRestock:new Set,eggRestock:new Set,decorRestock:new Set,purchase:new Set,availability:new Set},a={},i=new Set,s=2;function l(){if(i.size<s)return;const c=xc(a);if(ut(e,c)||(t=e,e=c,!n))return;for(const g of o.all)g(e,t);if(vc(t)!==vc(e))for(const g of o.stable)g(e,t);const u={seed:o.seedRestock,tool:o.toolRestock,egg:o.eggRestock,decor:o.decorRestock};for(const g of Xr){const m=Vv(t.byType[g],e.byType[g]);if(m)for(const h of u[g])h(m);}const p=Xv(t,e);for(const g of p)for(const m of o.purchase)m(g);const f=qv(t,e);for(const g of f)for(const m of o.availability)m(g);}async function d(){if(n)return;const c=await mx.onChangeNow(p=>{a.shops=p,i.add("shops"),l();});r.push(c);const u=await hx.onChangeNow(p=>{a.purchases=p,i.add("purchases"),l();});r.push(u),n=true,i.size===s&&(e=xc(a));}return d(),{get(){return e},getShop(c){return e.byType[c]},getItem(c,u){return e.byType[c].items.find(f=>f.id===u)??null},subscribe(c,u){return o.all.add(c),u?.immediate!==false&&n&&i.size===s&&c(e,e),()=>o.all.delete(c)},subscribeStable(c,u){return o.stable.add(c),u?.immediate!==false&&n&&i.size===s&&c(e,e),()=>o.stable.delete(c)},subscribeSeedRestock(c,u){return o.seedRestock.add(c),u?.immediate&&n&&i.size===s&&c({shop:e.byType.seed,previousItems:[]}),()=>o.seedRestock.delete(c)},subscribeToolRestock(c,u){return o.toolRestock.add(c),u?.immediate&&n&&i.size===s&&c({shop:e.byType.tool,previousItems:[]}),()=>o.toolRestock.delete(c)},subscribeEggRestock(c,u){return o.eggRestock.add(c),u?.immediate&&n&&i.size===s&&c({shop:e.byType.egg,previousItems:[]}),()=>o.eggRestock.delete(c)},subscribeDecorRestock(c,u){return o.decorRestock.add(c),u?.immediate&&n&&i.size===s&&c({shop:e.byType.decor,previousItems:[]}),()=>o.decorRestock.delete(c)},subscribePurchase(c,u){if(o.purchase.add(c),u?.immediate&&n&&i.size===s)for(const p of e.all)for(const f of p.items)f.purchased>0&&c({shopType:p.type,itemId:f.id,quantity:f.purchased,newPurchased:f.purchased,remaining:f.remaining});return ()=>o.purchase.delete(c)},subscribeAvailability(c,u){if(o.availability.add(c),u?.immediate&&n&&i.size===s)for(const p of e.all)for(const f of p.items)c({shopType:p.type,itemId:f.id,wasAvailable:f.isAvailable,isAvailable:f.isAvailable});return ()=>o.availability.delete(c)},destroy(){for(const c of r)c();r.length=0,o.all.clear(),o.stable.clear(),o.seedRestock.clear(),o.toolRestock.clear(),o.eggRestock.clear(),o.decorRestock.clear(),o.purchase.clear(),o.availability.clear(),n=false;}}}let ti=null;function Ks(){return ti||(ti=Kv()),ti}const Yv=["Sunny","Rain","Frost","Dawn","AmberMoon"];function Jv(e){return Yv.includes(e)}const zi={type:"Sunny",isActive:false,startTime:null,endTime:null,remainingSeconds:0};function Qv(e){if(!e)return zi;const t=Date.now(),n=e.endTime??0,r=Math.max(0,n-t),o=Math.floor(r/1e3),a=o>0,i=e.type??"Sunny";return {type:Jv(i)?i:"Sunny",isActive:a,startTime:e.startTime??null,endTime:e.endTime??null,remainingSeconds:o}}function Zv(){let e=zi,t=zi,n=false,r=null;const o={all:new Set,change:new Set};function a(s){const l=Qv(s);if(e.type===l.type&&e.isActive===l.isActive&&e.startTime===l.startTime&&e.endTime===l.endTime){e=l;return}if(t=e,e=l,!!n){for(const d of o.all)d(e,t);if(t.type!==e.type||t.isActive!==e.isActive){const d={current:e,previous:t};for(const c of o.change)c(d);}}}async function i(){n||(r=await bx.onChangeNow(s=>{a(s);}),n=true);}return i(),{get(){return e},subscribe(s,l){return o.all.add(s),l?.immediate!==false&&n&&s(e,e),()=>o.all.delete(s)},subscribeChange(s,l){return o.change.add(s),l?.immediate&&n&&s({current:e,previous:e}),()=>o.change.delete(s)},destroy(){r?.(),r=null,o.all.clear(),o.change.clear(),n=false;}}}let ni=null;function ew(){return ni||(ni=Zv()),ni}let Fe=null;function rp(){return Fe||(Fe={currentTile:Xe(),myPets:Fn(),gameMap:Bi(),myInventory:sn(),players:np(),shops:Ks(),weather:ew(),myGarden:tp()},Fe)}function vt(){if(!Fe)throw new Error("[Globals] Not initialized. Call initGlobals() first.");return Fe}function tw(){Fe&&(Fe.currentTile.destroy(),Fe.myPets.destroy(),Fe.gameMap.destroy(),Fe.myInventory.destroy(),Fe.players.destroy(),Fe.shops.destroy(),Fe.weather.destroy(),Fe.myGarden.destroy(),Fe=null);}const de={get currentTile(){return vt().currentTile},get myPets(){return vt().myPets},get gameMap(){return vt().gameMap},get myInventory(){return vt().myInventory},get players(){return vt().players},get shops(){return vt().shops},get weather(){return vt().weather},get myGarden(){return vt().myGarden}},nw=100,ri=[];function Hi(e,t,n){let r="";if(n&&typeof n=="object"){if(t==="PartialState"){const o=n.op||"",a=n.path||"";let i="";if("value"in n){const s=n.value;i=typeof s=="object"?`{${Object.keys(s||{}).slice(0,2).join(",")}}`:String(s);}if(o||a)r=`PartialState : ${o} ${a} ${i}`.trim();else {const s=Object.keys(n).filter(l=>l!=="type");s.length>0&&(r=`PartialState - {${s.join(", ")}}`);}}if(!r&&n.event&&(r+=`${n.event} `),!r&&n.op&&(r+=`op:${n.op} `),!r&&n.data){const o=Object.keys(n.data);o.length>0&&(r+=`{${o.slice(0,3).join(",")}${o.length>3?"...":""}}`);}else !r&&Array.isArray(n)&&(r+=`[${n.length} items]`);}else typeof n=="string"&&(r=n.slice(0,50));ri.push({direction:e,type:String(t),timestamp:Date.now(),payload:n,summary:r.trim()||"-"}),ri.length>nw&&ri.shift();}const He={nativeCtor:null,captured:[],latestOpen:null},wc=Symbol.for("ariesmod.ws.capture.wrapped"),Sc=Symbol.for("ariesmod.ws.capture.native"),op=1;function ji(e){return !!e&&e.readyState===op}function rw(){if(ji(He.latestOpen))return He.latestOpen;for(let e=He.captured.length-1;e>=0;e--){const t=He.captured[e];if(ji(t))return t}return null}function ow(e,t){He.captured.push(e),He.captured.length>25&&He.captured.splice(0,He.captured.length-25);const n=()=>{He.latestOpen=e,t&&console.log("[WS] captured socket opened",e.url);};e.addEventListener("open",n),e.addEventListener("close",()=>{He.latestOpen===e&&(He.latestOpen=null),t&&console.log("[WS] captured socket closed",e.url);}),e.addEventListener("message",r=>{try{const o=JSON.parse(r.data);Hi("in",o.type||"unknown",o);}catch{Hi("in","raw",r.data);}}),e.readyState===op&&n();}function aw(e=F,t={}){const n=!!t.debug,r=e?.WebSocket;if(typeof r!="function")return ()=>{};if(r[wc])return He.nativeCtor=r[Sc]??He.nativeCtor??null,()=>{};const o=r;He.nativeCtor=o;function a(i,s){const l=s!==void 0?new o(i,s):new o(i);try{ow(l,n);}catch{}return l}try{a.prototype=o.prototype;}catch{}try{Object.setPrototypeOf(a,o);}catch{}try{a.CONNECTING=o.CONNECTING,a.OPEN=o.OPEN,a.CLOSING=o.CLOSING,a.CLOSED=o.CLOSED;}catch{}a[wc]=true,a[Sc]=o;try{e.WebSocket=a,n&&console.log("[WS] WebSocket capture installed");}catch{return ()=>{}}return ()=>{try{e.WebSocket===a&&(e.WebSocket=o);}catch{}}}function iw(e=F){const t=e?.MagicCircle_RoomConnection?.currentWebSocket;return t&&typeof t=="object"?t:null}function oa(e=F){const t=rw();if(t)return {ws:t,source:"captured"};const n=iw(e);return n?{ws:n,source:"roomConnection"}:{ws:null,source:null}}function ap(e,t={}){const n=t.pageWindow??F,r=t.intervalMs??500,o=!!t.debug;let a=null,i=null;const s=()=>{const d=oa(n);(d.ws!==a||d.source!==i)&&(a=d.ws,i=d.source,o&&console.log("[WS] best socket changed:",d.source,d.ws),e(d));};s();const l=setInterval(s,r);return ()=>clearInterval(l)}function sw(e){if(typeof e=="string")return e;try{return JSON.stringify(e)}catch{return null}}function lw(e,t=F){const n=t?.MagicCircle_RoomConnection;if(n&&typeof n.sendMessage=="function")try{return Array.isArray(e)?n.sendMessage(...e):n.sendMessage(e),{ok:!0}}catch(a){return {ok:false,reason:"error",error:a}}const{ws:r}=oa(t);if(!r)return {ok:false,reason:"no-ws"};if(!ji(r))return {ok:false,reason:"not-open"};const o=sw(e);if(o==null)return {ok:false,reason:"error",error:new Error("Cannot stringify message")};try{const a=JSON.parse(o);Hi("out",a.type||"unknown",a);}catch{}try{return r.send(o),{ok:!0}}catch(a){return {ok:false,reason:"error",error:a}}}function cw(e,t={},n=F){return lw({type:e,...t},n)}const _t={Welcome:"Welcome",PartialState:"PartialState",ServerErrorMessage:"ServerErrorMessage",Config:"Config",InappropriateContentRejected:"InappropriateContentRejected",Emote:"Emote",CurrencyTransaction:"CurrencyTransaction",Pong:"Pong"},M={Chat:"Chat",Emote:"Emote",Wish:"Wish",KickPlayer:"KickPlayer",SetPlayerData:"SetPlayerData",UsurpHost:"UsurpHost",Dev:"Dev",SetSelectedGame:"SetSelectedGame",VoteForGame:"VoteForGame",RequestGame:"RequestGame",RestartGame:"RestartGame",Ping:"Ping",PlayerPosition:"PlayerPosition",Teleport:"Teleport",CheckWeatherStatus:"CheckWeatherStatus",MoveInventoryItem:"MoveInventoryItem",DropObject:"DropObject",PickupObject:"PickupObject",ToggleFavoriteItem:"ToggleFavoriteItem",PutItemInStorage:"PutItemInStorage",RetrieveItemFromStorage:"RetrieveItemFromStorage",MoveStorageItem:"MoveStorageItem",LogItems:"LogItems",PlantSeed:"PlantSeed",WaterPlant:"WaterPlant",HarvestCrop:"HarvestCrop",SellAllCrops:"SellAllCrops",PurchaseSeed:"PurchaseSeed",PurchaseEgg:"PurchaseEgg",PurchaseTool:"PurchaseTool",PurchaseDecor:"PurchaseDecor",PlantEgg:"PlantEgg",HatchEgg:"HatchEgg",PlantGardenPlant:"PlantGardenPlant",PotPlant:"PotPlant",MutationPotion:"MutationPotion",PickupDecor:"PickupDecor",PlaceDecor:"PlaceDecor",RemoveGardenObject:"RemoveGardenObject",PlacePet:"PlacePet",FeedPet:"FeedPet",PetPositions:"PetPositions",SwapPet:"SwapPet",StorePet:"StorePet",NamePet:"NamePet",SellPet:"SellPet",ReportSpeakingStart:"ReportSpeakingStart"};var pt=(e=>(e[e.ReconnectInitiated=4100]="ReconnectInitiated",e[e.PlayerLeftVoluntarily=4200]="PlayerLeftVoluntarily",e[e.UserSessionSuperseded=4250]="UserSessionSuperseded",e[e.ConnectionSuperseded=4300]="ConnectionSuperseded",e[e.ServerDisposed=4310]="ServerDisposed",e[e.HeartbeatExpired=4400]="HeartbeatExpired",e[e.PlayerKicked=4500]="PlayerKicked",e[e.VersionMismatch=4700]="VersionMismatch",e[e.VersionExpired=4710]="VersionExpired",e[e.AuthenticationFailure=4800]="AuthenticationFailure",e))(pt||{});new Set(Object.values(_t));new Set(Object.values(M));const dw=["Room","Quinoa"],uw={Room:["Room"],Quinoa:dw};function re(e,t={},n=F){const r=t,{scopePath:o,scope:a,...i}=r,s=typeof o=="string"?o:a,l=Array.isArray(o)?o:s==="Room"||s==="Quinoa"?uw[s]:null;return cw(e,l?{scopePath:l,...i}:i,n)}function pw(e,t=F){return re(M.Chat,{scope:"Room",message:e},t)}function fw(e,t=F){return re(M.Emote,{scope:"Room",emoteType:e},t)}function gw(e,t=F){return re(M.Wish,{scope:"Quinoa",wish:e},t)}function mw(e,t=F){return re(M.KickPlayer,{scope:"Room",playerId:e},t)}function hw(e,t=F){return re(M.SetPlayerData,{scope:"Room",data:e},t)}function bw(e=F){return re(M.UsurpHost,{scope:"Quinoa"},e)}function xw(e=F){return re(M.ReportSpeakingStart,{scope:"Quinoa"},e)}function yw(e,t=F){return re(M.SetSelectedGame,{scope:"Room",gameId:e},t)}function vw(e,t=F){return re(M.VoteForGame,{scope:"Room",gameId:e},t)}function ww(e,t=F){return re(M.RequestGame,{scope:"Room",gameId:e},t)}function Sw(e=F){return re(M.RestartGame,{scope:"Room"},e)}function Cw(e,t=F){return re(M.Ping,{scope:"Quinoa",id:e},t)}function ip(e,t,n=F){return re(M.PlayerPosition,{scope:"Quinoa",x:e,y:t},n)}const kw=ip;function _w(e,t,n=F){return re(M.Teleport,{scope:"Quinoa",x:e,y:t},n)}function Tw(e=F){return re(M.CheckWeatherStatus,{scope:"Quinoa"},e)}function Pw(e,t,n=F){return re(M.MoveInventoryItem,{scope:"Quinoa",fromIndex:e,toIndex:t},n)}function Iw(e,t=F){return re(M.DropObject,{scope:"Quinoa",slotIndex:e},t)}function Aw(e,t=F){return re(M.PickupObject,{scope:"Quinoa",objectId:e},t)}function Ia(e,t=F){return re(M.ToggleFavoriteItem,{scope:"Quinoa",itemId:e},t)}function Ys(e,t="PetHutch",n=F){return re(M.PutItemInStorage,{scope:"Quinoa",itemId:e,storageId:t},n)}function Js(e,t="PetHutch",n=F){return re(M.RetrieveItemFromStorage,{scope:"Quinoa",itemId:e,storageId:t},n)}function Ew(e,t,n=F){return re(M.MoveStorageItem,{scope:"Quinoa",fromIndex:e,toIndex:t},n)}function Mw(e=F){return re(M.LogItems,{scope:"Quinoa"},e)}function Rw(e,t,n,r=F){return re(M.PlantSeed,{scope:"Quinoa",seedId:e,x:t,y:n},r)}function Lw(e,t=F){return re(M.WaterPlant,{scope:"Quinoa",plantId:e},t)}function Fw(e,t=F){return re(M.HarvestCrop,{scope:"Quinoa",cropId:e},t)}function Nw(e=F){return re(M.SellAllCrops,{scope:"Quinoa"},e)}function Ow(e,t=F){return re(M.PurchaseDecor,{scope:"Quinoa",decorId:e},t)}function $w(e,t=F){return re(M.PurchaseEgg,{scope:"Quinoa",eggId:e},t)}function Bw(e,t=F){return re(M.PurchaseTool,{scope:"Quinoa",toolId:e},t)}function Dw(e,t=F){return re(M.PurchaseSeed,{scope:"Quinoa",seedId:e},t)}function Gw(e,t,n,r=F){return re(M.PlantEgg,{scope:"Quinoa",eggId:e,x:t,y:n},r)}function zw(e,t=F){return re(M.HatchEgg,{scope:"Quinoa",eggId:e},t)}function Hw(e,t,n,r=F){return re(M.PlantGardenPlant,{scope:"Quinoa",plantId:e,x:t,y:n},r)}function jw(e,t,n=F){return re(M.PotPlant,{scope:"Quinoa",plantId:e,potId:t},n)}function Uw(e,t,n=F){return re(M.MutationPotion,{scope:"Quinoa",potionId:e,targetId:t},n)}function Ww(e,t=F){return re(M.PickupDecor,{scope:"Quinoa",decorInstanceId:e},t)}function Vw(e,t,n,r=F){return re(M.PlaceDecor,{scope:"Quinoa",decorId:e,x:t,y:n},r)}function Xw(e,t=F){return re(M.RemoveGardenObject,{scope:"Quinoa",objectId:e},t)}function sp(e,t={x:0,y:0},n="Dirt",r=0,o=F){return re(M.PlacePet,{scope:"Quinoa",itemId:e,position:t,tileType:n,localTileIndex:r},o)}function qw(e,t,n=F){return re(M.FeedPet,{scope:"Quinoa",petId:e,foodItemId:t},n)}function Kw(e,t=F){return re(M.PetPositions,{scope:"Quinoa",positions:e},t)}function lp(e,t,n=F){return re(M.SwapPet,{scope:"Quinoa",petSlotId:e,petInventoryId:t},n)}function cp(e,t=F){return re(M.StorePet,{scope:"Quinoa",itemId:e},t)}function Yw(e,t,n=F){return re(M.NamePet,{scope:"Quinoa",petId:e,name:t},n)}function Jw(e,t=F){return re(M.SellPet,{scope:"Quinoa",petId:e},t)}let Ho=null;const hr=new Set;function Ui(){const e=en();if(!e.enabled){console.log("[AutoFavorite] Disabled");return}hr.clear(),Ho=sn().subscribeItems(t=>{if(t.added.length>0){const n=en();for(const r of t.added)Zw(r,n);}}),console.log(`✅ [AutoFavorite] Started - Watching ${e.simple.favoriteSpecies.length} species, ${e.simple.favoriteMutations.length} mutations`);}function dp(){Ho&&(Ho(),Ho=null),hr.clear(),console.log("🛑 [AutoFavorite] Stopped");}function Qw(e){const t=en();t.enabled=e,t.simple.enabled=e,Zu(t),e?Ui():dp();}function Zw(e,t){if(e.itemType!=="Produce"&&e.itemType!=="Pet")return;if(!e.id){console.warn("[AutoFavorite] Item has no ID:",e);return}if(!(hr.has(e.id)||e.isFavorited||e.favorited)&&up(e,t.simple)){hr.add(e.id);try{Ia(e.id),console.log(`[AutoFavorite] ⭐ Favorited ${e.itemType}: ${e.species||e.id}`);}catch(r){console.error("[AutoFavorite] WebSocket error:",r),hr.delete(e.id);}}}function up(e,t){if(!t.enabled)return  false;const n=e.itemType==="Pet"?e.petSpecies:e.species;return n?!!(t.favoriteSpecies.includes(n)||t.favoriteMutations.length>0&&(e.mutations||[]).some(o=>t.favoriteMutations.includes(o))):false}function eS(){return Object.keys(K.get("mutations")??{})}const Qs={init(){this.isReady()||Ui();},isReady(){return Ql()},DEFAULT_CONFIG:Qu,STORAGE_KEY:Vs,loadConfig:en,saveConfig:Xs,updateConfig:Zu,updateSimpleConfig:qs,setFavoriteSpecies:Ky,setFavoriteMutations:Yy,isEnabled:Ql,start:Ui,stop:dp,setEnabled:Qw,shouldFavorite:up,getGameMutations:eS},Zs=we.JOURNAL_CHECKER,pp={enabled:false,autoRefresh:true,refreshIntervalMs:3e4};function Nn(){return ve(Zs,pp)}function Aa(e){Pe(Zs,e);}function Cc(){return Nn().enabled}function tS(e){const t=Nn();t.autoRefresh=e,Aa(t);}function nS(e){const t=Nn();t.refreshIntervalMs=e,Aa(t);}let oi=null,kc=null;function fp(){try{return np().get().myPlayer?.journal||null}catch{return null}}function rS(e){return e?`pro:${Object.keys(e.produce).length}-pet:${Object.keys(e.pets).length}`:"null"}function gp(){const e=K.get("mutations")??{};return ["Normal",...Object.keys(e),"Max Weight"]}function mp(){const e=K.get("mutations")??{};return ["Normal",...Object.entries(e).filter(([n,r])=>!("tileRef"in r)).map(([n])=>n),"Max Weight"]}function oS(){return Object.keys(K.get("mutations")??{})}function hp(e){const n=(K.get("pets")??{})[e];if(!n)return [];const r=new Set;return Array.isArray(n.abilities)&&n.abilities.forEach(o=>r.add(o)),Array.isArray(n.possibleAbilities)&&n.possibleAbilities.forEach(o=>r.add(o)),n.abilityTiers&&Object.values(n.abilityTiers).forEach(o=>{Array.isArray(o)&&o.forEach(a=>r.add(a));}),[...r]}function bp(e){const t=K.get("plants")??{},n=Object.keys(t),r=gp(),o=e?.produce??{},a=[];let i=0;for(const d of n){const u=o[d]?.variantsLogged?.map(f=>f.variant)??[],p=r.filter(f=>!u.includes(f));i+=u.length,a.push({species:d,variantsLogged:u,variantsMissing:p,variantsTotal:r.length,variantsPercentage:r.length>0?u.length/r.length*100:0,isComplete:p.length===0});}const s=n.length*r.length,l=a.filter(d=>d.variantsLogged.length>0).length;return {total:n.length,logged:l,percentage:n.length>0?l/n.length*100:0,speciesDetails:a,variantsTotal:s,variantsLogged:i,variantsPercentage:s>0?i/s*100:0}}function xp(e){const t=K.get("pets")??{},n=Object.keys(t),r=mp(),o=e?.pets??{},a=[];let i=0,s=0,l=0,d=0;for(const u of n){const p=o[u],f=p?.variantsLogged?.map(w=>w.variant)??[],g=p?.abilitiesLogged?.map(w=>w.ability)??[],m=r.filter(w=>!f.includes(w)),h=hp(u),b=h.filter(w=>!g.includes(w));s+=r.length,i+=f.length,d+=h.length,l+=Math.min(g.length,h.length),a.push({species:u,variantsLogged:f,variantsMissing:m,variantsTotal:r.length,variantsPercentage:r.length>0?f.length/r.length*100:0,abilitiesLogged:g,abilitiesMissing:b,abilitiesTotal:h.length,abilitiesPercentage:h.length>0?g.length/h.length*100:0,isComplete:m.length===0&&(h.length===0||b.length===0)});}const c=a.filter(u=>u.variantsLogged.length>0).length;return {total:n.length,logged:c,percentage:n.length>0?c/n.length*100:0,speciesDetails:a,variantsTotal:s,variantsLogged:i,variantsPercentage:s>0?i/s*100:0,abilitiesTotal:d,abilitiesLogged:l,abilitiesPercentage:d>0?l/d*100:0}}async function Ea(e=false){await K.waitForAny();const t=fp(),n=rS(t);if(!e&&oi&&n===kc)return oi;const r={plants:bp(t),pets:xp(t),lastUpdated:Date.now()};return oi=r,kc=n,r}async function aS(){const e=await Ea();return {plants:e.plants.speciesDetails.filter(t=>t.variantsMissing.length>0).map(t=>({species:t.species,missing:t.variantsMissing})),pets:e.pets.speciesDetails.filter(t=>t.variantsMissing.length>0||(t.abilitiesMissing?.length??0)>0).map(t=>({species:t.species,missingVariants:t.variantsMissing,missingAbilities:t.abilitiesMissing??[]}))}}let br=null;function Wi(){const e=Nn();e.enabled&&(e.autoRefresh&&!br&&(br=setInterval(async()=>{const t=await Ea();el(t);},e.refreshIntervalMs)),console.log("✅ [JournalChecker] Started"));}function yp(){br&&(clearInterval(br),br=null);}function iS(e){const t=Nn();t.enabled=e,Aa(t),e?Wi():yp();}function el(e){window.dispatchEvent(new CustomEvent("gemini:journal-updated",{detail:e}));}async function sS(){const e=await Ea();return el(e),e}const vp={init(){this.isReady()||Wi();},isReady(){return Cc()},DEFAULT_CONFIG:pp,STORAGE_KEY:Zs,loadConfig:Nn,saveConfig:Aa,isEnabled:Cc,setAutoRefresh:tS,setRefreshInterval:nS,getMyJournal:fp,getCropVariants:gp,getPetVariants:mp,getAllMutations:oS,getPetAbilities:hp,calculateProduceProgress:bp,calculatePetProgress:xp,aggregateJournalProgress:Ea,getMissingSummary:aS,start:Wi,stop:yp,setEnabled:iS,refresh:sS,dispatchUpdate:el},tl=we.BULK_FAVORITE,wp={enabled:false,position:"top-right"};function qr(){return ve(tl,wp)}function Sp(e){Pe(tl,e);}function lS(e){const t=qr();t.position=e,Sp(t);}function Cp(){return qr().enabled}function cS(e){return typeof e=="object"&&e!==null&&"id"in e&&typeof e.id=="string"}async function dS(e){const t=sn().get();if(!t?.items)return console.warn("[BulkFavorite] No inventory data available"),0;const n=new Set(t.favoritedItemIds??[]);let r=0;for(const o of t.items){if(!cS(o))continue;const a=n.has(o.id);e&&a||!e&&!a||(await Ia(o.id,e),r++,await uS(50));}return console.log(`[BulkFavorite] ${e?"Favorited":"Unfavorited"} ${r} items`),r}function uS(e){return new Promise(t=>setTimeout(t,e))}let bo=false;const aa={init(){bo||(bo=true,console.log("✅ [MGBulkFavorite] Feature initialized"));},isReady(){return bo},DEFAULT_CONFIG:wp,STORAGE_KEY:tl,loadConfig:qr,saveConfig:Sp,isEnabled:Cp,setPosition:lS,bulkFavorite:dS,destroy(){bo=false;}};class pS{constructor(){L(this,"achievements",new Map);L(this,"data");L(this,"STORAGE_KEY",we.ACHIEVEMENTS);L(this,"onUnlockCallbacks",[]);L(this,"onProgressCallbacks",[]);this.data=this.loadData();}loadData(){return ve(this.STORAGE_KEY,{unlocked:{},progress:{}})}saveData(){Pe(this.STORAGE_KEY,this.data);}register(t){this.achievements.set(t.id,t),this.data.progress[t.id]||(this.data.progress[t.id]={current:0,target:t.target,percentage:0});}registerMany(t){for(const n of t)this.register(n);}async checkAchievement(t){const n=this.achievements.get(t);if(!n)throw new Error(`Achievement not found: ${t}`);const r=this.isUnlocked(t),o=await n.checkProgress(),a={current:o,target:n.target,percentage:Math.min(100,Math.floor(o/n.target*100))},i=this.data.progress[t];this.data.progress[t]=a;const s=o>=n.target;return !r&&s?this.unlock(t,a):s||this.triggerProgressCallbacks({achievement:n,progress:a,previousProgress:i}),this.saveData(),{id:t,wasUnlocked:r,isUnlocked:s,progress:a}}async checkAllAchievements(){const t=[];for(const n of this.achievements.keys()){const r=await this.checkAchievement(n);t.push(r);}return t}unlock(t,n){const r=this.achievements.get(t);if(!r)return;const o={achievementId:t,unlockedAt:Date.now(),progress:n};this.data.unlocked[t]=o,this.saveData(),this.triggerUnlockCallbacks({achievement:r,unlockedAt:o.unlockedAt,progress:n});}isUnlocked(t){return !!this.data.unlocked[t]}getAchievement(t){return this.achievements.get(t)||null}getAllAchievements(){return Array.from(this.achievements.values())}getAchievementsByCategory(t){return Array.from(this.achievements.values()).filter(n=>n.category===t)}getAchievementsByRarity(t){return Array.from(this.achievements.values()).filter(n=>n.rarity===t)}getUnlockedAchievements(){return Object.values(this.data.unlocked)}getLockedAchievements(){return Array.from(this.achievements.values()).filter(t=>!this.isUnlocked(t.id)&&!t.hidden)}getProgress(t){return this.data.progress[t]||null}getCompletionPercentage(){const t=this.achievements.size,n=Object.keys(this.data.unlocked).length;return t>0?Math.floor(n/t*100):0}getCompletionStats(){const t=this.achievements.size,n=Object.keys(this.data.unlocked).length,r=t-n,o=this.getCompletionPercentage();return {total:t,unlocked:n,locked:r,percentage:o}}onUnlock(t){return this.onUnlockCallbacks.push(t),()=>{const n=this.onUnlockCallbacks.indexOf(t);n!==-1&&this.onUnlockCallbacks.splice(n,1);}}onProgress(t){return this.onProgressCallbacks.push(t),()=>{const n=this.onProgressCallbacks.indexOf(t);n!==-1&&this.onProgressCallbacks.splice(n,1);}}triggerUnlockCallbacks(t){for(const n of this.onUnlockCallbacks)try{n(t);}catch(r){console.warn("[Achievements] Unlock callback error:",r);}}triggerProgressCallbacks(t){for(const n of this.onProgressCallbacks)try{n(t);}catch(r){console.warn("[Achievements] Progress callback error:",r);}}reset(){this.data={unlocked:{},progress:{}};for(const t of this.achievements.values())this.data.progress[t.id]={current:0,target:t.target,percentage:0};this.saveData();}exportData(){return JSON.stringify(this.data,null,2)}importData(t){try{const n=JSON.parse(t);return this.data=n,this.saveData(),!0}catch(n){return console.warn("[Achievements] Failed to import data:",n),false}}}let xr=null;function it(){return xr||(xr=new pS),xr}function fS(){xr&&(xr=null);}let xo=false;const kp={init(){xo||(it(),xo=true,console.log("✅ [MGAchievements] Initialized"));},isReady(){return xo},getManager(){return it()},register:(...e)=>it().register(...e),registerMany:(...e)=>it().registerMany(...e),isUnlocked:(...e)=>it().isUnlocked(...e),getAll:()=>it().getAllAchievements(),getUnlocked:()=>it().getUnlockedAchievements(),getStats:()=>it().getCompletionStats(),checkAll:()=>it().checkAllAchievements(),onUnlock:(...e)=>it().onUnlock(...e),onProgress:(...e)=>it().onProgress(...e),destroy(){fS(),xo=false;}},gS={enabled:true},_p=we.ANTI_AFK,mS=["visibilitychange","blur","focus","focusout","pagehide","freeze","resume"],hS=25e3,bS=1,xS=1e-5,le={listeners:[],savedProps:{hidden:void 0,visibilityState:void 0,hasFocus:null},audioCtx:null,oscillator:null,gainNode:null,heartbeatInterval:null};function yS(){const e=(t,n)=>{const r=o=>{o.stopImmediatePropagation(),o.preventDefault?.();};t.addEventListener(n,r,{capture:true}),le.listeners.push({type:n,handler:r,target:t});};for(const t of mS)e(document,t),e(window,t);}function vS(){for(const{type:e,handler:t,target:n}of le.listeners)try{n.removeEventListener(e,t,{capture:!0});}catch{}le.listeners.length=0;}function wS(){const e=Object.getPrototypeOf(document);le.savedProps.hidden=Object.getOwnPropertyDescriptor(e,"hidden"),le.savedProps.visibilityState=Object.getOwnPropertyDescriptor(e,"visibilityState"),le.savedProps.hasFocus=document.hasFocus?document.hasFocus.bind(document):null;try{Object.defineProperty(e,"hidden",{configurable:!0,get:()=>!1});}catch{}try{Object.defineProperty(e,"visibilityState",{configurable:!0,get:()=>"visible"});}catch{}try{document.hasFocus=()=>!0;}catch{}}function SS(){const e=Object.getPrototypeOf(document);try{le.savedProps.hidden&&Object.defineProperty(e,"hidden",le.savedProps.hidden);}catch{}try{le.savedProps.visibilityState&&Object.defineProperty(e,"visibilityState",le.savedProps.visibilityState);}catch{}try{le.savedProps.hasFocus&&(document.hasFocus=le.savedProps.hasFocus);}catch{}}function ia(){le.audioCtx&&le.audioCtx.state!=="running"&&le.audioCtx.resume?.().catch(()=>{});}function CS(){try{const e=window.AudioContext||window.webkitAudioContext;le.audioCtx=new e({latencyHint:"interactive"}),le.gainNode=le.audioCtx.createGain(),le.gainNode.gain.value=xS,le.oscillator=le.audioCtx.createOscillator(),le.oscillator.frequency.value=bS,le.oscillator.connect(le.gainNode).connect(le.audioCtx.destination),le.oscillator.start(),document.addEventListener("visibilitychange",ia,{capture:!0}),window.addEventListener("focus",ia,{capture:!0});}catch{Tp();}}function Tp(){try{le.oscillator?.stop();}catch{}try{le.oscillator?.disconnect(),le.gainNode?.disconnect();}catch{}try{le.audioCtx?.close?.();}catch{}document.removeEventListener("visibilitychange",ia,{capture:true}),window.removeEventListener("focus",ia,{capture:true}),le.oscillator=null,le.gainNode=null,le.audioCtx=null;}function kS(){const e=document.querySelector("canvas")||document.body||document.documentElement;le.heartbeatInterval=window.setInterval(()=>{try{e.dispatchEvent(new MouseEvent("mousemove",{bubbles:!0,clientX:1,clientY:1}));}catch{}},hS);}function _S(){le.heartbeatInterval!==null&&(clearInterval(le.heartbeatInterval),le.heartbeatInterval=null);}function ai(){wS(),yS(),CS(),kS();}function ii(){_S(),Tp(),vS(),SS();}let yo=false,Ke=false;function dn(){return ve(_p,gS)}function si(e){Pe(_p,e);}const Jt={init(){if(yo)return;const e=dn();yo=true,e.enabled?(ai(),Ke=true,console.log("[MGAntiAfk] Initialized and started")):console.log("[MGAntiAfk] Initialized but disabled");},isReady(){return yo},isRunning(){return Ke},isEnabled(){return dn().enabled},enable(){const e=dn();e.enabled=true,si(e),Ke||(ai(),Ke=true,console.log("[MGAntiAfk] Enabled"));},disable(){const e=dn();e.enabled=false,si(e),Ke&&(ii(),Ke=false,console.log("[MGAntiAfk] Disabled"));},toggle(){Jt.isEnabled()?Jt.disable():Jt.enable();},getConfig(){return dn()},updateConfig(e){const n={...dn(),...e};si(n),n.enabled&&!Ke?(ai(),Ke=true):!n.enabled&&Ke&&(ii(),Ke=false);},destroy(){Ke&&(ii(),Ke=false),yo=false,console.log("[MGAntiAfk] Destroyed");}},Pp=we.PET_TEAM,TS={enabled:false,teams:[],activeTeamId:null},nl=3,_c=50,Ne="";function Oe(){return ve(Pp,TS)}function ln(e){Pe(Pp,e);}function PS(e){const n={...Oe(),...e};return ln(n),n}function IS(){return Oe().enabled}function AS(e){PS({enabled:e});}function ES(){return crypto.randomUUID()}function Vi(){return Date.now()}function Ip(e=[]){const t=[...e];for(;t.length<nl;)t.push(Ne);return [t[0]||Ne,t[1]||Ne,t[2]||Ne]}function Ap(e,t){const n=Oe(),r=e.trim();return r?!n.teams.some(o=>o.name.trim()===r&&o.id!==t):false}function Ep(e,t){const n=Oe();if(!e.some(a=>a!==Ne))return  true;const o=[...e].sort().join(",");return !n.teams.some(a=>a.id===t?false:[...a.petIds].sort().join(",")===o)}function Mp(e){const n=Fn().get(),r=new Set(n.all.map(a=>a.id)),o=Oe();for(const a of o.teams)for(const i of a.petIds)i!==Ne&&r.add(i);for(const a of e)if(a!==Ne&&!r.has(a))return  false;return  true}function Rp(e){const n=Fn().get(),r=new Map(n.all.map(a=>[a.id,a])),o=[];for(const a of e.petIds){if(a===Ne)continue;const i=r.get(a);i&&o.push(i);}return o}function MS(e){return e.petIds.every(t=>t!==Ne)}function RS(e){const t=[];for(let n=0;n<nl;n++)e.petIds[n]===Ne&&t.push(n);return t}function LS(e){return e.petIds.filter(t=>t!==Ne).length}function FS(e){return e.petIds.every(t=>t===Ne)}function NS(e,t){return e.petIds.includes(t)}function OS(e,t){return e.petIds.indexOf(t)}function $S(e,t=[]){const n=Oe();if(n.teams.length>=_c)throw new Error(`Maximum number of teams (${_c}) reached`);if(!Ap(e))throw new Error(`Team name "${e}" already exists`);const r=e.trim();if(!r)throw new Error("Team name cannot be empty");const o=Ip(t);if(!Mp(o))throw new Error("One or more pet IDs do not exist");if(!Ep(o))throw new Error("A team with this exact composition already exists");const a={id:ES(),name:r,petIds:o,createdAt:Vi(),updatedAt:Vi()};return n.teams.push(a),ln(n),a}function Lp(e,t){const n=Oe(),r=n.teams.findIndex(i=>i.id===e);if(r===-1)return null;const o=n.teams[r];if(t.name!==void 0){const i=t.name.trim();if(!i)throw new Error("Team name cannot be empty");if(!Ap(i,e))throw new Error(`Team name "${i}" already exists`);t.name=i;}if(t.petIds!==void 0){const i=Ip(t.petIds);if(!Mp(i))throw new Error("One or more pet IDs do not exist");if(!Ep(i,e))throw new Error("A team with this exact composition already exists");t.petIds=i;}const a={...o,...t,id:o.id,createdAt:o.createdAt,updatedAt:Vi()};return n.teams[r]=a,ln(n),a}function BS(e){const t=Oe(),n=t.teams.length;return t.teams=t.teams.filter(r=>r.id!==e),t.teams.length===n?false:(ln(t),true)}function DS(e){return Oe().teams.find(n=>n.id===e)??null}function GS(){return [...Oe().teams]}function zS(e){const t=Oe(),n=e.trim();return t.teams.find(r=>r.name.trim()===n)??null}function HS(e){const t=Oe(),n=new Map(t.teams.map(r=>[r.id,r]));if(e.length!==t.teams.length)return  false;for(const r of e)if(!n.has(r))return  false;return t.teams=e.map(r=>n.get(r)),ln(t),true}function jS(e,t){try{return Lp(e,{name:t})!==null}catch(n){return console.warn(`[PetTeam] Failed to rename team ${e}:`,n),false}}function US(){const n=Fn().get().byLocation.active.map(o=>o.id).sort(),r=Oe();for(const o of r.teams){const a=o.petIds.filter(i=>i!=="").sort();if(a.length===n.length&&a.every((i,s)=>i===n[s]))return o.id}return null}function Fp(){const e=US(),t=Oe();return e!==t.activeTeamId&&(t.activeTeamId=e,ln(t)),e}function Np(e){const t=Oe();t.activeTeamId=e,ln(t);}function WS(e){return Fp()===e}function VS(e){const t=Fn(),n=sn(),r=t.get();if(n.get().isFull)throw new Error("Cannot activate team: inventory is full");const a=r.byLocation.active,i=e.petIds.filter(c=>c!==Ne).sort(),s=a.map(c=>c.id).sort();if(JSON.stringify(i)===JSON.stringify(s)){console.log("[PetTeam] Team already active");return}const l=r.hutch,d=l.hasHutch?l.maxItems-l.currentItems:0;XS(e.petIds,d,r),Np(e.id),console.log("[PetTeam] Team activated successfully");}function XS(e,t,n){const r=n.byLocation.active;let o=t;console.log(`[PetTeam] Starting swap with ${t} hutch spaces available`);for(let a=0;a<nl;a++){const i=e[a],s=r[a]??null;if(console.log(`[PetTeam] Slot ${a}: current=${s?.id.slice(0,8)??"empty"}, target=${i.slice(0,8)||"empty"}, hutchSpace=${o}`),s?.id===i){console.log(`[PetTeam] Slot ${a}: Same pet, skipping`);continue}if(i===Ne&&s){const l=o>0;console.log(`[PetTeam] Slot ${a}: Removing pet, storeInHutch=${l}`),qS(s.id,l),l&&o--;continue}if(!s&&i!==Ne){const d=n.all.find(c=>c.id===i)?.location==="hutch";console.log(`[PetTeam] Slot ${a}: Adding pet, fromHutch=${d}`),d&&o++,KS(i,n);continue}if(s&&i!==Ne){const d=n.all.find(u=>u.id===i)?.location==="hutch";d&&o++;const c=o>0;console.log(`[PetTeam] Slot ${a}: Swapping pets, fromHutch=${d}, storeInHutch=${c}`),YS(s.id,i,n,c),c&&o--;continue}}console.log(`[PetTeam] Swap complete, ${o} hutch spaces remaining`);}function qS(e,t){cp(e),t&&Ys(e);}function KS(e,t){const n=t.all.find(r=>r.id===e);if(!n){console.warn(`[PetTeam] Pet ${e} not found`);return}n.location==="hutch"&&Js(e),sp(e);}function YS(e,t,n,r){const o=n.all.find(a=>a.id===t);if(!o){console.warn(`[PetTeam] Pet ${t} not found`);return}o.location==="hutch"&&Js(t),lp(e,t),r&&Ys(e);}let vo=false;const ae={init(){if(vo)return;if(!Oe().enabled){console.log("[PetTeam] Feature disabled");return}vo=true,console.log("[PetTeam] Feature initialized");},destroy(){vo&&(vo=false,console.log("[PetTeam] Feature destroyed"));},isEnabled:IS,setEnabled:AS,createTeam:$S,updateTeam:Lp,deleteTeam:BS,renameTeam:jS,getTeam:DS,getAllTeams:GS,getTeamByName:zS,reorderTeams:HS,getPetsForTeam:Rp,isTeamFull:MS,getEmptySlots:RS,getFilledSlotCount:LS,isTeamEmpty:FS,isPetInTeam:NS,getPetSlotIndex:OS,getActiveTeamId:Fp,setActiveTeamId:Np,isActiveTeam:WS,activateTeam:VS},JS=["PetXpBoost","PetXpBoostII","PetXpBoostIII","SnowyPetXpBoost"],Op=we.XP_TRACKER,QS={enabled:false,sortBy:"closestToMax",filterSpecies:[],filterHasXpBoost:false,updateIntervalMs:3e3,isPoppedOut:false,popOutPosition:null,collapsedSections:{activePets:false,allPets:false,xpBoostSummary:false}},yn="XP Tracker",vn="[XpTracker]";function On(){return ve(Op,QS)}function $p(e){Pe(Op,e);}function Bp(e){const n={...On(),...e};return $p(n),n}function Dp(){return On().enabled}function ZS(e){Bp({enabled:e});}function rl(e){return JS.includes(e)}function eC(e){const t=K.get("abilities");if(!t)return null;const n=t[e];return !n||!rl(e)?null:{id:e,name:n.name??"XP Boost",baseProbability:n.baseProbability??0,bonusXp:n.baseParameters?.bonusXp??0,requiredWeather:n.baseParameters?.requiredWeather??null}}function Gp(e){return e.filter(rl)}function zp(e){return e.some(rl)}function tC(e){switch(e){case "PetXpBoost":return "I";case "PetXpBoostII":return "II";case "PetXpBoostIII":return "III";case "SnowyPetXpBoost":return "Snowy";default:return "I"}}function Hp(e,t,n,r=100){const o=eC(e);if(!o)return null;const a=tC(e),i=o.requiredWeather,s=i===null||n===i,l=t/r,d=l*l,c=o.baseProbability,u=o.bonusXp,p=c,f=Math.floor(u*d),g=p/100*60,m=s?Math.floor(g*f):0;return {abilityId:e,abilityName:o.name,tier:a,baseChancePerMinute:c,actualChancePerMinute:p,baseXpPerProc:u,actualXpPerProc:f,expectedProcsPerHour:g,expectedXpPerHour:m,requiredWeather:i,isActive:s}}function jp(e,t){const n={totalBonusXpPerHour:0,totalProcsPerHour:0,activeBoosterCount:0,boosters:[]};for(const r of e){const o=Gp(r.abilities);for(const a of o){const i=Hp(a,r.strength,t,r.maxStrength||100);i&&(n.boosters.push({petId:r.petId,petName:r.petName,stats:i}),i.isActive&&(n.totalBonusXpPerHour+=i.expectedXpPerHour,n.totalProcsPerHour+=i.expectedProcsPerHour,n.activeBoosterCount++));}}return n}function Up(e,t,n,r=100){const o=Gp(e);return o.length===0?null:Hp(o[0],t,n,r)}function Tc(e,t){return e.hoursToMaxStrength-t.hoursToMaxStrength}function nC(e,t){return t.hoursToMaxStrength-e.hoursToMaxStrength}function rC(e,t){return e.species.localeCompare(t.species)}function oC(e,t){return t.currentStrength-e.currentStrength}function aC(e,t){const n={active:0,inventory:1,hutch:2};return n[e.location]-n[t.location]}function iC(e,t){return e.name.localeCompare(t.name)}function sC(e){switch(e){case "closestToMax":return Tc;case "furthestFromMax":return nC;case "species":return rC;case "strength":return oC;case "location":return aC;case "name":return iC;default:return Tc}}function Wp(e,t){const n=sC(t);return [...e].sort(n)}function lC(e,t){return t.length===0?e:e.filter(n=>t.includes(n.species))}function cC(e,t){return t?e.filter(n=>n.xpBoostStats!==null):e}function Vp(e,t){let n=e;return n=lC(n,t.filterSpecies),n=cC(n,t.filterHasXpBoost),n=Wp(n,t.sortBy),n}function jn(e){const t=ae.getTeam(e);if(!t)return null;const n=Xp(t);if(n.length===0)return {teamId:t.id,teamName:t.name,pets:[],teamSummary:{baseXpPerHour:Ae,bonusXpPerHour:0,totalXpPerHour:Ae,activeBoosterCount:0,totalProcsPerHour:0}};const r=de.weather.get(),o=r.isActive?r.type:null,a=n.filter(c=>!c.isMature||zp(c.abilities)).filter(c=>c.hunger>0).map(c=>({petId:c.id,petName:c.name??"",abilities:c.abilities,strength:c.currentStrength})),i=jp(a,o),s=[],l=dC(n,i.totalBonusXpPerHour);for(const c of n){const u=Xi(c,o,i.totalBonusXpPerHour,l);s.push(u);}const d={baseXpPerHour:Ae,bonusXpPerHour:i.totalBonusXpPerHour,totalXpPerHour:Ae+i.totalBonusXpPerHour,activeBoosterCount:i.activeBoosterCount,totalProcsPerHour:i.totalProcsPerHour};return {teamId:t.id,teamName:t.name,pets:s,teamSummary:d}}function Xp(e){const t=de.myPets.get(),n=[];for(const r of e.petIds){if(!r)continue;const o=t.all.find(a=>a.id===r);o&&n.push(o);}return n}function dC(e,t){let n=0;for(const r of e){const o=Ur(r.petSpecies,r.targetScale);if(Wr(r.petSpecies,r.xp,o)>=o)continue;const i=r.hunger>0?Ae+t:0,s=Pa(r.petSpecies,r.xp,o,i>0?i:Ae);n=Math.max(n,s);}return n}function Xi(e,t,n,r){const o=Ur(e.petSpecies,e.targetScale),a=Wr(e.petSpecies,e.xp,o),i=a>=o,s=e.hunger<=0,d=s?0:(s?0:Ae)+n,c=Up(e.abilities,a,t),u=i?null:Gs(e.petSpecies,e.xp,a,o,d>0?d:Ae),p=Pa(e.petSpecies,e.xp,o,d>0?d:Ae),f=u!==null?js(e.petSpecies,e.hunger,u):null,g=Mr(e.petSpecies,e.hunger,p),m=i&&c&&r>0?Us(true,true,e.petSpecies,e.hunger,0,r):null;return {id:e.id,name:e.name??"",species:e.petSpecies,currentStrength:a,maxStrength:o,isMaxStrength:i,xpPerHour:d,hoursToNextStrength:u,hoursToMaxStrength:p,feedsToNextStrength:f,feedsToMaxStrength:g,isStarving:s,hunger:e.hunger,xpBoostStats:c,supportingFeeds:m,mutations:e.mutations,targetScale:e.targetScale}}function Pc(e){const t=ae.getTeam(e);if(!t)return 0;const n=Xp(t);if(n.length===0)return 0;const r=n.map(o=>{const a=Ur(o.petSpecies,o.targetScale);return Wr(o.petSpecies,o.xp,a)/a*100});return r.reduce((o,a)=>o+a,0)/r.length}function Ic(e){if(!isFinite(e)||e<=0)return "0m";if(e<1)return `${Math.ceil(e*60)}m`;if(e<24)return `${e.toFixed(1)}h`;{const t=Math.floor(e/24),n=Math.floor(e%24);return `${t}d ${n}h`}}let An=false,jo=null,Ma=[],ol=null;function uC(e,t,n){const r=Ur(e.petSpecies,e.targetScale),o=Wr(e.petSpecies,e.xp,r),a=o>=r,i=e.hunger<=0,s=i?0:Ae,l=Up(e.abilities,o,t);l?.isActive&&l.expectedXpPerHour;const d=e.location==="active"&&!i?s+n:0,c=Gs(e.petSpecies,e.xp,o,r,d>0?d:Ae),u=Pa(e.petSpecies,e.xp,r,d>0?d:Ae),p=js(e.petSpecies,e.hunger,c),f=Mr(e.petSpecies,e.hunger,u);return {id:e.id,species:e.petSpecies,name:e.name,xp:e.xp,hunger:e.hunger,location:e.location,isStarving:i,currentStrength:o,maxStrength:r,isMaxStrength:a,hoursToNextStrength:c,hoursToMaxStrength:u,feedsToNextStrength:p,feedsToMaxStrength:f,baseXpPerHour:s,totalXpPerHour:d,xpBoostStats:l,targetScale:e.targetScale,abilities:e.abilities,mutations:e.mutations}}function qp(){const e=de.myPets.get(),t=de.weather.get(),n=t.isActive?t.type:null,o=e.byLocation.active.filter(l=>!l.isMature||zp(l.abilities)).filter(l=>l.hunger>0).map(l=>({petId:l.id,petName:l.name??"",abilities:l.abilities,strength:l.currentStrength})),a=jp(o,n);ol=a;const i=[];for(const l of e.all){const d=uC({id:l.id,petSpecies:l.petSpecies,name:l.name??"",xp:l.xp,hunger:l.hunger,targetScale:l.targetScale,abilities:l.abilities,mutations:l.mutations,location:l.location},n,a.totalBonusXpPerHour);i.push(d);}const s=Math.max(0,...i.map(l=>l.hoursToMaxStrength));for(const l of i)l.isMaxStrength&&l.xpBoostStats&&(l.feedsToMaxStrength=Us(true,true,l.species,l.hunger,0,s));return i}function Kp(){if(An)return;if(!On().enabled){console.log(`${vn} ${yn} disabled`);return}console.log(`${vn} Initializing ${yn}...`),K.isReady()&&(Ma=qp()),An=true,console.log(`${vn} ${yn} initialized`);}function al(){return An&&K.isReady()}function il(){return al()?Ma:[]}function pC(){return il().filter(e=>e.location==="active")}function fC(){return ol}function sl(){al()&&(Ma=qp());}function gC(e){ll();const t=On(),n=e??t.updateIntervalMs;jo=setInterval(()=>{Dp()&&sl();},n);}function ll(){jo&&(clearInterval(jo),jo=null);}function Yp(){An&&(ll(),An=false,Ma=[],ol=null,console.log(`${vn} ${yn} destroyed`));}function mC(){const e=On();return Vp(il(),{sortBy:e.sortBy,filterSpecies:e.filterSpecies,filterHasXpBoost:e.filterHasXpBoost})}function hC(e){ZS(e),e?(An=false,Kp(),K.isReady()&&sl(),console.log(`${vn} ${yn} enabled`)):(Yp(),console.log(`${vn} ${yn} disabled`));}const sa={init:Kp,isReady:al,destroy:Yp,loadConfig:On,saveConfig:$p,updateConfig:Bp,isEnabled:Dp,setEnabled:hC,getAllPetsProgress:il,getActivePetsProgress:pC,getCombinedBoostStats:fC,getFilteredPets:mC,refresh:sl,startAutoUpdate:gC,stopAutoUpdate:ll,sortPets:Wp,filterAndSortPets:Vp},Rr={EggGrowthBoost:{procRate:.21,minutesPerProc:7},EggGrowthBoostII_NEW:{procRate:.24,minutesPerProc:9},EggGrowthBoostII:{procRate:.27,minutesPerProc:11},SnowyEggGrowthBoost:{procRate:.35,minutesPerProc:10}},Lr={PlantGrowthBoost:{procRate:.24,minutesPerProc:3},PlantGrowthBoostII:{procRate:.27,minutesPerProc:5},PlantGrowthBoostIII:{procRate:.3,minutesPerProc:7},SnowyPlantGrowthBoost:{procRate:.4,minutesPerProc:6}};[...Object.keys(Rr),...Object.keys(Lr)];function cl(e){const t=[];for(const n of e)for(const r of n.abilities)if(r in Rr){const o=Rr[r];t.push({petId:n.id,petName:n.name||n.petSpecies,abilityId:r,procRate:o.procRate,minutesPerProc:o.minutesPerProc});}return t}function dl(e){const t=[];for(const n of e)for(const r of n.abilities)if(r in Lr){const o=Lr[r];t.push({petId:n.id,petName:n.name||n.petSpecies,abilityId:r,procRate:o.procRate,minutesPerProc:o.minutesPerProc});}return t}function Fr(e){let t=0,n=0;for(const r of e){const o=r.procRate*60;t+=o,n+=o*r.minutesPerProc;}return {procsPerHour:t,timeReductionPerHour:n}}function wn(e){return e.some(t=>t.abilities.some(n=>n in Rr))}function Sn(e){return e.some(t=>t.abilities.some(n=>n in Lr))}let yr=null,Ft=0;function Jp(){const t=Xe().get().plant;if(!t){Ft=0;return}const n=t.currentSlotIndex!==null?t.slots[t.currentSlotIndex]:null;if(!n){Ft=0;return}Ft=dt(n.species,n.targetScale,n.mutations||[]),console.log(`[CropValueIndicator] Updated crop value: ${Ft} coins`);}function bC(e){const{current:t}=e;if(Jp(),!t){console.log("[CropValueIndicator] No plant on current tile");return}const n=t.currentSlotIndex!==null?t.slots[t.currentSlotIndex]:null;n?console.log(`[CropValueIndicator] 💰 Crop Price: ${Ft} coins`,{species:t.species,slot:{index:t.currentSlotIndex,scale:n.targetScale,mutations:n.mutations||[]},plantInfo:{totalSlots:t.slots.length,sortedSlotIndices:t.sortedSlotIndices,nextHarvestSlotIndex:t.nextHarvestSlotIndex}}):console.log("[CropValueIndicator] Plant Info:",{species:t.species,currentSlotIndex:t.currentSlotIndex,sortedSlotIndices:t.sortedSlotIndices,nextHarvestSlotIndex:t.nextHarvestSlotIndex,totalSlots:t.slots.length,currentSlot:n,cropValue:Ft>0?`${Ft} coins`:"N/A"});}function xC(){yr&&(console.warn("[CropValueIndicator] Already monitoring, cleaning up previous subscription"),Qp()),console.log("[CropValueIndicator] Starting plant info monitoring..."),Jp(),yr=Xe().subscribePlantInfo(bC,{immediate:true}),console.log("[CropValueIndicator] Monitoring started");}function Qp(){yr&&(console.log("[CropValueIndicator] Stopping monitoring..."),yr(),yr=null,Ft=0,console.log("[CropValueIndicator] Monitoring stopped"));}function Ra(){const e=[];return {add(t){e.push(t);},run(){for(const t of e)try{t();}catch(n){console.warn("[CleanupTracker] Error during cleanup:",n);}},clear(){e.length=0;}}}function Zp(e,t){e.add(()=>t.disconnect());}const qi="css-qnqsp4",Ki="css-v439q6";let Cn=Ra(),Yi=false,Un=false,Uo=null,Ji=null,Vt=null;const yC=`
...
`;class W1 extends nn{constructor(n){super({id:"tab-pets",label:"Pets"});L(this,"unsubscribeMyPets");L(this,"lastActiveTeamId",null);L(this,"teamCardPart",null);L(this,"abilityLogsCardPart",null);L(this,"deps");this.deps=n;}async build(n){this.container=n;const{MGSprite:r}=await Rn(async()=>{const{MGSprite:i}=await Promise.resolve().then(()=>Ws);return {MGSprite:i}},void 0);await r.init();const o=n.getRootNode();ye(o,kf,"team-card-styles"),ye(o,_f,"base-pet-card-styles"),ye(o,bl,"badge-styles"),ye(o,Tf,"arcade-button-styles"),ye(o,Cf,"gemini-icon-button-styles"),ye(o,U1,"ability-logs-card-styles");const a=this.createGrid("12px");a.id="pets",n.appendChild(a),this.initializeTeamCardPart(a),this.initializeAbilityLogsCardPart(a),this.unsubscribeMyPets=de.myPets.subscribeStable(()=>{const i=ae.getActiveTeamId();i!==this.lastActiveTeamId&&(this.lastActiveTeamId=i,this.teamCardPart?.render());}),this.lastActiveTeamId=ae.getActiveTeamId();}async destroy(){this.unsubscribeMyPets&&(this.unsubscribeMyPets(),this.unsubscribeMyPets=void 0),this.teamCardPart&&(this.teamCardPart.destroy(),this.teamCardPart=null),this.abilityLogsCardPart&&(this.abilityLogsCardPart.destroy(),this.abilityLogsCardPart=null);}initializeTeamCardPart(n){this.teamCardPart||(this.teamCardPart=new B1({onTeamReordered:o=>{console.log("[PetsSection] Teams reordered:",o);},setHUDOpen:this.deps?.setHUDOpen}));const r=this.teamCardPart.build();n.appendChild(r),this.teamCardPart.render();}initializeAbilityLogsCardPart(n){this.abilityLogsCardPart||(this.abilityLogsCardPart=new j1);const r=this.abilityLogsCardPart.build();n.appendChild(r),this.abilityLogsCardPart.render();}}class V1{constructor(t){L(this,"root");L(this,"options");L(this,"headerElement",null);L(this,"petsContainer",null);L(this,"footerElement",null);this.options=t,this.root=document.createElement("div"),this.root.className="xp-panel";}build(){return this.headerElement=document.createElement("div"),this.headerElement.className="xp-panel__header",this.root.appendChild(this.headerElement),this.petsContainer=document.createElement("div"),this.petsContainer.className="xp-panel__pets",this.root.appendChild(this.petsContainer),this.footerElement=document.createElement("div"),this.footerElement.className="xp-panel__footer",this.root.appendChild(this.footerElement),this.root}update(t){this.updateHeader(t.teamSummary),this.updatePets(t.pets),this.updateFooter(t.teamSummary,t.pets);}updateHeader(t){this.headerElement&&(t.bonusXpPerHour>0,this.headerElement.innerHTML=`
        ...
        `;}formatHours(t){if(t===null||t===0)return "0h";if(!isFinite(t))return "∞";if(t<1)return `${Math.ceil(t*60)}m`;if(t<24)return `${t.toFixed(1)}h`;{const n=Math.floor(t/24),r=Math.floor(t%24);return `${n}d ${r}h`}}destroy(){this.root.parentNode&&this.root.parentNode.removeChild(this.root),this.headerElement=null,this.petsContainer=null,this.footerElement=null;}}const X1={id:"xp",label:"XP",icon:"📊",category:"stats",isAvailable:()=>true,getSummary:(e,t)=>{const n=Pc(e.id);return n>=99?null:{text:`${Math.round(n)}%`,variant:n<33?"low":n<67?"medium":"high",tooltip:`Average progress to max STR: ${Math.round(n)}%`,priority:10}},buildPanel:(e,t)=>{const n=new V1({teamId:e.id});t.appendChild(n.build());const r=jn(e.id);return r&&n.update(r),{update:(o,a)=>{const i=jn(o.id);i&&n.update(i);},destroy:()=>n.destroy(),refresh:()=>{const o=jn(e.id);o&&n.update(o);}}},renderPetSlot:(e,t,n)=>{const r=de.weather.get(),o=r.isActive?r.type:null,a=jn(t.id),i=a?.teamSummary.bonusXpPerHour||0,s=a?.pets||[],l=Math.max(0,...s.map(f=>f.hoursToMaxStrength||0)),d=Xi(e,o,i,l),c=d.isMaxStrength,u=!!d.xpBoostStats;let p="";if(c)u&&d.xpBoostStats&&(p=`
                ...
                <div class="stat-row">
                    ...
                    <span class="stat__timer">${Ic(d.hoursToNextStrength||0)}</span>
                ...
                <div class="stat-row">
                    ...
                    <span class="stat__timer">${Ic(d.hoursToMaxStrength||0)}</span>
            ...
            `;}n.innerHTML=p?`<div class="xp-stats-compact">${p}</div>`:"";},renderGroupedSlot:(e,t,n)=>{const r=de.weather.get(),o=r.isActive?r.type:null,i=jn(t.id)?.teamSummary.bonusXpPerHour||0;let s=0,l=0;for(const c of e){const u=Xi(c,o,i,0);u.xpBoostStats&&(s+=u.xpBoostStats.expectedXpPerHour),u.supportingFeeds&&(l+=u.supportingFeeds);}let d="";if(s>0&&(d=`
                <div class="stat-row stat-row--boost">
...
`;async function vk(){}const wk={seed:"Seeds",tool:"Tools",egg:"Eggs",decor:"Decor"},Xc={seed:"🌱",tool:"🔧",egg:"🥚",decor:"🎨"},vl={seed:"plants",tool:"items",egg:"eggs",decor:"decor"},wl={seed:"seed",tool:null,egg:null,decor:null},qc={common:0,uncommon:1,rare:2,legendary:3,mythical:4,divine:5,celestial:6};function Sk(e,t){try{const n=vl[t],r=K.get(n);if(!r||typeof r!="object")return null;const o=r[e];if(!o)return null;const a=wl[t];return (a?o[a]:o)?.spriteId??null}catch(n){return console.warn(`[ShopNotifier] Failed to get spriteId for ${e}:`,n),null}}function Ck(e,t){try{const n=vl[t],r=K.get(n);if(!r||typeof r!="object")return null;const o=r[e];if(!o)return null;const a=wl[t],s=(a?o[a]:o)?.rarity;return s?String(s).toLowerCase():null}catch{return null}}function kk(e,t){try{const n=vl[t],r=K.get(n);if(!r||typeof r!="object")return e;const o=r[e];if(!o)return e;const a=wl[t];return (a?o[a]:o)?.name??e}catch(n){return console.warn(`[ShopNotifier] Failed to get name for ${e}:`,n),e}}function _k(e){const n=tn.getTrackedItems().filter(r=>r.shopType===e).map(r=>r.itemId);return new Set(n)}function Rf(e,t){const n=_k(t);return e.items.map(r=>({...r,rarity:Ck(r.id,t),spriteId:Sk(r.id,t),itemName:kk(r.id,t),isTracked:n.has(r.id)}))}function Tk(e,t){const n=Rf(e,t);return us({columns:[{key:"icon",header:"",width:"40px",align:"center",sortable:false,render:a=>{const i=x("div",{className:"shop-item-icon"});if(a.spriteId){const s=j.toCanvas(a.spriteId);s?(s.style.maxWidth="32px",s.style.maxHeight="32px",s.style.width="auto",s.style.height="auto",s.style.imageRendering="auto",s.style.display="block",i.appendChild(s)):i.textContent=Xc[t];}else i.textContent=Xc[t];return i}},{key:"itemName",header:"Item",width:"1fr",align:"left",sortable:true,sortFn:(a,i)=>a.itemName.localeCompare(i.itemName,void 0,{numeric:true,sensitivity:"base"})},{key:"rarity",header:"Rarity",width:"120px",align:"left",sortable:true,sortFn:(a,i)=>{const s=a.rarity?qc[a.rarity.toLowerCase()]??999:999,l=i.rarity?qc[i.rarity.toLowerCase()]??999:999;return s-l},render:a=>{const i=x("div",{className:"shop-item-rarity"}),s=Vr({variant:"rarity",rarity:a.rarity});return i.appendChild(s.root),i}},{key:"toggle",header:"Track",width:"60px",align:"center",sortable:false,render:a=>{const i=x("div",{className:"shop-item-toggle"}),s=kr({checked:a.isTracked,size:"sm",onChange:l=>{a.isTracked=l,l?tn.addTrackedItem(t,a.id):tn.removeTrackedItem(t,a.id);}});return i.appendChild(s.root),i}}],data:n,maxHeight:360,stickyHeader:true,zebra:true,compact:true,getRowId:a=>a.id})}function Pk(e){const{shopType:t}=e,n=Ks(),r=n.getShop(t);let o=null,a=null,i=null;function s(){return a=Tk(r,t),o=We({id:`shop-card-${t}`,title:wk[t],expandable:true,defaultExpanded:true,stateKey:`shop-${t}`,variant:"soft",padding:"none",divider:false},a.root),o.classList.add(`shop-card--${t}`),o}function l(){if(!a)return;const c=n.getShop(t),u=Rf(c,t);a.setData(u);}function d(){i&&(i(),i=null),a&&(a.destroy(),a=null),o=null;}return i=n.subscribeStable(c=>{const u=c.byType[t];u&&JSON.stringify(r.items)!==JSON.stringify(u.items)&&(Object.assign(r,u),l());}),{root:s(),refresh:l,destroy:d}}const Ik=["seed","tool","egg","decor"];class Ak extends nn{constructor(){super({id:"tab-shop-notifier",label:"Shop Alerts"});L(this,"sectionElement",null);L(this,"shopCards",new Map);}async build(n){await vk();const r=n.getRootNode();ye(r,yk,"shop-notifier-styles");const o=this.createGrid("12px");o.id="shop-notifier-section",this.sectionElement=o;const{MGData:a}=await Rn(async()=>{const{MGData:i}=await Promise.resolve().then(()=>Ws);return {MGData:i}},void 0);await Promise.all([a.waitFor("plants"),a.waitFor("items"),a.waitFor("eggs"),a.waitFor("decor")]),this.buildParts(),n.appendChild(o);}render(n){super.render(n);}buildParts(){if(this.sectionElement)for(const n of Ik){const r=Pk({shopType:n});this.shopCards.set(n,r),this.sectionElement.appendChild(r.root);}}async destroy(){for(const n of this.shopCards.values())n.destroy?.();this.shopCards.clear(),this.sectionElement=null;}}const Ek={Store:{select:ge.select.bind(ge),set:ge.set.bind(ge),subscribe:ge.subscribe.bind(ge),subscribeImmediate:ge.subscribeImmediate.bind(ge)},Globals:de,Modules:{Version:ms,Assets:rn,Manifest:Ct,Data:K,Environment:Ve,CustomModal:bn,Sprite:j,Tile:kt,Pixi:xa,Audio:wa,Cosmetic:$s,Calculators:Ku},Features:{AutoFavorite:Qs,JournalChecker:vp,BulkFavorite:aa,Achievements:kp,Tracker:yf,AntiAfk:Jt,Pets:vf,PetTeam:ae,XPTracker:sa,CropValueIndicator:vr,CropSizeIndicator:wr,ShopNotifier:tn},WebSocket:{chat:pw,emote:fw,wish:gw,kickPlayer:mw,setPlayerData:hw,usurpHost:bw,reportSpeakingStart:xw,setSelectedGame:yw,voteForGame:vw,requestGame:ww,restartGame:Sw,ping:Cw,checkWeatherStatus:Tw,move:kw,playerPosition:ip,teleport:_w,moveInventoryItem:Pw,dropObject:Iw,pickupObject:Aw,toggleFavoriteItem:Ia,putItemInStorage:Ys,retrieveItemFromStorage:Js,moveStorageItem:Ew,logItems:Mw,plantSeed:Rw,waterPlant:Lw,harvestCrop:Fw,sellAllCrops:Nw,purchaseDecor:Ow,purchaseEgg:$w,purchaseTool:Bw,purchaseSeed:Dw,plantEgg:Gw,hatchEgg:zw,plantGardenPlant:Hw,potPlant:jw,mutationPotion:Uw,pickupDecor:Ww,placeDecor:Vw,removeGardenObject:Xw,placePet:sp,feedPet:qw,petPositions:Kw,swapPet:lp,storePet:cp,namePet:Yw,sellPet:Jw},_internal:{getGlobals:vt,initGlobals:rp,destroyGlobals:tw}};function Mk(){const e=F;e.Gemini=Ek,e.MGSprite=j,e.MGData=K,e.MGPixi=xa,e.MGAssets=rn,e.MGEnvironment=Ve;}let fi=null,gi=null;function Rk(){return fi||(fi=new Vy),fi}function Lf(){return gi||(gi=new Ak),gi}function Lk(e){return [new am(e),new g1,new M1,Lf(),new W1(e),new xk(e)]}async function Fk(){const e=Lf(),t=Rk();await Promise.all([e.preload(),t.preload()]);}function Nk(e){const{shadow:t,initialOpen:n}=e,r=x("div",{className:"gemini-panel",id:"panel",ariaHidden:String(!n)}),o=x("div",{className:"gemini-tabbar"}),a=x("div",{className:"gemini-content",id:"content"}),i=x("div",{className:"gemini-resizer",title:"Resize"}),s=x("button",{className:"gemini-close",title:"Fermer",ariaLabel:"Fermer"},"✕");r.append(o,a,i);const l=x("div",{className:"gemini-wrapper"},r);return t.append(l),{panel:r,tabbar:o,content:a,resizer:i,closeButton:s,wrapper:l}}function Ok(e){const{resizer:t,host:n,shadow:r,onWidthChange:o,initialWidth:a,minWidth:i,maxWidth:s}=e;let l=i,d=s;function c(){const v=Ve.detect(),_=Math.round(F.visualViewport?.width??F.innerWidth??0);if(v.platform==="mobile"||v.os==="ios"||v.os==="android"){const y=getComputedStyle(r.host),S=parseFloat(y.getPropertyValue("--inset-l"))||0,T=parseFloat(y.getPropertyValue("--inset-r"))||0,k=Math.max(280,_-Math.round(S+T));l=280,d=k;}else l=i,d=s;return {min:l,max:d}}function u(v){return Math.max(l,Math.min(d,Number(v)||a))}function p(v){const _=u(v);n.style.setProperty("--w",`${_}px`),o(_);}c();const f=Ve.detect(),g=!(f.platform==="mobile"||f.os==="ios"||f.os==="android");let m=false;const h=v=>{if(!m)return;v.preventDefault();const _=Math.round(F.innerWidth-v.clientX);p(_);},b=()=>{m&&(m=false,document.body.style.cursor="",F.removeEventListener("mousemove",h),F.removeEventListener("mouseup",b));},w=v=>{g&&(v.preventDefault(),m=true,document.body.style.cursor="ew-resize",F.addEventListener("mousemove",h),F.addEventListener("mouseup",b));};t.addEventListener("mousedown",w);function C(){t.removeEventListener("mousedown",w),F.removeEventListener("mousemove",h),F.removeEventListener("mouseup",b);}return {calculateResponsiveBounds:c,constrainWidthToLimits:u,setHudWidth:p,destroy:C}}function $k(e){const{panel:t,onToggle:n,onClose:r,toggleCombo:o=l=>l.ctrlKey&&l.shiftKey&&l.key.toLowerCase()==="u",closeOnEscape:a=true}=e;function i(l){const d=t.classList.contains("open");if(a&&l.key==="Escape"&&d){r();return}o(l)&&(l.preventDefault(),l.stopPropagation(),n());}document.addEventListener("keydown",i,{capture:true});function s(){document.removeEventListener("keydown",i,{capture:true});}return {destroy:s}}const Bk=`
@layer hud {
  /* Root container */
  .gemini-wrapper {
    position: relative;
...
`,s_={all:"initial",position:"fixed",top:"0",right:"0",zIndex:"2147483647",pointerEvents:"auto",fontFamily:'system-ui, -apple-system, "Segoe UI", Roboto, Inter, "Helvetica Neue", Arial, "Noto Sans", "Liberation Sans", sans-serif',fontSize:"13px",lineHeight:"1.35"};function l_(e="gemini-root"){const t=document.createElement("div");t.id=e,Object.assign(t.style,s_),(document.body||document.documentElement).appendChild(t);const n=t.attachShadow({mode:"open"});return {host:t,shadow:n}}function c_(){return new Promise(e=>{typeof requestIdleCallback<"u"?requestIdleCallback(()=>e(),{timeout:16}):setTimeout(e,0);})}async function d_(e){const{hostId:t="gemini-hud-root",initialWidth:n,initialOpen:r,onWidthChange:o,onOpenChange:a,themes:i,initialTheme:s,onThemeChange:l,buildSections:d,initialTab:c,onTabChange:u,toggleCombo:p=J=>J.ctrlKey&&J.shiftKey&&J.key.toLowerCase()==="u",closeOnEscape:f=true,minWidth:g=420,maxWidth:m=720}=e,{host:h,shadow:b}=l_(t),w=[[Dk,"variables"],[Gk,"primitives"],[zk,"utilities"],[Bk,"hud"],[Hk,"card"],[bl,"badge"],[jk,"button"],[Yk,"checkbox"],[Uk,"input"],[Wk,"label"],[Vk,"navTabs"],[Xk,"searchBar"],[qk,"select"],[Kk,"switch"],[Jk,"table"],[Qk,"teamListItem"],[Zk,"timeRangePicker"],[e_,"tooltip"],[t_,"slider"],[n_,"reorderableList"],[r_,"colorPicker"],[o_,"log"],[a_,"segmentedControl"],[i_,"settings"],[kf,"teamCard"],[Ju,"autoFavoriteSettings"]];for(let J=0;J<w.length;J++){const[V,pe]=w[J];ye(b,V,pe),J%5===4&&await c_();}const{panel:C,tabbar:v,content:_,resizer:y,closeButton:S,wrapper:T}=Nk({shadow:b,initialOpen:r});function k(J){C.dispatchEvent(new CustomEvent("gemini:hud-open-change",{detail:{isOpen:J},bubbles:true})),a?.(J);}function P(J){const V=C.classList.contains("open");C.classList.toggle("open",J),C.setAttribute("aria-hidden",J?"false":"true"),J!==V&&k(J);}P(r),S.addEventListener("click",J=>{J.preventDefault(),J.stopPropagation(),P(false);});const E=Qg({host:h,themes:i,initialTheme:s,onThemeChange:l}),B=Ok({resizer:y,host:h,shadow:b,onWidthChange:o||(()=>{}),initialWidth:n,minWidth:g,maxWidth:m});B.setHudWidth(n);const Z=d({applyTheme:E.applyTheme,initialTheme:s,getCurrentTheme:E.getCurrentTheme,setHUDWidth:B.setHudWidth,setHUDOpen:P}),H=new eg(Z,_,{applyTheme:E.applyTheme,getCurrentTheme:E.getCurrentTheme}),D=Z.map(J=>({id:J.id,label:J.label})),Y=c&&Z.some(J=>J.id===c)?c:D[0]?.id||"",O=Zf(D,Y,J=>{H.activate(J),u?.(J);});O.root.style.flex="1 1 auto",O.root.style.minWidth="0",v.append(O.root,S);const z={"tab-auto-favorite":"autoFavorite","tab-journal-checker":"journalChecker","tab-pets":"pets"};function G(){const J=ve(we.CONFIG,{autoFavorite:{enabled:true},journalChecker:{enabled:true},pets:{enabled:true}});for(const[V,pe]of Object.entries(z))J[pe]?.enabled??true?O.showTab(V):O.hideTab(V);}function $(J){const{key:V}=J.detail;(V===we.CONFIG||V==="feature:config")&&G();}window.addEventListener(Il.STORAGE_CHANGE,$),G();let A=Y;if(!O.isTabVisible(Y)){const J=O.getVisibleTabs();J.length>0&&(A=J[0]);}A&&H.activate(A);const R=$k({panel:C,onToggle:()=>P(!C.classList.contains("open")),onClose:()=>P(false),toggleCombo:p,closeOnEscape:f}),N=()=>{O.recalc();const J=parseInt(getComputedStyle(h).getPropertyValue("--w"))||n;B.calculateResponsiveBounds(),B.setHudWidth(J);};F.addEventListener("resize",N);const U=J=>{const V=J.detail?.width;V?B.setHudWidth(V):B.setHudWidth(n),O.recalc();};h.addEventListener("gemini:layout-resize",U);function xe(){window.removeEventListener(Il.STORAGE_CHANGE,$),R.destroy(),B.destroy(),F.removeEventListener("resize",N),h.removeEventListener("gemini:layout-resize",U);}return {host:h,shadow:b,wrapper:T,panel:C,content:_,setOpen:P,setWidth:B.setHudWidth,sections:Z,manager:H,nav:O,destroy:xe}}const lr={isOpen:"gemini.hud.isOpen",width:"gemini.hud.width",theme:"gemini.hud.theme",activeTab:"gemini.hud.activeTab"},Eo={isOpen:false,width:480,theme:"dark",activeTab:"tab-settings"};function u_(){return {isOpen:ve(lr.isOpen,Eo.isOpen),width:ve(lr.width,Eo.width),theme:ve(lr.theme,Eo.theme),activeTab:ve(lr.activeTab,Eo.activeTab)}}function Mo(e,t){Pe(lr[e],t);}const p_="https://i.imgur.com/IMkhMur.png",f_="Stats";function g_(e){let t=e.iconUrl||p_;const n=e.ariaLabel||"Open MGH";let r=null,o=null,a=null,i=false,s=null,l=null;const d=["Chat","Leaderboard","Stats","Open Activity Log"],c=C=>{try{return typeof CSS<"u"&&CSS&&typeof CSS.escape=="function"?CSS.escape(C):C.replace(/"/g,'\\"')}catch{return C}};function u(){const C=document.querySelector(d.map(_=>`button[aria-label="${c(_)}"]`).join(","));if(!C)return null;let v=C.parentElement;for(;v&&v!==document.body;){if(d.reduce((y,S)=>y+v.querySelectorAll(`button[aria-label="${c(S)}"]`).length,0)>=2)return v;v=v.parentElement;}return null}function f(C){const v=Array.from(C.querySelectorAll("button[aria-label]"));if(!v.length)return {refBtn:null,refWrapper:null};const _=v.filter(B=>B.dataset.mghBtn!=="true"&&(B.getAttribute("aria-label")||"")!==(e.ariaLabel||"Open MGH")),y=_.length?_:v,S=y.find(B=>(B.getAttribute("aria-label")||"").toLowerCase()===f_.toLowerCase())||null,T=y.length>=2?y.length-2:y.length-1,k=S||y[T],P=k.parentElement,E=P&&P.parentElement===C&&P.tagName==="DIV"?P:null;return {refBtn:k,refWrapper:E}}function g(C,v,_){const y=C.cloneNode(false);y.type="button",y.setAttribute("aria-label",v),y.title=v,y.dataset.mghBtn="true",y.style.pointerEvents="auto",y.removeAttribute("id");const S=document.createElement("img");return S.src=_,S.alt="MGH",S.style.pointerEvents="none",S.style.userSelect="none",S.style.width="76%",S.style.height="76%",S.style.objectFit="contain",S.style.display="block",S.style.margin="auto",y.appendChild(S),y.addEventListener("click",T=>{T.preventDefault(),T.stopPropagation();try{e.onClick?.();}catch{}}),y}function m(){if(i)return  false;i=true;let C=false;try{const v=u();if(!v)return !1;s!==v&&(s=v);const{refBtn:_,refWrapper:y}=f(v);if(!_)return !1;o=v.querySelector('div[data-mgh-wrapper="true"]'),!o&&y&&(o=y.cloneNode(!1),o.dataset.mghWrapper="true",o.removeAttribute("id"),C=!0);const S=o?.querySelector('button[data-mgh-btn="true"]')||null;r||(r=S),r||(r=g(_,n,t),o?o.appendChild(r):r.parentElement!==v&&v.appendChild(r),C=!0),o&&o.parentElement!==v&&(v.appendChild(o),C=!0);const T=v;if(T&&T!==l){try{w.disconnect();}catch{}l=T,w.observe(l,{childList:!0,subtree:!0});}return C}finally{i=false;}}const h=document.getElementById("App")||document.body;let b=null;const w=new MutationObserver(C=>{const v=C.every(y=>{const S=Array.from(y.addedNodes||[]),T=Array.from(y.removedNodes||[]),k=S.concat(T);if(k.length===0){const P=y.target;return o&&(P===o||o.contains(P))||r&&(P===r||r.contains(P))}return k.every(P=>!!(!(P instanceof HTMLElement)||o&&(P===o||o.contains(P))||r&&(P===r||r.contains(P))))}),_=C.some(y=>Array.from(y.removedNodes||[]).some(S=>S instanceof HTMLElement?!!(o&&(S===o||o.contains(S))||r&&(S===r||r.contains(S))):false));v&&!_||b===null&&(b=window.setTimeout(()=>{if(b=null,m()&&o){const S=o.parentElement;S&&S.lastElementChild!==o&&S.appendChild(o);}},150));});return m(),w.observe(h,{childList:true,subtree:true}),a=()=>w.disconnect(),()=>{try{a?.();}catch{}try{o?.remove();}catch{}}}const Ff=[];function m_(){return Ff.slice()}function h_(e){Ff.push(e);}function Nf(e){try{return JSON.parse(e)}catch{return}}function Kc(e){if(typeof e=="string"){const t=Nf(e);return t!==void 0?t:e}return e}function Of(e){if(e!=null){if(typeof e=="string"){const t=Nf(e);return t!==void 0?Of(t):e}if(Array.isArray(e)&&typeof e[0]=="string")return e[0];if(typeof e=="object"){const t=e;return t.type??t.Type??t.kind??t.messageType}}}function b_(e){const t=e?.MagicCircle_RoomConnection?.currentWebSocket;return t&&typeof t=="object"?t:null}function ne(e,t,n){const r=typeof t=="boolean"?t:true,o=typeof t=="function"?t:n,a=(i,s)=>{if(Of(i)!==e)return;const d=o(i,s);return d&&typeof d=="object"&&"kind"in d?d:typeof d=="boolean"?d?void 0:{kind:"drop"}:r?void 0:{kind:"drop"}};return h_(a),a}const Yn=new WeakSet,Yc=new WeakMap;function x_(e){const t=e.pageWindow,n=!!e.debug,r=e.middlewares&&e.middlewares.length?e.middlewares:m_();if(!r.length)return ()=>{};const o=p=>({ws:p,pageWindow:t,debug:n}),a=(p,f)=>{let g=p;for(const m of r){const h=m(g,o(f));if(h){if(h.kind==="drop")return {kind:"drop"};h.kind==="replace"&&(g=h.message);}}return g!==p?{kind:"replace",message:g}:void 0};let i=null,s=null,l=null;const d=()=>{const p=t?.MagicCircle_RoomConnection,f=p?.sendMessage;if(!p||typeof f!="function")return  false;if(Yn.has(f))return  true;const g=f.bind(p);function m(...h){const b=h.length===1?h[0]:h,w=Kc(b),C=a(w,b_(t));if(C?.kind==="drop"){n&&console.log("[WS] drop outgoing (RoomConnection.sendMessage)",w);return}if(C?.kind==="replace"){const v=C.message;return h.length>1&&Array.isArray(v)?(n&&console.log("[WS] replace outgoing (RoomConnection.sendMessage)",w,"=>",v),g(...v)):(n&&console.log("[WS] replace outgoing (RoomConnection.sendMessage)",w,"=>",v),g(v))}return g(...h)}Yn.add(m),Yc.set(m,f);try{p.sendMessage=m,Yn.add(p.sendMessage),n&&console.log("[WS] outgoing patched via MagicCircle_RoomConnection.sendMessage");}catch{return  false}return i=()=>{try{p.sendMessage===m&&(p.sendMessage=f);}catch{}},true};(()=>{const p=t?.WebSocket?.prototype,f=p?.send;if(typeof f!="function"||Yn.has(f))return;function g(m){const h=Kc(m),b=a(h,this);if(b?.kind==="drop"){n&&console.log("[WS] drop outgoing (ws.send)",h);return}if(b?.kind==="replace"){const w=b.message,C=typeof w=="string"||w instanceof ArrayBuffer||w instanceof Blob?w:JSON.stringify(w);return n&&console.log("[WS] replace outgoing (ws.send)",h,"=>",w),f.call(this,C)}return f.call(this,m)}Yn.add(g),Yc.set(g,f);try{p.send=g,n&&console.log("[WS] outgoing patched via WebSocket.prototype.send");}catch{return}s=()=>{try{p.send===g&&(p.send=f);}catch{}};})();const u=e.waitForRoomConnectionMs??4e3;if(!d()&&u>0){const p=Date.now();l=setInterval(()=>{if(d()){clearInterval(l),l=null;return}Date.now()-p>u&&(clearInterval(l),l=null,n&&console.log("[WS] RoomConnection not found, only ws.send is patched"));},250);}return ()=>{if(l){try{clearInterval(l);}catch{}l=null;}if(i){try{i();}catch{}i=null;}if(s){try{s();}catch{}s=null;}}}(function(){try{const t=({ url: (_documentCurrentScript && _documentCurrentScript.tagName.toUpperCase() === 'SCRIPT' && _documentCurrentScript.src || new URL('__entry.js', document.baseURI).href) }),n=t.glob?.("./**/*.ts",{eager:!0})??t.glob?.("./**/*.js",{eager:!0});if(!n)return}catch{}})();const $f=[];function y_(){return $f.slice()}function Jc(e){$f.push(e);}function v_(e){if(e!=null){if(typeof e=="object"){const t=e;if(typeof t.type=="string")return t.type;if(typeof t.Type=="string")return t.Type;if(typeof t.kind=="string")return t.kind;if(typeof t.messageType=="string")return t.messageType}if(Array.isArray(e)&&typeof e[0]=="string")return e[0]}}function w_(e){if(typeof e=="string")try{return JSON.parse(e)}catch{return e}return e}const mi=Symbol.for("ariesmod.ws.handlers.patched");function Ee(e,t){if(typeof e=="string"){const o=e,a={match:i=>i.kind==="message"&&i.type===o,handle:t};return Jc(a),a}const n=e,r={match:o=>o.kind==="close"&&o.code===n,handle:t};return Jc(r),r}function S_(e,t=y_(),n={}){const r=n.pageWindow??window,o=!!n.debug;if(e[mi])return ()=>{};e[mi]=true;const a={ws:e,pageWindow:r,debug:o},i=u=>{for(const p of t)try{if(!p.match(u))continue;if(p.handle(u,a)===!0)return}catch(f){o&&console.error("[WS] handler error",f,u);}},s=u=>{const p=w_(u.data),f=v_(p);i({kind:"message",raw:u.data,data:p,type:f});},l=u=>{i({kind:"close",code:u.code,reason:u.reason,wasClean:u.wasClean,event:u});},d=u=>i({kind:"open",event:u}),c=u=>i({kind:"error",event:u});return e.addEventListener("message",s),e.addEventListener("close",l),e.addEventListener("open",d),e.addEventListener("error",c),()=>{try{e.removeEventListener("message",s);}catch{}try{e.removeEventListener("close",l);}catch{}try{e.removeEventListener("open",d);}catch{}try{e.removeEventListener("error",c);}catch{}try{delete e[mi];}catch{}}}(function(){try{const t=({ url: (_documentCurrentScript && _documentCurrentScript.tagName.toUpperCase() === 'SCRIPT' && _documentCurrentScript.src || new URL('__entry.js', document.baseURI).href) }),n=t.glob?.("./**/*.ts",{eager:!0})??t.glob?.("./**/*.js",{eager:!0});if(!n)return}catch{}})();Ee(pt.AuthenticationFailure,(e,t)=>{t.debug&&console.log("[WS][Close] Auth failure",e.code,e.reason);});Ee(pt.ConnectionSuperseded,(e,t)=>{t.debug&&console.log("[WS][Close] Superseded",e.code,e.reason);});Ee(pt.HeartbeatExpired,(e,t)=>{t.debug&&console.log("[WS][Close] Heartbeat expired",e.code,e.reason);});Ee(pt.PlayerKicked,(e,t)=>{t.debug&&console.log("[WS][Close] Player kicked",e.code,e.reason);});Ee(pt.PlayerLeftVoluntarily,(e,t)=>{t.debug&&console.log("[WS][Close] Player left voluntarily",e.code,e.reason);});Ee(pt.ReconnectInitiated,(e,t)=>{t.debug&&console.log("[WS][Close] Reconnect initiated",e.code,e.reason);});Ee(pt.ServerDisposed,(e,t)=>{t.debug&&console.log("[WS][Close] Server disposed",e.code,e.reason);});Ee(pt.UserSessionSuperseded,(e,t)=>{t.debug&&console.log("[WS][Close] User session superseded",e.code,e.reason);});Ee(pt.VersionExpired,(e,t)=>{t.debug&&console.log("[WS][Close] Version expired",e.code,e.reason);});Ee(pt.VersionMismatch,(e,t)=>{t.debug&&console.log("[WS][Close] Version mismatch",e.code,e.reason);});Ee(_t.Config,(e,t)=>{t.debug&&console.log("[WS][STC] Config",e.data);});Ee(_t.CurrencyTransaction,(e,t)=>{t.debug&&console.log("[WS][STC] CurrencyTransaction",e.data);});Ee(_t.Emote,(e,t)=>{t.debug&&console.log("[WS][STC] Emote",e.data);});Ee(_t.InappropriateContentRejected,(e,t)=>{t.debug&&console.log("[WS][STC] InappropriateContentRejected",e.data);});Ee(_t.PartialState,(e,t)=>{t.debug&&console.log("[WS][STC] PartialState",e.data);});Ee(_t.Pong,(e,t)=>{t.debug&&console.log("[WS][STC] Pong",e.data);});Ee(_t.ServerErrorMessage,(e,t)=>{t.debug&&console.log("[WS][STC] ServerErrorMessage",e.data);});Ee(_t.Welcome,(e,t)=>{t.debug&&console.log("[WS][STC] Welcome",e.data);});ne(M.PlantSeed,(e,t)=>(t.debug&&console.log("[MW][Garden] PlantSeed"),true));ne(M.WaterPlant,(e,t)=>(t.debug&&console.log("[MW][Garden] WaterPlant"),true));ne(M.HarvestCrop,(e,t)=>(t.debug&&console.log("[MW][Garden] HarvestCrop"),true));ne(M.SellAllCrops,(e,t)=>(t.debug&&console.log("[MW][Garden] SellAllCrops"),true));ne(M.PurchaseSeed,(e,t)=>(t.debug&&console.log("[MW][Garden] PurchaseSeed"),true));ne(M.PurchaseEgg,(e,t)=>(t.debug&&console.log("[MW][Garden] PurchaseEgg"),true));ne(M.PurchaseTool,(e,t)=>(t.debug&&console.log("[MW][Garden] PurchaseTool"),true));ne(M.PurchaseDecor,(e,t)=>(t.debug&&console.log("[MW][Garden] PurchaseDecor"),true));ne(M.PlantEgg,(e,t)=>(t.debug&&console.log("[MW][Garden] PlantEgg"),true));ne(M.HatchEgg,(e,t)=>(t.debug&&console.log("[MW][Garden] HatchEgg"),true));ne(M.PlantGardenPlant,(e,t)=>(t.debug&&console.log("[MW][Garden] PlantGardenPlant"),true));ne(M.PotPlant,(e,t)=>(t.debug&&console.log("[MW][Garden] PotPlant"),true));ne(M.MutationPotion,(e,t)=>(t.debug&&console.log("[MW][Garden] MutationPotion"),true));ne(M.PickupDecor,(e,t)=>(t.debug&&console.log("[MW][Garden] PickupDecor"),true));ne(M.PlaceDecor,(e,t)=>(t.debug&&console.log("[MW][Garden] PlaceDecor"),true));ne(M.RemoveGardenObject,(e,t)=>(t.debug&&console.log("[MW][Garden] RemoveGardenObject"),true));ne(M.MoveInventoryItem,(e,t)=>(t.debug&&console.log("[MW][Inventory] MoveInventoryItem"),true));ne(M.DropObject,(e,t)=>(t.debug&&console.log("[MW][Inventory] DropObject"),true));ne(M.PickupObject,(e,t)=>(t.debug&&console.log("[MW][Inventory] PickupObject"),true));ne(M.ToggleFavoriteItem,(e,t)=>(t.debug&&console.log("[MW][Inventory] ToggleFavoriteItem"),true));ne(M.PutItemInStorage,(e,t)=>(t.debug&&console.log("[MW][Inventory] PutItemInStorage"),true));ne(M.RetrieveItemFromStorage,(e,t)=>(t.debug&&console.log("[MW][Inventory] RetrieveItemFromStorage"),true));ne(M.MoveStorageItem,(e,t)=>(t.debug&&console.log("[MW][Inventory] MoveStorageItem"),true));ne(M.LogItems,(e,t)=>(t.debug&&console.log("[MW][Inventory] LogItems"),true));ne(M.PlacePet,(e,t)=>(t.debug&&console.log("[MW][Pets] PlacePet"),true));ne(M.FeedPet,(e,t)=>(t.debug&&console.log("[MW][Pets] FeedPet"),true));ne(M.PetPositions,(e,t)=>(t.debug&&console.log("[MW][Pets] PetPositions"),true));ne(M.SwapPet,(e,t)=>(t.debug&&console.log("[MW][Pets] SwapPet"),true));ne(M.StorePet,(e,t)=>(t.debug&&console.log("[MW][Pets] StorePet"),true));ne(M.NamePet,(e,t)=>(t.debug&&console.log("[MW][Pets] NamePet"),true));ne(M.SellPet,(e,t)=>(t.debug&&console.log("[MW][Pets] SellPet"),true));console.log("[WS] TESTTEST");ne(M.SetSelectedGame,(e,t)=>(t.debug&&console.log("[MW][Session] SetSelectedGame"),true));ne(M.VoteForGame,(e,t)=>(t.debug&&console.log("[MW][Session] VoteForGame"),true));ne(M.RequestGame,(e,t)=>(t.debug&&console.log("[MW][Session] RequestGame"),true));ne(M.RestartGame,(e,t)=>(t.debug&&console.log("[MW][Session] RestartGame"),true));ne(M.Ping,(e,t)=>(t.debug&&console.log("[MW][Session] Ping"),true));ne(M.PlayerPosition,(e,t)=>(t.debug&&console.log("[MW][Session] PlayerPosition"),true));ne(M.Teleport,(e,t)=>(t.debug&&console.log("[MW][Session] Teleport"),true));ne(M.CheckWeatherStatus,(e,t)=>(t.debug&&console.log("[MW][Session] CheckWeatherStatus"),true));ne(M.Chat,(e,t)=>(t.debug&&console.log("[MW][Social] Chat"),true));ne(M.Dev,(e,t)=>(t.debug&&console.log("[MW][Social] Dev"),true));ne(M.Emote,(e,t)=>(t.debug&&console.log("[MW][Social] Emote"),true));ne(M.Wish,(e,t)=>(t.debug&&console.log("[MW][Social] Wish"),true));ne(M.KickPlayer,(e,t)=>(t.debug&&console.log("[MW][Social] KickPlayer"),true));ne(M.ReportSpeakingStart,(e,t)=>(t.debug&&console.log("[MW][Voice] ReportSpeakingStart"),true));ne(M.SetPlayerData,(e,t)=>(t.debug&&console.log("[MW][Social] SetPlayerData"),true));ne(M.UsurpHost,(e,t)=>(t.debug&&console.log("[MW][Social] UsurpHost"),true));function C_(e={}){const t=e.pageWindow??F,n=e.pollMs??500,r=!!e.debug,o=[];o.push(aw(t,{debug:r})),o.push(x_({pageWindow:t,middlewares:e.middlewares,debug:r}));let a=null;const i=s=>{if(a){try{a();}catch{}a=null;}s&&(a=S_(s,e.handlers,{debug:r,pageWindow:t}));};return i(oa(t).ws),o.push(ap(s=>i(s.ws),{intervalMs:n,debug:r,pageWindow:t})),{getWs:()=>oa(t).ws,dispose:()=>{for(let s=o.length-1;s>=0;s--)try{o[s]();}catch{}if(a){try{a();}catch{}a=null;}}}}let Ro=null;function k_(e={}){return Ro||(Ro=C_(e),Ro)}function __(e,t){const n=new MutationObserver(o=>{for(const a of o)for(const i of a.addedNodes){if(!(i instanceof Element))continue;i.matches(e)&&t(i);const s=i.querySelectorAll(e);for(const l of s)t(l);}});n.observe(document.body,{childList:true,subtree:true});const r=document.querySelectorAll(e);for(const o of r)t(o);return {disconnect:()=>n.disconnect()}}function T_(e,t){const n=new MutationObserver(r=>{for(const o of r)for(const a of o.removedNodes){if(!(a instanceof Element))continue;a.matches(e)&&t(a);const i=a.querySelectorAll(e);for(const s of i)t(s);}});return n.observe(document.body,{childList:true,subtree:true}),{disconnect:()=>n.disconnect()}}const Bf=768,Qc=6,hi=62,bi=50,P_=.5,I_=.4,Lo=36,Fo=28,A_=6,ts=4,E_=8,M_=100,R_=200,Zc=14,ed=3,L_=40,F_=50,td=2147483646,cr="gemini-bulk-favorite-sidebar",N_="gemini-bulk-favorite-top-row",O_="gemini-bulk-favorite-bottom-row",ns="gemini-qol-bulkFavorite-styles",$_=`
...
`,B_='<svg width="12" height="12" viewBox="0 0 24 24" fill="currentColor"><path d="M12 21.35l-1.45-1.32C5.4 15.36 2 12.28 2 8.5 2 5.42 4.42 3 7.5 3c1.74 0 3.41.81 4.5 2.09C13.09 3.81 14.76 3 16.5 3 19.58 3 22 5.42 22 8.5c0 3.78-3.4 6.86-8.55 11.54L12 21.35z"/></svg>',D_='<svg width="12" height="12" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><path d="M12 21.35l-1.45-1.32C5.4 15.36 2 12.28 2 8.5 2 5.42 4.42 3 7.5 3c1.74 0 3.41.81 4.5 2.09C13.09 3.81 14.76 3 16.5 3 19.58 3 22 5.42 22 8.5c0 3.78-3.4 6.86-8.55 11.54L12 21.35z"/></svg>';function G_(e){const{species:t,itemCount:n,isFavorited:r,isMobile:o,onClick:a}=e,i=x("button",{className:`gemini-qol-bulkFavorite-btn${o?" mobile":""}`,title:`${r?"Unfavorite":"Favorite"} all ${n} ${t}`});return i.dataset.species=t,i.appendChild(z_(t,o)),i.appendChild(H_(r)),i.appendChild(j_(t)),i.addEventListener("click",async s=>{s.preventDefault(),s.stopPropagation(),a();}),i}function z_(e,t){try{if(!j.isReady()||!j.has("plant",e))return nd(e);const n=t?I_:P_,r=j.toCanvas("plant",e,{scale:n});return r.className="gemini-qol-bulkFavorite-sprite",r}catch(n){return console.warn(`[BulkFavorite] Failed to load sprite for ${e}:`,n),nd(e)}}function nd(e){return x("div",{className:"gemini-qol-bulkFavorite-fallback"},e.charAt(0).toUpperCase())}function H_(e){const t=x("span",{className:`gemini-qol-bulkFavorite-heart ${e?"filled":"outline"}`});return t.innerHTML=e?B_:D_,t}function j_(e){return x("span",{className:"gemini-qol-bulkFavorite-label"},e)}let ht=null,bt=null,mt=null,Xo=false,Sr=null,dr=false,_n=null;const rs=[];function No(e){rs.push(e);}function U_(){for(const e of rs)try{e();}catch(t){console.warn("[BulkFavorite] Cleanup error:",t);}rs.length=0;}function Df(){return window.innerWidth<=Bf}function W_(e){return new Promise(t=>setTimeout(t,e))}function Gf(){if(Xo)return;if(document.getElementById(ns)){Xo=true;return}const e=document.createElement("style");e.id=ns,e.textContent=$_,document.head.appendChild(e),Xo=true;}function V_(){document.getElementById(ns)?.remove(),Xo=false;}function X_(){const e=sn().get();if(!e?.items)return [];const t=new Set(e.favoritedItemIds??[]),n=new Map;for(const o of e.items){const a=o;if(a.itemType!=="Produce")continue;const i=a.species,s=a.id;if(!i||!s)continue;const l=n.get(i);l?l.push(s):n.set(i,[s]);}const r=[];for(const[o,a]of n){const i=a.length>0&&a.every(s=>t.has(s));r.push({species:o,itemIds:a,allFavorited:i});}return r.sort((o,a)=>o.species.localeCompare(a.species)),r}async function q_(e){const t=sn().get();if(!t?.items)return;const n=new Set(t.favoritedItemIds??[]),r=[];for(const i of t.items){const s=i;if(s.itemType!=="Produce"||s.species!==e)continue;const l=s.id;l&&r.push({id:l,favorited:n.has(l)});}if(r.length===0)return;const o=r.every(i=>i.favorited),a=o?r.filter(i=>i.favorited):r.filter(i=>!i.favorited);console.log(`🔄 [BulkFavorite] ${o?"Unfavoriting":"Favoriting"} ${a.length}/${r.length} ${e}`);for(const i of a)Ia(i.id),await W_(L_);}function os(e,t){const{species:n,itemIds:r,allFavorited:o}=e;return G_({species:n,itemCount:r.length,isFavorited:o,isMobile:t,onClick:()=>q_(n)})}function K_(e){const t=x("div",{id:cr}),n=e.getBoundingClientRect(),r=Math.max(window.innerHeight-M_,R_);return t.style.maxHeight=`${r}px`,t.style.position="fixed",t.style.left=`${n.right+E_}px`,t.style.top=`${n.top}px`,t}function rd(e,t,n){const r=x("div",{id:e,className:"gemini-qol-bulkFavorite-row"}),o=t.getBoundingClientRect();return n==="top"?r.style.bottom=`${window.innerHeight-o.top+ts}px`:r.style.top=`${o.bottom+ts}px`,r.style.left=`${o.left}px`,r.style.maxWidth=`${o.width}px`,r}function od(){const e=X_();Df()?J_(e):Y_(e);}function Y_(e){if(ht){if(ht.innerHTML="",e.length===0){ht.style.display="none";return}ht.style.display="flex";for(const t of e)ht.appendChild(os(t,false));console.log(`🎯 [BulkFavorite] Desktop: Rendered ${e.length} produce types`);}}function J_(e){if(!bt||!mt)return;if(bt.innerHTML="",mt.innerHTML="",e.length===0){bt.style.display="none",mt.style.display="none";return}bt.style.display="flex";const t=e.slice(0,Qc),n=e.slice(Qc);for(const r of t)bt.appendChild(os(r,true));if(n.length>0){mt.style.display="flex";for(const r of n)mt.appendChild(os(r,true));}else mt.style.display="none";console.log(`🎯 [BulkFavorite] Mobile: Rendered ${e.length} types`);}function Q_(){const e=document.querySelector(".McGrid");if(!e)return console.log("⚠️ [BulkFavorite] No .McGrid found"),null;const t=e.getBoundingClientRect();if(window.innerWidth<=Bf)return console.log(`🎯 [BulkFavorite] Mobile mode - using McGrid: ${Math.round(t.width)}x${Math.round(t.height)}`),e;const r=window.innerWidth/2;let o=null,a=0;const i=e.querySelectorAll(".McFlex, .McGrid");for(const s of i){const l=s.getBoundingClientRect();if(l.width<200||l.height<200||l.width>window.innerWidth-100)continue;const d=l.left+l.width/2,c=1-Math.abs(d-r)/r,p=l.width*l.height*c;p>a&&(o=s,a=p);}if(o){const s=o.getBoundingClientRect();return console.log(`🎯 [BulkFavorite] Found desktop container: ${Math.round(s.width)}x${Math.round(s.height)} @ (${Math.round(s.left)}, ${Math.round(s.top)})`),o}return console.log(`🎯 [BulkFavorite] Fallback to McGrid: ${Math.round(t.width)}x${Math.round(t.height)}`),e}let Tn=null;function as(){Tn&&clearTimeout(Tn),Tn=setTimeout(()=>{Z_();},F_);}function Z_(){const e=Q_();if(!e)return;console.log("🎯 [BulkFavorite] Found inventory modal container"),Cr(),Gf(),Sr=e,Df()?(bt=rd(N_,e,"top"),mt=rd(O_,e,"bottom"),document.body.appendChild(bt),document.body.appendChild(mt)):(ht=K_(e),document.body.appendChild(ht)),od(),_n&&_n(),_n=sn().subscribeFavorites(()=>{dr&&od();});}function Cr(){Tn&&(clearTimeout(Tn),Tn=null),_n&&(_n(),_n=null),ht?.remove(),ht=null,bt?.remove(),bt=null,mt?.remove(),mt=null,Sr=null;}function eT(){Cr();}async function is(){if(!qr().enabled){console.log("⚠️ [BulkFavorite] Feature disabled");return}Gf();const t=await _s.onChangeNow(o=>{const a=o==="inventory";a!==dr&&(dr=a,a?as():Cr());}),n=__(".McGrid",()=>{dr&&(ht||bt||as());}),r=T_(".McGrid",o=>{Sr&&Sr===o&&Cr();});No(()=>t()),No(()=>n.disconnect()),No(()=>r.disconnect()),No(()=>{Cr(),dr=false,Sr=null;}),console.log("✅ [BulkFavorite] Started (State-driven + DOM observation)");}function ss(){U_(),V_(),console.log("🛑 [BulkFavorite] Stopped");}function tT(e){const t=qr();t.enabled=e,e?is():ss();}let Oo=false;const nT={init(){Oo||(is(),Oo=true);},destroy(){Oo&&(ss(),Oo=false);},isEnabled(){return Cp()},renderButton:as,removeButton:eT,startWatching:is,stopWatching:ss,setEnabled:tT};function rT(e){e.logStep("WebSocket","Capturing WebSocket...");let t=null;return t=ap(n=>{n.ws&&(e.logStep("WebSocket","WebSocket captured","success"),t?.(),t=null);},{intervalMs:250}),k_({debug:false}),()=>{t?.(),t=null;}}async function oT(e){e.logStep("Atoms","Prewarming Jotai store...");try{await sx(),await rx({timeoutMs:8e3,intervalMs:50}),e.logStep("Atoms","Jotai store ready","success");}catch(t){e.logStep("Atoms","Jotai store not captured yet","error"),console.warn("[Bootstrap] Jotai store wait failed",t);}}function aT(e){e.logStep("Globals","Initializing global variables...");try{rp(),e.logStep("Globals","Global variables ready","success");}catch(t){e.logStep("Globals","Failed to initialize global variables","error"),console.warn("[Bootstrap] Global variables init failed",t);}}function iT(e){e.logStep("API","Exposing Gemini API...");try{Mk(),e.logStep("API","Gemini API ready","success");}catch(t){e.logStep("API","Failed to expose API","error"),console.warn("[Bootstrap] API init failed",t);}}function xi(){return new Promise(e=>{typeof requestIdleCallback<"u"?requestIdleCallback(()=>e(),{timeout:50}):setTimeout(e,0);})}async function sT(e){e.logStep("HUD","Loading HUD preferences..."),await xi();const t=u_();await xi();const n=await d_({hostId:"gemini-hud-root",initialWidth:t.width,initialOpen:t.isOpen,onWidthChange:r=>Mo("width",r),onOpenChange:r=>Mo("isOpen",r),themes:pr,initialTheme:t.theme,onThemeChange:r=>Mo("theme",r),buildSections:r=>Lk({applyTheme:r.applyTheme,initialTheme:r.initialTheme,getCurrentTheme:r.getCurrentTheme,setHUDWidth:r.setHUDWidth,setHUDOpen:r.setHUDOpen}),initialTab:t.activeTab,onTabChange:r=>Mo("activeTab",r)});return await xi(),e.logStep("HUD","HUD ready","success"),n}async function lT(e){e.setSubtitle("Activating Gemini modules...");const t=7;let n=0;await Yu(r=>{r.status==="success"?(n++,e.logStep("Modules",`Loading modules... (${n}/${t})`)):r.status==="error"&&e.logStep("Modules",`Loading modules... (${n}/${t}) - ${r.name} failed`,"error");}),e.logStep("Modules",`All modules loaded (${t}/${t})`,"success");}async function cT(e){try{j.isReady()||await j.init(),K.resolveSprites();const t=[],n=K.get("plants");if(n)for(const l of Object.values(n))l?.seed?.spriteId&&t.push(l.seed.spriteId),l?.plant?.spriteId&&t.push(l.plant.spriteId),l?.crop?.spriteId&&t.push(l.crop.spriteId);const r=K.get("pets");if(r)for(const l of Object.values(r))l?.spriteId&&t.push(l.spriteId);const o=K.get("items");if(o)for(const l of Object.values(o))l?.spriteId&&t.push(l.spriteId);const a=K.get("eggs");if(a)for(const l of Object.values(a))l?.spriteId&&t.push(l.spriteId);const i=K.get("decor");if(i)for(const l of Object.values(i))l?.spriteId&&t.push(l.spriteId);const s=[...new Set(t)];s.length>0&&await j.warmup(s,()=>{},5);}catch(t){console.warn("[Bootstrap] Sprite warmup failed",t);}}async function dT(e){e.logStep("Sections","Preloading UI sections...");try{await Fk(),e.logStep("Sections","Sections preloaded","success");}catch(t){e.logStep("Sections","Sections preload failed","error"),console.warn("[Bootstrap] Sections preload failed",t);}}function uT(e){e.logStep("Features","Initializing features...");const t=[{name:"AntiAfk",init:Jt.init.bind(Jt)},{name:"PetTeam",init:ae.init.bind(ae)},{name:"BulkFavorite",init:aa.init.bind(aa)},{name:"XPTracker",init:sa.init.bind(sa)},{name:"CropValueIndicator",init:vr.init.bind(vr)},{name:"CropSizeIndicator",init:wr.init.bind(wr)},{name:"ShopNotifier",init:tn.init.bind(tn)}];let n=0;for(const r of t)try{r.init(),n++,e.logStep("Features",`Initializing features... (${n}/${t.length})`,"info");}catch(o){e.logStep("Features",`Initializing features... (${n}/${t.length}) - ${r.name} failed`,"error"),console.warn(`[Bootstrap] Feature ${r.name} init failed`,o);}e.logStep("Features",`All features initialized (${t.length}/${t.length})`,"success"),e.logStep("Injections","Initializing QOL injections...");try{const r=bd();r.register({id:"bulkFavoriteInject",name:"Bulk Favorite Inject",description:"Quick favorite/unfavorite multiple mutations",injection:nT,storageKey:we.BULK_FAVORITE,defaultEnabled:!1}),r.register({id:"cropValueIndicator",name:"Crop Price",description:"Shows coin value in crop tooltips",injection:vr.render,storageKey:we.CROP_VALUE_INDICATOR,defaultEnabled:!1}),r.register({id:"cropSizeIndicator",name:"Crop Size",description:"Shows size percentage in crop tooltips",injection:wr.render,storageKey:we.CROP_SIZE_INDICATOR,defaultEnabled:!1}),r.initAll(),e.logStep("Injections","QOL injections registered and initialized","success");}catch(r){e.logStep("Injections","QOL injections initialization failed","error"),console.warn("[Bootstrap] Injections init failed",r);}}Ed();Zb();(async function(){sg();const e=Jf({title:"Gemini is loading",subtitle:"Connecting and preparing modules..."});let t=null;try{t=rT(e),await oT(e),aT(e),iT(e),await lT(e),await Promise.all([(async()=>{uT(e);})(),(async()=>{await cT(e);})()]),await dT(e),e.succeed("Gemini is ready!");}catch(r){e.fail("Failed to initialize the mod.",r);}finally{t?.();}const n=await sT(e);g_({onClick:()=>n.setOpen(true)});})();
