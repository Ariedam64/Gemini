...
`)}var Jo,Ue,Je,Xo=G(()=>{"use strict";Ze();fn();Jo=null,Ue={ready:!1,xform:null,xformAt:0};Je={init:gy,ready:()=>Ue.ready,hook:fy,engine:()=>Ia(),tos:()=>Rn(),gidx:(e,t)=>Ea(Number(e),Number(t)),getTileObject:Yo,inspect:Sy,setTileEmpty:by,setTilePlant:hy,setTileDecor:yy,setTileEgg:vy,setTileObjectRaw:xy,rebuildTransform:nc,pointToTile:wy,help:Ty}});function Qo(e,t,n){return e+(t-e)*n}function ky(e,t,n){let r=e>>16&255,o=e>>8&255,a=e&255,i=t>>16&255,s=t>>8&255,u=t&255,d=Qo(r,i,n)|0,l=Qo(o,s,n)|0,c=Qo(a,u,n)|0;return d<<16|l<<8|c}function Cy(e,t=900){let n=[],r=[e];for(;r.length&&n.length<t;){let o=r.pop();if(!o)continue;Zo(o)&&n.push(o);let a=o.children;if(Array.isArray(a))for(let i=a.length-1;i>=0;i--)r.push(a[i])}return n}function Py(e,t=25e3){let n=[],r=[e],o=0;for(;r.length&&o++<t;){let a=r.pop();if(!a)continue;kt(a)&&n.push(a);let i=a.children;if(Array.isArray(i))for(let s=i.length-1;s>=0;s--)r.push(i[s])}return n}function oc(e){if(!Array.isArray(e))return[];let t=new Set,n=[];for(let r of e){let o,a;if(Array.isArray(r))o=r[0],a=r[1];else if(Ha(r))o=r.x??r.tx,a=r.y??r.ty;else continue;if(o=Number(o),a=Number(a),!Number.isFinite(o)||!Number.isFinite(a))continue;o|=0,a|=0;let i=`${o},${a}`;t.has(i)||(t.add(i),n.push({x:o,y:a}))}return n}function My(e,t){let n=String(e||"").trim();if(!n)throw new Error("MGPixi.defineTileSet: empty name");let r=oc(t);return U.tileSets.set(n,r),{ok:!0,name:n,count:r.length}}function Ay(e){return U.tileSets.delete(String(e||"").trim())}function Iy(){return Array.from(U.tileSets.keys()).sort((e,t)=>e.localeCompare(t))}function rc(e){return!!(e&&(e.tileSet!=null||Array.isArray(e.tiles)))}function Na(e){let n=Je.tos?.()?.tileViews;if(!n?.entries)throw new Error("MGPixi: TOS.tileViews not found");if(!rc(e))return{entries:Array.from(n.entries()),gidxSet:null};let r=[];if(e.tileSet!=null){let a=String(e.tileSet||"").trim(),i=U.tileSets.get(a);if(!i)throw new Error(`MGPixi: tileSet not found "${a}"`);r=i}else r=oc(e.tiles||[]);let o=new Map;for(let a of r){let i=Je.getTileObject(a.x,a.y,{ensureView:!0,clone:!1});i?.tileView&&i.gidx!=null&&o.set(i.gidx,i.tileView)}return{entries:Array.from(o.entries()),gidxSet:new Set(o.keys())}}function _a(e){let t=U.highlights.get(e);if(!t)return!1;Ae(()=>U.ticker?.remove(t.tick)),t.root&&t.baseAlpha!=null&&kt(t.root)&&Ae(()=>{t.root.alpha=t.baseAlpha});for(let n of t.tint)n.o&&Zo(n.o)&&Ae(()=>{n.o.tint=n.baseTint});return U.highlights.delete(e),!0}function ac(e=null){for(let t of Array.from(U.highlights.keys()))e&&!String(t).startsWith(e)||_a(t);return!0}function ic(e,t={}){if(Ct(),!Da(e))throw new Error("MGPixi.highlightPulse: invalid root");let n=String(t.key||`hl:${Math.random().toString(16).slice(2)}`);if(U.highlights.has(n))return n;let r=kt(e)?Number(e.alpha):null,o=Re(Number(t.minAlpha??.12),0,1),a=Re(Number(t.maxAlpha??1),0,1),i=Number(t.speed??1.25),s=(t.tint??8386303)>>>0,u=Re(Number(t.tintMix??.85),0,1),d=t.deepTint!==!1,l=[];if(d)for(let m of Cy(e))l.push({o:m,baseTint:m.tint});else Zo(e)&&l.push({o:e,baseTint:e.tint});let c=performance.now(),p=()=>{let m=(performance.now()-c)/1e3,g=(Math.sin(m*Math.PI*2*i)+1)/2,f=g*g*(3-2*g);r!=null&&kt(e)&&(e.alpha=Re(Qo(o,a,f)*r,0,1));let h=f*u;for(let b of l)b.o&&Zo(b.o)&&(b.o.tint=ky(b.baseTint,s,h))};return U.ticker?.add(p),U.highlights.set(n,{root:e,tick:p,baseAlpha:r,tint:l}),n}function Ra(e){if(!e)return null;if(Da(e))return e;if(!Ha(e))return null;for(let t of Ey){let n=e[t];if(Da(n))return n}return null}function Ly(e,t){let n=[{o:e,d:0}],r=new Set,o=6;for(;n.length;){let{o:a,d:i}=n.shift();if(!(!a||i>o)&&!r.has(a)){if(r.add(a),Array.isArray(a)){if(a.length===t){let s=new Array(t),u=!0;for(let d=0;d<t;d++){let l=Ra(a[d]);if(!l){u=!1;break}s[d]=l}if(u)return s}for(let s of a)n.push({o:s,d:i+1});continue}if(Ha(a)){let s=a;for(let u of Object.keys(s))n.push({o:s[u],d:i+1})}}}return null}function Dy(e,t){let n=e?.mutations;if(!Array.isArray(n))return!1;for(let r of n)if(String(r||"").toLowerCase()===t)return!0;return!1}function sc(e,t={}){Ct();let n=String(e||"").trim().toLowerCase();if(!n)throw new Error("MGPixi.highlightMutation: empty mutation");let{entries:r,gidxSet:o}=Na(t),a=`hlmut:${n}:`;if(t.clear===!0)if(!o)ac(a);else for(let c of Array.from(U.highlights.keys())){if(!c.startsWith(a))continue;let p=c.split(":"),m=Number(p[2]);o.has(m)&&_a(c)}let i={tint:(t.tint??8386303)>>>0,minAlpha:Number(t.minAlpha??.12),maxAlpha:Number(t.maxAlpha??1),speed:Number(t.speed??1.25),tintMix:Number(t.tintMix??.85),deepTint:t.deepTint!==!1},s=0,u=0,d=0,l=0;for(let[c,p]of r){let m=p?.tileObject;if(!m||m.objectType!=="plant")continue;let g=m.slots;if(!Array.isArray(g)||g.length===0)continue;let f=!1,h=[];for(let S=0;S<g.length;S++)Dy(g[S],n)&&(h.push(S),f=!0);if(!f)continue;s++,u+=h.length;let b=p?.childView?.plantVisual||p?.childView||p,T=Ly(b,g.length);if(!T){l+=h.length;continue}for(let S of h){let v=T[S];if(!v){l++;continue}let k=`${a}${c}:${S}`;U.highlights.has(k)||(ic(v,{key:k,...i}),d++)}}return{ok:!0,mutation:n,filtered:!!o,plantsMatched:s,matchedSlots:u,newHighlights:d,failedSlots:l}}function Ry(e,t={}){Ct();let n=String(e||"").trim().toLowerCase();if(!n)throw new Error("MGPixi.watchMutation: empty mutation");let r=`watchmut:${n}:${t.tileSet?`set:${t.tileSet}`:t.tiles?"tiles":"all"}`,o=Number.isFinite(t.intervalMs)?t.intervalMs:1e3,a=U.watches.get(r);a&&clearInterval(a);let i=setInterval(()=>{Ae(()=>sc(n,{...t,clear:!1}))},o);return U.watches.set(r,i),{ok:!0,key:r,mutation:n,intervalMs:o}}function Oy(e){let t=String(e||"").trim();if(!t)return!1;if(!t.startsWith("watchmut:")){let r=t.toLowerCase(),o=0;for(let[a,i]of Array.from(U.watches.entries()))a.startsWith(`watchmut:${r}:`)&&(clearInterval(i),U.watches.delete(a),o++);return o>0}let n=U.watches.get(t);return n?(clearInterval(n),U.watches.delete(t),!0):!1}function Gy(e){let t=Array.isArray(e?.slots)?e.slots:[];return{objectType:"plant",species:e?.species??null,plantedAt:e?.plantedAt??null,maturedAt:e?.maturedAt??null,slotCount:t.length,slots:t.map((n,r)=>({idx:r,mutations:Array.isArray(n?.mutations)?n.mutations.slice():[]}))}}function Hy(e,t,n={}){Ct();let r=Number(e)|0,o=Number(t)|0,a=n.ensureView!==!1,i=Je.getTileObject(r,o,{ensureView:a,clone:!1}),s=i?.tileView||null,u=s?.tileObject,d={ok:!0,tx:r,ty:o,gidx:i?.gidx??Je.gidx?.(r,o)??null,hasTileView:!!s,objectType:u?.objectType??null,tileObject:u??null,summary:u?.objectType==="plant"?Gy(u):u?{objectType:u.objectType??null}:null,display:s?s.childView?.plantVisual||s.childView||s.displayObject||s:null};return n.log!==!1&&Ae(()=>console.log("[MGPixi.inspectTile]",d)),d}function Ny(e){let t=e?.childView?.plantVisual||e?.childView?.cropVisual||e?.childView||e?.displayObject||e;return Ra(t)||Ra(e?.displayObject)||null}function lc(e){let t=U.fades.get(e);if(!t)return!1;for(let n of t.targets)n.o&&kt(n.o)&&Number.isFinite(n.baseAlpha)&&Ae(()=>{n.o.alpha=n.baseAlpha});return U.fades.delete(e),!0}function Oa(e=null){for(let t of Array.from(U.fades.keys()))e&&!String(t).startsWith(e)||lc(t);return!0}function cc(e,t={}){Ct();let n=String(e||"").trim().toLowerCase();if(!n)throw new Error("MGPixi.clearSpeciesFade: empty species");let r=`fade:${n}:`;if(!rc(t))return Oa(r);let{gidxSet:o}=Na(t);if(!o)return Oa(r);for(let a of Array.from(U.fades.keys())){if(!a.startsWith(r))continue;let i=Number(a.slice(r.length));o.has(i)&&lc(a)}return!0}function uc(e,t={}){Ct();let n=String(e||"").trim().toLowerCase();if(!n)throw new Error("MGPixi.fadeSpecies: empty species");let r=Re(Number(t.alpha??.2),0,1),o=t.deep===!0,{entries:a,gidxSet:i}=Na(t),s=`fade:${n}:`;t.clear===!0&&cc(n,t);let u=0,d=0,l=0,c=0;for(let[p,m]of a){let g=m?.tileObject;if(!g||g.objectType!=="plant")continue;u++;let f=String(g.species||"").trim().toLowerCase();if(!f||f!==n)continue;d++;let h=Ny(m);if(!h||!kt(h)){c++;continue}let b=`${s}${p}`;if(U.fades.has(b)){Ae(()=>{h.alpha=r}),l++;continue}let T=o?Py(h):[h],S=[];for(let v of T)kt(v)&&S.push({o:v,baseAlpha:Number(v.alpha)});for(let v of S)Ae(()=>{v.o.alpha=r});U.fades.set(b,{targets:S}),l++}return{ok:!0,species:n,alpha:r,deep:o,filtered:!!i,plantsSeen:u,matchedPlants:d,applied:l,failed:c,totalFades:U.fades.size}}function _y(e,t={}){Ct();let n=String(e||"").trim().toLowerCase();if(!n)throw new Error("MGPixi.watchFadeSpecies: empty species");let r=`watchfade:${n}:${t.tileSet?`set:${t.tileSet}`:t.tiles?"tiles":"all"}`,o=Number.isFinite(t.intervalMs)?t.intervalMs:1e3,a=U.fadeWatches.get(r);a&&clearInterval(a);let i=setInterval(()=>{Ae(()=>uc(n,{...t,clear:!1}))},o);return U.fadeWatches.set(r,i),{ok:!0,key:r,species:n,intervalMs:o}}function Wy(e){let t=String(e||"").trim();if(!t)return!1;if(!t.startsWith("watchfade:")){let r=t.toLowerCase(),o=0;for(let[a,i]of Array.from(U.fadeWatches.entries()))a.startsWith(`watchfade:${r}:`)&&(clearInterval(i),U.fadeWatches.delete(a),o++);return o>0}let n=U.fadeWatches.get(t);return n?(clearInterval(n),U.fadeWatches.delete(t),!0):!1}function Ga(){let e=A;return e.$PIXI=e.PIXI||null,e.$app=U.app||null,e.$renderer=U.renderer||null,e.$stage=U.stage||null,e.$ticker=U.ticker||null,e.__MG_PIXI__={PIXI:e.$PIXI,app:e.$app,renderer:e.$renderer,stage:e.$stage,ticker:e.$ticker,ready:U.ready},e.__MG_PIXI__}function Ct(){if(!U.ready)throw new Error("MGPixi: call MGPixi.init() first")}async function Fy(e=15e3){if(U.ready)return Ga(),!0;if(await Pe.init(e),U.app=Pe.app(),U.ticker=Pe.ticker(),U.renderer=Pe.renderer(),U.stage=Pe.stage(),!U.app||!U.ticker)throw new Error("MGPixi: PIXI app/ticker not found");return U.ready=!0,Ga(),!0}var U,Ha,Da,Zo,kt,Ey,On,Wa=G(()=>{"use strict";Ze();ve();fn();Xo();U={ready:!1,app:null,renderer:null,stage:null,ticker:null,tileSets:new Map,highlights:new Map,watches:new Map,fades:new Map,fadeWatches:new Map},Ha=e=>!!e&&typeof e=="object"&&!Array.isArray(e),Da=e=>!!(e&&typeof e.getBounds=="function"&&("parent"in e||"children"in e)),Zo=e=>!!(e&&typeof e.tint=="number"),kt=e=>!!(e&&typeof e.alpha=="number");Ey=["plantVisual","cropVisual","slotVisual","slotView","displayObject","view","container","root","sprite","gfx","graphics"];On={init:Fy,ready:()=>U.ready,expose:Ga,get app(){return U.app},get renderer(){return U.renderer},get stage(){return U.stage},get ticker(){return U.ticker},get PIXI(){return A.PIXI||null},defineTileSet:My,deleteTileSet:Ay,listTileSets:Iy,highlightPulse:ic,stopHighlight:_a,clearHighlights:ac,highlightMutation:sc,watchMutation:Ry,stopWatchMutation:Oy,inspectTile:Hy,fadeSpecies:uc,clearSpeciesFade:cc,clearFades:Oa,watchFadeSpecies:_y,stopWatchFadeSpecies:Wy}});function _n(){if(!$.ready)throw new Error("MGAudio not ready yet")}function pc(e,t=NaN){try{let n=localStorage.getItem(e);if(n==null)return t;let r;try{r=JSON.parse(n)}catch{r=n}if(typeof r=="number"&&Number.isFinite(r))return r;if(typeof r=="string"){let o=parseFloat(r);if(Number.isFinite(o))return o}}catch{}return t}function Nn(e){let t=By[e],n=jy[e];if(!t)return{atom:Hn,vol100:tr(Hn)};let r=pc(t,NaN);if(Number.isFinite(r)){let a=Re(r,0,1);return{atom:a,vol100:tr(a)}}if(n){let a=pc(n,NaN);if(Number.isFinite(a)){let i=Re(a,0,1);return{atom:i,vol100:tr(i)}}}let o=Hn;return{atom:o,vol100:tr(o)}}function Uy(e){let t=Number(e);if(!Number.isFinite(t))return null;if(t<=0)return 0;let r=(Re(t,1,100)-1)/99;return Gn+r*(Hn-Gn)}function tr(e){let t=Re(Number(e),0,1);if(t<=Gn)return 0;let n=(t-Gn)/(Hn-Gn);return Math.round(1+n*99)}function mc(e,t){if(t==null)return Nn(e).atom;let n=Uy(t);return n===null?Nn(e).atom:Gr(n)}async function gc(){let e=$.ctx;if(e)return e;let t=dc.AudioContext||dc.webkitAudioContext;if(!t)throw new Error("WebAudio not supported");let n=new t;return $.ctx=n,n}async function fc(){if($.ctx&&$.ctx.state==="suspended")try{await $.ctx.resume()}catch{}}function zy(e){let t=new Map,n=(r,o)=>{t.has(r)||t.set(r,[]),t.get(r).push(o)};for(let r of Object.keys(e||{})){let o=/^(.*)_([A-Z])$/.exec(r);o?.[1]?n(o[1],r):n(r,r)}for(let[r,o]of Array.from(t.entries()))o.sort((a,i)=>a.localeCompare(i)),t.set(r,o);$.sfx.groups=t}function Vy(e){let t=$.sfx.atlas;if(!t)throw new Error("SFX atlas not loaded");if(t[e])return e;let n=$.sfx.groups.get(e);if(n?.length)return n[Math.random()*n.length|0];throw new Error(`Unknown sfx/group: ${e}`)}async function $y(){if($.sfx.buffer)return $.sfx.buffer;if(!$.sfx.mp3Url)throw new Error("SFX mp3 url missing");let e=await gc();await fc();let n=await(await vo($.sfx.mp3Url)).arrayBuffer(),r=await new Promise((o,a)=>{let i=e.decodeAudioData(n,o,a);i?.then&&i.then(o,a)});return $.sfx.buffer=r,r}async function Ky(e,t={}){if(!$.ready)throw new Error("MGAudio not ready yet");let n=String(e||"").trim();if(!n)throw new Error("Missing sfx name");let r=Vy(n),o=$.sfx.atlas[r];if(!o)throw new Error(`Missing segment for sfx: ${r}`);let a=await gc();await fc();let i=await $y(),s=Math.max(0,+o.start||0),u=Math.max(s,+o.end||s),d=Math.max(.01,u-s),l=mc("sfx",t.volume),c=a.createGain();c.gain.value=l,c.connect(a.destination);let p=a.createBufferSource();return p.buffer=i,p.connect(c),p.start(0,s,d),{name:r,source:p,start:s,end:u,duration:d,volume:l}}function bc(e){if(e!=="music"&&e!=="ambience")return!1;let t=$.tracks[e];if(t){try{t.pause()}catch{}try{t.src=""}catch{}}return $.tracks[e]=null,!0}function Jy(e,t,n={}){if(!$.ready)throw new Error("MGAudio not ready yet");if(e!=="music"&&e!=="ambience")throw new Error(`Invalid category: ${e}`);let r=$.urls[e].get(t);if(!r)throw new Error(`Unknown ${e}: ${t}`);bc(e);let o=new Audio(r);return o.loop=!!n.loop,o.volume=mc(e,n.volume),o.preload="auto",o.play().catch(()=>{}),$.tracks[e]=o,o}async function qy(e,t,n={}){let r=String(e||"").trim(),o=String(t||"").trim();if(!r||!o)throw new Error("play(category, asset) missing args");if(r==="sfx")return Ky(o,n);if(r==="music"||r==="ambience")return Jy(r,o,n);throw new Error(`Unknown category: ${r}`)}function Yy(e,t={}){let n=String(e||"").trim();return n==="music"||n==="ambience"?Array.from($.urls[n].keys()).sort():n==="sfx"?$.sfx.atlas?t.groups?Array.from($.sfx.groups.keys()).sort():Object.keys($.sfx.atlas).sort():[]:[]}function Xy(){return $.tracks.music&&($.tracks.music.volume=Nn("music").atom),$.tracks.ambience&&($.tracks.ambience.volume=Nn("ambience").atom),!0}function Qy(){return _n(),["sfx","music","ambience"]}function Zy(){return _n(),Array.from($.sfx.groups.keys()).sort((e,t)=>e.localeCompare(t))}function ev(e,t){_n();let n=String(e||"").trim().toLowerCase(),r=String(t||"").trim();if(!r||n!=="music"&&n!=="ambience")return!1;let o=$.urls[n],a=r.toLowerCase();for(let i of o.keys())if(i.toLowerCase()===a)return!0;return!1}function tv(e){_n();let t=String(e||"").trim();if(!t)return!1;let n=t.toLowerCase();for(let r of $.sfx.groups.keys())if(r.toLowerCase()===n)return!0;return!1}function nv(e,t){_n();let n=String(e||"").trim().toLowerCase(),r=String(t||"").trim();if(!r)throw new Error("getTrackUrl(category, name) missing name");if(n!=="music"&&n!=="ambience")throw new Error(`Invalid category: ${e}`);let o=$.urls[n],a=r.toLowerCase();for(let[i,s]of o.entries())if(i.toLowerCase()===a)return s;return null}async function ov(){return $.ready?!0:er||(er=(async()=>{$.baseUrl=await Be.base();let e=await Oe.load($.baseUrl),t=Oe.getBundle(e,"audio");if(!t)throw new Error("No audio bundle in manifest");for(let n of t.assets||[])for(let r of n.src||[]){if(typeof r!="string")continue;let o=/^audio\/(ambience|music)\/(.+)\.mp3$/i.exec(r);if(o){let a=o[1].toLowerCase(),i=o[2];$.urls[a].set(i,Ie($.baseUrl,r));continue}/^audio\/sfx\/sfx\.mp3$/i.test(r)&&($.sfx.mp3Url=Ie($.baseUrl,r)),/^audio\/sfx\/sfx\.json$/i.test(r)&&($.sfx.atlasUrl=Ie($.baseUrl,r))}if(!$.sfx.atlasUrl)throw new Error("Missing audio/sfx/sfx.json in manifest");return $.sfx.atlas=await _t($.sfx.atlasUrl),zy($.sfx.atlas),$.ready=!0,!0})(),er)}var dc,By,jy,Gn,Hn,er,$,Wn,Fa=G(()=>{"use strict";ve();Ze();bn();Wt();Ft();xn();dc=A??window,By={sfx:"soundEffectsVolume",music:"musicVolume",ambience:"ambienceVolume"},jy={sfx:"soundEffectsVolumeAtom",music:"musicVolumeAtom",ambience:"ambienceVolumeAtom"},Gn=.001,Hn=.2,er=null,$={ready:!1,baseUrl:null,urls:{ambience:new Map,music:new Map},sfx:{mp3Url:null,atlasUrl:null,atlas:null,groups:new Map,buffer:null},tracks:{ambience:null,music:null},ctx:null};Wn={init:ov,ready:()=>$.ready,play:qy,stop:bc,list:Yy,refreshVolumes:Xy,categoryVolume:Nn,getCategories:Qy,getGroups:Zy,hasTrack:ev,hasGroup:tv,getTrackUrl:nv}});function rv(){if(me.overlay)return me.overlay;let e=Ba.createElement("div");return e.id="MG_COSMETIC_OVERLAY",e.style.cssText=["position:fixed","left:0","top:0","width:100vw","height:100vh","pointer-events:none","z-index:99999999"].join(";"),Ba.documentElement.appendChild(e),me.overlay=e,e}function av(){let e=me.defaultParent;if(!e)return null;try{return typeof e=="function"?e():e}catch{return null}}function ja(e){let t=String(e||"").trim();return t?(t=t.replace(/^cosmetic\//i,""),t=t.replace(/\.png$/i,""),t):""}function iv(e,t){if(t===void 0){let a=ja(e),i=a.indexOf("_");return i<0?{cat:"",asset:a,base:a}:{cat:a.slice(0,i),asset:a.slice(i+1),base:a}}let n=String(e||"").trim(),r=ja(t),o=r.includes("_")?r:`${n}_${r}`;if(r.includes("_")&&!n){let a=r.indexOf("_");return{cat:r.slice(0,a),asset:r.slice(a+1),base:r}}return{cat:n,asset:r.replace(/^.+?_/,""),base:o}}function sv(){return Array.from(me.byCat.keys()).sort((e,t)=>e.localeCompare(t))}function lv(e){let t=me.byCat.get(String(e||"").trim());return t?Array.from(t.keys()).sort((n,r)=>n.localeCompare(r)):[]}function Ua(e,t){let{cat:n,asset:r,base:o}=iv(e,t),a=me.byBase.get(o);if(a)return a;let s=me.byCat.get(n)?.get(r);if(s)return s;if(!me.baseUrl)throw new Error("MGCosmetic not initialized");if(!o)throw new Error("Invalid cosmetic name");return Ie(me.baseUrl,`cosmetic/${o}.png`)}function za(e,t,n){if(!me.ready)throw new Error("MGCosmetic not ready yet");let r,o;typeof t=="object"&&t!==null?(r=t,o=void 0):typeof t=="string"?(o=t,r=n||{}):(o=void 0,r=n||{});let a=o!==void 0?Ua(e,o):Ua(e),i=Ba.createElement("img");if(i.decoding="async",i.loading="eager",i.src=a,i.alt=r.alt!=null?String(r.alt):ja(o??e),r.className&&(i.className=String(r.className)),r.width!=null&&(i.style.width=String(r.width)),r.height!=null&&(i.style.height=String(r.height)),r.opacity!=null&&(i.style.opacity=String(r.opacity)),r.style&&typeof r.style=="object")for(let[s,u]of Object.entries(r.style))try{i.style[s]=String(u)}catch{}return i}function cv(e,t,n){let r,o;typeof t=="object"&&t!==null?(r=t,o=void 0):typeof t=="string"?(o=t,r=n||{}):(o=void 0,r=n||{});let a=r.parent||av()||rv(),i=o!==void 0?za(e,o,r):za(e,r);if(a===me.overlay||r.center||r.x!=null||r.y!=null||r.absolute){i.style.position="absolute",i.style.pointerEvents="none",i.style.zIndex=String(r.zIndex??999999);let u=r.scale??1,d=r.rotation??0;if(r.center)i.style.left="50%",i.style.top="50%",i.style.transform=`translate(-50%, -50%) scale(${u}) rotate(${d}rad)`;else{let l=r.x??innerWidth/2,c=r.y??innerHeight/2;i.style.left=`${l}px`,i.style.top=`${c}px`,i.style.transform=`scale(${u}) rotate(${d}rad)`,r.anchor==="center"&&(i.style.transform=`translate(-50%, -50%) scale(${u}) rotate(${d}rad)`)}}return a.appendChild(i),me.live.add(i),i.__mgDestroy=()=>{try{i.remove()}catch{}me.live.delete(i)},i}function uv(e){return me.defaultParent=e,!0}function dv(){for(let e of Array.from(me.live))e.__mgDestroy?.()}async function pv(){return me.ready?!0:nr||(nr=(async()=>{me.baseUrl=await Be.base();let e=await Oe.load(me.baseUrl),t=Oe.getBundle(e,"cosmetic");if(!t)throw new Error("No 'cosmetic' bundle in manifest");me.byCat.clear(),me.byBase.clear();for(let n of t.assets||[])for(let r of n.src||[]){if(typeof r!="string"||!/^cosmetic\/.+\.png$/i.test(r))continue;let a=r.split("/").pop().replace(/\.png$/i,""),i=a.indexOf("_");if(i<0)continue;let s=a.slice(0,i),u=a.slice(i+1),d=Ie(me.baseUrl,r);me.byBase.set(a,d),me.byCat.has(s)||me.byCat.set(s,new Map),me.byCat.get(s).set(u,d)}return me.ready=!0,!0})(),nr)}var Ba,nr,me,Fn,Va=G(()=>{"use strict";ve();Wt();Ft();xn();Ba=A?.document??document,nr=null,me={ready:!1,baseUrl:null,byCat:new Map,byBase:new Map,overlay:null,live:new Set,defaultParent:null};Fn={init:pv,ready:()=>me.ready,categories:sv,list:lv,url:Ua,create:za,show:cv,attach:uv,clear:dv}});var hc=G(()=>{"use strict"});function mv(){return Bn||(Bn=new or),Bn}function gv(){Bn&&(Bn=null)}var or,Bn,yc=G(()=>{"use strict";or=class{constructor(){ne(this,"achievements",new Map);ne(this,"data");ne(this,"storageKey","gemini_achievements");ne(this,"onUnlockCallbacks",[]);ne(this,"onProgressCallbacks",[]);this.data=this.loadData()}loadData(){try{let t=localStorage.getItem(this.storageKey);if(t)return JSON.parse(t)}catch(t){console.warn("[Achievements] Failed to load data:",t)}return{unlocked:{},progress:{}}}saveData(){try{localStorage.setItem(this.storageKey,JSON.stringify(this.data))}catch(t){console.warn("[Achievements] Failed to save data:",t)}}register(t){this.achievements.set(t.id,t),this.data.progress[t.id]||(this.data.progress[t.id]={current:0,target:t.target,percentage:0})}registerMany(t){for(let n of t)this.register(n)}async checkAchievement(t){let n=this.achievements.get(t);if(!n)throw new Error(`Achievement not found: ${t}`);let r=this.isUnlocked(t),o=await n.checkProgress(),a={current:o,target:n.target,percentage:Math.min(100,Math.floor(o/n.target*100))},i=this.data.progress[t];this.data.progress[t]=a;let s=o>=n.target;return!r&&s?this.unlock(t,a):s||this.triggerProgressCallbacks({achievement:n,progress:a,previousProgress:i}),this.saveData(),{id:t,wasUnlocked:r,isUnlocked:s,progress:a}}async checkAllAchievements(){let t=[];for(let n of this.achievements.keys()){let r=await this.checkAchievement(n);t.push(r)}return t}unlock(t,n){let r=this.achievements.get(t);if(!r)return;let o={achievementId:t,unlockedAt:Date.now(),progress:n};this.data.unlocked[t]=o,this.saveData(),this.triggerUnlockCallbacks({achievement:r,unlockedAt:o.unlockedAt,progress:n})}isUnlocked(t){return!!this.data.unlocked[t]}getAchievement(t){return this.achievements.get(t)||null}getAllAchievements(){return Array.from(this.achievements.values())}getAchievementsByCategory(t){return Array.from(this.achievements.values()).filter(n=>n.category===t)}getAchievementsByRarity(t){return Array.from(this.achievements.values()).filter(n=>n.rarity===t)}getUnlockedAchievements(){return Object.values(this.data.unlocked)}getLockedAchievements(){return Array.from(this.achievements.values()).filter(t=>!this.isUnlocked(t.id)&&!t.hidden)}getProgress(t){return this.data.progress[t]||null}getCompletionPercentage(){let t=this.achievements.size,n=Object.keys(this.data.unlocked).length;return t>0?Math.floor(n/t*100):0}getCompletionStats(){let t=this.achievements.size,n=Object.keys(this.data.unlocked).length,r=t-n,o=this.getCompletionPercentage();return{total:t,unlocked:n,locked:r,percentage:o}}onUnlock(t){return this.onUnlockCallbacks.push(t),()=>{let n=this.onUnlockCallbacks.indexOf(t);n!==-1&&this.onUnlockCallbacks.splice(n,1)}}onProgress(t){return this.onProgressCallbacks.push(t),()=>{let n=this.onProgressCallbacks.indexOf(t);n!==-1&&this.onProgressCallbacks.splice(n,1)}}triggerUnlockCallbacks(t){for(let n of this.onUnlockCallbacks)try{n(t)}catch(r){console.warn("[Achievements] Unlock callback error:",r)}}triggerProgressCallbacks(t){for(let n of this.onProgressCallbacks)try{n(t)}catch(r){console.warn("[Achievements] Progress callback error:",r)}}reset(){this.data={unlocked:{},progress:{}};for(let t of this.achievements.values())this.data.progress[t.id]={current:0,target:t.target,percentage:0};this.saveData()}exportData(){return JSON.stringify(this.data,null,2)}importData(t){try{let n=JSON.parse(t);return this.data=n,this.saveData(),!0}catch(n){return console.warn("[Achievements] Failed to import data:",n),!1}}},Bn=null});var rr={};Ot(rr,{AchievementManager:()=>or,destroyAchievementManager:()=>gv,getAchievementManager:()=>mv});var vc=G(()=>{"use strict";hc();yc()});function ar(e){let t=1,n=0,r=0;for(let o of e)o==="Gold"||o==="Rainbow"?o==="Rainbow"?t=Yt.Rainbow:t===1&&(t=Yt.Gold):o in Yt&&(n+=Yt[o],r++);return t*(1+n-r)}function $a(e){return Yt[e]??null}function Ka(e){return fv.has(e)}function xc(e){return bv.has(e)}function hv(){return Object.keys(Yt)}function yv(e){let t=$a(e);return t===null?null:{name:e,value:t,type:Ka(e)?"growth":"environmental"}}var Yt,fv,bv,ir=G(()=>{"use strict";Yt={Gold:25,Rainbow:50,Frozen:10,Chilled:5,Wet:2},fv=new Set(["Gold","Rainbow"]),bv=new Set(["Frozen","Chilled","Wet"])});function Sc(e,t){let n=sr(e);if(!n)return 50;let r=n.maxScale;if(t<=1)return 50;if(t>=r)return 100;let o=(t-1)/(r-1);return Math.floor(50+50*o)}function Ja(e,t,n){let r=sr(e);if(!r)return 0;let o=r.baseSellPrice,a=ar(n);return Math.round(o*t*a)}function wc(e,t,n){if(n>=t)return 100;if(n<=e)return 0;let r=t-e,o=n-e;return Math.floor(o/r*100)}function Tc(e,t){return t>=e}function vv(e,t){let n=Math.max(0,e-t);return Math.floor(n/1e3)}function sr(e){let t=le.get("plants");if(!t)return null;let n=t[e];return n?.crop?{baseSellPrice:n.crop.baseSellPrice??0,maxScale:n.crop.maxScale??1,growTime:n.crop.growTime??0}:null}function xv(e){return e.reduce((t,n)=>t+Ja(n.species,n.targetScale,n.mutations),0)}var qa=G(()=>{"use strict";ut();ir()});function Pt(e){return e/kc}function Mt(e,t){let n=Et(e);if(!n)return Ya;let r=n.maxScale;if(t<=1)return Ya;if(t>=r)return Sv;let o=(t-1)/(r-1);return Math.floor(Ya+20*o)}function At(e,t,n){let r=Et(e);if(!r)return n-jn;let o=r.hoursToMature,a=t/kc,i=jn/o,s=Math.min(i*a,jn),u=n-jn;return Math.floor(u+s)}function It(e,t){let n=Et(e);return n?t>=n.hoursToMature:!1}function lr(e){let t=Et(e);return t?jn/t.hoursToMature:0}function Xa(e,t,n){let r=t-e;return r<=0||n<=0?0:r/n}function wv(e,t){let n=Et(e);if(!n)return 0;let r=n.hoursToMature-t;return Math.max(0,r)}function Et(e){let t=le.get("pets");if(!t)return null;let n=t[e];return n?{hoursToMature:n.hoursToMature??0,maxScale:n.maxScale??1,abilities:n.abilities??[]}:null}function Qa(e,t){return t<=0?1:Math.min(1,e/t)}var kc,Ya,Sv,jn,Za=G(()=>{"use strict";ut();kc=3600,Ya=80,Sv=100,jn=30});var cr={};Ot(cr,{calculateCropProgress:()=>wc,calculateCropSellPrice:()=>Ja,calculateCropSize:()=>Sc,calculateCurrentStrength:()=>At,calculateHoursToMature:()=>wv,calculateHoursToMaxStrength:()=>Xa,calculateMaxStrength:()=>Mt,calculateMutationMultiplier:()=>ar,calculatePetAge:()=>Pt,calculateStrengthPerHour:()=>lr,calculateStrengthProgress:()=>Qa,calculateTimeRemaining:()=>vv,calculateTotalCropValue:()=>xv,getAllMutationNames:()=>hv,getCropData:()=>sr,getMutationInfo:()=>yv,getMutationValue:()=>$a,getPetData:()=>Et,isCropReady:()=>Tc,isEnvironmentalMutation:()=>xc,isGrowthMutation:()=>Ka,isPetMature:()=>It});var ur=G(()=>{"use strict";qa();Za();ir();qa();Za();ir()});var ei={};Ot(ei,{calculatePetStrength:()=>Cc,enrichPetWithStrength:()=>Pc,enrichPetsWithStrength:()=>Mc,getPetStrengthStats:()=>Tv});function Cc(e){let t=Pt(e.xp),n=Mt(e.petSpecies,e.targetScale),r=At(e.petSpecies,e.xp,n),o=It(e.petSpecies,t),a=lr(e.petSpecies),i=Xa(r,n,a),s=Qa(r,n);return{current:r,max:n,progress:s,age:t,isMature:o,strengthPerHour:a,hoursToMax:i}}function Pc(e){return{...e,strength:Cc(e)}}function Mc(e){return e.map(Pc)}function Tv(e){if(e.length===0)return{averageCurrent:0,averageMax:0,totalMature:0,totalImmature:0,strongestPet:null,weakestPet:null};let t=Mc(e),n=t.reduce((u,d)=>u+d.strength.current,0),r=t.reduce((u,d)=>u+d.strength.max,0),o=t.filter(u=>u.strength.isMature).length,a=t.length-o,i=t.reduce((u,d)=>d.strength.max>(u?.strength.max||0)?d:u,t[0]),s=t.reduce((u,d)=>d.strength.max<(u?.strength.max||1/0)?d:u,t[0]);return{averageCurrent:Math.round(n/t.length),averageMax:Math.round(r/t.length),totalMature:o,totalImmature:a,strongestPet:i,weakestPet:s}}var Ac=G(()=>{"use strict";ur()});var Ic=G(()=>{"use strict"});function Te(e,t){if(e===t)return!0;if(e===null||t===null)return e===t;if(typeof e!=typeof t)return!1;if(typeof e!="object")return e===t;if(Array.isArray(e)&&Array.isArray(t)){if(e.length!==t.length)return!1;for(let i=0;i<e.length;i++)if(!Te(e[i],t[i]))return!1;return!0}if(Array.isArray(e)||Array.isArray(t))return!1;let n=e,r=t,o=Object.keys(n),a=Object.keys(r);if(o.length!==a.length)return!1;for(let i of o)if(!Object.prototype.hasOwnProperty.call(r,i)||!Te(n[i],r[i]))return!1;return!0}var pt=G(()=>{"use strict";Fe()});function kv(e){let t=e.currentGardenTile;return{globalIndex:e.globalTileIndex,localIndex:t?.localTileIndex??null}}function Cv(e){return{type:e.currentGardenTile?.tileType??null,isEmpty:e.gardenObject===null}}function Pv(e){let t=e.currentGardenTile;return{name:e.gardenName,isOwner:e.isInMyGarden??!1,playerSlotIndex:t?.userSlotIdx??null}}function Mv(e){let t=e.gardenObject;return t?{type:t.objectType,data:t,isMature:e.isMature??!1}:{type:null,data:null,isMature:!1}}function Av(e){let t=e.gardenObject;if(!t||t.objectType!=="plant")return null;let n=t,r=e.sortedSlotIndices??[];return{species:n.species,slots:n.slots??[],currentSlotIndex:e.currentGrowSlotIndex,sortedSlotIndices:r,nextHarvestSlotIndex:r.length>0?r[0]:null}}function Dc(e){return{position:kv(e),tile:Cv(e),garden:Pv(e),object:Mv(e),plant:Av(e)}}function Rc(e){return JSON.stringify({globalIndex:e.position.globalIndex,localIndex:e.position.localIndex,tileType:e.tile.type,isEmpty:e.tile.isEmpty,gardenName:e.garden.name,isOwner:e.garden.isOwner,playerSlotIndex:e.garden.playerSlotIndex,objectType:e.object.type,isMature:e.object.isMature,plantSpecies:e.plant?.species??null,slotCount:e.plant?.slots.length??0})}function Iv(e,t){return e.type!==t.type||e.isMature!==t.isMature?!0:e.data===null&&t.data===null?!1:e.data===null||t.data===null?!0:!Te(e.data,t.data)}function Ev(e,t){return e===null&&t===null?!1:e===null||t===null||e.species!==t.species||e.currentSlotIndex!==t.currentSlotIndex||e.nextHarvestSlotIndex!==t.nextHarvestSlotIndex||e.slots.length!==t.slots.length?!0:!Te(e.sortedSlotIndices,t.sortedSlotIndices)}function Lv(e,t){return e.name!==t.name||e.isOwner!==t.isOwner||e.playerSlotIndex!==t.playerSlotIndex}function Dv(){let e=Lc,t=Lc,n=!1,r=[],o={all:new Set,stable:new Set,object:new Set,plantInfo:new Set,garden:new Set},a={},i=Object.keys(Ec),s=new Set;function u(){if(s.size<i.length)return;let l=Dc(a);if(!Te(e,l)&&(t=e,e=l,!!n)){for(let c of o.all)c(e,t);if(Rc(t)!==Rc(e))for(let c of o.stable)c(e,t);if(Iv(t.object,e.object)){let c={current:e.object,previous:t.object};for(let p of o.object)p(c)}if(Ev(t.plant,e.plant)){let c={current:e.plant,previous:t.plant};for(let p of o.plantInfo)p(c)}if(Lv(t.garden,e.garden)){let c={current:e.garden,previous:t.garden};for(let p of o.garden)p(c)}}}async function d(){if(n)return;let l=i.map(async c=>{let p=Ec[c],m=await te.subscribe(p,g=>{a[c]=g,s.add(c),u()});r.push(m)});await Promise.all(l),n=!0,s.size===i.length&&(e=Dc(a))}return d(),{get(){return e},subscribe(l,c){return o.all.add(l),c?.immediate!==!1&&n&&s.size===i.length&&l(e,e),()=>o.all.delete(l)},subscribeStable(l,c){return o.stable.add(l),c?.immediate!==!1&&n&&s.size===i.length&&l(e,e),()=>o.stable.delete(l)},subscribeObject(l,c){return o.object.add(l),c?.immediate&&n&&s.size===i.length&&l({current:e.object,previous:e.object}),()=>o.object.delete(l)},subscribePlantInfo(l,c){return o.plantInfo.add(l),c?.immediate&&n&&s.size===i.length&&l({current:e.plant,previous:e.plant}),()=>o.plantInfo.delete(l)},subscribeGarden(l,c){return o.garden.add(l),c?.immediate&&n&&s.size===i.length&&l({current:e.garden,previous:e.garden}),()=>o.garden.delete(l)},destroy(){for(let l of r)l();r.length=0,o.all.clear(),o.stable.clear(),o.object.clear(),o.plantInfo.clear(),o.garden.clear(),n=!1}}}function ni(){return ti||(ti=Dv()),ti}var Ec,Lc,ti,oi=G(()=>{"use strict";Fe();pt();Ec={currentGardenTile:"myCurrentGardenTileAtom",globalTileIndex:"myCurrentGlobalTileIndexAtom",gardenObject:"myCurrentGardenObjectAtom",isMature:"isGardenObjectMatureAtom",isInMyGarden:"isInMyGardenAtom",gardenName:"currentGardenNameAtom",sortedSlotIndices:"myCurrentSortedGrowSlotIndicesAtom",currentGrowSlotIndex:"myCurrentGrowSlotIndexAtom"},Lc={position:{globalIndex:null,localIndex:null},tile:{type:null,isEmpty:!0},garden:{name:null,isOwner:!1,playerSlotIndex:null},object:{type:null,data:null,isMature:!1},plant:null};ti=null});function Gc(e,t){let n=Pt(e.xp),r=Mt(e.petSpecies,e.targetScale),o=At(e.petSpecies,e.xp,r),a=It(e.petSpecies,n);return{id:e.id,petSpecies:e.petSpecies,name:e.name,xp:e.xp,hunger:e.hunger,mutations:[...e.mutations],targetScale:e.targetScale,abilities:[...e.abilities],location:t,position:null,lastAbilityTrigger:null,growthStage:n,currentStrength:o,maxStrength:r,isMature:a}}function Rv(e,t){let r=t[e.slot.id]?.lastAbilityTrigger??null,o=Pt(e.slot.xp),a=Mt(e.slot.petSpecies,e.slot.targetScale),i=At(e.slot.petSpecies,e.slot.xp,a),s=It(e.slot.petSpecies,o);return{id:e.slot.id,petSpecies:e.slot.petSpecies,name:e.slot.name,xp:e.slot.xp,hunger:e.slot.hunger,mutations:[...e.slot.mutations],targetScale:e.slot.targetScale,abilities:[...e.slot.abilities],location:"active",position:e.position?{x:e.position.x,y:e.position.y}:null,lastAbilityTrigger:r,growthStage:o,currentStrength:i,maxStrength:a,isMature:s}}function Hc(e){let t=new Set,n=[];for(let u of e.active??[]){let d=Rv(u,e.slotInfos??{});n.push(d),t.add(d.id)}let r=[];for(let u of e.inventory??[]){if(t.has(u.id))continue;let d=Gc(u,"inventory");r.push(d),t.add(d.id)}let o=[];for(let u of e.hutch??[]){if(t.has(u.id))continue;let d=Gc(u,"hutch");o.push(d),t.add(d.id)}let a=[...n,...r,...o],i=e.expandedPetSlotId??null,s=i?a.find(u=>u.id===i)??null:null;return{all:a,byLocation:{inventory:r,hutch:o,active:n},counts:{inventory:r.length,hutch:o.length,active:n.length,total:a.length},expandedPetSlotId:i,expandedPet:s}}function Ov(e,t){if(e.length!==t.length)return!1;for(let n=0;n<e.length;n++)if(e[n]!==t[n])return!1;return!0}function _c(e){return JSON.stringify({id:e.id,petSpecies:e.petSpecies,name:e.name,mutations:e.mutations,abilities:e.abilities,location:e.location})}function Gv(e,t){if(e.all.length!==t.all.length)return!1;let n=e.all.map(_c),r=t.all.map(_c);return Ov(n,r)}function Hv(e,t){let n=[],r=new Map(e.all.map(o=>[o.id,o]));for(let o of t.all){let a=r.get(o.id);a&&a.location!==o.location&&n.push({pet:o,from:a.location,to:o.location})}return n}function Nv(e,t){let n=[],r=new Map(e.all.map(o=>[o.id,o]));for(let o of t.all){if(!o.lastAbilityTrigger)continue;let i=r.get(o.id)?.lastAbilityTrigger;(!i||i.abilityId!==o.lastAbilityTrigger.abilityId||i.performedAt!==o.lastAbilityTrigger.performedAt)&&n.push({pet:o,trigger:o.lastAbilityTrigger})}return n}function _v(e,t){let n=new Set(e.all.map(i=>i.id)),r=new Set(t.all.map(i=>i.id)),o=t.all.filter(i=>!n.has(i.id)),a=e.all.filter(i=>!r.has(i.id));return o.length===0&&a.length===0?null:{added:o,removed:a,counts:t.counts}}function Wv(e,t){let n=[],r=new Map(e.all.map(o=>[o.id,o]));for(let o of t.all){let a=r.get(o.id);a&&o.growthStage>a.growthStage&&n.push({pet:o,previousStage:a.growthStage,newStage:o.growthStage})}return n}function Fv(e,t){let n=[],r=new Map(e.all.map(o=>[o.id,o]));for(let o of t.all){let a=r.get(o.id);a&&o.currentStrength>a.currentStrength&&n.push({pet:o,previousStrength:a.currentStrength,newStrength:o.currentStrength})}return n}function Bv(e,t){let n=[],r=new Map(e.all.map(o=>[o.id,o]));for(let o of t.all){let a=r.get(o.id);a&&o.currentStrength===o.maxStrength&&a.currentStrength<a.maxStrength&&n.push({pet:o})}return n}function jv(){let e=Nc,t=Nc,n=!1,r=[],o={all:new Set,stable:new Set,location:new Set,ability:new Set,count:new Set,expandedPet:new Set,growth:new Set,strengthGain:new Set,maxStrength:new Set},a={},i=Object.keys(Oc),s=new Set;function u(){if(s.size<i.length)return;let l=Hc(a);if(Te(e,l)||(t=e,e=l,!n))return;for(let b of o.all)b(e,t);if(!Gv(t,e))for(let b of o.stable)b(e,t);let c=Hv(t,e);for(let b of c)for(let T of o.location)T(b);let p=Nv(t,e);for(let b of p)for(let T of o.ability)T(b);let m=_v(t,e);if(m)for(let b of o.count)b(m);let g=Wv(t,e);for(let b of g)for(let T of o.growth)T(b);let f=Fv(t,e);for(let b of f)for(let T of o.strengthGain)T(b);let h=Bv(t,e);for(let b of h)for(let T of o.maxStrength)T(b);if(t.expandedPetSlotId!==e.expandedPetSlotId){let b={current:e.expandedPet,previous:t.expandedPet,currentId:e.expandedPetSlotId,previousId:t.expandedPetSlotId};for(let T of o.expandedPet)T(b)}}async function d(){if(n)return;let l=i.map(async c=>{let p=Oc[c],m=await te.subscribe(p,g=>{a[c]=g,s.add(c),u()});r.push(m)});await Promise.all(l),n=!0,s.size===i.length&&(e=Hc(a))}return d(),{get(){return e},subscribe(l,c){return o.all.add(l),c?.immediate!==!1&&n&&s.size===i.length&&l(e,e),()=>o.all.delete(l)},subscribeStable(l,c){return o.stable.add(l),c?.immediate!==!1&&n&&s.size===i.length&&l(e,e),()=>o.stable.delete(l)},subscribeLocation(l,c){if(o.location.add(l),c?.immediate&&n&&s.size===i.length)for(let p of e.all)l({pet:p,from:p.location,to:p.location});return()=>o.location.delete(l)},subscribeAbility(l,c){if(o.ability.add(l),c?.immediate&&n&&s.size===i.length)for(let p of e.all)p.lastAbilityTrigger&&l({pet:p,trigger:p.lastAbilityTrigger});return()=>o.ability.delete(l)},subscribeCount(l,c){return o.count.add(l),c?.immediate&&n&&s.size===i.length&&l({added:e.all,removed:[],counts:e.counts}),()=>o.count.delete(l)},subscribeExpandedPet(l,c){return o.expandedPet.add(l),c?.immediate&&n&&s.size===i.length&&l({current:e.expandedPet,previous:e.expandedPet,currentId:e.expandedPetSlotId,previousId:e.expandedPetSlotId}),()=>o.expandedPet.delete(l)},subscribeGrowth(l,c){if(o.growth.add(l),c?.immediate&&n&&s.size===i.length)for(let p of e.all)l({pet:p,previousStage:p.growthStage,newStage:p.growthStage});return()=>o.growth.delete(l)},subscribeStrengthGain(l,c){if(o.strengthGain.add(l),c?.immediate&&n&&s.size===i.length)for(let p of e.all)l({pet:p,previousStrength:p.currentStrength,newStrength:p.currentStrength});return()=>o.strengthGain.delete(l)},subscribeMaxStrength(l,c){if(o.maxStrength.add(l),c?.immediate&&n&&s.size===i.length)for(let p of e.all)p.currentStrength===p.maxStrength&&l({pet:p});return()=>o.maxStrength.delete(l)},destroy(){for(let l of r)l();r.length=0,o.all.clear(),o.stable.clear(),o.location.clear(),o.ability.clear(),o.count.clear(),o.expandedPet.clear(),o.growth.clear(),o.strengthGain.clear(),o.maxStrength.clear(),n=!1}}}function ai(){return ri||(ri=jv()),ri}var Oc,Nc,ri,ii=G(()=>{"use strict";Fe();pt();ur();Oc={inventory:"myPetInventoryAtom",hutch:"myPetHutchPetItemsAtom",active:"myPetInfosAtom",slotInfos:"myPetSlotInfosAtom",expandedPetSlotId:"expandedPetSlotIdAtom"};Nc={all:[],byLocation:{inventory:[],hutch:[],active:[]},counts:{inventory:0,hutch:0,active:0,total:0},expandedPetSlotId:null,expandedPet:null};ri=null});function Uv(){let e=null,t=[],n=new Set,r={},o=new Set,a=2;function i(c,p){return{x:p%c,y:Math.floor(p/c)}}function s(c,p,m){return m*c+p}function u(c,p){let{cols:m,rows:g}=c,f=m*g,h=new Set,b=new Set,T=new Map,S=[],v=c.userSlotIdxAndDirtTileIdxToGlobalTileIdx??[],k=c.userSlotIdxAndBoardwalkTileIdxToGlobalTileIdx??[],x=Math.max(v.length,k.length);for(let M=0;M<x;M++){let D=v[M]??[],L=k[M]??[],W=D.map((z,X)=>(h.add(z),T.set(z,M),{globalIndex:z,localIndex:X,position:i(m,z)})),oe=L.map((z,X)=>(b.add(z),T.set(z,M),{globalIndex:z,localIndex:X,position:i(m,z)}));S.push({userSlotIdx:M,dirtTiles:W,boardwalkTiles:oe,allTiles:[...W,...oe]})}let C=c.spawnTiles.map(M=>i(m,M)),P={};if(c.locations)for(let[M,D]of Object.entries(c.locations)){let L=D.spawnTileIdx??[];P[M]={name:M,spawnTiles:L,spawnPositions:L.map(W=>i(m,W))}}return{cols:m,rows:g,totalTiles:f,tileSize:p,spawnTiles:c.spawnTiles,spawnPositions:C,locations:P,userSlots:S,globalToXY(M){return i(m,M)},xyToGlobal(M,D){return s(m,M,D)},getTileOwner(M){return T.get(M)??null},isDirtTile(M){return h.has(M)},isBoardwalkTile(M){return b.has(M)}}}function d(){if(o.size<a||e)return;let c=r.map,p=r.tileSize??0;if(c){e=u(c,p);for(let m of n)m(e);n.clear()}}async function l(){let c=await te.subscribe("mapAtom",m=>{r.map=m,o.add("map"),d()});t.push(c);let p=await te.subscribe("tileSizeAtom",m=>{r.tileSize=m,o.add("tileSize"),d()});t.push(p)}return l(),{get(){return e},isReady(){return e!==null},onReady(c,p){return e?(p?.immediate!==!1&&c(e),()=>{}):(n.add(c),()=>n.delete(c))},destroy(){for(let c of t)c();t.length=0,e=null,n.clear()}}}function Xt(){return si||(si=Uv()),si}var si,dr=G(()=>{"use strict";Fe();si=null});function Bc(e){let t=e.inventory,n=t?.items??[],r=t?.favoritedItemIds??[],o=e.selectedItemIndex,a=null;return o!==null&&o>=0&&o<n.length&&(a={index:o,item:n[o]}),{items:n,favoritedItemIds:r,count:n.length,isFull:e.isFull??!1,selectedItem:a}}function jc(e){let t=e.items.map(n=>"id"in n?n.id:"species"in n&&n.itemType==="Seed"?`seed:${n.species}:${n.quantity}`:"toolId"in n?`tool:${n.toolId}:${n.quantity}`:"eggId"in n?`egg:${n.eggId}:${n.quantity}`:"decorId"in n?`decor:${n.decorId}:${n.quantity}`:JSON.stringify(n));return JSON.stringify({itemKeys:t,favoritedItemIds:e.favoritedItemIds,isFull:e.isFull,selectedItemIndex:e.selectedItem?.index??null})}function zv(e,t){return jc(e)===jc(t)}function Vv(e,t){return e===null&&t===null?!1:e===null||t===null?!0:e.index!==t.index}function pr(e){return"id"in e?e.id:"species"in e&&e.itemType==="Seed"?`seed:${e.species}`:"toolId"in e?`tool:${e.toolId}`:"eggId"in e?`egg:${e.eggId}`:"decorId"in e?`decor:${e.decorId}`:JSON.stringify(e)}function $v(e,t){let n=new Set(e.map(pr)),r=new Set(t.map(pr)),o=t.filter(i=>!n.has(pr(i))),a=e.filter(i=>!r.has(pr(i)));return o.length===0&&a.length===0?null:{added:o,removed:a,counts:{before:e.length,after:t.length}}}function Kv(e,t){let n=new Set(e),r=new Set(t),o=t.filter(i=>!n.has(i)),a=e.filter(i=>!r.has(i));return o.length===0&&a.length===0?null:{added:o,removed:a,current:t}}function Jv(){let e=Fc,t=Fc,n=!1,r=[],o={all:new Set,stable:new Set,selection:new Set,items:new Set,favorites:new Set},a={},i=Object.keys(Wc),s=new Set;function u(){if(s.size<i.length)return;let l=Bc(a);if(Te(e,l)||(t=e,e=l,!n))return;for(let m of o.all)m(e,t);if(!zv(t,e))for(let m of o.stable)m(e,t);if(Vv(t.selectedItem,e.selectedItem)){let m={current:e.selectedItem,previous:t.selectedItem};for(let g of o.selection)g(m)}let c=$v(t.items,e.items);if(c)for(let m of o.items)m(c);let p=Kv(t.favoritedItemIds,e.favoritedItemIds);if(p)for(let m of o.favorites)m(p)}async function d(){if(n)return;let l=i.map(async c=>{let p=Wc[c],m=await te.subscribe(p,g=>{a[c]=g,s.add(c),u()});r.push(m)});await Promise.all(l),n=!0,s.size===i.length&&(e=Bc(a))}return d(),{get(){return e},subscribe(l,c){return o.all.add(l),c?.immediate!==!1&&n&&s.size===i.length&&l(e,e),()=>o.all.delete(l)},subscribeStable(l,c){return o.stable.add(l),c?.immediate!==!1&&n&&s.size===i.length&&l(e,e),()=>o.stable.delete(l)},subscribeSelection(l,c){return o.selection.add(l),c?.immediate&&n&&s.size===i.length&&l({current:e.selectedItem,previous:e.selectedItem}),()=>o.selection.delete(l)},subscribeItems(l,c){return o.items.add(l),c?.immediate&&n&&s.size===i.length&&l({added:e.items,removed:[],counts:{before:0,after:e.count}}),()=>o.items.delete(l)},subscribeFavorites(l,c){return o.favorites.add(l),c?.immediate&&n&&s.size===i.length&&l({added:e.favoritedItemIds,removed:[],current:e.favoritedItemIds}),()=>o.favorites.delete(l)},destroy(){for(let l of r)l();r.length=0,o.all.clear(),o.stable.clear(),o.selection.clear(),o.items.clear(),o.favorites.clear(),n=!1}}}function ci(){return li||(li=Jv()),li}var Wc,Fc,li,ui=G(()=>{"use strict";Fe();pt();Wc={inventory:"myInventoryAtom",isFull:"isMyInventoryAtMaxLengthAtom",selectedItemIndex:"myPossiblyNoLongerValidSelectedItemIndexAtom"},Fc={items:[],favoritedItemIds:[],count:0,isFull:!1,selectedItem:null};li=null});function qv(e,t,n){let r=n.get(e.id),o=r?.slot,a=o?.data,i=o?.lastActionEvent;return{id:e.id,name:e.name,discordId:e.databaseUserId,discordAvatarUrl:e.discordAvatarUrl,guildId:e.guildId,isConnected:e.isConnected,isHost:e.id===t,slotIndex:r?.index??null,position:o?.position??null,cosmetic:{color:e.cosmetic?.color??"",avatar:e.cosmetic?.avatar?[...e.cosmetic.avatar]:[]},emote:{type:e.emoteData?.emoteType??-1},coins:a?.coinsCount??0,inventory:a?.inventory??null,shopPurchases:a?.shopPurchases??null,garden:a?.garden??null,pets:{slots:a?.petSlots??[],slotInfos:o?.petSlotInfos??null},journal:a?.journal??null,stats:a?.stats??null,tasksCompleted:a?.tasksCompleted??[],activityLogs:a?.activityLogs??[],customRestocks:{config:a?.customRestocks??null,inventories:o?.customRestockInventories??null},lastAction:i?{type:i.action,data:i.data,timestamp:i.timestamp}:null,selectedItemIndex:o?.notAuthoritative_selectedItemIndex??null,lastSlotMachineInfo:o?.lastSlotMachineInfo??null}}function Uc(e){let t=e.players,n=e.hostPlayerId??"",r=e.userSlots??[];if(!t||!Array.isArray(t)||t.length===0)return pi;let o=new Map;Array.isArray(r)&&r.forEach((s,u)=>{s?.type==="user"&&s?.playerId&&o.set(s.playerId,{slot:s,index:u})});let a=t.map(s=>qv(s,n,o)),i=a.find(s=>s.isHost)??null;return{all:a,host:i,count:a.length}}function zc(e){let t=e.all.map(n=>`${n.id}:${n.isConnected}:${n.isHost}`);return JSON.stringify({playerKeys:t,hostId:e.host?.id??null,count:e.count})}function Yv(e,t){let n=[],r=new Set(e.map(a=>a.id)),o=new Set(t.map(a=>a.id));for(let a of t)r.has(a.id)||n.push({player:a,type:"join"});for(let a of e)o.has(a.id)||n.push({player:a,type:"leave"});return n}function Xv(e,t){let n=[],r=new Map(e.map(o=>[o.id,o]));for(let o of t){let a=r.get(o.id);a&&a.isConnected!==o.isConnected&&n.push({player:o,isConnected:o.isConnected})}return n}function Qv(){let e=pi,t=pi,n=!1,r=[],o={all:new Set,stable:new Set,joinLeave:new Set,connection:new Set,host:new Set},a={},i=new Set,s=3;function u(){if(i.size<s)return;let l=Uc(a);if(Te(e,l)||(t=e,e=l,!n))return;for(let f of o.all)f(e,t);if(zc(t)!==zc(e))for(let f of o.stable)f(e,t);let c=Yv(t.all,e.all);for(let f of c)for(let h of o.joinLeave)h(f);let p=Xv(t.all,e.all);for(let f of p)for(let h of o.connection)h(f);let m=t.host?.id??null,g=e.host?.id??null;if(m!==g){let f={current:e.host,previous:t.host};for(let h of o.host)h(f)}}async function d(){if(n)return;let l=await ma.onChangeNow(m=>{a.players=m,i.add("players"),u()});r.push(l);let c=await ga.onChangeNow(m=>{a.hostPlayerId=m,i.add("hostPlayerId"),u()});r.push(c);let p=await pa.onChangeNow(m=>{a.userSlots=m,i.add("userSlots"),u()});r.push(p),n=!0,i.size===s&&(e=Uc(a))}return d(),{get(){return e},subscribe(l,c){return o.all.add(l),c?.immediate!==!1&&n&&i.size===s&&l(e,e),()=>o.all.delete(l)},subscribeStable(l,c){return o.stable.add(l),c?.immediate!==!1&&n&&i.size===s&&l(e,e),()=>o.stable.delete(l)},subscribeJoinLeave(l,c){if(o.joinLeave.add(l),c?.immediate&&n&&i.size===s)for(let p of e.all)l({player:p,type:"join"});return()=>o.joinLeave.delete(l)},subscribeConnection(l,c){if(o.connection.add(l),c?.immediate&&n&&i.size===s)for(let p of e.all)l({player:p,isConnected:p.isConnected});return()=>o.connection.delete(l)},subscribeHost(l,c){return o.host.add(l),c?.immediate&&n&&i.size===s&&l({current:e.host,previous:e.host}),()=>o.host.delete(l)},destroy(){for(let l of r)l();r.length=0,o.all.clear(),o.stable.clear(),o.joinLeave.clear(),o.connection.clear(),o.host.clear(),n=!1}}}function mi(){return di||(di=Qv()),di}var pi,di,gi=G(()=>{"use strict";wt();pt();pi={all:[],host:null,count:0};di=null});function Zv(e,t){switch(t){case"seed":return e.species??e.itemType;case"tool":return e.toolId??e.itemType;case"egg":return e.eggId??e.itemType;case"decor":return e.decorId??e.itemType;default:return e.itemType}}function ex(e,t,n){let r=Zv(e,t),o=n[r]??0,a=Math.max(0,e.initialStock-o);return{id:r,itemType:e.itemType,initialStock:e.initialStock,purchased:o,remaining:a,isAvailable:a>0}}function tx(e,t,n){if(!t)return{type:e,items:[],availableCount:0,totalCount:0,secondsUntilRestock:0,restockAt:null};let o=n[e]?.purchases??{},a=(t.inventory??[]).map(d=>ex(d,e,o)),i=a.filter(d=>d.isAvailable).length,s=t.secondsUntilRestock??0,u=s>0?Date.now()+s*1e3:null;return{type:e,items:a,availableCount:i,totalCount:a.length,secondsUntilRestock:s,restockAt:u}}function Vc(e){let t=e.shops,n=e.purchases??{},r=Un.map(s=>tx(s,t?.[s],n)),o={seed:r[0],tool:r[1],egg:r[2],decor:r[3]},a=r.filter(s=>s.restockAt!==null),i=null;if(a.length>0){let u=a.sort((d,l)=>(d.restockAt??0)-(l.restockAt??0))[0];i={shop:u.type,seconds:u.secondsUntilRestock,at:u.restockAt}}return{all:r,byType:o,nextRestock:i}}function Kc(e){return JSON.stringify({shops:e.all.map(t=>({type:t.type,itemCount:t.items.length,availableCount:t.availableCount}))})}function nx(e,t){let n=e.secondsUntilRestock,r=t.secondsUntilRestock;return n>0&&n<=5&&r>n||n>0&&r===0&&t.items.some(a=>a.purchased===0)?{shop:t,previousItems:e.items}:null}function ox(e,t){let n=[];for(let r of Un){let o=e.byType[r],a=t.byType[r],i=new Map(o.items.map(s=>[s.id,s]));for(let s of a.items){let u=i.get(s.id);u&&s.purchased>u.purchased&&n.push({shopType:r,itemId:s.id,quantity:s.purchased-u.purchased,newPurchased:s.purchased,remaining:s.remaining})}}return n}function rx(e,t){let n=[];for(let r of Un){let o=e.byType[r],a=t.byType[r],i=new Map(o.items.map(s=>[s.id,s]));for(let s of a.items){let u=i.get(s.id);u&&u.isAvailable!==s.isAvailable&&n.push({shopType:r,itemId:s.id,wasAvailable:u.isAvailable,isAvailable:s.isAvailable})}}return n}function ax(){let e=$c,t=$c,n=!1,r=[],o={all:new Set,stable:new Set,seedRestock:new Set,toolRestock:new Set,eggRestock:new Set,decorRestock:new Set,purchase:new Set,availability:new Set},a={},i=new Set,s=2;function u(){if(i.size<s)return;let l=Vc(a);if(Te(e,l)||(t=e,e=l,!n))return;for(let g of o.all)g(e,t);if(Kc(t)!==Kc(e))for(let g of o.stable)g(e,t);let c={seed:o.seedRestock,tool:o.toolRestock,egg:o.eggRestock,decor:o.decorRestock};for(let g of Un){let f=nx(t.byType[g],e.byType[g]);if(f)for(let h of c[g])h(f)}let p=ox(t,e);for(let g of p)for(let f of o.purchase)f(g);let m=rx(t,e);for(let g of m)for(let f of o.availability)f(g)}async function d(){if(n)return;let l=await ba.onChangeNow(p=>{a.shops=p,i.add("shops"),u()});r.push(l);let c=await ha.onChangeNow(p=>{a.purchases=p,i.add("purchases"),u()});r.push(c),n=!0,i.size===s&&(e=Vc(a))}return d(),{get(){return e},getShop(l){return e.byType[l]},getItem(l,c){return e.byType[l].items.find(m=>m.id===c)??null},subscribe(l,c){return o.all.add(l),c?.immediate!==!1&&n&&i.size===s&&l(e,e),()=>o.all.delete(l)},subscribeStable(l,c){return o.stable.add(l),c?.immediate!==!1&&n&&i.size===s&&l(e,e),()=>o.stable.delete(l)},subscribeSeedRestock(l,c){return o.seedRestock.add(l),c?.immediate&&n&&i.size===s&&l({shop:e.byType.seed,previousItems:[]}),()=>o.seedRestock.delete(l)},subscribeToolRestock(l,c){return o.toolRestock.add(l),c?.immediate&&n&&i.size===s&&l({shop:e.byType.tool,previousItems:[]}),()=>o.toolRestock.delete(l)},subscribeEggRestock(l,c){return o.eggRestock.add(l),c?.immediate&&n&&i.size===s&&l({shop:e.byType.egg,previousItems:[]}),()=>o.eggRestock.delete(l)},subscribeDecorRestock(l,c){return o.decorRestock.add(l),c?.immediate&&n&&i.size===s&&l({shop:e.byType.decor,previousItems:[]}),()=>o.decorRestock.delete(l)},subscribePurchase(l,c){if(o.purchase.add(l),c?.immediate&&n&&i.size===s)for(let p of e.all)for(let m of p.items)m.purchased>0&&l({shopType:p.type,itemId:m.id,quantity:m.purchased,newPurchased:m.purchased,remaining:m.remaining});return()=>o.purchase.delete(l)},subscribeAvailability(l,c){if(o.availability.add(l),c?.immediate&&n&&i.size===s)for(let p of e.all)for(let m of p.items)l({shopType:p.type,itemId:m.id,wasAvailable:m.isAvailable,isAvailable:m.isAvailable});return()=>o.availability.delete(l)},destroy(){for(let l of r)l();r.length=0,o.all.clear(),o.stable.clear(),o.seedRestock.clear(),o.toolRestock.clear(),o.eggRestock.clear(),o.decorRestock.clear(),o.purchase.clear(),o.availability.clear(),n=!1}}}function bi(){return fi||(fi=ax()),fi}var Un,$c,fi,hi=G(()=>{"use strict";wt();pt();Un=["seed","tool","egg","decor"];$c={all:Un.map(e=>({type:e,items:[],availableCount:0,totalCount:0,secondsUntilRestock:0,restockAt:null})),byType:{seed:{type:"seed",items:[],availableCount:0,totalCount:0,secondsUntilRestock:0,restockAt:null},tool:{type:"tool",items:[],availableCount:0,totalCount:0,secondsUntilRestock:0,restockAt:null},egg:{type:"egg",items:[],availableCount:0,totalCount:0,secondsUntilRestock:0,restockAt:null},decor:{type:"decor",items:[],availableCount:0,totalCount:0,secondsUntilRestock:0,restockAt:null}},nextRestock:null};fi=null});function sx(e){return ix.includes(e)}function lx(e){if(!e)return vi;let t=Date.now(),n=e.endTime??0,r=Math.max(0,n-t),o=Math.floor(r/1e3),a=o>0,i=e.type??"Sunny";return{type:sx(i)?i:"Sunny",isActive:a,startTime:e.startTime??null,endTime:e.endTime??null,remainingSeconds:o}}function cx(){let e=vi,t=vi,n=!1,r=null,o={all:new Set,change:new Set};function a(s){let u=lx(s);if(e.type===u.type&&e.isActive===u.isActive&&e.startTime===u.startTime&&e.endTime===u.endTime){e=u;return}if(t=e,e=u,!!n){for(let d of o.all)d(e,t);if(t.type!==e.type||t.isActive!==e.isActive){let d={current:e,previous:t};for(let l of o.change)l(d)}}}async function i(){n||(r=await ya.onChangeNow(s=>{a(s)}),n=!0)}return i(),{get(){return e},subscribe(s,u){return o.all.add(s),u?.immediate!==!1&&n&&s(e,e),()=>o.all.delete(s)},subscribeChange(s,u){return o.change.add(s),u?.immediate&&n&&s({current:e,previous:e}),()=>o.change.delete(s)},destroy(){r?.(),r=null,o.all.clear(),o.change.clear(),n=!1}}}function xi(){return yi||(yi=cx()),yi}var ix,vi,yi,Si=G(()=>{"use strict";wt();ix=["Sunny","Rain","Frost","Dawn","AmberMoon"];vi={type:"Sunny",isActive:!1,startTime:null,endTime:null,remainingSeconds:0};yi=null});function ux(){let e=le.get("mutations");return e?Object.keys(e):[]}function Xc(){let e={};for(let t of ux())e[t]=[];return e}function Ti(){return{garden:null,mySlotIndex:null,plants:{all:[],mature:[],growing:[],bySpecies:{},count:0},crops:{all:[],mature:[],growing:[],mutated:{all:[],byMutation:Xc()}},eggs:{all:[],mature:[],growing:[],byType:{},count:0},decors:{tileObjects:[],boardwalk:[],all:[],byType:{},count:0},tiles:{tileObjects:[],boardwalk:[],empty:{tileObjects:[],boardwalk:[]}},counts:{plants:0,maturePlants:0,crops:0,matureCrops:0,eggs:0,matureEggs:0,decors:0,emptyTileObjects:0,emptyBoardwalk:0}}}function dx(e,t,n,r){let o=t.slots.filter(a=>r>=a.endTime).length;return{tileIndex:e,position:n,species:t.species,plantedAt:t.plantedAt,maturedAt:t.maturedAt,isMature:r>=t.maturedAt,slots:t.slots,slotsCount:t.slots.length,matureSlotsCount:o}}function px(e,t,n,r,o){return{tileIndex:e,position:t,slotIndex:n,species:r.species,startTime:r.startTime,endTime:r.endTime,targetScale:r.targetScale,mutations:[...r.mutations],isMature:o>=r.endTime}}function mx(e,t,n,r){return{tileIndex:e,position:n,eggId:t.eggId,plantedAt:t.plantedAt,maturedAt:t.maturedAt,isMature:r>=t.maturedAt}}function Jc(e,t,n,r){return{tileIndex:e,position:n,decorId:t.decorId,rotation:t.rotation,location:r}}function qc(e,t){let{garden:n,mySlotIndex:r}=e,o=Date.now();if(!n||r===null)return Ti();let a=t().get(),i=a?.userSlots[r],s=i?.dirtTiles??[],u=i?.boardwalkTiles??[],d=[],l=[],c=[],p={},m=[],g=[],f=[],h=[],b=Xc(),T=[],S=[],v=[],k={},x=[],C=[],P={},M=new Set,D=new Set;for(let[z,X]of Object.entries(n.tileObjects)){let ue=parseInt(z,10);M.add(ue);let V=a?a.globalToXY(ue):{x:0,y:0};if(X.objectType==="plant"){let _=X,H=dx(z,_,V,o);d.push(H),H.isMature?l.push(H):c.push(H),p[H.species]||(p[H.species]=[]),p[H.species].push(H);for(let E=0;E<_.slots.length;E++){let R=_.slots[E],N=px(z,V,E,R,o);if(m.push(N),N.isMature?g.push(N):f.push(N),N.mutations.length>0){h.push(N);for(let O of N.mutations)b[O]||(b[O]=[]),b[O].push(N)}}}else if(X.objectType==="egg"){let H=mx(z,X,V,o);T.push(H),k[H.eggId]||(k[H.eggId]=[]),k[H.eggId].push(H),H.isMature?S.push(H):v.push(H)}else if(X.objectType==="decor"){let H=Jc(z,X,V,"tileObjects");x.push(H),P[H.decorId]||(P[H.decorId]=[]),P[H.decorId].push(H)}}for(let[z,X]of Object.entries(n.boardwalkTileObjects)){let ue=parseInt(z,10);D.add(ue);let V=a?a.globalToXY(ue):{x:0,y:0},H=Jc(z,X,V,"boardwalk");C.push(H),P[H.decorId]||(P[H.decorId]=[]),P[H.decorId].push(H)}let L=[...x,...C],W=s.filter(z=>!M.has(z.localIndex)),oe=u.filter(z=>!D.has(z.localIndex));return{garden:n,mySlotIndex:r,plants:{all:d,mature:l,growing:c,bySpecies:p,count:d.length},crops:{all:m,mature:g,growing:f,mutated:{all:h,byMutation:b}},eggs:{all:T,mature:S,growing:v,byType:k,count:T.length},decors:{tileObjects:x,boardwalk:C,all:L,byType:P,count:L.length},tiles:{tileObjects:s,boardwalk:u,empty:{tileObjects:W,boardwalk:oe}},counts:{plants:d.length,maturePlants:l.length,crops:m.length,matureCrops:g.length,eggs:T.length,matureEggs:S.length,decors:L.length,emptyTileObjects:W.length,emptyBoardwalk:oe.length}}}function Yc(e){return JSON.stringify({plants:e.counts.plants,maturePlants:e.counts.maturePlants,crops:e.counts.crops,matureCrops:e.counts.matureCrops,eggs:e.counts.eggs,matureEggs:e.counts.matureEggs,decors:e.counts.decors,emptyTileObjects:e.counts.emptyTileObjects,emptyBoardwalk:e.counts.emptyBoardwalk})}function gx(e,t){let n=new Set(e.map(i=>i.tileIndex)),r=new Set(t.map(i=>i.tileIndex)),o=t.filter(i=>!n.has(i.tileIndex)),a=e.filter(i=>!r.has(i.tileIndex));return{added:o,removed:a}}function fx(e,t,n){let r=new Set(e.map(a=>a.tileIndex)),o=new Set(n.map(a=>a.tileIndex));return t.filter(a=>!r.has(a.tileIndex)&&o.has(a.tileIndex))}function bx(e,t,n){let r=new Set(e.map(a=>`${a.tileIndex}:${a.slotIndex}`)),o=new Set(n.map(a=>`${a.tileIndex}:${a.slotIndex}`));return t.filter(a=>{let i=`${a.tileIndex}:${a.slotIndex}`;return!r.has(i)&&o.has(i)})}function hx(e,t,n){let r=new Set(e.map(a=>a.tileIndex)),o=new Set(n.map(a=>a.tileIndex));return t.filter(a=>!r.has(a.tileIndex)&&o.has(a.tileIndex))}function yx(e,t){let n=[],r=new Map(e.map(o=>[o.tileIndex,o]));for(let o of t){let a=r.get(o.tileIndex);if(!a)continue;let i=Math.min(a.slots.length,o.slots.length);for(let s=0;s<i;s++){let u=new Set(a.slots[s].mutations),d=new Set(o.slots[s].mutations),l=[...d].filter(p=>!u.has(p)),c=[...u].filter(p=>!d.has(p));if(l.length>0||c.length>0){let p=Date.now(),m=o.slots[s],g={tileIndex:o.tileIndex,position:o.position,slotIndex:s,species:m.species,startTime:m.startTime,endTime:m.endTime,targetScale:m.targetScale,mutations:[...m.mutations],isMature:p>=m.endTime};n.push({crop:g,added:l,removed:c})}}}return n}function vx(e,t,n){let r=[],o=new Map(t.map(i=>[i.tileIndex,i])),a=new Map;for(let i of n)a.set(`${i.tileIndex}:${i.slotIndex}`,i);for(let i of e){let s=o.get(i.tileIndex);if(!s)continue;let u=Math.min(i.slots.length,s.slots.length);for(let d=0;d<u;d++){let l=i.slots[d],c=s.slots[d];if(l.startTime!==c.startTime){let p=a.get(`${i.tileIndex}:${d}`);if(!p||!p.isMature)continue;let m={tileIndex:i.tileIndex,position:i.position,slotIndex:d,species:l.species,startTime:l.startTime,endTime:l.endTime,targetScale:l.targetScale,mutations:[...l.mutations],isMature:!0};r.push({crop:m,remainingSlots:s.slotsCount})}}if(s.slotsCount<i.slotsCount)for(let d=s.slotsCount;d<i.slotsCount;d++){let l=a.get(`${i.tileIndex}:${d}`);if(!l||!l.isMature)continue;let c=i.slots[d];if(!c)continue;let p={tileIndex:i.tileIndex,position:i.position,slotIndex:d,species:c.species,startTime:c.startTime,endTime:c.endTime,targetScale:c.targetScale,mutations:[...c.mutations],isMature:!0};r.push({crop:p,remainingSlots:s.slotsCount})}}return r}function xx(e,t){let n=new Set(e.map(i=>i.tileIndex)),r=new Set(t.map(i=>i.tileIndex)),o=t.filter(i=>!n.has(i.tileIndex)),a=e.filter(i=>!r.has(i.tileIndex));return{added:o,removed:a}}function Sx(e,t){let n=u=>`${u.tileIndex}:${u.location}`,r=u=>`${u.tileIndex}:${u.location}`,o=new Set(e.map(n)),a=new Set(t.map(r)),i=t.filter(u=>!o.has(r(u))),s=e.filter(u=>!a.has(n(u)));return{added:i,removed:s}}function wx(){let e=Ti(),t=Ti(),n=!1,r=[],o={all:new Set,stable:new Set,plantAdded:new Set,plantRemoved:new Set,plantMatured:new Set,cropMutated:new Set,cropMatured:new Set,cropHarvested:new Set,eggPlaced:new Set,eggRemoved:new Set,eggMatured:new Set,decorPlaced:new Set,decorRemoved:new Set},a={},i=new Set,s=2;function u(){if(i.size<s)return;let l=qc(a,Xt);if(Te(e,l)||(t=e,e=l,!n))return;for(let S of o.all)S(e,t);if(Yc(t)!==Yc(e))for(let S of o.stable)S(e,t);let c=gx(t.plants.all,e.plants.all);for(let S of c.added)for(let v of o.plantAdded)v({plant:S});for(let S of c.removed)for(let v of o.plantRemoved)v({plant:S,tileIndex:S.tileIndex});let p=fx(t.plants.mature,e.plants.mature,e.plants.all);for(let S of p)for(let v of o.plantMatured)v({plant:S});let m=yx(t.plants.all,e.plants.all);for(let S of m)for(let v of o.cropMutated)v(S);let g=bx(t.crops.mature,e.crops.mature,e.crops.all);for(let S of g)for(let v of o.cropMatured)v({crop:S});let f=vx(t.plants.all,e.plants.all,t.crops.all);for(let S of f)for(let v of o.cropHarvested)v(S);let h=xx(t.eggs.all,e.eggs.all);for(let S of h.added)for(let v of o.eggPlaced)v({egg:S});for(let S of h.removed)for(let v of o.eggRemoved)v({egg:S});let b=hx(t.eggs.mature,e.eggs.mature,e.eggs.all);for(let S of b)for(let v of o.eggMatured)v({egg:S});let T=Sx(t.decors.all,e.decors.all);for(let S of T.added)for(let v of o.decorPlaced)v({decor:S});for(let S of T.removed)for(let v of o.decorRemoved)v({decor:S})}async function d(){if(n)return;let l=await fa.onChangeNow(p=>{a.garden=p,i.add("garden"),u()});r.push(l);let c=await te.subscribe("myUserSlotIdxAtom",p=>{a.mySlotIndex=p,i.add("mySlotIndex"),u()});r.push(c),n=!0,i.size===s&&(e=qc(a,Xt))}return d(),{get(){return e},subscribe(l,c){return o.all.add(l),c?.immediate!==!1&&n&&i.size===s&&l(e,e),()=>o.all.delete(l)},subscribeStable(l,c){return o.stable.add(l),c?.immediate!==!1&&n&&i.size===s&&l(e,e),()=>o.stable.delete(l)},subscribePlantAdded(l,c){if(o.plantAdded.add(l),c?.immediate&&n&&i.size===s)for(let p of e.plants.all)l({plant:p});return()=>o.plantAdded.delete(l)},subscribePlantRemoved(l,c){return o.plantRemoved.add(l),()=>o.plantRemoved.delete(l)},subscribePlantMatured(l,c){if(o.plantMatured.add(l),c?.immediate&&n&&i.size===s)for(let p of e.plants.mature)l({plant:p});return()=>o.plantMatured.delete(l)},subscribeCropMutated(l,c){if(o.cropMutated.add(l),c?.immediate&&n&&i.size===s)for(let p of e.crops.mutated.all)l({crop:p,added:p.mutations,removed:[]});return()=>o.cropMutated.delete(l)},subscribeCropMatured(l,c){if(o.cropMatured.add(l),c?.immediate&&n&&i.size===s)for(let p of e.crops.mature)l({crop:p});return()=>o.cropMatured.delete(l)},subscribeCropHarvested(l,c){return o.cropHarvested.add(l),()=>o.cropHarvested.delete(l)},subscribeEggPlaced(l,c){if(o.eggPlaced.add(l),c?.immediate&&n&&i.size===s)for(let p of e.eggs.all)l({egg:p});return()=>o.eggPlaced.delete(l)},subscribeEggRemoved(l,c){return o.eggRemoved.add(l),()=>o.eggRemoved.delete(l)},subscribeEggMatured(l,c){if(o.eggMatured.add(l),c?.immediate&&n&&i.size===s)for(let p of e.eggs.mature)l({egg:p});return()=>o.eggMatured.delete(l)},subscribeDecorPlaced(l,c){if(o.decorPlaced.add(l),c?.immediate&&n&&i.size===s)for(let p of e.decors.all)l({decor:p});return()=>o.decorPlaced.delete(l)},subscribeDecorRemoved(l,c){return o.decorRemoved.add(l),()=>o.decorRemoved.delete(l)},destroy(){for(let l of r)l();r.length=0,o.all.clear(),o.stable.clear(),o.plantAdded.clear(),o.plantRemoved.clear(),o.plantMatured.clear(),o.cropMutated.clear(),o.cropMatured.clear(),o.cropHarvested.clear(),o.eggPlaced.clear(),o.eggRemoved.clear(),o.eggMatured.clear(),o.decorPlaced.clear(),o.decorRemoved.clear(),n=!1}}}function ki(){return wi||(wi=wx()),wi}var wi,Ci=G(()=>{"use strict";wt();Fe();dr();pt();ut();wi=null});function mr(){return ke||(ke={currentTile:ni(),myPets:ai(),gameMap:Xt(),myInventory:ci(),players:mi(),shops:bi(),weather:xi(),myGarden:ki()},ke)}function qe(){if(!ke)throw new Error("[Globals] Not initialized. Call initGlobals() first.");return ke}function Qc(){ke&&(ke.currentTile.destroy(),ke.myPets.destroy(),ke.gameMap.destroy(),ke.myInventory.destroy(),ke.players.destroy(),ke.shops.destroy(),ke.weather.destroy(),ke.myGarden.destroy(),ke=null)}var ke,gr,fr=G(()=>{"use strict";Ic();pt();oi();ii();dr();ui();gi();hi();Si();Ci();oi();ii();dr();ui();gi();hi();Si();Ci();ke=null;gr={get currentTile(){return qe().currentTile},get myPets(){return qe().myPets},get gameMap(){return qe().gameMap},get myInventory(){return qe().myInventory},get players(){return qe().players},get shops(){return qe().shops},get weather(){return qe().weather},get myGarden(){return qe().myGarden}}});function Zc(){return Lt||(Lt=new zn,Lt.init()),Lt}function eu(){Lt&&(Lt.destroy(),Lt=null)}var zn,Lt,tu=G(()=>{"use strict";fr();zn=class{constructor(){ne(this,"logs",[]);ne(this,"maxLogs",1e3);ne(this,"unsubscribe",null);ne(this,"isInitialized",!1)}init(){this.isInitialized||(this.unsubscribe=gr.myPets.subscribeAbility(t=>{this.log({abilityId:t.trigger.abilityId||"unknown",petId:t.pet.id,petSpecies:t.pet.petSpecies,petName:t.pet.name,timestamp:t.trigger.performedAt||Date.now()})}),this.isInitialized=!0)}log(t){let n={...t,id:`${t.timestamp}-${Math.random().toString(36).substr(2,9)}`};this.logs.push(n),this.logs.length>this.maxLogs&&(this.logs=this.logs.slice(-this.maxLogs))}getLogs(t){let n=this.logs;t?.abilityId&&(n=n.filter(o=>o.abilityId===t.abilityId)),t?.petId&&(n=n.filter(o=>o.petId===t.petId)),t?.petSpecies&&(n=n.filter(o=>o.petSpecies===t.petSpecies));let{since:r}=t??{};return r!==void 0&&(n=n.filter(o=>o.timestamp>=r)),t?.limit&&(n=n.slice(-t.limit)),n}getStats(t=36e5){let n=Date.now()-t,r=this.logs.filter(a=>a.timestamp>=n),o=new Map;for(let a of r){o.has(a.abilityId)||o.set(a.abilityId,{abilityId:a.abilityId,count:0,procsPerMinute:0,procsPerHour:0,lastProc:null});let i=o.get(a.abilityId);i.count++,(!i.lastProc||a.timestamp>i.lastProc)&&(i.lastProc=a.timestamp)}for(let a of o.values())a.procsPerMinute=a.count/t*6e4,a.procsPerHour=a.count/t*36e5;return o}getAbilityStats(t,n=36e5){return this.getStats(n).get(t)||null}getPetStats(t,n=36e5){let r=Date.now()-n,o=this.logs.filter(i=>i.petId===t&&i.timestamp>=r),a=new Map;for(let i of o){a.has(i.abilityId)||a.set(i.abilityId,{abilityId:i.abilityId,count:0,procsPerMinute:0,procsPerHour:0,lastProc:null});let s=a.get(i.abilityId);s.count++,(!s.lastProc||i.timestamp>s.lastProc)&&(s.lastProc=i.timestamp)}for(let i of a.values())i.procsPerMinute=i.count/n*6e4,i.procsPerHour=i.count/n*36e5;return{totalProcs:o.length,abilities:a}}getTopAbilities(t=10,n=36e5){return Array.from(this.getStats(n).values()).sort((o,a)=>a.count-o.count).slice(0,t)}clear(){this.logs=[]}setMaxLogs(t){this.maxLogs=t,this.logs.length>t&&(this.logs=this.logs.slice(-t))}getLogCount(){return this.logs.length}isActive(){return this.isInitialized}destroy(){this.unsubscribe&&(this.unsubscribe(),this.unsubscribe=null),this.logs=[],this.isInitialized=!1}},Lt=null});function nu(){return Qt||(Qt=new Vn),Qt}function ou(){Qt&&(Qt.endSession(),Qt=null)}var Vn,Qt,ru=G(()=>{"use strict";Vn=class{constructor(){ne(this,"stats");ne(this,"storageKey","gemini_stats");this.stats=this.loadStats(),this.startSession()}loadStats(){try{let t=localStorage.getItem(this.storageKey);if(t)return JSON.parse(t)}catch(t){console.warn("[StatsTracker] Failed to load stats:",t)}return this.getDefaultStats()}saveStats(){try{localStorage.setItem(this.storageKey,JSON.stringify(this.stats))}catch(t){console.warn("[StatsTracker] Failed to save stats:",t)}}getDefaultStats(){return{session:{sessionStart:Date.now(),sessionEnd:null,coinsEarned:0,coinsSpent:0,cropsHarvested:0,cropsSold:0,petsHatched:0,petsSold:0,petsFed:0,seedsPurchased:0,eggsPurchased:0,abilityProcs:0},allTime:{totalSessions:0,totalPlayTime:0,coinsEarned:0,coinsSpent:0,cropsHarvested:0,cropsSold:0,petsHatched:0,petsSold:0,petsFed:0,seedsPurchased:0,eggsPurchased:0,abilityProcs:0,crops:{},pets:{}}}}startSession(){this.stats.session={sessionStart:Date.now(),sessionEnd:null,coinsEarned:0,coinsSpent:0,cropsHarvested:0,cropsSold:0,petsHatched:0,petsSold:0,petsFed:0,seedsPurchased:0,eggsPurchased:0,abilityProcs:0},this.stats.allTime.totalSessions++,this.saveStats()}endSession(){this.stats.session.sessionEnd=Date.now();let t=this.stats.session.sessionEnd-this.stats.session.sessionStart;this.stats.allTime.totalPlayTime+=t,this.saveStats()}recordHarvest(t,n=1,r=[]){this.stats.session.cropsHarvested+=n,this.stats.allTime.cropsHarvested+=n,this.stats.allTime.crops[t]||(this.stats.allTime.crops[t]={harvested:0,sold:0,totalValue:0,mutations:{}}),this.stats.allTime.crops[t].harvested+=n;for(let o of r)this.stats.allTime.crops[t].mutations[o]||(this.stats.allTime.crops[t].mutations[o]=0),this.stats.allTime.crops[t].mutations[o]++;this.saveStats()}recordCropSale(t,n=1,r=0){this.stats.session.cropsSold+=n,this.stats.session.coinsEarned+=r,this.stats.allTime.cropsSold+=n,this.stats.allTime.coinsEarned+=r,this.stats.allTime.crops[t]||(this.stats.allTime.crops[t]={harvested:0,sold:0,totalValue:0,mutations:{}}),this.stats.allTime.crops[t].sold+=n,this.stats.allTime.crops[t].totalValue+=r,this.saveStats()}recordPetHatch(t,n=[],r=[]){this.stats.session.petsHatched++,this.stats.allTime.petsHatched++,this.stats.allTime.pets[t]||(this.stats.allTime.pets[t]={hatched:0,sold:0,fed:0,mutations:{},abilities:{}}),this.stats.allTime.pets[t].hatched++;for(let o of n)this.stats.allTime.pets[t].mutations[o]||(this.stats.allTime.pets[t].mutations[o]=0),this.stats.allTime.pets[t].mutations[o]++;for(let o of r)this.stats.allTime.pets[t].abilities[o]||(this.stats.allTime.pets[t].abilities[o]=0),this.stats.allTime.pets[t].abilities[o]++;this.saveStats()}recordPetSale(t,n=0){this.stats.session.petsSold++,this.stats.session.coinsEarned+=n,this.stats.allTime.petsSold++,this.stats.allTime.coinsEarned+=n,this.stats.allTime.pets[t]||(this.stats.allTime.pets[t]={hatched:0,sold:0,fed:0,mutations:{},abilities:{}}),this.stats.allTime.pets[t].sold++,this.saveStats()}recordPetFeed(t){this.stats.session.petsFed++,this.stats.allTime.petsFed++,this.stats.allTime.pets[t]||(this.stats.allTime.pets[t]={hatched:0,sold:0,fed:0,mutations:{},abilities:{}}),this.stats.allTime.pets[t].fed++,this.saveStats()}recordSeedPurchase(t,n=1,r=0){this.stats.session.seedsPurchased+=n,this.stats.session.coinsSpent+=r,this.stats.allTime.seedsPurchased+=n,this.stats.allTime.coinsSpent+=r,this.saveStats()}recordEggPurchase(t,n=1,r=0){this.stats.session.eggsPurchased+=n,this.stats.session.coinsSpent+=r,this.stats.allTime.eggsPurchased+=n,this.stats.allTime.coinsSpent+=r,this.saveStats()}recordAbilityProc(t){this.stats.session.abilityProcs++,this.stats.allTime.abilityProcs++,this.saveStats()}recordCoinsEarned(t){this.stats.session.coinsEarned+=t,this.stats.allTime.coinsEarned+=t,this.saveStats()}recordCoinsSpent(t){this.stats.session.coinsSpent+=t,this.stats.allTime.coinsSpent+=t,this.saveStats()}getStats(){return{...this.stats}}getSessionStats(){return{...this.stats.session}}getAllTimeStats(){return{...this.stats.allTime}}getCropStats(t){return this.stats.allTime.crops[t]||null}getPetStats(t){return this.stats.allTime.pets[t]||null}getTopCrops(t=10){return Object.entries(this.stats.allTime.crops).map(([n,r])=>({species:n,stats:r})).sort((n,r)=>r.stats.harvested-n.stats.harvested).slice(0,t)}getTopPets(t=10){return Object.entries(this.stats.allTime.pets).map(([n,r])=>({species:n,stats:r})).sort((n,r)=>r.stats.hatched-n.stats.hatched).slice(0,t)}resetSession(){this.startSession()}resetAll(){this.stats=this.getDefaultStats(),this.saveStats()}exportStats(){return JSON.stringify(this.stats,null,2)}importStats(t){try{let n=JSON.parse(t);return this.stats=n,this.saveStats(),!0}catch(n){return console.warn("[StatsTracker] Failed to import stats:",n),!1}}},Qt=null});async function su(e){let t=[{name:"Data",init:()=>le.init()},{name:"AntiAfk",init:()=>wn.init()},{name:"CustomModal",init:()=>Dn.init()},{name:"Sprites",init:()=>de.init()},{name:"TileObjectSystem",init:()=>Je.init()},{name:"Pixi",init:()=>On.init()},{name:"Audio",init:()=>Wn.init()},{name:"Cosmetics",init:()=>Fn.init()}];await Promise.all(t.map(async n=>{e?.({status:"start",name:n.name});try{await n.init(),e?.({status:"success",name:n.name})}catch(r){console.error(`[${n.name}] failed`,r),e?.({status:"error",name:n.name,error:r})}})),console.log("[Gemini] Modules ready. Access via Gemini.Modules in console.")}var au,iu,$n=G(()=>{"use strict";Wr();Ft();xn();ut();na();Gt();Pa();fn();Vt();Xo();Wa();Fa();Va();vc();ur();Ac();tu();ru();ut();na();Pa();Vt();Xo();Wa();Fa();Va();au={AbilityLogger:zn,getAbilityLogger:Zc,destroyAbilityLogger:eu,...ei},iu={StatsTracker:Vn,getStatsTracker:nu,destroyStatsTracker:ou}});function ze(e,t){try{let n=e.startsWith(Zt)?e:Zt+e,r=localStorage.getItem(n);return r===null?t:JSON.parse(r)}catch(n){return console.error(`[Storage] Error reading key "${e}":`,n),t}}function nt(e,t){try{let n=e.startsWith(Zt)?e:Zt+e,r=e.startsWith(Zt)?e.slice(Zt.length):e;localStorage.setItem(n,JSON.stringify(t)),window.dispatchEvent(new CustomEvent("gemini:storage:change",{detail:{key:r,value:t}}))}catch(n){console.error(`[Storage] Error writing key "${e}":`,n)}}var Zt,Kn=G(()=>{"use strict";Zt="gemini:"});function Pi(e){return!!e&&e.readyState===uu}function Tx(){if(Pi(Ee.latestOpen))return Ee.latestOpen;for(let e=Ee.captured.length-1;e>=0;e--){let t=Ee.captured[e];if(Pi(t))return t}return null}function kx(e,t){Ee.captured.push(e),Ee.captured.length>25&&Ee.captured.splice(0,Ee.captured.length-25);let n=()=>{Ee.latestOpen=e,t&&console.log("[WS] captured socket opened",e.url)};e.addEventListener("open",n),e.addEventListener("close",()=>{Ee.latestOpen===e&&(Ee.latestOpen=null),t&&console.log("[WS] captured socket closed",e.url)}),e.readyState===uu&&n()}function du(e=A,t={}){let n=!!t.debug,r=e?.WebSocket;if(typeof r!="function")return()=>{};if(r[lu])return Ee.nativeCtor=r[cu]??Ee.nativeCtor??null,()=>{};let o=r;Ee.nativeCtor=o;function a(i,s){let u=s!==void 0?new o(i,s):new o(i);try{kx(u,n)}catch{}return u}try{a.prototype=o.prototype}catch{}try{Object.setPrototypeOf(a,o)}catch{}try{a.CONNECTING=o.CONNECTING,a.OPEN=o.OPEN,a.CLOSING=o.CLOSING,a.CLOSED=o.CLOSED}catch{}a[lu]=!0,a[cu]=o;try{e.WebSocket=a,n&&console.log("[WS] WebSocket capture installed")}catch{return()=>{}}return()=>{try{e.WebSocket===a&&(e.WebSocket=o)}catch{}}}function Cx(e=A){let t=e?.MagicCircle_RoomConnection?.currentWebSocket;return t&&typeof t=="object"?t:null}function Jn(e=A){let t=Tx();if(t)return{ws:t,source:"captured"};let n=Cx(e);return n?{ws:n,source:"roomConnection"}:{ws:null,source:null}}function br(e,t={}){let n=t.pageWindow??A,r=t.intervalMs??500,o=!!t.debug,a=null,i=null,s=()=>{let d=Jn(n);(d.ws!==a||d.source!==i)&&(a=d.ws,i=d.source,o&&console.log("[WS] best socket changed:",d.source,d.ws),e(d))};s();let u=setInterval(s,r);return()=>clearInterval(u)}function Px(e){if(typeof e=="string")return e;try{return JSON.stringify(e)}catch{return null}}function Mx(e,t=A){let n=t?.MagicCircle_RoomConnection;if(n&&typeof n.sendMessage=="function")try{return Array.isArray(e)?n.sendMessage(...e):n.sendMessage(e),{ok:!0}}catch(a){return{ok:!1,reason:"error",error:a}}let{ws:r}=Jn(t);if(!r)return{ok:!1,reason:"no-ws"};if(!Pi(r))return{ok:!1,reason:"not-open"};let o=Px(e);if(o==null)return{ok:!1,reason:"error",error:new Error("Cannot stringify message")};try{return r.send(o),{ok:!0}}catch(a){return{ok:!1,reason:"error",error:a}}}function pu(e,t={},n=A){return Mx({type:e,...t},n)}var Ee,lu,cu,uu,hr=G(()=>{"use strict";ve();Ee={nativeCtor:null,captured:[],latestOpen:null},lu=Symbol.for("ariesmod.ws.capture.wrapped"),cu=Symbol.for("ariesmod.ws.capture.native"),uu=1});var Ye,I,G0,H0,ot=G(()=>{"use strict";Ye={Welcome:"Welcome",PartialState:"PartialState",ServerErrorMessage:"ServerErrorMessage",Config:"Config",InappropriateContentRejected:"InappropriateContentRejected",Emote:"Emote",CurrencyTransaction:"CurrencyTransaction",Pong:"Pong"},I={Chat:"Chat",Emote:"Emote",Wish:"Wish",KickPlayer:"KickPlayer",SetPlayerData:"SetPlayerData",UsurpHost:"UsurpHost",Dev:"Dev",SetSelectedGame:"SetSelectedGame",VoteForGame:"VoteForGame",RequestGame:"RequestGame",RestartGame:"RestartGame",Ping:"Ping",PlayerPosition:"PlayerPosition",Teleport:"Teleport",CheckWeatherStatus:"CheckWeatherStatus",MoveInventoryItem:"MoveInventoryItem",DropObject:"DropObject",PickupObject:"PickupObject",ToggleFavoriteItem:"ToggleFavoriteItem",PutItemInStorage:"PutItemInStorage",RetrieveItemFromStorage:"RetrieveItemFromStorage",MoveStorageItem:"MoveStorageItem",LogItems:"LogItems",PlantSeed:"PlantSeed",WaterPlant:"WaterPlant",HarvestCrop:"HarvestCrop",SellAllCrops:"SellAllCrops",PurchaseSeed:"PurchaseSeed",PurchaseEgg:"PurchaseEgg",PurchaseTool:"PurchaseTool",PurchaseDecor:"PurchaseDecor",PlantEgg:"PlantEgg",HatchEgg:"HatchEgg",PlantGardenPlant:"PlantGardenPlant",PotPlant:"PotPlant",MutationPotion:"MutationPotion",PickupDecor:"PickupDecor",PlaceDecor:"PlaceDecor",RemoveGardenObject:"RemoveGardenObject",PlacePet:"PlacePet",FeedPet:"FeedPet",PetPositions:"PetPositions",SwapPet:"SwapPet",StorePet:"StorePet",NamePet:"NamePet",SellPet:"SellPet",ReportSpeakingStart:"ReportSpeakingStart"},G0=new Set(Object.values(Ye)),H0=new Set(Object.values(I))});function q(e,t={},n=A){return pu(e,t,n)}function mu(e,t=A){return q(I.Chat,{scopePath:["Room"],message:e},t)}function gu(e,t=A){return q(I.Emote,{scopePath:["Room"],emoteType:e},t)}function fu(e,t=A){return q(I.Wish,{wish:e},t)}function bu(e,t=A){return q(I.KickPlayer,{scopePath:["Room"],playerId:e},t)}function hu(e,t=A){return q(I.SetPlayerData,{scopePath:["Room"],data:e},t)}function yu(e=A){return q(I.UsurpHost,{},e)}function vu(e=A){return q(I.ReportSpeakingStart,{},e)}function xu(e,t=A){return q(I.SetSelectedGame,{scopePath:["Room"],gameId:e},t)}function Su(e,t=A){return q(I.VoteForGame,{scopePath:["Room"],gameId:e},t)}function wu(e,t=A){return q(I.RequestGame,{scopePath:["Room"],gameId:e},t)}function Tu(e=A){return q(I.RestartGame,{scopePath:["Room"]},e)}function ku(e,t=A){return q(I.Ping,{id:e},t)}function Mi(e,t,n=A){return q(I.PlayerPosition,{x:e,y:t},n)}function Pu(e,t,n=A){return q(I.Teleport,{x:e,y:t},n)}function Mu(e=A){return q(I.CheckWeatherStatus,{},e)}function Au(e,t,n=A){return q(I.MoveInventoryItem,{fromIndex:e,toIndex:t},n)}function Iu(e,t=A){return q(I.DropObject,{slotIndex:e},t)}function Eu(e,t=A){return q(I.PickupObject,{objectId:e},t)}function Lu(e,t,n=A){return q(I.ToggleFavoriteItem,{itemId:e,favorite:t},n)}function Du(e,t=A){return q(I.PutItemInStorage,{itemId:e},t)}function Ru(e,t=A){return q(I.RetrieveItemFromStorage,{itemId:e},t)}function Ou(e,t,n=A){return q(I.MoveStorageItem,{fromIndex:e,toIndex:t},n)}function Gu(e=A){return q(I.LogItems,{},e)}function Hu(e,t,n,r=A){return q(I.PlantSeed,{seedId:e,x:t,y:n},r)}function Nu(e,t=A){return q(I.WaterPlant,{plantId:e},t)}function _u(e,t=A){return q(I.HarvestCrop,{cropId:e},t)}function Wu(e=A){return q(I.SellAllCrops,{},e)}function Fu(e,t=A){return q(I.PurchaseDecor,{decorId:e},t)}function Bu(e,t=A){return q(I.PurchaseEgg,{eggId:e},t)}function ju(e,t=A){return q(I.PurchaseTool,{toolId:e},t)}function Uu(e,t=A){return q(I.PurchaseSeed,{seedId:e},t)}function zu(e,t,n,r=A){return q(I.PlantEgg,{eggId:e,x:t,y:n},r)}function Vu(e,t=A){return q(I.HatchEgg,{eggId:e},t)}function $u(e,t,n,r=A){return q(I.PlantGardenPlant,{plantId:e,x:t,y:n},r)}function Ku(e,t,n=A){return q(I.PotPlant,{plantId:e,potId:t},n)}function Ju(e,t,n=A){return q(I.MutationPotion,{potionId:e,targetId:t},n)}function qu(e,t=A){return q(I.PickupDecor,{decorInstanceId:e},t)}function Yu(e,t,n,r=A){return q(I.PlaceDecor,{decorId:e,x:t,y:n},r)}function Xu(e,t=A){return q(I.RemoveGardenObject,{objectId:e},t)}function Qu(e,t,n,r=A){return q(I.PlacePet,{petId:e,x:t,y:n},r)}function Zu(e,t,n=A){return q(I.FeedPet,{petId:e,foodItemId:t},n)}function ed(e,t=A){return q(I.PetPositions,{positions:e},t)}function td(e,t,n=A){return q(I.SwapPet,{petIdA:e,petIdB:t},n)}function nd(e,t=A){return q(I.StorePet,{petId:e},t)}function od(e,t,n=A){return q(I.NamePet,{petId:e,name:t},n)}function rd(e,t=A){return q(I.SellPet,{petId:e},t)}var Cu,ad=G(()=>{"use strict";hr();ot();ve();Cu=Mi});function id(){A.Gemini=en}var en,yr=G(()=>{"use strict";ve();Fe();fr();ad();$n();en={Store:{select:te.select.bind(te),set:te.set.bind(te),subscribe:te.subscribe.bind(te),subscribeImmediate:te.subscribeImmediate.bind(te)},Globals:gr,Modules:{Version:yn,Assets:Be,Manifest:Oe,Data:le,AntiAfk:wn,Environment:De,CustomModal:Dn,Sprite:de,Tile:Je,Pixi:On,Audio:Wn,Cosmetic:Fn,Achievements:rr,Calculators:cr,Pets:au,Tracker:iu},WebSocket:{chat:mu,emote:gu,wish:fu,kickPlayer:bu,setPlayerData:hu,usurpHost:yu,reportSpeakingStart:vu,setSelectedGame:xu,voteForGame:Su,requestGame:wu,restartGame:Tu,ping:ku,checkWeatherStatus:Mu,move:Cu,playerPosition:Mi,teleport:Pu,moveInventoryItem:Au,dropObject:Iu,pickupObject:Eu,toggleFavoriteItem:Lu,putItemInStorage:Du,retrieveItemFromStorage:Ru,moveStorageItem:Ou,logItems:Gu,plantSeed:Hu,waterPlant:Nu,harvestCrop:_u,sellAllCrops:Wu,purchaseDecor:Fu,purchaseEgg:Bu,purchaseTool:ju,purchaseSeed:Uu,plantEgg:zu,hatchEgg:Vu,plantGardenPlant:$u,potPlant:Ku,mutationPotion:Ju,pickupDecor:qu,placeDecor:Yu,removeGardenObject:Xu,placePet:Qu,feedPet:Zu,petPositions:ed,swapPet:td,storePet:nd,namePet:od,sellPet:rd},_internal:{getGlobals:qe,initGlobals:mr,destroyGlobals:Qc}}});var cd={};Ot(cd,{getGameMutations:()=>Gx,setEnabled:()=>Ox,start:()=>sd,stop:()=>ld,updateSimpleConfig:()=>Rx});function sd(){let e=ze("gemini:features:autoFavorite",Ii);if(!e.enabled){console.log("[AutoFavorite] Disabled");return}qn.clear(),vr=en.Globals.myInventory.subscribeItems(t=>{if(t.added.length>0)for(let n of t.added)Ix(n,e)}),console.log(`\u2705 [AutoFavorite] Started - Watching ${e.simple.favoriteSpecies.length} species, ${e.simple.favoriteMutations.length} mutations`)}function ld(){vr&&(vr(),vr=null),qn.clear(),console.log("\u{1F6D1} [AutoFavorite] Stopped")}function Ix(e,t){if(e.itemType!=="Produce"&&e.itemType!=="Pet")return;let n=e.id;if(!n){console.warn("[AutoFavorite] Item has no ID:",e);return}if(qn.has(n))return;if(e.isFavorited||e.favorited||!1){console.log(`[AutoFavorite] Already favorited: ${e.species||n}`);return}if(Ex(e,t.simple)){qn.add(n);try{let a=en.WebSocket.toggleFavoriteItem(n,!0);console.log(`[AutoFavorite] \u2B50 Favorited ${e.itemType}: ${e.species||n}`,{itemId:n,webSocketResult:a})}catch(a){console.error("[AutoFavorite] WebSocket error:",a),qn.delete(n)}}}function Ex(e,t){if(!t.enabled)return!1;let n=e.species||e.itemType||"",r=Lx(n);return!!(t.favoriteSpecies.includes(r)||t.favoriteMutations.length>0&&Dx(n).some(a=>t.favoriteMutations.includes(a)))}function Lx(e){let t=e;for(let n of Ai)t=t.replace(n,"").trim();return t}function Dx(e){let t=[];for(let n of Ai)e.includes(n)&&t.push(n);return t}function Rx(e){let t=ze("gemini:features:autoFavorite",Ii);t.mode="simple",t.simple={...t.simple,...e},nt("gemini:features:autoFavorite",t)}function Ox(e){let t=ze("gemini:features:autoFavorite",Ii);t.enabled=e,t.simple.enabled=e,nt("gemini:features:autoFavorite",t),e?sd():ld()}function Gx(){return Ai}var Ai,Ii,vr,qn,ud=G(()=>{"use strict";yr();Kn();Ai=["Gold","Rainbow","Wet","Chilled","Frozen","Dawnlit","Ambershine","Dawncharged","Ambercharged"],Ii={enabled:!1,mode:"simple",simple:{enabled:!1,favoriteSpecies:[],favoriteMutations:[]}},vr=null,qn=new Set});var bd={};Ot(bd,{aggregateJournalProgress:()=>Ei,refresh:()=>_x,setEnabled:()=>Nx,start:()=>gd,stop:()=>fd});async function Ei(){await le.waitForAnyData();let e=le.get("plants")||{},t=le.get("pets")||{},n=le.get("decor")||{},o=en.Globals.players.get()?.host?.journal||{pets:{},produce:{}},a=Object.keys(o.pets||{}),i=Object.keys(o.produce||{}),s=Object.keys(e),u=Object.keys(t),d=Object.keys(n);return{plants:{total:s.length,logged:i.length,percentage:s.length>0?i.length/s.length*100:0,missing:s.filter(l=>!i.includes(l))},pets:{total:u.length,logged:a.length,percentage:u.length>0?a.length/u.length*100:0,missing:u.filter(l=>!a.includes(l))},decor:{total:d.length,logged:0,percentage:0,missing:d}}}function gd(){let e=ze("gemini:features:journalChecker",md);e.enabled&&(e.autoRefresh&&!Yn&&(Yn=setInterval(async()=>{let t=await Ei();window.dispatchEvent(new CustomEvent("gemini:journal-updated",{detail:t}))},e.refreshIntervalMs)),console.log("\u2705 [JournalChecker] Started"))}function fd(){Yn&&(clearInterval(Yn),Yn=null)}function Nx(e){let t=ze("gemini:features:journalChecker",md);t.enabled=e,nt("gemini:features:journalChecker",t),e?gd():fd()}async function _x(){let e=await Ei();return window.dispatchEvent(new CustomEvent("gemini:journal-updated",{detail:e})),e}var md,Yn,hd=G(()=>{"use strict";yr();$n();Kn();md={enabled:!1,autoRefresh:!0,refreshIntervalMs:3e4},Yn=null});function y(e,t=null,...n){let r=document.createElement(e);for(let[o,a]of Object.entries(t||{}))a!=null&&(o==="style"?typeof a=="string"?r.setAttribute("style",a):typeof a=="object"&&Object.assign(r.style,a):o.startsWith("on")&&typeof a=="function"?r[o.toLowerCase()]=a:o in r?r[o]=a:r.setAttribute(o,String(a)));for(let o of n)o==null||o===!1||r.appendChild(typeof o=="string"||typeof o=="number"?document.createTextNode(String(o)):o);return r}var no="https://i.imgur.com/k5WuC32.png",rs="gemini-loader-style",mt="gemini-loader",as=80;function ep(){if(document.getElementById(rs))return;let e=document.createElement("style");e.id=rs,e.textContent=`
  ...
  `,document.head.appendChild(e)}function oo(e,t,n){let r=y("div",{className:`gemini-loader__log ${n}`},y("div",{className:"gemini-loader__dot"}),y("div",{textContent:t}));for(e.appendChild(r);e.childElementCount>as;)e.firstElementChild?.remove();e.scrollTop=e.scrollHeight}function tp(){return new Promise(e=>{if(typeof GM_xmlhttpRequest>"u"){e(no);return}GM_xmlhttpRequest({method:"GET",url:no,responseType:"blob",onload:t=>{let n=t.response,r=new FileReader;r.onloadend=()=>e(r.result),r.onerror=()=>e(no),r.readAsDataURL(n)},onerror:()=>e(no)})})}function Ir(e={}){let t=Number.isFinite(e.blurPx)?Math.max(4,Number(e.blurPx)):14;ep();let n=y("div",{className:"gemini-loader__subtitle",textContent:e.subtitle??"Initializing the mod..."}),r=y("div",{className:"gemini-loader__logs"}),o=y("img",{className:"gemini-loader__spinner-icon",alt:"Gemini"}),a=y("div",{className:"gemini-loader__spinner"},o);tp().then(h=>{o.src=h});let i=y("div",{className:"gemini-loader__card"},y("div",{className:"gemini-loader__header"},a,y("div",{className:"gemini-loader__titles"},y("div",{className:"gemini-loader__title",textContent:e.title??"Gemini is loading"}),n)),r),s=y("div",{id:mt},i);(document.body||document.documentElement).appendChild(s);let u=y("div",{className:"gemini-loader__actions"},y("button",{className:"gemini-loader__button",textContent:"Close loader",onclick:()=>s.remove()}));i.appendChild(u),s.style.setProperty("--loader-blur",`${t}px`);let d=h=>{n.textContent=h},l=new Map,c=(h,b)=>{h.className=`gemini-loader__log ${b}`};return{log:(h,b="info")=>oo(r,h,b),logStep:(h,b,T="info")=>{let S=String(h||"").trim();if(!S){oo(r,b,T);return}let v=l.get(S);if(v){v.el.lastElementChild&&(v.el.lastElementChild.textContent=b),v.tone!==T&&(c(v.el,T),v.tone=T);return}let k=y("div",{className:`gemini-loader__log ${T}`},y("div",{className:"gemini-loader__dot"}),y("div",{textContent:b}));for(l.set(S,{el:k,tone:T}),r.appendChild(k);r.childElementCount>as;){let x=r.firstElementChild;if(!x)break;let C=Array.from(l.entries()).find(([,P])=>P.el===x)?.[0];C&&l.delete(C),x.remove()}r.scrollTop=r.scrollHeight},setSubtitle:d,succeed:(h,b=600)=>{h&&oo(r,h,"success"),s.classList.add("gemini-loader--closing"),setTimeout(()=>s.remove(),b)},fail:(h,b)=>{oo(r,h,"error"),d("Something went wrong. Check the console for details."),s.classList.add("gemini-loader--error"),console.error("[Gemini loader]",h,b)}}}function is(e,t,n){let r=y("div",{className:"lg-pill",id:"pill"}),o=e.map(l=>{let c=y("button",{className:"lg-tab"},l.label);return c.setAttribute("data-target",l.id),c}),a=y("div",{className:"lg-tabs",id:"lg-tabs-row"},r,...o),i=a;a.addEventListener("wheel",l=>{Math.abs(l.deltaY)>Math.abs(l.deltaX)&&(l.preventDefault(),a.scrollLeft+=l.deltaY)},{passive:!1});function s(l){let c=a.getBoundingClientRect(),p=o.find(k=>k.dataset.target===l)||o[0];if(!p)return;let m=p.getBoundingClientRect(),g=m.left-c.left,f=m.width;r.style.width=`${f}px`,r.style.transform=`translateX(${g}px)`;let h=a.scrollLeft,b=h,T=h+a.clientWidth,S=g-12,v=g+f+12;S<b?a.scrollTo({left:S,behavior:"smooth"}):v>T&&a.scrollTo({left:v-a.clientWidth,behavior:"smooth"})}let u=t||(e[0]?.id??"");function d(l){u=l,o.forEach(c=>c.classList.toggle("active",c.dataset.target===l)),s(l),n(l)}return o.forEach(l=>l.addEventListener("click",()=>d(l.dataset.target))),queueMicrotask(()=>s(u)),{root:i,activate:d,recalc:()=>s(u),getActive:()=>u}}var Le=class{constructor(t){ne(this,"id");ne(this,"label");ne(this,"container",null);ne(this,"cleanupFunctions",[]);ne(this,"preloadedContent",null);ne(this,"preloadPromise",null);this.id=t.id,this.label=t.label}async preload(){if(this.preloadedContent||this.preloadPromise)return;let t=y("div");this.preloadPromise=(async()=>{let n=this.build(t);n instanceof Promise&&await n,this.preloadedContent=t,this.preloadPromise=null})(),await this.preloadPromise}isPreloaded(){return this.preloadedContent!==null}render(t){for(this.unmount();t.firstChild;)t.removeChild(t.firstChild);if(this.container=t,this.preloadedContent){for(;this.preloadedContent.firstChild;)t.appendChild(this.preloadedContent.firstChild);this.preloadedContent=null}else{let r=this.build(t);r instanceof Promise&&r.catch(o=>{console.error(`[Gemini] Error building section ${this.id}:`,o)})}let n=t.firstElementChild;n&&n.classList.contains("gemini-section")&&n.classList.add("active")}unmount(){this.executeCleanup(),this.container=null}createContainer(t,n){let r=n?`gemini-section ${n}`:"gemini-section";return y("section",{id:t,className:r})}addCleanup(t){this.cleanupFunctions.push(t)}createGrid(t="12px"){let n=y("div");return n.style.display="grid",n.style.gap=t,n}executeCleanup(){for(let t of this.cleanupFunctions)try{t()}catch(n){console.error(`[Gemini] Cleanup error in section ${this.id}:`,n)}this.cleanupFunctions=[]}};var sn=class{constructor(t,n,r){ne(this,"sections");ne(this,"activeId",null);ne(this,"container");ne(this,"theme");this.sections=new Map(t.map(o=>[o.id,o])),this.container=n,this.theme=r}get ids(){return Array.from(this.sections.keys())}get all(){return Array.from(this.sections.values())}get active(){return this.activeId}activate(t){if(this.activeId!==t){if(!this.sections.has(t))throw new Error(`[Gemini] Unknown section: ${t}`);if(this.activeId&&this.sections.get(this.activeId).unmount(),this.activeId=t,this.sections.get(t).render(this.container),this.theme){let n=this.theme.getCurrentTheme();this.theme.applyTheme(n)}}}};function ln(e,t){try{let n=JSON.stringify(t);GM_setValue(e,n)}catch(n){console.error(`[Gemini] Failed to save key "${e}" to storage:`,n)}}function at(e,t){try{let n=GM_getValue(e);return n==null?t:typeof n=="string"?JSON.parse(n):n}catch(n){return console.error(`[Gemini] Failed to load key "${e}" from storage, using default:`,n),t}}var ss="gemini.sections";function ls(){let e=at(ss,{});return e&&typeof e=="object"&&!Array.isArray(e)?e:{}}function np(e){ln(ss,e)}async function cs(e){return ls()[e]}function us(e,t){let n=ls();np({...n,[e]:t})}function ro(e,t){return{...e,...t??{}}}async function ds(e){let t=await cs(e.path),n;e.migrate?n=e.migrate(t):n=t??{},n=Object.assign((d=>JSON.parse(JSON.stringify(d)))(e.defaults),n),e.sanitize&&(n=e.sanitize(n));function o(){us(e.path,n)}function a(){return n}function i(d){n=e.sanitize?e.sanitize(d):d,o()}function s(d){let c=Object.assign((p=>JSON.parse(JSON.stringify(p)))(n),{});typeof d=="function"?d(c):Object.assign(c,d),n=e.sanitize?e.sanitize(c):c,o()}function u(){o()}return{get:a,set:i,update:s,save:u}}async function cn(e,t){let{path:n=e,...r}=t;return ds({path:n,...r})}var op=0,ao=new Map;function ye(e={},...t){let{id:n,className:r,variant:o="default",padding:a="md",interactive:i=!1,expandable:s=!1,defaultExpanded:u=!0,onExpandChange:d,mediaTop:l,title:c,subtitle:p,badge:m,actions:g,footer:f,divider:h=!1,tone:b="neutral",stateKey:T}=e,S=y("div",{className:"card",id:n,tabIndex:i?0:void 0});S.classList.add(`card--${o}`,`card--p-${a}`),i&&S.classList.add("card--interactive"),b!=="neutral"&&S.classList.add(`card--tone-${b}`),r&&S.classList.add(...r.split(" ").filter(Boolean)),s&&S.classList.add("card--expandable");let v=s?T??n??(typeof c=="string"?`title:${c}`:null):null,k=!s||u;v&&ao.has(v)&&(k=!!ao.get(v));let x=null,C=null,P=null,M=null,D=null,L=n?`${n}-collapse`:`card-collapse-${++op}`,W=()=>{if(M!==null&&(cancelAnimationFrame(M),M=null),D){let _=D;D=null,_()}},oe=(_,H)=>{if(!P)return;W();let E=P;if(E.setAttribute("aria-hidden",String(!_)),!H){E.classList.remove("card-collapse--animating"),E.style.display=_?"":"none",E.style.height="",E.style.opacity="";return}if(E.classList.add("card-collapse--animating"),E.style.display="",_){E.style.height="auto";let B=E.scrollHeight;if(!B){E.classList.remove("card-collapse--animating"),E.style.display="",E.style.height="",E.style.opacity="";return}E.style.height="0px",E.style.opacity="0",E.offsetHeight,M=requestAnimationFrame(()=>{M=null,E.style.height=`${B}px`,E.style.opacity="1"})}else{let B=E.scrollHeight;if(!B){E.classList.remove("card-collapse--animating"),E.style.display="none",E.style.height="",E.style.opacity="";return}E.style.height=`${B}px`,E.style.opacity="1",E.offsetHeight,M=requestAnimationFrame(()=>{M=null,E.style.height="0px",E.style.opacity="0"})}let R=()=>{E.classList.remove("card-collapse--animating"),E.style.height="",_||(E.style.display="none"),E.style.opacity=""},N=null,O=B=>{B.target===E&&(N!==null&&(clearTimeout(N),N=null),E.removeEventListener("transitionend",O),E.removeEventListener("transitioncancel",O),D=null,R())};D=()=>{N!==null&&(clearTimeout(N),N=null),E.removeEventListener("transitionend",O),E.removeEventListener("transitioncancel",O),D=null,R()},E.addEventListener("transitionend",O),E.addEventListener("transitioncancel",O),N=window.setTimeout(()=>{D?.()},420)};function z(_){let H=document.createElementNS("http://www.w3.org/2000/svg","svg");return H.setAttribute("viewBox","0 0 24 24"),H.setAttribute("width","16"),H.setAttribute("height","16"),H.innerHTML=_==="up"?'<path d="M7 14l5-5 5 5" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"/>':'<path d="M7 10l5 5 5-5" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"/>',H}function X(_,H=!0,E=!0){k=_,S.classList.toggle("card--collapsed",!k),S.classList.toggle("card--expanded",k),x&&(x.dataset.expanded=String(k),x.setAttribute("aria-expanded",String(k))),C&&(C.setAttribute("aria-expanded",String(k)),C.classList.toggle("card-toggle--collapsed",!k),C.setAttribute("aria-label",k?"Replier le contenu":"Deplier le contenu"),C.replaceChildren(z(k?"up":"down"))),s?oe(k,E):P&&(P.style.display="",P.style.height="",P.style.opacity="",P.setAttribute("aria-hidden","false")),H&&d&&d(k),v&&ao.set(v,k)}if(l){let _=y("div",{className:"card-media"});_.append(l),S.appendChild(_)}let ue=!!(c||p||m||g&&g.length||s);if(ue){x=y("div",{className:"card-header"});let _=y("div",{className:"card-headline",style:"min-width:0;display:flex;flex-direction:column;gap:2px;"});if(c){let R=y("h3",{className:"card-title",style:"margin:0;font-size:15px;font-weight:700;line-height:1.25;white-space:nowrap;overflow:hidden;text-overflow:ellipsis;display:flex;align-items:center;gap:8px;color:var(--group-title, var(--fg));"},c);m&&R.append(typeof m=="string"?y("span",{className:"badge"},m):m),_.appendChild(R)}if(p){let R=y("div",{className:"card-subtitle",style:"opacity:.85;font-size:12px;color:color-mix(in oklab, var(--fg) 80%, #9ca3af)"},p);_.appendChild(R)}(_.childNodes.length||s)&&x.appendChild(_);let H=y("div",{className:"card-header-right",style:"display:flex;gap:8px;flex:0 0 auto;align-items:center;"}),E=y("div",{className:"card-actions",style:"display:flex;gap:8px;flex:0 0 auto;align-items:center;"});g?.forEach(R=>E.appendChild(R)),E.childNodes.length&&H.appendChild(E),s&&(C=y("button",{className:"card-toggle",type:"button",ariaExpanded:String(k),ariaControls:L,ariaLabel:k?"Replier le contenu":"Deplier le contenu"}),C.textContent=k?"\u25B2":"\u25BC",C.addEventListener("click",R=>{R.preventDefault(),R.stopPropagation(),X(!k)}),H.appendChild(C),x.classList.add("card-header--expandable"),x.addEventListener("click",R=>{let N=R.target;N?.closest(".card-actions")||N?.closest(".card-toggle")||X(!k)})),H.childNodes.length&&x.appendChild(H),S.appendChild(x)}P=y("div",{className:"card-collapse",id:L,ariaHidden:s?String(!k):"false"}),S.appendChild(P),h&&ue&&P.appendChild(y("div",{className:"card-divider"}));let V=y("div",{className:"card-body"});if(V.append(...t),P.appendChild(V),f){h&&P.appendChild(y("div",{className:"card-divider"}));let _=y("div",{className:"card-footer"});_.append(f),P.appendChild(_)}return C&&C.setAttribute("aria-controls",L),X(k,!1,!1),v&&ao.set(v,k),S}var io=!1,so=new Set,He=e=>{let t=document.activeElement;for(let n of so)if(t&&(t===n||n.contains(t))){e.stopImmediatePropagation(),e.stopPropagation();return}};function rp(){io||(io=!0,window.addEventListener("keydown",He,!0),window.addEventListener("keypress",He,!0),window.addEventListener("keyup",He,!0),document.addEventListener("keydown",He,!0),document.addEventListener("keypress",He,!0),document.addEventListener("keyup",He,!0))}function ap(){io&&(so.size>0||(io=!1,window.removeEventListener("keydown",He,!0),window.removeEventListener("keypress",He,!0),window.removeEventListener("keyup",He,!0),document.removeEventListener("keydown",He,!0),document.removeEventListener("keypress",He,!0),document.removeEventListener("keyup",He,!0)))}function ps(e){let{id:t,value:n=null,options:r,placeholder:o="Select...",size:a="md",disabled:i=!1,blockGameKeys:s=!0,onChange:u,onOpenChange:d}=e,l=y("div",{className:"select",id:t}),c=y("button",{className:"select-trigger",type:"button"}),p=y("span",{className:"select-value"},o),m=y("span",{className:"select-caret"},"\u25BE");c.append(p,m);let g=y("div",{className:"select-menu",role:"listbox",tabindex:"-1","aria-hidden":"true"});l.classList.add(`select--${a}`);let f=!1,h=n,b=null,T=!!i;function S(R){return R==null?o:(e.options||r).find(O=>O.value===R)?.label??o}function v(R){p.textContent=S(R),g.querySelectorAll(".select-option").forEach(N=>{let O=N.dataset.value,B=R!=null&&O===R;N.classList.toggle("selected",B),N.setAttribute("aria-selected",String(B))})}function k(R){g.replaceChildren(),R.forEach(N=>{let O=y("button",{className:"select-option"+(N.disabled?" disabled":""),type:"button",role:"option","data-value":N.value,"aria-selected":String(N.value===h),tabindex:"-1"},N.label);N.value===h&&O.classList.add("selected"),N.disabled||O.addEventListener("pointerdown",B=>{B.preventDefault(),B.stopPropagation(),L(N.value,{notify:!0}),M()},{capture:!0}),g.appendChild(O)})}function x(){c.setAttribute("aria-expanded",String(f)),g.setAttribute("aria-hidden",String(!f))}function C(){let R=c.getBoundingClientRect();Object.assign(g.style,{minWidth:`${R.width}px`})}function P(){f||T||(f=!0,l.classList.add("open"),x(),C(),document.addEventListener("mousedown",ue,!0),document.addEventListener("scroll",V,!0),window.addEventListener("resize",_),g.focus({preventScroll:!0}),s&&(rp(),so.add(l),b=()=>{so.delete(l),ap()}),d?.(!0))}function M(){f&&(f=!1,l.classList.remove("open"),x(),document.removeEventListener("mousedown",ue,!0),document.removeEventListener("scroll",V,!0),window.removeEventListener("resize",_),c.focus({preventScroll:!0}),b?.(),b=null,d?.(!1))}function D(){f?M():P()}function L(R,N={}){let O=h;h=R,v(h),N.notify!==!1&&O!==R&&u?.(R)}function W(){return h}function oe(R){let N=Array.from(g.querySelectorAll(".select-option:not(.disabled)"));if(!N.length)return;let O=N.findIndex(fe=>fe.classList.contains("active")),B=N[(O+(R===1?1:N.length-1))%N.length];N.forEach(fe=>fe.classList.remove("active")),B.classList.add("active"),B.focus({preventScroll:!0}),B.scrollIntoView({block:"nearest"})}function z(R){(R.key===" "||R.key==="Enter"||R.key==="ArrowDown")&&(R.preventDefault(),P())}function X(R){if(R.key==="Escape"){R.preventDefault(),M();return}if(R.key==="Enter"||R.key===" "){let N=g.querySelector(".select-option.active")||g.querySelector(".select-option.selected");N&&!N.classList.contains("disabled")&&(R.preventDefault(),L(N.dataset.value,{notify:!0}),M());return}if(R.key==="ArrowDown"){R.preventDefault(),oe(1);return}if(R.key==="ArrowUp"){R.preventDefault(),oe(-1);return}}function ue(R){l.contains(R.target)||M()}function V(){f&&C()}function _(){f&&C()}function H(R){T=!!R,c.disabled=T,l.classList.toggle("disabled",T),T&&M()}function E(R){e.options=R,k(R),R.some(N=>N.value===h)||(h=null,v(null))}return l.append(c,g),c.addEventListener("pointerdown",R=>{R.preventDefault(),R.stopPropagation(),D()},{capture:!0}),c.addEventListener("keydown",z),g.addEventListener("keydown",X),k(r),n!=null?(h=n,v(h)):v(null),x(),H(T),{root:l,open:P,close:M,toggle:D,getValue:W,setValue:L,setOptions:E,setDisabled:H,destroy(){document.removeEventListener("mousedown",ue,!0),document.removeEventListener("scroll",V,!0),window.removeEventListener("resize",_),b?.(),b=null}}}function it(e={}){let{id:t,text:n="",htmlFor:r,tone:o="default",size:a="md",layout:i="inline",variant:s="text",required:u=!1,disabled:d=!1,tooltip:l,hint:c,icon:p,suffix:m,onClick:g}=e,f=y("div",{className:"lg-label-wrap",id:t}),h=y("label",{className:"lg-label",...r?{htmlFor:r}:{},...l?{title:l}:{}});if(p){let L=typeof p=="string"?y("span",{className:"lg-label-ico"},p):p;L.classList?.add?.("lg-label-ico"),h.appendChild(L)}let b=y("span",{className:"lg-label-text"},n);h.appendChild(b);let T=y("span",{className:"lg-label-req",ariaHidden:"true"}," *");u&&h.appendChild(T);let S=null;if(m!=null){S=typeof m=="string"?document.createTextNode(m):m;let L=y("span",{className:"lg-label-suffix"});L.appendChild(S),h.appendChild(L)}let v=c?y("div",{className:"lg-label-hint"},c):null;f.classList.add(`lg-label--${i}`),f.classList.add(`lg-label--${a}`),s==="title"&&f.classList.add("lg-label--title"),k(o),d&&f.classList.add("is-disabled"),f.appendChild(h),v&&f.appendChild(v),g&&h.addEventListener("click",g);function k(L){f.classList.remove("lg-label--default","lg-label--muted","lg-label--info","lg-label--success","lg-label--warning","lg-label--danger"),f.classList.add(`lg-label--${L}`)}function x(L){b.textContent=L}function C(L){k(L)}function P(L){L&&!T.isConnected&&h.appendChild(T),!L&&T.isConnected&&T.remove(),L?h.setAttribute("aria-required","true"):h.removeAttribute("aria-required")}function M(L){f.classList.toggle("is-disabled",!!L)}function D(L){!L&&v&&v.isConnected?v.remove():L&&v?v.textContent=L:L&&!v&&f.appendChild(y("div",{className:"lg-label-hint"},L))}return{root:f,labelEl:h,hintEl:v,setText:x,setTone:C,setRequired:P,setDisabled:M,setHint:D}}function un(e){return e==null?null:typeof e=="string"?document.createTextNode(e):e}function lo(e,t){let n=document.createElement("span");n.className=`btn-ico btn-ico--${t}`;let r=un(e);return r&&n.appendChild(r),n}function ip(){let e="http://www.w3.org/2000/svg",t=document.createElementNS(e,"svg");t.setAttribute("viewBox","0 0 24 24"),t.setAttribute("width","16"),t.setAttribute("height","16"),t.setAttribute("aria-hidden","true"),t.style.marginRight="6px",t.style.display="none",t.style.flexShrink="0";let n=document.createElementNS(e,"circle");n.setAttribute("cx","12"),n.setAttribute("cy","12"),n.setAttribute("r","9"),n.setAttribute("fill","none"),n.setAttribute("stroke","currentColor"),n.setAttribute("stroke-width","3"),n.setAttribute("stroke-linecap","round");let r=document.createElementNS(e,"animate");r.setAttribute("attributeName","stroke-dasharray"),r.setAttribute("values","1,150;90,150;90,150"),r.setAttribute("dur","1.5s"),r.setAttribute("repeatCount","indefinite");let o=document.createElementNS(e,"animateTransform");return o.setAttribute("attributeName","transform"),o.setAttribute("attributeType","XML"),o.setAttribute("type","rotate"),o.setAttribute("from","0 12 12"),o.setAttribute("to","360 12 12"),o.setAttribute("dur","1s"),o.setAttribute("repeatCount","indefinite"),n.appendChild(r),n.appendChild(o),t.appendChild(n),t}function st(e={}){let{label:t="",id:n,variant:r="default",size:o="md",iconLeft:a,iconRight:i,loading:s=!1,tooltip:u,type:d="button",onClick:l,disabled:c=!1,fullWidth:p=!1}=e,m=y("button",{className:"btn",id:n});m.type=d,r==="primary"&&m.classList.add("primary"),o==="sm"&&m.classList.add("btn--sm"),u&&(m.title=u),p&&(m.style.width="100%");let g=ip(),f=a?lo(a,"left"):null,h=i?lo(i,"right"):null,b=document.createElement("span");b.className="btn-label";let T=un(t);T&&b.appendChild(T),!T&&(f||h)&&m.classList.add("btn--icon"),m.appendChild(g),f&&m.appendChild(f),m.appendChild(b),h&&m.appendChild(h);let S=c||s;m.disabled=S,m.setAttribute("aria-busy",String(!!s)),g.style.display=s?"inline-block":"none",l&&m.addEventListener("click",l);let v=m;return v.setLoading=k=>{m.setAttribute("aria-busy",String(!!k)),g.style.display=k?"inline-block":"none",m.disabled=k||c},v.setDisabled=k=>{m.disabled=k||m.getAttribute("aria-busy")==="true"},v.setLabel=k=>{b.replaceChildren();let x=un(k);x&&b.appendChild(x),!x&&(f||h)?m.classList.add("btn--icon"):m.classList.remove("btn--icon")},v.setIconLeft=k=>{if(k==null){f?.remove();return}f?f.replaceChildren(un(k)):m.insertBefore(lo(k,"left"),b)},v.setIconRight=k=>{if(k==null){h?.remove();return}h?h.replaceChildren(un(k)):m.appendChild(lo(k,"right"))},v}Gt();var co=!1,dn=new Set;function pp(e=document){let t=e.activeElement||null;for(;t&&t.shadowRoot&&t.shadowRoot.activeElement;)t=t.shadowRoot.activeElement;return t}var Ne=e=>{let t=pp();if(t){for(let n of dn)if(t===n||n.contains(t)){e.stopImmediatePropagation(),e.stopPropagation();return}}};function mp(){co||(co=!0,window.addEventListener("keydown",Ne,!0),window.addEventListener("keypress",Ne,!0),window.addEventListener("keyup",Ne,!0),document.addEventListener("keydown",Ne,!0),document.addEventListener("keypress",Ne,!0),document.addEventListener("keyup",Ne,!0))}function gp(){co&&(co=!1,window.removeEventListener("keydown",Ne,!0),window.removeEventListener("keypress",Ne,!0),window.removeEventListener("keyup",Ne,!0),document.removeEventListener("keydown",Ne,!0),document.removeEventListener("keypress",Ne,!0),document.removeEventListener("keyup",Ne,!0))}function fp(e){return dn.size===0&&mp(),dn.add(e),()=>{dn.delete(e),dn.size===0&&gp()}}function bp(e,t,n,r){let o;switch(e){case"digits":o="0-9";break;case"alpha":o="\\p{L}";break;case"alphanumeric":o="\\p{L}0-9";break;default:return null}return t&&(o+=" "),n&&(o+="\\-"),r&&(o+="_"),new RegExp(`[^${o}]`,"gu")}function hp(e,t){return t?e.replace(t,""):e}function yp(e,t=0){if(!t)return e;let n;return((...r)=>{clearTimeout(n),n=setTimeout(()=>e(...r),t)})}function fs(e={}){let{id:t,placeholder:n="",value:r="",mode:o="any",allowSpaces:a=!1,allowDashes:i=!1,allowUnderscore:s=!1,maxLength:u,blockGameKeys:d=!0,debounceMs:l=0,onChange:c,onEnter:p,label:m}=e,g=y("div",{className:"lg-input-wrap"}),f=y("input",{className:"input",id:t,placeholder:n});if(typeof u=="number"&&u>0&&(f.maxLength=u),r&&(f.value=r),m){let L=y("div",{className:"lg-input-label"},m);g.appendChild(L)}g.appendChild(f);let h=bp(o,a,i,s),b=()=>{let L=f.selectionStart??f.value.length,W=f.value.length,oe=hp(f.value,h);if(oe!==f.value){f.value=oe;let z=W-oe.length,X=Math.max(0,L-z);f.setSelectionRange(X,X)}},T=yp(()=>c?.(f.value),l);f.addEventListener("input",()=>{b(),T()}),f.addEventListener("paste",()=>queueMicrotask(()=>{b(),T()})),f.addEventListener("keydown",L=>{L.key==="Enter"&&p?.(f.value)});let S=d?fp(f):()=>{};function v(){return f.value}function k(L){f.value=L??"",b(),T()}function x(){f.focus()}function C(){f.blur()}function P(L){f.disabled=!!L}function M(){return document.activeElement===f}function D(){S()}return{root:g,input:f,getValue:v,setValue:k,focus:x,blur:C,setDisabled:P,isFocused:M,destroy:D}}function xe(e,t,n){return Math.min(n,Math.max(t,e))}function mn({h:e,s:t,v:n,a:r}){let o=(e%360+360)%360/60,a=n*t,i=a*(1-Math.abs(o%2-1)),s=0,u=0,d=0;switch(Math.floor(o)){case 0:s=a,u=i;break;case 1:s=i,u=a;break;case 2:u=a,d=i;break;case 3:u=i,d=a;break;case 4:s=i,d=a;break;default:s=a,d=i;break}let c=n-a,p=Math.round((s+c)*255),m=Math.round((u+c)*255),g=Math.round((d+c)*255);return{r:xe(p,0,255),g:xe(m,0,255),b:xe(g,0,255),a:xe(r,0,1)}}function bs({r:e,g:t,b:n,a:r}){let o=xe(e,0,255)/255,a=xe(t,0,255)/255,i=xe(n,0,255)/255,s=Math.max(o,a,i),u=Math.min(o,a,i),d=s-u,l=0;d!==0&&(s===o?l=60*((a-i)/d%6):s===a?l=60*((i-o)/d+2):l=60*((o-a)/d+4)),l<0&&(l+=360);let c=s===0?0:d/s;return{h:l,s:c,v:s,a:xe(r,0,1)}}function Dr({r:e,g:t,b:n}){let r=o=>xe(Math.round(o),0,255).toString(16).padStart(2,"0");return`#${r(e)}${r(t)}${r(n)}`.toUpperCase()}function vp({r:e,g:t,b:n,a:r}){let o=xe(Math.round(r*255),0,255);return`${Dr({r:e,g:t,b:n,a:r})}${o.toString(16).padStart(2,"0")}`.toUpperCase()}function pn({r:e,g:t,b:n,a:r}){let o=Math.round(r*1e3)/1e3;return`rgba(${e}, ${t}, ${n}, ${o})`}function Ht(e){let t=e.trim();if(!t||(t.startsWith("#")&&(t=t.slice(1)),![3,4,6,8].includes(t.length))||!/^[0-9a-fA-F]+$/.test(t))return null;(t.length===3||t.length===4)&&(t=t.split("").map(i=>i+i).join(""));let n=255;t.length===8&&(n=parseInt(t.slice(6,8),16),t=t.slice(0,6));let r=parseInt(t.slice(0,2),16),o=parseInt(t.slice(2,4),16),a=parseInt(t.slice(4,6),16);return{r,g:o,b:a,a:n/255}}function Lr(e){if(!e)return null;let t=e.trim();if(t.startsWith("#"))return Ht(t);let n=t.match(/^rgba?\(([^)]+)\)$/i);if(n){let r=n[1].split(",").map(u=>u.trim());if(r.length<3)return null;let o=Number(r[0]),a=Number(r[1]),i=Number(r[2]),s=r[3]!=null?Number(r[3]):1;return[o,a,i,s].some(u=>Number.isNaN(u))?null:{r:o,g:a,b:i,a:s}}return null}function xp(e,t){let n=Lr(e)??Ht(e??"")??{r:244,g:67,b:54,a:1};return typeof t=="number"&&(n.a=xe(t,0,1)),bs(n)}function Sp(e){return`#${e.trim().replace(/[^0-9a-fA-F#]/g,"").replace(/#/g,"")}`.slice(0,9).toUpperCase()}function wp(e){let t=e.trim();return t&&(/^rgba?\s*\(/i.test(t)?t=t.replace(/^rgba?/i,"rgba"):(t=t.replace(/^\(?(.*)\)?$/,"$1"),t=`rgba(${t})`),t=t.replace(/\s*\(\s*/,"("),t=t.replace(/\s*\)\s*$/,")"),t=t.replace(/\s*,\s*/g,", "),t)}function gt(e){let t=mn(e),n=mn({...e,a:1});return{hsva:{...e},hex:Dr(n),hexa:vp(t),rgba:pn(t),alpha:e.a}}function hs(e={}){let{id:t,label:n="Color",value:r,alpha:o,defaultExpanded:a=!1,detectMobile:i,onInput:s,onChange:u}=e,l=i?i():De.detect().platform==="mobile",c=xp(r,o),p=ye({id:t,className:"color-picker",title:n,padding:l?"md":"lg",variant:"soft",expandable:!l,defaultExpanded:!l&&a});p.classList.add(l?"color-picker--mobile":"color-picker--desktop");let m=p.querySelector(".card-header");m&&m.classList.add("color-picker__header");let g=m?.querySelector(".card-title"),f=y("button",{className:"color-picker__preview",type:"button",title:`Preview ${n}`,"aria-label":`Change ${n}`});g?g.prepend(f):m?m.prepend(f):p.prepend(f);let h=p.querySelector(".card-toggle");!l&&h&&f.addEventListener("click",()=>{p.classList.contains("card--collapsed")&&h.click()});let b=p.querySelector(".card-collapse"),T=null,S=null,v=null,k=null,x=null,C=null,P=null,M=null,D=null,L="hex";function W(V){let _=gt(c);V==="input"?s?.(_):u?.(_)}function oe(){let V=gt(c);if(f.style.setProperty("--cp-preview-color",V.rgba),f.setAttribute("aria-label",`${n}: ${V.hexa}`),!l&&T&&S&&v&&k&&x&&C&&P){let _=mn({...c,s:1,v:1,a:1}),H=pn(_);T.style.setProperty("--cp-palette-hue",H),S.style.left=`${c.s*100}%`,S.style.top=`${(1-c.v)*100}%`,v.style.setProperty("--cp-alpha-gradient",`linear-gradient(180deg, ${pn({..._,a:1})} 0%, ${pn({..._,a:0})} 100%)`),k.style.top=`${(1-c.a)*100}%`,x.style.setProperty("--cp-hue-color",pn(mn({...c,v:1,s:1,a:1}))),C.style.left=`${c.h/360*100}%`;let E=c.a===1?V.hex:V.hexa,R=V.rgba,N=L==="hex"?E:R;P!==document.activeElement&&(P.value=N),P.setAttribute("aria-label",`${L.toUpperCase()} code for ${n}`),P.placeholder=L==="hex"?"#RRGGBB or #RRGGBBAA":"rgba(0, 0, 0, 1)",L==="hex"?P.maxLength=9:P.removeAttribute("maxLength"),P.dataset.mode=L,M&&(M.textContent=L.toUpperCase(),M.setAttribute("aria-label",L==="hex"?"Passer en saisie RGBA":"Revenir en saisie HEX"),M.setAttribute("aria-pressed",L==="rgba"?"true":"false"),M.classList.toggle("is-alt",L==="rgba"))}D&&D!==document.activeElement&&(D.value=V.hex)}function z(V,_=null){c={h:(V.h%360+360)%360,s:xe(V.s,0,1),v:xe(V.v,0,1),a:xe(V.a,0,1)},oe(),_&&W(_)}function X(V,_=null){z(bs(V),_)}function ue(V,_,H){V.addEventListener("pointerdown",E=>{E.preventDefault();let R=E.pointerId,N=B=>{B.pointerId===R&&_(B)},O=B=>{B.pointerId===R&&(document.removeEventListener("pointermove",N),document.removeEventListener("pointerup",O),document.removeEventListener("pointercancel",O),H?.(B))};_(E),document.addEventListener("pointermove",N),document.addEventListener("pointerup",O),document.addEventListener("pointercancel",O)})}if(!l&&b){let V=b.querySelector(".card-body");if(V){V.classList.add("color-picker__body"),S=y("div",{className:"color-picker__palette-cursor"}),T=y("div",{className:"color-picker__palette"},S),k=y("div",{className:"color-picker__alpha-thumb"}),v=y("div",{className:"color-picker__alpha"},k),C=y("div",{className:"color-picker__hue-thumb"}),x=y("div",{className:"color-picker__hue"},C);let _=y("div",{className:"color-picker__main"},T,v),H=y("div",{className:"color-picker__hue-row"},x),E=fs({blockGameKeys:!0});P=E.input,P.classList.add("color-picker__hex-input"),P.value="",P.maxLength=9,P.spellcheck=!1,P.inputMode="text",P.setAttribute("aria-label",`Hex code for ${n}`),M=y("button",{type:"button",className:"color-picker__mode-btn",textContent:"HEX","aria-pressed":"false","aria-label":"Passer en saisie RGBA"}),E.root.classList.add("color-picker__hex-wrap");let R=y("div",{className:"color-picker__hex-row"},M,E.root);V.replaceChildren(_,H,R),ue(T,O=>{if(!T||!S)return;let B=T.getBoundingClientRect(),fe=xe((O.clientX-B.left)/B.width,0,1),Dt=xe((O.clientY-B.top)/B.height,0,1);z({...c,s:fe,v:1-Dt},"input")},()=>W("change")),ue(v,O=>{if(!v)return;let B=v.getBoundingClientRect(),fe=xe((O.clientY-B.top)/B.height,0,1);z({...c,a:1-fe},"input")},()=>W("change")),ue(x,O=>{if(!x)return;let B=x.getBoundingClientRect(),fe=xe((O.clientX-B.left)/B.width,0,1);z({...c,h:fe*360},"input")},()=>W("change")),M.addEventListener("click",()=>{if(L=L==="hex"?"rgba":"hex",P){let O=gt(c);P.value=L==="hex"?c.a===1?O.hex:O.hexa:O.rgba}oe(),P?.focus(),P?.select()}),P.addEventListener("input",()=>{if(L==="hex"){let O=Sp(P.value);if(O!==P.value){let B=P.selectionStart??O.length;P.value=O,P.setSelectionRange(B,B)}}});let N=()=>{let O=P.value;if(L==="hex"){let B=Ht(O);if(!B){P.value=c.a===1?gt(c).hex:gt(c).hexa;return}let fe=O.startsWith("#")?O.slice(1):O,Dt=fe.length===4||fe.length===8;B.a=Dt?B.a:c.a,X(B,"change")}else{let B=wp(O),fe=Lr(B);if(!fe){P.value=gt(c).rgba;return}X(fe,"change")}};P.addEventListener("change",N),P.addEventListener("blur",N),P.addEventListener("keydown",O=>{O.key==="Enter"&&(N(),P.blur())})}}return l&&(b&&b.remove(),D=y("input",{className:"color-picker__native",type:"color",value:Dr(mn({...c,a:1}))}),f.addEventListener("click",()=>D.click()),D.addEventListener("input",()=>{let V=Ht(D.value);V&&(V.a=c.a,X(V,"input"),W("change"))}),p.appendChild(D)),oe(),{root:p,isMobile:l,getValue:()=>gt(c),setValue:(V,_)=>{let H=Lr(V)??Ht(V)??Ht("#FFFFFF");H&&(typeof _=="number"&&(H.a=_),X(H,null))}}}Gt();ve();Gt();function Pp(e){try{return!!e.isSecureContext}catch{return!1}}function Rr(e){let t=e?.getRootNode?.();return t&&(t instanceof Document||t.host)?t:document}function ys(){let e=navigator.platform||"",t=navigator.userAgent||"";return/Mac|iPhone|iPad|iPod/i.test(e)||/Mac OS|iOS/i.test(t)}async function Mp(){try{let e=await navigator.permissions?.query?.({name:"clipboard-write"});return e?e.state==="granted"||e.state==="prompt":!0}catch{return!0}}function Ap(e,t){let n=document.createElement("textarea");return n.value=e,n.setAttribute("readonly","true"),n.style.position="fixed",n.style.opacity="0",n.style.pointerEvents="none",n.style.top="0",t.appendChild?t.appendChild(n):document.body.appendChild(n),n}function Ip(e){try{let t=window.getSelection?.();if(!t)return!1;let n=document.createRange();return n.selectNodeContents(e),t.removeAllRanges(),t.addRange(n),!0}catch{return!1}}async function Ep(e){if(!("clipboard"in navigator))return{ok:!1,method:"clipboard-write"};if(!Pp(A))return{ok:!1,method:"clipboard-write"};if(!await Mp())return{ok:!1,method:"clipboard-write"};try{return await navigator.clipboard.writeText(e),{ok:!0,method:"clipboard-write"}}catch{return{ok:!1,method:"clipboard-write"}}}function Lp(e,t){try{let n=t||Rr(),r=Ap(e,n);r.focus(),r.select(),r.setSelectionRange(0,r.value.length);let o=!1;try{o=document.execCommand("copy")}catch{o=!1}return r.remove(),{ok:o,method:"execCommand"}}catch{return{ok:!1,method:"execCommand"}}}function Dp(e,t){if(!t)return{ok:!1,method:"selection"};let n=t.textContent??"",r=!1;if(n!==e)try{t.textContent=e,r=!0}catch{}let o=Ip(t);r&&setTimeout(()=>{try{t.textContent=n}catch{}},80);let a=ys()?"\u2318C pour copier":"Ctrl+C pour copier";return{ok:o,method:"selection",hint:a}}async function Rp(e,t={}){let n=(e??"").toString();if(!n.length)return{ok:!1,method:"noop"};let r=await Ep(n);if(r.ok)return r;let o=t.injectionRoot||Rr(t.valueNode||void 0),a=Lp(n,o);if(a.ok)return a;let i=Dp(n,t.valueNode||null);if(i.ok)return i;if(!t.disablePromptFallback)try{return window.prompt(De.isDiscord()?"Copie manuelle (Discord bloque clipboard):":"Copie manuelle:",n),{ok:!0,method:"prompt"}}catch{}return{ok:!1,method:"noop"}}function vs(e,t,n={}){let r=o=>{if(n.showTip){n.showTip(o);return}try{e.setAttribute("aria-label",o);let a=document.createElement("div");a.textContent=o,a.style.position="absolute",a.style.top="-28px",a.style.right="0",a.style.padding="4px 8px",a.style.borderRadius="8px",a.style.fontSize="12px",a.style.background="color-mix(in oklab, var(--bg) 85%, transparent)",a.style.border="1px solid var(--border)",a.style.color="var(--fg)",a.style.pointerEvents="none",a.style.opacity="0",a.style.transition="opacity .12s";let i=Rr(e);i.appendChild?i.appendChild(a):document.body.appendChild(a);let s=e.getBoundingClientRect();a.style.left=`${s.right-8}px`,a.style.top=`${s.top-28}px`,requestAnimationFrame(()=>a.style.opacity="1"),setTimeout(()=>{a.style.opacity="0",setTimeout(()=>a.remove(),150)},1200)}catch{}};e.addEventListener("click",async o=>{o.stopPropagation();let a=(t()??"").toString(),i=await Rp(a,{valueNode:n.valueNode??null,injectionRoot:n.injectionRoot??null,disablePromptFallback:n.disablePromptFallback??!1});n.onResult?.(i),i.ok?i.method==="clipboard-write"||i.method==="execCommand"||i.method==="prompt"?r("Copi\xE9"):i.method==="selection"&&r(i.hint||(ys()?"\u2318C pour copier":"Ctrl+C pour copier")):r("Impossible de copier")})}var lt={light:{"--bg":"rgba(255,255,255,0.7)","--fg":"#0f172a","--muted":"rgba(15,23,42,0.06)","--soft":"rgba(15,23,42,0.04)","--accent":"#2563eb","--border":"rgba(15,23,42,0.12)","--shadow":"rgba(2,6,23,.2)","--tab-bg":"#ffffff","--tab-fg":"#0f172a","--pill-from":"#4f46e5","--pill-to":"#06b6d4"},dark:{"--bg":"rgba(10,12,18,0.6)","--fg":"#e5e7eb","--muted":"rgba(229,231,235,0.08)","--soft":"rgba(229,231,235,0.05)","--accent":"#60a5fa","--border":"rgba(148,163,184,0.2)","--shadow":"rgba(0,0,0,.45)","--tab-bg":"rgba(255,255,255,0.08)","--tab-fg":"#e5e7eb","--pill-from":"#6366f1","--pill-to":"#06b6d4"},sepia:{"--bg":"rgba(247,242,231,0.72)","--fg":"#3b2f2f","--muted":"rgba(59,47,47,0.06)","--soft":"rgba(59,47,47,0.04)","--accent":"#b07d62","--border":"rgba(59,47,47,0.14)","--shadow":"rgba(0,0,0,.18)","--tab-bg":"#fff","--tab-fg":"#3b2f2f","--pill-from":"#b07d62","--pill-to":"#d4a373"},forest:{"--bg":"rgba(14,24,18,0.62)","--fg":"#e7f5e9","--muted":"rgba(231,245,233,0.08)","--soft":"rgba(231,245,233,0.05)","--accent":"#34d399","--border":"rgba(231,245,233,0.16)","--shadow":"rgba(0,0,0,.5)","--tab-bg":"rgba(255,255,255,0.06)","--tab-fg":"#e7f5e9","--pill-from":"#10b981","--pill-to":"#84cc16"},violet:{"--bg":"rgba(23, 16, 42, 0.68)","--fg":"#f5f3ff","--muted":"rgba(245,243,255,0.08)","--soft":"rgba(245,243,255,0.05)","--accent":"#a855f7","--border":"rgba(216,180,254,0.22)","--shadow":"rgba(12,3,30,.55)","--tab-bg":"rgba(255,255,255,0.08)","--tab-fg":"#ede9fe","--pill-from":"#a855f7","--pill-to":"#f472b6"},ocean:{"--bg":"rgba(10, 34, 46, 0.66)","--fg":"#e0f7ff","--muted":"rgba(224,247,255,0.07)","--soft":"rgba(224,247,255,0.05)","--accent":"#38bdf8","--border":"rgba(125, 211, 252, 0.22)","--shadow":"rgba(0, 16, 32, .52)","--tab-bg":"rgba(56,189,248,0.14)","--tab-fg":"#e0f7ff","--pill-from":"#0ea5e9","--pill-to":"#14b8a6"},ember:{"--bg":"rgba(34,18,10,0.64)","--fg":"#fff7ed","--muted":"rgba(255,247,237,0.08)","--soft":"rgba(255,247,237,0.05)","--accent":"#f97316","--border":"rgba(255, 159, 92, 0.24)","--shadow":"rgba(16,6,2,.52)","--tab-bg":"rgba(255,247,237,0.09)","--tab-fg":"#fff7ed","--pill-from":"#fb923c","--pill-to":"#facc15"},magicGarden:{"--bg":"#201D1D","--fg":"#F5F5F5","--muted":"rgba(255,255,255,0.6)","--soft":"rgba(0,0,0,0.3)","--accent":"#FFF27D","--border":"rgba(255,255,255,0.1)","--border-accent":"#4A3B2E","--shadow":"rgba(0,0,0,0.5)","--card-shadow":"0 4px 10px rgba(0, 0, 0, 0.5)","--tab-bg":"#10725A","--tab-fg":"#F5F5F5","--section-title":"#10725A","--group-title":"#5EB292","--item-label":"#F5F5F5","--item-desc":"rgba(255,255,255,0.6)","--item-value":"#FFF27D","--card-bg":"rgba(0,0,0,0.3)","--card-radius":"12px","--card-border":"#4A3B2E","--pill-from":"#FFF27D","--pill-to":"#5EB292","--scrollbar-thumb":"rgba(255,255,255,0.2)","--scrollbar-thumb-hover":"rgba(255,255,255,0.3)"}};ve();function Or(e){let{host:t,themes:n,initialTheme:r,onThemeChange:o}=e,a=r,i=null,s=!1;function u(l){let c=n[l]||n[a]||{};s&&t.classList.add("theme-anim");for(let[p,m]of Object.entries(c))t.style.setProperty(p,m);s?(i!==null&&clearTimeout(i),i=A.setTimeout(()=>{t.classList.remove("theme-anim"),i=null},320)):s=!0,a=l,o?.(l)}function d(){return a}return u(r),{applyTheme:u,getCurrentTheme:d}}var uo={ui:{expandedCards:{style:!1,system:!1}}};async function xs(){let e=await cn("tab-settings",{version:1,defaults:uo,sanitize:o=>({ui:{expandedCards:ro(uo.ui.expandedCards,o.ui?.expandedCards)}})});function t(o){let a=e.get();e.update({ui:{...a.ui,...o,expandedCards:ro(a.ui.expandedCards,o.expandedCards)}})}function n(o,a){let i=e.get();e.update({ui:{...i.ui,expandedCards:{...i.ui.expandedCards,[o]:!!a}}})}function r(o){let a=e.get();n(o,!a.ui.expandedCards[o])}return{get:e.get,set:e.set,save:e.save,setUI:t,setCardExpanded:n,toggleCard:r}}function Ss(e){return e.replace(/[_-]+/g," ").replace(/^\w/,t=>t.toUpperCase())}function Op(){return Object.keys(lt).map(e=>({value:e,label:Ss(e)}))}var Gp=["--bg","--fg","--accent","--muted","--soft","--border","--shadow","--tab-bg","--tab-fg","--pill-from","--pill-to"];function Hp(e){return Ss(e.replace(/^--/,""))}function Np(e){return e.alpha<1?e.rgba:e.hex}var po=class extends Le{constructor(n){super({id:"tab-settings",label:"Settings"});this.deps=n}async build(n){let r=this.createGrid("12px");r.id="settings",n.appendChild(r);let o;try{o=await xs()}catch{o={get:()=>uo,set:()=>{},save:()=>{},setUI:()=>{},setCardExpanded:()=>{},toggleCard:()=>{}}}let a=o.get(),i=Object.keys(lt),s=this.deps.getCurrentTheme?.()??this.deps.initialTheme,u=i.includes(s)?s:i[0]??"dark",d=u,l=it({text:"Theme",tone:"muted",size:"lg"}),c=ps({options:Op(),value:u,onChange:f=>{d=f,this.deps.applyTheme(f),this.renderThemePickers(f,p,d)}}),p=y("div",{className:"settings-theme-grid"}),m=ye({title:"Style",padding:"lg",expandable:!0,defaultExpanded:!!a.ui.expandedCards.style,onExpandChange:f=>o.setCardExpanded("style",f)},y("div",{className:"kv settings-theme-row"},l.root,c.root),p);this.renderThemePickers(u,p,d);let g=this.createEnvCard({defaultExpanded:!!a.ui.expandedCards.system,onExpandChange:f=>o.setCardExpanded("system",f)});r.appendChild(m),r.appendChild(g)}renderThemePickers(n,r,o){let a=lt[n];if(r.replaceChildren(),!!a)for(let i of Gp){let s=a[i];if(s==null)continue;let u=hs({label:Hp(i),value:s,defaultExpanded:!1,onInput:d=>this.updateThemeVar(n,i,d,o),onChange:d=>this.updateThemeVar(n,i,d,o)});r.appendChild(u.root)}}updateThemeVar(n,r,o,a){let i=lt[n];i&&(i[r]=Np(o),a===n&&this.deps.applyTheme(n))}createEnvCard(n){let r=n?.defaultExpanded??!1,o=n?.onExpandChange,a=(b,T)=>{let S=y("div",{className:"kv kv--inline-mobile"}),v=y("label",{},b),k=y("div",{className:"ro"});return typeof T=="string"?k.textContent=T:k.append(T),S.append(v,k),S},i=y("code",{},"\u2014"),s=y("span",{},"\u2014"),u=y("span",{},"\u2014"),d=y("span",{},"\u2014"),l=y("span",{},"\u2014"),c=y("span",{},"\u2014"),p=()=>{let b=De.detect();u.textContent=b.surface,d.textContent=b.platform,l.textContent=b.browser??"Unknown",c.textContent=b.os??"Unknown",i.textContent=b.host,s.textContent=b.isInIframe?"Yes":"No"},m=st({label:"Copy JSON",variant:"primary",size:"sm"});vs(m,()=>{let b=De.detect();return JSON.stringify(b,null,2)});let g=y("div",{style:"width:100%;display:flex;justify-content:center;"},m),f=ye({title:"System",variant:"soft",padding:"lg",footer:g,expandable:!0,defaultExpanded:r,onExpandChange:o},a("Surface",u),a("Platform",d),a("Browser",l),a("OS",c),a("Host",i),a("Iframe",s)),h=()=>{document.hidden||p()};return document.addEventListener("visibilitychange",h),p(),this.addCleanup(()=>document.removeEventListener("visibilitychange",h)),f}};function Nt(e={}){let{id:t,checked:n=!1,disabled:r=!1,size:o="md",label:a,labelSide:i="right",onChange:s}=e,u=y("div",{className:"lg-switch-wrap"}),d=y("button",{className:`lg-switch lg-switch--${o}`,id:t,type:"button",role:"switch","aria-checked":String(!!n),"aria-disabled":String(!!r),title:a??"Basculer"}),l=y("span",{className:"lg-switch-track"}),c=y("span",{className:"lg-switch-thumb"});d.append(l,c);let p=null;a&&i!=="none"&&(p=y("span",{className:"lg-switch-label"},a)),p&&i==="left"?u.append(p,d):p&&i==="right"?u.append(d,p):u.append(d);let m=!!n,g=!!r;function f(){d.classList.toggle("on",m),d.setAttribute("aria-checked",String(m)),d.disabled=g,d.setAttribute("aria-disabled",String(g))}function h(M=!1){g||(m=!m,f(),M||s?.(m))}function b(M){M.preventDefault(),h()}function T(M){g||((M.key===" "||M.key==="Enter")&&(M.preventDefault(),h()),M.key==="ArrowLeft"&&(M.preventDefault(),v(!1)),M.key==="ArrowRight"&&(M.preventDefault(),v(!0)))}d.addEventListener("click",b),d.addEventListener("keydown",T);function S(){return m}function v(M,D=!1){m=!!M,f(),D||s?.(m)}function k(M){g=!!M,f()}function x(M){if(!M){p&&(p.remove(),p=null);return}p?p.textContent=M:(p=y("span",{className:"lg-switch-label"},M),u.append(p))}function C(){d.focus()}function P(){d.removeEventListener("click",b),d.removeEventListener("keydown",T)}return f(),{root:u,button:d,isChecked:S,setChecked:v,setDisabled:k,setLabel:x,focus:C,destroy:P}}function mo(e){let{id:t,columns:n,data:r,pageSize:o=0,stickyHeader:a=!0,zebra:i=!0,animations:s=!0,respectReducedMotion:u=!0,compact:d=!1,maxHeight:l,selectable:c=!1,selectionType:p="switch",selectOnRowClick:m=!1,initialSelection:g=[],hideHeaderCheckbox:f=!1,getRowId:h=(F,K)=>String(K),onSortChange:b,onSelectionChange:T,onRowClick:S}=e,v=n.slice(),k=r.slice(),x=r.slice(),C=null,P=null,M=1,D=typeof window<"u"&&typeof window.matchMedia=="function"?window.matchMedia("(prefers-reduced-motion: reduce)").matches:!1,L=!!s&&!(u&&D),W=y("div",{className:"lg-table-wrap",id:t});if(l!=null){let F=typeof l=="number"?`${l}px`:l;W.style.setProperty("--tbl-max-h",F)}let oe=y("div",{className:"lg-table"}),z=y("div",{className:"lg-thead"}),X=y("div",{className:"lg-tbody"}),ue=y("div",{className:"lg-tfoot"});a&&W.classList.add("sticky"),i&&W.classList.add("zebra"),d&&W.classList.add("compact"),c&&W.classList.add("selectable");let V=p==="switch"?"52px":"36px";W.style.setProperty("--check-w",V);function _(F){return F==="center"?"center":F==="right"?"flex-end":"flex-start"}function H(){let F=v.map(ee=>{let ie=(ee.width||"1fr").trim();return/\bfr$/.test(ie)?`minmax(0, ${ie})`:ie}),K=(c?[V,...F]:F).join(" ");W.style.setProperty("--lg-cols",K)}H();function E(){return o?Math.max(1,Math.ceil(k.length/o)):1}function R(){if(!o)return k;let F=(M-1)*o;return k.slice(F,F+o)}function N(){if(!C||!P)return;let F=v.find(ie=>String(ie.key)===C),K=P==="asc"?1:-1,ee=F?.sortFn?(ie,pe)=>K*F.sortFn(ie,pe):(ie,pe)=>{let Y=ie[C],Z=pe[C];return Y==null&&Z==null?0:Y==null?-1*K:Z==null?1*K:typeof Y=="number"&&typeof Z=="number"?K*(Y-Z):K*String(Y).localeCompare(String(Z),void 0,{numeric:!0,sensitivity:"base"})};k.sort(ee)}let O=new Set(g);function B(){return Array.from(O)}let fe=new Map;function Dt(F){O.clear(),F.forEach(K=>O.add(K)),Me(),fe.forEach((K,ee)=>{K.setChecked(O.has(ee),!0)}),rn(),T?.(B())}function ae(){O.clear(),Me(),fe.forEach(F=>F.setChecked(!1,!0)),rn(),T?.(B())}let ge=null;function Me(){if(!ge)return;let F=R();if(!F.length){ge.indeterminate=!1,ge.checked=!1;return}let K=F.map((ie,pe)=>h(ie,(M-1)*(o||0)+pe)),ee=K.reduce((ie,pe)=>ie+(O.has(pe)?1:0),0);ge.checked=ee===K.length,ge.indeterminate=ee>0&&ee<K.length}function Zn(){let F=X.offsetWidth-X.clientWidth;z.style.paddingRight=F>0?`${F}px`:"0px"}function Cr(){requestAnimationFrame(Zn)}let Pr=new ResizeObserver(()=>Zn()),Zi=()=>Zn();function Kd(){z.replaceChildren();let F=y("div",{className:"lg-tr lg-tr-head"});if(c){let K=y("div",{className:"lg-th lg-th-check"});f||(ge=y("input",{type:"checkbox"}),ge.addEventListener("change",()=>{let ee=R(),ie=ge.checked;ee.forEach((pe,Y)=>{let Z=h(pe,(M-1)*(o||0)+Y);ie?O.add(Z):O.delete(Z)}),T?.(B()),rn()}),K.appendChild(ge)),F.appendChild(K)}v.forEach(K=>{let ee=y("button",{className:"lg-th",type:"button",title:K.title||K.header});ee.textContent=K.header,K.align&&ee.style.setProperty("--col-justify",_(K.align)),K.sortable&&ee.classList.add("sortable"),C===String(K.key)&&P?ee.setAttribute("data-sort",P):ee.removeAttribute("data-sort"),K.sortable&&ee.addEventListener("click",()=>{let ie=String(K.key);C!==ie?(C=ie,P="asc"):(P=P==="asc"?"desc":P==="desc"?null:"asc",P||(C=null,k=x.slice())),b?.(C,P),C&&P&&N(),to()}),F.appendChild(ee)}),z.appendChild(F);try{Pr.disconnect()}catch{}Pr.observe(X),Cr()}function Mr(F){return Array.from(F.querySelectorAll(":scope > .lg-td, :scope > .lg-td-check"))}function es(F){return F.querySelector(".lg-td, .lg-td-check")}function ts(F){let K=es(F);return K?K.getBoundingClientRect():null}function rn(){let F=R(),K=new Map;Array.from(X.children).forEach(Y=>{let Z=Y,Ce=Z.getAttribute("data-id");if(!Ce)return;let Ge=ts(Z);Ge&&K.set(Ce,Ge)});let ee=new Map;Array.from(X.children).forEach(Y=>{let Z=Y,Ce=Z.getAttribute("data-id");Ce&&ee.set(Ce,Z)});let ie=[];for(let Y=0;Y<F.length;Y++){let Z=F[Y],Ce=(o?(M-1)*o:0)+Y,Ge=h(Z,Ce);ie.push(Ge);let be=ee.get(Ge);be||(be=Jd(Z,Ce),L&&Mr(be).forEach(an=>{an.style.transform="translateY(6px)",an.style.opacity="0"})),X.appendChild(be)}let pe=[];if(ee.forEach((Y,Z)=>{ie.includes(Z)||pe.push(Y)}),!L){pe.forEach(Y=>Y.remove()),Me(),Cr();return}ie.forEach(Y=>{let Z=X.querySelector(`.lg-tr-body[data-id="${Y}"]`);if(!Z)return;let Ce=ts(Z),Ge=K.get(Y),be=Mr(Z);if(Ge&&Ce){let Ve=Ge.left-Ce.left,Rt=Ge.top-Ce.top;be.forEach(rt=>{rt.style.transition="none",rt.style.transform=`translate(${Ve}px, ${Rt}px)`,rt.style.opacity="1"}),es(Z)?.getBoundingClientRect(),be.forEach(rt=>{rt.style.willChange="transform, opacity",rt.style.transition="transform .18s ease, opacity .18s ease"}),requestAnimationFrame(()=>{be.forEach(rt=>{rt.style.transform="translate(0,0)"})})}else be.forEach(Ve=>{Ve.style.transition="transform .18s ease, opacity .18s ease"}),requestAnimationFrame(()=>{be.forEach(Ve=>{Ve.style.transform="translate(0,0)",Ve.style.opacity="1"})});let Ar=Ve=>{(Ve.propertyName==="transform"||Ve.propertyName==="opacity")&&(be.forEach(Rt=>{Rt.style.willChange="",Rt.style.transition="",Rt.style.transform="",Rt.style.opacity=""}),Ve.currentTarget.removeEventListener("transitionend",Ar))},an=be[0];an&&an.addEventListener("transitionend",Ar)}),pe.forEach(Y=>{let Z=Mr(Y);Z.forEach(be=>{be.style.willChange="transform, opacity",be.style.transition="transform .18s ease, opacity .18s ease",be.style.opacity="0",be.style.transform="translateY(-6px)"});let Ce=be=>{be.propertyName==="opacity"&&(be.currentTarget.removeEventListener("transitionend",Ce),Y.remove())},Ge=Z[0];Ge?Ge.addEventListener("transitionend",Ce):Y.remove()}),Me(),Cr()}function Jd(F,K){let ee=h(F,K),ie=y("div",{className:"lg-tr lg-tr-body","data-id":ee});if(c){let pe=y("div",{className:"lg-td lg-td-check"});if(p==="switch"){let Y=Nt({size:"sm",checked:O.has(ee),onChange:Z=>{Z?O.add(ee):O.delete(ee),Me(),T?.(B())}});fe.set(ee,Y),pe.appendChild(Y.root)}else{let Y=y("input",{type:"checkbox",className:"lg-row-check"});Y.checked=O.has(ee),Y.addEventListener("change",Z=>{Z.stopPropagation(),Y.checked?O.add(ee):O.delete(ee),Me(),T?.(B())}),Y.addEventListener("click",Z=>Z.stopPropagation()),pe.appendChild(Y)}ie.appendChild(pe)}return v.forEach(pe=>{let Y=y("div",{className:"lg-td"});pe.align&&Y.style.setProperty("--col-justify",_(pe.align));let Z=pe.render?pe.render(F,K):String(F[pe.key]??"");typeof Z=="string"?Y.textContent=Z:Y.appendChild(Z),ie.appendChild(Y)}),(S||c&&m)&&(ie.classList.add("clickable"),ie.addEventListener("click",pe=>{if(!pe.target.closest(".lg-td-check")){if(c&&m){let Y=!O.has(ee);if(Y?O.add(ee):O.delete(ee),Me(),p==="switch"){let Z=fe.get(ee);Z&&Z.setChecked(Y,!0)}else{let Z=ie.querySelector(".lg-row-check");Z&&(Z.checked=Y)}T?.(B())}S?.(F,K,pe)}})),ie}function ns(){if(ue.replaceChildren(),!o)return;let F=E(),K=y("div",{className:"lg-pager"}),ee=y("button",{className:"btn",type:"button"},"\u2190"),ie=y("button",{className:"btn",type:"button"},"\u2192"),pe=y("span",{className:"lg-pager-info"},`${M} / ${F}`);ee.disabled=M<=1,ie.disabled=M>=F,ee.addEventListener("click",()=>eo(M-1)),ie.addEventListener("click",()=>eo(M+1)),K.append(ee,pe,ie),ue.appendChild(K)}function eo(F){let K=E();M=Math.min(Math.max(1,F),K),rn(),ns()}function to(){H(),Kd(),rn(),ns()}function qd(F){x=F.slice(),k=F.slice(),C&&P&&N(),eo(1)}function Yd(F){v=F.slice(),to()}function Xd(F,K="asc"){C=F,P=F?K:null,C&&P?N():k=x.slice(),to()}function Qd(){try{Pr.disconnect()}catch{}window.removeEventListener("resize",Zi)}return oe.append(z,X,ue),W.appendChild(oe),window.addEventListener("resize",Zi),to(),{root:W,setData:qd,setColumns:Yd,sortBy:Xd,getSelection:B,setSelection:Dt,clearSelection:ae,setPage:eo,getState:()=>({page:M,pageCount:E(),sortKey:C,sortDir:P}),destroy:Qd}}var fo=!1,gn=new Set;function _p(e=document){let t=e.activeElement||null;for(;t&&t.shadowRoot&&t.shadowRoot.activeElement;)t=t.shadowRoot.activeElement;return t}var _e=e=>{let t=_p();if(t){for(let n of gn)if(t===n||n.contains(t)){e.stopImmediatePropagation(),e.stopPropagation();return}}};function Wp(){fo||(fo=!0,window.addEventListener("keydown",_e,!0),window.addEventListener("keypress",_e,!0),window.addEventListener("keyup",_e,!0),document.addEventListener("keydown",_e,!0),document.addEventListener("keypress",_e,!0),document.addEventListener("keyup",_e,!0))}function Fp(){fo&&(fo=!1,window.removeEventListener("keydown",_e,!0),window.removeEventListener("keypress",_e,!0),window.removeEventListener("keyup",_e,!0),document.removeEventListener("keydown",_e,!0),document.removeEventListener("keypress",_e,!0),document.removeEventListener("keyup",_e,!0))}function Bp(e){return gn.size===0&&Wp(),gn.add(e),()=>{gn.delete(e),gn.size===0&&Fp()}}function go(e){return e==null?null:typeof e=="string"?document.createTextNode(e):e}function jp(){let e="http://www.w3.org/2000/svg",t=document.createElementNS(e,"svg");t.setAttribute("viewBox","0 0 24 24"),t.setAttribute("width","16"),t.setAttribute("height","16"),t.setAttribute("aria-hidden","true"),t.style.display="none",t.style.flexShrink="0";let n=document.createElementNS(e,"circle");n.setAttribute("cx","12"),n.setAttribute("cy","12"),n.setAttribute("r","9"),n.setAttribute("fill","none"),n.setAttribute("stroke","currentColor"),n.setAttribute("stroke-width","3"),n.setAttribute("stroke-linecap","round");let r=document.createElementNS(e,"animate");r.setAttribute("attributeName","stroke-dasharray"),r.setAttribute("values","1,150;90,150;90,150"),r.setAttribute("dur","1.5s"),r.setAttribute("repeatCount","indefinite");let o=document.createElementNS(e,"animateTransform");return o.setAttribute("attributeName","transform"),o.setAttribute("attributeType","XML"),o.setAttribute("type","rotate"),o.setAttribute("from","0 12 12"),o.setAttribute("to","360 12 12"),o.setAttribute("dur","1s"),o.setAttribute("repeatCount","indefinite"),n.append(r,o),t.appendChild(n),t}function bo(e={}){let{id:t,placeholder:n="Rechercher\u2026",value:r="",size:o="md",disabled:a=!1,autoFocus:i=!1,onChange:s,onSearch:u,autoSearch:d=!1,debounceMs:l=0,focusKey:c="/",iconLeft:p,iconRight:m,withClear:g=!0,clearTitle:f="Effacer",ariaLabel:h,submitLabel:b,loading:T=!1,blockGameKeys:S=!0}=e,v=y("div",{className:"search"+(o?` search--${o}`:""),id:t}),k=y("span",{className:"search-ico search-ico--left"});if(p){let ae=go(p);ae&&k.appendChild(ae)}else k.textContent="\u{1F50E}",k.style.opacity=".9";let x=y("input",{className:"input search-input",type:"text",placeholder:n,value:r,"aria-label":h||n}),C=y("span",{className:"search-ico search-ico--right"});if(m){let ae=go(m);ae&&C.appendChild(ae)}let P=jp();P.classList.add("search-spinner");let M=g?y("button",{className:"search-clear",type:"button",title:f},"\xD7"):null,D=b!=null?y("button",{className:"btn search-submit",type:"button"},b):null,L=y("div",{className:"search-field"},k,x,C,P,...M?[M]:[]);v.append(L,...D?[D]:[]);let W=!!a,oe=null;function z(ae){P.style.display=ae?"inline-block":"none",v.classList.toggle("is-loading",ae)}function X(){oe!=null&&(window.clearTimeout(oe),oe=null)}function ue(ae){X(),l>0?oe=window.setTimeout(()=>{oe=null,ae()},l):ae()}function V(){s?.(x.value),d&&u&&u(x.value)}x.addEventListener("input",()=>{ue(V)}),x.addEventListener("keydown",ae=>{ae.key==="Enter"?(ae.preventDefault(),X(),u?.(x.value)):ae.key==="Escape"&&(x.value.length>0?E("",{notify:!0}):x.blur())}),M&&M.addEventListener("click",()=>E("",{notify:!0})),D&&D.addEventListener("click",()=>u?.(x.value));let _=()=>{};if(S&&(_=Bp(x)),c){let ae=ge=>{if(ge.key===c&&!ge.ctrlKey&&!ge.metaKey&&!ge.altKey){let Me=document.activeElement;Me&&(Me.tagName==="INPUT"||Me.tagName==="TEXTAREA"||Me.isContentEditable)||(ge.preventDefault(),x.focus())}};window.addEventListener("keydown",ae,!0),v.__cleanup=()=>{window.removeEventListener("keydown",ae,!0),_()}}else v.__cleanup=()=>{_()};function H(ae){W=!!ae,x.disabled=W,M&&(M.disabled=W),D&&(D.disabled=W),v.classList.toggle("disabled",W)}function E(ae,ge={}){let Me=x.value;x.value=ae??"",ge.notify&&Me!==ae&&ue(V)}function R(){return x.value}function N(){x.focus()}function O(){x.blur()}function B(ae){x.placeholder=ae}function fe(ae){E("",ae)}return H(W),z(T),i&&N(),{root:v,input:x,getValue:R,setValue:E,focus:N,blur:O,setDisabled:H,setPlaceholder:B,clear:fe,setLoading:z,setIconLeft(ae){k.replaceChildren();let ge=go(ae??"\u{1F50E}");ge&&k.appendChild(ge)},setIconRight(ae){C.replaceChildren();let ge=go(ae??"");ge&&C.appendChild(ge)}}}function Up(e){let t=String(e??"").trim().toLowerCase();return t?t==="common"?"Common":t==="uncommon"?"Uncommon":t==="rare"?"Rare":t==="legendary"?"Legendary":t==="mythical"?"Mythical":t==="divine"?"Divine":t==="celestial"?"Celestial":t==="unknown"||t==="unknow"?"Unknown":null:null}function zp(e){return e.toLowerCase()}function ho(e={}){let{id:t,label:n="",type:r="neutral",tone:o="soft",border:a,withBorder:i,pill:s=!0,size:u="md",onClick:d,variant:l="default",rarity:c=null}=e,p=y("span",{className:"badge",id:t});s&&p.classList.add("badge--pill"),u==="sm"?p.classList.add("badge--sm"):u==="lg"?p.classList.add("badge--lg"):p.classList.add("badge--md"),d&&p.addEventListener("click",d);let m=!1,g=i;function f(){m||(g===!1?p.style.border="none":p.style.border="")}function h(x,C=o){p.classList.remove("badge--neutral","badge--info","badge--success","badge--warning","badge--danger","badge--soft","badge--outline","badge--solid"),p.classList.add(`badge--${x}`,`badge--${C}`),f()}function b(x){let C=(x??"").trim();C?(p.style.border=C,m=!0):(m=!1,f())}function T(x){g=x,f()}function S(x){p.textContent=x}function v(x,C=o){h(x,C)}function k(x){p.classList.remove("badge--rarity","badge--rarity-common","badge--rarity-uncommon","badge--rarity-rare","badge--rarity-legendary","badge--rarity-mythical","badge--rarity-divine","badge--rarity-celestial","badge--rarity-unknown"),p.style.background="",p.style.backgroundSize="",p.style.animation="",p.style.color="",p.style.webkitTextStroke="";let C=Up(x);if(!C){p.textContent=String(x??"\u2014");return}p.textContent=C,p.classList.add("badge--rarity",`badge--rarity-${zp(C)}`)}return l==="rarity"?k(c):(p.textContent=n,h(r,o),typeof i=="boolean"&&T(i),a&&b(a)),{root:p,setLabel:S,setType:v,setBorder:b,setWithBorder:T,setRarity:k}}Vt();ut();var Tg={expanded:!1,sort:{key:null,dir:null},search:""},kg={categories:{}};async function Pl(){let e=await cn("tab-test",{version:2,defaults:kg,sanitize:a=>({categories:a.categories&&typeof a.categories=="object"?a.categories:{}})});function t(a){return e.get().categories[a]||{...Tg}}function n(a,i){let s=e.get(),u=t(a);e.update({categories:{...s.categories,[a]:{...u,expanded:i}}})}function r(a,i,s){let u=e.get(),d=t(a);e.update({categories:{...u.categories,[a]:{...d,sort:{key:i,dir:s}}}})}function o(a,i){let s=e.get(),u=t(a);e.update({categories:{...s.categories,[a]:{...u,search:i}}})}return{get:e.get,set:e.set,save:e.save,getCategoryState:t,setCategoryExpanded:n,setCategorySort:r,setCategorySearch:o}}var Cg={Common:1,Uncommon:2,Rare:3,Legendary:4,Mythical:5,Divine:6,Celestial:7};function Do(e){return e?Cg[e]??0:0}var Ro=class extends Le{constructor(){super({id:"tab-test",label:"Test"});ne(this,"stateCtrl",null)}async build(n){this.stateCtrl=await Pl();let r=this.createContainer("test-section");r.style.display="flex",r.style.flexDirection="column",r.style.gap="12px",n.appendChild(r),await this.buildSpriteTables(r)}renderSprite(n){let r=y("div",{style:"display:flex;align-items:center;justify-content:center;width:32px;height:32px;"});if(n.spriteId){let o=n.spriteId;requestAnimationFrame(()=>{try{let a=de.toCanvas(o,{scale:1});a.style.maxWidth="32px",a.style.maxHeight="32px",a.style.objectFit="contain",r.appendChild(a)}catch{r.textContent="-"}})}else r.textContent="-";return r}renderRarity(n){if(!n.rarity){let o=y("span",{style:"opacity:0.5;"});return o.textContent="\u2014",o}return ho({variant:"rarity",rarity:n.rarity,size:"sm"}).root}createDataCard(n,r,o,a){let i=this.stateCtrl.getCategoryState(n),s=p=>{if(!p)return o;let m=p.toLowerCase();return o.filter(g=>g.name.toLowerCase().includes(m))},u=mo({columns:a,data:s(i.search),pageSize:0,compact:!0,maxHeight:"calc(var(--lg-row-h, 40px) * 6)",getRowId:p=>p.spriteId,onSortChange:(p,m)=>{this.stateCtrl.setCategorySort(n,p,m)}});i.sort.key&&i.sort.dir&&u.sortBy(i.sort.key,i.sort.dir);let d=bo({placeholder:"Search...",value:i.search,debounceMs:150,withClear:!0,size:"sm",focusKey:"",onChange:p=>{let m=p.trim();this.stateCtrl.setCategorySearch(n,m),u.setData(s(m))}}),l=y("div",{style:"margin-bottom:8px;"});l.appendChild(d.root);let c=y("div");return c.appendChild(l),c.appendChild(u.root),ye({title:r,subtitle:`${o.length} entries`,variant:"soft",padding:"sm",expandable:!0,defaultExpanded:i.expanded,onExpandChange:p=>{this.stateCtrl.setCategoryExpanded(n,p)}},c)}formatCategoryName(n){return n.split("-").map(r=>r.charAt(0).toUpperCase()+r.slice(1)).join(" ")}findPlantBySprite(n,r){let o=le.get("plants");if(!o)return null;for(let i of Object.values(o))if(i?.seed?.spriteId===n||i?.plant?.spriteId===n||i?.crop?.spriteId===n)return i;let a=r.toLowerCase();for(let i of Object.values(o)){let s=(i?.seed?.name||"").toLowerCase();if(s===a||s===`${a} seed`)return i}return null}findPetBySpriteId(n){let r=le.get("pets");if(!r)return null;for(let o of Object.values(r))if(o?.spriteId===n)return o;return null}findItemBySpriteId(n){let r=le.get("items");if(!r)return null;for(let o of Object.values(r))if(o?.spriteId===n)return o;return null}findDecorBySpriteId(n){let r=le.get("decor");if(!r)return null;for(let o of Object.values(r))if(o?.spriteId===n)return o;return null}findEggBySpriteId(n){let r=le.get("eggs");if(!r)return null;for(let o of Object.values(r))if(o?.spriteId===n)return o;return null}getRarityForSprite(n,r,o){let a=n.toLowerCase();if(a==="plant"||a==="seed"||a==="tallplant"){let i=this.findPlantBySprite(r,o);if(i?.seed?.rarity)return i.seed.rarity}if(a==="pet"){let i=this.findPetBySpriteId(r);if(i?.rarity)return i.rarity}if(a==="item"){let i=this.findItemBySpriteId(r);if(i?.rarity)return i.rarity}if(a==="decor"){let i=this.findDecorBySpriteId(r);if(i?.rarity)return i.rarity}if(a==="egg"){let i=this.findEggBySpriteId(r);if(i?.rarity)return i.rarity}return null}yieldToMain(n=0){return new Promise(r=>{n>0?setTimeout(r,n):typeof requestIdleCallback<"u"?requestIdleCallback(()=>r(),{timeout:50}):setTimeout(r,4)})}async buildSpriteTables(n){let r=[{key:"name",header:"Name",sortable:!0,width:"1fr",sortFn:(a,i)=>a.name.localeCompare(i.name,void 0,{numeric:!0,sensitivity:"base"})},{key:"rarity",header:"Rarity",sortable:!0,width:"100px",align:"center",render:a=>this.renderRarity(a),sortFn:(a,i)=>Do(a.rarity)-Do(i.rarity)},{key:"sprite",header:"Sprite",width:"60px",align:"center",render:a=>this.renderSprite(a)}];if(!de.ready())try{await de.init()}catch{return}let o=de.getCategories();for(let a=0;a<o.length;a++){await this.yieldToMain(8);let i=o[a],u=de.getCategoryId(i).map(d=>{let l=`sprite/${i}/${d}`;return{name:d,spriteId:l,rarity:this.getRarityForSprite(i,l,d)}});if(u.sort((d,l)=>Do(d.rarity)-Do(l.rarity)),u.length>0){let d=this.createDataCard(i,this.formatCategoryName(i),u,r);n.appendChild(d)}}}};$n();Kn();var dd={enabled:!1,favoriteProduceList:[],favoritePetsList:[],favoriteMutations:[]},Xe=[{id:"Rainbow",color:"#FF00FF",desc:"All Rainbow items"},{id:"Gold",color:"#EBC800",desc:"All Gold items"},{id:"Wet",color:"#5FFFFF",desc:"All Wet items"},{id:"Chilled",color:"#B4E6FF",desc:"All Chilled items"},{id:"Frozen",color:"#B9C8FF",desc:"All Frozen items"},{id:"Dawnlit",color:"#F59BE1",desc:"Dawn mutations"},{id:"Dawncharged",color:"#C896FF",desc:"Dawn charged"},{id:"Ambershine",color:"#FFB478",desc:"Amber mutations"},{id:"Ambercharged",color:"#FA8C4B",desc:"Amber charged"}],Hx={Common:1,Uncommon:2,Rare:3,Legendary:4,Mythical:5,Divine:6,Celestial:7};function tn(e){return e?Hx[e]??0:0}var xr=class extends Le{constructor(){super({id:"tab-auto-favorite",label:"Auto-Favorite"});ne(this,"config",dd);ne(this,"allPlants",[]);ne(this,"allPets",[]);ne(this,"sectionElement",null)}async build(n){let r=this.createGrid("12px");r.id="auto-favorite-settings";let o=document.createElement("style");o.textContent=`
    ...
    `,n.appendChild(o),this.sectionElement=r,n.appendChild(r),this.config=ze("gemini:features:autoFavorite:ui",dd),await this.loadGameData(),await this.waitForSprites(),this.renderContent()}async loadGameData(){try{await le.waitForAnyData();let n=le.get("plants")||{},r=le.get("pets")||{};this.allPlants=Object.keys(n).sort((o,a)=>{let i=n[o]?.seed?.rarity||null,s=n[a]?.seed?.rarity||null,u=tn(i)-tn(s);return u!==0?u:o.localeCompare(a,void 0,{numeric:!0,sensitivity:"base"})}),this.allPets=Object.keys(r).sort((o,a)=>{let i=r[o]?.rarity||null,s=r[a]?.rarity||null,u=tn(i)-tn(s);return u!==0?u:o.localeCompare(a,void 0,{numeric:!0,sensitivity:"base"})})}catch(n){console.error("[AutoFavorite UI] Failed to load game data:",n)}}async waitForSprites(){if(de.ready())return;let n=1e4,r=100,o=0;return new Promise(a=>{let i=()=>{de.ready()||o>=n?a():(o+=r,setTimeout(i,r))};i()})}renderContent(){this.sectionElement&&(this.sectionElement.innerHTML="",this.sectionElement.appendChild(this.createMasterToggle()),this.sectionElement.appendChild(this.createMutationsCard()),this.sectionElement.appendChild(this.createProduceCard()),this.sectionElement.appendChild(this.createPetsCard()))}createMasterToggle(){let n=y("div",{className:"kv"}),r=it({text:"Enable Auto-Favorite",tone:"default",size:"lg"}),o=Nt({checked:this.config.enabled,onChange:a=>{this.config.enabled=a,this.saveConfig()}});return n.append(r.root,o.root),ye({title:"Auto-Favorite",padding:"lg"},n,y("p",{style:"margin-top: 6px; font-size: 12px; color: var(--muted);"},"Automatically favorite items when added to inventory"))}createMutationsCard(){let n=y("div",{style:"display: grid; gap: 10px;"}),r=y("div",{style:"display: grid; grid-template-columns: 1fr 1fr; gap: 8px;"});r.appendChild(this.createMutationButton(Xe[0],{align:"center"})),r.appendChild(this.createMutationButton(Xe[1],{align:"center"})),n.appendChild(r);let o=y("div",{style:"display: grid; grid-template-columns: 1fr 1fr 1fr; gap: 8px;"});o.appendChild(this.createMutationButton(Xe[2],{align:"center"})),o.appendChild(this.createMutationButton(Xe[3],{align:"center"})),o.appendChild(this.createMutationButton(Xe[4],{align:"center"})),n.appendChild(o);let a=y("div",{style:"display: grid; grid-template-columns: 1fr 1fr; gap: 8px;"});a.appendChild(this.createMutationButton(Xe[5],{align:"center"})),a.appendChild(this.createMutationButton(Xe[6],{align:"center"})),n.appendChild(a);let i=y("div",{style:"display: grid; grid-template-columns: 1fr 1fr; gap: 8px;"});return i.appendChild(this.createMutationButton(Xe[7],{align:"center"})),i.appendChild(this.createMutationButton(Xe[8],{align:"center"})),n.appendChild(i),ye({title:"Mutations Priority",variant:"soft",padding:"lg",expandable:!0,defaultExpanded:!0},n,y("p",{style:"margin-top: 8px; font-size: 11px; color: var(--muted);"},`${this.config.favoriteMutations.length} / ${Xe.length} active`))}createMutationButton(n,r={}){let{large:o=!1,align:a="center"}=r,i=this.config.favoriteMutations.includes(n.id),s=n.color,u=parseInt(s.slice(1,3),16),d=parseInt(s.slice(3,5),16),l=parseInt(s.slice(5,7),16),c=`rgba(${u}, ${d}, ${l}, 0.25)`,p=s;n.id==="Rainbow"&&i&&(c="linear-gradient(135deg, rgba(255,0,0,0.3) 0%, rgba(255,165,0,0.3) 20%, rgba(255,255,0,0.3) 40%, rgba(0,128,0,0.3) 60%, rgba(0,0,255,0.3) 80%, rgba(75,0,130,0.3) 100%)",p="#fff9c4");let m=y("div",{style:`padding: ${o?"14px":"8px 16px"}; min-height: 52px; border-radius: var(--card-radius, 12px); cursor: pointer; transition: all 0.35s cubic-bezier(0.4, 0, 0.2, 1); background: ${i?c:"color-mix(in oklab, var(--tab-bg) 5%, transparent)"}; border: 2px solid ${i?p:"color-mix(in oklab, var(--tab-bg) 20%, transparent)"}; display: flex; align-items: center; justify-content: center; gap: 16px; box-shadow: ${i?n.id==="Rainbow"?"0 4px 18px rgba(255,255,255,0.25)":`0 4px 12px rgba(${u}, ${d}, ${l}, 0.3)`:"none"}; opacity: ${i?"1":"0.8"};`}),g=y("div",{style:"width: 32px; height: 32px; display: flex; align-items: center; justify-content: center; flex-shrink: 0;"});try{if(de.ready()){let b=de.toCanvas("plant","Sunflower",{mutations:[n.id],scale:.18});b.style.width="32px",b.style.height="32px",b.style.objectFit="contain",g.appendChild(b)}}catch{}let f=n.id.charAt(0).toUpperCase()+n.id.slice(1).toLowerCase(),h=y("div",{style:`font-size: ${o?"15px":"13px"}; font-weight: 600; color: var(--fg); text-shadow: 0 1px 2px rgba(0,0,0,0.5); white-space: nowrap;`},f);if(m.append(g,h),n.id==="Rainbow"||n.id==="Gold"){let b=y("div",{style:"width: 32px; height: 32px; display: flex; align-items: center; justify-content: center; flex-shrink: 0;"});try{if(de.ready()){let T=de.toCanvas("pet","Capybara",{mutations:[n.id],scale:.18});T.style.width="32px",T.style.height="32px",T.style.objectFit="contain",b.appendChild(T)}}catch{}m.append(b)}else{let b=y("div",{style:"width: 32px; height: 32px; flex-shrink: 0;"});m.append(b)}return m.addEventListener("click",()=>{i?this.config.favoriteMutations=this.config.favoriteMutations.filter(b=>b!==n.id):this.config.favoriteMutations.push(n.id),this.saveConfig(),this.renderContent()}),m}createProduceCard(){return this.createItemSelectionCard({title:"Produce",items:this.allPlants,category:"plant",selected:this.config.favoriteProduceList,onUpdate:n=>{this.config.favoriteProduceList=n,this.saveConfig()}})}createPetsCard(){return this.createItemSelectionCard({title:"Pets",items:this.allPets,category:"pet",selected:this.config.favoritePetsList,onUpdate:n=>{this.config.favoritePetsList=n,this.saveConfig()}})}createItemSelectionCard(n){let{title:r,items:o,category:a,selected:i,onUpdate:s}=n,u=new Set(i),d=o,l=y("div",{style:"margin-bottom: 8px;"}),c=bo({placeholder:`Search ${r.toLowerCase()}...`,value:"",debounceMs:150,withClear:!0,size:"sm",focusKey:"",onChange:x=>{let C=x.trim().toLowerCase();C?d=o.filter(P=>P.toLowerCase().includes(C)):d=o,S.setData(f())}});l.appendChild(c.root);let p=y("div",{style:"display: flex; gap: 8px; margin-bottom: 12px;"}),m=st({label:"Select All",variant:"default",size:"sm",onClick:()=>{let x=f().map(C=>C.id);S.setSelection(x)}}),g=st({label:"Deselect All",variant:"default",size:"sm",onClick:()=>{S.clearSelection()}});p.append(m,g);let f=()=>d.map(x=>({id:x,name:x,rarity:this.getItemRarity(x,a),selected:u.has(x)})),h=x=>{if(!x){let P=y("span",{style:"opacity:0.5;"});return P.textContent="\u2014",P}return ho({variant:"rarity",rarity:x,size:"sm"}).root},b=x=>{let C=y("div",{style:"width: 28px; height: 28px; display: flex; align-items: center; justify-content: center; overflow: hidden; flex-shrink: 0; background: rgba(0,0,0,0.05); border-radius: 6px;"});try{if(de.ready()){let P=a,M=x;a==="plant"&&(["Bamboo","Cactus"].includes(x)&&(P="tallplant"),x==="DawnCelestial"&&(M="DawnCelestialCrop"),x==="MoonCelestial"&&(M="MoonCelestialCrop"),x==="OrangeTulip"&&(M="Tulip"));let D=de.toCanvas(P,M,{scale:.5});D.style.width="28px",D.style.height="28px",D.style.objectFit="contain",C.appendChild(D)}}catch{}return C},S=mo({columns:[{key:"name",header:"Name",width:"1fr",align:"center",sortable:!0,sortFn:(x,C)=>x.name.localeCompare(C.name,void 0,{numeric:!0,sensitivity:"base"}),render:x=>{let C=y("div",{style:"display: flex; align-items: center; justify-content: center; gap: 8px; width: 100%;"}),P=b(x.id),M=y("span",{style:"font-weight: 500; color: var(--fg); white-space: nowrap;"},x.name);return C.append(P,M),C}},{key:"rarity",header:"Rarity",width:"100px",align:"center",sortable:!0,sortFn:(x,C)=>tn(x.rarity)-tn(C.rarity),render:x=>h(x.rarity)}],data:f(),maxHeight:280,compact:!0,zebra:!0,animations:!0,selectable:!0,selectOnRowClick:!0,hideHeaderCheckbox:!0,initialSelection:Array.from(u),getRowId:x=>x.id,onSelectionChange:x=>{u.clear(),x.forEach(C=>u.add(C)),s(Array.from(u)),k()}}),v=y("p",{style:"margin-top: 8px; font-size: 11px; color: var(--muted);"}),k=()=>{v.textContent=`${u.size} / ${o.length} selected`};return k(),ye({title:`${r} (${u.size}/${o.length})`,variant:"soft",padding:"lg",expandable:!0,defaultExpanded:!1},l,p,S.root,v)}getItemRarity(n,r){try{if(r==="pet")return(le.get("pets")||{})[n]?.rarity||null;if(r==="plant"){let o=le.get("plants")||{},a=o[n];if(a?.seed?.rarity)return a.seed.rarity;let i=n.toLowerCase();for(let s of Object.values(o))if(s?.seed?.name?.toLowerCase()===i||s?.plant?.name?.toLowerCase()===i)return s.seed.rarity}}catch{}return null}async saveConfig(){nt("gemini:features:autoFavorite:ui",this.config);try{let{setEnabled:n,updateSimpleConfig:r}=await Promise.resolve().then(()=>(ud(),cd));await r({enabled:this.config.enabled,favoriteSpecies:[...this.config.favoriteProduceList,...this.config.favoritePetsList],favoriteMutations:this.config.favoriteMutations}),await n(this.config.enabled)}catch(n){console.error("[AutoFavorite UI] Failed to apply config:",n)}}};Kn();var pd={autoFavorite:{enabled:!1},bulkFavorite:{enabled:!1},journalChecker:{enabled:!1},cropSizeIndicator:{enabled:!1,showForGrowing:!0,showForMature:!0,showJournalBadges:!0},eggProbabilityIndicator:{enabled:!1},cropValueIndicator:{enabled:!1},xpTracker:{enabled:!1},abilityTracker:{enabled:!1},mutationTracker:{enabled:!1},cropBoostTracker:{enabled:!1},turtleTimer:{enabled:!1}},Sr=class extends Le{constructor(){super({id:"tab-feature-settings",label:"Features"});ne(this,"config",pd)}async build(n){let r=this.createGrid("12px");r.id="feature-settings",n.appendChild(r),this.config=ze("gemini:features:config",pd),r.appendChild(this.createQOLCard()),r.appendChild(this.createVisualIndicatorsCard()),r.appendChild(this.createTrackingCard())}createQOLCard(){return ye({title:"Quality of Life",padding:"lg",expandable:!0,defaultExpanded:!0},this.createToggleRow("Auto-Favorite",this.config.autoFavorite.enabled,n=>{this.config.autoFavorite.enabled=n,this.saveConfig()}),this.createToggleRow("Bulk Favorite",this.config.bulkFavorite.enabled,n=>{this.config.bulkFavorite.enabled=n,this.saveConfig()}),this.createToggleRow("Journal Checker",this.config.journalChecker.enabled,n=>{this.config.journalChecker.enabled=n,this.saveConfig()}))}createVisualIndicatorsCard(){return ye({title:"Visual Indicators",variant:"soft",padding:"lg",expandable:!0,defaultExpanded:!0},this.createToggleRow("Crop Size",this.config.cropSizeIndicator.enabled,n=>{this.config.cropSizeIndicator.enabled=n,this.saveConfig()},"Shows size % and journal badges"),this.createToggleRow("Egg Probability",this.config.eggProbabilityIndicator.enabled,n=>{this.config.eggProbabilityIndicator.enabled=n,this.saveConfig()},"Shows hatch chances + mutation %"),this.createToggleRow("Crop Value",this.config.cropValueIndicator.enabled,n=>{this.config.cropValueIndicator.enabled=n,this.saveConfig()},"Shows coin value"))}createTrackingCard(){return ye({title:"Tracking & Analytics",variant:"soft",padding:"lg",expandable:!0,defaultExpanded:!1},this.createToggleRow("XP Tracker",this.config.xpTracker.enabled,n=>{this.config.xpTracker.enabled=n,this.saveConfig()}),this.createToggleRow("Ability Tracker",this.config.abilityTracker.enabled,n=>{this.config.abilityTracker.enabled=n,this.saveConfig()}),this.createToggleRow("Mutation Tracker",this.config.mutationTracker.enabled,n=>{this.config.mutationTracker.enabled=n,this.saveConfig()}),this.createToggleRow("Crop Boost Tracker",this.config.cropBoostTracker.enabled,n=>{this.config.cropBoostTracker.enabled=n,this.saveConfig()}),this.createToggleRow("Turtle Timer",this.config.turtleTimer.enabled,n=>{this.config.turtleTimer.enabled=n,this.saveConfig()}))}createToggleRow(n,r,o,a){let i=y("div",{className:a?"kv-col":"kv"}),s=y("div",{className:"kv"}),u=it({text:n,tone:"default",size:"md"}),d=Nt({checked:r,onChange:o});if(s.append(u.root,d.root),a){i.appendChild(s);let l=y("p",{className:"helper-text",style:"font-size: 12px; color: var(--item-desc, var(--muted)); margin-top: 4px;"},a);return i.appendChild(l),i}return s}saveConfig(){nt("gemini:features:config",this.config),console.log("[FeatureSettings] Config saved:",this.config)}};var wr=class extends Le{constructor(){super({id:"tab-journal-checker",label:"Journal"});ne(this,"progress",null)}async build(n){this.container=n;let r=this.createGrid("12px");r.id="journal-checker",n.appendChild(r),await this.updateProgress();let o=(a=>{this.progress=a.detail,this.renderContent()});window.addEventListener("gemini:journal-updated",o),this.addCleanup(()=>{window.removeEventListener("gemini:journal-updated",o)})}async updateProgress(){try{let{aggregateJournalProgress:n}=await Promise.resolve().then(()=>(hd(),bd));this.progress=await n(),this.renderContent()}catch(n){console.error("[JournalChecker] Failed to load progress:",n)}}renderContent(){if(!this.container)return;let n=this.container.querySelector("#journal-checker");if(n){if(n.innerHTML="",!this.progress){n.appendChild(this.createLoadingCard());return}n.appendChild(this.createProgressCard()),n.appendChild(this.createActionsCard())}}createLoadingCard(){return ye({title:"Loading...",padding:"lg"},y("p",{},"Fetching journal data..."))}createProgressCard(){if(!this.progress)return y("div");let n=this.createProgressRow("\u{1F331} Plants",this.progress.plants.logged,this.progress.plants.total,this.progress.plants.percentage),r=this.createProgressRow("\u{1F43E} Pets",this.progress.pets.logged,this.progress.pets.total,this.progress.pets.percentage),o=this.createProgressRow("\u{1F3A8} Decor",this.progress.decor.logged,this.progress.decor.total,this.progress.decor.percentage);return ye({title:"Collection Progress",padding:"lg",expandable:!0,defaultExpanded:!0},n,r,o)}createProgressRow(n,r,o,a){let i=y("div",{className:"kv-col",style:"gap: 6px;"}),s=y("div",{className:"kv"}),u=it({text:n,tone:"default",size:"md"}),d=y("span",{style:"font-size: 13px; color: var(--item-desc, var(--muted));"},`${r}/${o}`);s.append(u.root,d);let l=y("div",{style:`
      ...
      `});return l.appendChild(c),i.append(s,l),i}createActionsCard(){let n=st({label:"\u{1F504} Refresh",variant:"default",size:"md",onClick:async()=>{await this.updateProgress()}}),r=st({label:"\u{1F4CB} Show Missing",variant:"default",size:"md",onClick:()=>{this.showMissingItems()}}),o=y("div",{style:"display: flex; gap: 8px; flex-wrap: wrap;"});return o.append(n,r),ye({title:"Actions",variant:"soft",padding:"lg",expandable:!0,defaultExpanded:!1},o)}showMissingItems(){if(!this.progress)return;let n=[{category:"Plants",items:this.progress.plants.missing},{category:"Pets",items:this.progress.pets.missing},{category:"Decor",items:this.progress.decor.missing}].filter(r=>r.items.length>0);if(n.length===0){console.log("\u{1F389} [JournalChecker] Collection complete!");return}console.group("\u{1F4CB} Missing Items"),n.forEach(r=>{console.group(`${r.category} (${r.items.length})`),r.items.forEach(o=>console.log(`- ${o}`)),console.groupEnd()}),console.groupEnd()}};var Li=null;function yd(){return Li||(Li=new Ro),Li}async function Di(){await yd().preload()}function Ri(e){return[new po(e),new Sr,new xr,new wr,yd()]}ve();function Oi(e){let{shadow:t,initialOpen:n}=e,r=y("div",{className:"gemini-panel",id:"panel",ariaHidden:String(!n)}),o=y("div",{className:"gemini-tabbar"}),a=y("div",{className:"gemini-content",id:"content"}),i=y("div",{className:"gemini-resizer",title:"Resize"}),s=y("button",{className:"gemini-close",title:"Fermer",ariaLabel:"Fermer"},"\u2715");r.append(o,a,i);let u=y("div",{className:"gemini-wrapper"},r);return t.append(u),{panel:r,tabbar:o,content:a,resizer:i,closeButton:s,wrapper:u}}Gt();ve();function Gi(e){let{resizer:t,host:n,panel:r,shadow:o,onWidthChange:a,initialWidth:i,minWidth:s,maxWidth:u}=e,d=s,l=u;function c(){let k=De.detect(),x=Math.round(A.visualViewport?.width??A.innerWidth??0);if(k.platform==="mobile"||k.os==="ios"||k.os==="android"){let C=getComputedStyle(o.host),P=parseFloat(C.getPropertyValue("--inset-l"))||0,M=parseFloat(C.getPropertyValue("--inset-r"))||0,D=Math.max(280,x-Math.round(P+M)),L=Math.min(420,Math.max(300,Math.floor(x*.66))),W=D;d=Math.min(L,D),l=W}else d=s,l=u;return{min:d,max:l}}function p(k){return Math.max(d,Math.min(l,Number(k)||i))}function m(k){let x=p(k);n.style.setProperty("--w",`${x}px`),a(x)}c();let g=De.detect(),f=!(g.platform==="mobile"||g.os==="ios"||g.os==="android"),h=!1,b=k=>{if(!h)return;k.preventDefault();let x=Math.round(A.innerWidth-k.clientX);m(x)},T=()=>{h&&(h=!1,document.body.style.cursor="",A.removeEventListener("mousemove",b),A.removeEventListener("mouseup",T))},S=k=>{f&&(k.preventDefault(),h=!0,document.body.style.cursor="ew-resize",A.addEventListener("mousemove",b),A.addEventListener("mouseup",T))};t.addEventListener("mousedown",S);function v(){t.removeEventListener("mousedown",S),A.removeEventListener("mousemove",b),A.removeEventListener("mouseup",T)}return{calculateResponsiveBounds:c,constrainWidthToLimits:p,setHudWidth:m,destroy:v}}function Hi(e){let{panel:t,onToggle:n,onClose:r,toggleCombo:o=u=>u.ctrlKey&&u.shiftKey&&u.key.toLowerCase()==="u",closeOnEscape:a=!0}=e;function i(u){let d=t.classList.contains("open");if(a&&u.key==="Escape"&&d){r();return}o(u)&&(u.preventDefault(),u.stopPropagation(),n())}document.addEventListener("keydown",i,{capture:!0});function s(){document.removeEventListener("keydown",i,{capture:!0})}return{destroy:s}}var vd=`
@layer hud {
  /* Root container */
  .gemini-wrapper {
    position: relative;
...
`;var Wx={all:"initial",position:"fixed",top:"0",right:"0",zIndex:"2147483647",pointerEvents:"auto",fontFamily:'system-ui, -apple-system, "Segoe UI", Roboto, Inter, "Helvetica Neue", Arial, "Noto Sans", "Liberation Sans", sans-serif',fontSize:"13px",lineHeight:"1.35"};function Fx(e="gemini-root"){let t=document.createElement("div");t.id=e,Object.assign(t.style,Wx),(document.body||document.documentElement).appendChild(t);let n=t.attachShadow({mode:"open"});return{host:t,shadow:n}}function Bx(){return new Promise(e=>{typeof requestIdleCallback<"u"?requestIdleCallback(()=>e(),{timeout:16}):setTimeout(e,0)})}async function Bi(e){let{hostId:t="gemini-hud-root",initialWidth:n,initialOpen:r,onWidthChange:o,onOpenChange:a,themes:i,initialTheme:s,onThemeChange:u,buildSections:d,initialTab:l,onTabChange:c,toggleCombo:p=E=>E.ctrlKey&&E.shiftKey&&E.key.toLowerCase()==="u",closeOnEscape:m=!0,minWidth:g=420,maxWidth:f=720}=e,{host:h,shadow:b}=Fx(t),T=[[Ni,"variables"],[_i,"primitives"],[Wi,"utilities"],[vd,"hud"],[xd,"card"],[Sd,"badge"],[wd,"button"],[Td,"input"],[kd,"label"],[Cd,"navTabs"],[Pd,"searchBar"],[Md,"select"],[Ad,"switch"],[Id,"table"],[Ed,"timeRangePicker"],[Ld,"tooltip"],[Dd,"slider"],[Rd,"reorderableList"],[Od,"colorPicker"],[Gd,"log"],[Hd,"settings"]];for(let E=0;E<T.length;E++){let[R,N]=T[E];Fi(b,R,N),E%5===4&&await Bx()}let{panel:S,tabbar:v,content:k,resizer:x,closeButton:C,wrapper:P}=Oi({shadow:b,initialOpen:r});function M(E){S.dispatchEvent(new CustomEvent("gemini:hud-open-change",{detail:{isOpen:E},bubbles:!0})),a?.(E)}function D(E){let R=S.classList.contains("open");S.classList.toggle("open",E),S.setAttribute("aria-hidden",E?"false":"true"),E!==R&&M(E)}D(r),C.addEventListener("click",E=>{E.preventDefault(),E.stopPropagation(),D(!1)});let L=Or({host:h,themes:i,initialTheme:s,onThemeChange:u}),W=Gi({resizer:x,host:h,panel:S,shadow:b,onWidthChange:o||(()=>{}),initialWidth:n,minWidth:g,maxWidth:f});W.setHudWidth(n);let oe=d({applyTheme:L.applyTheme,initialTheme:s,getCurrentTheme:L.getCurrentTheme,setHUDWidth:W.setHudWidth,setHUDOpen:D}),z=new sn(oe,k,{applyTheme:L.applyTheme,getCurrentTheme:L.getCurrentTheme}),X=oe.map(E=>({id:E.id,label:E.label})),ue=is(X,l||X[0]?.id||"",E=>{z.activate(E),c?.(E)});ue.root.style.flex="1 1 auto",ue.root.style.minWidth="0",v.append(ue.root,C),z.activate(l||X[0]?.id||"");let V=Hi({panel:S,onToggle:()=>D(!S.classList.contains("open")),onClose:()=>D(!1),toggleCombo:p,closeOnEscape:m}),_=()=>{ue.recalc();let E=parseInt(getComputedStyle(h).getPropertyValue("--w"))||n;W.calculateResponsiveBounds(),W.setHudWidth(E)};A.addEventListener("resize",_);function H(){V.destroy(),W.destroy(),A.removeEventListener("resize",_)}return{host:h,shadow:b,wrapper:P,panel:S,content:k,setOpen:D,setWidth:W.setHudWidth,sections:oe,manager:z,nav:ue,destroy:H}}var nn={isOpen:"gemini.hud.isOpen",width:"gemini.hud.width",theme:"gemini.hud.theme",activeTab:"gemini.hud.activeTab"},Xn={isOpen:!1,width:480,theme:"dark",activeTab:"tab-settings"};function ji(){return{isOpen:at(nn.isOpen,Xn.isOpen),width:at(nn.width,Xn.width),theme:at(nn.theme,Xn.theme),activeTab:at(nn.activeTab,Xn.activeTab)}}function on(e,t){ln(nn[e],t)}var jx="https://i.imgur.com/IMkhMur.png",Ux="Stats";function Tr(e){let t=e.iconUrl||jx,n=e.ariaLabel||"Open MGH",r=null,o=null,a=null,i=!1,s=null,u=null,d=["Chat","Leaderboard","Stats","Open Activity Log"],l=S=>{try{return typeof CSS<"u"&&CSS&&typeof CSS.escape=="function"?CSS.escape(S):S.replace(/"/g,'\\"')}catch{return S}};function c(){let S=document.querySelector(d.map(k=>`button[aria-label="${l(k)}"]`).join(","));if(!S)return null;let v=S.parentElement;for(;v&&v!==document.body;){if(d.reduce((x,C)=>x+v.querySelectorAll(`button[aria-label="${l(C)}"]`).length,0)>=2)return v;v=v.parentElement}return null}function p(S){return S}function m(S){let v=Array.from(S.querySelectorAll("button[aria-label]"));if(!v.length)return{refBtn:null,refWrapper:null};let k=v.filter(W=>W.dataset.mghBtn!=="true"&&(W.getAttribute("aria-label")||"")!==(e.ariaLabel||"Open MGH")),x=k.length?k:v,C=x.find(W=>(W.getAttribute("aria-label")||"").toLowerCase()===Ux.toLowerCase())||null,P=x.length>=2?x.length-2:x.length-1,M=C||x[P],D=M.parentElement,L=D&&D.parentElement===S&&D.tagName==="DIV"?D:null;return{refBtn:M,refWrapper:L}}function g(S,v,k){let x=S.cloneNode(!1);x.type="button",x.setAttribute("aria-label",v),x.title=v,x.dataset.mghBtn="true",x.style.pointerEvents="auto",x.removeAttribute("id");let C=document.createElement("img");return C.src=k,C.alt="MGH",C.style.pointerEvents="none",C.style.userSelect="none",C.style.width="76%",C.style.height="76%",C.style.objectFit="contain",C.style.display="block",C.style.margin="auto",x.appendChild(C),x.addEventListener("click",P=>{P.preventDefault(),P.stopPropagation();try{e.onClick?.()}catch{}}),x}function f(){if(i)return!1;i=!0;let S=!1;try{let v=c();if(!v)return!1;s!==v&&(s=v);let{refBtn:k,refWrapper:x}=m(v);if(!k)return!1;o=v.querySelector('div[data-mgh-wrapper="true"]'),!o&&x&&(o=x.cloneNode(!1),o.dataset.mghWrapper="true",o.removeAttribute("id"),S=!0);let C=o?.querySelector('button[data-mgh-btn="true"]')||null;r||(r=C),r||(r=g(k,n,t),o?o.appendChild(r):r.parentElement!==v&&v.appendChild(r),S=!0),o&&o.parentElement!==v&&(v.appendChild(o),S=!0);let P=v;if(P&&P!==u){try{T.disconnect()}catch{}u=P,T.observe(u,{childList:!0,subtree:!0})}return S}finally{i=!1}}f();let h=document.getElementById("App")||document.body,b=null,T=new MutationObserver(S=>{let v=S.every(x=>{let C=Array.from(x.addedNodes||[]),P=Array.from(x.removedNodes||[]),M=C.concat(P);if(M.length===0){let D=x.target;return o&&(D===o||o.contains(D))||r&&(D===r||r.contains(D))}return M.every(D=>!!(!(D instanceof HTMLElement)||o&&(D===o||o.contains(D))||r&&(D===r||r.contains(D))))}),k=S.some(x=>Array.from(x.removedNodes||[]).some(C=>C instanceof HTMLElement?!!(o&&(C===o||o.contains(C))||r&&(C===r||r.contains(C))):!1));v&&!k||b===null&&(b=window.setTimeout(()=>{if(b=null,f()&&o){let C=o.parentElement;C&&C.lastElementChild!==o&&C.appendChild(o)}},150))});return T.observe(h,{childList:!0,subtree:!0}),a=()=>T.disconnect(),()=>{try{a?.()}catch{}try{o?.remove()}catch{}}}hr();ve();var Kx={},Wd=[];function zx(){return Wd.slice()}function Vx(e){Wd.push(e)}function Fd(e){try{return JSON.parse(e)}catch{return}}function Nd(e){if(typeof e=="string"){let t=Fd(e);return t!==void 0?t:e}return e}function Bd(e){if(e!=null){if(typeof e=="string"){let t=Fd(e);return t!==void 0?Bd(t):e}if(Array.isArray(e)&&typeof e[0]=="string")return e[0];if(typeof e=="object"){let t=e;return t.type??t.Type??t.kind??t.messageType}}}function $x(e){let t=e?.MagicCircle_RoomConnection?.currentWebSocket;return t&&typeof t=="object"?t:null}function j(e,t,n){let r=typeof t=="boolean"?t:!0,o=typeof t=="function"?t:n,a=(i,s)=>{if(Bd(i)!==e)return;let d=o(i,s);return d&&typeof d=="object"&&"kind"in d?d:typeof d=="boolean"?d?void 0:{kind:"drop"}:r?void 0:{kind:"drop"}};return Vx(a),a}var Qn=new WeakSet,_d=new WeakMap;function jd(e){let t=e.pageWindow,n=!!e.debug,r=e.middlewares&&e.middlewares.length?e.middlewares:zx();if(!r.length)return()=>{};let o=p=>({ws:p,pageWindow:t,debug:n}),a=(p,m)=>{let g=p;for(let f of r){let h=f(g,o(m));if(h){if(h.kind==="drop")return{kind:"drop"};h.kind==="replace"&&(g=h.message)}}return g!==p?{kind:"replace",message:g}:void 0},i=null,s=null,u=null,d=()=>{let p=t?.MagicCircle_RoomConnection,m=p?.sendMessage;if(!p||typeof m!="function")return!1;if(Qn.has(m))return!0;let g=m.bind(p);function f(...h){let b=h.length===1?h[0]:h,T=Nd(b),S=a(T,$x(t));if(S?.kind==="drop"){n&&console.log("[WS] drop outgoing (RoomConnection.sendMessage)",T);return}if(S?.kind==="replace"){let v=S.message;return h.length>1&&Array.isArray(v)?(n&&console.log("[WS] replace outgoing (RoomConnection.sendMessage)",T,"=>",v),g(...v)):(n&&console.log("[WS] replace outgoing (RoomConnection.sendMessage)",T,"=>",v),g(v))}return g(...h)}Qn.add(f),_d.set(f,m);try{p.sendMessage=f,Qn.add(p.sendMessage),n&&console.log("[WS] outgoing patched via MagicCircle_RoomConnection.sendMessage")}catch{return!1}return i=()=>{try{p.sendMessage===f&&(p.sendMessage=m)}catch{}},!0};(()=>{let p=t?.WebSocket?.prototype,m=p?.send;if(typeof m!="function"||Qn.has(m))return;function g(f){let h=Nd(f),b=a(h,this);if(b?.kind==="drop"){n&&console.log("[WS] drop outgoing (ws.send)",h);return}if(b?.kind==="replace"){let T=b.message,S=typeof T=="string"||T instanceof ArrayBuffer||T instanceof Blob?T:JSON.stringify(T);return n&&console.log("[WS] replace outgoing (ws.send)",h,"=>",T),m.call(this,S)}return m.call(this,f)}Qn.add(g),_d.set(g,m);try{p.send=g,n&&console.log("[WS] outgoing patched via WebSocket.prototype.send")}catch{return}s=()=>{try{p.send===g&&(p.send=m)}catch{}}})();let c=e.waitForRoomConnectionMs??4e3;if(!d()&&c>0){let p=Date.now();u=setInterval(()=>{if(d()){clearInterval(u),u=null;return}Date.now()-p>c&&(clearInterval(u),u=null,n&&console.log("[WS] RoomConnection not found, only ws.send is patched"))},250)}return()=>{if(u){try{clearInterval(u)}catch{}u=null}if(i){try{i()}catch{}i=null}if(s){try{s()}catch{}s=null}}}(function(){try{let t=Kx,n=t.glob?.("./**/*.ts",{eager:!0})??t.glob?.("./**/*.js",{eager:!0});if(!n)return}catch{}})();var Xx={},zd=[];function Jx(){return zd.slice()}function Ud(e){zd.push(e)}function qx(e){if(e!=null){if(typeof e=="object"){let t=e;if(typeof t.type=="string")return t.type;if(typeof t.Type=="string")return t.Type;if(typeof t.kind=="string")return t.kind;if(typeof t.messageType=="string")return t.messageType}if(Array.isArray(e)&&typeof e[0]=="string")return e[0]}}function Yx(e){if(typeof e=="string")try{return JSON.parse(e)}catch{return e}return e}var Ui=Symbol.for("ariesmod.ws.handlers.patched");function he(e,t){if(typeof e=="string"){let o=e,a={match:i=>i.kind==="message"&&i.type===o,handle:t};return Ud(a),a}let n=e,r={match:o=>o.kind==="close"&&o.code===n,handle:t};return Ud(r),r}function Vd(e,t=Jx(),n={}){let r=n.pageWindow??window,o=!!n.debug;if(e[Ui])return()=>{};e[Ui]=!0;let a={ws:e,pageWindow:r,debug:o},i=c=>{for(let p of t)try{if(!p.match(c))continue;if(p.handle(c,a)===!0)return}catch(m){o&&console.error("[WS] handler error",m,c)}},s=c=>{let p=Yx(c.data),m=qx(p);i({kind:"message",raw:c.data,data:p,type:m})},u=c=>{i({kind:"close",code:c.code,reason:c.reason,wasClean:c.wasClean,event:c})},d=c=>i({kind:"open",event:c}),l=c=>i({kind:"error",event:c});return e.addEventListener("message",s),e.addEventListener("close",u),e.addEventListener("open",d),e.addEventListener("error",l),()=>{try{e.removeEventListener("message",s)}catch{}try{e.removeEventListener("close",u)}catch{}try{e.removeEventListener("open",d)}catch{}try{e.removeEventListener("error",l)}catch{}try{delete e[Ui]}catch{}}}(function(){try{let t=Xx,n=t.glob?.("./**/*.ts",{eager:!0})??t.glob?.("./**/*.js",{eager:!0});if(!n)return}catch{}})();ot();he(4800,(e,t)=>{t.debug&&console.log("[WS][Close] Auth failure",e.code,e.reason)});he(4300,(e,t)=>{t.debug&&console.log("[WS][Close] Superseded",e.code,e.reason)});he(4400,(e,t)=>{t.debug&&console.log("[WS][Close] Heartbeat expired",e.code,e.reason)});he(4500,(e,t)=>{t.debug&&console.log("[WS][Close] Player kicked",e.code,e.reason)});he(4200,(e,t)=>{t.debug&&console.log("[WS][Close] Player left voluntarily",e.code,e.reason)});he(4100,(e,t)=>{t.debug&&console.log("[WS][Close] Reconnect initiated",e.code,e.reason)});he(4310,(e,t)=>{t.debug&&console.log("[WS][Close] Server disposed",e.code,e.reason)});he(4250,(e,t)=>{t.debug&&console.log("[WS][Close] User session superseded",e.code,e.reason)});he(4710,(e,t)=>{t.debug&&console.log("[WS][Close] Version expired",e.code,e.reason)});he(4700,(e,t)=>{t.debug&&console.log("[WS][Close] Version mismatch",e.code,e.reason)});ot();he(Ye.Config,(e,t)=>{t.debug&&console.log("[WS][STC] Config",e.data)});he(Ye.CurrencyTransaction,(e,t)=>{t.debug&&console.log("[WS][STC] CurrencyTransaction",e.data)});he(Ye.Emote,(e,t)=>{t.debug&&console.log("[WS][STC] Emote",e.data)});he(Ye.InappropriateContentRejected,(e,t)=>{t.debug&&console.log("[WS][STC] InappropriateContentRejected",e.data)});he(Ye.PartialState,(e,t)=>{t.debug&&console.log("[WS][STC] PartialState",e.data)});he(Ye.Pong,(e,t)=>{t.debug&&console.log("[WS][STC] Pong",e.data)});he(Ye.ServerErrorMessage,(e,t)=>{t.debug&&console.log("[WS][STC] ServerErrorMessage",e.data)});he(Ye.Welcome,(e,t)=>{t.debug&&console.log("[WS][STC] Welcome",e.data)});ot();j(I.PlantSeed,(e,t)=>(t.debug&&console.log("[MW][Garden] PlantSeed"),!!1));j(I.WaterPlant,(e,t)=>(t.debug&&console.log("[MW][Garden] WaterPlant"),!!1));j(I.HarvestCrop,(e,t)=>(t.debug&&console.log("[MW][Garden] HarvestCrop"),!!1));j(I.SellAllCrops,(e,t)=>(t.debug&&console.log("[MW][Garden] SellAllCrops"),!!1));j(I.PurchaseSeed,(e,t)=>(t.debug&&console.log("[MW][Garden] PurchaseSeed"),!!1));j(I.PurchaseEgg,(e,t)=>(t.debug&&console.log("[MW][Garden] PurchaseEgg"),!!1));j(I.PurchaseTool,(e,t)=>(t.debug&&console.log("[MW][Garden] PurchaseTool"),!!1));j(I.PurchaseDecor,(e,t)=>(t.debug&&console.log("[MW][Garden] PurchaseDecor"),!!1));j(I.PlantEgg,(e,t)=>(t.debug&&console.log("[MW][Garden] PlantEgg"),!!1));j(I.HatchEgg,(e,t)=>(t.debug&&console.log("[MW][Garden] HatchEgg"),!!1));j(I.PlantGardenPlant,(e,t)=>(t.debug&&console.log("[MW][Garden] PlantGardenPlant"),!!1));j(I.PotPlant,(e,t)=>(t.debug&&console.log("[MW][Garden] PotPlant"),!!1));j(I.MutationPotion,(e,t)=>(t.debug&&console.log("[MW][Garden] MutationPotion"),!!1));j(I.PickupDecor,(e,t)=>(t.debug&&console.log("[MW][Garden] PickupDecor"),!!1));j(I.PlaceDecor,(e,t)=>(t.debug&&console.log("[MW][Garden] PlaceDecor"),!!1));j(I.RemoveGardenObject,(e,t)=>(t.debug&&console.log("[MW][Garden] RemoveGardenObject"),!!1));ot();j(I.MoveInventoryItem,(e,t)=>(t.debug&&console.log("[MW][Inventory] MoveInventoryItem"),!!1));j(I.DropObject,(e,t)=>(t.debug&&console.log("[MW][Inventory] DropObject"),!!1));j(I.PickupObject,(e,t)=>(t.debug&&console.log("[MW][Inventory] PickupObject"),!!1));j(I.ToggleFavoriteItem,(e,t)=>(t.debug&&console.log("[MW][Inventory] ToggleFavoriteItem"),!!1));j(I.PutItemInStorage,(e,t)=>(t.debug&&console.log("[MW][Inventory] PutItemInStorage"),!!1));j(I.RetrieveItemFromStorage,(e,t)=>(t.debug&&console.log("[MW][Inventory] RetrieveItemFromStorage"),!!1));j(I.MoveStorageItem,(e,t)=>(t.debug&&console.log("[MW][Inventory] MoveStorageItem"),!!1));j(I.LogItems,(e,t)=>(t.debug&&console.log("[MW][Inventory] LogItems"),!!1));ot();j(I.PlacePet,(e,t)=>(t.debug&&console.log("[MW][Pets] PlacePet"),!!1));j(I.FeedPet,(e,t)=>(t.debug&&console.log("[MW][Pets] FeedPet"),!!1));j(I.PetPositions,(e,t)=>(t.debug&&console.log("[MW][Pets] PetPositions"),!!1));j(I.SwapPet,(e,t)=>(t.debug&&console.log("[MW][Pets] SwapPet"),!!1));j(I.StorePet,(e,t)=>(t.debug&&console.log("[MW][Pets] StorePet"),!!1));j(I.NamePet,(e,t)=>(t.debug&&console.log("[MW][Pets] NamePet"),!!1));j(I.SellPet,(e,t)=>(t.debug&&console.log("[MW][Pets] SellPet"),!!1));ot();console.log("[WS] TESTTEST");j(I.SetSelectedGame,(e,t)=>(t.debug&&console.log("[MW][Session] SetSelectedGame"),!!1));j(I.VoteForGame,(e,t)=>(t.debug&&console.log("[MW][Session] VoteForGame"),!!1));j(I.RequestGame,(e,t)=>(t.debug&&console.log("[MW][Session] RequestGame"),!!1));j(I.RestartGame,(e,t)=>(t.debug&&console.log("[MW][Session] RestartGame"),!!1));j(I.Ping,(e,t)=>(t.debug&&console.log("[MW][Session] Ping"),!!1));j(I.PlayerPosition,(e,t)=>(t.debug&&console.log("[MW][Session] PlayerPosition"),!!1));j(I.Teleport,(e,t)=>(t.debug&&console.log("[MW][Session] Teleport"),!!1));j(I.CheckWeatherStatus,(e,t)=>(t.debug&&console.log("[MW][Session] CheckWeatherStatus"),!!1));ot();j(I.Chat,(e,t)=>(t.debug&&console.log("[MW][Social] Chat"),!!1));j(I.Dev,(e,t)=>(t.debug&&console.log("[MW][Social] Dev"),!!1));j(I.Emote,(e,t)=>(t.debug&&console.log("[MW][Social] Emote"),!!1));j(I.Wish,(e,t)=>(t.debug&&console.log("[MW][Social] Wish"),!!1));j(I.KickPlayer,(e,t)=>(t.debug&&console.log("[MW][Social] KickPlayer"),!!1));j(I.ReportSpeakingStart,(e,t)=>(t.debug&&console.log("[MW][Voice] ReportSpeakingStart"),!!1));j(I.SetPlayerData,(e,t)=>(t.debug&&console.log("[MW][Social] SetPlayerData"),!!1));j(I.UsurpHost,(e,t)=>(t.debug&&console.log("[MW][Social] UsurpHost"),!!1));function Qx(e={}){let t=e.pageWindow??A,n=e.pollMs??500,r=!!e.debug,o=[];o.push(du(t,{debug:r})),o.push(jd({pageWindow:t,middlewares:e.middlewares,debug:r}));let a=null,i=s=>{if(a){try{a()}catch{}a=null}s&&(a=Vd(s,e.handlers,{debug:r,pageWindow:t}))};return i(Jn(t).ws),o.push(br(s=>i(s.ws),{intervalMs:n,debug:r,pageWindow:t})),{getWs:()=>Jn(t).ws,dispose:()=>{for(let s=o.length-1;s>=0;s--)try{o[s]()}catch{}if(a){try{a()}catch{}a=null}}}}var kr=null;function $d(e={}){return kr||(kr=Qx(e),kr)}hr();$n();wt();fr();yr();ut();Vt();function Vi(e){e.logStep("WebSocket","Capturing WebSocket...");let t=null;return t=br(n=>{n.ws&&(e.logStep("WebSocket","WebSocket captured","success"),t?.(),t=null)},{intervalMs:250}),$d({debug:!1}),()=>{t?.(),t=null}}async function $i(e){e.logStep("Atoms","Prewarming Jotai store...");try{await sa(),await Ho({timeoutMs:8e3,intervalMs:50}),e.logStep("Atoms","Jotai store ready","success")}catch(t){e.logStep("Atoms","Jotai store not captured yet","error"),console.warn("[Bootstrap] Jotai store wait failed",t)}}function Ki(e){e.logStep("Globals","Initializing global variables...");try{mr(),e.logStep("Globals","Global variables ready","success")}catch(t){e.logStep("Globals","Failed to initialize global variables","error"),console.warn("[Bootstrap] Global variables init failed",t)}}function Ji(e){e.logStep("API","Exposing Gemini API...");try{id(),e.logStep("API","Gemini API ready","success")}catch(t){e.logStep("API","Failed to expose API","error"),console.warn("[Bootstrap] API init failed",t)}}function zi(){return new Promise(e=>{typeof requestIdleCallback<"u"?requestIdleCallback(()=>e(),{timeout:50}):setTimeout(e,0)})}async function qi(e){e.logStep("HUD","Loading HUD preferences..."),await zi();let t=ji();await zi();let n=await Bi({hostId:"gemini-hud-root",initialWidth:t.width,initialOpen:t.isOpen,onWidthChange:r=>on("width",r),onOpenChange:r=>on("isOpen",r),themes:lt,initialTheme:t.theme,onThemeChange:r=>on("theme",r),buildSections:r=>Ri({applyTheme:r.applyTheme,initialTheme:r.initialTheme,getCurrentTheme:r.getCurrentTheme}),initialTab:t.activeTab,onTabChange:r=>on("activeTab",r)});return await zi(),e.logStep("HUD","HUD ready","success"),n}async function Yi(e){e.setSubtitle("Activating Gemini modules..."),await su(t=>{t.status==="start"?e.logStep(t.name,`Loading ${t.name}...`):t.status==="success"?e.logStep(t.name,`${t.name} ready`,"success"):e.logStep(t.name,`${t.name} encountered an issue.`,"error")})}async function Xi(e){e.logStep("Sprites","Warming up sprite cache...");try{de.ready()||await de.init();let t=[],n=le.get("plants");if(n)for(let i of Object.values(n))i?.seed?.spriteId&&t.push(i.seed.spriteId),i?.plant?.spriteId&&t.push(i.plant.spriteId),i?.crop?.spriteId&&t.push(i.crop.spriteId);let r=le.get("pets");if(r)for(let i of Object.values(r))i?.spriteId&&t.push(i.spriteId);let o=[...new Set(t)],a=o.length;if(a===0){e.logStep("Sprites","No sprites to warmup","success");return}await de.warmup(o,(i,s)=>{e.logStep("Sprites",`Loading sprites (${i}/${s})...`)},5),e.logStep("Sprites",`${a} sprites loaded`,"success")}catch(t){e.logStep("Sprites","Sprite warmup failed","error"),console.warn("[Bootstrap] Sprite warmup failed",t)}}async function Qi(e){e.logStep("Sections","Preloading UI sections...");try{await Di(),e.logStep("Sections","Sections preloaded","success")}catch(t){e.logStep("Sections","Sections preload failed","error"),console.warn("[Bootstrap] Sections preload failed",t)}}(async function(){"use strict";let e=Ir({title:"Gemini is loading",subtitle:"Connecting and preparing modules..."}),t=null;try{t=Vi(e),await $i(e),Ki(e),Ji(e),await Yi(e),await Xi(e),await Qi(e),e.succeed("Gemini is ready!")}catch(r){e.fail("Failed to initialize the mod.",r)}finally{t?.()}let n=await qi(e);Tr({onClick:()=>n.setOpen(!0)})})();})();
