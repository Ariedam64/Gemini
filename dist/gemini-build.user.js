...
(function () {
  ...
  var jv=Object.defineProperty;var Gv=(e,t,n)=>t in e?jv(e,t,{enumerable:true,configurable:true,writable:true,value:n}):e[t]=n;var xe=(e,t,n)=>Gv(e,typeof t!="symbol"?t+"":t,n);function w(e,t=null,...n){const r=document.createElement(e);for(const[o,i]of Object.entries(t||{}))i!=null&&(o==="style"?typeof i=="string"?r.setAttribute("style",i):typeof i=="object"&&Object.assign(r.style,i):o.startsWith("on")&&typeof i=="function"?r[o.toLowerCase()]=i:o in r?r[o]=i:r.setAttribute(o,String(i)));for(const o of n)o==null||o===false||r.appendChild(typeof o=="string"||typeof o=="number"?document.createTextNode(String(o)):o);return r}const pa="https://i.imgur.com/k5WuC32.png",hp="gemini-loader-style",Cr="gemini-loader",Jf=80;function Uv(){if(document.getElementById(hp))return;const e=document.createElement("style");e.id=hp,e.textContent=`
    /* ===== Loader Variables ===== */
    #${Cr} {
  ...
  `;const t=document.head||document.documentElement||document.body;if(t){t.appendChild(e);return}const n=()=>{(document.head||document.documentElement||document.body)?.appendChild(e);};document.readyState==="loading"?document.addEventListener("DOMContentLoaded",n,{once:true}):setTimeout(n,0);}function fa(e,t,n){const r=w("div",{className:`gemini-loader__log ${n}`},w("div",{className:"gemini-loader__dot"}),w("div",{textContent:t}));for(e.appendChild(r);e.childElementCount>Jf;)e.firstElementChild?.remove();e.scrollTop=e.scrollHeight;}function Wv(){return new Promise(e=>{if(typeof GM_xmlhttpRequest>"u"){e(pa);return}GM_xmlhttpRequest({method:"GET",url:pa,responseType:"blob",onload:t=>{const n=t.response,r=new FileReader;r.onloadend=()=>e(r.result),r.onerror=()=>e(pa),r.readAsDataURL(n);},onerror:()=>e(pa)});})}function Hv(e={}){const t=Number.isFinite(e.blurPx)?Math.max(4,Number(e.blurPx)):14;Uv();const n=w("div",{className:"gemini-loader__subtitle",textContent:e.subtitle??"Initializing the mod..."}),r=w("div",{className:"gemini-loader__logs"}),o=w("img",{className:"gemini-loader__spinner-icon",alt:"Gemini"}),i=w("div",{className:"gemini-loader__spinner"},o);Wv().then(P=>{o.src=P;});const a=w("div",{className:"gemini-loader__card"},w("div",{className:"gemini-loader__header"},i,w("div",{className:"gemini-loader__titles"},w("div",{className:"gemini-loader__title",textContent:e.title??"Gemini is loading"}),n)),r),l=w("div",{id:Cr},a);(document.body||document.documentElement).appendChild(l);const u=w("div",{className:"gemini-loader__actions"},w("button",{className:"gemini-loader__button",textContent:"Close loader",onclick:()=>l.remove()}));a.appendChild(u),l.style.setProperty("--loader-blur",`${t}px`);const f=P=>{n.textContent=P;},p=new Map,m=(P,I)=>{P.className=`gemini-loader__log ${I}`;};return {log:(P,I="info")=>fa(r,P,I),logStep:(P,I,T="info")=>{const N=String(P||"").trim();if(!N){fa(r,I,T);return}const z=p.get(N);if(z){z.el.lastElementChild&&(z.el.lastElementChild.textContent=I),z.tone!==T&&(m(z.el,T),z.tone=T);return}const O=w("div",{className:`gemini-loader__log ${T}`},w("div",{className:"gemini-loader__dot"}),w("div",{textContent:I}));for(p.set(N,{el:O,tone:T}),r.appendChild(O);r.childElementCount>Jf;){const M=r.firstElementChild;if(!M)break;const F=Array.from(p.entries()).find(([,L])=>L.el===M)?.[0];F&&p.delete(F),M.remove();}r.scrollTop=r.scrollHeight;},setSubtitle:f,succeed:(P,I=600)=>{P&&fa(r,P,"success"),l.classList.add("gemini-loader--closing"),setTimeout(()=>l.remove(),I);},fail:(P,I)=>{fa(r,P,"error"),f("Something went wrong. Check the console for details."),l.classList.add("gemini-loader--error"),console.error("[Gemini loader]",P,I);}}}const mp=150,Vv=30;function Kv(e,t,n){const r=w("div",{className:"lg-pill",id:"pill"}),o=e.map(C=>{const E=w("button",{className:"lg-tab"},C.label);return E.setAttribute("data-target",C.id),E}),i=w("div",{className:"lg-tabs",id:"lg-tabs-row"},r,...o),a=new Map(e.map(C=>[C.id,true])),l=new Map(o.map((C,E)=>[e[E].id,C]));function u(C){const E=document.createElementNS("http://www.w3.org/2000/svg","svg");E.setAttribute("viewBox","0 0 24 24"),E.setAttribute("fill","none"),E.setAttribute("stroke","currentColor"),E.setAttribute("stroke-width","2"),E.setAttribute("stroke-linecap","round"),E.setAttribute("stroke-linejoin","round");const B=document.createElementNS("http://www.w3.org/2000/svg","polyline");return B.setAttribute("points",C==="left"?"15 18 9 12 15 6":"9 18 15 12 9 6"),E.appendChild(B),E}const f=w("button",{className:"lg-tabs-arrow lg-tabs-arrow-left",ariaLabel:"Scroll left"});f.appendChild(u("left"));const p=w("button",{className:"lg-tabs-arrow lg-tabs-arrow-right",ariaLabel:"Scroll right"});p.appendChild(u("right"));const v=w("div",{className:"lg-tabs-wrapper"},f,i,p);let y=0,b=0,A=false;function P(){const C=i.scrollLeft>0,E=i.scrollLeft<i.scrollWidth-i.clientWidth-1;f.classList.toggle("disabled",!C),p.classList.toggle("disabled",!E);}f.addEventListener("click",()=>{i.scrollBy({left:-mp,behavior:"smooth"}),setTimeout(P,300);}),p.addEventListener("click",()=>{i.scrollBy({left:mp,behavior:"smooth"}),setTimeout(P,300);}),i.addEventListener("wheel",C=>{Math.abs(C.deltaY)>Math.abs(C.deltaX)&&(C.preventDefault(),i.scrollLeft+=C.deltaY,P());},{passive:false});let I=0;i.addEventListener("touchstart",C=>{const E=C.touches[0];y=E.clientX,b=E.clientY,A=false,I=i.scrollLeft;},{passive:true}),i.addEventListener("touchmove",C=>{if(A)return;const E=C.touches[0],B=E.clientX-y,j=E.clientY-b;if(Math.abs(j)>Math.abs(B)){A=true;return}Math.abs(B)>Vv&&(C.preventDefault(),i.scrollLeft=I-B);},{passive:false}),i.addEventListener("touchend",()=>{P();},{passive:true}),i.addEventListener("scroll",P,{passive:true});function T(C){const E=o.find(B=>B.dataset.target===C)||o[0];E&&requestAnimationFrame(()=>{const B=E.offsetLeft,j=E.offsetWidth;r.style.width=`${j}px`,r.style.transform=`translateX(${B}px)`;const V=i.scrollLeft,U=V,ce=V+i.clientWidth,Y=B-12,ie=B+j+12;Y<U?i.scrollTo({left:Y,behavior:"smooth"}):ie>ce&&i.scrollTo({left:ie-i.clientWidth,behavior:"smooth"}),setTimeout(P,300);});}function N(){for(const[C,E]of a)if(E)return C;return null}function z(C){const E=l.get(C);if(E)if(a.set(C,false),E.style.display="none",F===C){const B=N();B&&L(B);}else M();}function O(C){const E=l.get(C);E&&(a.set(C,true),E.style.display="",M());}function M(){T(F),P();}let F=t||(e[0]?.id??"");function L(C){a.get(C)&&(F=C,o.forEach(E=>E.classList.toggle("active",E.dataset.target===C)),T(C),n(C));}return o.forEach(C=>C.addEventListener("click",()=>L(C.dataset.target))),queueMicrotask(()=>{T(F),P();}),{root:v,activate:L,recalc:M,getActive:()=>F,showTab:O,hideTab:z,isTabVisible:C=>a.get(C)??false,getVisibleTabs:()=>[...a.entries()].filter(([C,E])=>E).map(([C])=>C)}}class Br{constructor(t){xe(this,"id");xe(this,"label");xe(this,"container",null);xe(this,"cleanupFunctions",[]);xe(this,"preloadedContent",null);xe(this,"preloadPromise",null);this.id=t.id,this.label=t.label;}destroy(){}async preload(){if(this.preloadedContent||this.preloadPromise)return;const t=w("div");this.preloadPromise=(async()=>{const n=this.build(t);n instanceof Promise&&await n,this.preloadedContent=t,this.preloadPromise=null;})(),await this.preloadPromise;}isPreloaded(){return this.preloadedContent!==null}render(t){for(this.unmount();t.firstChild;)t.removeChild(t.firstChild);if(this.container=t,this.preloadedContent){for(;this.preloadedContent.firstChild;)t.appendChild(this.preloadedContent.firstChild);this.preloadedContent=null;}else {const r=this.build(t);r instanceof Promise&&r.catch(o=>{console.error(`[Gemini] Error building section ${this.id}:`,o);});}const n=t.firstElementChild;n&&n.classList.contains("gemini-section")&&n.classList.add("active");}unmount(){const t=this.destroy();t instanceof Promise&&t.catch(n=>{console.error(`[Gemini] Destroy error in section ${this.id}:`,n);}),this.executeCleanup(),this.container=null;}createContainer(t,n){const r=n?`gemini-section ${n}`:"gemini-section";return w("section",{id:t,className:r})}addCleanup(t){this.cleanupFunctions.push(t);}createGrid(t="12px"){const n=w("div");return n.style.display="grid",n.style.gap=t,n}executeCleanup(){for(const t of this.cleanupFunctions)try{t();}catch(n){console.error(`[Gemini] Cleanup error in section ${this.id}:`,n);}this.cleanupFunctions=[];}}class Yv{constructor(t,n,r){xe(this,"sections");xe(this,"activeId",null);xe(this,"container");xe(this,"theme");this.sections=new Map(t.map(o=>[o.id,o])),this.container=n,this.theme=r;}get ids(){return Array.from(this.sections.keys())}get all(){return Array.from(this.sections.values())}get active(){return this.activeId}activate(t){if(this.activeId!==t){if(!this.sections.has(t))throw new Error(`[Gemini] Unknown section: ${t}`);if(this.activeId&&this.sections.get(this.activeId).unmount(),this.activeId=t,this.sections.get(t).render(this.container),this.theme){const n=this.theme.getCurrentTheme();this.theme.applyTheme(n);}}}}const Jr="gemini:",qv={STATE:"hud:state",THEME:"hud:theme"},Xv={ALL:"sections",SETTINGS:"sections:settings",TEST:"sections:test",AVATAR_LOADOUTS:"sections:avatar:loadouts"},Qv={AUDIO_CUSTOM_SOUNDS:"module:audio:customSounds",AUDIO_NOTIFICATION_SETTINGS:"module:audio:notificationSettings"},Jv={MY_PETS_ABILITY_LOGS:"global:myPets:abilityLogs"},At={ACHIEVEMENTS:"feature:achievements:data",TRACKER_STATS:"feature:tracker:stats",ANTI_AFK:"feature:antiAfk:config",CONFIG:"feature:config",PET_TEAM:"feature:petTeam:config",XP_TRACKER:"feature:xpTracker:config",CROP_VALUE_INDICATOR:"feature:cropValueIndicator:config",CROP_SIZE_INDICATOR:"feature:cropSizeIndicator:config",SHOP_NOTIFIER:"feature:shopNotifier:config",WEATHER_NOTIFIER:"feature:weatherNotifier:config",PET_HUNGER_NOTIFIER:"feature:petHungerNotifier:config",ARIES_API:"feature:ariesAPI:config",HARVEST_LOCKER:"feature:harvestLocker:config",EGG_LOCKER:"feature:eggLocker:config",DECOR_LOCKER:"feature:decorLocker:config"},Zv={},ey={AUTO_RELOAD:"dev:auto-reload"},$t={HUD:qv,SECTION:Xv,MODULE:Qv,GLOBAL:Jv,FEATURE:At,INJECT:Zv,DEV:ey},ft={STORAGE_CHANGE:"gemini:storage:change",CUSTOM_SOUND_CHANGE:"gemini:custom-sound-change",HARVEST_LOCKER_LOCKS_UPDATED:"gemini:harvestLocker-locks-updated",EGG_LOCKER_LOCKS_UPDATED:"gemini:eggLocker-locks-updated",DECOR_LOCKER_LOCKS_UPDATED:"gemini:decorLocker-locks-updated"};function at(e,t){try{const n=e.startsWith(Jr)?e:Jr+e,r=GM_getValue(n);return r==null?t:typeof r=="string"?JSON.parse(r):r}catch(n){return console.error(`[Gemini Storage] Failed to read key "${e}":`,n),t}}function st(e,t){try{const n=e.startsWith(Jr)?e:Jr+e,r=e.startsWith(Jr)?e.slice(Jr.length):e,o=JSON.stringify(t);GM_setValue(n,o),window.dispatchEvent(new CustomEvent("gemini:storage:change",{detail:{key:r,value:t}}));}catch(n){console.error(`[Gemini Storage] Failed to write key "${e}":`,n);}}function ty(){try{const e="gemini:",t=[];for(let o=0;o<localStorage.length;o++){const i=localStorage.key(o);i&&i.startsWith(e)&&t.push(i);}for(const o of t)try{const i=localStorage.getItem(o);if(i!==null){const a=JSON.parse(i),l=o.slice(e.length);st(l,a),console.log(`[Gemini Storage] Migrated key: ${o}`);}}catch(i){console.warn(`[Gemini Storage] Failed to migrate key "${o}":`,i);}const n="gemini.sections",r=GM_getValue(n);r!=null&&(st("sections",r),GM_setValue(n,void 0),console.log("[Gemini Storage] Migrated: gemini.sections → gemini:sections")),t.length>0&&console.log(`[Gemini Storage] Migration complete. ${t.length} keys migrated from localStorage to GM_* storage.`);}catch(e){console.error("[Gemini Storage] Migration failed:",e);}}const Zf="gemini.sections";function eh(){const e=at(Zf,{});return e&&typeof e=="object"&&!Array.isArray(e)?e:{}}function ny(e){st(Zf,e);}async function ry(e){return eh()[e]}function oy(e,t){const n=eh();ny({...n,[e]:t});}function go(e,t){return {...e,...t??{}}}async function iy(e){const t=await ry(e.path);let n;e.migrate?n=e.migrate(t):n=t??{},n=Object.assign((f=>JSON.parse(JSON.stringify(f)))(e.defaults),n),e.sanitize&&(n=e.sanitize(n));function o(){oy(e.path,n);}function i(){return n}function a(f){n=e.sanitize?e.sanitize(f):f,o();}function l(f){const m=Object.assign((v=>JSON.parse(JSON.stringify(v)))(n),{});typeof f=="function"?f(m):Object.assign(m,f),n=e.sanitize?e.sanitize(m):m,o();}function u(){o();}return {get:i,set:a,update:l,save:u}}async function _o(e,t){const{path:n=e,...r}=t;return iy({path:n,...r})}let ay=0;const ha=new Map;function pt(e={},...t){const{id:n,className:r,variant:o="default",padding:i="md",interactive:a=false,expandable:l=false,defaultExpanded:u=true,onExpandChange:f,mediaTop:p,title:m,subtitle:v,badge:y,actions:b,footer:A,divider:P=false,tone:I="neutral",stateKey:T}=e,N=w("div",{className:"card",id:n,tabIndex:a?0:void 0});N.classList.add(`card--${o}`,`card--p-${i}`),a&&N.classList.add("card--interactive"),I!=="neutral"&&N.classList.add(`card--tone-${I}`),r&&N.classList.add(...r.split(" ").filter(Boolean)),l&&N.classList.add("card--expandable");const z=l?T??n??(typeof m=="string"?`title:${m}`:null):null;let O=!l||u;z&&ha.has(z)&&(O=!!ha.get(z));let M=null,F=null,L=null,C=null,E=null;const B=n?`${n}-collapse`:`card-collapse-${++ay}`,j=()=>{if(C!==null&&(cancelAnimationFrame(C),C=null),E){const se=E;E=null,se();}},V=(se,ae)=>{if(!L)return;j();const ne=L;if(ne.setAttribute("aria-hidden",String(!se)),!ae){ne.classList.remove("card-collapse--animating"),ne.style.display=se?"":"none",ne.style.height="",ne.style.opacity="";return}if(ne.classList.add("card-collapse--animating"),ne.style.display="",se){ne.style.height="auto";const $=ne.scrollHeight;if(!$){ne.classList.remove("card-collapse--animating"),ne.style.display="",ne.style.height="",ne.style.opacity="";return}ne.style.height="0px",ne.style.opacity="0",ne.offsetHeight,C=requestAnimationFrame(()=>{C=null,ne.style.height=`${$}px`,ne.style.opacity="1";});}else {const $=ne.scrollHeight;if(!$){ne.classList.remove("card-collapse--animating"),ne.style.display="none",ne.style.height="",ne.style.opacity="";return}ne.style.height=`${$}px`,ne.style.opacity="1",ne.offsetHeight,C=requestAnimationFrame(()=>{C=null,ne.style.height="0px",ne.style.opacity="0";});}const q=()=>{ne.classList.remove("card-collapse--animating"),ne.style.height="",se||(ne.style.display="none"),ne.style.opacity="";};let Z=null;const R=$=>{$.target===ne&&(Z!==null&&(clearTimeout(Z),Z=null),ne.removeEventListener("transitionend",R),ne.removeEventListener("transitioncancel",R),E=null,q());};E=()=>{Z!==null&&(clearTimeout(Z),Z=null),ne.removeEventListener("transitionend",R),ne.removeEventListener("transitioncancel",R),E=null,q();},ne.addEventListener("transitionend",R),ne.addEventListener("transitioncancel",R),Z=window.setTimeout(()=>{E?.();},420);};function U(se){const ae=document.createElementNS("http://www.w3.org/2000/svg","svg");return ae.setAttribute("viewBox","0 0 24 24"),ae.setAttribute("width","16"),ae.setAttribute("height","16"),ae.innerHTML=se==="up"?'<path d="M7 14l5-5 5 5" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"/>':'<path d="M7 10l5 5 5-5" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"/>',ae}function ce(se,ae=true,ne=true){O=se,N.classList.toggle("card--collapsed",!O),N.classList.toggle("card--expanded",O),M&&(M.dataset.expanded=String(O),M.setAttribute("aria-expanded",String(O))),F&&(F.setAttribute("aria-expanded",String(O)),F.classList.toggle("card-toggle--collapsed",!O),F.setAttribute("aria-label",O?"Replier le contenu":"Deplier le contenu"),F.replaceChildren(U(O?"up":"down"))),l?V(O,ne):L&&(L.style.display="",L.style.height="",L.style.opacity="",L.setAttribute("aria-hidden","false")),ae&&f&&f(O),z&&ha.set(z,O);}if(p){const se=w("div",{className:"card-media"});se.append(p),N.appendChild(se);}const Y=!!(m||v||y||b&&b.length||l);if(Y){M=w("div",{className:"card-header"});const se=w("div",{className:"card-headline",style:"min-width:0;display:flex;flex-direction:column;gap:2px;"});if(m){const q=w("h3",{className:"card-title",style:"margin:0;font-size:15px;font-weight:700;line-height:1.25;white-space:nowrap;overflow:hidden;text-overflow:ellipsis;display:flex;align-items:center;gap:8px;color:var(--fg);"},m);y&&q.append(typeof y=="string"?w("span",{className:"badge"},y):y),se.appendChild(q);}if(v){const q=w("div",{className:"card-subtitle",style:"opacity:.85;font-size:12px;color:color-mix(in oklab, var(--fg) 80%, #9ca3af)"},v);se.appendChild(q);}(se.childNodes.length||l)&&M.appendChild(se);const ae=w("div",{className:"card-header-right",style:"display:flex;gap:8px;flex:0 0 auto;align-items:center;"}),ne=w("div",{className:"card-actions",style:"display:flex;gap:8px;flex:0 0 auto;align-items:center;"});b?.forEach(q=>ne.appendChild(q)),ne.childNodes.length&&ae.appendChild(ne),l&&(F=w("button",{className:"card-toggle",type:"button",ariaExpanded:String(O),ariaControls:B,ariaLabel:O?"Replier le contenu":"Deplier le contenu"}),F.textContent=O?"▲":"▼",F.addEventListener("click",q=>{q.preventDefault(),q.stopPropagation(),ce(!O);}),ae.appendChild(F),M.classList.add("card-header--expandable"),M.addEventListener("click",q=>{const Z=q.target;Z?.closest(".card-actions")||Z?.closest(".card-toggle")||ce(!O);})),ae.childNodes.length&&M.appendChild(ae),N.appendChild(M);}L=w("div",{className:"card-collapse",id:B,ariaHidden:l?String(!O):"false"}),N.appendChild(L),P&&Y&&L.appendChild(w("div",{className:"card-divider"}));const ie=w("div",{className:"card-body"});if(ie.append(...t),L.appendChild(ie),A){P&&L.appendChild(w("div",{className:"card-divider"}));const se=w("div",{className:"card-footer"});se.append(A),L.appendChild(se);}return F&&F.setAttribute("aria-controls",B),ce(O,false,false),z&&ha.set(z,O),N}let ds=false;const us=new Set,ln=e=>{const t=document.activeElement;for(const n of us)if(t&&(t===n||n.contains(t))){e.stopImmediatePropagation(),e.stopPropagation();return}};function sy(){ds||(ds=true,window.addEventListener("keydown",ln,true),window.addEventListener("keypress",ln,true),window.addEventListener("keyup",ln,true),document.addEventListener("keydown",ln,true),document.addEventListener("keypress",ln,true),document.addEventListener("keyup",ln,true));}function ly(){ds&&(us.size>0||(ds=false,window.removeEventListener("keydown",ln,true),window.removeEventListener("keypress",ln,true),window.removeEventListener("keyup",ln,true),document.removeEventListener("keydown",ln,true),document.removeEventListener("keypress",ln,true),document.removeEventListener("keyup",ln,true)));}let kr=null;const wc=e=>{e.preventDefault(),e.stopPropagation(),e.stopImmediatePropagation(),kr!==null&&(window.clearTimeout(kr),kr=null),document.removeEventListener("click",wc,true);};function cy(){document.addEventListener("click",wc,true),kr!==null&&window.clearTimeout(kr),kr=window.setTimeout(()=>{document.removeEventListener("click",wc,true),kr=null;},500);}function Fr(e){const{id:t,value:n=null,options:r,placeholder:o="Select...",size:i="md",disabled:a=false,blockGameKeys:l=true,onChange:u,onOpenChange:f}=e,p=w("div",{className:"select",id:t}),m=w("button",{className:"select-trigger",type:"button"}),v=w("span",{className:"select-value"},o),y=w("span",{className:"select-caret"},"▾");m.append(v,y);const b=w("div",{className:"select-menu",role:"listbox",tabindex:"-1","aria-hidden":"true"});p.classList.add(`select--${i}`);let A=false,P=n,I=null,T=!!a;function N(q){return q==null?o:(e.options||r).find(R=>R.value===q)?.label??o}function z(q){v.textContent=N(q),b.querySelectorAll(".select-option").forEach(Z=>{const R=Z.dataset.value,$=q!=null&&R===q;Z.classList.toggle("selected",$),Z.setAttribute("aria-selected",String($));});}function O(q){b.replaceChildren(),q.forEach(Z=>{const R=w("button",{className:"select-option"+(Z.disabled?" disabled":""),type:"button",role:"option","data-value":Z.value,"aria-selected":String(Z.value===P),tabindex:"-1"},Z.label);Z.value===P&&R.classList.add("selected"),Z.disabled||R.addEventListener("pointerdown",$=>{$.preventDefault(),$.stopPropagation(),$.pointerType&&$.pointerType!=="mouse"&&cy(),B(Z.value,{notify:true}),C();},{capture:true}),b.appendChild(R);});}function M(){m.setAttribute("aria-expanded",String(A)),b.setAttribute("aria-hidden",String(!A));}function F(){const q=m.getBoundingClientRect();Object.assign(b.style,{minWidth:`${q.width}px`});}function L(){A||T||(A=true,p.classList.add("open"),M(),F(),document.addEventListener("mousedown",Y,true),document.addEventListener("scroll",ie,true),window.addEventListener("resize",se),b.focus({preventScroll:true}),l&&(sy(),us.add(p),I=()=>{us.delete(p),ly();}),f?.(true));}function C(){A&&(A=false,p.classList.remove("open"),M(),document.removeEventListener("mousedown",Y,true),document.removeEventListener("scroll",ie,true),window.removeEventListener("resize",se),m.focus({preventScroll:true}),I?.(),I=null,f?.(false));}function E(){A?C():L();}function B(q,Z={}){const R=P;P=q,z(P),Z.notify!==false&&R!==q&&u?.(q);}function j(){return P}function V(q){const Z=Array.from(b.querySelectorAll(".select-option:not(.disabled)"));if(!Z.length)return;const R=Z.findIndex(Q=>Q.classList.contains("active")),$=Z[(R+(q===1?1:Z.length-1))%Z.length];Z.forEach(Q=>Q.classList.remove("active")),$.classList.add("active"),$.focus({preventScroll:true}),$.scrollIntoView({block:"nearest"});}function U(q){(q.key===" "||q.key==="Enter"||q.key==="ArrowDown")&&(q.preventDefault(),L());}function ce(q){if(q.key==="Escape"){q.preventDefault(),C();return}if(q.key==="Enter"||q.key===" "){const Z=b.querySelector(".select-option.active")||b.querySelector(".select-option.selected");Z&&!Z.classList.contains("disabled")&&(q.preventDefault(),B(Z.dataset.value,{notify:true}),C());return}if(q.key==="ArrowDown"){q.preventDefault(),V(1);return}if(q.key==="ArrowUp"){q.preventDefault(),V(-1);return}}function Y(q){p.contains(q.target)||C();}function ie(){A&&F();}function se(){A&&F();}function ae(q){T=!!q,m.disabled=T,p.classList.toggle("disabled",T),T&&C();}function ne(q){e.options=q,O(q),q.some(Z=>Z.value===P)||(P=null,z(null));}return p.append(m,b),m.addEventListener("pointerdown",q=>{q.preventDefault(),q.stopPropagation(),E();},{capture:true}),m.addEventListener("keydown",U),b.addEventListener("keydown",ce),O(r),n!=null?(P=n,z(P)):z(null),M(),ae(T),{root:p,open:L,close:C,toggle:E,getValue:j,setValue:B,setOptions:ne,setDisabled:ae,destroy(){document.removeEventListener("mousedown",Y,true),document.removeEventListener("scroll",ie,true),window.removeEventListener("resize",se),I?.(),I=null;}}}function th(e={}){const{id:t,text:n="",htmlFor:r,tone:o="default",size:i="md",layout:a="inline",variant:l="text",required:u=false,disabled:f=false,tooltip:p,hint:m,icon:v,suffix:y,onClick:b}=e,A=w("div",{className:"lg-label-wrap",id:t}),P=w("label",{className:"lg-label",...r?{htmlFor:r}:{},...p?{title:p}:{}});if(v){const B=typeof v=="string"?w("span",{className:"lg-label-ico"},v):v;B.classList?.add?.("lg-label-ico"),P.appendChild(B);}const I=w("span",{className:"lg-label-text"},n);P.appendChild(I);const T=w("span",{className:"lg-label-req",ariaHidden:"true"}," *");u&&P.appendChild(T);let N=null;if(y!=null){N=typeof y=="string"?document.createTextNode(y):y;const B=w("span",{className:"lg-label-suffix"});B.appendChild(N),P.appendChild(B);}const z=m?w("div",{className:"lg-label-hint"},m):null;A.classList.add(`lg-label--${a}`),A.classList.add(`lg-label--${i}`),l==="title"&&A.classList.add("lg-label--title"),O(o),f&&A.classList.add("is-disabled"),A.appendChild(P),z&&A.appendChild(z),b&&P.addEventListener("click",b);function O(B){A.classList.remove("lg-label--default","lg-label--muted","lg-label--info","lg-label--success","lg-label--warning","lg-label--danger"),A.classList.add(`lg-label--${B}`);}function M(B){I.textContent=B;}function F(B){O(B);}function L(B){B&&!T.isConnected&&P.appendChild(T),!B&&T.isConnected&&T.remove(),B?P.setAttribute("aria-required","true"):P.removeAttribute("aria-required");}function C(B){A.classList.toggle("is-disabled",!!B);}function E(B){!B&&z&&z.isConnected?z.remove():B&&z?z.textContent=B:B&&!z&&A.appendChild(w("div",{className:"lg-label-hint"},B));}return {root:A,labelEl:P,hintEl:z,setText:M,setTone:F,setRequired:L,setDisabled:C,setHint:E}}function ti(e){return e==null?null:typeof e=="string"?document.createTextNode(e):e}function ma(e,t){const n=document.createElement("span");n.className=`btn-ico btn-ico--${t}`;const r=ti(e);return r&&n.appendChild(r),n}function dy(){const e="http://www.w3.org/2000/svg",t=document.createElementNS(e,"svg");t.setAttribute("viewBox","0 0 24 24"),t.setAttribute("width","16"),t.setAttribute("height","16"),t.setAttribute("aria-hidden","true"),t.style.marginRight="6px",t.style.display="none",t.style.flexShrink="0";const n=document.createElementNS(e,"circle");n.setAttribute("cx","12"),n.setAttribute("cy","12"),n.setAttribute("r","9"),n.setAttribute("fill","none"),n.setAttribute("stroke","currentColor"),n.setAttribute("stroke-width","3"),n.setAttribute("stroke-linecap","round");const r=document.createElementNS(e,"animate");r.setAttribute("attributeName","stroke-dasharray"),r.setAttribute("values","1,150;90,150;90,150"),r.setAttribute("dur","1.5s"),r.setAttribute("repeatCount","indefinite");const o=document.createElementNS(e,"animateTransform");return o.setAttribute("attributeName","transform"),o.setAttribute("attributeType","XML"),o.setAttribute("type","rotate"),o.setAttribute("from","0 12 12"),o.setAttribute("to","360 12 12"),o.setAttribute("dur","1s"),o.setAttribute("repeatCount","indefinite"),n.appendChild(r),n.appendChild(o),t.appendChild(n),t}function kt(e={}){const{label:t="",id:n,variant:r="default",size:o="md",iconLeft:i,iconRight:a,loading:l=false,tooltip:u,type:f="button",onClick:p,disabled:m=false,fullWidth:v=false}=e,y=w("button",{className:"btn",id:n});y.type=f,r==="primary"&&y.classList.add("primary"),r==="danger"&&y.classList.add("danger"),o==="sm"&&y.classList.add("btn--sm"),u&&(y.title=u),v&&(y.style.width="100%");const b=dy(),A=i?ma(i,"left"):null,P=a?ma(a,"right"):null,I=document.createElement("span");I.className="btn-label";const T=ti(t);T&&I.appendChild(T),!T&&(A||P)&&y.classList.add("btn--icon"),y.appendChild(b),A&&y.appendChild(A),y.appendChild(I),P&&y.appendChild(P);const N=m||l;y.disabled=N,y.setAttribute("aria-busy",String(!!l)),b.style.display=l?"inline-block":"none",p&&y.addEventListener("click",p);const z=y;return z.setLoading=O=>{y.setAttribute("aria-busy",String(!!O)),b.style.display=O?"inline-block":"none",y.disabled=O||m;},z.setDisabled=O=>{y.disabled=O||y.getAttribute("aria-busy")==="true";},z.setLabel=O=>{I.replaceChildren();const M=ti(O);M&&I.appendChild(M),!M&&(A||P)?y.classList.add("btn--icon"):y.classList.remove("btn--icon");},z.setIconLeft=O=>{if(O==null){A?.remove();return}A?A.replaceChildren(ti(O)):y.insertBefore(ma(O,"left"),I);},z.setIconRight=O=>{if(O==null){P?.remove();return}P?P.replaceChildren(ti(O)):y.appendChild(ma(O,"right"));},z.setVariant=O=>{y.classList.remove("primary","danger"),O==="primary"&&y.classList.add("primary"),O==="danger"&&y.classList.add("danger");},z}function Or(e={}){const{id:t,checked:n=false,disabled:r=false,size:o="md",label:i,labelSide:a="right",onChange:l}=e,u=w("div",{className:"lg-switch-wrap"}),f=w("button",{className:`lg-switch lg-switch--${o}`,id:t,type:"button",role:"switch","aria-checked":String(!!n),"aria-disabled":String(!!r),title:i??"Basculer"}),p=w("span",{className:"lg-switch-track"}),m=w("span",{className:"lg-switch-thumb"});f.append(p,m);let v=null;i&&a!=="none"&&(v=w("span",{className:"lg-switch-label"},i)),v&&a==="left"?u.append(v,f):v&&a==="right"?u.append(f,v):u.append(f);let y=!!n,b=!!r;function A(){f.classList.toggle("on",y),f.setAttribute("aria-checked",String(y)),f.disabled=b,f.setAttribute("aria-disabled",String(b));}function P(C=false){b||(y=!y,A(),C||l?.(y));}function I(C){C.preventDefault(),P();}function T(C){b||((C.key===" "||C.key==="Enter")&&(C.preventDefault(),P()),C.key==="ArrowLeft"&&(C.preventDefault(),z(false)),C.key==="ArrowRight"&&(C.preventDefault(),z(true)));}f.addEventListener("click",I),f.addEventListener("keydown",T);function N(){return y}function z(C,E=false){y=!!C,A(),E||l?.(y);}function O(C){b=!!C,A();}function M(C){if(!C){v&&(v.remove(),v=null);return}v?v.textContent=C:(v=w("span",{className:"lg-switch-label"},C),u.append(v));}function F(){f.focus();}function L(){f.removeEventListener("click",I),f.removeEventListener("keydown",T);}return A(),{root:u,button:f,isChecked:N,setChecked:z,setDisabled:O,setLabel:M,focus:F,destroy:L}}let nh=null,gd=null;function uy(){return nh}function py(e){nh=e,gd=null;}function rh(){return gd}function fy(e){gd=e;}function hy(){try{const e=window.visualViewport,t=Math.round((e?.width??window.innerWidth)||0),n=Math.round((e?.height??window.innerHeight)||0);if(t&&n)return t>=n?"landscape":"portrait"}catch{}return "unknown"}function oh(){const e=navigator.userAgent||"",t=navigator.platform||"",n=navigator.userAgentData;if(n&&typeof n.platform=="string"){const o=n.platform.toLowerCase();if(o.includes("windows"))return "windows";if(o.includes("mac"))return "mac";if(o.includes("android"))return "android";if(o.includes("chrome os")||o.includes("cros"))return "chromeos";if(o.includes("linux"))return "linux";if(o.includes("ios"))return "ios"}return /iPhone|iPad|iPod/i.test(e)||t==="MacIntel"&&(navigator.maxTouchPoints??0)>1?"ios":/Android/i.test(e)?"android":/CrOS/i.test(e)?"chromeos":/Win/i.test(e)?"windows":/Mac/i.test(e)?"mac":/Linux/i.test(e)?"linux":"unknown"}function ih(){const e=navigator.userAgent||"",t=navigator.userAgentData;if(t&&Array.isArray(t.brands)){const n=t.brands.map(a=>String(a.brand||a.brandName||a.brandVersion||a)),r=n.some(a=>/Edge/i.test(a)||/Microsoft Edge/i.test(a)),o=n.some(a=>/Opera/i.test(a)||/OPR/i.test(a)),i=n.some(a=>/Chrome|Chromium/i.test(a));if(r)return "Edge";if(o)return "Opera";if(i)return "Chrome";if(navigator.brave)return "Brave"}return /FxiOS/i.test(e)?"Firefox":/CriOS/i.test(e)?"Chrome":/EdgiOS/i.test(e)?"Edge":/OPiOS|OPR|Opera Mini|Opera/i.test(e)?"Opera":/Edg\//i.test(e)?"Edge":/OPR\//i.test(e)||/Opera/i.test(e)?"Opera":/Firefox/i.test(e)?"Firefox":/Safari/i.test(e)&&!/Chrome|Chromium|Edg|OPR/i.test(e)?"Safari":/Brave/i.test(e)||window.Brave||navigator.brave?"Brave":/Chrome|Chromium/i.test(e)?"Chrome":"Unknown"}function my(){const e=uy();if(e)return e;const t=navigator.userAgent||"",n=navigator.userAgentData;return n&&typeof n.mobile=="boolean"?n.mobile?"mobile":"desktop":/Android|iPhone|iPad|iPod|Mobile/i.test(t)?"mobile":"desktop"}function gy(e){if(!e)return null;try{return new URL(e).hostname}catch{return null}}function ah(){try{return window.top!==window.self}catch{return  true}}function by(){const e=ah(),t=gy(document.referrer);return e&&!!t&&/(^|\.)discord(app)?\.com$/i.test(t)?"discord":"web"}function zs(){const e=rh();if(e)return e;const t=by(),n=my(),r=oh(),o=ih(),i=ah(),a=window.screen||{},l=window.visualViewport,u=Math.round(window.innerWidth||document.documentElement.clientWidth||0),f=Math.round(window.innerHeight||document.documentElement.clientHeight||0),p=Math.round(l?.width??u),m=Math.round(l?.height??f),v=Math.round(a.width||0),y=Math.round(a.height||0),b=Math.round(a.availWidth||v),A=Math.round(a.availHeight||y),P=Number.isFinite(window.devicePixelRatio)?window.devicePixelRatio:1,I={surface:t,host:location.hostname,origin:location.origin,isInIframe:i,platform:n,browser:o,os:r,viewportWidth:u,viewportHeight:f,visualViewportWidth:p,visualViewportHeight:m,screenWidth:v,screenHeight:y,availScreenWidth:b,availScreenHeight:A,dpr:P,orientation:hy()};return fy(I),I}function vy(){return zs().surface==="discord"}function yy(){return zs().platform==="mobile"}function xy(){zs();}function wy(){return rh()!==null}const Rt={init:xy,isReady:wy,detect:zs,isDiscord:vy,isMobile:yy,detectOS:oh,detectBrowser:ih,setPlatformOverride:py};let ps=false;const ni=new Set;function Cy(e=document){let t=e.activeElement||null;for(;t&&t.shadowRoot&&t.shadowRoot.activeElement;)t=t.shadowRoot.activeElement;return t}const cn=e=>{const t=Cy();if(t){for(const n of ni)if(t===n||n.contains(t)){e.stopImmediatePropagation(),e.stopPropagation();return}}};function ky(){ps||(ps=true,window.addEventListener("keydown",cn,true),window.addEventListener("keypress",cn,true),window.addEventListener("keyup",cn,true),document.addEventListener("keydown",cn,true),document.addEventListener("keypress",cn,true),document.addEventListener("keyup",cn,true));}function Sy(){ps&&(ps=false,window.removeEventListener("keydown",cn,true),window.removeEventListener("keypress",cn,true),window.removeEventListener("keyup",cn,true),document.removeEventListener("keydown",cn,true),document.removeEventListener("keypress",cn,true),document.removeEventListener("keyup",cn,true));}function Ay(e){return ni.size===0&&ky(),ni.add(e),()=>{ni.delete(e),ni.size===0&&Sy();}}function Ey(e,t,n,r){let o;switch(e){case "digits":o="0-9";break;case "alpha":o="\\p{L}";break;case "alphanumeric":o="\\p{L}0-9";break;default:return null}return t&&(o+=" "),n&&(o+="\\-"),r&&(o+="_"),new RegExp(`[^${o}]`,"gu")}function _y(e,t){return t?e.replace(t,""):e}function Iy(e,t=0){if(!t)return e;let n;return((...r)=>{clearTimeout(n),n=setTimeout(()=>e(...r),t);})}function js(e={}){const{id:t,placeholder:n="",value:r="",mode:o="any",allowSpaces:i=false,allowDashes:a=false,allowUnderscore:l=false,maxLength:u,blockGameKeys:f=true,debounceMs:p=0,onChange:m,onEnter:v,label:y}=e,b=w("div",{className:"lg-input-wrap"}),A=w("input",{className:"input",id:t,placeholder:n});if(typeof u=="number"&&u>0&&(A.maxLength=u),r&&(A.value=r),y){const B=w("div",{className:"lg-input-label"},y);b.appendChild(B);}b.appendChild(A);const P=Ey(o,i,a,l),I=()=>{const B=A.selectionStart??A.value.length,j=A.value.length,V=_y(A.value,P);if(V!==A.value){A.value=V;const U=j-V.length,ce=Math.max(0,B-U);A.setSelectionRange(ce,ce);}},T=Iy(()=>m?.(A.value),p);A.addEventListener("input",()=>{I(),T();}),A.addEventListener("paste",()=>queueMicrotask(()=>{I(),T();})),A.addEventListener("keydown",B=>{B.key==="Enter"&&v?.(A.value);});const N=f?Ay(A):()=>{};function z(){return A.value}function O(B){A.value=B??"",I(),T();}function M(){A.focus();}function F(){A.blur();}function L(B){A.disabled=!!B;}function C(){return document.activeElement===A}function E(){N();}return {root:b,input:A,getValue:z,setValue:O,focus:M,blur:F,setDisabled:L,isFocused:C,destroy:E}}function Tt(e,t,n){return Math.min(n,Math.max(t,e))}function ui({h:e,s:t,v:n,a:r}){const o=(e%360+360)%360/60,i=n*t,a=i*(1-Math.abs(o%2-1));let l=0,u=0,f=0;switch(Math.floor(o)){case 0:l=i,u=a;break;case 1:l=a,u=i;break;case 2:u=i,f=a;break;case 3:u=a,f=i;break;case 4:l=a,f=i;break;default:l=i,f=a;break}const m=n-i,v=Math.round((l+m)*255),y=Math.round((u+m)*255),b=Math.round((f+m)*255);return {r:Tt(v,0,255),g:Tt(y,0,255),b:Tt(b,0,255),a:Tt(r,0,1)}}function sh({r:e,g:t,b:n,a:r}){const o=Tt(e,0,255)/255,i=Tt(t,0,255)/255,a=Tt(n,0,255)/255,l=Math.max(o,i,a),u=Math.min(o,i,a),f=l-u;let p=0;f!==0&&(l===o?p=60*((i-a)/f%6):l===i?p=60*((a-o)/f+2):p=60*((o-i)/f+4)),p<0&&(p+=360);const m=l===0?0:f/l;return {h:p,s:m,v:l,a:Tt(r,0,1)}}function bd({r:e,g:t,b:n}){const r=o=>Tt(Math.round(o),0,255).toString(16).padStart(2,"0");return `#${r(e)}${r(t)}${r(n)}`.toUpperCase()}function Ty({r:e,g:t,b:n,a:r}){const o=Tt(Math.round(r*255),0,255);return `${bd({r:e,g:t,b:n})}${o.toString(16).padStart(2,"0")}`.toUpperCase()}function ri({r:e,g:t,b:n,a:r}){const o=Math.round(r*1e3)/1e3;return `rgba(${e}, ${t}, ${n}, ${o})`}function Zr(e){let t=e.trim();if(!t||(t.startsWith("#")&&(t=t.slice(1)),![3,4,6,8].includes(t.length))||!/^[0-9a-fA-F]+$/.test(t))return null;(t.length===3||t.length===4)&&(t=t.split("").map(a=>a+a).join(""));let n=255;t.length===8&&(n=parseInt(t.slice(6,8),16),t=t.slice(0,6));const r=parseInt(t.slice(0,2),16),o=parseInt(t.slice(2,4),16),i=parseInt(t.slice(4,6),16);return {r,g:o,b:i,a:n/255}}function Cc(e){if(!e)return null;const t=e.trim();if(t.startsWith("#"))return Zr(t);const n=t.match(/^rgba?\(([^)]+)\)$/i);if(n){const r=n[1].split(",").map(u=>u.trim());if(r.length<3)return null;const o=Number(r[0]),i=Number(r[1]),a=Number(r[2]),l=r[3]!=null?Number(r[3]):1;return [o,i,a,l].some(u=>Number.isNaN(u))?null:{r:o,g:i,b:a,a:l}}return null}function Py(e,t){const n=Cc(e)??Zr(e??"")??{r:244,g:67,b:54,a:1};return typeof t=="number"&&(n.a=Tt(t,0,1)),sh(n)}function Ly(e){return `#${e.trim().replace(/[^0-9a-fA-F#]/g,"").replace(/#/g,"")}`.slice(0,9).toUpperCase()}function My(e){let t=e.trim();return t&&(/^rgba?\s*\(/i.test(t)?t=t.replace(/^rgba?/i,"rgba"):(t=t.replace(/^\(?(.*)\)?$/,"$1"),t=`rgba(${t})`),t=t.replace(/\s*\(\s*/,"("),t=t.replace(/\s*\)\s*$/,")"),t=t.replace(/\s*,\s*/g,", "),t)}function yr(e){const t=ui(e),n=ui({...e,a:1});return {hsva:{...e},hex:bd(n),hexa:Ty(t),rgba:ri(t),alpha:e.a}}function Ry(e={}){const{id:t,label:n="Color",value:r,alpha:o,defaultExpanded:i=false,detectMobile:a,onInput:l,onChange:u}=e,p=a?a():Rt.detect().platform==="mobile";let m=Py(r,o);const v=pt({id:t,className:"color-picker",title:n,padding:p?"md":"lg",variant:"soft",expandable:!p,defaultExpanded:!p&&i});v.classList.add(p?"color-picker--mobile":"color-picker--desktop");const y=v.querySelector(".card-header");y&&y.classList.add("color-picker__header");const b=y?.querySelector(".card-title"),A=w("button",{className:"color-picker__preview",type:"button",title:`Preview ${n}`,"aria-label":`Change ${n}`});b?b.prepend(A):y?y.prepend(A):v.prepend(A);const P=v.querySelector(".card-toggle");!p&&P&&A.addEventListener("click",()=>{v.classList.contains("card--collapsed")&&P.click();});const I=v.querySelector(".card-collapse");let T=null,N=null,z=null,O=null,M=null,F=null,L=null,C=null,E=null,B="hex";function j(ie){const se=yr(m);ie==="input"?l?.(se):u?.(se);}function V(){const ie=yr(m);if(A.style.setProperty("--cp-preview-color",ie.rgba),A.setAttribute("aria-label",`${n}: ${ie.hexa}`),!p&&T&&N&&z&&O&&M&&F&&L){const se=ui({...m,s:1,v:1,a:1}),ae=ri(se);T.style.setProperty("--cp-palette-hue",ae),N.style.left=`${m.s*100}%`,N.style.top=`${(1-m.v)*100}%`,z.style.setProperty("--cp-alpha-gradient",`linear-gradient(180deg, ${ri({...se,a:1})} 0%, ${ri({...se,a:0})} 100%)`),O.style.top=`${(1-m.a)*100}%`,M.style.setProperty("--cp-hue-color",ri(ui({...m,v:1,s:1,a:1}))),F.style.left=`${m.h/360*100}%`;const ne=m.a===1?ie.hex:ie.hexa,q=ie.rgba,Z=B==="hex"?ne:q;L!==document.activeElement&&(L.value=Z),L.setAttribute("aria-label",`${B.toUpperCase()} code for ${n}`),L.placeholder=B==="hex"?"#RRGGBB or #RRGGBBAA":"rgba(0, 0, 0, 1)",B==="hex"?L.maxLength=9:L.removeAttribute("maxLength"),L.dataset.mode=B,C&&(C.textContent=B.toUpperCase(),C.setAttribute("aria-label",B==="hex"?"Passer en saisie RGBA":"Revenir en saisie HEX"),C.setAttribute("aria-pressed",B==="rgba"?"true":"false"),C.classList.toggle("is-alt",B==="rgba"));}E&&E!==document.activeElement&&(E.value=ie.hex);}function U(ie,se=null){m={h:(ie.h%360+360)%360,s:Tt(ie.s,0,1),v:Tt(ie.v,0,1),a:Tt(ie.a,0,1)},V(),se&&j(se);}function ce(ie,se=null){U(sh(ie),se);}function Y(ie,se,ae){ie.addEventListener("pointerdown",ne=>{ne.preventDefault();const q=ne.pointerId,Z=$=>{$.pointerId===q&&se($);},R=$=>{$.pointerId===q&&(document.removeEventListener("pointermove",Z),document.removeEventListener("pointerup",R),document.removeEventListener("pointercancel",R),ae?.($));};se(ne),document.addEventListener("pointermove",Z),document.addEventListener("pointerup",R),document.addEventListener("pointercancel",R);});}if(!p&&I){const ie=I.querySelector(".card-body");if(ie){ie.classList.add("color-picker__body"),N=w("div",{className:"color-picker__palette-cursor"}),T=w("div",{className:"color-picker__palette"},N),O=w("div",{className:"color-picker__alpha-thumb"}),z=w("div",{className:"color-picker__alpha"},O),F=w("div",{className:"color-picker__hue-thumb"}),M=w("div",{className:"color-picker__hue"},F);const se=w("div",{className:"color-picker__main"},T,z),ae=w("div",{className:"color-picker__hue-row"},M),ne=js({blockGameKeys:true});L=ne.input,L.classList.add("color-picker__hex-input"),L.value="",L.maxLength=9,L.spellcheck=false,L.inputMode="text",L.setAttribute("aria-label",`Hex code for ${n}`),C=w("button",{type:"button",className:"color-picker__mode-btn",textContent:"HEX","aria-pressed":"false","aria-label":"Passer en saisie RGBA"}),ne.root.classList.add("color-picker__hex-wrap");const q=w("div",{className:"color-picker__hex-row"},C,ne.root);ie.replaceChildren(se,ae,q),Y(T,R=>{if(!T||!N)return;const $=T.getBoundingClientRect(),Q=Tt((R.clientX-$.left)/$.width,0,1),re=Tt((R.clientY-$.top)/$.height,0,1);U({...m,s:Q,v:1-re},"input");},()=>j("change")),Y(z,R=>{if(!z)return;const $=z.getBoundingClientRect(),Q=Tt((R.clientY-$.top)/$.height,0,1);U({...m,a:1-Q},"input");},()=>j("change")),Y(M,R=>{if(!M)return;const $=M.getBoundingClientRect(),Q=Tt((R.clientX-$.left)/$.width,0,1);U({...m,h:Q*360},"input");},()=>j("change")),C.addEventListener("click",()=>{if(B=B==="hex"?"rgba":"hex",L){const R=yr(m);L.value=B==="hex"?m.a===1?R.hex:R.hexa:R.rgba;}V(),L?.focus(),L?.select();}),L.addEventListener("input",()=>{if(B==="hex"){const R=Ly(L.value);if(R!==L.value){const $=L.selectionStart??R.length;L.value=R,L.setSelectionRange($,$);}}});const Z=()=>{const R=L.value;if(B==="hex"){const $=Zr(R);if(!$){L.value=m.a===1?yr(m).hex:yr(m).hexa;return}const Q=R.startsWith("#")?R.slice(1):R,re=Q.length===4||Q.length===8;$.a=re?$.a:m.a,ce($,"change");}else {const $=My(R),Q=Cc($);if(!Q){L.value=yr(m).rgba;return}ce(Q,"change");}};L.addEventListener("change",Z),L.addEventListener("blur",Z),L.addEventListener("keydown",R=>{R.key==="Enter"&&(Z(),L.blur());});}}return p&&(I&&I.remove(),E=w("input",{className:"color-picker__native",type:"color",value:bd(ui({...m,a:1}))}),A.addEventListener("click",()=>E.click()),E.addEventListener("input",()=>{const ie=Zr(E.value);ie&&(ie.a=m.a,ce(ie,"input"),j("change"));}),v.appendChild(E)),V(),{root:v,isMobile:p,getValue:()=>yr(m),setValue:(ie,se)=>{const ae=Cc(ie)??Zr(ie)??Zr("#FFFFFF");ae&&(typeof se=="number"&&(ae.a=se),ce(ae,null));}}}const Fy=window;function Oy(){if(typeof unsafeWindow<"u"&&unsafeWindow)return unsafeWindow;const e=window.wrappedJSObject;return e&&e!==window?e:Fy}const Ny=Oy(),fe=Ny;function Dy(e){try{return !!e.isSecureContext}catch{return  false}}function vd(e){const t=e?.getRootNode?.();return t&&(t instanceof Document||t.host)?t:document}function lh(){const e=navigator.platform||"",t=navigator.userAgent||"";return /Mac|iPhone|iPad|iPod/i.test(e)||/Mac OS|iOS/i.test(t)}async function $y(){try{const e=await navigator.permissions?.query?.({name:"clipboard-write"});return e?e.state==="granted"||e.state==="prompt":!0}catch{return  true}}function By(e,t){const n=document.createElement("textarea");return n.value=e,n.setAttribute("readonly","true"),n.style.position="fixed",n.style.opacity="0",n.style.pointerEvents="none",n.style.top="0",t.appendChild?t.appendChild(n):document.body.appendChild(n),n}function zy(e){try{const t=window.getSelection?.();if(!t)return !1;const n=document.createRange();return n.selectNodeContents(e),t.removeAllRanges(),t.addRange(n),!0}catch{return  false}}async function jy(e){if(!("clipboard"in navigator))return {ok:false,method:"clipboard-write"};if(!Dy(fe))return {ok:false,method:"clipboard-write"};if(!await $y())return {ok:false,method:"clipboard-write"};try{return await navigator.clipboard.writeText(e),{ok:!0,method:"clipboard-write"}}catch{return {ok:false,method:"clipboard-write"}}}function Gy(e,t){try{const n=t||vd(),r=By(e,n);r.focus(),r.select(),r.setSelectionRange(0,r.value.length);let o=!1;try{o=document.execCommand("copy");}catch{o=!1;}return r.remove(),{ok:o,method:"execCommand"}}catch{return {ok:false,method:"execCommand"}}}function Uy(e,t){if(!t)return {ok:false,method:"selection"};const n=t.textContent??"";let r=false;if(n!==e)try{t.textContent=e,r=!0;}catch{}const o=zy(t);r&&setTimeout(()=>{try{t.textContent=n;}catch{}},80);const i=lh()?"⌘C pour copier":"Ctrl+C pour copier";return {ok:o,method:"selection",hint:i}}async function Wy(e,t={}){const n=(e??"").toString();if(!n.length)return {ok:false,method:"noop"};const r=await jy(n);if(r.ok)return r;const o=t.injectionRoot||vd(t.valueNode||void 0),i=Gy(n,o);if(i.ok)return i;const a=Uy(n,t.valueNode||null);if(a.ok)return a;if(!t.disablePromptFallback)try{return window.prompt(Rt.isDiscord()?"Copie manuelle (Discord bloque clipboard):":"Copie manuelle:",n),{ok:!0,method:"prompt"}}catch{}return {ok:false,method:"noop"}}function Hy(e,t,n={}){const r=o=>{if(n.showTip){n.showTip(o);return}try{e.setAttribute("aria-label",o);const i=document.createElement("div");i.textContent=o,i.style.position="absolute",i.style.top="-28px",i.style.right="0",i.style.padding="4px 8px",i.style.borderRadius="8px",i.style.fontSize="12px",i.style.background="color-mix(in oklab, var(--bg) 85%, transparent)",i.style.border="1px solid var(--border)",i.style.color="var(--fg)",i.style.pointerEvents="none",i.style.opacity="0",i.style.transition="opacity .12s";const a=vd(e);a.appendChild?a.appendChild(i):document.body.appendChild(i);const l=e.getBoundingClientRect();i.style.left=`${l.right-8}px`,i.style.top=`${l.top-28}px`,requestAnimationFrame(()=>i.style.opacity="1"),setTimeout(()=>{i.style.opacity="0",setTimeout(()=>i.remove(),150);},1200);}catch{}};e.addEventListener("click",async o=>{o.stopPropagation();const i=(t()??"").toString(),a=await Wy(i,{valueNode:n.valueNode??null,injectionRoot:n.injectionRoot??null,disablePromptFallback:n.disablePromptFallback??false});n.onResult?.(a),a.ok?a.method==="clipboard-write"||a.method==="execCommand"||a.method==="prompt"?r("Copié"):a.method==="selection"&&r(a.hint||(lh()?"⌘C pour copier":"Ctrl+C pour copier")):r("Impossible de copier");});}const oo={light:{"--bg":"rgba(255,255,255,0.7)","--fg":"#0f172a","--muted":"rgba(15,23,42,0.06)","--soft":"rgba(15,23,42,0.04)","--accent":"#2563eb","--border":"rgba(15,23,42,0.12)","--shadow":"rgba(2,6,23,.2)","--paper":"#FDFBF7","--tab-bg":"#ffffff","--tab-fg":"#0f172a","--pill-from":"#4f46e5","--pill-to":"#06b6d4","--low":"#dc2626","--medium":"#f59e0b","--high":"#16a34a","--complete":"#15803d","--info":"#2563eb","--xp-fill":"#0febff","--accent-1":"#16a34a","--accent-2":"#7c3aed","--mut-rainbow":"#FF00FF","--mut-gold":"#EBC800","--mut-wet":"#5FFFFF","--mut-chilled":"#B4E6FF","--mut-frozen":"#B9C8FF","--mut-dawnlit":"#F59BE1","--mut-dawncharged":"#C896FF","--mut-ambershine":"#FFB478","--mut-ambercharged":"#FA8C4B","--rarity-common":"#E7E7E7","--rarity-uncommon":"#67BD4D","--rarity-rare":"#0071C6","--rarity-legendary":"#FFC734","--rarity-mythical":"#9944A7","--rarity-divine":"#FF7835","--rarity-celestial":"#FF00FF","--rainbow-text-gradient":"linear-gradient(90deg, #b000b0, #d00000, #b08000, #008000, #0000b0, #4b0082, #9400d3)","--switch-thumb":"#ffffff","--journal-ink":"#333333"},dark:{"--bg":"rgba(10,12,18,0.6)","--fg":"#e5e7eb","--muted":"rgba(229,231,235,0.08)","--soft":"rgba(229,231,235,0.05)","--accent":"#60a5fa","--border":"rgba(148,163,184,0.2)","--shadow":"rgba(0,0,0,.45)","--paper":"#1a1d24","--tab-bg":"rgba(255,255,255,0.08)","--tab-fg":"#e5e7eb","--pill-from":"#6366f1","--pill-to":"#06b6d4","--low":"#ef4444","--medium":"#f59e0b","--high":"#22c55e","--complete":"#16a34a","--info":"#3b82f6","--xp-fill":"#0febff","--accent-1":"#22c55e","--accent-2":"#a855f7","--mut-rainbow":"#FF00FF","--mut-gold":"#EBC800","--mut-wet":"#5FFFFF","--mut-chilled":"#B4E6FF","--mut-frozen":"#B9C8FF","--mut-dawnlit":"#F59BE1","--mut-dawncharged":"#C896FF","--mut-ambershine":"#FFB478","--mut-ambercharged":"#FA8C4B","--rarity-common":"#E7E7E7","--rarity-uncommon":"#67BD4D","--rarity-rare":"#0071C6","--rarity-legendary":"#FFC734","--rarity-mythical":"#9944A7","--rarity-divine":"#FF7835","--rarity-celestial":"#FF00FF","--rainbow-text-gradient":"linear-gradient(90deg, #ff0000, #ff7f00, #ffff00, #00ff00, #00ffff, #ff00ff)","--switch-thumb":"#ffffff","--journal-ink":"#ffffff"},sepia:{"--bg":"rgba(247,242,231,0.72)","--fg":"#3b2f2f","--muted":"rgba(59,47,47,0.06)","--soft":"rgba(59,47,47,0.04)","--accent":"#b07d62","--border":"rgba(59,47,47,0.14)","--shadow":"rgba(0,0,0,.18)","--paper":"#F5E6D3","--tab-bg":"#fff","--tab-fg":"#3b2f2f","--pill-from":"#b07d62","--pill-to":"#d4a373","--low":"#c2410c","--medium":"#d97706","--high":"#15803d","--complete":"#166534","--info":"#1d4ed8","--accent-1":"#15803d","--accent-2":"#6b21a8","--mut-rainbow":"#FF00FF","--mut-gold":"#EBC800","--mut-wet":"#5FFFFF","--mut-chilled":"#B4E6FF","--mut-frozen":"#B9C8FF","--mut-dawnlit":"#F59BE1","--mut-dawncharged":"#C896FF","--mut-ambershine":"#FFB478","--mut-ambercharged":"#FA8C4B","--rarity-common":"#E7E7E7","--rarity-uncommon":"#67BD4D","--rarity-rare":"#0071C6","--rarity-legendary":"#FFC734","--rarity-mythical":"#9944A7","--rarity-divine":"#FF7835","--rarity-celestial":"#FF00FF","--rainbow-text-gradient":"linear-gradient(90deg, #b000b0, #d00000, #b08000, #008000, #0000b0, #4b0082, #9400d3)","--switch-thumb":"#ffffff","--journal-ink":"#3b2f2f"},forest:{"--bg":"rgba(14,24,18,0.62)","--fg":"#e7f5e9","--muted":"rgba(231,245,233,0.08)","--soft":"rgba(231,245,233,0.05)","--accent":"#34d399","--border":"rgba(231,245,233,0.16)","--shadow":"rgba(0,0,0,.5)","--paper":"#1e2820","--tab-bg":"rgba(255,255,255,0.06)","--tab-fg":"#e7f5e9","--pill-from":"#10b981","--pill-to":"#84cc16","--low":"#dc2626","--medium":"#eab308","--high":"#22c55e","--complete":"#16a34a","--info":"#06b6d4","--accent-1":"#22c55e","--accent-2":"#8b5cf6","--mut-rainbow":"#FF00FF","--mut-gold":"#EBC800","--mut-wet":"#5FFFFF","--mut-chilled":"#B4E6FF","--mut-frozen":"#B9C8FF","--mut-dawnlit":"#F59BE1","--mut-dawncharged":"#C896FF","--mut-ambershine":"#FFB478","--mut-ambercharged":"#FA8C4B","--rarity-common":"#E7E7E7","--rarity-uncommon":"#67BD4D","--rarity-rare":"#0071C6","--rarity-legendary":"#FFC734","--rarity-mythical":"#9944A7","--rarity-divine":"#FF7835","--rarity-celestial":"#FF00FF","--rainbow-text-gradient":"linear-gradient(90deg, #ff0000, #ff7f00, #ffff00, #00ff00, #00ffff, #ff00ff)","--switch-thumb":"#ffffff","--journal-ink":"#ffffff"},violet:{"--bg":"rgba(23, 16, 42, 0.68)","--fg":"#f5f3ff","--muted":"rgba(245,243,255,0.08)","--soft":"rgba(245,243,255,0.05)","--accent":"#a855f7","--border":"rgba(216,180,254,0.22)","--shadow":"rgba(12,3,30,.55)","--paper":"#1a1424","--tab-bg":"rgba(255,255,255,0.08)","--tab-fg":"#ede9fe","--pill-from":"#a855f7","--pill-to":"#f472b6","--low":"#f43f5e","--medium":"#fbbf24","--high":"#4ade80","--complete":"#22c55e","--info":"#60a5fa","--accent-1":"#4ade80","--accent-2":"#c084fc","--mut-rainbow":"#FF00FF","--mut-gold":"#EBC800","--mut-wet":"#5FFFFF","--mut-chilled":"#B4E6FF","--mut-frozen":"#B9C8FF","--mut-dawnlit":"#F59BE1","--mut-dawncharged":"#C896FF","--mut-ambershine":"#FFB478","--mut-ambercharged":"#FA8C4B","--rarity-common":"#E7E7E7","--rarity-uncommon":"#67BD4D","--rarity-rare":"#0071C6","--rarity-legendary":"#FFC734","--rarity-mythical":"#9944A7","--rarity-divine":"#FF7835","--rarity-celestial":"#FF00FF","--rainbow-text-gradient":"linear-gradient(90deg, #ff0000, #ff7f00, #ffff00, #00ff00, #00ffff, #ff00ff)","--switch-thumb":"#ffffff","--journal-ink":"#ffffff"},ocean:{"--bg":"rgba(10, 34, 46, 0.66)","--fg":"#e0f7ff","--muted":"rgba(224,247,255,0.07)","--soft":"rgba(224,247,255,0.05)","--accent":"#38bdf8","--border":"rgba(125, 211, 252, 0.22)","--shadow":"rgba(0, 16, 32, .52)","--paper":"#0f2027","--tab-bg":"rgba(56,189,248,0.14)","--tab-fg":"#e0f7ff","--pill-from":"#0ea5e9","--pill-to":"#14b8a6","--low":"#f43f5e","--medium":"#fbbf24","--high":"#34d399","--complete":"#10b981","--info":"#38bdf8","--accent-1":"#22c55e","--accent-2":"#a78bfa","--mut-rainbow":"#FF00FF","--mut-gold":"#EBC800","--mut-wet":"#5FFFFF","--mut-chilled":"#B4E6FF","--mut-frozen":"#B9C8FF","--mut-dawnlit":"#F59BE1","--mut-dawncharged":"#C896FF","--mut-ambershine":"#FFB478","--mut-ambercharged":"#FA8C4B","--rarity-common":"#E7E7E7","--rarity-uncommon":"#67BD4D","--rarity-rare":"#0071C6","--rarity-legendary":"#FFC734","--rarity-mythical":"#9944A7","--rarity-divine":"#FF7835","--rarity-celestial":"#FF00FF","--rainbow-text-gradient":"linear-gradient(90deg, #ff0000, #ff7f00, #ffff00, #00ff00, #00ffff, #ff00ff)","--switch-thumb":"#ffffff","--journal-ink":"#ffffff"},ember:{"--bg":"rgba(34,18,10,0.64)","--fg":"#fff7ed","--muted":"rgba(255,247,237,0.08)","--soft":"rgba(255,247,237,0.05)","--accent":"#f97316","--border":"rgba(255, 159, 92, 0.24)","--shadow":"rgba(16,6,2,.52)","--paper":"#1a1210","--tab-bg":"rgba(255,247,237,0.09)","--tab-fg":"#fff7ed","--pill-from":"#fb923c","--pill-to":"#facc15","--low":"#dc2626","--medium":"#f59e0b","--high":"#22c55e","--complete":"#16a34a","--info":"#38bdf8","--accent-1":"#22c55e","--accent-2":"#c084fc","--mut-rainbow":"#FF00FF","--mut-gold":"#EBC800","--mut-wet":"#5FFFFF","--mut-chilled":"#B4E6FF","--mut-frozen":"#B9C8FF","--mut-dawnlit":"#F59BE1","--mut-dawncharged":"#C896FF","--mut-ambershine":"#FFB478","--mut-ambercharged":"#FA8C4B","--rarity-common":"#E7E7E7","--rarity-uncommon":"#67BD4D","--rarity-rare":"#0071C6","--rarity-legendary":"#FFC734","--rarity-mythical":"#9944A7","--rarity-divine":"#FF7835","--rarity-celestial":"#FF00FF","--rainbow-text-gradient":"linear-gradient(90deg, #ff0000, #ff7f00, #ffff00, #00ff00, #00ffff, #ff00ff)","--switch-thumb":"#ffffff","--journal-ink":"#ffffff"},magicGarden:{"--bg":"#201D1D","--fg":"#F5F5F5","--muted":"rgba(255,255,255,0.6)","--soft":"rgba(0,0,0,0.3)","--accent":"#FFF27D","--border":"rgba(255,255,255,0.1)","--border-accent":"#4A3B2E","--shadow":"rgba(0,0,0,0.5)","--paper":"#FDFBF7","--card-shadow":"0 4px 10px rgba(0, 0, 0, 0.5)","--tab-bg":"#10725A","--tab-fg":"#F5F5F5","--section-title":"#10725A","--group-title":"#5EB292","--item-label":"#F5F5F5","--item-desc":"rgba(255,255,255,0.6)","--item-value":"#FFF27D","--card-bg":"rgba(0,0,0,0.3)","--card-radius":"12px","--card-border":"#4A3B2E","--pill-from":"#FFF27D","--pill-to":"#5EB292","--scrollbar-thumb":"rgba(255,255,255,0.2)","--scrollbar-thumb-hover":"rgba(255,255,255,0.3)","--low":"#F98B4B","--medium":"#F3D32B","--high":"#5EAC46","--complete":"#0B893F","--info":"#38bdf8","--accent-1":"#4caf50","--accent-2":"#9c27b0","--mut-rainbow":"#FF00FF","--mut-gold":"#EBC800","--mut-wet":"#5FFFFF","--mut-chilled":"#B4E6FF","--mut-frozen":"#B9C8FF","--mut-dawnlit":"#F59BE1","--mut-dawncharged":"#C896FF","--mut-ambershine":"#FFB478","--mut-ambercharged":"#FA8C4B","--rarity-common":"#E7E7E7","--rarity-uncommon":"#67BD4D","--rarity-rare":"#0071C6","--rarity-legendary":"#FFC734","--rarity-mythical":"#9944A7","--rarity-divine":"#FF7835","--rarity-celestial":"#FF00FF","--rainbow-text-gradient":"linear-gradient(90deg, #ff0000, #ff7f00, #ffff00, #00ff00, #00ffff, #ff00ff)","--switch-thumb":"#ffffff","--journal-ink":"#000000"}};function Vy(e){const{host:t,themes:n,initialTheme:r,onThemeChange:o}=e;let i=r,a=null,l=false;function u(p){const m=n[p]||n[i]||{};t.setAttribute("data-theme",p),l&&t.classList.add("theme-anim");for(const[v,y]of Object.entries(m))t.style.setProperty(v,y);l?(a!==null&&clearTimeout(a),a=fe.setTimeout(()=>{t.classList.remove("theme-anim"),a=null;},320)):l=true,i=p,o?.(p);}function f(){return i}return u(r),{applyTheme:u,getCurrentTheme:f}}const kc={ui:{expandedCards:{style:false,hudSections:false,enhancements:false,system:false}}};async function Ky(){const e=await _o("tab-settings",{version:2,defaults:kc,sanitize:o=>({ui:{expandedCards:go(kc.ui.expandedCards,o.ui?.expandedCards)}})});function t(o){const i=e.get();e.update({ui:{...i.ui,...o,expandedCards:go(i.ui.expandedCards,o.expandedCards)}});}function n(o,i){const a=e.get();e.update({ui:{...a.ui,expandedCards:{...a.ui.expandedCards,[o]:!!i}}});}function r(o){const i=e.get();n(o,!i.ui.expandedCards[o]);}return {get:e.get,set:e.set,save:e.save,setUI:t,setCardExpanded:n,toggleCard:r}}class Yy{constructor(){xe(this,"injections",new Map);xe(this,"state",{});xe(this,"initialized",false);}register(t){if(this.injections.has(t.id)){console.warn(`[InjectionRegistry] ${t.id} already registered`);return}this.injections.set(t.id,t),this.loadState(t.id),console.log(`[InjectionRegistry] Registered: ${t.name}`);}initAll(){if(!this.initialized){for(const[t,n]of this.injections)if(this.state[t]??n.defaultEnabled??false)try{n.injection.init();}catch(o){console.error(`[InjectionRegistry] Failed to init ${t}:`,o);}this.initialized=true,console.log("[InjectionRegistry] All injections initialized");}}destroyAll(){for(const[,t]of this.injections)try{t.injection.destroy();}catch(n){console.error(`[InjectionRegistry] Failed to destroy ${t.id}:`,n);}this.initialized=false,console.log("[InjectionRegistry] All injections destroyed");}setEnabled(t,n){const r=this.injections.get(t);if(!r){console.warn(`[InjectionRegistry] Unknown injection: ${t}`);return}this.state[t]=n,this.saveState(t),n?r.injection.init():r.injection.destroy(),console.log(`[InjectionRegistry] ${r.name} ${n?"enabled":"disabled"}`);}getAll(){return Array.from(this.injections.values())}isEnabled(t){return this.state[t]??false}loadState(t){const n=this.injections.get(t);if(!n)return;const r=at(n.storageKey,n.defaultEnabled??false);this.state[t]=r;}saveState(t){const n=this.injections.get(t);n&&st(n.storageKey,this.state[t]);}}let Dl=null;function ch(){return Dl||(Dl=new Yy),Dl}function dh(e){return e.replace(/[_-]+/g," ").replace(/^\w/,t=>t.toUpperCase())}function qy(){return Object.keys(oo).map(e=>({value:e,label:dh(e)}))}const Xy=["--bg","--fg","--accent","--muted","--soft","--border","--shadow","--paper","--tab-bg","--tab-fg","--pill-from","--pill-to","--accent-3"];function Qy(e){return dh(e.replace(/^--/,""))}function Jy(e){return e.alpha<1?e.rgba:e.hex}const Vn={pets:{enabled:true},locker:{enabled:true},alerts:{enabled:true},avatar:{enabled:true},room:{enabled:true},cropSizeIndicator:{enabled:false},eggProbabilityIndicator:{enabled:false},cropValueIndicator:{enabled:true}};class Zy extends Br{constructor(n){super({id:"tab-settings",label:"Settings"});xe(this,"featureConfig",Vn);this.deps=n;}async build(n){const r=this.createGrid("12px");r.id="settings",n.appendChild(r);let o;try{o=await Ky();}catch{o={get:()=>kc,set:()=>{},save:()=>{},setUI:()=>{},setCardExpanded:()=>{},toggleCard:()=>{}};}const i=o.get(),a=at(At.CONFIG,{});this.featureConfig=this.mergeFeatureConfig(a);const l=Object.keys(oo),u=this.deps.getCurrentTheme?.()??this.deps.initialTheme,f=l.includes(u)?u:l[0]??"dark";let p=f;const m=th({text:"Theme",tone:"muted",size:"lg"}),v=Fr({options:qy(),value:f,onChange:T=>{p=T,this.deps.applyTheme(T),this.renderThemePickers(T,y,p);}}),y=w("div",{className:"settings-theme-grid"}),b=pt({title:"Style",padding:"lg",expandable:true,defaultExpanded:!!i.ui.expandedCards.style,onExpandChange:T=>o.setCardExpanded("style",T)},w("div",{className:"kv settings-theme-row"},m.root,v.root),y);this.renderThemePickers(f,y,p);const A=this.createHUDSectionsCard({defaultExpanded:!!i.ui.expandedCards.hudSections,onExpandChange:T=>o.setCardExpanded("hudSections",T)}),P=this.createEnhancementsCard({defaultExpanded:!!i.ui.expandedCards.enhancements,onExpandChange:T=>o.setCardExpanded("enhancements",T)}),I=this.createEnvCard({defaultExpanded:!!i.ui.expandedCards.system,onExpandChange:T=>o.setCardExpanded("system",T)});r.appendChild(b),r.appendChild(A),r.appendChild(P),r.appendChild(I);}mergeFeatureConfig(n){return {pets:{...Vn.pets,...n.pets},locker:{...Vn.locker,...n.locker},alerts:{...Vn.alerts,...n.alerts},avatar:{...Vn.avatar,...n.avatar},room:{...Vn.room,...n.room},cropSizeIndicator:{...Vn.cropSizeIndicator,...n.cropSizeIndicator},eggProbabilityIndicator:{...Vn.eggProbabilityIndicator,...n.eggProbabilityIndicator},cropValueIndicator:{...Vn.cropValueIndicator,...n.cropValueIndicator}}}saveFeatureConfig(){st(At.CONFIG,this.featureConfig),console.log("[Settings] Feature config saved:",this.featureConfig);}createHUDSectionsCard(n){const r=(o,i,a,l,u=false,f=false)=>{const p=w("div",{style:`
        ...
        transition: opacity 0.2s ease;
        opacity: ${r?"1":"0.5"};
      `}),f=w("div"),p=w("div",{style:"font-weight: 500; margin-bottom: 4px;"},n),m=w("div",{style:"font-size: 12px; color: var(--fg); opacity: 0.7;"},i);f.append(p,m);const v=Or({checked:r,onChange:y=>{u.style.opacity=y?"1":"0.5",o(y);}});return u.append(f,v.root),u}createEnhancementsCard(n){const r=ch(),i=[...r.getAll()].sort((l,u)=>l.name.localeCompare(u.name)),a=i.map((l,u)=>{const f=u===0,p=u===i.length-1,m=r.isEnabled(l.id);return this.createSectionRow(l.name,m,v=>{r.setEnabled(l.id,v),this.saveFeatureConfig();},l.description,f,p)});return pt({title:"In-Game Enhancements",variant:"soft",padding:"lg",expandable:true,defaultExpanded:n?.defaultExpanded??false,onExpandChange:n?.onExpandChange},w("div",{},...a))}renderThemePickers(n,r,o){const i=oo[n];if(r.replaceChildren(),!!i)for(const a of Xy){const l=i[a];if(l==null)continue;const u=Ry({label:Qy(a),value:l,defaultExpanded:false,onInput:f=>this.updateThemeVar(n,a,f,o),onChange:f=>this.updateThemeVar(n,a,f,o)});r.appendChild(u.root);}}updateThemeVar(n,r,o,i){const a=oo[n];a&&(a[r]=Jy(o),i===n&&this.deps.applyTheme(n));}createEnvCard(n){const r=n?.defaultExpanded??false,o=n?.onExpandChange,i=(I,T)=>{const N=w("div",{className:"kv kv--inline-mobile"}),z=w("label",{},I),O=w("div",{className:"ro"});return typeof T=="string"?O.textContent=T:O.append(T),N.append(z,O),N},a=w("code",{},"—"),l=w("span",{},"—"),u=w("span",{},"—"),f=w("span",{},"—"),p=w("span",{},"—"),m=w("span",{},"—"),v=()=>{const I=Rt.detect();u.textContent=I.surface??"Unknown",f.textContent=I.platform??"Unknown",p.textContent=I.browser??"Unknown",m.textContent=I.os??"Unknown",a.textContent=I.host??"Unknown",l.textContent=I.isInIframe?"Yes":"No";},y=kt({label:"Copy JSON",variant:"primary",size:"sm"});Hy(y,()=>{const I=Rt.detect();return JSON.stringify(I,null,2)});const b=w("div",{style:"width:100%;display:flex;justify-content:center;"},y),A=pt({title:"System",variant:"soft",padding:"lg",footer:b,expandable:true,defaultExpanded:r,onExpandChange:o},i("Surface",u),i("Platform",f),i("Browser",p),i("OS",m),i("Host",a),i("Iframe",l)),P=()=>{document.hidden||v();};return document.addEventListener("visibilitychange",P),v(),this.addCleanup(()=>document.removeEventListener("visibilitychange",P)),A}}function yd(e){const{id:t,columns:n,data:r,pageSize:o=0,stickyHeader:i=true,zebra:a=true,animations:l=true,respectReducedMotion:u=true,compact:f=false,maxHeight:p,selectable:m=false,selectionType:v="switch",selectOnRowClick:y=false,initialSelection:b=[],hideHeaderCheckbox:A=false,getRowId:P=(d,h)=>String(h),onSortChange:I,onSelectionChange:T,onRowClick:N}=e;let z=n.slice(),O=r.slice(),M=r.slice(),F=null,L=null,C=1;const E=typeof window<"u"&&typeof window.matchMedia=="function"?window.matchMedia("(prefers-reduced-motion: reduce)").matches:false,B=!!l&&!(u&&E),j=w("div",{className:"lg-table-wrap",id:t});if(p!=null){const d=typeof p=="number"?`${p}px`:p;j.style.setProperty("--tbl-max-h",d);}const V=w("div",{className:"lg-table"}),U=w("div",{className:"lg-thead"}),ce=w("div",{className:"lg-tbody"}),Y=w("div",{className:"lg-tfoot"});i&&j.classList.add("sticky"),a&&j.classList.add("zebra"),f&&j.classList.add("compact"),m&&j.classList.add("selectable");const ie=v==="switch"?"52px":"36px";j.style.setProperty("--check-w",ie);function se(d){return d==="center"?"center":d==="right"?"flex-end":"flex-start"}function ae(){const d=z.map(S=>{const G=(S.width||"1fr").trim();return /\bfr$/.test(G)?`minmax(0, ${G})`:G}),h=(m?[ie,...d]:d).join(" ");j.style.setProperty("--lg-cols",h);}ae();function ne(){return o?Math.max(1,Math.ceil(O.length/o)):1}function q(){if(!o)return O;const d=(C-1)*o;return O.slice(d,d+o)}function Z(){if(!F||!L)return;const d=z.find(G=>String(G.key)===F),h=L==="asc"?1:-1,S=d?.sortFn?(G,W)=>h*d.sortFn(G,W):(G,W)=>{const J=G[F],de=W[F];return J==null&&de==null?0:J==null?-1*h:de==null?1*h:typeof J=="number"&&typeof de=="number"?h*(J-de):h*String(J).localeCompare(String(de),void 0,{numeric:true,sensitivity:"base"})};O.sort(S);}const R=new Set(b);function $(){return Array.from(R)}const Q=new Map;function re(d){R.clear(),d.forEach(h=>R.add(h)),_e(),Q.forEach((h,S)=>{h.setChecked(R.has(S),true);}),Ne(),T?.($());}function le(){R.clear(),_e(),Q.forEach(d=>d.setChecked(false,true)),Ne(),T?.($());}let ve=null;function _e(){if(!ve)return;const d=q();if(!d.length){ve.indeterminate=false,ve.checked=false;return}const h=d.map((G,W)=>P(G,(C-1)*(o||0)+W)),S=h.reduce((G,W)=>G+(R.has(W)?1:0),0);ve.checked=S===h.length,ve.indeterminate=S>0&&S<h.length;}let $e=false;function vt(){$e=false;const d=ce.offsetWidth-ce.clientWidth;U.style.paddingRight=d>0?`${d}px`:"0px";}function Bt(){$e||($e=true,requestAnimationFrame(vt));}const ct=new ResizeObserver(()=>Bt()),Et=()=>Bt();function Wt(){U.replaceChildren();const d=w("div",{className:"lg-tr lg-tr-head"});if(m){const h=w("div",{className:"lg-th lg-th-check"});A||(ve=w("input",{type:"checkbox"}),ve.addEventListener("change",()=>{const S=q(),G=ve.checked;S.forEach((W,J)=>{const de=P(W,(C-1)*(o||0)+J);G?R.add(de):R.delete(de);}),T?.($()),Ne();}),h.appendChild(ve)),d.appendChild(h);}z.forEach(h=>{const S=w("button",{className:"lg-th",type:"button",title:h.title||h.header});S.textContent=h.header,h.align&&S.style.setProperty("--col-justify",se(h.align)),h.sortable&&S.classList.add("sortable"),F===String(h.key)&&L?S.setAttribute("data-sort",L):S.removeAttribute("data-sort"),h.sortable&&S.addEventListener("click",()=>{const G=String(h.key);F!==G?(F=G,L="asc"):(L=L==="asc"?"desc":L==="desc"?null:"asc",L||(F=null,O=M.slice())),I?.(F,L),F&&L&&Z(),wt();}),d.appendChild(S);}),U.appendChild(d);try{ct.disconnect();}catch{}ct.observe(ce),Bt();}function Lt(d){return Array.from(d.querySelectorAll(":scope > .lg-td, :scope > .lg-td-check"))}function Ht(d){return d.querySelector(".lg-td, .lg-td-check")}function tt(d){const h=Ht(d);return h?h.getBoundingClientRect():null}function Ne(){const d=q(),h=new Map;Array.from(ce.children).forEach(J=>{const de=J,ye=de.getAttribute("data-id");if(!ye)return;const ge=tt(de);ge&&h.set(ye,ge);});const S=new Map;Array.from(ce.children).forEach(J=>{const de=J,ye=de.getAttribute("data-id");ye&&S.set(ye,de);});const G=[];for(let J=0;J<d.length;J++){const de=d[J],ye=(o?(C-1)*o:0)+J,ge=P(de,ye);G.push(ge);let we=S.get(ge);we||(we=mn(de,ye),B&&Lt(we).forEach(it=>{it.style.transform="translateY(6px)",it.style.opacity="0";})),ce.appendChild(we);}const W=[];if(S.forEach((J,de)=>{G.includes(de)||W.push(J);}),!B){W.forEach(J=>J.remove()),_e(),Bt();return}G.forEach(J=>{const de=ce.querySelector(`.lg-tr-body[data-id="${J}"]`);if(!de)return;const ye=tt(de),ge=h.get(J),we=Lt(de);if(ge&&ye){const Ve=ge.left-ye.left,_t=ge.top-ye.top;we.forEach(mt=>{mt.style.transition="none",mt.style.transform=`translate(${Ve}px, ${_t}px)`,mt.style.opacity="1";}),Ht(de)?.getBoundingClientRect(),we.forEach(mt=>{mt.style.willChange="transform, opacity",mt.style.transition="transform .18s ease, opacity .18s ease";}),requestAnimationFrame(()=>{we.forEach(mt=>{mt.style.transform="translate(0,0)";});});}else we.forEach(Ve=>{Ve.style.transition="transform .18s ease, opacity .18s ease";}),requestAnimationFrame(()=>{we.forEach(Ve=>{Ve.style.transform="translate(0,0)",Ve.style.opacity="1";});});const Je=Ve=>{(Ve.propertyName==="transform"||Ve.propertyName==="opacity")&&(we.forEach(_t=>{_t.style.willChange="",_t.style.transition="",_t.style.transform="",_t.style.opacity="";}),Ve.currentTarget.removeEventListener("transitionend",Je));},it=we[0];it&&it.addEventListener("transitionend",Je);}),W.forEach(J=>{const de=Lt(J);de.forEach(we=>{we.style.willChange="transform, opacity",we.style.transition="transform .18s ease, opacity .18s ease",we.style.opacity="0",we.style.transform="translateY(-6px)";});const ye=we=>{we.propertyName==="opacity"&&(we.currentTarget.removeEventListener("transitionend",ye),J.remove());},ge=de[0];ge?ge.addEventListener("transitionend",ye):J.remove();}),_e(),Bt();}function mn(d,h){const S=P(d,h),G=w("div",{className:"lg-tr lg-tr-body","data-id":S});if(m){const W=w("div",{className:"lg-td lg-td-check"});if(v==="switch"){const J=Or({size:"sm",checked:R.has(S),onChange:de=>{de?R.add(S):R.delete(S),_e(),T?.($());}});Q.set(S,J),W.appendChild(J.root);}else {const J=w("input",{type:"checkbox",className:"lg-row-check"});J.checked=R.has(S),J.addEventListener("change",de=>{de.stopPropagation(),J.checked?R.add(S):R.delete(S),_e(),T?.($());}),J.addEventListener("click",de=>de.stopPropagation()),W.appendChild(J);}G.appendChild(W);}return z.forEach(W=>{const J=w("div",{className:"lg-td"});W.align&&J.style.setProperty("--col-justify",se(W.align));let de=W.render?W.render(d,h):String(d[W.key]??"");typeof de=="string"?J.textContent=de:J.appendChild(de),G.appendChild(J);}),(N||m&&y)&&(G.classList.add("clickable"),G.addEventListener("click",W=>{if(!W.target.closest(".lg-td-check")){if(m&&y){const J=!R.has(S);if(J?R.add(S):R.delete(S),_e(),v==="switch"){const de=Q.get(S);de&&de.setChecked(J,true);}else {const de=G.querySelector(".lg-row-check");de&&(de.checked=J);}T?.($());}N?.(d,h,W);}})),G}function gn(){if(Y.replaceChildren(),!o)return;const d=ne(),h=w("div",{className:"lg-pager"}),S=w("button",{className:"btn",type:"button"},"←"),G=w("button",{className:"btn",type:"button"},"→"),W=w("span",{className:"lg-pager-info"},`${C} / ${d}`);S.disabled=C<=1,G.disabled=C>=d,S.addEventListener("click",()=>ut(C-1)),G.addEventListener("click",()=>ut(C+1)),h.append(S,W,G),Y.appendChild(h);}function ut(d){const h=ne();C=Math.min(Math.max(1,d),h),Ne(),gn();}function wt(){ae(),Wt(),Ne(),gn();}function Vt(d){M=d.slice(),O=d.slice(),F&&L&&Z(),ut(1);}function Sn(d){z=d.slice(),wt();}function tn(d,h="asc"){F=d,L=d?h:null,F&&L?Z():O=M.slice(),wt();}function k(){try{ct.disconnect();}catch{}window.removeEventListener("resize",Et);}return V.append(U,ce,Y),j.appendChild(V),window.addEventListener("resize",Et),wt(),{root:j,setData:Vt,setColumns:Sn,sortBy:tn,getSelection:$,setSelection:re,clearSelection:le,setPage:ut,getState:()=>({page:C,pageCount:ne(),sortKey:F,sortDir:L}),destroy:k}}let fs=false;const oi=new Set;function e0(e=document){let t=e.activeElement||null;for(;t&&t.shadowRoot&&t.shadowRoot.activeElement;)t=t.shadowRoot.activeElement;return t}const dn=e=>{const t=e0();if(t){for(const n of oi)if(t===n||n.contains(t)){e.stopImmediatePropagation(),e.stopPropagation();return}}};function t0(){fs||(fs=true,window.addEventListener("keydown",dn,true),window.addEventListener("keypress",dn,true),window.addEventListener("keyup",dn,true),document.addEventListener("keydown",dn,true),document.addEventListener("keypress",dn,true),document.addEventListener("keyup",dn,true));}function n0(){fs&&(fs=false,window.removeEventListener("keydown",dn,true),window.removeEventListener("keypress",dn,true),window.removeEventListener("keyup",dn,true),document.removeEventListener("keydown",dn,true),document.removeEventListener("keypress",dn,true),document.removeEventListener("keyup",dn,true));}function r0(e){return oi.size===0&&t0(),oi.add(e),()=>{oi.delete(e),oi.size===0&&n0();}}function ga(e){return e==null?null:typeof e=="string"?document.createTextNode(e):e}function o0(){const e="http://www.w3.org/2000/svg",t=document.createElementNS(e,"svg");t.setAttribute("viewBox","0 0 24 24"),t.setAttribute("width","16"),t.setAttribute("height","16"),t.setAttribute("aria-hidden","true"),t.style.display="none",t.style.flexShrink="0";const n=document.createElementNS(e,"circle");n.setAttribute("cx","12"),n.setAttribute("cy","12"),n.setAttribute("r","9"),n.setAttribute("fill","none"),n.setAttribute("stroke","currentColor"),n.setAttribute("stroke-width","3"),n.setAttribute("stroke-linecap","round");const r=document.createElementNS(e,"animate");r.setAttribute("attributeName","stroke-dasharray"),r.setAttribute("values","1,150;90,150;90,150"),r.setAttribute("dur","1.5s"),r.setAttribute("repeatCount","indefinite");const o=document.createElementNS(e,"animateTransform");return o.setAttribute("attributeName","transform"),o.setAttribute("attributeType","XML"),o.setAttribute("type","rotate"),o.setAttribute("from","0 12 12"),o.setAttribute("to","360 12 12"),o.setAttribute("dur","1s"),o.setAttribute("repeatCount","indefinite"),n.append(r,o),t.appendChild(n),t}function Gs(e={}){const{id:t,placeholder:n="Search...",value:r="",size:o="md",disabled:i=false,autoFocus:a=false,onChange:l,onSearch:u,autoSearch:f=false,debounceMs:p=0,focusKey:m="/",iconLeft:v,iconRight:y,withClear:b=true,clearTitle:A="Clear",ariaLabel:P,submitLabel:I,loading:T=false,blockGameKeys:N=true}=e,z=w("div",{className:"search"+(o?` search--${o}`:""),id:t}),O=w("span",{className:"search-ico search-ico--left"});if(v){const le=ga(v);le&&O.appendChild(le);}else O.textContent="🔎",O.style.opacity=".9";const M=w("input",{className:"input search-input",type:"text",placeholder:n,value:r,"aria-label":P||n}),F=w("span",{className:"search-ico search-ico--right"});if(y){const le=ga(y);le&&F.appendChild(le);}const L=o0();L.classList.add("search-spinner");const C=b?w("button",{className:"search-clear",type:"button",title:A},"×"):null,E=I!=null?w("button",{className:"btn search-submit",type:"button"},I):null,B=w("div",{className:"search-field"},O,M,F,L,...C?[C]:[]);z.append(B,...E?[E]:[]);let j=!!i,V=null;function U(le){L.style.display=le?"inline-block":"none",z.classList.toggle("is-loading",le);}function ce(){V!=null&&(window.clearTimeout(V),V=null);}function Y(le){ce(),p>0?V=window.setTimeout(()=>{V=null,le();},p):le();}function ie(){l?.(M.value),f&&u&&u(M.value);}M.addEventListener("input",()=>{Y(ie);}),M.addEventListener("keydown",le=>{le.key==="Enter"?(le.preventDefault(),ce(),u?.(M.value)):le.key==="Escape"&&(M.value.length>0?ne("",{notify:true}):M.blur());}),C&&C.addEventListener("click",()=>ne("",{notify:true})),E&&E.addEventListener("click",()=>u?.(M.value));let se=()=>{};if(N&&(se=r0(M)),m){const le=ve=>{if(ve.key===m&&!ve.ctrlKey&&!ve.metaKey&&!ve.altKey){const _e=document.activeElement;_e&&(_e.tagName==="INPUT"||_e.tagName==="TEXTAREA"||_e.isContentEditable)||(ve.preventDefault(),M.focus());}};window.addEventListener("keydown",le,true),z.__cleanup=()=>{window.removeEventListener("keydown",le,true),se();};}else z.__cleanup=()=>{se();};function ae(le){j=!!le,M.disabled=j,C&&(C.disabled=j),E&&(E.disabled=j),z.classList.toggle("disabled",j);}function ne(le,ve={}){const _e=M.value;M.value=le??"",ve.notify&&_e!==le&&Y(ie);}function q(){return M.value}function Z(){M.focus();}function R(){M.blur();}function $(le){M.placeholder=le;}function Q(le){ne("",le);}return ae(j),U(T),a&&Z(),{root:z,input:M,getValue:q,setValue:ne,focus:Z,blur:R,setDisabled:ae,setPlaceholder:$,clear:Q,setLoading:U,setIconLeft(le){O.replaceChildren();const ve=ga(le??"🔎");ve&&O.appendChild(ve);},setIconRight(le){F.replaceChildren();const ve=ga(le??"");ve&&F.appendChild(ve);}}}const uh=e=>new Promise(t=>setTimeout(t,e)),yn=e=>{try{return e()}catch{return}},Rn=(e,t,n)=>Math.max(t,Math.min(n,e)),i0=e=>Rn(e,0,1);let xd=null;function ph(){return xd}function a0(e){xd=e;}function fh(){return xd!==null}const s0=/\/(?:r\/\d+\/)?version\/([^/]+)/,l0=15e3,c0=50;function d0(){return fe?.document??(typeof document<"u"?document:null)}function wd(e={}){if(fh())return;const t=e.doc??d0();if(!t)return;const n=t.scripts;for(let r=0;r<n.length;r++){const i=n.item(r)?.src;if(!i)continue;const a=i.match(s0);if(a?.[1]){a0(a[1]);return}}}function u0(){return wd(),ph()}function p0(){return fh()}async function f0(e={}){const t=e.timeoutMs??l0,n=performance.now();for(;performance.now()-n<t;){wd();const r=ph();if(r)return r;await uh(c0);}throw new Error("MGVersion timeout (gameVersion not found)")}const Cd={init:wd,isReady:p0,get:u0,wait:f0},h0=fe?.location?.origin||"https://magicgarden.gg";function hh(){return typeof GM_xmlhttpRequest=="function"}function mh(e,t="text"){return new Promise((n,r)=>{GM_xmlhttpRequest({method:"GET",url:e,responseType:t,onload:o=>o.status>=200&&o.status<300?n(o):r(new Error(`HTTP ${o.status} for ${e}`)),onerror:()=>r(new Error(`Network error for ${e}`)),ontimeout:()=>r(new Error(`Timeout for ${e}`))});})}async function gh(e){if(hh())return JSON.parse((await mh(e,"text")).responseText);const t=await fetch(e);if(!t.ok)throw new Error(`HTTP ${t.status} for ${e}`);return t.json()}async function m0(e){if(hh())return (await mh(e,"blob")).response;const t=await fetch(e);if(!t.ok)throw new Error(`HTTP ${t.status} for ${e}`);return t.blob()}const Pr=(e,t)=>e.replace(/\/?$/,"/")+String(t||"").replace(/^\//,"");let kd=null,bh=null;function g0(){return kd}function b0(){return bh}function v0(e){kd=e;}function y0(e){bh=e;}function vh(){return kd!==null}const x0=15e3;async function w0(e={}){vh()||await Sd(e);}async function Sd(e={}){const t=g0();if(t)return t;const n=b0();if(n)return n;const r=(async()=>{const o=e.gameVersion??await Cd.wait({timeoutMs:x0}),i=`${h0}/version/${o}/assets/`;return v0(i),i})();return y0(r),r}async function C0(e){const t=await Sd();return Pr(t,e)}function k0(){return vh()}const Io={init:w0,isReady:k0,base:Sd,url:C0},yh=new Map;function S0(e){return yh.get(e)}function A0(e,t){yh.set(e,t);}const xh="manifest.json";let Sc=null;async function E0(){Sc||(Sc=await wh());}function _0(){return Sc!==null}async function wh(e={}){const t=e.baseUrl??await Io.base(),n=S0(t);if(n)return n;const r=gh(Pr(t,xh));return A0(t,r),r}function I0(e,t){return e.bundles.find(n=>n.name===t)??null}function T0(e){if(!e)return [];const t=new Set;for(const n of e.assets)for(const r of n.src??[])typeof r=="string"&&r.endsWith(".json")&&r!==xh&&t.add(r);return Array.from(t)}const bo={init:E0,isReady:_0,load:wh,getBundle:I0,listJsonFromBundle:T0},P0={items:"items",decor:"decor",mutations:"mutations",eggs:"eggs",pets:"pets",abilities:"abilities",plants:"plants",weathers:"weather"};function L0(){return {data:{items:null,decor:null,mutations:null,eggs:null,pets:null,abilities:null,plants:null,weather:null},ready:false}}const jt=L0(),gp="https://mg-api.ariedam.fr/data";async function M0(){if(jt.ready)return;console.log("[MGData] Fetching game data from API...");const e=await new Promise((n,r)=>{if(typeof GM_xmlhttpRequest>"u"){fetch(gp).then(o=>{if(!o.ok)r(new Error(`[MGData] API request failed: ${o.status}`));else return o.json()}).then(o=>n(o)).catch(r);return}GM_xmlhttpRequest({method:"GET",url:gp,responseType:"json",onload(o){if(o.status<200||o.status>=300){r(new Error(`[MGData] API request failed: ${o.status}`));return}n(o.response);},onerror(){r(new Error("[MGData] Network error"));}});});for(const[n,r]of Object.entries(P0)){const o=e[n];o&&typeof o=="object"&&(jt.data[r]=o);}jt.ready=true;const t=Object.entries(jt.data).filter(([,n])=>n!==null).map(([n])=>n);console.log(`[MGData] Data loaded: ${t.join(", ")}`);}const R0=/\/assets\/sprites\/(.+?)\.png/,F0={"mutation-overlays":"mutation-overlay"};function O0(e){const t=F0[e];return t||(e.endsWith("s")&&e.length>1?e.slice(0,-1):e)}function Kn(e){if(!e||typeof e!="string")return null;const t=e.match(R0);if(!t)return null;const n=t[1],r=n.indexOf("/");if(r>0){const o=n.slice(0,r),i=n.slice(r);return `sprite/${O0(o)}${i}`}return `sprite/${n}`}function N0(e){for(const[,t]of Object.entries(e.items||{})){const n=t,r=Kn(n.sprite);r&&(n.spriteId=r);}for(const[,t]of Object.entries(e.decor||{})){const n=t,r=Kn(n.sprite);r&&(n.spriteId=r);}for(const[,t]of Object.entries(e.mutations||{})){const n=t,r=Kn(n.sprite);r&&(n.spriteId=r);}for(const[,t]of Object.entries(e.eggs||{})){const n=t,r=Kn(n.sprite);r&&(n.spriteId=r);}for(const[,t]of Object.entries(e.pets||{})){const n=t,r=Kn(n.sprite);r&&(n.spriteId=r);}for(const[,t]of Object.entries(e.weather||{})){const n=t,r=Kn(n.sprite);r&&(n.spriteId=r);}for(const[,t]of Object.entries(e.plants||{})){const n=t;if(n.seed){const r=Kn(n.seed.sprite);r&&(n.seed.spriteId=r);}if(n.plant){const r=Kn(n.plant.sprite);r&&(n.plant.spriteId=r);}if(n.crop){const r=Kn(n.crop.sprite);r&&(n.crop.spriteId=r);}}}function D0(){try{console.log("[MGData] Resolving sprites..."),N0(jt.data),console.log("[MGData] Sprite resolution complete");}catch(e){try{console.warn("[MGData] Sprite resolution failed",e);}catch{}}}const Ch=1e4,kh=50;function Sh(e){return new Promise(t=>setTimeout(t,e))}function $0(e){return jt.data[e]}function B0(){return {...jt.data}}function z0(e){return jt.data[e]!=null}async function j0(e,t=Ch){const n=jt.data[e];if(n!=null)return n;const r=Date.now();for(;Date.now()-r<t;){await Sh(kh);const o=jt.data[e];if(o!=null)return o}throw new Error(`MGData.waitFor: timeout waiting for "${e}"`)}async function G0(e=Ch){if(jt.ready)return {...jt.data};const t=Date.now();for(;Date.now()-t<e;){if(jt.ready)return {...jt.data};await Sh(kh);}throw new Error("MGData.waitForAnyData: timeout")}const Ah=["CoinFinderI","CoinFinderII","CoinFinderIII","SeedFinderI","SeedFinderII","SeedFinderIII","SeedFinderIV","HungerRestore","HungerRestoreII","DoubleHarvest","DoubleHatch","ProduceEater","PetHatchSizeBoost","PetHatchSizeBoostII","PetAgeBoost","PetAgeBoostII","PetRefund","PetRefundII","ProduceRefund","SellBoostI","SellBoostII","SellBoostIII","SellBoostIV","GoldGranter","RainbowGranter","RainDance","PetXpBoost","PetXpBoostII","EggGrowthBoost","EggGrowthBoostII_NEW","EggGrowthBoostII","PlantGrowthBoost","PlantGrowthBoostII","ProduceScaleBoost","ProduceScaleBoostII"];function Eh(e){return Ah.includes(e)}function _h(e){return e.filter(t=>Eh(t.action))}function bp(e){const t=Math.floor(e/3600),n=Math.floor(e%3600/60),r=Math.floor(e%60);return t>0?`${t}h ${n}m`:n>0?`${n}m ${r}s`:`${r}s`}function $l(e){return e?.name||e?.petSpecies||"Unknown Pet"}function Ih(e){const{action:t,parameters:n}=e,r=n;switch(t){case "CoinFinderI":case "CoinFinderII":case "CoinFinderIII":return `Found ${r.coinsFound||0} coins`;case "SeedFinderI":case "SeedFinderII":case "SeedFinderIII":case "SeedFinderIV":return `Found 1× ${r.speciesId||"Unknown"} seed`;case "HungerRestore":case "HungerRestoreII":{const o=$l(r.targetPet),i=r.hungerRestoreAmount||0,l=r.pet?.id===r.targetPet?.id?"itself":o;return `Restored ${i} hunger to ${l}`}case "DoubleHarvest":return `Double harvested ${r.harvestedCrop?.species||"Unknown"}`;case "DoubleHatch":return `Double hatched ${r.extraPet?.petSpecies||"Unknown"}`;case "ProduceEater":{const o=r.growSlot?.species||"Unknown",i=r.sellPrice||0;return `Ate ${o} for ${i} coins`}case "PetHatchSizeBoost":case "PetHatchSizeBoostII":{const o=$l(r.targetPet),i=r.strengthIncrease||0;return `Boosted ${o}'s size by +${i.toFixed(0)}`}case "PetAgeBoost":case "PetAgeBoostII":{const o=$l(r.targetPet);return `Gave +${r.bonusXp||0} XP to ${o}`}case "PetRefund":case "PetRefundII":return `Refunded 1× ${r.eggId||"Unknown Egg"}`;case "ProduceRefund":{const o=r.cropsRefunded?.length||0;return `Refunded ${o} ${o===1?"crop":"crops"}`}case "SellBoostI":case "SellBoostII":case "SellBoostIII":case "SellBoostIV":return `Gave +${r.bonusCoins||0} bonus coins`;case "GoldGranter":case "RainbowGranter":case "RainDance":{const o=r.mutation||"Unknown";return `Made ${r.growSlot?.species||"Unknown"} turn ${o}`}case "PetXpBoost":case "PetXpBoostII":{const o=r.bonusXp||0,i=r.petsAffected?.length||0;return `Gave +${o} XP to ${i} ${i===1?"pet":"pets"}`}case "EggGrowthBoost":case "EggGrowthBoostII_NEW":case "EggGrowthBoostII":{const o=r.secondsReduced||0,i=r.eggsAffected?.length||0,a=bp(o);return `Reduced ${i} ${i===1?"egg":"eggs"} growth by ${a}`}case "PlantGrowthBoost":case "PlantGrowthBoostII":{const o=r.secondsReduced||0,i=r.numPlantsAffected||0,a=bp(o);return `Reduced ${i} ${i===1?"plant":"plants"} growth by ${a}`}case "ProduceScaleBoost":case "ProduceScaleBoostII":{const o=r.scaleIncreasePercentage||0,i=r.numPlantsAffected||0;return `Boosted ${i} ${i===1?"crop":"crops"} size by +${o.toFixed(0)}%`}default:return `Unknown ability: ${t}`}}const Oe={async init(){await M0();},isReady(){return jt.ready},get:$0,getAll:B0,has:z0,waitFor:j0,waitForAny:G0,resolveSprites:D0,cleanup(){}},U0=new Map;function W0(){return U0}function Ac(){return fe.jotaiAtomCache?.cache}function lr(e){const t=W0(),n=t.get(e);if(n)return n;const r=Ac();if(!r)return null;for(const o of r.values())if((o?.debugLabel||o?.label||"")===e)return t.set(e,o),o;return null}function H0(){const e=fe;if(e.__REACT_DEVTOOLS_GLOBAL_HOOK__)return;const t=new Map,n=new Map;e.__REACT_DEVTOOLS_GLOBAL_HOOK__={renderers:t,supportsFiber:true,inject:r=>{const o=t.size+1;return t.set(o,r),n.set(o,new Set),o},onCommitFiberRoot:(r,o)=>{const i=n.get(r);i&&i.add(o);},onCommitFiberUnmount:()=>{},onPostCommitFiberRoot:()=>{},getFiberRoots:r=>n.get(r),checkDCE:()=>{},isDisabled:false};}const V0={baseStore:null,captureInProgress:false,captureError:null,lastCapturedVia:null,mirror:void 0};function To(){return V0}const K0="__JOTAI_STORE_READY__";let vp=false;const Ec=new Set;function ba(){if(!vp){vp=true;for(const e of Ec)try{e();}catch{}try{const e=fe.CustomEvent||CustomEvent;fe.dispatchEvent?.(new e(K0));}catch{}}}function Y0(e){Ec.add(e);const t=Ic();if(t.via&&!t.polyfill)try{e();}catch{}return ()=>{Ec.delete(e);}}async function Ad(e={}){const{timeoutMs:t=6e3,intervalMs:n=50}=e,r=Ic();if(!(r.via&&!r.polyfill))return new Promise((o,i)=>{let a=false;const l=Y0(()=>{a||(a=true,l(),o());}),u=Date.now();(async()=>{for(;!a&&Date.now()-u<t;){const p=Ic();if(p.via&&!p.polyfill){if(a)return;a=true,l(),o();return}await Ci(n);}a||(a=true,l(),i(new Error("Store not captured within timeout")));})();})}const Ci=e=>new Promise(t=>setTimeout(t,e));function Th(){try{const e=fe.Event||Event;fe.dispatchEvent?.(new e("visibilitychange"));}catch{}}function _c(e){return e&&typeof e=="object"&&typeof e.get=="function"&&typeof e.set=="function"&&typeof e.sub=="function"}function Bl(e,t=0,n=new WeakSet){if(t>3||!e||typeof e!="object"||n.has(e))return null;try{n.add(e);}catch{return null}if(_c(e))return e;const r=["store","value","current","state","s","baseStore"];for(const o of r)try{const i=e[o];if(_c(i))return i}catch{}return null}function Ph(){const e=To(),t=fe.__REACT_DEVTOOLS_GLOBAL_HOOK__;if(!t?.renderers?.size)return null;let n=0;for(const[r]of t.renderers){const o=t.getFiberRoots?.(r);o&&(n+=o.size||0);}if(n===0)return null;for(const[r]of t.renderers){const o=t.getFiberRoots?.(r);if(o)for(const i of o){const a=new Set,l=[i.current];for(;l.length;){const u=l.pop();if(!(!u||a.has(u))){a.add(u);try{const f=u?.pendingProps?.value;if(_c(f))return e.lastCapturedVia="fiber",f}catch{}try{let f=u?.memoizedState,p=0;for(;f&&p<15;){p++;const m=Bl(f);if(m)return e.lastCapturedVia="fiber",m;const v=Bl(f.memoizedState);if(v)return e.lastCapturedVia="fiber",v;f=f.next;}}catch{}try{if(u?.stateNode){const f=Bl(u.stateNode);if(f)return e.lastCapturedVia="fiber",f}}catch{}u.child&&l.push(u.child),u.sibling&&l.push(u.sibling),u.alternate&&l.push(u.alternate);}}}}return null}function Lh(){return {get:()=>{throw new Error("Store not captured: get unavailable")},set:()=>{throw new Error("Store not captured: set unavailable")},sub:()=>()=>{},__polyfill:true}}async function q0(e=5e3){const t=Date.now();let n=Ac();for(;!n&&Date.now()-t<e;)await Ci(100),n=Ac();if(!n)throw new Error("jotaiAtomCache.cache not found");const r=To();let o=null,i=null;const a=[],l=()=>{for(const f of a)try{f.__origWrite&&(f.write=f.__origWrite,delete f.__origWrite);}catch{}};for(const f of n.values()){if(!f||typeof f.write!="function"||f.__origWrite)continue;const p=f.write;f.__origWrite=p,f.write=function(m,v,...y){return i||(o=m,i=v,l()),p.call(this,m,v,...y)},a.push(f);}Th();const u=Date.now();for(;!i&&Date.now()-u<e;)await Ci(50);return i?(r.lastCapturedVia="write",{get:f=>o(f),set:(f,p)=>i(f,p),sub:(f,p)=>{let m;try{m=o(f);}catch{}const v=setInterval(()=>{let y;try{y=o(f);}catch{return}if(y!==m){m=y;try{p();}catch{}}},100);return ()=>clearInterval(v)}}):(l(),r.lastCapturedVia="polyfill",Lh())}async function X0(e=1e4){const t=To();Th();const n=Date.now();for(;Date.now()-n<e;){const r=Ph();if(r)return r;await Ci(50);}return t.lastCapturedVia="polyfill",Lh()}async function Ed(){const e=To();if(e.baseStore&&!e.baseStore.__polyfill)return ba(),e.baseStore;if(e.captureInProgress){const t=Date.now(),n=2500;for(;!e.baseStore&&Date.now()-t<n;)await Ci(25);if(e.baseStore)return e.baseStore.__polyfill||ba(),e.baseStore}e.captureInProgress=true;try{const t=Ph();if(t)return e.baseStore=t,ba(),t;try{const r=await q0(5e3);return e.baseStore=r,r.__polyfill||ba(),r}catch(r){e.captureError=r;}const n=await X0();return e.baseStore=n,n}catch(t){throw e.captureError=t,t}finally{e.captureInProgress=false;}}function Ic(){const e=To();return {via:e.lastCapturedVia,polyfill:!!e.baseStore?.__polyfill,error:e.captureError}}async function Q0(){const e=await Ed(),t=new WeakMap,n=async o=>{let i=t.get(o);if(i)return i;i={last:void 0,has:false,subs:new Set},t.set(o,i);try{i.last=e.get(o),i.has=!0;}catch{}const a=e.sub(o,()=>{let l;try{l=e.get(o);}catch{return}const u=i.last,f=!Object.is(l,u)||!i.has;if(i.last=l,i.has=true,f)for(const p of i.subs)try{p(l,u);}catch{}});return i.unsubUpstream=a,i};return {async get(o){const i=await n(o);if(i.has)return i.last;const a=e.get(o);return i.last=a,i.has=true,a},async set(o,i){await e.set(o,i);const a=await n(o);a.last=i,a.has=true;},async sub(o,i){const a=await n(o);if(a.subs.add(i),a.has)try{i(a.last,a.last);}catch{}return ()=>{a.subs.delete(i);}},getShadow(o){return t.get(o)?.last},hasShadow(o){return !!t.get(o)?.has},async ensureWatch(o){await n(o);},async asStore(){return {get:o=>this.get(o),set:(o,i)=>this.set(o,i),sub:(o,i)=>{let a=null;return this.sub(o,()=>i()).then(l=>a=l),()=>a?.()}}}}}async function Ha(){const e=To();return e.mirror||(e.mirror=await Q0()),e.mirror}const Xe={async select(e){const t=await Ha(),n=lr(e);if(!n)throw new Error(`[Store] Atom not found: "${e}"`);return t.get(n)},async set(e,t){const n=await Ha(),r=lr(e);if(!r)throw new Error(`[Store] Atom not found: "${e}"`);await n.set(r,t);},async subscribe(e,t){const n=await Ha(),r=lr(e);if(!r)throw new Error(`[Store] Atom not found: "${e}"`);return n.sub(r,o=>{try{t(o);}catch{}})},async subscribeImmediate(e,t){const n=await Xe.select(e);try{t(n);}catch{}return Xe.subscribe(e,t)}};async function Mh(){await Ha();}const Di=Object.freeze(Object.defineProperty({__proto__:null,Store:Xe,prewarm:Mh,waitForStore:Ad},Symbol.toStringTag,{value:"Module"}));function _d(e){return e?Array.isArray(e)?e.slice():e.split(".").map(t=>t.match(/^\d+$/)?Number(t):t):[]}function ki(e,t){const n=_d(t);let r=e;for(const o of n){if(r==null)return;r=r[o];}return r}function J0(e,t,n){const r=_d(t);if(!r.length)return n;const o=Array.isArray(e)?[...e]:{...e??{}};let i=o;for(let a=0;a<r.length-1;a++){const l=r[a],u=i[l],f=typeof u=="object"&&u!==null?Array.isArray(u)?[...u]:{...u}:{};i[l]=f,i=f;}return i[r[r.length-1]]=n,o}function yp(e,t){const n={};for(const r of t)n[r]=r.includes(".")?ki(e,r):e?.[r];try{return JSON.stringify(n)}catch{return String(n)}}function Z0(e,t,n){const r=n.mode??"auto";function o(f){const p=t?ki(f,t):f,m=new Map;if(p==null)return {signatures:m,keys:[]};const v=Array.isArray(p);if((r==="array"||r==="auto"&&v)&&v)for(let b=0;b<p.length;b++){const A=p[b],P=n.key?n.key(A,b,f):b,I=n.sig?n.sig(A,b,f):n.fields?yp(A,n.fields):JSON.stringify(A);m.set(P,I);}else for(const[b,A]of Object.entries(p)){const P=n.key?n.key(A,b,f):b,I=n.sig?n.sig(A,b,f):n.fields?yp(A,n.fields):JSON.stringify(A);m.set(P,I);}return {signatures:m,keys:Array.from(m.keys())}}function i(f,p){if(f===p)return  true;if(!f||!p||f.size!==p.size)return  false;for(const[m,v]of f)if(p.get(m)!==v)return  false;return  true}async function a(f){let p=null;return Xe.subscribeImmediate(e,m=>{const v=t?ki(m,t):m,{signatures:y}=o(v);if(!i(p,y)){const b=new Set([...p?Array.from(p.keys()):[],...Array.from(y.keys())]),A=[];for(const P of b){const I=p?.get(P)??"__NONE__",T=y.get(P)??"__NONE__";I!==T&&A.push(P);}p=y,f({value:v,changedKeys:A});}})}async function l(f,p){return a(({value:m,changedKeys:v})=>{v.includes(f)&&p({value:m});})}async function u(f,p){const m=new Set(f);return a(({value:v,changedKeys:y})=>{const b=y.filter(A=>m.has(A));b.length&&p({value:v,changedKeys:b});})}return {sub:a,subKey:l,subKeys:u}}const eo=new Map;function ex(e,t){const n=eo.get(e);if(n)try{n();}catch{}return eo.set(e,t),()=>{try{t();}catch{}eo.get(e)===t&&eo.delete(e);}}function et(e,t={}){const{path:n,write:r="replace"}=t,o=n?`${e}:${_d(n).join(".")}`:e;async function i(){const m=await Xe.select(e);return n?ki(m,n):m}async function a(m){if(typeof r=="function"){const b=await Xe.select(e),A=r(m,b);return Xe.set(e,A)}const v=await Xe.select(e),y=n?J0(v,n,m):m;return r==="merge-shallow"&&!n&&v&&typeof v=="object"&&typeof m=="object"?Xe.set(e,{...v,...m}):Xe.set(e,y)}async function l(m){const v=await i(),y=m(v);return await a(y),y}async function u(m,v,y){let b;const A=I=>{const T=n?ki(I,n):I;if(typeof b>"u"||!y(b,T)){const N=b;b=T,v(T,N);}},P=m?await Xe.subscribeImmediate(e,A):await Xe.subscribe(e,A);return ex(o,P)}function f(){const m=eo.get(o);if(m){try{m();}catch{}eo.delete(o);}}function p(m){return Z0(e,m?.path??n,m)}return {label:o,get:i,set:a,update:l,onChange:(m,v=Object.is)=>u(false,m,v),onChangeNow:(m,v=Object.is)=>u(true,m,v),asSignature:p,stopOnChange:f}}function te(e){return et(e)}te("positionAtom");te("lastPositionInMyGardenAtom");te("playerDirectionAtom");te("stateAtom");te("quinoaDataAtom");te("currentTimeAtom");te("actionAtom");te("isPressAndHoldActionAtom");te("mapAtom");te("tileSizeAtom");et("mapAtom",{path:"cols"});et("mapAtom",{path:"rows"});et("mapAtom",{path:"spawnTiles"});et("mapAtom",{path:"locations.seedShop.spawnTileIdx"});et("mapAtom",{path:"locations.eggShop.spawnTileIdx"});et("mapAtom",{path:"locations.toolShop.spawnTileIdx"});et("mapAtom",{path:"locations.decorShop.spawnTileIdx"});et("mapAtom",{path:"locations.sellCropsShop.spawnTileIdx"});et("mapAtom",{path:"locations.sellPetShop.spawnTileIdx"});et("mapAtom",{path:"locations.collectorsClub.spawnTileIdx"});et("mapAtom",{path:"locations.wishingWell.spawnTileIdx"});et("mapAtom",{path:"locations.shopsCenter.spawnTileIdx"});te("playerAtom");te("myDataAtom");te("myUserSlotIdxAtom");te("isSpectatingAtom");te("myCoinsCountAtom");te("numPlayersAtom");et("playerAtom",{path:"id"});et("myDataAtom",{path:"activityLogs"});te("userSlotsAtom");te("filteredUserSlotsAtom");te("myUserSlotAtom");te("spectatorsAtom");et("stateAtom",{path:"child"});et("stateAtom",{path:"child.data"});et("stateAtom",{path:"child.data.shops"});const tx=et("stateAtom",{path:"child.data.userSlots"}),nx=et("stateAtom",{path:"data.players"}),rx=et("stateAtom",{path:"data.hostPlayerId"});te("myInventoryAtom");te("myInventoryItemsAtom");te("isMyInventoryAtMaxLengthAtom");te("myFavoritedItemIdsAtom");te("myCropInventoryAtom");te("mySeedInventoryAtom");te("myToolInventoryAtom");te("myEggInventoryAtom");te("myDecorInventoryAtom");te("myPetInventoryAtom");et("myInventoryAtom",{path:"favoritedItemIds"});te("itemTypeFiltersAtom");te("myItemStoragesAtom");te("myPetHutchStoragesAtom");te("myPetHutchItemsAtom");te("myPetHutchPetItemsAtom");te("myNumPetHutchItemsAtom");te("myValidatedSelectedItemIndexAtom");te("isSelectedItemAtomSuspended");te("mySelectedItemAtom");te("mySelectedItemNameAtom");te("mySelectedItemRotationsAtom");te("mySelectedItemRotationAtom");te("setSelectedIndexToEndAtom");te("myPossiblyNoLongerValidSelectedItemIndexAtom");te("mySelectedItemIdAtom");te("myCurrentGlobalTileIndexAtom");te("myCurrentGardenTileAtom");te("myCurrentGardenObjectAtom");te("myOwnCurrentGardenObjectAtom");te("myOwnCurrentDirtTileIndexAtom");te("myCurrentGardenObjectNameAtom");te("isInMyGardenAtom");te("myGardenBoardwalkTileObjectsAtom");const ox=et("myDataAtom",{path:"garden"});et("myDataAtom",{path:"garden.tileObjects"});et("myOwnCurrentGardenObjectAtom",{path:"objectType"});te("myCurrentStablePlantObjectInfoAtom");te("myCurrentSortedGrowSlotIndicesAtom");te("mySelectedSlotIdAtom");te("myCurrentGrowSlotsAtom");te("myCurrentGrowSlotAtom");te("secondsUntilCurrentGrowSlotMaturesAtom");te("isCurrentGrowSlotMatureAtom");te("numGrowSlotsAtom");te("myCurrentEggAtom");te("myPetSlotInfosAtom");te("myPrimitivePetSlotsAtom");te("myNonPrimitivePetSlotsAtom");te("myPetsProgressAtom");te("myActiveCropMutationPetsAtom");te("totalPetSellPriceAtom");te("selectedPetHasNewVariantsAtom");const ix=te("shopsAtom"),ax=et("myDataAtom",{path:"shopPurchases"});te("seedShopAtom");te("seedShopInventoryAtom");te("seedShopRestockSecondsAtom");te("seedShopCustomRestockInventoryAtom");te("eggShopAtom");te("eggShopInventoryAtom");te("eggShopRestockSecondsAtom");te("eggShopCustomRestockInventoryAtom");te("toolShopAtom");te("toolShopInventoryAtom");te("toolShopRestockSecondsAtom");te("toolShopCustomRestockInventoryAtom");te("decorShopAtom");te("decorShopInventoryAtom");te("decorShopRestockSecondsAtom");te("decorShopCustomRestockInventoryAtom");te("isDecorShopAboutToRestockAtom");et("shopsAtom",{path:"seed"});et("shopsAtom",{path:"tool"});et("shopsAtom",{path:"egg"});et("shopsAtom",{path:"decor"});te("myCropItemsAtom");te("myCropItemsToSellAtom");te("totalCropSellPriceAtom");te("friendBonusMultiplierAtom");te("myJournalAtom");te("myCropJournalAtom");te("myPetJournalAtom");te("myStatsAtom");te("myActivityLogsAtom");te("newLogsAtom");te("hasNewLogsAtom");te("newCropLogsFromSellingAtom");te("hasNewCropLogsFromSellingAtom");te("myCompletedTasksAtom");te("myActiveTasksAtom");te("isWelcomeToastVisibleAtom");te("shouldCloseWelcomeToastAtom");te("isInitialMoveToDirtPatchToastVisibleAtom");te("isFirstPlantSeedActiveAtom");te("isThirdSeedPlantActiveAtom");te("isThirdSeedPlantCompletedAtom");te("isDemoTouchpadVisibleAtom");te("areShopAnnouncersEnabledAtom");te("arePresentablesEnabledAtom");te("isEmptyDirtTileHighlightedAtom");te("isPlantTileHighlightedAtom");te("isItemHiglightedInHotbarAtom");te("isItemHighlightedInModalAtom");te("isMyGardenButtonHighlightedAtom");te("isSellButtonHighlightedAtom");te("isShopButtonHighlightedAtom");te("isInstaGrowButtonHiddenAtom");te("isActionButtonHighlightedAtom");te("isGardenItemInfoCardHiddenAtom");te("isSeedPurchaseButtonHighlightedAtom");te("isFirstSeedPurchaseActiveAtom");te("isFirstCropHarvestActiveAtom");te("isWeatherStatusHighlightedAtom");te("weatherAtom");const Rh=te("activeModalAtom"),Id=te("inventoryModalIsActiveAtom");te("hotkeyBeingPressedAtom");te("avatarTriggerAnimationAtom");te("avatarDataAtom");te("emoteDataAtom");te("otherUserSlotsAtom");te("otherPlayerPositionsAtom");te("otherPlayerSelectedItemsAtom");te("otherPlayerLastActionsAtom");te("traderBunnyPlayerId");te("npcPlayersAtom");te("npcQuinoaUsersAtom");te("numNpcAvatarsAtom");te("traderBunnyEmoteTimeoutAtom");te("traderBunnyEmoteAtom");te("unsortedLeaderboardAtom");te("currentGardenPlayer");te("quinoaEngineAtom");te("quinoaInitializationErrorAtom");te("avgPingAtom");te("serverClientTimeOffsetAtom");te("isEstablishingShotRunningAtom");te("isEstablishingShotCompleteAtom");const He={initialized:false,activeModal:null,isCustom:false,shadow:null,patchedAtoms:new Set,originalReads:new Map,unsubscribes:[],listeners:{onOpen:new Set,onClose:new Set}};function Us(){return He}function sx(){return He.initialized}function zr(){return He.isCustom&&He.activeModal!==null}function Nr(){return He.activeModal}function Fh(e){return !He.shadow||He.shadow.modal!==e?null:He.shadow.data}function lx(e){He.initialized=e;}function Td(e){He.activeModal=e;}function Pd(e){He.isCustom=e;}function Oh(e,t){He.shadow={modal:e,data:t,timestamp:Date.now()};}function Nh(){He.shadow=null;}function xp(e,t){He.patchedAtoms.add(e),He.originalReads.set(e,t);}function cx(e){return He.originalReads.get(e)}function Tc(e){return He.patchedAtoms.has(e)}function dx(e){He.patchedAtoms.delete(e),He.originalReads.delete(e);}function ux(e){He.unsubscribes.push(e);}function px(){for(const e of He.unsubscribes)try{e();}catch{}He.unsubscribes.length=0;}function fx(e){return He.listeners.onOpen.add(e),()=>He.listeners.onOpen.delete(e)}function Dh(e){return He.listeners.onClose.add(e),()=>He.listeners.onClose.delete(e)}function $h(e){for(const t of Array.from(He.listeners.onOpen))try{t(e);}catch{}}function Ld(e){for(const t of Array.from(He.listeners.onClose))try{t(e);}catch{}}function hx(){px(),He.initialized=false,He.activeModal=null,He.isCustom=false,He.shadow=null,He.patchedAtoms.clear(),He.originalReads.clear(),He.listeners.onOpen.clear(),He.listeners.onClose.clear();}const Md={inventory:{atoms:[{atomLabel:"myInventoryAtom",dataKey:"_full",transform:e=>{const t=e;return {items:t.items??[],storages:t.storages??[],favoritedItemIds:t.favoritedItemIds??[]}}}],derivedAtoms:[{atomLabel:"myCropInventoryAtom",sourceKey:"items",deriveFn:e=>Array.isArray(e)?e.filter(t=>t.itemType==="Produce"):[]},{atomLabel:"mySeedInventoryAtom",sourceKey:"items",deriveFn:e=>Array.isArray(e)?e.filter(t=>t.itemType==="Seed"):[]},{atomLabel:"myToolInventoryAtom",sourceKey:"items",deriveFn:e=>Array.isArray(e)?e.filter(t=>t.itemType==="Tool"):[]},{atomLabel:"myEggInventoryAtom",sourceKey:"items",deriveFn:e=>Array.isArray(e)?e.filter(t=>t.itemType==="Egg"):[]},{atomLabel:"myDecorInventoryAtom",sourceKey:"items",deriveFn:e=>Array.isArray(e)?e.filter(t=>t.itemType==="Decor"):[]},{atomLabel:"myPetInventoryAtom",sourceKey:"items",deriveFn:e=>Array.isArray(e)?e.filter(t=>t.itemType==="Pet"):[]}]},journal:{atoms:[{atomLabel:"myJournalAtom",dataKey:"_full"}],derivedAtoms:[{atomLabel:"myCropJournalAtom",sourceKey:"produce",deriveFn:e=>e??{}},{atomLabel:"myPetJournalAtom",sourceKey:"pets",deriveFn:e=>e??{}}]},stats:{atoms:[{atomLabel:"myStatsAtom",dataKey:"_full"}]},activityLog:{atoms:[{atomLabel:"myActivityLogsAtom",dataKey:"logs"}]},seedShop:{atoms:[{atomLabel:"seedShopInventoryAtom",dataKey:"inventory"},{atomLabel:"seedShopRestockSecondsAtom",dataKey:"secondsUntilRestock",transform:e=>e??0}]},eggShop:{atoms:[{atomLabel:"eggShopInventoryAtom",dataKey:"inventory"},{atomLabel:"eggShopRestockSecondsAtom",dataKey:"secondsUntilRestock",transform:e=>e??0}]},toolShop:{atoms:[{atomLabel:"toolShopInventoryAtom",dataKey:"inventory"},{atomLabel:"toolShopRestockSecondsAtom",dataKey:"secondsUntilRestock",transform:e=>e??0}]},decorShop:{atoms:[{atomLabel:"decorShopInventoryAtom",dataKey:"inventory"},{atomLabel:"decorShopRestockSecondsAtom",dataKey:"secondsUntilRestock",transform:e=>e??0}]},leaderboard:{atoms:[{atomLabel:"unsortedLeaderboardAtom",dataKey:"entries"}]},petHutch:{atoms:[{atomLabel:"myPetHutchItemsAtom",dataKey:"items"},{atomLabel:"myPetHutchPetItemsAtom",dataKey:"petItems"}]}};function Bh(e){return Md[e]}function mx(e){const t=Md[e],n=[];for(const r of t.atoms)n.push(r.atomLabel);if(t.derivedAtoms)for(const r of t.derivedAtoms)n.push(r.atomLabel);return n}const gx=new Set(["inventory","journal","stats","activityLog","petHutch"]),bx=new Set(["seedShop","eggShop","toolShop","decorShop"]),vx=new Set(["leaderboard"]);function yx(e,t,n,r){return function(i){const a=zr(),l=Nr();if(a&&l===r){const u=Fh(r);if(u!==null){let f;if(n.dataKey==="_full"?f=u:f=u[n.dataKey],f!==void 0)return t(i),n.transform?n.transform(f):f}}return t(i)}}function xx(e,t,n,r,o){return function(a){if(zr()&&Nr()===o){const l=Fh(o);if(l!==null){const u=l[n];if(u!==void 0)return t(a),r(u)}}return t(a)}}function wx(e){const t=Bh(e);for(const n of t.atoms){const r=lr(n.atomLabel);if(!r||Tc(n.atomLabel))continue;const o=r.read;if(typeof o!="function")continue;const i=yx(n.atomLabel,o,n,e);r.read=i,xp(n.atomLabel,o);}if(t.derivedAtoms)for(const n of t.derivedAtoms){const r=lr(n.atomLabel);if(!r||Tc(n.atomLabel))continue;const o=r.read;if(typeof o!="function")continue;const i=xx(n.atomLabel,o,n.sourceKey,n.deriveFn,e);r.read=i,xp(n.atomLabel,o);}}async function Ws(e){const t=Bh(e);for(const r of t.atoms)wp(r.atomLabel);if(t.derivedAtoms)for(const r of t.derivedAtoms)wp(r.atomLabel);const n=await Ed();await zh(n,e);}async function Cx(e){const t=await Ed();await zh(t,e);const n=mx(e);for(const r of n){const o=lr(r);if(o)try{t.get(o);}catch{}}}function wp(e){if(!Tc(e))return;const t=lr(e),n=cx(e);t&&n&&(t.read=n),dx(e);}async function zh(e,t){const n=gx.has(t),r=bx.has(t),o=vx.has(t);if(!n&&!r&&!o)return;const i=lr("stateAtom");if(i)try{const a=e.get(i);if(!a||typeof a!="object")return;let l=null;if(n||r){const u=a.child,f=u?.data;if(u&&f&&typeof f=="object"){let p=null;if(n&&Array.isArray(f.userSlots)){const m=f.userSlots.map(v=>{if(!v||typeof v!="object")return v;const y=v,b=y.data,A=b&&typeof b=="object"?{...b}:b;return {...y,data:A}});p={...p??f,userSlots:m};}if(r&&f.shops&&typeof f.shops=="object"&&(p={...p??f,shops:{...f.shops}}),p){const m={...u,data:p};l={...a,child:m};}}}if(o){const u=a.data;if(u&&Array.isArray(u.players)){const f={...u,players:[...u.players]};l={...l??a,data:f};}}if(!l)return;await e.set(i,l);}catch{}}async function kx(){for(const e of Object.keys(Md))await Ws(e);}let va=null,pi=null;async function Sx(){if(Us().initialized)return;pi=await Xe.select("activeModalAtom"),va=setInterval(async()=>{try{const n=await Xe.select("activeModalAtom"),r=pi;r!==n&&(pi=n,Ax(n,r));}catch{}},50),ux(()=>{va&&(clearInterval(va),va=null);}),lx(true);}function Ax(e,t){const n=zr(),r=Nr();e===null&&t!==null&&(n&&r===t?Ex("native"):n||Ld({modal:t,wasCustom:false,closedBy:"native"})),e!==null&&!n&&$h({modal:e,isCustom:false});}async function Ex(e){const t=Nr();t&&(Nh(),Pd(false),Td(null),t==="inventory"&&await Id.set(false),await Ws(t),Ld({modal:t,wasCustom:true,closedBy:e}));}async function _x(e,t){if(!Us().initialized)throw new Error("[MGCustomModal] Not initialized. Call init() first.");zr()&&await jh(),Oh(e,t),Pd(true),Td(e),wx(e),await Cx(e),e==="inventory"&&await Id.set(true),await Rh.set(e),pi=e,$h({modal:e,isCustom:true});}function Ix(e,t){const n=Us();if(!n.isCustom||n.activeModal!==e||!n.shadow)return;const o={...n.shadow.data,...t};Oh(e,o);}async function jh(){const e=Us();if(!e.isCustom||!e.activeModal)return;const t=e.activeModal;Nh(),Pd(false),Td(null),t==="inventory"&&await Id.set(false),await Rh.set(null),pi=null,await Ws(t),Ld({modal:t,wasCustom:true,closedBy:"api"});}function Tx(){return new Promise(e=>{if(!zr()){e();return}const t=Dh(()=>{t(),e();});})}async function Px(){if(zr()){const e=Nr();e&&await Ws(e);}await kx(),hx();}const io={async init(){return Sx()},isReady(){return sx()},async show(e,t){return _x(e,t)},update(e,t){return Ix(e,t)},async close(){return jh()},isOpen(){return Nr()!==null},isCustomOpen(){return zr()},getActiveModal(){return Nr()},waitForClose(){return Tx()},onOpen(e){return fx(e)},onClose(e){return Dh(e)},async destroy(){return Px()}};function Lx(){return {ready:false,app:null,renderer:null,ctors:null,textures:new Map,animations:new Map,spriteMeta:new Map,live:new Set,defaultParent:null,overlay:null,categoryIndex:null,catalogKeys:new Set,animationFrameIds:new Map,loadingPromises:new Map,spritePngUrlResolver:null}}function Mx(){return {lru:new Map,cost:0,srcCanvas:new Map}}function Rx(){return {cache:new Map,maxEntries:200}}const Fx={enabled:true,maxEntries:200,maxCost:800,srcCanvasMax:100},Ox={enabled:true,maxEntries:200},sn=Lx(),Nx=Mx(),Dx={...Fx},$x=Rx(),Bx={...Ox};function Ut(){return sn}function vo(){return Nx}function Si(){return Dx}function Ai(){return $x}function Pc(){return Bx}function Gh(){return sn.ready}function hs(e){const t=String(e||"").trim();return t?t.startsWith("sprite/")||t.startsWith("sprites/")?t:t.includes("/")?`sprite/${t}`:t:""}function $i(e,t){const n=String(e||"").trim().replace(/^sprites?\//,"").replace(/^\/+|\/+$/g,""),r=String(t||"").trim();return r.includes("/")||!n?hs(r):`sprite/${n}/${r}`}function Lc(e,t,n,r){const o=$i(e,t);if(n.has(o)||r.has(o))return o;const i=String(t||"").trim();if(n.has(i)||r.has(i))return i;const a=hs(i);return n.has(a)||r.has(a)?a:o}const Sr=(...e)=>{try{console.log("[MGSprite]",...e);}catch{}},zx="https://mg-api.ariedam.fr/assets/sprite-data?full=1",Cp="https://mg-api.ariedam.fr/assets/sprites";let ii=new Map;function jx(e){const t=e.startsWith("sprite/")?e.slice(7):e,n=t.indexOf("/");if(n>0){const r=t.slice(0,n),o=t.slice(n),i=ii.get(r)??r;return `${Cp}/${i}${o}.png`}return `${Cp}/${t}.png`}function Gx(e){return new Promise((t,n)=>{if(typeof GM_xmlhttpRequest>"u"){fetch(e).then(r=>{if(!r.ok)n(new Error(`HTTP ${r.status} for ${e}`));else return r.json()}).then(r=>t(r)).catch(n);return}GM_xmlhttpRequest({method:"GET",url:e,responseType:"json",onload(r){if(r.status<200||r.status>=300){n(new Error(`HTTP ${r.status} for ${e}`));return}t(r.response);},onerror(){n(new Error(`Network error: ${e}`));}});})}function Ux(e){return new Promise((t,n)=>{if(typeof GM_xmlhttpRequest>"u"){const r=new Image;r.crossOrigin="anonymous",r.onload=()=>t(r),r.onerror=()=>n(new Error(`Failed to load: ${e}`)),r.src=e;return}GM_xmlhttpRequest({method:"GET",url:e,responseType:"blob",onload(r){if(r.status<200||r.status>=300){n(new Error(`HTTP ${r.status} for ${e}`));return}const o=r.response,i=URL.createObjectURL(o),a=new Image;a.onload=()=>{URL.revokeObjectURL(i),t(a);},a.onerror=()=>{URL.revokeObjectURL(i),n(new Error(`Failed to decode: ${e}`));},a.src=i;},onerror(){n(new Error(`Network error: ${e}`));}});})}function Wx(e){const t=new Map;for(const n of e){const r=/^sprite\/([^/]+)\/(.+)$/.exec(n);if(!r)continue;const[,o,i]=r;t.has(o)||t.set(o,new Set),t.get(o).add(i);}return t}function Hx(e){return {anchor:e.anchor??{x:.5,y:.5},sourceSize:e.sourceSize??{w:0,h:0},trimmed:e.trimmed??false,trimOffset:{x:e.spriteSourceSize?.x??0,y:e.spriteSourceSize?.y??0}}}async function Vx(){Sr("fetching sprite catalog from API...");const e=await Gx(zx),t=e.items??e.categories?.flatMap(f=>f.items)??[];if(Sr(`catalog received: ${t.length} entries`),e.categories){ii=new Map;for(const f of e.categories)for(const p of f.items??[]){if(!p.id)continue;const m=/^sprite\/([^/]+)\//.exec(p.id);if(!m)continue;const v=m[1];(!ii.get(v)||v===f.cat)&&ii.set(v,f.cat);}Sr("category mapping:",Object.fromEntries(ii));}await new Promise(f=>setTimeout(f,0));const n=t.filter(f=>f.type==="frame"),r=t.filter(f=>f.type==="animation"),o=new Map,i=new Set;for(const f of n)o.set(f.id,Hx(f)),i.add(f.id);const a=new Map;for(const f of r)f.frames.length>=2&&(a.set(f.id,f.frames),i.add(f.id));await new Promise(f=>setTimeout(f,0));const l=[...i],u=Wx(l);return Sr(`indexed ${u.size} categories, ${a.size} animations, ${i.size} total keys`),{catalogKeys:i,meta:o,animationFrameIds:a,categoryIndex:u,pngUrlResolver:jx}}let ya=null;async function Kx(){return sn.ready?true:ya||(ya=(async()=>{const e=performance.now();Sr("init start");const{catalogKeys:t,meta:n,animationFrameIds:r,categoryIndex:o,pngUrlResolver:i}=await Vx();return sn.catalogKeys=t,sn.spriteMeta=n,sn.animationFrameIds=r,sn.categoryIndex=o,sn.spritePngUrlResolver=i,Sr("catalog loaded","keys",sn.catalogKeys.size,"animations",sn.animationFrameIds.size,"categories",sn.categoryIndex?.size??0),sn.ready=true,Sr("ready in",Math.round(performance.now()-e),"ms"),true})(),ya)}function Uh(e,t){const n=t.textures.get(e);if(n)return Promise.resolve(n);const r=t.loadingPromises.get(e);if(r)return r;if(!t.catalogKeys.has(e)||!t.spritePngUrlResolver)return Promise.resolve(null);const o=t.spritePngUrlResolver(e),i=Ux(o).then(a=>(t.textures.set(e,a),t.loadingPromises.delete(e),a)).catch(()=>(t.loadingPromises.delete(e),null));return t.loadingPromises.set(e,i),i}async function Wh(e,t){const n=new Map,r=e.map(async o=>{const i=await Uh(o,t);n.set(o,i);});return await Promise.all(r),n}const dr={Gold:{overlayTall:null,tallIconOverride:null},Rainbow:{overlayTall:null,tallIconOverride:null,angle:130,angleTall:0},Wet:{overlayTall:"sprite/mutation-overlay/WetTallPlant",tallIconOverride:"sprite/mutation/Puddle"},Chilled:{overlayTall:"sprite/mutation-overlay/ChilledTallPlant",tallIconOverride:null},Frozen:{overlayTall:"sprite/mutation-overlay/FrozenTallPlant",tallIconOverride:null},Thunderstruck:{overlayTall:"sprite/mutation-overlay/ThunderstruckTallPlant",tallIconOverride:"sprite/mutation/ThunderstruckGround"},Dawnlit:{overlayTall:null,tallIconOverride:null},Ambershine:{overlayTall:null,tallIconOverride:null},Dawncharged:{overlayTall:null,tallIconOverride:null},Ambercharged:{overlayTall:null,tallIconOverride:null}},Yx=Object.keys(dr),qx=["Gold","Rainbow","Wet","Chilled","Frozen","Thunderstruck","Ambershine","Dawnlit","Dawncharged","Ambercharged"],kp=new Map(qx.map((e,t)=>[e,t]));function ms(e){return [...new Set(e.filter(Boolean))].sort((n,r)=>(kp.get(n)??1/0)-(kp.get(r)??1/0))}const Xx=["Wet","Chilled","Frozen","Thunderstruck"],Qx=new Set(["Dawnlit","Ambershine","Dawncharged","Ambercharged"]),Jx={Banana:.68,Beet:.65,Carrot:.6,Sunflower:.5,Starweaver:.5,FavaBean:.25,BurrosTail:.2},Zx={Pepper:.6,Banana:.6},ew=256,tw=.5,nw=2;function Hh(e){if(!e.length)return {muts:[],overlayMuts:[],selectedMuts:[],sig:""};const t=ms(e),n=rw(e),r=ow(e);return {muts:n,overlayMuts:r,selectedMuts:t,sig:`${t.join(",")}|${n.join(",")}|${r.join(",")}`}}function rw(e){const t=e.filter((o,i,a)=>dr[o]&&a.indexOf(o)===i);if(!t.length)return [];if(t.includes("Gold"))return ["Gold"];if(t.includes("Rainbow"))return ["Rainbow"];const n=["Ambershine","Dawnlit","Dawncharged","Ambercharged"];return t.some(o=>n.includes(o))?ms(t.filter(o=>!Xx.includes(o))):ms(t)}function ow(e){const t=e.filter((n,r,o)=>dr[n]?.overlayTall&&o.indexOf(n)===r);return ms(t)}function fi(e,t){return e.map(n=>({name:n,meta:dr[n],overlayTall:dr[n]?.overlayTall??null,isTall:t}))}const iw={Gold:{op:"source-atop",colors:["rgb(235,200,0)"],a:.7},Rainbow:{op:"color",colors:["#FF1744","#FF9100","#FFEA00","#00E676","#2979FF","#D500F9"],ang:130,angTall:0,masked:true},Wet:{op:"source-atop",colors:["rgb(50,180,200)"],a:.25},Chilled:{op:"source-atop",colors:["rgb(100,160,210)"],a:.45},Frozen:{op:"source-atop",colors:["rgb(100,130,220)"],a:.5},Thunderstruck:{op:"source-atop",colors:["rgb(16, 141, 163)"],a:.4},Dawnlit:{op:"source-atop",colors:["rgb(209,70,231)"],a:.5},Ambershine:{op:"source-atop",colors:["rgb(190,100,40)"],a:.5},Dawncharged:{op:"source-atop",colors:["rgb(140,80,200)"],a:.5},Ambercharged:{op:"source-atop",colors:["rgb(170,60,25)"],a:.5}},xa=(()=>{try{const t=document.createElement("canvas").getContext("2d");if(!t)return new Set;const n=["color","hue","saturation","luminosity","overlay","screen","lighter","source-atop"],r=new Set;for(const o of n)t.globalCompositeOperation=o,t.globalCompositeOperation===o&&r.add(o);return r}catch{return new Set}})();function aw(e){return xa.has(e)?e:xa.has("overlay")?"overlay":xa.has("screen")?"screen":xa.has("lighter")?"lighter":"source-atop"}function sw(e,t,n,r,o=false){const i=(r-90)*Math.PI/180,a=t/2,l=n/2;if(!o){const m=Math.min(t,n)/2;return e.createLinearGradient(a-Math.cos(i)*m,l-Math.sin(i)*m,a+Math.cos(i)*m,l+Math.sin(i)*m)}const u=Math.cos(i),f=Math.sin(i),p=Math.abs(u)*t/2+Math.abs(f)*n/2;return e.createLinearGradient(a-u*p,l-f*p,a+u*p,l+f*p)}function Sp(e,t,n,r,o=false){const i=r.colors?.length?r.colors:["#fff"],a=r.ang!=null?sw(e,t,n,r.ang,o):e.createLinearGradient(0,0,0,n);i.length===1?(a.addColorStop(0,i[0]),a.addColorStop(1,i[0])):i.forEach((l,u)=>a.addColorStop(u/(i.length-1),l)),e.fillStyle=a,e.fillRect(0,0,t,n);}function lw(e,t,n,r){const o=iw[n];if(!o)return;const i={...o};n==="Rainbow"&&r&&i.angTall!=null&&(i.ang=i.angTall);const a=n==="Rainbow"&&r,l=t.width,u=t.height;e.save();const f=i.masked?aw(i.op):"source-in";if(e.globalCompositeOperation=f,i.a!=null&&(e.globalAlpha=i.a),i.masked){const p=document.createElement("canvas");p.width=l,p.height=u;const m=p.getContext("2d");m.imageSmoothingEnabled=false,Sp(m,l,u,i,a),m.globalCompositeOperation="destination-in",m.drawImage(t,0,0),e.drawImage(p,0,0);}else Sp(e,l,u,i,a);e.restore();}function Bi(e){const t=String(e||"").split("/");return t[t.length-1]||""}function Ei(e){switch(e){case "Ambershine":return ["Ambershine","Amberlit"];case "Dawncharged":return ["Dawncharged","Dawnbound"];case "Ambercharged":return ["Ambercharged","Amberbound"];case "Thunderstruck":return ["Thunderstruck","ThunderstruckGround"];default:return [e]}}function cw(e,t){const n=String(e||"").toLowerCase();for(const r of t.keys()){const o=/sprite\/mutation-overlay\/([A-Za-z0-9]+)TallPlant/i.exec(String(r));if(!o||!o[1])continue;if(o[1].toLowerCase()===n){const a=t.get(r);if(a)return {tex:a,key:r}}}return null}function dw(e,t,n,r){if(!t)return null;const o=Bi(e),i=Ei(t);for(const a of i){const l=[`sprite/mutation/${a}${o}`,`sprite/mutation/${a}-${o}`,`sprite/mutation/${a}_${o}`,`sprite/mutation/${a}/${o}`,`sprite/mutation/${a}`];for(const u of l){const f=n.get(u);if(f)return {tex:f,key:u}}{const u=`sprite/mutation-overlay/${a}TallPlant`,f=n.get(u);if(f)return {tex:f,key:u};const p=`sprite/mutation-overlay/${a}`,m=n.get(p);if(m)return {tex:m,key:p};const v=cw(t,n);if(v)return v}}return null}function uw(e,t,n,r){if(!t)return null;const o=dr[t];if(n&&o?.tallIconOverride){const l=r.get(o.tallIconOverride);if(l)return l}const i=Bi(e),a=Ei(t);for(const l of a){const u=[`sprite/mutation/${l}Icon`,`sprite/mutation/${l}`,`sprite/mutation/${l}${i}`,`sprite/mutation/${l}-${i}`,`sprite/mutation/${l}_${i}`,`sprite/mutation/${l}/${i}`];for(const f of u){const p=r.get(f);if(p)return p}if(n){const f=`sprite/mutation-overlay/${l}TallPlantIcon`,p=r.get(f);if(p)return p;const m=`sprite/mutation-overlay/${l}TallPlant`,v=r.get(m);if(v)return v}}return null}function pw(e,t,n){const r=e?.orig?.width??e?.frame?.width??e?.width??1,o=e?.orig?.height??e?.frame?.height??e?.height??1,i=e?.defaultAnchor?.x??0,a=e?.defaultAnchor?.y??0;let l=Zx[t]??i;const u=o>r*1.5;let f=Jx[t]??(u?a:.4);const p={x:(l-i)*r,y:(f-a)*o},m=Math.min(r,o),v=Math.min(1.5,m/ew);let y=tw*v;return n&&(y*=nw),{width:r,height:o,anchorX:i,anchorY:a,offset:p,iconScale:y}}function fw(e,t,n,r,o){const i=t.scale??1,a=t.frameIndex??0,l=t.mutations?.slice().sort().join(",")||"",u=t.anchorX??.5,f=t.anchorY??.5;return `${e}|s${i}|f${a}|m${l}|ax${u}|ay${f}|bm${n}|bp${o}|p${r}`}function hw(e,t){const n=e.cache.get(t);return n?(n.lastAccess=performance.now(),n.canvas):null}function mw(e,t,n,r){if(t.enabled){if(e.cache.size>=t.maxEntries){let o=null,i=1/0;for(const[a,l]of e.cache)l.lastAccess<i&&(i=l.lastAccess,o=a);o&&e.cache.delete(o);}e.cache.set(n,{canvas:r,lastAccess:performance.now()});}}function Mc(e){const t=document.createElement("canvas");t.width=e.width,t.height=e.height;const n=t.getContext("2d");return n&&n.drawImage(e,0,0),t}function gw(e){e.cache.clear();}function bw(e){return {size:e.cache.size,maxEntries:e.maxEntries}}function vw(){return new Promise(e=>{typeof requestIdleCallback<"u"?requestIdleCallback(()=>e(),{timeout:50}):setTimeout(e,0);})}async function yw(e,t,n,r,o,i,a,l=5,u=0){if(!t.ready||!i.enabled)return 0;const f=e.length;let p=0;a?.(0,f);for(let m=0;m<f;m+=l){const v=e.slice(m,m+l);for(const y of v)try{await Fc(t,n,r,null,y,{scale:1},o,i),p++;}catch{p++;}a?.(p,f),m+l<f&&await vw();}return p}function Rc(e){if(e instanceof HTMLCanvasElement)return Mc(e);if(e instanceof HTMLImageElement){const t=document.createElement("canvas");t.width=e.naturalWidth||e.width,t.height=e.naturalHeight||e.height;const n=t.getContext("2d");return n&&(n.imageSmoothingEnabled=false,n.drawImage(e,0,0)),t}throw new Error("Cannot convert to canvas: unknown source type")}async function xw(e,t,n){const r=Hh(t);if(!r.sig)return;const o=new Set,i=n.spriteMeta.get(e),a=i?.anchor?.y??.5,l=i?.sourceSize,u=l?.w??1,f=l?.h??1,p=a>.8&&f>u*1.8,m=fi(r.selectedMuts,p),v=fi(r.overlayMuts,p);for(const b of m){if(b.name==="Gold"||b.name==="Rainbow")continue;const A=dr[b.name];b.isTall&&A?.tallIconOverride&&o.add(A.tallIconOverride);const P=Bi(e);for(const I of Ei(b.name))o.add(`sprite/mutation/${I}Icon`),o.add(`sprite/mutation/${I}`),o.add(`sprite/mutation/${I}${P}`);}if(p)for(const b of v){b.overlayTall&&o.add(b.overlayTall);for(const A of Ei(b.name))o.add(`sprite/mutation-overlay/${A}TallPlant`),o.add(`sprite/mutation-overlay/${A}`),o.add(`sprite/mutation/${A}`);}const y=[...o].filter(b=>n.catalogKeys.has(b)&&!n.textures.has(b));y.length>0&&await Wh(y,n);}function ww(e,t,n,r){const o=dr[t];if(n&&o?.tallIconOverride&&r.has(o.tallIconOverride))return o.tallIconOverride;const i=Bi(e),a=Ei(t);for(const l of a){const u=[`sprite/mutation/${l}Icon`,`sprite/mutation/${l}`,`sprite/mutation/${l}${i}`];for(const f of u)if(r.has(f))return f}return null}function Cw(e,t,n,r,o){const i=Hh(n);if(!i.sig)return e;const a=e.width,l=e.height,u=o.get(t),f=u?.anchor?.x??.5,p=u?.anchor?.y??.5,m={x:a*f,y:l*p},v=p>.8&&l>a*1.8,y=fi(i.muts,v),b=fi(i.overlayMuts,v),A=fi(i.selectedMuts,v),P=Bi(t),T=pw({width:a,height:l,defaultAnchor:{x:f,y:p}},P,v),N=[];for(const M of A){if(M.name==="Gold"||M.name==="Rainbow")continue;const F=uw(t,M.name,M.isTall,r);if(F)try{const L=Rc(F),C=L.width*T.iconScale,E=L.height*T.iconScale,B=ww(t,M.name,M.isTall,r),j=B?o.get(B):null,V=j?.anchor?.x??.5,U=j?.anchor?.y??.5,ce=m.x+T.offset.x-C*V,Y=m.y+T.offset.y-E*U;let ie=2;M.isTall&&(ie=-1),Qx.has(M.name)&&(ie=10),N.push({canvas:L,x:ce,y:Y,sw:C,sh:E,z:ie});}catch{}}const z=document.createElement("canvas");z.width=a,z.height=l;const O=z.getContext("2d");O.imageSmoothingEnabled=false;for(const M of N)M.z===-1&&O.drawImage(M.canvas,M.x,M.y,M.sw,M.sh);O.drawImage(e,0,0);for(const M of y){const F=document.createElement("canvas");F.width=a,F.height=l;const L=F.getContext("2d");L.imageSmoothingEnabled=false,L.drawImage(e,0,0),lw(L,F,M.name,M.isTall),O.drawImage(F,0,0);}for(const M of N)M.z===2&&O.drawImage(M.canvas,M.x,M.y,M.sw,M.sh);if(v)for(const M of b){const F=M.overlayTall,L=F&&r.get(F)?{tex:r.get(F),key:F}:dw(t,M.name,r);if(L?.tex)try{const C=Rc(L.tex),E=C.width,B=C.height,j=m.x-f*E,V=0,U=document.createElement("canvas");U.width=E,U.height=B;const ce=U.getContext("2d");if(!ce)continue;ce.imageSmoothingEnabled=!1,ce.drawImage(C,0,0),ce.globalCompositeOperation="destination-in",ce.drawImage(e,-j,-V),O.drawImage(U,j,V);}catch{}}for(const M of N)M.z===10&&O.drawImage(M.canvas,M.x,M.y,M.sw,M.sh);return z}function kw(e){return e.boundsMode?e.boundsMode:"base"}function Sw(e,t){return t.pad??0}function Yo(e){return Number.isFinite(e)?Math.max(0,e):0}function Vh(e){if(typeof e=="number"){const t=Yo(e);return {top:t,right:t,bottom:t,left:t}}return e?{top:Yo(e.top??0),right:Yo(e.right??0),bottom:Yo(e.bottom??0),left:Yo(e.left??0)}:{top:0,right:0,bottom:0,left:0}}function Aw(e,t){if(e==="mutations")return "0,0,0,0";if(e==="padded"&&t==null)return "auto";const n=Vh(t);return `${n.top},${n.right},${n.bottom},${n.left}`}async function Fc(e,t,n,r,o,i={},a,l){if(!e.ready)throw new Error("MGSprite not ready yet");const u=Lc(r,o,e.catalogKeys,e.animationFrameIds),f=kw(i),p=Sw(f,i),m=Aw(f,i.boundsPadding),v=a&&l?.enabled?fw(u,i,f,p,m):null;if(v&&a&&l?.enabled){const C=hw(a,v);if(C)return Mc(C)}const y=i.mutations||[],b=e.animationFrameIds.get(u);b?.length?await Wh(b,e):await Uh(u,e),y.length>0&&await xw(u,y,e);const A=Math.max(0,(i.frameIndex??0)|0);let P;if(b?.length){const C=b.map(E=>e.textures.get(E)).filter(Boolean);P=C.length>0?C[A%C.length]:null;}else P=e.textures.get(u);if(!P)throw new Error(`Unknown sprite/anim key: ${u}`);let I=Rc(P);y.length>0&&(I=Cw(I,u,y,e.textures,e.spriteMeta));const T=i.scale??1,N=Vh(i.boundsPadding),z=I.width,O=I.height,M=Math.max(1,Math.ceil((z+N.left+N.right+p*2)*T)),F=Math.max(1,Math.ceil((O+N.top+N.bottom+p*2)*T));let L;if(T===1&&!p&&!N.top&&!N.right&&!N.bottom&&!N.left)L=I;else {L=document.createElement("canvas"),L.width=M,L.height=F;const C=L.getContext("2d");if(C){C.imageSmoothingEnabled=false;const E=(N.left+p)*T,B=(N.top+p)*T;C.drawImage(I,E,B,z*T,O*T);}}return v&&a&&l?.enabled?(mw(a,l,v,L),Mc(L)):L}function Ap(e,t,n,r,o,i={}){throw e.ready?!e.app||!e.ctors?new Error("MGSprite.show() requires PIXI (not available - use toCanvas() instead)"):new Error("MGSprite.show() is not supported in API-only mode"):new Error("MGSprite not ready yet")}function Ew(e){for(const t of Array.from(e.live)){const n=t.__mgDestroy;typeof n=="function"&&n.call(t);}}function _w(e,t){return e.defaultParent=t,true}function Iw(e,t){return e.defaultParent=t,true}function Tw(e){e.lru.clear(),e.cost=0,e.srcCanvas.clear();}function jr(){if(!Gh())throw new Error("MGSprite not ready yet")}function Pw(e,t,n){return typeof t=="string"?Ap(Ut(),vo(),Si(),e,t,n||{}):Ap(Ut(),vo(),Si(),null,e,t||{})}function Lw(e,t,n){return typeof t=="string"?Fc(Ut(),vo(),Si(),e,t,n||{},Ai(),Pc()):Fc(Ut(),vo(),Si(),null,e,t||{},Ai(),Pc())}function Mw(){Ew(Ut());}function Rw(e){return _w(Ut(),e)}function Fw(e){return Iw(Ut(),e)}function Ow(e,t){const n=Ut(),r=typeof t=="string"?Lc(e,t,n.catalogKeys,n.animationFrameIds):Lc(null,e,n.catalogKeys,n.animationFrameIds);return n.catalogKeys.has(r)||n.animationFrameIds.has(r)}function Nw(){jr();const e=Ut().categoryIndex;return e?Array.from(e.keys()).sort((t,n)=>t.localeCompare(n)):[]}function Dw(e){jr();const t=String(e||"").trim();if(!t)return [];const n=Ut().categoryIndex;return n?Array.from(n.get(t)?.values()||[]):[]}function $w(e,t){jr();const n=String(e||"").trim(),r=String(t||"").trim();if(!n||!r)return  false;const o=Ut().categoryIndex;if(!o)return  false;const i=n.toLowerCase(),a=r.toLowerCase();for(const[l,u]of o.entries())if(l.toLowerCase()===i){for(const f of u.values())if(f.toLowerCase()===a)return  true}return  false}function Bw(e){jr();const t=Ut().categoryIndex;if(!t)return [];const n=String(e||"").trim().toLowerCase(),r=[];for(const[o,i]of t.entries())for(const a of i.values()){const l=$i(o,a);(!n||l.toLowerCase().startsWith(n))&&r.push(l);}return r.sort((o,i)=>o.localeCompare(i))}function zw(e){jr();const t=String(e||"").trim();if(!t)return null;const n=hs(t),r=/^sprite\/([^/]+)\/(.+)$/.exec(n);if(!r)return null;const o=r[1],i=r[2],a=Ut().categoryIndex,l=o.toLowerCase(),u=i.toLowerCase();let f=o,p=i;if(a){const m=Array.from(a.keys()).find(b=>b.toLowerCase()===l);if(!m)return null;f=m;const v=a.get(m);if(!v)return null;const y=Array.from(v.values()).find(b=>b.toLowerCase()===u);if(!y)return null;p=y;}return {category:f,id:p,key:$i(f,p)}}function jw(e,t){jr();const n=String(e||"").trim(),r=String(t||"").trim();if(!n||!r)throw new Error("getIdPath(category, id) requires both category and id");const o=Ut().categoryIndex;if(!o)throw new Error("Sprite categories not indexed");const i=n.toLowerCase(),a=r.toLowerCase(),l=Array.from(o.keys()).find(p=>p.toLowerCase()===i)||n,u=o.get(l);if(!u)throw new Error(`Unknown sprite category: ${n}`);const f=Array.from(u.values()).find(p=>p.toLowerCase()===a)||r;if(!u.has(f))throw new Error(`Unknown sprite id: ${n}/${r}`);return $i(l,f)}function Gw(){Tw(vo());}function Uw(){gw(Ai());}function Ww(){return bw(Ai())}function Hw(){return [...Yx]}async function Vw(e,t,n=10,r=0){return jr(),yw(e,Ut(),vo(),Si(),Ai(),Pc(),t,n,r)}const Qe={init:Kx,isReady:Gh,show:Pw,toCanvas:Lw,clear:Mw,attach:Rw,attachProvider:Fw,has:Ow,key:(e,t)=>$i(e,t),getCategories:Nw,getCategoryId:Dw,hasId:$w,listIds:Bw,getIdInfo:zw,getIdPath:jw,clearMutationCache:Gw,clearToCanvasCache:Uw,getToCanvasCacheStats:Ww,getMutationNames:Hw,warmup:Vw};function Kw(){return {ready:false,xform:null,xformAt:0}}const pn=Kw();function Kh(){return pn.ready}const Ep=Function.prototype.bind,qe={_bindPatched:false,engine:null,tos:null,app:null,renderer:null,ticker:null,stage:null};let Yh,qh,Xh;const Yw=new Promise(e=>{Yh=e;}),qw=new Promise(e=>{qh=e;}),Xw=new Promise(e=>{Xh=e;});function Qw(e){return !!(e&&typeof e=="object"&&typeof e.start=="function"&&typeof e.destroy=="function"&&e.app&&e.app.stage&&e.app.renderer&&e.systems&&typeof e.systems.values=="function")}function Jw(e){try{for(const t of e.systems.values()){const n=t?.system;if(n?.name==="tileObject")return n}}catch{}return null}function Zw(e){qe.engine=e,qe.tos=Jw(e)||null,qe.app=e.app||null,qe.renderer=e.app?.renderer||null,qe.ticker=e.app?.ticker||null,qe.stage=e.app?.stage||null;try{Yh(e);}catch{}try{qe.app&&qh(qe.app);}catch{}try{qe.renderer&&Xh(qe.renderer);}catch{}}function Rd(){return qe.engine?true:(qe._bindPatched||(qe._bindPatched=true,Function.prototype.bind=function(e,...t){const n=Ep.call(this,e,...t);try{!qe.engine&&Qw(e)&&(Function.prototype.bind=Ep,qe._bindPatched=!1,Zw(e));}catch{}return n}),false)}Rd();async function eC(e=15e3){const t=performance.now();for(;performance.now()-t<e;){if(qe.engine)return  true;Rd(),await uh(50);}throw new Error("MGPixiHooks: engine capture timeout")}async function tC(e=15e3){return qe.engine||await eC(e),true}function nC(){return qe.engine&&qe.app?{ok:true,engine:qe.engine,tos:qe.tos,app:qe.app}:(Rd(),{ok:false,engine:qe.engine,tos:qe.tos,app:qe.app,note:"Not captured. Wait for room, or reload."})}const Mn={engineReady:Yw,appReady:qw,rendererReady:Xw,engine:()=>qe.engine,tos:()=>qe.tos,app:()=>qe.app,renderer:()=>qe.renderer,ticker:()=>qe.ticker,stage:()=>qe.stage,PIXI:()=>fe.PIXI||null,init:tC,hook:nC,ready:()=>!!qe.engine};function Po(e){try{if(typeof structuredClone=="function")return structuredClone(e)}catch{}try{return JSON.parse(JSON.stringify(e))}catch{}return e}function zi(){return Mn.tos()}function Fd(){return Mn.engine()}function rC(){const e=zi()?.map?.cols;return Number.isFinite(e)&&e>0?e:null}function Od(e,t){const n=rC();return n?t*n+e|0:null}let wa=null;async function oC(e=15e3){return pn.ready?true:wa||(wa=(async()=>{if(await Mn.init(e),!zi())throw new Error("MGTile: engine captured but tileObject system not found");return pn.ready=true,true})(),wa)}function Lr(e,t,n=true){const r=zi(),o=Od(e,t);if(!r||o==null)return {gidx:null,tv:null};let i=r.tileViews?.get?.(o)||null;if(!i&&n&&typeof r.getOrCreateTileView=="function")try{i=r.getOrCreateTileView(o);}catch{}return {gidx:o,tv:i||null}}function zl(e,t){if("startTime"in t&&(e.startTime=Number(t.startTime)),"endTime"in t&&(e.endTime=Number(t.endTime)),"targetScale"in t&&(e.targetScale=Number(t.targetScale)),"mutations"in t){if(!Array.isArray(t.mutations))throw new Error("MGTile: mutations must be an array of strings");e.mutations=t.mutations.slice();}}function Nd(e,t){if(!e)throw new Error("MGTile: no tileObject on this tile");if(e.objectType!==t)throw new Error(`MGTile: expected objectType "${t}", got "${e.objectType}"`)}function ao(e,t,n,r={}){const o=r.ensureView!==false,i=r.forceUpdate!==false,a=Fd(),{gidx:l,tv:u}=Lr(Number(e),Number(t),o);if(l==null)throw new Error("MGTile: cols unavailable (engine/TOS not ready)");if(!u)throw new Error("MGTile: TileView unavailable (not instantiated)");const f=u.tileObject;if(typeof u.onDataChanged!="function")throw new Error("MGTile: tileView.onDataChanged not found (different API?)");if(u.onDataChanged(n),i&&a?.reusableContext&&typeof u.update=="function")try{u.update(a.reusableContext);}catch{}return {ok:true,tx:Number(e),ty:Number(t),gidx:l,before:f,after:u.tileObject}}function Hs(e,t,n={}){const r=n.ensureView!==false,o=n.clone!==false,{gidx:i,tv:a}=Lr(Number(e),Number(t),r);if(i==null)throw new Error("MGTile: cols unavailable (engine not ready)");if(!a)return {tx:Number(e),ty:Number(t),gidx:i,tileView:null,tileObject:void 0};const l=a.tileObject;return {tx:Number(e),ty:Number(t),gidx:i,tileView:a,tileObject:o?Po(l):l}}function iC(e,t,n={}){return ao(e,t,null,n)}function aC(e,t,n,r={}){const i=Hs(e,t,{...r,clone:false}).tileView?.tileObject;Nd(i,"plant");const a=Po(i);if(Array.isArray(a.slots)||(a.slots=[]),"plantedAt"in n&&(a.plantedAt=Number(n.plantedAt)),"maturedAt"in n&&(a.maturedAt=Number(n.maturedAt)),"species"in n&&(a.species=String(n.species)),"slotIdx"in n&&"slotPatch"in n){const l=Number(n.slotIdx)|0;if(!a.slots[l])throw new Error(`MGTile: plant slot ${l} doesn't exist`);return zl(a.slots[l],n.slotPatch),ao(e,t,a,r)}if("slots"in n){const l=n.slots;if(Array.isArray(l)){for(let u=0;u<l.length;u++)if(l[u]!=null){if(!a.slots[u])throw new Error(`MGTile: plant slot ${u} doesn't exist`);zl(a.slots[u],l[u]);}}else if(l&&typeof l=="object")for(const u of Object.keys(l)){const f=Number(u)|0;if(Number.isFinite(f)){if(!a.slots[f])throw new Error(`MGTile: plant slot ${f} doesn't exist`);zl(a.slots[f],l[f]);}}else throw new Error("MGTile: patch.slots must be array or object map");return ao(e,t,a,r)}return ao(e,t,a,r)}function sC(e,t,n,r={}){const i=Hs(e,t,{...r,clone:false}).tileView?.tileObject;Nd(i,"decor");const a=Po(i);return "rotation"in n&&(a.rotation=Number(n.rotation)),ao(e,t,a,r)}function lC(e,t,n,r={}){const i=Hs(e,t,{...r,clone:false}).tileView?.tileObject;Nd(i,"egg");const a=Po(i);return "plantedAt"in n&&(a.plantedAt=Number(n.plantedAt)),"maturedAt"in n&&(a.maturedAt=Number(n.maturedAt)),ao(e,t,a,r)}function cC(e,t,n,r={}){const o=r.ensureView!==false,i=r.forceUpdate!==false,a=Fd(),{gidx:l,tv:u}=Lr(Number(e),Number(t),o);if(l==null)throw new Error("MGTile: cols unavailable (engine not ready)");if(!u)throw new Error("MGTile: TileView unavailable");const f=u.tileObject,p=typeof n=="function"?n(Po(f)):n;if(u.onDataChanged(p),i&&a?.reusableContext&&typeof u.update=="function")try{u.update(a.reusableContext);}catch{}return {ok:true,tx:Number(e),ty:Number(t),gidx:l,before:f,after:u.tileObject}}function dC(e,t,n={}){const r=n.ensureView!==false,{gidx:o,tv:i}=Lr(Number(e),Number(t),r);if(o==null)throw new Error("MGTile: cols unavailable");if(!i)return {ok:true,tx:Number(e),ty:Number(t),gidx:o,tv:null,tileObject:void 0};const a=n.clone!==false,l=i.tileObject;return {ok:true,tx:Number(e),ty:Number(t),gidx:o,objectType:l?.objectType??null,tileObject:a?Po(l):l,tvKeys:Object.keys(i||{}).sort(),tileView:i}}function jl(e){if(!e)return null;const t=o=>o&&(typeof o.getGlobalPosition=="function"||typeof o.toGlobal=="function"),n=["container","root","view","tile","ground","base","floor","bg","background","baseSprite","tileSprite","displayObject","gfx","graphics","sprite"];for(const o of n)if(t(e[o]))return e[o];if(t(e))return e;const r=[e.container,e.root,e.view,e.displayObject,e.tileSprite,e.gfx,e.graphics,e.sprite];for(const o of r)if(t(o))return o;try{for(const o of Object.keys(e))if(t(e[o]))return e[o]}catch{}return null}function Va(e){const t=yn(()=>e?.getGlobalPosition?.());if(t&&Number.isFinite(t.x)&&Number.isFinite(t.y))return {x:t.x,y:t.y};const n=yn(()=>e?.toGlobal?.({x:0,y:0}));return n&&Number.isFinite(n.x)&&Number.isFinite(n.y)?{x:n.x,y:n.y}:null}function uC(e){try{if(!e?.getBounds)return "center";const t=e.getBounds(),n=Va(e);if(!n||!t||!Number.isFinite(t.width)||!Number.isFinite(t.height))return "center";const r=t.x+t.width/2,o=t.y+t.height/2;return Math.hypot(n.x-r,n.y-o)<Math.hypot(n.x-t.x,n.y-t.y)?"center":"topleft"}catch{return "center"}}function pC(){const e=zi(),t=e?.map?.cols,n=e?.map?.rows;if(!e||!Number.isFinite(t)||t<=1)return null;const r=Number.isFinite(n)&&n>1?n:null,o=[[0,0],[1,1],[Math.min(2,t-2),0],[0,1]];r&&r>2&&o.push([Math.floor(t/2),Math.floor(r/2)]);for(const[i,a]of o){if(i<0||a<0||i>=t||r&&a>=r)continue;const l=Lr(i,a,true).tv,u=i+1<t?Lr(i+1,a,true).tv:null,f=Lr(i,a+1,true).tv,p=jl(l),m=jl(u),v=jl(f);if(!p||!m||!v)continue;const y=Va(p),b=Va(m),A=Va(v);if(!y||!b||!A)continue;const P={x:b.x-y.x,y:b.y-y.y},I={x:A.x-y.x,y:A.y-y.y},T=P.x*I.y-P.y*I.x;if(!Number.isFinite(T)||Math.abs(T)<1e-6)continue;const N=1/T,z={a:I.y*N,b:-I.x*N,c:-P.y*N,d:P.x*N},O={x:y.x-i*P.x-a*I.x,y:y.y-i*P.y-a*I.y},M=uC(p),F=M==="center"?O:{x:O.x+.5*(P.x+I.x),y:O.y+.5*(P.y+I.y)};return {ok:true,cols:t,rows:r,vx:P,vy:I,inv:z,anchorMode:M,originCenter:F}}return null}function Qh(){return pn.xform=pC(),pn.xformAt=Date.now(),{ok:!!pn.xform?.ok,xform:pn.xform}}function fC(e,t={}){if(!e||!Number.isFinite(e.x)||!Number.isFinite(e.y))return null;const n=Number.isFinite(t.maxAgeMs)?Number(t.maxAgeMs):1500;(!pn.xform?.ok||t.forceRebuild||Date.now()-pn.xformAt>n)&&Qh();const r=pn.xform;if(!r?.ok)return null;const o=e.x-r.originCenter.x,i=e.y-r.originCenter.y,a=r.inv.a*o+r.inv.b*i,l=r.inv.c*o+r.inv.d*i,u=Math.floor(a),f=Math.floor(l),p=[[u,f],[u+1,f],[u,f+1],[u+1,f+1]];let m=null,v=1/0;for(const[y,b]of p){if(y<0||b<0||y>=r.cols||Number.isFinite(r.rows)&&r.rows!==null&&b>=r.rows)continue;const A=r.originCenter.x+y*r.vx.x+b*r.vy.x,P=r.originCenter.y+y*r.vx.y+b*r.vy.y,I=(e.x-A)**2+(e.y-P)**2;I<v&&(v=I,m={tx:y,ty:b,fx:a,fy:l,x:e.x,y:e.y,gidx:null});}return m?(m.gidx=Od(m.tx,m.ty),m):null}function hC(e,t){const n=pn.xform;return n?.ok?{x:n.originCenter.x+e*n.vx.x+t*n.vy.x,y:n.originCenter.y+e*n.vx.y+t*n.vy.y}:null}function bn(){if(!Kh())throw new Error("MGTile: not ready. Call MGTile.init() first.")}function mC(){return ["MGTile.init()","MGTile.hook()","MGTile.getTileObject(tx,ty) / inspect(tx,ty)","MGTile.setTileEmpty(tx,ty)","MGTile.setTilePlant(tx,ty,{...}) / setTileDecor / setTileEgg","MGTile.setTileObjectRaw(tx,ty,objOrFn)","MGTile.rebuildTransform() / pointToTile({x,y})","MGTile.tileToPoint(tx,ty)"].join(`
`)}const Zn={init:oC,isReady:Kh,hook:Mn.hook,engine:Fd,tos:zi,gidx:(e,t)=>Od(Number(e),Number(t)),getTileObject:(e,t,n={})=>(bn(),Hs(e,t,n)),inspect:(e,t,n={})=>(bn(),dC(e,t,n)),setTileEmpty:(e,t,n={})=>(bn(),iC(e,t,n)),setTilePlant:(e,t,n,r={})=>(bn(),aC(e,t,n,r)),setTileDecor:(e,t,n,r={})=>(bn(),sC(e,t,n,r)),setTileEgg:(e,t,n,r={})=>(bn(),lC(e,t,n,r)),setTileObjectRaw:(e,t,n,r={})=>(bn(),cC(e,t,n,r)),rebuildTransform:()=>(bn(),Qh()),pointToTile:(e,t={})=>(bn(),fC(e,t)),tileToPoint:(e,t)=>(bn(),hC(e,t)),getTransform:()=>(bn(),pn.xform),help:mC};function gC(){return {ready:false,app:null,renderer:null,stage:null,ticker:null,tileSets:new Map,highlights:new Map,watches:new Map,fades:new Map,fadeWatches:new Map}}const Ie=gC();function Jh(){return Ie.ready}async function bC(e=15e3){if(Ie.ready)return Oc(),true;if(await Mn.init(e),Ie.app=Mn.app(),Ie.ticker=Mn.ticker(),Ie.renderer=Mn.renderer(),Ie.stage=Mn.stage(),!Ie.app||!Ie.ticker)throw new Error("MGPixi: PIXI app/ticker not found");return Ie.ready=true,Oc(),true}function Oc(){const e=fe;return e.$PIXI=e.PIXI||null,e.$app=Ie.app||null,e.$renderer=Ie.renderer||null,e.$stage=Ie.stage||null,e.$ticker=Ie.ticker||null,e.__MG_PIXI__={PIXI:e.$PIXI,app:e.$app,renderer:e.$renderer,stage:e.$stage,ticker:e.$ticker,ready:Ie.ready},e.__MG_PIXI__}function Dd(e){return !!e&&typeof e=="object"&&!Array.isArray(e)}function Nc(e){return !!(e&&typeof e.getBounds=="function"&&("parent"in e||"children"in e))}function gs(e){return !!(e&&typeof e.tint=="number")}function Dr(e){return !!(e&&typeof e.alpha=="number")}function Ka(e,t,n){return e+(t-e)*n}function vC(e,t,n){const r=e>>16&255,o=e>>8&255,i=e&255,a=t>>16&255,l=t>>8&255,u=t&255,f=Ka(r,a,n)|0,p=Ka(o,l,n)|0,m=Ka(i,u,n)|0;return f<<16|p<<8|m}function yC(e,t=900){const n=[],r=[e];for(;r.length&&n.length<t;){const o=r.pop();if(!o)continue;gs(o)&&n.push(o);const i=o.children;if(Array.isArray(i))for(let a=i.length-1;a>=0;a--)r.push(i[a]);}return n}function xC(e,t=25e3){const n=[],r=[e];let o=0;for(;r.length&&o++<t;){const i=r.pop();if(!i)continue;Dr(i)&&n.push(i);const a=i.children;if(Array.isArray(a))for(let l=a.length-1;l>=0;l--)r.push(a[l]);}return n}const wC=["plantVisual","cropVisual","slotVisual","slotView","displayObject","view","container","root","sprite","gfx","graphics"];function Dc(e){if(!e)return null;if(Nc(e))return e;if(!Dd(e))return null;for(const t of wC){const n=e[t];if(Nc(n))return n}return null}function CC(e,t){const n=[{o:e,d:0}],r=new Set,o=6;for(;n.length;){const{o:i,d:a}=n.shift();if(!(!i||a>o)&&!r.has(i)){if(r.add(i),Array.isArray(i)){if(i.length===t){const l=new Array(t);let u=true;for(let f=0;f<t;f++){const p=Dc(i[f]);if(!p){u=false;break}l[f]=p;}if(u)return l}for(const l of i)n.push({o:l,d:a+1});continue}if(Dd(i)){const l=i;for(const u of Object.keys(l))n.push({o:l[u],d:a+1});}}}return null}function Zh(e){if(!Array.isArray(e))return [];const t=new Set,n=[];for(const r of e){let o,i;if(Array.isArray(r))o=r[0],i=r[1];else if(Dd(r))o=r.x??r.tx,i=r.y??r.ty;else continue;if(o=Number(o),i=Number(i),!Number.isFinite(o)||!Number.isFinite(i))continue;o|=0,i|=0;const a=`${o},${i}`;t.has(a)||(t.add(a),n.push({x:o,y:i}));}return n}function kC(e,t){const n=String(e||"").trim();if(!n)throw new Error("MGPixi.defineTileSet: empty name");const r=Zh(t);return Ie.tileSets.set(n,r),{ok:true,name:n,count:r.length}}function SC(e){return Ie.tileSets.delete(String(e||"").trim())}function AC(){return Array.from(Ie.tileSets.keys()).sort((e,t)=>e.localeCompare(t))}function em(e){return !!(e&&(e.tileSet!=null||Array.isArray(e.tiles)))}function $d(e){const n=Zn.tos?.()?.tileViews;if(!n?.entries)throw new Error("MGPixi: TOS.tileViews not found");if(!em(e))return {entries:Array.from(n.entries()),gidxSet:null};let r=[];if(e.tileSet!=null){const i=String(e.tileSet||"").trim(),a=Ie.tileSets.get(i);if(!a)throw new Error(`MGPixi: tileSet not found "${i}"`);r=a;}else r=Zh(e.tiles||[]);const o=new Map;for(const i of r){const a=Zn.getTileObject(i.x,i.y,{ensureView:true,clone:false});a?.tileView&&a.gidx!=null&&o.set(a.gidx,a.tileView);}return {entries:Array.from(o.entries()),gidxSet:new Set(o.keys())}}function Bd(e){const t=Ie.highlights.get(e);if(!t)return  false;yn(()=>Ie.ticker?.remove(t.tick)),t.root&&t.baseAlpha!=null&&Dr(t.root)&&yn(()=>{t.root.alpha=t.baseAlpha;});for(const n of t.tint)n.o&&gs(n.o)&&yn(()=>{n.o.tint=n.baseTint;});return Ie.highlights.delete(e),true}function tm(e=null){for(const t of Array.from(Ie.highlights.keys()))e&&!String(t).startsWith(e)||Bd(t);return  true}function nm(e,t={}){if(!Nc(e))throw new Error("MGPixi.highlightPulse: invalid root");const n=String(t.key||`hl:${Math.random().toString(16).slice(2)}`);if(Ie.highlights.has(n))return n;const r=Dr(e)?Number(e.alpha):null,o=Rn(Number(t.minAlpha??.12),0,1),i=Rn(Number(t.maxAlpha??1),0,1),a=Number(t.speed??1.25),l=(t.tint??8386303)>>>0,u=Rn(Number(t.tintMix??.85),0,1),f=t.deepTint!==false,p=[];if(f)for(const y of yC(e))p.push({o:y,baseTint:y.tint});else gs(e)&&p.push({o:e,baseTint:e.tint});const m=performance.now(),v=()=>{const y=(performance.now()-m)/1e3,b=(Math.sin(y*Math.PI*2*a)+1)/2,A=b*b*(3-2*b);r!=null&&Dr(e)&&(e.alpha=Rn(Ka(o,i,A)*r,0,1));const P=A*u;for(const I of p)I.o&&gs(I.o)&&(I.o.tint=vC(I.baseTint,l,P));};return Ie.ticker?.add(v),Ie.highlights.set(n,{root:e,tick:v,baseAlpha:r,tint:p}),n}function EC(e,t){const n=e?.mutations;if(!Array.isArray(n))return  false;for(const r of n)if(String(r||"").toLowerCase()===t)return  true;return  false}function rm(e,t={}){const n=String(e||"").trim().toLowerCase();if(!n)throw new Error("MGPixi.highlightMutation: empty mutation");const{entries:r,gidxSet:o}=$d(t),i=`hlmut:${n}:`;if(t.clear===true)if(!o)tm(i);else for(const m of Array.from(Ie.highlights.keys())){if(!m.startsWith(i))continue;const v=m.split(":"),y=Number(v[2]);o.has(y)&&Bd(m);}const a={tint:(t.tint??8386303)>>>0,minAlpha:Number(t.minAlpha??.12),maxAlpha:Number(t.maxAlpha??1),speed:Number(t.speed??1.25),tintMix:Number(t.tintMix??.85),deepTint:t.deepTint!==false};let l=0,u=0,f=0,p=0;for(const[m,v]of r){const y=v?.tileObject;if(!y||y.objectType!=="plant")continue;const b=y.slots;if(!Array.isArray(b)||b.length===0)continue;let A=false;const P=[];for(let N=0;N<b.length;N++)EC(b[N],n)&&(P.push(N),A=true);if(!A)continue;l++,u+=P.length;const I=v?.childView?.plantVisual||v?.childView||v,T=CC(I,b.length);if(!T){p+=P.length;continue}for(const N of P){const z=T[N];if(!z){p++;continue}const O=`${i}${m}:${N}`;Ie.highlights.has(O)||(nm(z,{key:O,...a}),f++);}}return {ok:true,mutation:n,filtered:!!o,plantsMatched:l,matchedSlots:u,newHighlights:f,failedSlots:p}}function _C(e,t={}){const n=String(e||"").trim().toLowerCase();if(!n)throw new Error("MGPixi.watchMutation: empty mutation");const r=`watchmut:${n}:${t.tileSet?`set:${t.tileSet}`:t.tiles?"tiles":"all"}`,o=Number.isFinite(t.intervalMs)?t.intervalMs:1e3,i=Ie.watches.get(r);i&&clearInterval(i);const a=setInterval(()=>{yn(()=>rm(n,{...t,clear:!1}));},o);return Ie.watches.set(r,a),{ok:true,key:r,mutation:n,intervalMs:o}}function IC(e){const t=String(e||"").trim();if(!t)return  false;if(!t.startsWith("watchmut:")){const r=t.toLowerCase();let o=0;for(const[i,a]of Array.from(Ie.watches.entries()))i.startsWith(`watchmut:${r}:`)&&(clearInterval(a),Ie.watches.delete(i),o++);return o>0}const n=Ie.watches.get(t);return n?(clearInterval(n),Ie.watches.delete(t),true):false}function TC(e){const t=e?.childView?.plantVisual||e?.childView?.cropVisual||e?.childView||e?.displayObject||e;return Dc(t)||Dc(e?.displayObject)||null}function om(e){const t=Ie.fades.get(e);if(!t)return  false;for(const n of t.targets)n.o&&Dr(n.o)&&Number.isFinite(n.baseAlpha)&&yn(()=>{n.o.alpha=n.baseAlpha;});return Ie.fades.delete(e),true}function $c(e=null){for(const t of Array.from(Ie.fades.keys()))e&&!String(t).startsWith(e)||om(t);return  true}function im(e,t={}){const n=String(e||"").trim().toLowerCase();if(!n)throw new Error("MGPixi.clearSpeciesFade: empty species");const r=`fade:${n}:`;if(!em(t))return $c(r);const{gidxSet:o}=$d(t);if(!o)return $c(r);for(const i of Array.from(Ie.fades.keys())){if(!i.startsWith(r))continue;const a=Number(i.slice(r.length));o.has(a)&&om(i);}return  true}function am(e,t={}){const n=String(e||"").trim().toLowerCase();if(!n)throw new Error("MGPixi.fadeSpecies: empty species");const r=Rn(Number(t.alpha??.2),0,1),o=t.deep===true,{entries:i,gidxSet:a}=$d(t),l=`fade:${n}:`;t.clear===true&&im(n,t);let u=0,f=0,p=0,m=0;for(const[v,y]of i){const b=y?.tileObject;if(!b||b.objectType!=="plant")continue;u++;const A=String(b.species||"").trim().toLowerCase();if(!A||A!==n)continue;f++;const P=TC(y);if(!P||!Dr(P)){m++;continue}const I=`${l}${v}`;if(Ie.fades.has(I)){yn(()=>{P.alpha=r;}),p++;continue}const T=o?xC(P):[P],N=[];for(const z of T)Dr(z)&&N.push({o:z,baseAlpha:Number(z.alpha)});for(const z of N)yn(()=>{z.o.alpha=r;});Ie.fades.set(I,{targets:N}),p++;}return {ok:true,species:n,alpha:r,deep:o,filtered:!!a,plantsSeen:u,matchedPlants:f,applied:p,failed:m,totalFades:Ie.fades.size}}function PC(e,t={}){const n=String(e||"").trim().toLowerCase();if(!n)throw new Error("MGPixi.watchFadeSpecies: empty species");const r=`watchfade:${n}:${t.tileSet?`set:${t.tileSet}`:t.tiles?"tiles":"all"}`,o=Number.isFinite(t.intervalMs)?t.intervalMs:1e3,i=Ie.fadeWatches.get(r);i&&clearInterval(i);const a=setInterval(()=>{yn(()=>am(n,{...t,clear:!1}));},o);return Ie.fadeWatches.set(r,a),{ok:true,key:r,species:n,intervalMs:o}}function LC(e){const t=String(e||"").trim();if(!t)return  false;if(!t.startsWith("watchfade:")){const r=t.toLowerCase();let o=0;for(const[i,a]of Array.from(Ie.fadeWatches.entries()))i.startsWith(`watchfade:${r}:`)&&(clearInterval(a),Ie.fadeWatches.delete(i),o++);return o>0}const n=Ie.fadeWatches.get(t);return n?(clearInterval(n),Ie.fadeWatches.delete(t),true):false}function MC(e){const t=Array.isArray(e?.slots)?e.slots:[];return {objectType:"plant",species:e?.species??null,plantedAt:e?.plantedAt??null,maturedAt:e?.maturedAt??null,slotCount:t.length,slots:t.map((n,r)=>({idx:r,mutations:Array.isArray(n?.mutations)?n.mutations.slice():[]}))}}function RC(e,t,n={}){const r=Number(e)|0,o=Number(t)|0,i=n.ensureView!==false,a=Zn.getTileObject(r,o,{ensureView:i,clone:false}),l=a?.tileView||null,u=l?.tileObject,f={ok:true,tx:r,ty:o,gidx:a?.gidx??Zn.gidx?.(r,o)??null,hasTileView:!!l,objectType:u?.objectType??null,tileObject:u??null,summary:u?.objectType==="plant"?MC(u):u?{objectType:u.objectType??null}:null,display:l?l.childView?.plantVisual||l.childView||l.displayObject||l:null};return n.log!==false&&yn(()=>console.log("[MGPixi.inspectTile]",f)),f}function FC(e,t,n){const r=fe.PIXI;if(!r)return;let o=Ie.stage.getChildByName("gemini-overlay");o||(o=new r.Container,o.name="gemini-overlay",Ie.stage.addChild(o));const i=n.key;let a=o.getChildByName(i);a||(a=new r.Graphics,a.name=i,o.addChild(a));const l=Zn.tileToPoint(e,t);if(!l)return;a.clear(),a.lineStyle(2,n.tint??65280,n.alpha??1),a.beginFill(n.tint??65280,(n.alpha??1)*.2);const u=Zn.getTransform(),f=u?Math.hypot(u.vx.x,u.vx.y):32,p=u?Math.hypot(u.vy.x,u.vy.y):32;a.drawRect(0,0,f,p),a.endFill(),a.x=l.x,a.y=l.y,u&&(a.rotation=Math.atan2(u.vx.y,u.vx.x));}function OC(e){const t=Ie.stage?.getChildByName("gemini-overlay");if(!t)return  false;const n=t.getChildByName(e);return n?(t.removeChild(n),n.destroy?.(),true):false}function Mt(){if(!Jh())throw new Error("MGPixi: call MGPixi.init() first")}const Vs={init:bC,isReady:Jh,expose:Oc,get app(){return Ie.app},get renderer(){return Ie.renderer},get stage(){return Ie.stage},get ticker(){return Ie.ticker},get PIXI(){return fe.PIXI||null},defineTileSet:(e,t)=>(Mt(),kC(e,t)),deleteTileSet:e=>(Mt(),SC(e)),listTileSets:()=>(Mt(),AC()),highlightPulse:(e,t)=>(Mt(),nm(e,t)),stopHighlight:e=>(Mt(),Bd(e)),clearHighlights:e=>(Mt(),tm(e)),drawOverlayBox:(e,t,n)=>(Mt(),FC(e,t,n)),stopOverlay:e=>(Mt(),OC(e)),highlightMutation:(e,t)=>(Mt(),rm(e,t)),watchMutation:(e,t)=>(Mt(),_C(e,t)),stopWatchMutation:e=>(Mt(),IC(e)),inspectTile:(e,t,n)=>(Mt(),RC(e,t,n)),fadeSpecies:(e,t)=>(Mt(),am(e,t)),clearSpeciesFade:(e,t)=>(Mt(),im(e,t)),clearFades:e=>(Mt(),$c(e)),watchFadeSpecies:(e,t)=>(Mt(),PC(e,t)),stopWatchFadeSpecies:e=>(Mt(),LC(e))},NC=["Top","Mid","Bottom","DiscordAvatarPlaceholder"],Gl={AVATAR:/avatarelements[^"'`\s]*\.riv/,EMOTES:/emotes[^"'`\s]*\.riv/,UI:/(giftbox|currency|bread|donut|streak|countdown|loader)[^"'`\s]*\.riv/},sm=new Map;let bs=[],lm=false;function DC(e){return sm.get(e)}function $C(e,t){sm.set(e,t);}function Ks(){return [...bs]}function BC(e){bs=e;}function cm(e){bs.some(t=>t.url===e.url)||bs.push(e);}function zC(){return lm}function _p(e){lm=e;}const so=[];let xr=null;function jC(){if(xr)return xr;const e=window.fetch;window.fetch=function(r,o){const i=Tp(r);return i&&i.endsWith(".riv")&&Ip(i),e.call(this,r,o)},xr=()=>{window.fetch===t&&(window.fetch=e),xr=null;};function t(n,r){const o=Tp(n);return o&&o.endsWith(".riv")&&Ip(o),e.call(window,n,r)}return window.fetch=t,xr=()=>{window.fetch===t&&(window.fetch=e),xr=null;},xr}function Ip(e){const t=Rt.detect(),n=e.startsWith("/")?`${t.origin}${e}`:e,r=um(e),o=pm(e),i={name:o,url:n,type:r};cm(i),console.log(`[MGRiveLoader] Intercepted .riv fetch: ${o} (${r})`,n);for(let a=so.length-1;a>=0;a--){const l=so[a];l.type===r&&(clearTimeout(l.timer),l.resolve(i),so.splice(a,1));}}async function GC(){const t=Rt.detect().origin,n=Array.from(document.scripts),r=[];for(const i of n){const a=i.textContent||"",l=Pp(a,t);r.push(...l);}for(const i of n)if(i.src)try{if(new URL(i.src).origin!==t)continue;const l=await fetch(i.src);if(!l.ok)continue;const u=await l.text(),f=Pp(u,t);r.push(...f);}catch(a){console.debug("[MGRiveLoader] Failed to fetch script:",i.src,a);}const o=Array.from(new Map(r.map(i=>[i.url,i])).values());for(const i of o)cm(i);return Ks()}async function UC(){jC();const e=await GC();return BC(e),console.log(`[MGRiveLoader] Discovered ${e.length} .riv files:`,e),e}function WC(e,t=3e4){const n=Ks().find(r=>r.type===e);return n?Promise.resolve(n):new Promise(r=>{const o=setTimeout(()=>{const i=so.findIndex(a=>a.resolve===r);i!==-1&&so.splice(i,1),console.warn(`[MGRiveLoader] Timed out waiting for ${e} .riv file`),r(null);},t);so.push({type:e,resolve:r,timer:o});})}async function dm(){const e=Ks().find(n=>n.type==="avatar");if(e)return e;console.log("[MGRiveLoader] Avatar .riv not found yet, waiting for game to load it...");const t=await WC("avatar",3e4);return t||console.warn("[MGRiveLoader] Could not find avatar .riv file"),t}function Tp(e){return typeof e=="string"?e:e instanceof URL?e.href:e instanceof Request?e.url:null}function Pp(e,t){const n=[],r=new Set,o=/["'`]([^"'`]*\.riv)["'`]/g;let i;for(;(i=o.exec(e))!==null;){const a=i[1],l=um(a);if(l==="other"&&!a.endsWith(".riv")||r.has(a))continue;r.add(a);const u=a.startsWith("/")?`${t}${a}`:a;n.push({name:pm(a),url:u,type:l});}return n}function um(e){return Gl.AVATAR.test(e)?"avatar":Gl.EMOTES.test(e)?"emote":Gl.UI.test(e)?"ui":"other"}function pm(e){const t=e.split("/");return t[t.length-1].replace(/-[a-zA-Z0-9_]+\.riv$/,"")}var Ya={exports:{}},HC=Ya.exports,Lp;function VC(){return Lp||(Lp=1,(function(e,t){(function(r,o){e.exports=o();})(HC,()=>(()=>{var n=[,((a,l,u)=>{u.r(l),u.d(l,{default:()=>p});var f=(()=>{var m=typeof document<"u"?document.currentScript?.src:void 0;return(function(v={}){var y,b=v,A,P,I=new Promise((s,c)=>{A=s,P=c;}),T=typeof window=="object",N=typeof importScripts=="function";function z(){function s(H){const K=x;g=c=0,x=new Map,K.forEach(oe=>{try{oe(H);}catch(ee){console.error(ee);}}),this.ob(),_&&_.Qb();}let c=0,g=0,x=new Map,_=null,D=null;this.requestAnimationFrame=function(H){c||(c=requestAnimationFrame(s.bind(this)));const K=++g;return x.set(K,H),K},this.cancelAnimationFrame=function(H){x.delete(H),c&&x.size==0&&(cancelAnimationFrame(c),c=0);},this.Ob=function(H){D&&(document.body.remove(D),D=null),H||(D=document.createElement("div"),D.style.backgroundColor="black",D.style.position="fixed",D.style.right=0,D.style.top=0,D.style.color="white",D.style.padding="4px",D.innerHTML="RIVE FPS",H=function(K){D.innerHTML="RIVE FPS "+K.toFixed(1);},document.body.appendChild(D)),_=new function(){let K=0,oe=0;this.Qb=function(){var ee=performance.now();oe?(++K,ee-=oe,1e3<ee&&(H(1e3*K/ee),K=oe=0)):(oe=ee,K=0);};};},this.Lb=function(){D&&(document.body.remove(D),D=null),_=null;},this.ob=function(){};}function O(s){console.assert(true);const c=new Map;let g=-1/0;this.push=function(x){return x=x+((1<<s)-1)>>s,c.has(x)&&clearTimeout(c.get(x)),c.set(x,setTimeout(function(){c.delete(x),c.length==0?g=-1/0:x==g&&(g=Math.max(...c.keys()),console.assert(g<x));},1e3)),g=Math.max(x,g),g<<s};}const M=b.onRuntimeInitialized;b.onRuntimeInitialized=function(){M&&M();let s=b.decodeAudio;b.decodeAudio=function(_,D){_=s(_),D(_);};let c=b.decodeFont;b.decodeFont=function(_,D){_=c(_),D(_);};const g=b.FileAssetLoader;b.ptrToAsset=_=>{let D=b.ptrToFileAsset(_);return D.isImage?b.ptrToImageAsset(_):D.isFont?b.ptrToFontAsset(_):D.isAudio?b.ptrToAudioAsset(_):D},b.CustomFileAssetLoader=g.extend("CustomFileAssetLoader",{__construct:function({loadContents:_}){this.__parent.__construct.call(this),this.Eb=_;},loadContents:function(_,D){return _=b.ptrToAsset(_),this.Eb(_,D)}}),b.CDNFileAssetLoader=g.extend("CDNFileAssetLoader",{__construct:function(){this.__parent.__construct.call(this);},loadContents:function(_){let D=b.ptrToAsset(_);return _=D.cdnUuid,_===""?false:((function(H,K){var oe=new XMLHttpRequest;oe.responseType="arraybuffer",oe.onreadystatechange=function(){oe.readyState==4&&oe.status==200&&K(oe);},oe.open("GET",H,true),oe.send(null);})(D.cdnBaseUrl+"/"+_,H=>{D.decode(new Uint8Array(H.response));}),true)}}),b.FallbackFileAssetLoader=g.extend("FallbackFileAssetLoader",{__construct:function(){this.__parent.__construct.call(this),this.kb=[];},addLoader:function(_){this.kb.push(_);},loadContents:function(_,D){for(let H of this.kb)if(H.loadContents(_,D))return  true;return  false}});let x=b.computeAlignment;b.computeAlignment=function(_,D,H,K,oe=1){return x.call(this,_,D,H,K,oe)};};const F="createConicGradient createImageData createLinearGradient createPattern createRadialGradient getContextAttributes getImageData getLineDash getTransform isContextLost isPointInPath isPointInStroke measureText".split(" "),L=new function(){function s(){if(!c){let De=function(Ge,ke,rt){if(ke=pe.createShader(ke),pe.shaderSource(ke,rt),pe.compileShader(ke),rt=pe.getShaderInfoLog(ke),0<(rt||"").length)throw rt;pe.attachShader(Ge,ke);};var X=document.createElement("canvas"),be={alpha:1,depth:0,stencil:0,antialias:0,premultipliedAlpha:1,preserveDrawingBuffer:0,powerPreference:"high-performance",failIfMajorPerformanceCaveat:0,enableExtensionsByDefault:1,explicitSwapControl:1,renderViaOffscreenBackBuffer:1};let pe;if(/iPhone|iPad|iPod/i.test(navigator.userAgent)){if(pe=X.getContext("webgl",be),g=1,!pe)return console.log("No WebGL support. Image mesh will not be drawn."),false}else if(pe=X.getContext("webgl2",be))g=2;else if(pe=X.getContext("webgl",be))g=1;else return console.log("No WebGL support. Image mesh will not be drawn."),false;if(pe=new Proxy(pe,{get(Ge,ke){if(Ge.isContextLost()){if(oe||(console.error("Cannot render the mesh because the GL Context was lost. Tried to invoke ",ke),oe=true),typeof Ge[ke]=="function")return function(){}}else return typeof Ge[ke]=="function"?function(...rt){return Ge[ke].apply(Ge,rt)}:Ge[ke]},set(Ge,ke,rt){if(Ge.isContextLost())oe||(console.error("Cannot render the mesh because the GL Context was lost. Tried to set property "+ke),oe=true);else return Ge[ke]=rt,true}}),x=Math.min(pe.getParameter(pe.MAX_RENDERBUFFER_SIZE),pe.getParameter(pe.MAX_TEXTURE_SIZE)),X=pe.createProgram(),De(X,pe.VERTEX_SHADER,`attribute vec2 vertex;
                attribute vec2 uv;
                uniform vec4 mat;
...
`);console.error(G);}});},k.getInstance=function(d){k.isLoading||(k.isLoading=true,k.loadRuntime()),k.runtime?d(k.runtime):k.callBackQueue.push(d);},k.awaitInstance=function(){return new Promise(function(d){return k.getInstance(function(h){return d(h)})})},k.setWasmUrl=function(d){k.wasmURL=d;},k.getWasmUrl=function(){return k.wasmURL},k.isLoading=false,k.callBackQueue=[],k.wasmURL="https://unpkg.com/".concat(l.name,"@").concat(l.version,"/rive.wasm"),k})(),M;(function(k){k[k.Number=56]="Number",k[k.Trigger=58]="Trigger",k[k.Boolean=59]="Boolean";})(M||(M={}));var F=(function(){function k(d,h){this.type=d,this.runtimeInput=h;}return Object.defineProperty(k.prototype,"name",{get:function(){return this.runtimeInput.name},enumerable:false,configurable:true}),Object.defineProperty(k.prototype,"value",{get:function(){return this.runtimeInput.value},set:function(d){this.runtimeInput.value=d;},enumerable:false,configurable:true}),k.prototype.fire=function(){this.type===M.Trigger&&this.runtimeInput.fire();},k.prototype.delete=function(){this.runtimeInput=null;},k})(),L;(function(k){k[k.General=128]="General",k[k.OpenUrl=131]="OpenUrl";})(L||(L={}));var C=(function(){function k(d){this.isBindableArtboard=false,this.isBindableArtboard=d;}return k})(),E=(function(k){p(d,k);function d(h,S){var G=k.call(this,false)||this;return G.nativeArtboard=h,G.file=S,G}return d})(C),B=(function(k){p(d,k);function d(h){var S=k.call(this,true)||this;return S.selfUnref=false,S.nativeArtboard=h,S}return Object.defineProperty(d.prototype,"viewModel",{set:function(h){this.nativeViewModel=h.nativeInstance;},enumerable:false,configurable:true}),d.prototype.destroy=function(){var h;this.selfUnref&&(this.nativeArtboard.unref(),(h=this.nativeViewModel)===null||h===void 0||h.unref());},d})(C),j=(function(){function k(d,h,S,G){this.stateMachine=d,this.playing=S,this.artboard=G,this.inputs=[],this.instance=new h.StateMachineInstance(d,G),this.initInputs(h);}return Object.defineProperty(k.prototype,"name",{get:function(){return this.stateMachine.name},enumerable:false,configurable:true}),Object.defineProperty(k.prototype,"statesChanged",{get:function(){for(var d=[],h=0;h<this.instance.stateChangedCount();h++)d.push(this.instance.stateChangedNameByIndex(h));return d},enumerable:false,configurable:true}),k.prototype.advance=function(d){this.instance.advance(d);},k.prototype.advanceAndApply=function(d){this.instance.advanceAndApply(d);},k.prototype.reportedEventCount=function(){return this.instance.reportedEventCount()},k.prototype.reportedEventAt=function(d){return this.instance.reportedEventAt(d)},k.prototype.initInputs=function(d){for(var h=0;h<this.instance.inputCount();h++){var S=this.instance.input(h);this.inputs.push(this.mapRuntimeInput(S,d));}},k.prototype.mapRuntimeInput=function(d,h){if(d.type===h.SMIInput.bool)return new F(M.Boolean,d.asBool());if(d.type===h.SMIInput.number)return new F(M.Number,d.asNumber());if(d.type===h.SMIInput.trigger)return new F(M.Trigger,d.asTrigger())},k.prototype.cleanup=function(){this.inputs.forEach(function(d){d.delete();}),this.inputs.length=0,this.instance.delete();},k.prototype.bindViewModelInstance=function(d){d.runtimeInstance!=null&&this.instance.bindViewModelInstance(d.runtimeInstance);},k})(),V=(function(){function k(d,h,S,G,W){G===void 0&&(G=[]),W===void 0&&(W=[]),this.runtime=d,this.artboard=h,this.eventManager=S,this.animations=G,this.stateMachines=W;}return k.prototype.add=function(d,h,S){if(S===void 0&&(S=true),d=ut(d),d.length===0)this.animations.forEach(function(Ve){return Ve.playing=h}),this.stateMachines.forEach(function(Ve){return Ve.playing=h});else for(var G=this.animations.map(function(Ve){return Ve.name}),W=this.stateMachines.map(function(Ve){return Ve.name}),J=0;J<d.length;J++){var de=G.indexOf(d[J]),ye=W.indexOf(d[J]);if(de>=0||ye>=0)de>=0?this.animations[de].playing=h:this.stateMachines[ye].playing=h;else {var ge=this.artboard.animationByName(d[J]);if(ge){var we=new u.Animation(ge,this.artboard,this.runtime,h);we.advance(0),we.apply(1),this.animations.push(we);}else {var Je=this.artboard.stateMachineByName(d[J]);if(Je){var it=new j(Je,this.runtime,h,this.artboard);this.stateMachines.push(it);}}}}return S&&(h?this.eventManager.fire({type:U.Play,data:this.playing}):this.eventManager.fire({type:U.Pause,data:this.paused})),h?this.playing:this.paused},k.prototype.initLinearAnimations=function(d,h){for(var S=this.animations.map(function(ye){return ye.name}),G=0;G<d.length;G++){var W=S.indexOf(d[G]);if(W>=0)this.animations[W].playing=h;else {var J=this.artboard.animationByName(d[G]);if(J){var de=new u.Animation(J,this.artboard,this.runtime,h);de.advance(0),de.apply(1),this.animations.push(de);}else console.error("Animation with name ".concat(d[G]," not found."));}}},k.prototype.initStateMachines=function(d,h){for(var S=this.stateMachines.map(function(ye){return ye.name}),G=0;G<d.length;G++){var W=S.indexOf(d[G]);if(W>=0)this.stateMachines[W].playing=h;else {var J=this.artboard.stateMachineByName(d[G]);if(J){var de=new j(J,this.runtime,h,this.artboard);this.stateMachines.push(de);}else console.warn("State Machine with name ".concat(d[G]," not found.")),this.initLinearAnimations([d[G]],h);}}},k.prototype.play=function(d){return this.add(d,true)},k.prototype.advanceIfPaused=function(){this.stateMachines.forEach(function(d){d.playing||d.advanceAndApply(0);});},k.prototype.pause=function(d){return this.add(d,false)},k.prototype.scrub=function(d,h){var S=this.animations.filter(function(G){return d.includes(G.name)});return S.forEach(function(G){return G.scrubTo=h}),S.map(function(G){return G.name})},Object.defineProperty(k.prototype,"playing",{get:function(){return this.animations.filter(function(d){return d.playing}).map(function(d){return d.name}).concat(this.stateMachines.filter(function(d){return d.playing}).map(function(d){return d.name}))},enumerable:false,configurable:true}),Object.defineProperty(k.prototype,"paused",{get:function(){return this.animations.filter(function(d){return !d.playing}).map(function(d){return d.name}).concat(this.stateMachines.filter(function(d){return !d.playing}).map(function(d){return d.name}))},enumerable:false,configurable:true}),k.prototype.stop=function(d){var h=this;d=ut(d);var S=[];if(d.length===0)S=this.animations.map(function(J){return J.name}).concat(this.stateMachines.map(function(J){return J.name})),this.animations.forEach(function(J){return J.cleanup()}),this.stateMachines.forEach(function(J){return J.cleanup()}),this.animations.splice(0,this.animations.length),this.stateMachines.splice(0,this.stateMachines.length);else {var G=this.animations.filter(function(J){return d.includes(J.name)});G.forEach(function(J){J.cleanup(),h.animations.splice(h.animations.indexOf(J),1);});var W=this.stateMachines.filter(function(J){return d.includes(J.name)});W.forEach(function(J){J.cleanup(),h.stateMachines.splice(h.stateMachines.indexOf(J),1);}),S=G.map(function(J){return J.name}).concat(W.map(function(J){return J.name}));}return this.eventManager.fire({type:U.Stop,data:S}),S},Object.defineProperty(k.prototype,"isPlaying",{get:function(){return this.animations.reduce(function(d,h){return d||h.playing},false)||this.stateMachines.reduce(function(d,h){return d||h.playing},false)},enumerable:false,configurable:true}),Object.defineProperty(k.prototype,"isPaused",{get:function(){return !this.isPlaying&&(this.animations.length>0||this.stateMachines.length>0)},enumerable:false,configurable:true}),Object.defineProperty(k.prototype,"isStopped",{get:function(){return this.animations.length===0&&this.stateMachines.length===0},enumerable:false,configurable:true}),k.prototype.atLeastOne=function(d,h){h===void 0&&(h=true);var S;return this.animations.length===0&&this.stateMachines.length===0&&(this.artboard.animationCount()>0?this.add([S=this.artboard.animationByIndex(0).name],d,h):this.artboard.stateMachineCount()>0&&this.add([S=this.artboard.stateMachineByIndex(0).name],d,h)),S},k.prototype.handleLooping=function(){for(var d=0,h=this.animations.filter(function(G){return G.playing});d<h.length;d++){var S=h[d];S.loopValue===0&&S.loopCount?(S.loopCount=0,this.stop(S.name)):S.loopValue===1&&S.loopCount?(this.eventManager.fire({type:U.Loop,data:{animation:S.name,type:ce.Loop}}),S.loopCount=0):S.loopValue===2&&S.loopCount>1&&(this.eventManager.fire({type:U.Loop,data:{animation:S.name,type:ce.PingPong}}),S.loopCount=0);}},k.prototype.handleStateChanges=function(){for(var d=[],h=0,S=this.stateMachines.filter(function(W){return W.playing});h<S.length;h++){var G=S[h];d.push.apply(d,G.statesChanged);}d.length>0&&this.eventManager.fire({type:U.StateChange,data:d});},k.prototype.handleAdvancing=function(d){this.eventManager.fire({type:U.Advance,data:d});},k})(),U;(function(k){k.Load="load",k.LoadError="loaderror",k.Play="play",k.Pause="pause",k.Stop="stop",k.Loop="loop",k.Draw="draw",k.Advance="advance",k.StateChange="statechange",k.RiveEvent="riveevent",k.AudioStatusChange="audiostatuschange";})(U||(U={}));var ce;(function(k){k.OneShot="oneshot",k.Loop="loop",k.PingPong="pingpong";})(ce||(ce={}));var Y=(function(){function k(d){d===void 0&&(d=[]),this.listeners=d;}return k.prototype.getListeners=function(d){return this.listeners.filter(function(h){return h.type===d})},k.prototype.add=function(d){this.listeners.includes(d)||this.listeners.push(d);},k.prototype.remove=function(d){for(var h=0;h<this.listeners.length;h++){var S=this.listeners[h];if(S.type===d.type&&S.callback===d.callback){this.listeners.splice(h,1);break}}},k.prototype.removeAll=function(d){var h=this;d?this.listeners.filter(function(S){return S.type===d}).forEach(function(S){return h.remove(S)}):this.listeners.splice(0,this.listeners.length);},k.prototype.fire=function(d){var h=this.getListeners(d.type);h.forEach(function(S){return S.callback(d)});},k})(),ie=(function(){function k(d){this.eventManager=d,this.queue=[];}return k.prototype.add=function(d){this.queue.push(d);},k.prototype.process=function(){for(;this.queue.length>0;){var d=this.queue.shift();d?.action&&d.action(),d?.event&&this.eventManager.fire(d.event);}},k})(),se;(function(k){k[k.AVAILABLE=0]="AVAILABLE",k[k.UNAVAILABLE=1]="UNAVAILABLE";})(se||(se={}));var ae=(function(k){p(d,k);function d(){var h=k!==null&&k.apply(this,arguments)||this;return h._started=false,h._enabled=false,h._status=se.UNAVAILABLE,h}return d.prototype.delay=function(h){return v(this,void 0,void 0,function(){return y(this,function(S){return [2,new Promise(function(G){return setTimeout(G,h)})]})})},d.prototype.timeout=function(){return v(this,void 0,void 0,function(){return y(this,function(h){return [2,new Promise(function(S,G){return setTimeout(G,50)})]})})},d.prototype.reportToListeners=function(){this.fire({type:U.AudioStatusChange}),this.removeAll();},d.prototype.enableAudio=function(){return v(this,void 0,void 0,function(){return y(this,function(h){return this._enabled||(this._enabled=true,this._status=se.AVAILABLE,this.reportToListeners()),[2]})})},d.prototype.testAudio=function(){return v(this,void 0,void 0,function(){return y(this,function(h){switch(h.label){case 0:if(!(this._status===se.UNAVAILABLE&&this._audioContext!==null))return [3,4];h.label=1;case 1:return h.trys.push([1,3,,4]),[4,Promise.race([this._audioContext.resume(),this.timeout()])];case 2:return h.sent(),this.enableAudio(),[3,4];case 3:return h.sent(),[3,4];case 4:return [2]}})})},d.prototype._establishAudio=function(){return v(this,void 0,void 0,function(){return y(this,function(h){switch(h.label){case 0:return this._started?[3,5]:(this._started=true,typeof window>"u"?(this.enableAudio(),[3,5]):[3,1]);case 1:this._audioContext=new AudioContext,this.listenForUserAction(),h.label=2;case 2:return this._status!==se.UNAVAILABLE?[3,5]:[4,this.testAudio()];case 3:return h.sent(),[4,this.delay(1e3)];case 4:return h.sent(),[3,2];case 5:return [2]}})})},d.prototype.listenForUserAction=function(){var h=this,S=function(){return v(h,void 0,void 0,function(){return y(this,function(G){return this.enableAudio(),[2]})})};document.addEventListener("pointerdown",S,{once:true});},d.prototype.establishAudio=function(){return v(this,void 0,void 0,function(){return y(this,function(h){return this._establishAudio(),[2]})})},Object.defineProperty(d.prototype,"systemVolume",{get:function(){return this._status===se.UNAVAILABLE?(this.testAudio(),0):1},enumerable:false,configurable:true}),Object.defineProperty(d.prototype,"status",{get:function(){return this._status},enumerable:false,configurable:true}),d})(Y),ne=new ae,q=(function(){function k(){}return k.prototype.observe=function(){},k.prototype.unobserve=function(){},k.prototype.disconnect=function(){},k})(),Z=globalThis.ResizeObserver||q,R=(function(){function k(){var d=this;this._elementsMap=new Map,this._onObservedEntry=function(h){var S=d._elementsMap.get(h.target);S!==null?S.onResize(h.target.clientWidth==0||h.target.clientHeight==0):d._resizeObserver.unobserve(h.target);},this._onObserved=function(h){h.forEach(d._onObservedEntry);},this._resizeObserver=new Z(this._onObserved);}return k.prototype.add=function(d,h){var S={onResize:h,element:d};return this._elementsMap.set(d,S),this._resizeObserver.observe(d),S},k.prototype.remove=function(d){this._resizeObserver.unobserve(d.element),this._elementsMap.delete(d.element);},k})(),$=new R,Q=(function(){function k(d){this.enableRiveAssetCDN=true,this.referenceCount=0,this.destroyed=false,this.selfUnref=false,this.bindableArtboards=[],this.src=d.src,this.buffer=d.buffer,d.assetLoader&&(this.assetLoader=d.assetLoader),this.enableRiveAssetCDN=typeof d.enableRiveAssetCDN=="boolean"?d.enableRiveAssetCDN:true,this.eventManager=new Y,d.onLoad&&this.on(U.Load,d.onLoad),d.onLoadError&&this.on(U.LoadError,d.onLoadError);}return k.prototype.releaseFile=function(){var d;this.selfUnref&&((d=this.file)===null||d===void 0||d.unref()),this.file=null;},k.prototype.releaseBindableArtboards=function(){this.bindableArtboards.forEach(function(d){return d.destroy()});},k.prototype.initData=function(){return v(this,void 0,void 0,function(){var d,h,S,G,W;return y(this,function(J){switch(J.label){case 0:return this.src?(d=this,[4,gn(this.src)]):[3,2];case 1:d.buffer=J.sent(),J.label=2;case 2:return this.destroyed?[2]:(this.assetLoader&&(S=new f.CustomFileAssetLoaderWrapper(this.runtime,this.assetLoader),h=S.assetLoader),G=this,[4,this.runtime.load(new Uint8Array(this.buffer),h,this.enableRiveAssetCDN)]);case 3:return G.file=J.sent(),W=new f.FileFinalizer(this.file),f.finalizationRegistry.register(this,W),this.destroyed?(this.releaseFile(),[2]):(this.file!==null?this.eventManager.fire({type:U.Load,data:this}):this.fireLoadError(k.fileLoadErrorMessage),[2])}})})},k.prototype.init=function(){return v(this,void 0,void 0,function(){var d,h;return y(this,function(S){switch(S.label){case 0:if(!this.src&&!this.buffer)return this.fireLoadError(k.missingErrorMessage),[2];S.label=1;case 1:return S.trys.push([1,4,,5]),d=this,[4,O.awaitInstance()];case 2:return d.runtime=S.sent(),this.destroyed?[2]:[4,this.initData()];case 3:return S.sent(),[3,5];case 4:return h=S.sent(),this.fireLoadError(h instanceof Error?h.message:k.fileLoadErrorMessage),[3,5];case 5:return [2]}})})},k.prototype.fireLoadError=function(d){throw this.eventManager.fire({type:U.LoadError,data:d}),new Error(d)},k.prototype.on=function(d,h){this.eventManager.add({type:d,callback:h});},k.prototype.off=function(d,h){this.eventManager.remove({type:d,callback:h});},k.prototype.cleanup=function(){this.referenceCount-=1,this.referenceCount<=0&&(this.removeAllRiveEventListeners(),this.releaseFile(),this.releaseBindableArtboards(),this.destroyed=true);},k.prototype.removeAllRiveEventListeners=function(d){this.eventManager.removeAll(d);},k.prototype.getInstance=function(){if(this.file!==null)return this.referenceCount+=1,this.file},k.prototype.destroyIfUnused=function(){this.referenceCount<=0&&this.cleanup();},k.prototype.createBindableArtboard=function(d){if(d!=null){var h=new B(d);return (0, f.createFinalization)(h,h.nativeArtboard),this.bindableArtboards.push(h),h}return null},k.prototype.getArtboard=function(d){var h=this.file.artboardByName(d);if(h!=null)return new E(h,this)},k.prototype.getBindableArtboard=function(d){var h=this.file.bindableArtboardByName(d);return this.createBindableArtboard(h)},k.prototype.getDefaultBindableArtboard=function(){var d=this.file.bindableArtboardDefault();return this.createBindableArtboard(d)},k.prototype.internalBindableArtboardFromArtboard=function(d){var h=this.file.internalBindableArtboardFromArtboard(d);return this.createBindableArtboard(h)},k.prototype.viewModelByName=function(d){var h=this.file.viewModelByName(d);return h!==null?new le(h):null},k.missingErrorMessage="Rive source file or data buffer required",k.fileLoadErrorMessage="The file failed to load",k})(),re=(function(){function k(d){var h=this,S,G;this.loaded=false,this.destroyed=false,this._observed=null,this.readyForPlaying=false,this.artboard=null,this.eventCleanup=null,this.shouldDisableRiveListeners=false,this.automaticallyHandleEvents=false,this.dispatchPointerExit=true,this.enableMultiTouch=false,this.enableRiveAssetCDN=true,this._volume=1,this._artboardWidth=void 0,this._artboardHeight=void 0,this._devicePixelRatioUsed=1,this._hasZeroSize=false,this._needsRedraw=false,this._currentCanvasWidth=0,this._currentCanvasHeight=0,this._audioEventListener=null,this._boundDraw=null,this._viewModelInstance=null,this._dataEnums=null,this.drawOptimization=N.DrawOnChanged,this.durations=[],this.frameTimes=[],this.frameCount=0,this.isTouchScrollEnabled=false,this.onCanvasResize=function(W){var J=h._hasZeroSize!==W;h._hasZeroSize=W,W?(!h._layout.maxX||!h._layout.maxY)&&h.resizeToCanvas():J&&h.resizeDrawingSurfaceToCanvas();},this.renderSecondTimer=0,this._boundDraw=this.draw.bind(this),this.canvas=d.canvas,d.canvas.constructor===HTMLCanvasElement&&(this._observed=$.add(this.canvas,this.onCanvasResize)),this._currentCanvasWidth=this.canvas.width,this._currentCanvasHeight=this.canvas.height,this.src=d.src,this.buffer=d.buffer,this.riveFile=d.riveFile,this.layout=(S=d.layout)!==null&&S!==void 0?S:new z,this.shouldDisableRiveListeners=!!d.shouldDisableRiveListeners,this.isTouchScrollEnabled=!!d.isTouchScrollEnabled,this.automaticallyHandleEvents=!!d.automaticallyHandleEvents,this.dispatchPointerExit=d.dispatchPointerExit===false?d.dispatchPointerExit:this.dispatchPointerExit,this.enableMultiTouch=!!d.enableMultiTouch,this.drawOptimization=(G=d.drawingOptions)!==null&&G!==void 0?G:this.drawOptimization,this.enableRiveAssetCDN=d.enableRiveAssetCDN===void 0?true:d.enableRiveAssetCDN,this.eventManager=new Y,d.onLoad&&this.on(U.Load,d.onLoad),d.onLoadError&&this.on(U.LoadError,d.onLoadError),d.onPlay&&this.on(U.Play,d.onPlay),d.onPause&&this.on(U.Pause,d.onPause),d.onStop&&this.on(U.Stop,d.onStop),d.onLoop&&this.on(U.Loop,d.onLoop),d.onStateChange&&this.on(U.StateChange,d.onStateChange),d.onAdvance&&this.on(U.Advance,d.onAdvance),d.onload&&!d.onLoad&&this.on(U.Load,d.onload),d.onloaderror&&!d.onLoadError&&this.on(U.LoadError,d.onloaderror),d.onplay&&!d.onPlay&&this.on(U.Play,d.onplay),d.onpause&&!d.onPause&&this.on(U.Pause,d.onpause),d.onstop&&!d.onStop&&this.on(U.Stop,d.onstop),d.onloop&&!d.onLoop&&this.on(U.Loop,d.onloop),d.onstatechange&&!d.onStateChange&&this.on(U.StateChange,d.onstatechange),d.assetLoader&&(this.assetLoader=d.assetLoader),this.taskQueue=new ie(this.eventManager),this.init({src:this.src,buffer:this.buffer,riveFile:this.riveFile,autoplay:d.autoplay,autoBind:d.autoBind,animations:d.animations,stateMachines:d.stateMachines,artboard:d.artboard,useOffscreenRenderer:d.useOffscreenRenderer});}return Object.defineProperty(k.prototype,"viewModelCount",{get:function(){return this.file.viewModelCount()},enumerable:false,configurable:true}),k.new=function(d){return console.warn("This function is deprecated: please use `new Rive({})` instead"),new k(d)},k.prototype.onSystemAudioChanged=function(){this.volume=this._volume;},k.prototype.init=function(d){var h=this,S=d.src,G=d.buffer,W=d.riveFile,J=d.animations,de=d.stateMachines,ye=d.artboard,ge=d.autoplay,we=ge===void 0?false:ge,Je=d.useOffscreenRenderer,it=Je===void 0?false:Je,Ve=d.autoBind,_t=Ve===void 0?false:Ve;if(!this.destroyed){if(this.src=S,this.buffer=G,this.riveFile=W,!this.src&&!this.buffer&&!this.riveFile)throw new A(k.missingErrorMessage);var mt=ut(J),qt=ut(de);this.loaded=false,this.readyForPlaying=false,O.awaitInstance().then(function(Xt){h.destroyed||(h.runtime=Xt,h.removeRiveListeners(),h.deleteRiveRenderer(),h.renderer=h.runtime.makeRenderer(h.canvas,it),h.canvas.width||h.canvas.height||h.resizeDrawingSurfaceToCanvas(),h.initData(ye,mt,qt,we,_t).then(function(nn){if(nn)return h.setupRiveListeners()}).catch(function(nn){console.error(nn);}));}).catch(function(Xt){console.error(Xt);});}},k.prototype.setupRiveListeners=function(d){var h=this;if(this.eventCleanup&&this.eventCleanup(),!this.shouldDisableRiveListeners){var S=(this.animator.stateMachines||[]).filter(function(de){return de.playing&&h.runtime.hasListeners(de.instance)}).map(function(de){return de.instance}),G=this.isTouchScrollEnabled,W=this.dispatchPointerExit,J=this.enableMultiTouch;d&&"isTouchScrollEnabled"in d&&(G=d.isTouchScrollEnabled),this.eventCleanup=(0, f.registerTouchInteractions)({canvas:this.canvas,artboard:this.artboard,stateMachines:S,renderer:this.renderer,rive:this.runtime,fit:this._layout.runtimeFit(this.runtime),alignment:this._layout.runtimeAlignment(this.runtime),isTouchScrollEnabled:G,dispatchPointerExit:W,enableMultiTouch:J,layoutScaleFactor:this._layout.layoutScaleFactor});}},k.prototype.removeRiveListeners=function(){this.eventCleanup&&(this.eventCleanup(),this.eventCleanup=null);},k.prototype.initializeAudio=function(){var d=this,h;ne.status==se.UNAVAILABLE&&!((h=this.artboard)===null||h===void 0)&&h.hasAudio&&this._audioEventListener===null&&(this._audioEventListener={type:U.AudioStatusChange,callback:function(){return d.onSystemAudioChanged()}},ne.add(this._audioEventListener),ne.establishAudio());},k.prototype.initArtboardSize=function(){this.artboard&&(this._artboardWidth=this.artboard.width=this._artboardWidth||this.artboard.width,this._artboardHeight=this.artboard.height=this._artboardHeight||this.artboard.height);},k.prototype.initData=function(d,h,S,G,W){return v(this,void 0,void 0,function(){var J,de,ye,ge;return y(this,function(we){switch(we.label){case 0:return we.trys.push([0,3,,4]),this.riveFile!=null?[3,2]:(J=new Q({src:this.src,buffer:this.buffer,enableRiveAssetCDN:this.enableRiveAssetCDN,assetLoader:this.assetLoader}),this.riveFile=J,[4,J.init()]);case 1:if(we.sent(),this.destroyed)return J.destroyIfUnused(),[2,false];we.label=2;case 2:return this.file=this.riveFile.getInstance(),this.initArtboard(d,h,S,G,W),this.initArtboardSize(),this.initializeAudio(),this.loaded=true,this.eventManager.fire({type:U.Load,data:(ge=this.src)!==null&&ge!==void 0?ge:"buffer"}),this.animator.advanceIfPaused(),this.readyForPlaying=true,this.taskQueue.process(),this.drawFrame(),[2,true];case 3:return de=we.sent(),ye=P(de),console.warn(ye),this.eventManager.fire({type:U.LoadError,data:ye}),[2,Promise.reject(ye)];case 4:return [2]}})})},k.prototype.initArtboard=function(d,h,S,G,W){if(this.file){var J=d?this.file.artboardByName(d):this.file.defaultArtboard();if(!J){var de="Invalid artboard name or no default artboard";console.warn(de),this.eventManager.fire({type:U.LoadError,data:de});return}this.artboard=J,J.volume=this._volume*ne.systemVolume,this.animator=new V(this.runtime,this.artboard,this.eventManager);var ye;if(h.length>0||S.length>0?(ye=h.concat(S),this.animator.initLinearAnimations(h,G),this.animator.initStateMachines(S,G)):ye=[this.animator.atLeastOne(G,false)],this.taskQueue.add({event:{type:G?U.Play:U.Pause,data:ye}}),W){var ge=this.file.defaultArtboardViewModel(J);if(ge!==null){var we=ge.defaultInstance();if(we!==null){var Je=new $e(we,null);(0, f.createFinalization)(Je,Je.runtimeInstance),this.bindViewModelInstance(Je);}}}}},k.prototype.drawFrame=function(){var d,h;!((d=document?.timeline)===null||d===void 0)&&d.currentTime?this.loaded&&this.artboard&&!this.frameRequestId&&(this._boundDraw(document.timeline.currentTime),(h=this.runtime)===null||h===void 0||h.resolveAnimationFrame()):this.scheduleRendering();},k.prototype._canvasSizeChanged=function(){var d=false;return this.canvas&&(this.canvas.width!==this._currentCanvasWidth&&(this._currentCanvasWidth=this.canvas.width,d=true),this.canvas.height!==this._currentCanvasHeight&&(this._currentCanvasHeight=this.canvas.height,d=true)),d},k.prototype.draw=function(d,h){var S;this.frameRequestId=null;var G=performance.now();this.lastRenderTime||(this.lastRenderTime=d),this.renderSecondTimer+=d-this.lastRenderTime,this.renderSecondTimer>5e3&&(this.renderSecondTimer=0,h?.());var W=(d-this.lastRenderTime)/1e3;this.lastRenderTime=d;for(var J=this.animator.animations.filter(function(on){return on.playing||on.needsScrub}).sort(function(on){return on.needsScrub?-1:1}),de=0,ye=J;de<ye.length;de++){var ge=ye[de];ge.advance(W),ge.instance.didLoop&&(ge.loopCount+=1),ge.apply(1);}for(var we=this.animator.stateMachines.filter(function(on){return on.playing}),Je=0,it=we;Je<it.length;Je++){var Ve=it[Je],_t=Ve.reportedEventCount();if(_t)for(var mt=0;mt<_t;mt++){var qt=Ve.reportedEventAt(mt);if(qt)if(qt.type===L.OpenUrl){if(this.eventManager.fire({type:U.RiveEvent,data:qt}),this.automaticallyHandleEvents){var Xt=document.createElement("a"),nn=qt,Bn=nn.url,Fe=nn.target,zn=(0, f.sanitizeUrl)(Bn);Bn&&Xt.setAttribute("href",zn),Fe&&Xt.setAttribute("target",Fe),zn&&zn!==f.BLANK_URL&&Xt.click();}}else this.eventManager.fire({type:U.RiveEvent,data:qt});}Ve.advanceAndApply(W);}this.animator.stateMachines.length==0&&this.artboard.advance(W);var rn=this.renderer;this._hasZeroSize||(this.drawOptimization==N.AlwaysDraw||this.artboard.didChange()||this._needsRedraw||this._canvasSizeChanged())&&(rn.clear(),rn.save(),this.alignRenderer(),this.artboard.draw(rn),rn.restore(),rn.flush(),this._needsRedraw=false),this.animator.handleLooping(),this.animator.handleStateChanges(),this.animator.handleAdvancing(W),this.frameCount++;var Ke=performance.now();for(this.frameTimes.push(Ke),this.durations.push(Ke-G);this.frameTimes[0]<=Ke-1e3;)this.frameTimes.shift(),this.durations.shift();(S=this._viewModelInstance)===null||S===void 0||S.handleCallbacks(),this.animator.isPlaying?this.scheduleRendering():this.animator.isPaused?this.lastRenderTime=0:this.animator.isStopped&&(this.lastRenderTime=0);},k.prototype.alignRenderer=function(){var d=this,h=d.renderer,S=d.runtime,G=d._layout,W=d.artboard;h.align(G.runtimeFit(S),G.runtimeAlignment(S),{minX:G.minX,minY:G.minY,maxX:G.maxX,maxY:G.maxY},W.bounds,this._devicePixelRatioUsed*G.layoutScaleFactor);},Object.defineProperty(k.prototype,"fps",{get:function(){return this.durations.length},enumerable:false,configurable:true}),Object.defineProperty(k.prototype,"frameTime",{get:function(){return this.durations.length===0?0:(this.durations.reduce(function(d,h){return d+h},0)/this.durations.length).toFixed(4)},enumerable:false,configurable:true}),k.prototype.cleanup=function(){var d,h;this.destroyed=true,this.stopRendering(),this.cleanupInstances(),this._observed!==null&&$.remove(this._observed),this.removeRiveListeners(),this.file&&((d=this.riveFile)===null||d===void 0||d.cleanup(),this.file=null),this.riveFile=null,this.deleteRiveRenderer(),this._audioEventListener!==null&&(ne.remove(this._audioEventListener),this._audioEventListener=null),(h=this._viewModelInstance)===null||h===void 0||h.cleanup(),this._viewModelInstance=null,this._dataEnums=null;},k.prototype.deleteRiveRenderer=function(){var d;(d=this.renderer)===null||d===void 0||d.delete(),this.renderer=null;},k.prototype.cleanupInstances=function(){this.eventCleanup!==null&&this.eventCleanup(),this.stop(),this.artboard&&(this.artboard.delete(),this.artboard=null);},k.prototype.retrieveTextRun=function(d){var h;if(!d){console.warn("No text run name provided");return}if(!this.artboard){console.warn("Tried to access text run, but the Artboard is null");return}var S=this.artboard.textRun(d);if(!S){console.warn("Could not access a text run with name '".concat(d,"' in the '").concat((h=this.artboard)===null||h===void 0?void 0:h.name,"' Artboard. Note that you must rename a text run node in the Rive editor to make it queryable at runtime."));return}return S},k.prototype.getTextRunValue=function(d){var h=this.retrieveTextRun(d);return h?h.text:void 0},k.prototype.setTextRunValue=function(d,h){var S=this.retrieveTextRun(d);S&&(S.text=h);},k.prototype.play=function(d,h){var S=this;if(d=ut(d),!this.readyForPlaying){this.taskQueue.add({action:function(){return S.play(d,h)}});return}this.animator.play(d),this.eventCleanup&&this.eventCleanup(),this.setupRiveListeners(),this.startRendering();},k.prototype.pause=function(d){var h=this;if(d=ut(d),!this.readyForPlaying){this.taskQueue.add({action:function(){return h.pause(d)}});return}this.eventCleanup&&this.eventCleanup(),this.animator.pause(d);},k.prototype.scrub=function(d,h){var S=this;if(d=ut(d),!this.readyForPlaying){this.taskQueue.add({action:function(){return S.scrub(d,h)}});return}this.animator.scrub(d,h||0),this.drawFrame();},k.prototype.stop=function(d){var h=this;if(d=ut(d),!this.readyForPlaying){this.taskQueue.add({action:function(){return h.stop(d)}});return}this.animator&&this.animator.stop(d),this.eventCleanup&&this.eventCleanup();},k.prototype.reset=function(d){var h,S,G=d?.artboard,W=ut(d?.animations),J=ut(d?.stateMachines),de=(h=d?.autoplay)!==null&&h!==void 0?h:false,ye=(S=d?.autoBind)!==null&&S!==void 0?S:false;this.cleanupInstances(),this.initArtboard(G,W,J,de,ye),this.taskQueue.process();},k.prototype.load=function(d){this.file=null,this.stop(),this.init(d);},Object.defineProperty(k.prototype,"layout",{get:function(){return this._layout},set:function(d){this._layout=d,(!d.maxX||!d.maxY)&&this.resizeToCanvas(),this.loaded&&!this.animator.isPlaying&&this.drawFrame();},enumerable:false,configurable:true}),k.prototype.resizeToCanvas=function(){this._layout=this.layout.copyWith({minX:0,minY:0,maxX:this.canvas.width,maxY:this.canvas.height});},k.prototype.resizeDrawingSurfaceToCanvas=function(d){if(this.canvas instanceof HTMLCanvasElement&&window){var h=this.canvas.getBoundingClientRect(),S=h.width,G=h.height,W=d||window.devicePixelRatio||1;if(this.devicePixelRatioUsed=W,this.canvas.width=W*S,this.canvas.height=W*G,this._needsRedraw=true,this.resizeToCanvas(),this.drawFrame(),this.layout.fit===I.Layout){var J=this._layout.layoutScaleFactor;this.artboard.width=S/J,this.artboard.height=G/J;}}},Object.defineProperty(k.prototype,"source",{get:function(){return this.src},enumerable:false,configurable:true}),Object.defineProperty(k.prototype,"activeArtboard",{get:function(){return this.artboard?this.artboard.name:""},enumerable:false,configurable:true}),Object.defineProperty(k.prototype,"animationNames",{get:function(){if(!this.loaded||!this.artboard)return [];for(var d=[],h=0;h<this.artboard.animationCount();h++)d.push(this.artboard.animationByIndex(h).name);return d},enumerable:false,configurable:true}),Object.defineProperty(k.prototype,"stateMachineNames",{get:function(){if(!this.loaded||!this.artboard)return [];for(var d=[],h=0;h<this.artboard.stateMachineCount();h++)d.push(this.artboard.stateMachineByIndex(h).name);return d},enumerable:false,configurable:true}),k.prototype.stateMachineInputs=function(d){if(this.loaded){var h=this.animator.stateMachines.find(function(S){return S.name===d});return h?.inputs}},k.prototype.retrieveInputAtPath=function(d,h){if(!d){console.warn("No input name provided for path '".concat(h,"'"));return}if(!this.artboard){console.warn("Tried to access input: '".concat(d,"', at path: '").concat(h,"', but the Artboard is null"));return}var S=this.artboard.inputByPath(d,h);if(!S){console.warn("Could not access an input with name: '".concat(d,"', at path:'").concat(h,"'"));return}return S},k.prototype.setBooleanStateAtPath=function(d,h,S){var G=this.retrieveInputAtPath(d,S);G&&(G.type===M.Boolean?G.asBool().value=h:console.warn("Input with name: '".concat(d,"', at path:'").concat(S,"' is not a boolean")));},k.prototype.setNumberStateAtPath=function(d,h,S){var G=this.retrieveInputAtPath(d,S);G&&(G.type===M.Number?G.asNumber().value=h:console.warn("Input with name: '".concat(d,"', at path:'").concat(S,"' is not a number")));},k.prototype.fireStateAtPath=function(d,h){var S=this.retrieveInputAtPath(d,h);S&&(S.type===M.Trigger?S.asTrigger().fire():console.warn("Input with name: '".concat(d,"', at path:'").concat(h,"' is not a trigger")));},k.prototype.retrieveTextAtPath=function(d,h){if(!d){console.warn("No text name provided for path '".concat(h,"'"));return}if(!h){console.warn("No path provided for text '".concat(d,"'"));return}if(!this.artboard){console.warn("Tried to access text: '".concat(d,"', at path: '").concat(h,"', but the Artboard is null"));return}var S=this.artboard.textByPath(d,h);if(!S){console.warn("Could not access text with name: '".concat(d,"', at path:'").concat(h,"'"));return}return S},k.prototype.getTextRunValueAtPath=function(d,h){var S=this.retrieveTextAtPath(d,h);if(!S){console.warn("Could not get text with name: '".concat(d,"', at path:'").concat(h,"'"));return}return S.text},k.prototype.setTextRunValueAtPath=function(d,h,S){var G=this.retrieveTextAtPath(d,S);if(!G){console.warn("Could not set text with name: '".concat(d,"', at path:'").concat(S,"'"));return}G.text=h;},Object.defineProperty(k.prototype,"playingStateMachineNames",{get:function(){return this.loaded?this.animator.stateMachines.filter(function(d){return d.playing}).map(function(d){return d.name}):[]},enumerable:false,configurable:true}),Object.defineProperty(k.prototype,"playingAnimationNames",{get:function(){return this.loaded?this.animator.animations.filter(function(d){return d.playing}).map(function(d){return d.name}):[]},enumerable:false,configurable:true}),Object.defineProperty(k.prototype,"pausedAnimationNames",{get:function(){return this.loaded?this.animator.animations.filter(function(d){return !d.playing}).map(function(d){return d.name}):[]},enumerable:false,configurable:true}),Object.defineProperty(k.prototype,"pausedStateMachineNames",{get:function(){return this.loaded?this.animator.stateMachines.filter(function(d){return !d.playing}).map(function(d){return d.name}):[]},enumerable:false,configurable:true}),Object.defineProperty(k.prototype,"isPlaying",{get:function(){return this.animator.isPlaying},enumerable:false,configurable:true}),Object.defineProperty(k.prototype,"isPaused",{get:function(){return this.animator.isPaused},enumerable:false,configurable:true}),Object.defineProperty(k.prototype,"isStopped",{get:function(){var d,h;return (h=(d=this.animator)===null||d===void 0?void 0:d.isStopped)!==null&&h!==void 0?h:true},enumerable:false,configurable:true}),Object.defineProperty(k.prototype,"bounds",{get:function(){return this.artboard?this.artboard.bounds:void 0},enumerable:false,configurable:true}),k.prototype.on=function(d,h){this.eventManager.add({type:d,callback:h});},k.prototype.off=function(d,h){this.eventManager.remove({type:d,callback:h});},k.prototype.unsubscribe=function(d,h){console.warn("This function is deprecated: please use `off()` instead."),this.off(d,h);},k.prototype.removeAllRiveEventListeners=function(d){this.eventManager.removeAll(d);},k.prototype.unsubscribeAll=function(d){console.warn("This function is deprecated: please use `removeAllRiveEventListeners()` instead."),this.removeAllRiveEventListeners(d);},k.prototype.stopRendering=function(){this.loaded&&this.frameRequestId&&(this.runtime.cancelAnimationFrame?this.runtime.cancelAnimationFrame(this.frameRequestId):cancelAnimationFrame(this.frameRequestId),this.frameRequestId=null);},k.prototype.startRendering=function(){this.drawFrame();},k.prototype.scheduleRendering=function(){this.loaded&&this.artboard&&!this.frameRequestId&&(this.runtime.requestAnimationFrame?this.frameRequestId=this.runtime.requestAnimationFrame(this._boundDraw):this.frameRequestId=requestAnimationFrame(this._boundDraw));},k.prototype.enableFPSCounter=function(d){this.runtime.enableFPSCounter(d);},k.prototype.disableFPSCounter=function(){this.runtime.disableFPSCounter();},Object.defineProperty(k.prototype,"contents",{get:function(){if(this.loaded){for(var d={artboards:[]},h=0;h<this.file.artboardCount();h++){for(var S=this.file.artboardByIndex(h),G={name:S.name,animations:[],stateMachines:[]},W=0;W<S.animationCount();W++){var J=S.animationByIndex(W);G.animations.push(J.name);}for(var de=0;de<S.stateMachineCount();de++){for(var ye=S.stateMachineByIndex(de),ge=ye.name,we=new this.runtime.StateMachineInstance(ye,S),Je=[],it=0;it<we.inputCount();it++){var Ve=we.input(it);Je.push({name:Ve.name,type:Ve.type});}G.stateMachines.push({name:ge,inputs:Je});}d.artboards.push(G);}return d}},enumerable:false,configurable:true}),Object.defineProperty(k.prototype,"volume",{get:function(){return this.artboard&&this.artboard.volume!==this._volume&&(this._volume=this.artboard.volume),this._volume},set:function(d){this._volume=d,this.artboard&&(this.artboard.volume=d*ne.systemVolume);},enumerable:false,configurable:true}),Object.defineProperty(k.prototype,"artboardWidth",{get:function(){var d;return this.artboard?this.artboard.width:(d=this._artboardWidth)!==null&&d!==void 0?d:0},set:function(d){this._artboardWidth=d,this.artboard&&(this.artboard.width=d);},enumerable:false,configurable:true}),Object.defineProperty(k.prototype,"artboardHeight",{get:function(){var d;return this.artboard?this.artboard.height:(d=this._artboardHeight)!==null&&d!==void 0?d:0},set:function(d){this._artboardHeight=d,this.artboard&&(this.artboard.height=d);},enumerable:false,configurable:true}),k.prototype.resetArtboardSize=function(){this.artboard?(this.artboard.resetArtboardSize(),this._artboardWidth=this.artboard.width,this._artboardHeight=this.artboard.height):(this._artboardWidth=void 0,this._artboardHeight=void 0);},Object.defineProperty(k.prototype,"devicePixelRatioUsed",{get:function(){return this._devicePixelRatioUsed},set:function(d){this._devicePixelRatioUsed=d;},enumerable:false,configurable:true}),k.prototype.bindViewModelInstance=function(d){var h;this.artboard&&!this.destroyed&&d&&d.runtimeInstance&&(d.internalIncrementReferenceCount(),(h=this._viewModelInstance)===null||h===void 0||h.cleanup(),this._viewModelInstance=d,this.animator.stateMachines.length>0?this.animator.stateMachines.forEach(function(S){return S.bindViewModelInstance(d)}):this.artboard.bindViewModelInstance(d.runtimeInstance));},Object.defineProperty(k.prototype,"viewModelInstance",{get:function(){return this._viewModelInstance},enumerable:false,configurable:true}),k.prototype.viewModelByIndex=function(d){var h=this.file.viewModelByIndex(d);return h!==null?new le(h):null},k.prototype.viewModelByName=function(d){var h;return (h=this.riveFile)===null||h===void 0?void 0:h.viewModelByName(d)},k.prototype.enums=function(){if(this._dataEnums===null){var d=this.file.enums();this._dataEnums=d.map(function(h){return new ve(h)});}return this._dataEnums},k.prototype.defaultViewModel=function(){if(this.artboard){var d=this.file.defaultArtboardViewModel(this.artboard);if(d)return new le(d)}return null},k.prototype.getArtboard=function(d){var h,S;return (S=(h=this.riveFile)===null||h===void 0?void 0:h.getArtboard(d))!==null&&S!==void 0?S:null},k.prototype.getBindableArtboard=function(d){var h,S;return (S=(h=this.riveFile)===null||h===void 0?void 0:h.getBindableArtboard(d))!==null&&S!==void 0?S:null},k.prototype.getDefaultBindableArtboard=function(){var d,h;return (h=(d=this.riveFile)===null||d===void 0?void 0:d.getDefaultBindableArtboard())!==null&&h!==void 0?h:null},k.missingErrorMessage="Rive source file or data buffer required",k.cleanupErrorMessage="Attempt to use file after calling cleanup.",k})(),le=(function(){function k(d){this._viewModel=d;}return Object.defineProperty(k.prototype,"instanceCount",{get:function(){return this._viewModel.instanceCount},enumerable:false,configurable:true}),Object.defineProperty(k.prototype,"name",{get:function(){return this._viewModel.name},enumerable:false,configurable:true}),k.prototype.instanceByIndex=function(d){var h=this._viewModel.instanceByIndex(d);if(h!==null){var S=new $e(h,null);return (0, f.createFinalization)(S,h),S}return null},k.prototype.instanceByName=function(d){var h=this._viewModel.instanceByName(d);if(h!==null){var S=new $e(h,null);return (0, f.createFinalization)(S,h),S}return null},k.prototype.defaultInstance=function(){var d=this._viewModel.defaultInstance();if(d!==null){var h=new $e(d,null);return (0, f.createFinalization)(h,d),h}return null},k.prototype.instance=function(){var d=this._viewModel.instance();if(d!==null){var h=new $e(d,null);return (0, f.createFinalization)(h,d),h}return null},Object.defineProperty(k.prototype,"properties",{get:function(){return this._viewModel.getProperties()},enumerable:false,configurable:true}),Object.defineProperty(k.prototype,"instanceNames",{get:function(){return this._viewModel.getInstanceNames()},enumerable:false,configurable:true}),k})(),ve=(function(){function k(d){this._dataEnum=d;}return Object.defineProperty(k.prototype,"name",{get:function(){return this._dataEnum.name},enumerable:false,configurable:true}),Object.defineProperty(k.prototype,"values",{get:function(){return this._dataEnum.values},enumerable:false,configurable:true}),k})(),_e;(function(k){k.Number="number",k.String="string",k.Boolean="boolean",k.Color="color",k.Trigger="trigger",k.Enum="enum",k.List="list",k.Image="image",k.Artboard="artboard";})(_e||(_e={}));var $e=(function(){function k(d,h){this._parents=[],this._children=[],this._viewModelInstances=new Map,this._propertiesWithCallbacks=[],this._referenceCount=0,this.selfUnref=false,this._runtimeInstance=d,h!==null&&this._parents.push(h);}return Object.defineProperty(k.prototype,"runtimeInstance",{get:function(){return this._runtimeInstance},enumerable:false,configurable:true}),Object.defineProperty(k.prototype,"nativeInstance",{get:function(){return this._runtimeInstance},enumerable:false,configurable:true}),k.prototype.handleCallbacks=function(){this._propertiesWithCallbacks.length!==0&&(this._propertiesWithCallbacks.forEach(function(d){d.handleCallbacks();}),this._propertiesWithCallbacks.forEach(function(d){d.clearChanges();})),this._children.forEach(function(d){return d.handleCallbacks()});},k.prototype.addParent=function(d){this._parents.includes(d)||(this._parents.push(d),(this._propertiesWithCallbacks.length>0||this._children.length>0)&&d.addToViewModelCallbacks(this));},k.prototype.removeParent=function(d){var h=this._parents.indexOf(d);if(h!==-1){var S=this._parents[h];S.removeFromViewModelCallbacks(this),this._parents.splice(h,1);}},k.prototype.addToPropertyCallbacks=function(d){var h=this;this._propertiesWithCallbacks.includes(d)||(this._propertiesWithCallbacks.push(d),this._propertiesWithCallbacks.length>0&&this._parents.forEach(function(S){S.addToViewModelCallbacks(h);}));},k.prototype.removeFromPropertyCallbacks=function(d){var h=this;this._propertiesWithCallbacks.includes(d)&&(this._propertiesWithCallbacks=this._propertiesWithCallbacks.filter(function(S){return S!==d}),this._children.length===0&&this._propertiesWithCallbacks.length===0&&this._parents.forEach(function(S){S.removeFromViewModelCallbacks(h);}));},k.prototype.addToViewModelCallbacks=function(d){var h=this;this._children.includes(d)||(this._children.push(d),this._parents.forEach(function(S){S.addToViewModelCallbacks(h);}));},k.prototype.removeFromViewModelCallbacks=function(d){var h=this;this._children.includes(d)&&(this._children=this._children.filter(function(S){return S!==d}),this._children.length===0&&this._propertiesWithCallbacks.length===0&&this._parents.forEach(function(S){S.removeFromViewModelCallbacks(h);}));},k.prototype.clearCallbacks=function(){this._propertiesWithCallbacks.forEach(function(d){d.clearCallbacks();});},k.prototype.propertyFromPath=function(d,h){var S=d.split("/");return this.propertyFromPathSegments(S,0,h)},k.prototype.viewModelFromPathSegments=function(d,h){var S=this.internalViewModelInstance(d[h]);return S!==null?h==d.length-1?S:S.viewModelFromPathSegments(d,h++):null},k.prototype.propertyFromPathSegments=function(d,h,S){var G,W,J,de,ye,ge,we,Je,it,Ve,_t,mt,qt,Xt,nn,Bn,Fe,zn;if(h<d.length-1){var rn=this.internalViewModelInstance(d[h]);return rn!==null?rn.propertyFromPathSegments(d,h+1,S):null}var Ke=null;switch(S){case _e.Number:if(Ke=(W=(G=this._runtimeInstance)===null||G===void 0?void 0:G.number(d[h]))!==null&&W!==void 0?W:null,Ke!==null)return new ct(Ke,this);break;case _e.String:if(Ke=(de=(J=this._runtimeInstance)===null||J===void 0?void 0:J.string(d[h]))!==null&&de!==void 0?de:null,Ke!==null)return new Bt(Ke,this);break;case _e.Boolean:if(Ke=(ge=(ye=this._runtimeInstance)===null||ye===void 0?void 0:ye.boolean(d[h]))!==null&&ge!==void 0?ge:null,Ke!==null)return new Et(Ke,this);break;case _e.Color:if(Ke=(Je=(we=this._runtimeInstance)===null||we===void 0?void 0:we.color(d[h]))!==null&&Je!==void 0?Je:null,Ke!==null)return new tt(Ke,this);break;case _e.Trigger:if(Ke=(Ve=(it=this._runtimeInstance)===null||it===void 0?void 0:it.trigger(d[h]))!==null&&Ve!==void 0?Ve:null,Ke!==null)return new Wt(Ke,this);break;case _e.Enum:if(Ke=(mt=(_t=this._runtimeInstance)===null||_t===void 0?void 0:_t.enum(d[h]))!==null&&mt!==void 0?mt:null,Ke!==null)return new Lt(Ke,this);break;case _e.List:if(Ke=(Xt=(qt=this._runtimeInstance)===null||qt===void 0?void 0:qt.list(d[h]))!==null&&Xt!==void 0?Xt:null,Ke!==null)return new Ht(Ke,this);break;case _e.Image:if(Ke=(Bn=(nn=this._runtimeInstance)===null||nn===void 0?void 0:nn.image(d[h]))!==null&&Bn!==void 0?Bn:null,Ke!==null)return new Ne(Ke,this);break;case _e.Artboard:if(Ke=(zn=(Fe=this._runtimeInstance)===null||Fe===void 0?void 0:Fe.artboard(d[h]))!==null&&zn!==void 0?zn:null,Ke!==null)return new mn(Ke,this);break}return null},k.prototype.internalViewModelInstance=function(d){var h;if(this._viewModelInstances.has(d))return this._viewModelInstances.get(d);var S=(h=this._runtimeInstance)===null||h===void 0?void 0:h.viewModel(d);if(S!==null){var G=new k(S,this);return (0, f.createFinalization)(G,S),G.internalIncrementReferenceCount(),this._viewModelInstances.set(d,G),G}return null},k.prototype.number=function(d){var h=this.propertyFromPath(d,_e.Number);return h},k.prototype.string=function(d){var h=this.propertyFromPath(d,_e.String);return h},k.prototype.boolean=function(d){var h=this.propertyFromPath(d,_e.Boolean);return h},k.prototype.color=function(d){var h=this.propertyFromPath(d,_e.Color);return h},k.prototype.trigger=function(d){var h=this.propertyFromPath(d,_e.Trigger);return h},k.prototype.enum=function(d){var h=this.propertyFromPath(d,_e.Enum);return h},k.prototype.list=function(d){var h=this.propertyFromPath(d,_e.List);return h},k.prototype.image=function(d){var h=this.propertyFromPath(d,_e.Image);return h},k.prototype.artboard=function(d){var h=this.propertyFromPath(d,_e.Artboard);return h},k.prototype.viewModel=function(d){var h=d.split("/"),S=h.length>1?this.viewModelFromPathSegments(h.slice(0,h.length-1),0):this;return S!=null?S.internalViewModelInstance(h[h.length-1]):null},k.prototype.internalReplaceViewModel=function(d,h){var S;if(h.runtimeInstance!==null){var G=((S=this._runtimeInstance)===null||S===void 0?void 0:S.replaceViewModel(d,h.runtimeInstance))||false;if(G){h.internalIncrementReferenceCount();var W=this.internalViewModelInstance(d);W!==null&&(W.removeParent(this),this._children.includes(W)&&(this._children=this._children.filter(function(J){return J!==W})),W.cleanup()),this._viewModelInstances.set(d,h),h.addParent(this);}return G}return  false},k.prototype.replaceViewModel=function(d,h){var S,G=d.split("/"),W=G.length>1?this.viewModelFromPathSegments(G.slice(0,G.length-1),0):this;return (S=W?.internalReplaceViewModel(G[G.length-1],h))!==null&&S!==void 0?S:false},k.prototype.incrementReferenceCount=function(){var d;this._referenceCount++,(d=this._runtimeInstance)===null||d===void 0||d.incrementReferenceCount();},k.prototype.decrementReferenceCount=function(){var d;this._referenceCount--,(d=this._runtimeInstance)===null||d===void 0||d.decrementReferenceCount();},Object.defineProperty(k.prototype,"properties",{get:function(){var d;return ((d=this._runtimeInstance)===null||d===void 0?void 0:d.getProperties().map(function(h){return m({},h)}))||[]},enumerable:false,configurable:true}),k.prototype.internalIncrementReferenceCount=function(){this._referenceCount++;},k.prototype.cleanup=function(){var d=this,h;if(this._referenceCount--,this._referenceCount<=0){this.selfUnref&&((h=this._runtimeInstance)===null||h===void 0||h.unref()),this._runtimeInstance=null,this.clearCallbacks(),this._propertiesWithCallbacks=[],this._viewModelInstances.forEach(function(W){W.cleanup();}),this._viewModelInstances.clear();var S=b([],this._children);this._children.length=0;var G=b([],this._parents);this._parents.length=0,S.forEach(function(W){W.removeParent(d);}),G.forEach(function(W){W.removeFromViewModelCallbacks(d);});}},k})(),vt=(function(){function k(d,h){this.callbacks=[],this._viewModelInstanceValue=d,this._parentViewModel=h;}return k.prototype.on=function(d){this.callbacks.length===0&&this._viewModelInstanceValue.clearChanges(),this.callbacks.includes(d)||(this.callbacks.push(d),this._parentViewModel.addToPropertyCallbacks(this));},k.prototype.off=function(d){d?this.callbacks=this.callbacks.filter(function(h){return h!==d}):this.callbacks.length=0,this.callbacks.length===0&&this._parentViewModel.removeFromPropertyCallbacks(this);},k.prototype.internalHandleCallback=function(d){},k.prototype.handleCallbacks=function(){var d=this;this._viewModelInstanceValue.hasChanged&&this.callbacks.forEach(function(h){d.internalHandleCallback(h);});},k.prototype.clearChanges=function(){this._viewModelInstanceValue.clearChanges();},k.prototype.clearCallbacks=function(){this.callbacks.length=0;},Object.defineProperty(k.prototype,"name",{get:function(){return this._viewModelInstanceValue.name},enumerable:false,configurable:true}),k})(),Bt=(function(k){p(d,k);function d(h,S){return k.call(this,h,S)||this}return Object.defineProperty(d.prototype,"value",{get:function(){return this._viewModelInstanceValue.value},set:function(h){this._viewModelInstanceValue.value=h;},enumerable:false,configurable:true}),d.prototype.internalHandleCallback=function(h){h(this.value);},d})(vt),ct=(function(k){p(d,k);function d(h,S){return k.call(this,h,S)||this}return Object.defineProperty(d.prototype,"value",{get:function(){return this._viewModelInstanceValue.value},set:function(h){this._viewModelInstanceValue.value=h;},enumerable:false,configurable:true}),d.prototype.internalHandleCallback=function(h){h(this.value);},d})(vt),Et=(function(k){p(d,k);function d(h,S){return k.call(this,h,S)||this}return Object.defineProperty(d.prototype,"value",{get:function(){return this._viewModelInstanceValue.value},set:function(h){this._viewModelInstanceValue.value=h;},enumerable:false,configurable:true}),d.prototype.internalHandleCallback=function(h){h(this.value);},d})(vt),Wt=(function(k){p(d,k);function d(h,S){return k.call(this,h,S)||this}return d.prototype.trigger=function(){return this._viewModelInstanceValue.trigger()},d.prototype.internalHandleCallback=function(h){h();},d})(vt),Lt=(function(k){p(d,k);function d(h,S){return k.call(this,h,S)||this}return Object.defineProperty(d.prototype,"value",{get:function(){return this._viewModelInstanceValue.value},set:function(h){this._viewModelInstanceValue.value=h;},enumerable:false,configurable:true}),Object.defineProperty(d.prototype,"valueIndex",{get:function(){return this._viewModelInstanceValue.valueIndex},set:function(h){this._viewModelInstanceValue.valueIndex=h;},enumerable:false,configurable:true}),Object.defineProperty(d.prototype,"values",{get:function(){return this._viewModelInstanceValue.values},enumerable:false,configurable:true}),d.prototype.internalHandleCallback=function(h){h(this.value);},d})(vt),Ht=(function(k){p(d,k);function d(h,S){return k.call(this,h,S)||this}return Object.defineProperty(d.prototype,"length",{get:function(){return this._viewModelInstanceValue.size},enumerable:false,configurable:true}),d.prototype.addInstance=function(h){h.runtimeInstance!=null&&(this._viewModelInstanceValue.addInstance(h.runtimeInstance),h.addParent(this._parentViewModel));},d.prototype.addInstanceAt=function(h,S){return h.runtimeInstance!=null&&this._viewModelInstanceValue.addInstanceAt(h.runtimeInstance,S)?(h.addParent(this._parentViewModel),true):false},d.prototype.removeInstance=function(h){h.runtimeInstance!=null&&(this._viewModelInstanceValue.removeInstance(h.runtimeInstance),h.removeParent(this._parentViewModel));},d.prototype.removeInstanceAt=function(h){this._viewModelInstanceValue.removeInstanceAt(h);},d.prototype.instanceAt=function(h){var S=this._viewModelInstanceValue.instanceAt(h);if(S!=null){var G=new $e(S,this._parentViewModel);return (0, f.createFinalization)(G,S),G}return null},d.prototype.swap=function(h,S){this._viewModelInstanceValue.swap(h,S);},d.prototype.internalHandleCallback=function(h){h();},d})(vt),tt=(function(k){p(d,k);function d(h,S){return k.call(this,h,S)||this}return Object.defineProperty(d.prototype,"value",{get:function(){return this._viewModelInstanceValue.value},set:function(h){this._viewModelInstanceValue.value=h;},enumerable:false,configurable:true}),d.prototype.rgb=function(h,S,G){this._viewModelInstanceValue.rgb(h,S,G);},d.prototype.rgba=function(h,S,G,W){this._viewModelInstanceValue.argb(W,h,S,G);},d.prototype.argb=function(h,S,G,W){this._viewModelInstanceValue.argb(h,S,G,W);},d.prototype.alpha=function(h){this._viewModelInstanceValue.alpha(h);},d.prototype.opacity=function(h){this._viewModelInstanceValue.alpha(Math.round(Math.max(0,Math.min(1,h))*255));},d.prototype.internalHandleCallback=function(h){h(this.value);},d})(vt),Ne=(function(k){p(d,k);function d(h,S){return k.call(this,h,S)||this}return Object.defineProperty(d.prototype,"value",{set:function(h){var S;this._viewModelInstanceValue.value((S=h?.nativeImage)!==null&&S!==void 0?S:null);},enumerable:false,configurable:true}),d.prototype.internalHandleCallback=function(h){h();},d})(vt),mn=(function(k){p(d,k);function d(h,S){return k.call(this,h,S)||this}return Object.defineProperty(d.prototype,"value",{set:function(h){var S,G,W;h.isBindableArtboard?W=h:W=h.file.internalBindableArtboardFromArtboard(h.nativeArtboard),this._viewModelInstanceValue.value((S=W?.nativeArtboard)!==null&&S!==void 0?S:null),W?.nativeViewModel&&this._viewModelInstanceValue.viewModelInstance((G=W?.nativeViewModel)!==null&&G!==void 0?G:null);},enumerable:false,configurable:true}),d.prototype.internalHandleCallback=function(h){h();},d})(vt),gn=function(k){return v(void 0,void 0,void 0,function(){var d,h,S;return y(this,function(G){switch(G.label){case 0:return d=new Request(k),[4,fetch(d)];case 1:return h=G.sent(),[4,h.arrayBuffer()];case 2:return S=G.sent(),[2,S]}})})},ut=function(k){return typeof k=="string"?[k]:k instanceof Array?k:[]},wt={EventManager:Y,TaskQueueManager:ie},Vt=function(k){return v(void 0,void 0,void 0,function(){var d,h,S;return y(this,function(G){switch(G.label){case 0:return d=new Promise(function(W){return O.getInstance(function(J){J.decodeAudio(k,W);})}),[4,d];case 1:return h=G.sent(),S=new f.AudioWrapper(h),f.finalizationRegistry.register(S,h),[2,S]}})})},Sn=function(k){return v(void 0,void 0,void 0,function(){var d,h,S;return y(this,function(G){switch(G.label){case 0:return d=new Promise(function(W){return O.getInstance(function(J){J.decodeImage(k,W);})}),[4,d];case 1:return h=G.sent(),S=new f.ImageWrapper(h),f.finalizationRegistry.register(S,h),[2,S]}})})},tn=function(k){return v(void 0,void 0,void 0,function(){var d,h,S;return y(this,function(G){switch(G.label){case 0:return d=new Promise(function(W){return O.getInstance(function(J){J.decodeFont(k,W);})}),[4,d];case 1:return h=G.sent(),S=new f.FontWrapper(h),f.finalizationRegistry.register(S,h),[2,S]}})})};})(),i})());})(Ya)),Ya.exports}var zd=VC();async function jd(e){const t=DC(e);if(t)return console.log(`[MGRiveLoader] Using cached RiveFile: ${e}`),t;console.log(`[MGRiveLoader] Loading RiveFile from: ${e}`);const n=await fetch(e);if(!n.ok)throw new Error(`Failed to load RiveFile: ${e} (${n.status})`);const r=await n.arrayBuffer(),o={};let i=null;if(await new Promise((l,u)=>{i=new zd.RiveFile({buffer:r,assetLoader:f=>f.isImage&&NC.includes(f.name)?(o[f.name]=f,console.log(`[MGRiveLoader] Captured image asset: ${f.name}`),true):false,onLoad:()=>{console.log(`[MGRiveLoader] RiveFile loaded: ${e}`),l();},onLoadError:f=>{console.error("[MGRiveLoader] RiveFile load error:",f),u(f);}}),i.init().catch(f=>{console.error("[MGRiveLoader] Failed to initialize RiveFile:",f),u(f);});}),!i)throw new Error(`[MGRiveLoader] Failed to create RiveFile for ${e}`);i.getInstance();const a={riveFile:i,imageAssets:o,url:e,loadedAt:Date.now()};return $C(e,a),a}const fm=[{id:"Top_DefaultGray.png",filename:"Top_DefaultGray.png",type:"Top",availability:"default",displayName:"Default",price:0,url:""},{id:"Mid_DefaultGray.png",filename:"Mid_DefaultGray.png",type:"Mid",availability:"default",displayName:"Default",price:0,url:""},{id:"Bottom_DefaultGray.png",filename:"Bottom_DefaultGray.png",type:"Bottom",availability:"default",displayName:"Default",price:0,url:""},{id:"Expression_Default.png",filename:"Expression_Default.png",type:"Expression",availability:"default",displayName:"Default",price:0,url:""},{id:"Top_Blank.png",filename:"Top_Blank.png",type:"Top",availability:"default",displayName:"None",price:0,url:""},{id:"Mid_Blank.png",filename:"Mid_Blank.png",type:"Mid",availability:"default",displayName:"None",price:0,url:""},{id:"Bottom_Blank.png",filename:"Bottom_Blank.png",type:"Bottom",availability:"default",displayName:"None",price:0,url:""},{id:"Expression_Blank.png",filename:"Expression_Blank.png",type:"Expression",availability:"default",displayName:"None",price:0,url:""}],KC=(function(){const t=typeof document<"u"&&document.createElement("link").relList;return t&&t.supports&&t.supports("modulepreload")?"modulepreload":"preload"})(),YC=function(e){return "/"+e},Mp={},xn=function(t,n,r){let o=Promise.resolve();if(n&&n.length>0){let u=function(f){return Promise.all(f.map(p=>Promise.resolve(p).then(m=>({status:"fulfilled",value:m}),m=>({status:"rejected",reason:m}))))};document.getElementsByTagName("link");const a=document.querySelector("meta[property=csp-nonce]"),l=a?.nonce||a?.getAttribute("nonce");o=u(n.map(f=>{if(f=YC(f),f in Mp)return;Mp[f]=true;const p=f.endsWith(".css"),m=p?'[rel="stylesheet"]':"";if(document.querySelector(`link[href="${f}"]${m}`))return;const v=document.createElement("link");if(v.rel=p?"stylesheet":KC,p||(v.as="script"),v.crossOrigin="",v.href=f,l&&v.setAttribute("nonce",l),document.head.appendChild(v),p)return new Promise((y,b)=>{v.addEventListener("load",y),v.addEventListener("error",()=>b(new Error(`Unable to preload CSS for ${f}`)));})}));}function i(a){const l=new Event("vite:preloadError",{cancelable:true});if(l.payload=a,window.dispatchEvent(l),!l.defaultPrevented)throw a}return o.then(a=>{for(const l of a||[])l.status==="rejected"&&i(l.reason);return t().catch(i)})},Ca={BOTTOM:0,MID:1,TOP:2,EXPRESSION:3},Bc=["Bottom_DefaultGray.png","Mid_DefaultGray.png","Top_DefaultGray.png","Expression_Default.png"];async function hm(){try{const{Store:e}=await xn(async()=>{const{Store:o}=await Promise.resolve().then(()=>Di);return {Store:o}},void 0),t=await e.select("myDataAtom");if(!t||typeof t!="object")throw new Error("myDataAtom not available");const n=t.cosmetic,r=t.name;return {avatar:n?.avatar||[...Bc],color:n?.color||"Red",name:r||"Player"}}catch(e){return console.error("[Avatar] Failed to get current avatar state:",e),{avatar:[...Bc],color:"Red",name:"Player"}}}function mm(e,t){const n=t?[...t]:[...Bc];return e.bottom&&(n[Ca.BOTTOM]=e.bottom),e.mid&&(n[Ca.MID]=e.mid),e.top&&(n[Ca.TOP]=e.top),e.expression&&(n[Ca.EXPRESSION]=e.expression),n}const gm="Expression_Stressed.png";function qC(){try{return Array.from(fe.document.querySelectorAll("script")).find(r=>r.src.includes("/version/"))?.src.match(/\/version\/([^/]+)\//)?.[1]||"669ccaa"}catch(e){return console.error("[Avatar API] Failed to get version hash:",e),"669ccaa"}}function XC(){return fe.location.pathname.split("/").pop()||"UNKNOWN"}async function QC(){try{const e=qC(),t=XC(),n=`https://magicgarden.gg/version/${e}/api/rooms/${t}/me/cosmetics`,r=await fetch(n,{method:"GET",credentials:"include",headers:{"Content-Type":"application/json"}});if(!r.ok)throw new Error(`HTTP ${r.status}`);return await r.json()}catch(e){return console.error("[Avatar API] Failed to fetch owned cosmetics:",e),[]}}function Ul(){return  false}const rr={ownedFilenames:new Set,loaded:false,error:null},JC=[];function Wl(){JC.forEach(e=>e());}async function bm(){try{await Ad();const{Store:e}=await xn(async()=>{const{Store:r}=await Promise.resolve().then(()=>Di);return {Store:r}},void 0);if(!await e.select("isUserAuthenticatedAtom")){rr.loaded=!0,Wl();return}const n=await QC();rr.ownedFilenames=new Set(n.map(r=>r.cosmeticFilename)),rr.loaded=!0,rr.error=null,Wl();}catch(e){rr.error=e,rr.loaded=true,Wl();}}function ZC(e){return rr.ownedFilenames.has(e)}function ek(){return rr.loaded}const zc=[];let Rp=false,Fp=false;function tk(){Fp||(Fp=true,ik().then(()=>{}).catch(()=>{}));}tk();let Op=false;async function nk(){Op||(await bm(),Op=true);}function Gr(){try{const t=Array.from(fe.document.querySelectorAll("script")).find(n=>n.src.includes("/version/"));if(t){const n=t.src.match(/(https:\/\/.+?\/version\/[^/]+)/);if(n)return `${n[1]}/assets/cosmetic/`}return console.warn("[Avatar] Could not find versioned asset path, using fallback"),`${fe.location.origin}/assets/cosmetic/`}catch(e){return console.error("[Avatar] Failed to get asset base URL:",e),"https://magicgarden.gg/assets/cosmetic/"}}function rk(e,t){if(!t)return e;let n=e;if(t.type){const r=Array.isArray(t.type)?t.type:[t.type];n=n.filter(o=>r.includes(o.type));}if(t.availability){const r=Array.isArray(t.availability)?t.availability:[t.availability];n=n.filter(o=>r.includes(o.availability));}if(t.search){const r=t.search.toLowerCase();n=n.filter(o=>o.displayName.toLowerCase().includes(r));}return n}function ok(e,t){return t?.includeUnowned?e:e.filter(n=>n.availability==="default"?true:ZC(n.filename))}async function ik(){if(!Rp)try{const e=Gr(),t=e.replace(/\/cosmetic\/$/,"/manifest.json"),n=await fetch(t);if(!n.ok)return;const i=((await n.json())?.bundles||[]).find(l=>l.name==="cosmetic"||l.name==="cosmetics");if(!i)return;const a=new Set(fm.map(l=>l.filename));for(const l of i.assets||[])for(const u of l.src||[]){if(typeof u!="string")continue;const f=/^(cosmetic|cosmetics)\/(.+)\.png$/i.exec(u);if(!f)continue;const p=f[1],m=f[2],v=`${m}.png`;if(a.has(v))continue;const y=m.split("_");if(y.length<2)continue;const b=y[0],A=y.slice(1).join(" ").replace(/([a-z])([A-Z])/g,"$1 $2");zc.push({id:v,filename:v,type:b,displayName:A,availability:"purchasable",price:0,url:`${e.replace(/\/cosmetic\/$/,`/${p}/`)}${v}`}),a.add(v);}Rp=!0,console.log(`[Avatar] Discovered ${zc.length} new items from manifest`);}catch(e){console.error("[Avatar] Discovery failed:",e);}}function ji(e){const t=Gr(),n=zc.map(f=>({...f,url:f.url||`${t}${f.filename}`})),r=fm.map(f=>({...f,url:`${t}${f.filename}`})),o=new Set,i=[];for(const f of n)o.has(f.filename)||(i.push(f),o.add(f.filename));for(const f of r)o.has(f.filename)||(i.push(f),o.add(f.filename));const l=[...[],...i];let u=rk(l,e);return u=ok(u,e),u}async function vm(e){return await nk(),ji(e)}function ak(e){return ji(e).map(t=>t.url)}async function Ys(){const{avatar:e,color:t}=await hm();return {top:e[2],mid:e[1],bottom:e[0],expression:e[3],color:t,array:e}}async function sk(){const e=await hm(),t=await Ys(),n=ji(),r={};return n.forEach(o=>{r[o.type]=(r[o.type]||0)+1;}),{current:{avatar:e.avatar,color:e.color,parsed:{top:t.top,mid:t.mid,bottom:t.bottom,expression:t.expression}},counts:r,allItems:n,assetBaseUrl:Gr()}}const lk="_Blank.png";let ka=null;function ck(){if(ka)return Promise.resolve(ka);const e=document.createElement("canvas");return e.width=1,e.height=1,new Promise((t,n)=>{e.toBlob(r=>{if(!r){n(new Error("[MGRiveLoader] Failed to create transparent PNG"));return}r.arrayBuffer().then(o=>{ka=new Uint8Array(o),t(ka);},n);},"image/png");})}async function Hl(e,t,n){let r;if(t.includes(lk))r=await ck();else {const i=await fetch(`${n}${t}`).then(a=>a.arrayBuffer());r=new Uint8Array(i);}const o=await zd.decodeImage(r);e.setRenderImage(o),o.unref();}async function ym(e,t){const{imageAssets:n}=e,r=Gr(),o=[];t.top&&n.Top&&o.push(Hl(n.Top,t.top,r).catch(i=>console.warn("[MGRiveLoader] Failed to load Top:",i))),t.mid&&n.Mid&&o.push(Hl(n.Mid,t.mid,r).catch(i=>console.warn("[MGRiveLoader] Failed to load Mid:",i))),t.bottom&&n.Bottom&&o.push(Hl(n.Bottom,t.bottom,r).catch(i=>console.warn("[MGRiveLoader] Failed to load Bottom:",i))),await Promise.all(o);}async function dk(e){const{canvas:t,outfit:n,riveUrl:r,stateMachine:o="State Machine 1",autoplay:i=true}=e;let a=r;if(!a){const p=await dm();if(!p)throw new Error("[MGRiveLoader] Could not find avatar .riv file");a=p.url;}console.log(`[MGRiveLoader] Creating Rive instance from: ${a}`);const l=await jd(a),u=new zd.Rive({riveFile:l.riveFile,canvas:t,autoplay:i,stateMachines:o});if(console.log("[MGRiveLoader] Rive instance created"),await ym(l,n),n.expression&&n.expression!=="Expression_Blank.png"){const m=["Expression_Default.png","Expression_Alarmed.png","Expression_Annoyed.png","Expression_Bashful.png","Expression_Calm3.png","Expression_Crying.png","Expression_Cute.png","Expression_Derpy.png","Expression_Happy.png","Expression_Mad.png","Expression_Pouty.png","Expression_Shocked.png","Expression_Thinking.png","Expression_Tired.png","Expression_Loopy.png","Expression_SoHappy.png","Expression_Vampire.png","Expression_Stressed.png"].indexOf(n.expression);if(m!==-1&&u.stateMachineInputs("State Machine 1")){const v=u.stateMachineInputs("State Machine 1").find(y=>y.name==="expression");v&&(v.value=m,console.log(`[MGRiveLoader] Set expression: ${n.expression} (index ${m})`),u.drawFrame());}}return console.log("[MGRiveLoader] Outfit applied"),{rive:u,cacheEntry:l,outfit:{...n},play(){u.play();},pause(){u.pause();},triggerAnimation(p){const m=u.stateMachineInputs(o);if(!m)return  false;const v=m.find(y=>y.name===p);return v?(typeof v.fire=="function"?v.fire():v.value=true,true):false},randomAnimation(){const p=u.stateMachineInputs(o);if(!p||p.length===0)return  false;const m=p.filter(y=>typeof y.fire=="function");return m.length===0?false:(m[Math.floor(Math.random()*m.length)].fire(),true)},destroy(){u.cleanup();}}}async function uk(e,t){if(console.log("[MGRiveLoader] Updating outfit"),await ym(e.cacheEntry,t),t.expression&&t.expression!=="Expression_Blank.png"){const r=["Expression_Default.png","Expression_Alarmed.png","Expression_Annoyed.png","Expression_Bashful.png","Expression_Calm3.png","Expression_Crying.png","Expression_Cute.png","Expression_Derpy.png","Expression_Happy.png","Expression_Mad.png","Expression_Pouty.png","Expression_Shocked.png","Expression_Thinking.png","Expression_Tired.png","Expression_Loopy.png","Expression_SoHappy.png","Expression_Vampire.png","Expression_Stressed.png"].indexOf(t.expression);if(r!==-1&&e.rive.stateMachineInputs("State Machine 1")){const o=e.rive.stateMachineInputs("State Machine 1").find(i=>i.name==="expression");o&&(o.value=r,console.log(`[MGRiveLoader] Set expression: ${t.expression} (index ${r})`),e.rive.drawFrame());}}e.outfit={...t},console.log("[MGRiveLoader] Outfit updated");}let Np=false;async function pk(){if(!Np){Np=true;try{await UC(),_p(!0),console.log("[MGRiveLoader] Initialized");}catch(e){throw console.error("[MGRiveLoader] Initialization failed:",e),_p(false),e}}}function fk(){return zC()}function hk(){return Ks()}async function mk(e){return await jd(e)}async function gk(){const e=await dm();return e?await jd(e.url):null}async function bk(e){return await dk(e)}async function vk(e,t){return await uk(e,t)}const yo={init:pk,isReady:fk,list:hk,getRiveFile:mk,getAvatarRiveFile:gk,createInstance:bk,updateOutfit:vk};function yk(){return {ready:false,baseUrl:null,urls:{ambience:new Map,music:new Map},sfx:{mp3Url:null,atlasUrl:null,atlas:null,groups:new Map,buffer:null},tracks:{ambience:null,music:null},customAudio:{current:null,onEnd:void 0},ctx:null}}const Le=yk();function xm(){return Le.ready}const Dp=fe??window;async function wm(){const e=Le.ctx;if(e)return e;const t=Dp.AudioContext||Dp.webkitAudioContext;if(!t)throw new Error("WebAudio not supported");const n=new t;return Le.ctx=n,n}async function Cm(){if(Le.ctx&&Le.ctx.state==="suspended")try{await Le.ctx.resume();}catch{}}const xk={sfx:"soundEffectsVolume",music:"musicVolume",ambience:"ambienceVolume"},wk={sfx:"soundEffectsVolumeAtom",music:"musicVolumeAtom",ambience:"ambienceVolumeAtom"},hi=.001,mi=.2;function $p(e,t=NaN){try{const n=localStorage.getItem(e);if(n==null)return t;let r;try{r=JSON.parse(n);}catch{r=n;}if(typeof r=="number"&&Number.isFinite(r))return r;if(typeof r=="string"){const o=parseFloat(r);if(Number.isFinite(o))return o}}catch{}return t}function _i(e){const t=xk[e],n=wk[e];if(!t)return {atom:mi,vol100:Sa(mi)};const r=$p(t,NaN);if(Number.isFinite(r)){const i=Rn(r,0,1);return {atom:i,vol100:Sa(i)}}if(n){const i=$p(n,NaN);if(Number.isFinite(i)){const a=Rn(i,0,1);return {atom:a,vol100:Sa(a)}}}const o=mi;return {atom:o,vol100:Sa(o)}}function Ck(e){const t=Number(e);if(!Number.isFinite(t))return null;if(t<=0)return 0;const r=(Rn(t,1,100)-1)/99;return hi+r*(mi-hi)}function Sa(e){const t=Rn(Number(e),0,1);if(t<=hi)return 0;const n=(t-hi)/(mi-hi);return Math.round(1+n*99)}function km(e,t){if(t==null)return _i(e).atom;const n=Ck(t);return n===null?_i(e).atom:i0(n)}function kk(e){const t=new Map,n=(r,o)=>{t.has(r)||t.set(r,[]),t.get(r).push(o);};for(const r of Object.keys(e||{})){const o=/^(.*)_([A-Z])$/.exec(r);o?.[1]?n(o[1],r):n(r,r);}for(const[r,o]of Array.from(t.entries()))o.sort((i,a)=>i.localeCompare(a)),t.set(r,o);Le.sfx.groups=t;}function Sk(e){const t=Le.sfx.atlas;if(!t)throw new Error("SFX atlas not loaded");if(t[e])return e;const n=Le.sfx.groups.get(e);if(n?.length)return n[Math.random()*n.length|0];throw new Error(`Unknown sfx/group: ${e}`)}async function Ak(){if(Le.sfx.buffer)return Le.sfx.buffer;if(!Le.sfx.mp3Url)throw new Error("SFX mp3 url missing");const e=await wm();await Cm();const n=await(await m0(Le.sfx.mp3Url)).arrayBuffer(),r=await new Promise((o,i)=>{const a=e.decodeAudioData(n,o,i);a?.then&&a.then(o,i);});return Le.sfx.buffer=r,r}async function Ek(e,t={}){if(!Le.ready)throw new Error("MGAudio not ready yet");const n=String(e||"").trim();if(!n)throw new Error("Missing sfx name");const r=Sk(n),o=Le.sfx.atlas[r];if(!o)throw new Error(`Missing segment for sfx: ${r}`);const i=await wm();await Cm();const a=await Ak(),l=Math.max(0,+o.start||0),u=Math.max(l,+o.end||l),f=Math.max(.01,u-l),p=km("sfx",t.volume),m=i.createGain();m.gain.value=p,m.connect(i.destination);const v=i.createBufferSource();return v.buffer=a,v.connect(m),v.start(0,l,f),{name:r,source:v,start:l,end:u,duration:f,volume:p}}const xo={MAX_SOUNDS:50,MAX_SIZE_BYTES:250*1024},_k={sounds:[],itemCustomSounds:[],version:1},Pn={shop:{soundId:"default-notification",volume:80,mode:"one-shot"},pet:{soundId:"default-notification",volume:80,mode:"one-shot"},weather:{soundId:"default-notification",volume:80,mode:"one-shot"}};class Gd extends Error{constructor(t){super(t),this.name="CustomSoundError";}}class Ik extends Gd{constructor(){super(`Maximum number of sounds reached (${xo.MAX_SOUNDS})`),this.name="SoundLimitError";}}class Tk extends Gd{constructor(t){super(`Sound size (${Math.round(t/1024)}KB) exceeds limit (${xo.MAX_SIZE_BYTES/1024}KB)`),this.name="SoundSizeError";}}class Pk extends Gd{constructor(t){super(`Sound not found: ${t}`),this.name="SoundNotFoundError";}}function Lk(e){const t={sounds:e.sounds??[],itemCustomSounds:e.itemCustomSounds??[],version:e.version??1};return e.itemCustomSounds||Ud(t),t}function qs(){const e=at($t.MODULE.AUDIO_CUSTOM_SOUNDS,_k);return Lk(e)}function Ud(e){st($t.MODULE.AUDIO_CUSTOM_SOUNDS,e);}function Bp(){return qs().sounds}function Xs(e){const t=qs();t.sounds=e,Ud(t);}function Qs(){return qs().itemCustomSounds}function Sm(e){const t=qs();t.itemCustomSounds=e,Ud(t);}function Mk(e){const t={shop:{soundId:e.shop?.soundId??Pn.shop.soundId,volume:e.shop?.volume??Pn.shop.volume,mode:e.shop?.mode??Pn.shop.mode},pet:{soundId:e.pet?.soundId??Pn.pet.soundId,volume:e.pet?.volume??Pn.pet.volume,mode:e.pet?.mode??Pn.pet.mode},weather:{soundId:e.weather?.soundId??Pn.weather.soundId,volume:e.weather?.volume??Pn.weather.volume,mode:e.weather?.mode??Pn.weather.mode}};return t!==e&&Hd(t),t}function Wd(){const e=at($t.MODULE.AUDIO_NOTIFICATION_SETTINGS,Pn);return Mk(e)}function Hd(e){st($t.MODULE.AUDIO_NOTIFICATION_SETTINGS,e);}const Rk="https://cdn.pixabay.com/audio/2025/05/31/audio_b2dfcd42bb.mp3",Am=[{id:"default-notification",name:"Default",source:Rk,type:"upload",createdAt:0}];function Fk(e){const t=new Set(e.map(r=>r.id)),n=Am.filter(r=>!t.has(r.id));return n.length===0?e:[...e,...n]}function Em(e){return Am.some(t=>t.id===e)}function Ok(e){if(!e.startsWith("data:"))return 0;const n=e.indexOf(",");if(n===-1)return 0;const o=e.slice(n+1).length*3/4;return Math.round(o)}function _m(e){if(!e||!e.trim())throw new Error("Sound source cannot be empty");const t=Ok(e);if(t>0&&t>xo.MAX_SIZE_BYTES)throw new Tk(t)}function Im(e){if(!e||!e.trim())throw new Error("Sound name cannot be empty");if(e.length>100)throw new Error("Sound name too long (max 100 characters)")}function Nk(e){if(e>=xo.MAX_SOUNDS)throw new Ik}let fn=[],jc=false;function $n(){jc||Tm();}function Dk(){return "xxxxxxxx-xxxx-4xxx-yxxx-xxxxxxxxxxxx".replace(/[xy]/g,e=>{const t=Math.random()*16|0;return (e==="x"?t:t&3|8).toString(16)})}function Tm(){if(jc)return;let e=Bp();e=Fk(e),e.length!==Bp().length&&Xs(e),fn=e,jc=true,console.log(`[CustomSounds] Initialized with ${fn.length} sounds`);}function $k(){return $n(),[...fn]}function Pm(e){return $n(),fn.find(t=>t.id===e)}function Bk(e,t,n){$n(),Im(e),_m(t),Nk(fn.length);const r={id:Dk(),name:e.trim(),source:t.trim(),type:n,createdAt:Date.now()};return fn.push(r),Xs(fn),console.log(`[CustomSounds] Added sound: ${r.name} (${r.id})`),r}function zk(e){if($n(),Em(e))throw new Error("Cannot remove default sounds");const t=fn.findIndex(r=>r.id===e);if(t===-1)return  false;const n=fn.splice(t,1)[0];return Xs(fn),console.log(`[CustomSounds] Removed sound: ${n.name} (${n.id})`),true}function jk(e,t){if($n(),Em(e))throw new Error("Cannot update default sounds");const n=fn.find(r=>r.id===e);return n?(t.name!==void 0&&(Im(t.name),n.name=t.name.trim()),t.source!==void 0&&(_m(t.source),n.source=t.source.trim()),Xs(fn),console.log(`[CustomSounds] Updated sound: ${n.name} (${n.id})`),true):false}async function Gk(e,t={}){$n();const n=Pm(e);if(!n)throw new Pk(e);const{MGAudio:r}=await xn(async()=>{const{MGAudio:o}=await Promise.resolve().then(()=>Fm);return {MGAudio:o}},void 0);try{await r.playCustom(n.source,{volume:t.volume??.5,loop:t.loop??!1}),console.log(`[CustomSounds] Playing: ${n.name} (${n.id})`);}catch(o){throw console.error(`[CustomSounds] Failed to play ${n.name}:`,o),o}}function Uk(){xn(async()=>{const{MGAudio:e}=await Promise.resolve().then(()=>Fm);return {MGAudio:e}},void 0).then(({MGAudio:e})=>{e.stopCustom(),console.log("[CustomSounds] Stopped current sound");});}function Wk(){return Wd()}function Hk(e){return Wd()[e]}function Vk(e,t){const n=Wd();n[e]=t,Hd(n),console.log(`[CustomSounds] Updated notification config for ${e}:`,t);}function Kk(e){Hd(e),console.log("[CustomSounds] Updated all notification settings");}function wo(e,t,n){return e==="shop"&&n?`${e}:${n}:${t}`:`${e}:${t}`}function Lm(e,t,n){$n();const r=Qs(),o=wo(e,t,n);return r.find(i=>wo(i.entityType,i.entityId,i.shopType)===o)??null}function Yk(e,t,n,r){$n();const o=Qs(),i=wo(e,t,r),a=o.findIndex(u=>wo(u.entityType,u.entityId,u.shopType)===i),l={entityType:e,entityId:t,shopType:r,soundId:n.soundId,volume:n.volume,mode:n.mode};a!==-1?o[a]=l:o.push(l),Sm(o),console.log(`[CustomSounds] Set custom sound for ${e}:${t}`,n),window.dispatchEvent(new CustomEvent(ft.CUSTOM_SOUND_CHANGE,{detail:{action:"set",entityType:e,entityId:t,shopType:r,config:n}}));}function qk(e,t,n){$n();const r=Qs(),o=wo(e,t,n),i=r.findIndex(a=>wo(a.entityType,a.entityId,a.shopType)===o);return i===-1?false:(r.splice(i,1),Sm(r),console.log(`[CustomSounds] Removed custom sound for ${e}:${t}`),window.dispatchEvent(new CustomEvent(ft.CUSTOM_SOUND_CHANGE,{detail:{action:"remove",entityType:e,entityId:t,shopType:n}})),true)}function Xk(e,t,n){return Lm(e,t,n)!==null}function Qk(e){return $n(),Qs().filter(n=>n.entityType===e)}const Re={init:Tm,getAll:$k,getById:Pm,add:Bk,remove:zk,update:jk,play:Gk,stop:Uk,getNotificationSettings:Wk,getNotificationConfig:Hk,setNotificationConfig:Vk,setNotificationSettings:Kk,getItemCustomSound:Lm,setItemCustomSound:Yk,removeItemCustomSound:qk,hasItemCustomSound:Xk,getItemCustomSoundsByType:Qk};let Aa=null;async function Jk(){return Le.ready?true:Aa||(Aa=(async()=>{Le.baseUrl=await Io.base();const e=await bo.load({baseUrl:Le.baseUrl}),t=bo.getBundle(e,"audio");if(!t)throw new Error("No audio bundle in manifest");for(const n of t.assets||[])for(const r of n.src||[]){if(typeof r!="string")continue;const o=/^audio\/(ambience|music)\/(.+)\.mp3$/i.exec(r);if(o){const i=o[1].toLowerCase(),a=o[2];Le.urls[i].set(a,Pr(Le.baseUrl,r));continue}/^audio\/sfx\/sfx\.mp3$/i.test(r)&&(Le.sfx.mp3Url=Pr(Le.baseUrl,r)),/^audio\/sfx\/sfx\.json$/i.test(r)&&(Le.sfx.atlasUrl=Pr(Le.baseUrl,r));}if(!Le.sfx.atlasUrl)throw new Error("Missing audio/sfx/sfx.json in manifest");return Le.sfx.atlas=await gh(Le.sfx.atlasUrl),kk(Le.sfx.atlas),Re.init(),Le.ready=true,true})(),Aa)}function Mm(e){if(e!=="music"&&e!=="ambience")return  false;const t=Le.tracks[e];if(t){try{t.pause();}catch{}try{t.src="";}catch{}}return Le.tracks[e]=null,true}function Zk(e,t,n={}){if(!Le.ready)throw new Error("MGAudio not ready yet");if(e!=="music"&&e!=="ambience")throw new Error(`Invalid category: ${e}`);const r=Le.urls[e].get(t);if(!r)throw new Error(`Unknown ${e}: ${t}`);Mm(e);const o=new Audio(r);return o.loop=!!n.loop,o.volume=km(e,n.volume),o.preload="auto",o.play().catch(()=>{}),Le.tracks[e]=o,o}function eS(e,t={}){const n=String(e||"").trim();return n==="music"||n==="ambience"?Array.from(Le.urls[n].keys()).sort():n==="sfx"?Le.sfx.atlas?t.groups?Array.from(Le.sfx.groups.keys()).sort():Object.keys(Le.sfx.atlas).sort():[]:[]}function tS(){return ["sfx","music","ambience"]}function nS(){return Array.from(Le.sfx.groups.keys()).sort((e,t)=>e.localeCompare(t))}function rS(e,t){const n=String(e||"").trim().toLowerCase(),r=String(t||"").trim();if(!r||n!=="music"&&n!=="ambience")return  false;const o=Le.urls[n],i=r.toLowerCase();for(const a of Array.from(o.keys()))if(a.toLowerCase()===i)return  true;return  false}function oS(e){const t=String(e||"").trim();if(!t)return  false;const n=t.toLowerCase();for(const r of Array.from(Le.sfx.groups.keys()))if(r.toLowerCase()===n)return  true;return  false}function iS(e,t){const n=String(e||"").trim().toLowerCase(),r=String(t||"").trim();if(!r)throw new Error("getTrackUrl(category, name) missing name");if(n!=="music"&&n!=="ambience")throw new Error(`Invalid category: ${e}`);const o=Le.urls[n],i=r.toLowerCase();for(const[a,l]of Array.from(o.entries()))if(a.toLowerCase()===i)return l;return null}function aS(){return Le.tracks.music&&(Le.tracks.music.volume=_i("music").atom),Le.tracks.ambience&&(Le.tracks.ambience.volume=_i("ambience").atom),true}let en=null;async function sS(e,t={}){Rm();const n=new Audio(e);n.volume=t.volume??1,n.loop=t.loop??false,n.preload="auto";const r={audio:n,url:e,stop:()=>{n.loop?n.loop=false:(n.pause(),n.currentTime=0,en?.audio===n&&(en=null));},setVolume:o=>{n.volume=Math.max(0,Math.min(1,o));},isPlaying:()=>!n.paused&&!n.ended};en=r;try{await new Promise((o,i)=>{const a=setTimeout(()=>{i(new Error("Audio load timeout"));},5e3),l=()=>{clearTimeout(a),n.removeEventListener("canplay",u),n.removeEventListener("error",f);},u=()=>{l(),o();},f=()=>{l(),i(new Error(`Audio load error: ${n.error?.message}`));};n.readyState>=2?(clearTimeout(a),o()):(n.addEventListener("canplay",u,{once:!0}),n.addEventListener("error",f,{once:!0}));}),await n.play();}catch(o){throw en=null,o}return n.addEventListener("ended",()=>{en?.audio===n&&(en=null);}),r}function Rm(){return en?(en.stop(),en=null,true):false}function lS(e){return en?(en.setVolume(e),true):false}function cS(){return en?.isPlaying()??false}function dS(){return en}function Kt(){if(!xm())throw new Error("MGAudio not ready yet")}async function uS(e,t,n={}){const r=String(e||"").trim(),o=String(t||"").trim();if(!r||!o)throw new Error("play(category, asset) missing args");if(r==="sfx")return Ek(o,n);if(r==="music"||r==="ambience")return Zk(r,o,n);throw new Error(`Unknown category: ${r}`)}const xt={init:Jk,isReady:xm,play:uS,stop:e=>(Kt(),Mm(e)),list:(e,t)=>(Kt(),eS(e,t)),refreshVolumes:()=>(Kt(),aS()),categoryVolume:e=>(Kt(),_i(e)),getCategories:()=>(Kt(),tS()),getGroups:()=>(Kt(),nS()),hasTrack:(e,t)=>(Kt(),rS(e,t)),hasGroup:e=>(Kt(),oS(e)),getTrackUrl:(e,t)=>(Kt(),iS(e,t)),playCustom:async(e,t)=>(Kt(),sS(e,t)),stopCustom:()=>(Kt(),Rm()),setCustomVolume:e=>(Kt(),lS(e)),isCustomPlaying:()=>(Kt(),cS()),getCustomHandle:()=>(Kt(),dS()),CustomSounds:Re},Fm=Object.freeze(Object.defineProperty({__proto__:null,MGAudio:xt},Symbol.toStringTag,{value:"Module"}));function pS(){return {ready:false,baseUrl:null,byCat:new Map,byBase:new Map,overlay:null,live:new Set,defaultParent:null}}const ot=pS();function Om(){return ot.ready}let Ea=null;async function fS(){return ot.ready?true:Ea||(Ea=(async()=>{ot.baseUrl=await Io.base();const e=await bo.load({baseUrl:ot.baseUrl}),t=bo.getBundle(e,"cosmetic");if(!t)throw new Error("No 'cosmetic' bundle in manifest");ot.byCat.clear(),ot.byBase.clear();for(const n of t.assets||[])for(const r of n.src||[]){if(typeof r!="string"||!/^cosmetic\/.+\.png$/i.test(r))continue;const i=r.split("/").pop().replace(/\.png$/i,""),a=i.indexOf("_");if(a<0)continue;const l=i.slice(0,a),u=i.slice(a+1),f=Pr(ot.baseUrl,r);ot.byBase.set(i,f),ot.byCat.has(l)||ot.byCat.set(l,new Map),ot.byCat.get(l).set(u,f);}return ot.ready=true,true})(),Ea)}function Gc(e){let t=String(e||"").trim();return t?(t=t.replace(/^cosmetic\//i,""),t=t.replace(/\.png$/i,""),t):""}function hS(e,t){if(t===void 0){const i=Gc(e),a=i.indexOf("_");return a<0?{cat:"",asset:i,base:i}:{cat:i.slice(0,a),asset:i.slice(a+1),base:i}}const n=String(e||"").trim(),r=Gc(t),o=r.includes("_")?r:`${n}_${r}`;if(r.includes("_")&&!n){const i=r.indexOf("_");return {cat:r.slice(0,i),asset:r.slice(i+1),base:r}}return {cat:n,asset:r.replace(/^.+?_/,""),base:o}}function mS(){return Array.from(ot.byCat.keys()).sort((e,t)=>e.localeCompare(t))}function gS(e){const t=ot.byCat.get(String(e||"").trim());return t?Array.from(t.keys()).sort((n,r)=>n.localeCompare(r)):[]}function Uc(e,t){const{cat:n,asset:r,base:o}=hS(e,t),i=ot.byBase.get(o);if(i)return i;const l=ot.byCat.get(n)?.get(r);if(l)return l;if(!ot.baseUrl)throw new Error("MGCosmetic not initialized");if(!o)throw new Error("Invalid cosmetic name");return Pr(ot.baseUrl,`cosmetic/${o}.png`)}const zp=fe?.document??document;function bS(){if(ot.overlay)return ot.overlay;const e=zp.createElement("div");return e.id="MG_COSMETIC_OVERLAY",e.style.cssText=["position:fixed","left:0","top:0","width:100vw","height:100vh","pointer-events:none","z-index:99999999"].join(";"),zp.documentElement.appendChild(e),ot.overlay=e,e}function vS(){const e=ot.defaultParent;if(!e)return null;try{return typeof e=="function"?e():e}catch{return null}}function yS(e){return ot.defaultParent=e,true}const xS=fe?.document??document;function Wc(e,t,n){if(!ot.ready)throw new Error("MGCosmetic not ready yet");let r,o;typeof t=="object"&&t!==null?(r=t,o=void 0):typeof t=="string"?(o=t,r=n||{}):(o=void 0,r=n||{});const i=o!==void 0?Uc(e,o):Uc(e),a=xS.createElement("img");if(a.decoding="async",a.loading="eager",a.src=i,a.alt=r.alt!=null?String(r.alt):Gc(o??e),r.className&&(a.className=String(r.className)),r.width!=null&&(a.style.width=String(r.width)),r.height!=null&&(a.style.height=String(r.height)),r.opacity!=null&&(a.style.opacity=String(r.opacity)),r.style&&typeof r.style=="object")for(const[l,u]of Object.entries(r.style))try{a.style[l]=String(u);}catch{}return a}function wS(e,t,n){let r,o;typeof t=="object"&&t!==null?(r=t,o=void 0):typeof t=="string"?(o=t,r=n||{}):(o=void 0,r=n||{});const i=r.parent||vS()||bS(),a=o!==void 0?Wc(e,o,r):Wc(e,r);if(i===ot.overlay||r.center||r.x!=null||r.y!=null||r.absolute){a.style.position="absolute",a.style.pointerEvents="none",a.style.zIndex=String(r.zIndex??999999);const u=r.scale??1,f=r.rotation??0;if(r.center)a.style.left="50%",a.style.top="50%",a.style.transform=`translate(-50%, -50%) scale(${u}) rotate(${f}rad)`;else {const p=r.x??innerWidth/2,m=r.y??innerHeight/2;a.style.left=`${p}px`,a.style.top=`${m}px`,a.style.transform=`scale(${u}) rotate(${f}rad)`,r.anchor==="center"&&(a.style.transform=`translate(-50%, -50%) scale(${u}) rotate(${f}rad)`);}}return i.appendChild(a),ot.live.add(a),a.__mgDestroy=()=>{try{a.remove();}catch{}ot.live.delete(a);},a}function CS(){for(const e of Array.from(ot.live))e.__mgDestroy?.();}const kS=100,Vl=[];function Hc(e,t,n){let r="";if(n&&typeof n=="object"){if(t==="PartialState"){const o=n.op||"",i=n.path||"";let a="";if("value"in n){const l=n.value;a=typeof l=="object"?`{${Object.keys(l||{}).slice(0,2).join(",")}}`:String(l);}if(o||i)r=`PartialState : ${o} ${i} ${a}`.trim();else {const l=Object.keys(n).filter(u=>u!=="type");l.length>0&&(r=`PartialState - {${l.join(", ")}}`);}}if(!r&&n.event&&(r+=`${n.event} `),!r&&n.op&&(r+=`op:${n.op} `),!r&&n.data){const o=Object.keys(n.data);o.length>0&&(r+=`{${o.slice(0,3).join(",")}${o.length>3?"...":""}}`);}else !r&&Array.isArray(n)&&(r+=`[${n.length} items]`);}else typeof n=="string"&&(r=n.slice(0,50));Vl.push({direction:e,type:String(t),timestamp:Date.now(),payload:n,summary:r.trim()||"-"}),Vl.length>kS&&Vl.shift();}const Yt={nativeCtor:null,captured:[],latestOpen:null},jp=Symbol.for("ariesmod.ws.capture.wrapped"),Gp=Symbol.for("ariesmod.ws.capture.native"),Nm=1;function Vc(e){return !!e&&e.readyState===Nm}function SS(){if(Vc(Yt.latestOpen))return Yt.latestOpen;for(let e=Yt.captured.length-1;e>=0;e--){const t=Yt.captured[e];if(Vc(t))return t}return null}function AS(e,t){Yt.captured.push(e),Yt.captured.length>25&&Yt.captured.splice(0,Yt.captured.length-25);const n=()=>{Yt.latestOpen=e,t&&console.log("[WS] captured socket opened",e.url);};e.addEventListener("open",n),e.addEventListener("close",()=>{Yt.latestOpen===e&&(Yt.latestOpen=null),t&&console.log("[WS] captured socket closed",e.url);}),e.addEventListener("message",r=>{try{const o=JSON.parse(r.data);Hc("in",o.type||"unknown",o);}catch{Hc("in","raw",r.data);}}),e.readyState===Nm&&n();}function ES(e=fe,t={}){const n=!!t.debug,r=e?.WebSocket;if(typeof r!="function")return ()=>{};if(r[jp])return Yt.nativeCtor=r[Gp]??Yt.nativeCtor??null,()=>{};const o=r;Yt.nativeCtor=o;function i(a,l){const u=l!==void 0?new o(a,l):new o(a);try{AS(u,n);}catch{}return u}try{i.prototype=o.prototype;}catch{}try{Object.setPrototypeOf(i,o);}catch{}try{i.CONNECTING=o.CONNECTING,i.OPEN=o.OPEN,i.CLOSING=o.CLOSING,i.CLOSED=o.CLOSED;}catch{}i[jp]=true,i[Gp]=o;try{e.WebSocket=i,n&&console.log("[WS] WebSocket capture installed");}catch{return ()=>{}}return ()=>{try{e.WebSocket===i&&(e.WebSocket=o);}catch{}}}function _S(e=fe){const t=e?.MagicCircle_RoomConnection?.currentWebSocket;return t&&typeof t=="object"?t:null}function vs(e=fe){const t=SS();if(t)return {ws:t,source:"captured"};const n=_S(e);return n?{ws:n,source:"roomConnection"}:{ws:null,source:null}}function Dm(e,t={}){const n=t.pageWindow??fe,r=t.intervalMs??500,o=!!t.debug;let i=null,a=null;const l=()=>{const f=vs(n);(f.ws!==i||f.source!==a)&&(i=f.ws,a=f.source,o&&console.log("[WS] best socket changed:",f.source,f.ws),e(f));};l();const u=setInterval(l,r);return ()=>clearInterval(u)}function IS(e){if(typeof e=="string")return e;try{return JSON.stringify(e)}catch{return null}}function TS(e,t=fe){const n=t?.MagicCircle_RoomConnection;if(n&&typeof n.sendMessage=="function")try{return Array.isArray(e)?n.sendMessage(...e):n.sendMessage(e),{ok:!0}}catch(i){return {ok:false,reason:"error",error:i}}const{ws:r}=vs(t);if(!r)return {ok:false,reason:"no-ws"};if(!Vc(r))return {ok:false,reason:"not-open"};const o=IS(e);if(o==null)return {ok:false,reason:"error",error:new Error("Cannot stringify message")};try{const i=JSON.parse(o);Hc("out",i.type||"unknown",i);}catch{}try{return r.send(o),{ok:!0}}catch(i){return {ok:false,reason:"error",error:i}}}function PS(e,t={},n=fe){return TS({type:e,...t},n)}const er={Welcome:"Welcome",PartialState:"PartialState",ServerErrorMessage:"ServerErrorMessage",Config:"Config",InappropriateContentRejected:"InappropriateContentRejected",Emote:"Emote",CurrencyTransaction:"CurrencyTransaction",Pong:"Pong"},he={Chat:"Chat",Emote:"Emote",Wish:"Wish",KickPlayer:"KickPlayer",SetPlayerData:"SetPlayerData",UsurpHost:"UsurpHost",SetSelectedGame:"SetSelectedGame",VoteForGame:"VoteForGame",RestartGame:"RestartGame",Ping:"Ping",PlayerPosition:"PlayerPosition",Teleport:"Teleport",CheckWeatherStatus:"CheckWeatherStatus",MoveInventoryItem:"MoveInventoryItem",DropObject:"DropObject",PickupObject:"PickupObject",PutItemInStorage:"PutItemInStorage",RetrieveItemFromStorage:"RetrieveItemFromStorage",MoveStorageItem:"MoveStorageItem",LogItems:"LogItems",ToggleLockItem:"ToggleLockItem",SetSelectedItem:"SetSelectedItem",PlantSeed:"PlantSeed",WaterPlant:"WaterPlant",HarvestCrop:"HarvestCrop",SellAllCrops:"SellAllCrops",PurchaseSeed:"PurchaseSeed",PurchaseEgg:"PurchaseEgg",PurchaseTool:"PurchaseTool",PurchaseDecor:"PurchaseDecor",GrowEgg:"GrowEgg",HatchEgg:"HatchEgg",PlantGardenPlant:"PlantGardenPlant",PotPlant:"PotPlant",MutationPotion:"MutationPotion",CropCleanser:"CropCleanser",PickupDecor:"PickupDecor",PlaceDecor:"PlaceDecor",RemoveGardenObject:"RemoveGardenObject",PlacePet:"PlacePet",FeedPet:"FeedPet",PetPositions:"PetPositions",SwapPet:"SwapPet",SwapPetFromStorage:"SwapPetFromStorage",PickupPet:"PickupPet",MovePetSlot:"MovePetSlot",NamePet:"NamePet",SellPet:"SellPet",ThrowSnowball:"ThrowSnowball",CheckFriendBonus:"CheckFriendBonus",ReportSpeakingStart:"ReportSpeakingStart"};var Cn=(e=>(e[e.ReconnectInitiated=4100]="ReconnectInitiated",e[e.PlayerLeftVoluntarily=4200]="PlayerLeftVoluntarily",e[e.UserSessionSuperseded=4250]="UserSessionSuperseded",e[e.ConnectionSuperseded=4300]="ConnectionSuperseded",e[e.ServerDisposed=4310]="ServerDisposed",e[e.HeartbeatExpired=4400]="HeartbeatExpired",e[e.PlayerKicked=4500]="PlayerKicked",e[e.VersionMismatch=4700]="VersionMismatch",e[e.VersionExpired=4710]="VersionExpired",e[e.AuthenticationFailure=4800]="AuthenticationFailure",e))(Cn||{});new Set(Object.values(er));new Set(Object.values(he));const LS=["Room","Quinoa"],MS={Room:["Room"],Quinoa:LS};function Te(e,t={},n=fe){const r=t,{scopePath:o,scope:i,...a}=r,l=typeof o=="string"?o:i,u=Array.isArray(o)?o:l==="Room"||l==="Quinoa"?MS[l]:null;return PS(e,u?{scopePath:u,...a}:a,n)}function RS(e,t=fe){return Te(he.Chat,{scope:"Room",message:e},t)}function FS(e,t=fe){return Te(he.Emote,{scope:"Room",emoteType:e},t)}function OS(e,t=fe){return Te(he.Wish,{scope:"Quinoa",wish:e},t)}function NS(e,t=fe){return Te(he.KickPlayer,{scope:"Room",playerId:e},t)}function Js(e,t=fe){console.log("[Gemini][WS] setPlayerData:",e);const{name:n,cosmetic:r}=e;return Te(he.SetPlayerData,{scope:"Room",name:n,cosmetic:r},t)}function DS(e=fe){return Te(he.UsurpHost,{scope:"Quinoa"},e)}function $S(e=fe){return Te(he.ReportSpeakingStart,{scope:"Quinoa"},e)}function BS(e,t=fe){return Te(he.SetSelectedGame,{scope:"Room",gameId:e},t)}function zS(e,t=fe){return Te(he.VoteForGame,{scope:"Room",gameId:e},t)}function jS(e=fe){return Te(he.RestartGame,{scope:"Room"},e)}function GS(e,t=fe){return Te(he.Ping,{scope:"Quinoa",id:e},t)}function $m(e,t,n=fe){return Te(he.PlayerPosition,{scope:"Quinoa",x:e,y:t},n)}const US=$m;function WS(e,t,n=fe){return Te(he.Teleport,{scope:"Quinoa",x:e,y:t},n)}function HS(e=fe){return Te(he.CheckWeatherStatus,{scope:"Quinoa"},e)}function VS(e,t,n=fe){return Te(he.MoveInventoryItem,{scope:"Quinoa",fromIndex:e,toIndex:t},n)}function KS(e,t=fe){return Te(he.DropObject,{scope:"Quinoa",slotIndex:e},t)}function YS(e,t=fe){return Te(he.PickupObject,{scope:"Quinoa",objectId:e},t)}function Bm(e,t=fe){return Te(he.ToggleLockItem,{scope:"Quinoa",itemId:e},t)}const qS=Bm;function XS(e,t=fe){return Te(he.SetSelectedItem,{scope:"Quinoa",itemIndex:e},t)}function Vd(e,t="PetHutch",n,r,o=fe){return Te(he.PutItemInStorage,{scope:"Quinoa",itemId:e,storageId:t,...n!==void 0&&{toStorageIndex:n},...r!==void 0&&{quantity:r}},o)}function Kd(e,t="PetHutch",n,r,o=fe){return Te(he.RetrieveItemFromStorage,{scope:"Quinoa",itemId:e,storageId:t,...n!==void 0&&{toInventoryIndex:n},...r!==void 0&&{quantity:r}},o)}function QS(e,t,n,r=fe){return Te(he.MoveStorageItem,{scope:"Quinoa",itemId:e,storageId:t,toStorageIndex:n},r)}function JS(e=fe){return Te(he.LogItems,{scope:"Quinoa"},e)}function ZS(e,t,n=fe){return Te(he.PlantSeed,{scope:"Quinoa",slot:e,species:t},n)}function e1(e,t=fe){return Te(he.WaterPlant,{scope:"Quinoa",slot:e},t)}function t1(e,t,n=fe){return Te(he.HarvestCrop,{scope:"Quinoa",slot:e,...t!==void 0&&{slotsIndex:t}},n)}function n1(e=fe){return Te(he.SellAllCrops,{scope:"Quinoa"},e)}function Yd(e,t=fe){return Te(he.PurchaseDecor,{scope:"Quinoa",decorId:e},t)}function qd(e,t=fe){return Te(he.PurchaseEgg,{scope:"Quinoa",eggId:e},t)}function Xd(e,t=fe){return Te(he.PurchaseTool,{scope:"Quinoa",toolId:e},t)}function Qd(e,t=fe){return Te(he.PurchaseSeed,{scope:"Quinoa",species:e},t)}function zm(e,t,n=fe){return Te(he.GrowEgg,{scope:"Quinoa",slot:e,eggId:t},n)}const r1=zm;function o1(e,t=fe){return Te(he.HatchEgg,{scope:"Quinoa",slot:e},t)}function i1(e,t,n=fe){return Te(he.PlantGardenPlant,{scope:"Quinoa",slot:e,itemId:t},n)}function a1(e,t=fe){return Te(he.PotPlant,{scope:"Quinoa",slot:e},t)}function s1(e,t,n,r=fe){return Te(he.MutationPotion,{scope:"Quinoa",tileObjectIdx:e,growSlotIdx:t,mutation:n},r)}function l1(e,t,n=fe){return Te(he.CropCleanser,{scope:"Quinoa",tileObjectIdx:e,growSlotIdx:t},n)}function c1(e,t,n=fe){return Te(he.PickupDecor,{scope:"Quinoa",tileType:e,localTileIndex:t},n)}function d1(e,t,n,r,o=fe){return Te(he.PlaceDecor,{scope:"Quinoa",decorId:e,tileType:t,localTileIndex:n,...r!==void 0&&{rotation:r}},o)}function u1(e,t,n=fe){return Te(he.RemoveGardenObject,{scope:"Quinoa",slot:e,slotType:t},n)}function jm(e,t={x:0,y:0},n="Dirt",r=0,o=fe){return Te(he.PlacePet,{scope:"Quinoa",itemId:e,position:t,tileType:n,localTileIndex:r},o)}function p1(e,t,n=fe){return Te(he.FeedPet,{scope:"Quinoa",petItemId:e,cropItemId:t},n)}function f1(e,t=fe){return Te(he.PetPositions,{scope:"Quinoa",petPositions:e},t)}function Gm(e,t,n=fe){return Te(he.SwapPet,{scope:"Quinoa",petSlotId:e,petInventoryId:t},n)}function h1(e,t,n,r=fe){return Te(he.SwapPetFromStorage,{scope:"Quinoa",petSlotId:e,storagePetId:t,storageId:n},r)}function Um(e,t=fe){return Te(he.PickupPet,{scope:"Quinoa",petId:e},t)}function m1(e,t,n=fe){return Te(he.MovePetSlot,{scope:"Quinoa",movePetSlotId:e,toPetSlotIndex:t},n)}function g1(e,t,n=fe){return Te(he.NamePet,{scope:"Quinoa",petItemId:e,name:t},n)}function b1(e,t=fe){return Te(he.SellPet,{scope:"Quinoa",itemId:e},t)}function v1(e=fe){return Te(he.ThrowSnowball,{scope:"Quinoa"},e)}function y1(e=fe){return Te(he.CheckFriendBonus,{scope:"Quinoa"},e)}async function Wm(e){try{const t=await Ys(),n=[e.bottom!==void 0?e.bottom:t.bottom,e.mid!==void 0?e.mid:t.mid,e.top!==void 0?e.top:t.top,e.expression!==void 0?e.expression:t.expression],r=e.color!==void 0?e.color:t.color,o=Js({cosmetic:{color:r,avatar:n}},fe);return console.log("[Avatar] Set outfit:",{outfit:e,finalAvatar:n,result:o}),!0}catch(t){return console.error("[Avatar] Failed to set outfit:",t),false}}async function x1(){return Wm({top:"Top_DefaultGray.png",mid:"Mid_DefaultGray.png",bottom:"Bottom_DefaultGray.png",expression:"Expression_Default.png",color:"Red"})}const ai=new Map;function w1(e){if(ai.has(e))return ai.get(e);const t=new Promise((n,r)=>{const o=new Image;o.crossOrigin="anonymous",o.onload=()=>n(o),o.onerror=()=>{ai.delete(e),r(new Error(`Failed to load image: ${e}`));},o.src=e;});return ai.set(e,t),t}function C1(){ai.clear();}function k1(e){return ji().find(r=>r.filename===e)?.url||""}async function S1(e,t={}){const n=document.createElement("canvas"),r=t.width||400,o=t.height||400,i=t.scale||1;n.width=r*i,n.height=o*i;const a=n.getContext("2d");if(!a)throw new Error("Failed to get canvas 2D context");if(a.imageSmoothingEnabled=i!==1,e.color){const p={Red:"#FF0000",Blue:"#0000FF",Green:"#00FF00",Yellow:"#FFFF00",Purple:"#800080",Orange:"#FFA500",Pink:"#FFC0CB",Brown:"#A52A2A"};a.fillStyle=p[e.color]||"#FF0000",a.fillRect(0,0,n.width,n.height);}const u=[e.bottom,e.mid,e.top,e.expression].filter(p=>!!p).map(p=>k1(p));return (await Promise.all(u.map(p=>w1(p)))).forEach(p=>{a.drawImage(p,0,0,n.width,n.height);}),n}let Jd=null,lo=null,Ar=null,ir=null;function Kl(e){return Gr()+e}async function A1(e){try{const{Store:t}=await xn(async()=>{const{Store:a}=await Promise.resolve().then(()=>Di);return {Store:a}},void 0),n=await t.select("myDataAtom"),r=n?.cosmetic?.avatar||[],o=mm(e,r),i=e.color||n?.cosmetic?.color||"Red";return Jd={avatar:o,color:i},_1(),I1(o),console.log("[Avatar] Rendered avatar override:",o),!0}catch(t){return console.error("[Avatar] Failed to render avatar:",t),false}}async function E1(){Jd=null,lo&&(clearInterval(lo),lo=null),Ar&&(Ar.disconnect(),Ar=null);const e=fe.document;return e.querySelectorAll("[data-gemini-avatar-overridden]").forEach(t=>{t.removeAttribute("data-gemini-avatar-overridden");}),e.querySelectorAll(".gemini-avatar-overlay").forEach(t=>t.remove()),e.querySelectorAll("img[data-gemini-override]").forEach(t=>{t.removeAttribute("data-gemini-override");}),ir&&(ir.remove(),ir=null),console.log("[Avatar] Cleared override"),true}function _1(){if(ir)return;const e=fe.document;ir=e.createElement("style"),ir.id="gemini-avatar-override-styles",ir.textContent=`
    ...
    `,e.head.appendChild(ir);}function I1(e){lo&&clearInterval(lo),Ar&&Ar.disconnect();const t=fe.document,n=()=>{const o=t.querySelectorAll(".Avatar");let i=0;o.forEach(a=>{const l=Array.from(a.querySelectorAll("img"));if(l.length===4){let f=false;l.forEach((p,m)=>{const v=Kl(e[m]);p.src!==v&&(f=true);}),f&&(l.forEach((p,m)=>{p.src=Kl(e[m]),p.setAttribute("data-gemini-override",e[m]);}),i++);return}if(a.querySelector("canvas")&&!a.querySelector(".gemini-avatar-overlay")){a.setAttribute("data-gemini-avatar-overridden","true");const f=t.createElement("div");f.className="gemini-avatar-overlay",e.forEach(p=>{const m=t.createElement("img");m.src=Kl(p),m.setAttribute("data-gemini-cosmetic",p),f.appendChild(m);}),window.getComputedStyle(a).position==="static"&&(a.style.position="relative"),a.appendChild(f),i++;}}),i>0&&console.log(`[Avatar] Re-applied ${i} override(s) (React reverted)`);};n(),lo=setInterval(n,500),Ar=new MutationObserver(()=>{setTimeout(n,10);});const r=t.querySelector(".game-root")||t.querySelector("#root")||t.body;Ar.observe(r,{childList:true,subtree:true,attributeFilter:["src"]}),console.log("[Avatar] Aggressive monitor started (500ms + MutationObserver)");}function T1(){return Jd}function P1(e){if(!e)return  false;const t=e.toLowerCase();return t.includes("_blank")||t.includes("_none")||t===gm.toLowerCase()}function L1(e){return e.some(P1)}let ys=null,to=null;fe.Gemini_AvatarOverride=null;async function Hm(e){try{const{Store:t}=await xn(async()=>{const{Store:A}=await Promise.resolve().then(()=>Di);return {Store:A}},void 0),{getPlayers:n}=await xn(async()=>{const{getPlayers:A}=await Promise.resolve().then(()=>sg);return {getPlayers:A}},void 0);Ul();const i=n().get().myPlayer;if(!i)return console.error("[WorldAvatar] myPlayer not available"),!1;const a=i.id,l=i.cosmetic.avatar;fe.MagicCircle_PlayerId=a,to||(to=[...l]);let u=mm(e,l);const f=L1(u);Ul(),ys=u,fe.Gemini_AvatarOverride=u,console.log("[WorldAvatar] Applying override:",u);const p=await t.select("stateAtom");if(!p?.data?.players)return console.error("[WorldAvatar] stateAtom.data.players not available"),!1;const m=p.data.players.findIndex(A=>A.id===a);if(m===-1)return console.error("[WorldAvatar] Current player not found in players array"),!1;const v=p.data.players[m],y=[...p.data.players];y[m]={...v,cosmetic:{...v.cosmetic,avatar:u}};const b={...p,data:{...p.data,players:y}};return await t.set("stateAtom",b),Ul()&&f||Js({name:i.name,cosmetic:{...i.cosmetic,avatar:u}},fe),!0}catch{return  false}}async function M1(){if(!ys||!to)return  true;try{const{Store:e}=await xn(async()=>{const{Store:m}=await Promise.resolve().then(()=>Di);return {Store:m}},void 0),{getPlayers:t}=await xn(async()=>{const{getPlayers:m}=await Promise.resolve().then(()=>sg);return {getPlayers:m}},void 0);fe.Gemini_AvatarOverride=null;const o=t().get().myPlayer;if(!o)return !1;const i=o.id,a=await e.select("stateAtom");if(!a?.data?.players)return !1;const l=a.data.players.findIndex(m=>m.id===i);if(l===-1)return !1;const u=a.data.players[l],f=[...a.data.players];f[l]={...u,cosmetic:{...u.cosmetic,avatar:to}};const p={...a,data:{...a.data,players:f}};return await e.set("stateAtom",p),Js({name:o.name,cosmetic:{...o.cosmetic,avatar:to}},fe),ys=null,to=null,!0}catch{return  false}}function R1(){return ys}let Nt=[];const qa=[],Up=()=>{qa.forEach(e=>e([...Nt]));},Mr={init(){Nt=at($t.SECTION.AVATAR_LOADOUTS,[]);},get(){return [...Nt]},async save(e,t,n){if(!n){const i=Nt.find(a=>a.top===t.top&&a.mid===t.mid&&a.bottom===t.bottom&&a.expression===t.expression);if(i)return i.id}const r=n||Math.random().toString(36).substring(2,9),o={...t,id:r,name:e,createdAt:n&&Nt.find(i=>i.id===n)?.createdAt||Date.now()};if(n){const i=Nt.findIndex(a=>a.id===n);i!==-1?Nt[i]=o:Nt.push(o);}else Nt.push(o);return st($t.SECTION.AVATAR_LOADOUTS,Nt),Up(),r},delete(e){Nt=Nt.filter(t=>t.id!==e),st($t.SECTION.AVATAR_LOADOUTS,Nt),Up();},rename(e,t){const n=Nt.find(r=>r.id===e);n&&(n.name=t,st($t.SECTION.AVATAR_LOADOUTS,Nt));},async wear(e){const t=Nt.find(r=>r.id===e);if(!t)return  false;const n={top:t.top,mid:t.mid,bottom:t.bottom,expression:t.expression};return await Hm(n)},subscribe(e){return qa.push(e),()=>{const t=qa.indexOf(e);t!==-1&&qa.splice(t,1);}}},Vm={init:bm,isReady:()=>ek(),list:ji,listAsync:vm,listUrls:ak,get:Ys,debug:sk,set:Wm,blank:x1,Loadouts:Mr,toCanvas:S1,clearImageCache:C1,render:A1,clearOverride:E1,getOverride:T1,renderWorld:Hm,clearWorldOverride:M1,getWorldOverride:R1};function wr(){if(!Om())throw new Error("MGCosmetic not ready yet")}const Zd={init:fS,isReady:Om,categories:()=>(wr(),mS()),list:e=>(wr(),gS(e)),url:((e,t)=>(wr(),Uc(e,t))),create:((e,t,n)=>(wr(),Wc(e,t,n))),show:((e,t,n)=>(wr(),wS(e,t,n))),attach:e=>(wr(),yS(e)),clear:()=>(wr(),CS()),Avatar:Vm},Wp={Gold:25,Rainbow:50,Wet:2,Chilled:2,Frozen:10,Dawnlit:2,Dawnbound:3,Amberlit:5,Amberbound:6};function Km(e){const t=Oe.get("mutations");if(!t)return Wp[e]??null;const n=t[e];return !n||typeof n.coinMultiplier!="number"?Wp[e]??null:n.coinMultiplier}const Yl=new Map;function ql(e){if(Yl.has(e))return Yl.get(e);const t=Km(e)??1;return Yl.set(e,t),t}const F1=new Set(["Gold","Rainbow"]),O1=new Set(["Wet","Chilled","Frozen","Dawnlit","Dawnbound","Amberlit","Amberbound"]);function Ym(e){let t=1,n=0,r=0;for(const o of e)if(o==="Gold"||o==="Rainbow")o==="Rainbow"?t=ql("Rainbow"):t===1&&(t=ql("Gold"));else {const i=ql(o);i>1&&(n+=i,r++);}return t*(1+n-r)}function N1(e){return Km(e)}function D1(e){return F1.has(e)}function $1(e){return O1.has(e)}function B1(e){return $1(e)}function eu(e,t){const n=tu(e);if(!n)return 50;const r=n.maxScale;if(t<=1)return 50;if(t>=r)return 100;const o=(t-1)/(r-1);return Math.floor(50+50*o)}function Ii(e,t,n){const r=tu(e);if(!r)return 0;const o=r.baseSellPrice,i=Ym(n);return Math.round(o*t*i)}function z1(e,t,n){if(n>=t)return 100;if(n<=e)return 0;const r=t-e,o=n-e;return Math.floor(o/r*100)}function j1(e,t){return t>=e}function tu(e){const t=Oe.get("plants");if(!t)return null;const n=t[e];return n?.crop?{baseSellPrice:n.crop.baseSellPrice??0,maxScale:n.crop.maxScale??1,growTime:n.crop.growTime??0}:null}const qm=3600,Xl=80,G1=100,si=30;function Zs(e){return e/qm}function el(e,t){const n=Gi(e);if(!n)return Xl;const r=n.maxScale;if(t<=1)return Xl;if(t>=r)return G1;const o=(t-1)/(r-1);return Math.floor(Xl+20*o)}function tl(e,t,n){const r=Gi(e);if(!r)return n-si;const o=r.hoursToMature,i=t/qm,a=si/o,l=Math.min(a*i,si),u=n-si;return Math.floor(u+l)}function nl(e,t){const n=Gi(e);return n?t>=n.hoursToMature:false}function Xm(e){const t=Gi(e);return t?si/t.hoursToMature:0}function U1(e,t,n){const r=t-e;return r<=0||n<=0?0:r/n}function Gi(e){const t=Oe.get("pets");if(!t)return null;const n=t[e];return n?{hoursToMature:n.hoursToMature??0,maxScale:n.maxScale??1,abilities:n.abilities??[]}:null}function W1(e,t){return t<=0?1:Math.min(1,e/t)}const Qn=3600,_a=80,Hp=100,Fn=30,H1={Worm:30,Snail:60,Bee:15,Chicken:60,Bunny:45,Dragonfly:15,Pig:60,Cow:75,Turkey:60,SnowFox:45,Stoat:60,WhiteCaribou:75,Squirrel:30,Turtle:90,Goat:60,Butterfly:30,Peacock:60,Capybara:60};function Ui(e){const t=Oe.get("pets");if(!t)return null;const n=t[e];return n?{hoursToMature:n.hoursToMature??0,maxScale:n.maxScale??1}:null}function V1(e){return e/Qn}function Qm(e,t){const n=Ui(e);if(!n)return _a;const{maxScale:r}=n;if(t<=1)return _a;if(t>=r)return Hp;const o=(t-1)/(r-1);return Math.floor(_a+(Hp-_a)*o)}function K1(e){return e-Fn}function Y1(e){const t=Ui(e);return !t||t.hoursToMature<=0?0:Fn/t.hoursToMature}function Jm(e,t,n){const r=Ui(e);if(!r)return n-Fn;const o=t/Qn,i=Fn/r.hoursToMature,a=Math.min(i*o,Fn),l=n-Fn;return Math.floor(l+a)}function Zm(e,t,n){const r=Ui(e);if(!r)return 0;const o=n-Fn,i=t-o;if(i<=0)return 0;const a=Fn/r.hoursToMature;return a<=0?0:i/a*Qn}function nu(e,t,n,r,o=Qn){const a=Zm(e,n,r)-t;return a<=0?0:o<=0?1/0:a/o}function eg(e,t,n,r=Qn){return nu(e,t,n,n,r)}function tg(e,t,n,r,o=Qn){if(n>=r)return 0;const i=n+1;return nu(e,t,i,r,o)}function q1(e,t){return e>=t}function X1(e,t){const n=t-Fn,o=(e-n)/Fn*100;return Math.min(100,Math.max(0,o))}const Q1=Object.freeze(Object.defineProperty({__proto__:null,calculateAge:V1,calculateCurrentStrength:Jm,calculateHoursToMaxStrength:eg,calculateHoursToNextStrength:tg,calculateHoursToStrength:nu,calculateMaxStrength:Qm,calculateStartingStrength:K1,calculateStrengthPerHour:Y1,calculateStrengthProgress:X1,calculateXpForStrength:Zm,getSpeciesData:Ui,isPetMature:q1},Symbol.toStringTag,{value:"Module"}));function ru(e){const t=Oe.get("pets");if(!t)return 100/24;const n=t[e];if(!n?.coinsToFullyReplenishHunger)return 100/24;const r=H1[e];return r?n.coinsToFullyReplenishHunger/r*60:(console.warn(`[Feed] Unknown species "${e}", using 60min default`),n.coinsToFullyReplenishHunger/60*60)}function J1(e,t){return e<=0?0:t<=0?1/0:e/t}function ou(e,t,n,r){if(e<=0||n<=0)return 0;const o=t/n;if(o>=e)return 0;const i=e-o,a=r/n;return Math.ceil(i/a)}function ng(e,t,n){const r=Oe.get("pets");if(!r)return 0;const o=r[e];if(!o?.coinsToFullyReplenishHunger)return 0;const i=o.coinsToFullyReplenishHunger,a=ru(e);return ou(n,t,a,i)}function xs(e,t,n){const r=Oe.get("pets");if(!r)return 0;const o=r[e];if(!o?.coinsToFullyReplenishHunger)return 0;const i=o.coinsToFullyReplenishHunger,a=ru(e);return ou(n,t,a,i)}function rg(e,t,n,r,o,i){return e?t&&i>0?xs(n,r,i):0:xs(n,r,o)}const Z1=Object.freeze(Object.defineProperty({__proto__:null,calculateAdjustedFeedsToMax:rg,calculateFeedsForDuration:ou,calculateFeedsToMaxStrength:xs,calculateFeedsToNextStrength:ng,calculateHoursUntilStarving:J1,getHungerDrainPerHour:ru},Symbol.toStringTag,{value:"Module"})),og={init(){},isReady(){return  true},crop:{calculateSize:eu,calculateSellPrice:Ii,calculateProgress:z1,isReady:j1,getData:tu},pet:{calculateAge:Zs,calculateMaxStrength:el,calculateCurrentStrength:tl,isMature:nl,calculateStrengthPerHour:Xm,getData:Gi},mutation:{calculateMultiplier:Ym,getValue:N1,isGrowth:D1,isEnvironmental:B1},xp:Q1,feed:Z1};function wn(e,t){if(e===t)return  true;if(e===null||t===null)return e===t;if(typeof e!=typeof t)return  false;if(typeof e!="object")return e===t;if(Array.isArray(e)&&Array.isArray(t)){if(e.length!==t.length)return  false;for(let a=0;a<e.length;a++)if(!wn(e[a],t[a]))return  false;return  true}if(Array.isArray(e)||Array.isArray(t))return  false;const n=e,r=t,o=Object.keys(n),i=Object.keys(r);if(o.length!==i.length)return  false;for(const a of o)if(!Object.prototype.hasOwnProperty.call(r,a)||!wn(n[a],r[a]))return  false;return  true}const Vp={currentGardenTile:"myCurrentGardenTileAtom",globalTileIndex:"myCurrentGlobalTileIndexAtom",gardenObject:"myCurrentGardenObjectAtom",isMature:"isGardenObjectMatureAtom",isInMyGarden:"isInMyGardenAtom",gardenName:"currentGardenPlayer",sortedSlotIndices:"myCurrentSortedGrowSlotIndicesAtom",currentGrowSlotIndex:"mySelectedSlotIdAtom"},Kp={position:{globalIndex:null,localIndex:null},tile:{type:null,isEmpty:true},garden:{name:null,isOwner:false,playerSlotIndex:null},object:{type:null,data:null,isMature:false},plant:null};function eA(e){const t=e.currentGardenTile;return {globalIndex:e.globalTileIndex,localIndex:t?.localTileIndex??null}}function tA(e){return {type:e.currentGardenTile?.tileType??null,isEmpty:e.gardenObject===null}}function nA(e){const t=e.currentGardenTile;return {name:e.gardenName?.name??null,isOwner:e.isInMyGarden??false,playerSlotIndex:t?.userSlotIdx??null}}function rA(e){const t=e.gardenObject;return t?{type:t.objectType,data:t,isMature:e.isMature??false}:{type:null,data:null,isMature:false}}function oA(e){const t=e.gardenObject;if(!t||t.objectType!=="plant")return null;const n=t,r=e.sortedSlotIndices??[];return {species:n.species,slots:n.slots??[],currentSlotIndex:e.currentGrowSlotIndex,sortedSlotIndices:r,nextHarvestSlotIndex:r.length>0?r[0]:null}}function Yp(e){return {position:eA(e),tile:tA(e),garden:nA(e),object:rA(e),plant:oA(e)}}function qp(e){return JSON.stringify({globalIndex:e.position.globalIndex,localIndex:e.position.localIndex,tileType:e.tile.type,isEmpty:e.tile.isEmpty,gardenName:e.garden.name,isOwner:e.garden.isOwner,playerSlotIndex:e.garden.playerSlotIndex,objectType:e.object.type,isMature:e.object.isMature,plantSpecies:e.plant?.species??null,slotCount:e.plant?.slots.length??0})}function iA(e,t){return e.type!==t.type||e.isMature!==t.isMature?true:e.data===null&&t.data===null?false:e.data===null||t.data===null?true:!wn(e.data,t.data)}function aA(e,t){return e===null&&t===null?false:e===null||t===null||e.species!==t.species||e.currentSlotIndex!==t.currentSlotIndex||e.nextHarvestSlotIndex!==t.nextHarvestSlotIndex||e.slots.length!==t.slots.length||!wn(e.sortedSlotIndices,t.sortedSlotIndices)?true:!wn(e.slots,t.slots)}function sA(e,t){return e.name!==t.name||e.isOwner!==t.isOwner||e.playerSlotIndex!==t.playerSlotIndex}function lA(){let e=Kp,t=Kp,n=false;const r=[],o={all:new Set,stable:new Set,object:new Set,plantInfo:new Set,garden:new Set},i={},a=Object.keys(Vp),l=new Set;let u=false;function f(){if(u=false,l.size<a.length)return;const v=Yp(i);if(!wn(e,v)&&(t=e,e=v,!!n)){for(const y of o.all)y(e,t);if(qp(t)!==qp(e))for(const y of o.stable)y(e,t);if(iA(t.object,e.object)){const y={current:e.object,previous:t.object};for(const b of o.object)b(y);}if(aA(t.plant,e.plant)){const y={current:e.plant,previous:t.plant};for(const b of o.plantInfo)b(y);}if(sA(t.garden,e.garden)){const y={current:e.garden,previous:t.garden};for(const b of o.garden)b(y);}}}function p(){u||(u=true,queueMicrotask(f));}async function m(){if(n)return;const v=a.map(async y=>{const b=Vp[y],A=await Xe.subscribe(b,P=>{i[y]=P,l.add(y),p();});r.push(A);});await Promise.all(v),n=true,l.size===a.length&&(e=Yp(i));}return m(),{get(){return e},subscribe(v,y){return o.all.add(v),y?.immediate!==false&&n&&l.size===a.length&&v(e,e),()=>o.all.delete(v)},subscribeStable(v,y){return o.stable.add(v),y?.immediate!==false&&n&&l.size===a.length&&v(e,e),()=>o.stable.delete(v)},subscribeObject(v,y){return o.object.add(v),y?.immediate&&n&&l.size===a.length&&v({current:e.object,previous:e.object}),()=>o.object.delete(v)},subscribePlantInfo(v,y){return o.plantInfo.add(v),y?.immediate&&n&&l.size===a.length&&v({current:e.plant,previous:e.plant}),()=>o.plantInfo.delete(v)},subscribeGarden(v,y){return o.garden.add(v),y?.immediate&&n&&l.size===a.length&&v({current:e.garden,previous:e.garden}),()=>o.garden.delete(v)},destroy(){for(const v of r)v();r.length=0,o.all.clear(),o.stable.clear(),o.object.clear(),o.plantInfo.clear(),o.garden.clear(),n=false;}}}let Ql=null;function bt(){return Ql||(Ql=lA()),Ql}function cA(){let e=null;const t=[],n=new Set,r={},o=new Set,i=2;function a(m,v){return {x:v%m,y:Math.floor(v/m)}}function l(m,v,y){return y*m+v}function u(m,v){const{cols:y,rows:b}=m,A=y*b,P=new Set,I=new Set,T=new Map,N=[],z=m.userSlotIdxAndDirtTileIdxToGlobalTileIdx??[],O=m.userSlotIdxAndBoardwalkTileIdxToGlobalTileIdx??[],M=Math.max(z.length,O.length);for(let C=0;C<M;C++){const E=z[C]??[],B=O[C]??[],j=E.map((U,ce)=>(P.add(U),T.set(U,C),{globalIndex:U,localIndex:ce,position:a(y,U)})),V=B.map((U,ce)=>(I.add(U),T.set(U,C),{globalIndex:U,localIndex:ce,position:a(y,U)}));N.push({userSlotIdx:C,dirtTiles:j,boardwalkTiles:V,allTiles:[...j,...V]});}const F=m.spawnTiles.map(C=>a(y,C)),L={};if(m.locations)for(const[C,E]of Object.entries(m.locations)){const B=E.spawnTileIdx??[];L[C]={name:C,spawnTiles:B,spawnPositions:B.map(j=>a(y,j))};}return {cols:y,rows:b,totalTiles:A,tileSize:v,spawnTiles:m.spawnTiles,spawnPositions:F,locations:L,userSlots:N,globalToXY(C){return a(y,C)},xyToGlobal(C,E){return l(y,C,E)},getTileOwner(C){return T.get(C)??null},isDirtTile(C){return P.has(C)},isBoardwalkTile(C){return I.has(C)}}}function f(){if(o.size<i||e)return;const m=r.map,v=r.tileSize??0;if(m){e=u(m,v);for(const y of n)y(e);n.clear();}}async function p(){const m=await Xe.subscribe("mapAtom",y=>{r.map=y,o.add("map"),f();});t.push(m);const v=await Xe.subscribe("tileSizeAtom",y=>{r.tileSize=y,o.add("tileSize"),f();});t.push(v);}return p(),{get(){return e},isReady(){return e!==null},onReady(m,v){return e?(v?.immediate!==false&&m(e),()=>{}):(n.add(m),()=>n.delete(m))},destroy(){for(const m of t)m();t.length=0,e=null,n.clear();}}}let Jl=null;function Kc(){return Jl||(Jl=cA()),Jl}function dA(){const e=Oe.get("mutations");return e?Object.keys(e):[]}function ig(){const e={};for(const t of dA())e[t]=[];return e}function Yc(){return {garden:null,mySlotIndex:null,plants:{all:[],mature:[],growing:[],bySpecies:{},count:0},crops:{all:[],mature:[],growing:[],mutated:{all:[],byMutation:ig()}},eggs:{all:[],mature:[],growing:[],byType:{},count:0},decors:{tileObjects:[],boardwalk:[],all:[],byType:{},count:0},tiles:{tileObjects:[],boardwalk:[],empty:{tileObjects:[],boardwalk:[]}},counts:{plants:0,maturePlants:0,crops:0,matureCrops:0,eggs:0,matureEggs:0,decors:0,emptyTileObjects:0,emptyBoardwalk:0}}}function Xp(e){return JSON.stringify({plants:e.counts.plants,maturePlants:e.counts.maturePlants,crops:e.counts.crops,matureCrops:e.counts.matureCrops,eggs:e.counts.eggs,matureEggs:e.counts.matureEggs,decors:e.counts.decors,emptyTileObjects:e.counts.emptyTileObjects,emptyBoardwalk:e.counts.emptyBoardwalk})}function uA(e,t,n,r){const o=t.slots.filter(i=>r>=i.endTime).length;return {tileIndex:e,position:n,species:t.species,plantedAt:t.plantedAt,maturedAt:t.maturedAt,isMature:r>=t.maturedAt,slots:t.slots,slotsCount:t.slots.length,matureSlotsCount:o}}function pA(e,t,n,r,o){return {tileIndex:e,position:t,slotIndex:n,species:r.species,startTime:r.startTime,endTime:r.endTime,targetScale:r.targetScale,mutations:[...r.mutations],isMature:o>=r.endTime,fruitCount:1}}function fA(e,t,n,r){return {tileIndex:e,position:n,eggId:t.eggId,plantedAt:t.plantedAt,maturedAt:t.maturedAt,isMature:r>=t.maturedAt}}function Qp(e,t,n,r){return {tileIndex:e,position:n,decorId:t.decorId,rotation:t.rotation,location:r}}function Jp(e,t){const{garden:n,mySlotIndex:r}=e,o=Date.now();if(!n||r===null)return Yc();const i=t().get(),a=i?.userSlots[r],l=a?.dirtTiles??[],u=a?.boardwalkTiles??[],f=[],p=[],m=[],v={},y=[],b=[],A=[],P=[],I=ig(),T=[],N=[],z=[],O={},M=[],F=[],L={},C=new Set,E=new Set;for(const[U,ce]of Object.entries(n.tileObjects)){const Y=parseInt(U,10);C.add(Y);const ie=i?i.globalToXY(Y):{x:0,y:0};if(ce.objectType==="plant"){const se=ce,ae=uA(U,se,ie,o);f.push(ae),ae.isMature?p.push(ae):m.push(ae),v[ae.species]||(v[ae.species]=[]),v[ae.species].push(ae);for(let ne=0;ne<se.slots.length;ne++){const q=se.slots[ne],Z=pA(U,ie,ne,q,o);if(y.push(Z),Z.isMature?b.push(Z):A.push(Z),Z.mutations.length>0){P.push(Z);for(const R of Z.mutations)I[R]||(I[R]=[]),I[R].push(Z);}}}else if(ce.objectType==="egg"){const ae=fA(U,ce,ie,o);T.push(ae),O[ae.eggId]||(O[ae.eggId]=[]),O[ae.eggId].push(ae),ae.isMature?N.push(ae):z.push(ae);}else if(ce.objectType==="decor"){const ae=Qp(U,ce,ie,"tileObjects");M.push(ae),L[ae.decorId]||(L[ae.decorId]=[]),L[ae.decorId].push(ae);}}for(const[U,ce]of Object.entries(n.boardwalkTileObjects)){const Y=parseInt(U,10);E.add(Y);const ie=i?i.globalToXY(Y):{x:0,y:0},ae=Qp(U,ce,ie,"boardwalk");F.push(ae),L[ae.decorId]||(L[ae.decorId]=[]),L[ae.decorId].push(ae);}const B=[...M,...F],j=l.filter(U=>!C.has(U.localIndex)),V=u.filter(U=>!E.has(U.localIndex));return {garden:n,mySlotIndex:r,plants:{all:f,mature:p,growing:m,bySpecies:v,count:f.length},crops:{all:y,mature:b,growing:A,mutated:{all:P,byMutation:I}},eggs:{all:T,mature:N,growing:z,byType:O,count:T.length},decors:{tileObjects:M,boardwalk:F,all:B,byType:L,count:B.length},tiles:{tileObjects:l,boardwalk:u,empty:{tileObjects:j,boardwalk:V}},counts:{plants:f.length,maturePlants:p.length,crops:y.length,matureCrops:b.length,eggs:T.length,matureEggs:N.length,decors:B.length,emptyTileObjects:j.length,emptyBoardwalk:V.length}}}function hA(e,t){const n=new Set(e.map(a=>a.tileIndex)),r=new Set(t.map(a=>a.tileIndex)),o=t.filter(a=>!n.has(a.tileIndex)),i=e.filter(a=>!r.has(a.tileIndex));return {added:o,removed:i}}function mA(e,t,n){const r=new Set(e.map(i=>i.tileIndex)),o=new Set(n.map(i=>i.tileIndex));return t.filter(i=>!r.has(i.tileIndex)&&o.has(i.tileIndex))}function gA(e,t,n){const r=new Set(e.map(i=>`${i.tileIndex}:${i.slotIndex}`)),o=new Set(n.map(i=>`${i.tileIndex}:${i.slotIndex}`));return t.filter(i=>{const a=`${i.tileIndex}:${i.slotIndex}`;return !r.has(a)&&o.has(a)})}function bA(e,t,n){const r=new Set(e.map(i=>i.tileIndex)),o=new Set(n.map(i=>i.tileIndex));return t.filter(i=>!r.has(i.tileIndex)&&o.has(i.tileIndex))}function vA(e,t){const n=[],r=new Map(e.map(o=>[o.tileIndex,o]));for(const o of t){const i=r.get(o.tileIndex);if(!i)continue;const a=Math.min(i.slots.length,o.slots.length);for(let l=0;l<a;l++){const u=new Set(i.slots[l].mutations),f=new Set(o.slots[l].mutations),p=[...f].filter(v=>!u.has(v)),m=[...u].filter(v=>!f.has(v));if(p.length>0||m.length>0){const v=Date.now(),y=o.slots[l],b={tileIndex:o.tileIndex,position:o.position,slotIndex:l,species:y.species,startTime:y.startTime,endTime:y.endTime,targetScale:y.targetScale,mutations:[...y.mutations],isMature:v>=y.endTime,fruitCount:1};n.push({crop:b,added:p,removed:m});}}}return n}function yA(e,t,n){const r=[],o=new Map(t.map(a=>[a.tileIndex,a])),i=new Map;for(const a of n)i.set(`${a.tileIndex}:${a.slotIndex}`,a);for(const a of e){const l=o.get(a.tileIndex);if(!l)continue;const u=Math.min(a.slots.length,l.slots.length);for(let f=0;f<u;f++){const p=a.slots[f],m=l.slots[f];if(p.startTime!==m.startTime){const v=i.get(`${a.tileIndex}:${f}`);if(!v||!v.isMature)continue;const y={tileIndex:a.tileIndex,position:a.position,slotIndex:f,species:p.species,startTime:p.startTime,endTime:p.endTime,targetScale:p.targetScale,mutations:[...p.mutations],isMature:true,fruitCount:1};r.push({crop:y,remainingSlots:l.slotsCount});}}if(l.slotsCount<a.slotsCount)for(let f=l.slotsCount;f<a.slotsCount;f++){const p=i.get(`${a.tileIndex}:${f}`);if(!p||!p.isMature)continue;const m=a.slots[f];if(!m)continue;const v={tileIndex:a.tileIndex,position:a.position,slotIndex:f,species:m.species,startTime:m.startTime,endTime:m.endTime,targetScale:m.targetScale,mutations:[...m.mutations],isMature:true,fruitCount:1};r.push({crop:v,remainingSlots:l.slotsCount});}}return r}function xA(e,t){const n=new Set(e.map(a=>a.tileIndex)),r=new Set(t.map(a=>a.tileIndex)),o=t.filter(a=>!n.has(a.tileIndex)),i=e.filter(a=>!r.has(a.tileIndex));return {added:o,removed:i}}function wA(e,t){const n=u=>`${u.tileIndex}:${u.location}`,r=u=>`${u.tileIndex}:${u.location}`,o=new Set(e.map(n)),i=new Set(t.map(r)),a=t.filter(u=>!o.has(r(u))),l=e.filter(u=>!i.has(n(u)));return {added:a,removed:l}}function CA(){let e=Yc(),t=Yc(),n=false;const r=[],o={all:new Set,stable:new Set,plantAdded:new Set,plantRemoved:new Set,plantMatured:new Set,cropMutated:new Set,cropMatured:new Set,cropHarvested:new Set,eggPlaced:new Set,eggRemoved:new Set,eggMatured:new Set,decorPlaced:new Set,decorRemoved:new Set},i={},a=new Set,l=2;function u(){if(a.size<l)return;const p=Jp(i,Kc);if(wn(e,p)||(t=e,e=p,!n))return;for(const N of o.all)N(e,t);if(Xp(t)!==Xp(e))for(const N of o.stable)N(e,t);const m=hA(t.plants.all,e.plants.all);for(const N of m.added)for(const z of o.plantAdded)z({plant:N});for(const N of m.removed)for(const z of o.plantRemoved)z({plant:N,tileIndex:N.tileIndex});const v=mA(t.plants.mature,e.plants.mature,e.plants.all);for(const N of v)for(const z of o.plantMatured)z({plant:N});const y=vA(t.plants.all,e.plants.all);for(const N of y)for(const z of o.cropMutated)z(N);const b=gA(t.crops.mature,e.crops.mature,e.crops.all);for(const N of b)for(const z of o.cropMatured)z({crop:N});const A=yA(t.plants.all,e.plants.all,t.crops.all);for(const N of A)for(const z of o.cropHarvested)z(N);const P=xA(t.eggs.all,e.eggs.all);for(const N of P.added)for(const z of o.eggPlaced)z({egg:N});for(const N of P.removed)for(const z of o.eggRemoved)z({egg:N});const I=bA(t.eggs.mature,e.eggs.mature,e.eggs.all);for(const N of I)for(const z of o.eggMatured)z({egg:N});const T=wA(t.decors.all,e.decors.all);for(const N of T.added)for(const z of o.decorPlaced)z({decor:N});for(const N of T.removed)for(const z of o.decorRemoved)z({decor:N});}async function f(){if(n)return;const p=await ox.onChangeNow(v=>{i.garden=v,a.add("garden"),u();});r.push(p);const m=await Xe.subscribe("myUserSlotIdxAtom",v=>{i.mySlotIndex=v,a.add("mySlotIndex"),u();});r.push(m),n=true,a.size===l&&(e=Jp(i,Kc));}return f(),{get(){return e},subscribe(p,m){return o.all.add(p),m?.immediate!==false&&n&&a.size===l&&p(e,e),()=>o.all.delete(p)},subscribeStable(p,m){return o.stable.add(p),m?.immediate!==false&&n&&a.size===l&&p(e,e),()=>o.stable.delete(p)},subscribePlantAdded(p,m){if(o.plantAdded.add(p),m?.immediate&&n&&a.size===l)for(const v of e.plants.all)p({plant:v});return ()=>o.plantAdded.delete(p)},subscribePlantRemoved(p,m){return o.plantRemoved.add(p),()=>o.plantRemoved.delete(p)},subscribePlantMatured(p,m){if(o.plantMatured.add(p),m?.immediate&&n&&a.size===l)for(const v of e.plants.mature)p({plant:v});return ()=>o.plantMatured.delete(p)},subscribeCropMutated(p,m){if(o.cropMutated.add(p),m?.immediate&&n&&a.size===l)for(const v of e.crops.mutated.all)p({crop:v,added:v.mutations,removed:[]});return ()=>o.cropMutated.delete(p)},subscribeCropMatured(p,m){if(o.cropMatured.add(p),m?.immediate&&n&&a.size===l)for(const v of e.crops.mature)p({crop:v});return ()=>o.cropMatured.delete(p)},subscribeCropHarvested(p,m){return o.cropHarvested.add(p),()=>o.cropHarvested.delete(p)},subscribeEggPlaced(p,m){if(o.eggPlaced.add(p),m?.immediate&&n&&a.size===l)for(const v of e.eggs.all)p({egg:v});return ()=>o.eggPlaced.delete(p)},subscribeEggRemoved(p,m){return o.eggRemoved.add(p),()=>o.eggRemoved.delete(p)},subscribeEggMatured(p,m){if(o.eggMatured.add(p),m?.immediate&&n&&a.size===l)for(const v of e.eggs.mature)p({egg:v});return ()=>o.eggMatured.delete(p)},subscribeDecorPlaced(p,m){if(o.decorPlaced.add(p),m?.immediate&&n&&a.size===l)for(const v of e.decors.all)p({decor:v});return ()=>o.decorPlaced.delete(p)},subscribeDecorRemoved(p,m){return o.decorRemoved.add(p),()=>o.decorRemoved.delete(p)},destroy(){for(const p of r)p();r.length=0,o.all.clear(),o.stable.clear(),o.plantAdded.clear(),o.plantRemoved.clear(),o.plantMatured.clear(),o.cropMutated.clear(),o.cropMatured.clear(),o.cropHarvested.clear(),o.eggPlaced.clear(),o.eggRemoved.clear(),o.eggMatured.clear(),o.decorPlaced.clear(),o.decorRemoved.clear(),n=false;}}}let Zl=null;function Ur(){return Zl||(Zl=CA()),Zl}const Zp={inventory:"myPetInventoryAtom",hutch:"myPetHutchPetItemsAtom",active:"myPrimitivePetSlotsAtom",slotInfos:"myPetSlotInfosAtom",myNumPetHutchItems:"myNumPetHutchItemsAtom",activityLogs:"myDataAtom"};function ef(e,t){const n=Zs(e.xp),r=el(e.petSpecies,e.targetScale),o=tl(e.petSpecies,e.xp,r),i=nl(e.petSpecies,n),u=Oe.get("pets")?.[e.petSpecies]?.coinsToFullyReplenishHunger??1,f=e.hunger/u*100;return {id:e.id,petSpecies:e.petSpecies,name:e.name,xp:e.xp,hunger:e.hunger,hungerPercent:f,mutations:[...e.mutations],targetScale:e.targetScale,abilities:[...e.abilities],location:t,position:null,lastAbilityTrigger:null,growthStage:n,currentStrength:o,maxStrength:r,isMature:i}}function kA(e,t){const n=t[e.id],r=n?.lastAbilityTrigger??null,o=n?.position??null,i=Zs(e.xp),a=el(e.petSpecies,e.targetScale),l=tl(e.petSpecies,e.xp,a),u=nl(e.petSpecies,i),m=Oe.get("pets")?.[e.petSpecies]?.coinsToFullyReplenishHunger??1,v=e.hunger/m*100;return {id:e.id,petSpecies:e.petSpecies,name:e.name,xp:e.xp,hunger:e.hunger,hungerPercent:v,mutations:[...e.mutations],targetScale:e.targetScale,abilities:[...e.abilities],location:"active",position:o?{x:o.x,y:o.y}:null,lastAbilityTrigger:r,growthStage:i,currentStrength:l,maxStrength:a,isMature:u}}const tf=500;let Ln=[],Xa=0;function SA(){try{const e=at($t.GLOBAL.MY_PETS_ABILITY_LOGS,[]);if(!Array.isArray(e))return [];const t=e.filter(n=>typeof n=="object"&&n!==null&&typeof n.petId=="string"&&typeof n.petName=="string"&&typeof n.petSpecies=="string"&&typeof n.abilityId=="string"&&typeof n.performedAt=="number");return t.length<e.length&&console.log(`[myPets] Migrated ability logs: removed ${e.length-t.length} old entries`),t.length>0&&(Xa=Math.max(...t.map(n=>n.performedAt))),t}catch(e){return console.error("[myPets] Failed to load ability logs from storage:",e),[]}}function AA(e){try{st($t.GLOBAL.MY_PETS_ABILITY_LOGS,e);}catch(t){console.error("[myPets] Failed to save ability logs to storage:",t);}}function EA(e){try{const n=e.parameters.pet;return !n||!n.id||!n.petSpecies?null:{petId:n.id,petName:n.name||n.petSpecies,petSpecies:n.petSpecies,abilityId:e.action,data:e.parameters,performedAt:e.timestamp}}catch(t){return console.error("[myPets] Failed to convert activity log:",t),null}}function _A(e){if(!e||!Array.isArray(e))return;const t=_h(e),n=[];for(const r of t)if(r.timestamp>Xa){const o=EA(r);o&&n.push(o);}n.length!==0&&(Xa=Math.max(...n.map(r=>r.performedAt),Xa),Ln=[...n,...Ln],Ln.length>tf&&(Ln=Ln.slice(0,tf)),AA(Ln),console.log(`[myPets] Processed ${n.length} new ability logs (total: ${Ln.length})`));}function nf(e){const t=new Set,n=[];for(const m of e.active??[]){const v=kA(m,e.slotInfos??{});n.push(v),t.add(v.id);}const r=[];for(const m of e.inventory??[]){if(t.has(m.id))continue;const v=ef(m,"inventory");r.push(v),t.add(v.id);}const o=[];for(const m of e.hutch??[]){if(t.has(m.id))continue;const v=ef(m,"hutch");o.push(v),t.add(v.id);}const i=[...n,...r,...o],u=Ur().get().decors.all.some(m=>m.decorId==="PetHutch"),f=e.myNumPetHutchItems??0;return {all:i,byLocation:{inventory:r,hutch:o,active:n},counts:{inventory:r.length,hutch:o.length,active:n.length,total:i.length},hutch:{hasHutch:u,currentItems:f,maxItems:25},abilityLogs:[...Ln]}}const rf={all:[],byLocation:{inventory:[],hutch:[],active:[]},counts:{inventory:0,hutch:0,active:0,total:0},hutch:{hasHutch:false,currentItems:0,maxItems:25},abilityLogs:[]};function IA(e,t){if(e.length!==t.length)return  false;for(let n=0;n<e.length;n++)if(e[n]!==t[n])return  false;return  true}function of(e){return JSON.stringify({id:e.id,petSpecies:e.petSpecies,name:e.name,mutations:e.mutations,abilities:e.abilities,location:e.location})}function TA(e,t){if(e.all.length!==t.all.length)return  false;const n=e.all.map(of),r=t.all.map(of);return IA(n,r)}function PA(e,t){const n=[],r=new Map(e.all.map(o=>[o.id,o]));for(const o of t.all){const i=r.get(o.id);i&&i.location!==o.location&&n.push({pet:o,from:i.location,to:o.location});}return n}function LA(e,t){const n=[],r=new Map(e.all.map(o=>[o.id,o]));for(const o of t.all){if(!o.lastAbilityTrigger)continue;const a=r.get(o.id)?.lastAbilityTrigger;(!a||a.abilityId!==o.lastAbilityTrigger.abilityId||a.performedAt!==o.lastAbilityTrigger.performedAt)&&n.push({pet:o,trigger:o.lastAbilityTrigger});}return n}function MA(e,t){const n=new Set(e.all.map(a=>a.id)),r=new Set(t.all.map(a=>a.id)),o=t.all.filter(a=>!n.has(a.id)),i=e.all.filter(a=>!r.has(a.id));return o.length===0&&i.length===0?null:{added:o,removed:i,counts:t.counts}}function RA(e,t){const n=[],r=new Map(e.all.map(o=>[o.id,o]));for(const o of t.all){const i=r.get(o.id);i&&o.growthStage>i.growthStage&&n.push({pet:o,previousStage:i.growthStage,newStage:o.growthStage});}return n}function FA(e,t){const n=[],r=new Map(e.all.map(o=>[o.id,o]));for(const o of t.all){const i=r.get(o.id);i&&o.currentStrength>i.currentStrength&&n.push({pet:o,previousStrength:i.currentStrength,newStrength:o.currentStrength});}return n}function OA(e,t){const n=[],r=new Map(e.all.map(o=>[o.id,o]));for(const o of t.all){const i=r.get(o.id);i&&o.currentStrength===o.maxStrength&&i.currentStrength<i.maxStrength&&n.push({pet:o});}return n}function NA(){let e=rf,t=rf,n=false;const r=[],o={all:new Set,stable:new Set,location:new Set,ability:new Set,count:new Set,growth:new Set,strengthGain:new Set,maxStrength:new Set},i={},a=Object.keys(Zp),l=new Set;function u(){if(l.size<a.length)return;if(i.activityLogs){const I=i.activityLogs?.activityLogs||i.activityLogs;Array.isArray(I)&&_A(I);}const p=nf(i);if(wn(e,p)||(t=e,e=p,!n))return;for(const I of o.all)I(e,t);if(!TA(t,e))for(const I of o.stable)I(e,t);const m=PA(t,e);for(const I of m)for(const T of o.location)T(I);const v=LA(t,e);for(const I of v)for(const T of o.ability)T(I);const y=MA(t,e);if(y)for(const I of o.count)I(y);const b=RA(t,e);for(const I of b)for(const T of o.growth)T(I);const A=FA(t,e);for(const I of A)for(const T of o.strengthGain)T(I);const P=OA(t,e);for(const I of P)for(const T of o.maxStrength)T(I);}async function f(){if(n)return;Ln=SA(),console.log(`[myPets] Loaded ${Ln.length} ability logs from storage`);const p=a.map(async m=>{const v=Zp[m],y=await Xe.subscribe(v,b=>{i[m]=b,l.add(m),u();});r.push(y);});await Promise.all(p),n=true,l.size===a.length&&(e=nf(i));}return f(),{get(){return e},subscribe(p,m){return o.all.add(p),m?.immediate!==false&&n&&l.size===a.length&&p(e,e),()=>o.all.delete(p)},subscribeStable(p,m){return o.stable.add(p),m?.immediate!==false&&n&&l.size===a.length&&p(e,e),()=>o.stable.delete(p)},subscribeLocation(p,m){if(o.location.add(p),m?.immediate&&n&&l.size===a.length)for(const v of e.all)p({pet:v,from:v.location,to:v.location});return ()=>o.location.delete(p)},subscribeAbility(p,m){if(o.ability.add(p),m?.immediate&&n&&l.size===a.length)for(const v of e.all)v.lastAbilityTrigger&&p({pet:v,trigger:v.lastAbilityTrigger});return ()=>o.ability.delete(p)},subscribeCount(p,m){return o.count.add(p),m?.immediate&&n&&l.size===a.length&&p({added:e.all,removed:[],counts:e.counts}),()=>o.count.delete(p)},subscribeGrowth(p,m){if(o.growth.add(p),m?.immediate&&n&&l.size===a.length)for(const v of e.all)p({pet:v,previousStage:v.growthStage,newStage:v.growthStage});return ()=>o.growth.delete(p)},subscribeStrengthGain(p,m){if(o.strengthGain.add(p),m?.immediate&&n&&l.size===a.length)for(const v of e.all)p({pet:v,previousStrength:v.currentStrength,newStrength:v.currentStrength});return ()=>o.strengthGain.delete(p)},subscribeMaxStrength(p,m){if(o.maxStrength.add(p),m?.immediate&&n&&l.size===a.length)for(const v of e.all)v.currentStrength===v.maxStrength&&p({pet:v});return ()=>o.maxStrength.delete(p)},destroy(){for(const p of r)p();r.length=0,o.all.clear(),o.stable.clear(),o.location.clear(),o.ability.clear(),o.count.clear(),o.growth.clear(),o.strengthGain.clear(),o.maxStrength.clear(),n=false;}}}let ec=null;function Wr(){return ec||(ec=NA()),ec}const af={inventory:"myInventoryAtom",isFull:"isMyInventoryAtMaxLengthAtom",selectedItemIndex:"myValidatedSelectedItemIndexAtom"},sf={items:[],favoritedItemIds:[],count:0,isFull:false,selectedItem:null};function lf(e){const t=e.inventory,n=t?.items??[],r=t?.favoritedItemIds??[],o=e.selectedItemIndex;let i=null;return o!==null&&o>=0&&o<n.length&&(i={index:o,item:n[o]}),{items:n,favoritedItemIds:r,count:n.length,isFull:e.isFull??false,selectedItem:i}}function cf(e){const t=e.items.map(n=>"id"in n?n.id:"species"in n&&n.itemType==="Seed"?`seed:${n.species}:${n.quantity}`:"toolId"in n?`tool:${n.toolId}:${n.quantity}`:"eggId"in n?`egg:${n.eggId}:${n.quantity}`:"decorId"in n?`decor:${n.decorId}:${n.quantity}`:JSON.stringify(n));return JSON.stringify({itemKeys:t,favoritedItemIds:e.favoritedItemIds,isFull:e.isFull,selectedItemIndex:e.selectedItem?.index??null})}function DA(e,t){return cf(e)===cf(t)}function $A(e,t){return e===null&&t===null?false:e===null||t===null?true:e.index!==t.index}function Ia(e){return "id"in e?e.id:"species"in e&&e.itemType==="Seed"?`seed:${e.species}`:"toolId"in e?`tool:${e.toolId}`:"eggId"in e?`egg:${e.eggId}`:"decorId"in e?`decor:${e.decorId}`:JSON.stringify(e)}function BA(e,t){const n=new Set(e.map(Ia)),r=new Set(t.map(Ia)),o=t.filter(a=>!n.has(Ia(a))),i=e.filter(a=>!r.has(Ia(a)));return o.length===0&&i.length===0?null:{added:o,removed:i,counts:{before:e.length,after:t.length}}}function zA(e,t){const n=new Set(e),r=new Set(t),o=t.filter(a=>!n.has(a)),i=e.filter(a=>!r.has(a));return o.length===0&&i.length===0?null:{added:o,removed:i,current:t}}function jA(){let e=sf,t=sf,n=false;const r=[],o={all:new Set,stable:new Set,selection:new Set,items:new Set,favorites:new Set},i={},a=Object.keys(af),l=new Set;function u(){if(l.size<a.length)return;const p=lf(i);if(wn(e,p)||(t=e,e=p,!n))return;for(const y of o.all)y(e,t);if(!DA(t,e))for(const y of o.stable)y(e,t);if($A(t.selectedItem,e.selectedItem)){const y={current:e.selectedItem,previous:t.selectedItem};for(const b of o.selection)b(y);}const m=BA(t.items,e.items);if(m)for(const y of o.items)y(m);const v=zA(t.favoritedItemIds,e.favoritedItemIds);if(v)for(const y of o.favorites)y(v);}async function f(){if(n)return;const p=a.map(async m=>{const v=af[m],y=await Xe.subscribe(v,b=>{i[m]=b,l.add(m),u();});r.push(y);});await Promise.all(p),n=true,l.size===a.length&&(e=lf(i));}return f(),{get(){return e},subscribe(p,m){return o.all.add(p),m?.immediate!==false&&n&&l.size===a.length&&p(e,e),()=>o.all.delete(p)},subscribeStable(p,m){return o.stable.add(p),m?.immediate!==false&&n&&l.size===a.length&&p(e,e),()=>o.stable.delete(p)},subscribeSelection(p,m){return o.selection.add(p),m?.immediate&&n&&l.size===a.length&&p({current:e.selectedItem,previous:e.selectedItem}),()=>o.selection.delete(p)},subscribeItems(p,m){return o.items.add(p),m?.immediate&&n&&l.size===a.length&&p({added:e.items,removed:[],counts:{before:0,after:e.count}}),()=>o.items.delete(p)},subscribeFavorites(p,m){return o.favorites.add(p),m?.immediate&&n&&l.size===a.length&&p({added:e.favoritedItemIds,removed:[],current:e.favoritedItemIds}),()=>o.favorites.delete(p)},destroy(){for(const p of r)p();r.length=0,o.all.clear(),o.stable.clear(),o.selection.clear(),o.items.clear(),o.favorites.clear(),n=false;}}}let tc=null;function Lo(){return tc||(tc=jA()),tc}const qc={all:[],host:null,myPlayer:null,count:0};function GA(e,t,n){const r=n.get(e.id),o=r?.slot,i=o?.data,a=o?.lastActionEvent;return {id:e.id,name:e.name,discordId:e.databaseUserId,discordAvatarUrl:e.discordAvatarUrl,guildId:e.guildId,isConnected:e.isConnected,isHost:e.id===t,slotIndex:r?.index??null,position:o?.position??null,cosmetic:{color:e.cosmetic?.color??"",avatar:e.cosmetic?.avatar?[...e.cosmetic.avatar]:[]},emote:{type:e.emoteData?.emoteType??-1},coins:i?.coinsCount??0,inventory:i?.inventory??null,shopPurchases:i?.shopPurchases??null,garden:i?.garden??null,pets:{slots:i?.petSlots??[],slotInfos:o?.petSlotInfos??null},journal:i?.journal??null,stats:i?.stats??null,tasksCompleted:i?.tasksCompleted??[],activityLogs:i?.activityLogs??[],customRestocks:{config:i?.customRestocks??null,inventories:o?.customRestockInventories??null},lastAction:a?{type:a.action,data:a.data,timestamp:a.timestamp}:null,selectedItemIndex:o?.notAuthoritative_selectedItemIndex??null,lastSlotMachineInfo:o?.lastSlotMachineInfo??null}}function df(e){const t=e.players,n=e.hostPlayerId??"",r=e.userSlots??[],o=e.myUserSlotIndex;if(!t||!Array.isArray(t)||t.length===0)return qc;const i=new Map;Array.isArray(r)&&r.forEach((f,p)=>{f?.type==="user"&&f?.playerId&&i.set(f.playerId,{slot:f,index:p});});const a=t.map(f=>GA(f,n,i)),l=a.find(f=>f.isHost)??null,u=o!==null?a.find(f=>f.slotIndex===o)??null:null;return {all:a,host:l,myPlayer:u,count:a.length}}function uf(e){const t=e.all.map(n=>`${n.id}:${n.isConnected}:${n.isHost}`);return JSON.stringify({playerKeys:t,hostId:e.host?.id??null,count:e.count})}function UA(e,t){const n=[],r=new Set(e.map(i=>i.id)),o=new Set(t.map(i=>i.id));for(const i of t)r.has(i.id)||n.push({player:i,type:"join"});for(const i of e)o.has(i.id)||n.push({player:i,type:"leave"});return n}function WA(e,t){const n=[],r=new Map(e.map(o=>[o.id,o]));for(const o of t){const i=r.get(o.id);i&&i.isConnected!==o.isConnected&&n.push({player:o,isConnected:o.isConnected});}return n}function HA(){let e=qc,t=qc,n=false;const r=[],o={all:new Set,stable:new Set,joinLeave:new Set,connection:new Set,host:new Set},i={},a=new Set,l=4;function u(){if(a.size<l)return;const p=df(i);if(wn(e,p)||(t=e,e=p,!n))return;for(const A of o.all)A(e,t);if(uf(t)!==uf(e))for(const A of o.stable)A(e,t);const m=UA(t.all,e.all);for(const A of m)for(const P of o.joinLeave)P(A);const v=WA(t.all,e.all);for(const A of v)for(const P of o.connection)P(A);const y=t.host?.id??null,b=e.host?.id??null;if(y!==b){const A={current:e.host,previous:t.host};for(const P of o.host)P(A);}}async function f(){if(n)return;const p=await nx.onChangeNow(b=>{i.players=b,a.add("players"),u();});r.push(p);const m=await rx.onChangeNow(b=>{i.hostPlayerId=b,a.add("hostPlayerId"),u();});r.push(m);const v=await tx.onChangeNow(b=>{i.userSlots=b,a.add("userSlots"),u();});r.push(v);const y=await Xe.subscribe("myUserSlotIdxAtom",b=>{i.myUserSlotIndex=b,a.add("myUserSlotIndex"),u();});r.push(y),n=true,a.size===l&&(e=df(i));}return f(),{get(){return e},subscribe(p,m){return o.all.add(p),m?.immediate!==false&&n&&a.size===l&&p(e,e),()=>o.all.delete(p)},subscribeStable(p,m){return o.stable.add(p),m?.immediate!==false&&n&&a.size===l&&p(e,e),()=>o.stable.delete(p)},subscribeJoinLeave(p,m){if(o.joinLeave.add(p),m?.immediate&&n&&a.size===l)for(const v of e.all)p({player:v,type:"join"});return ()=>o.joinLeave.delete(p)},subscribeConnection(p,m){if(o.connection.add(p),m?.immediate&&n&&a.size===l)for(const v of e.all)p({player:v,isConnected:v.isConnected});return ()=>o.connection.delete(p)},subscribeHost(p,m){return o.host.add(p),m?.immediate&&n&&a.size===l&&p({current:e.host,previous:e.host}),()=>o.host.delete(p)},destroy(){for(const p of r)p();r.length=0,o.all.clear(),o.stable.clear(),o.joinLeave.clear(),o.connection.clear(),o.host.clear(),n=false;}}}let nc=null;function ag(){return nc||(nc=HA()),nc}const sg=Object.freeze(Object.defineProperty({__proto__:null,getPlayers:ag},Symbol.toStringTag,{value:"Module"})),Wi=["seed","tool","egg","decor"];function VA(e,t){switch(t){case "seed":return e.species??e.itemType;case "tool":return e.toolId??e.itemType;case "egg":return e.eggId??e.itemType;case "decor":return e.decorId??e.itemType;default:return e.itemType}}function KA(e,t,n){const r=VA(e,t),o=n[r]??0,i=Math.max(0,e.initialStock-o);return {id:r,itemType:e.itemType,initialStock:e.initialStock,purchased:o,remaining:i,isAvailable:i>0,price:e.price}}function YA(e,t,n){if(!t)return {type:e,items:[],availableCount:0,totalCount:0,secondsUntilRestock:0,restockAt:null};const o=n[e]?.purchases??{},i=(t.inventory??[]).map(f=>KA(f,e,o)),a=i.filter(f=>f.isAvailable).length,l=t.secondsUntilRestock??0,u=l>0?Date.now()+l*1e3:null;return {type:e,items:i,availableCount:a,totalCount:i.length,secondsUntilRestock:l,restockAt:u}}function pf(e){const t=e.shops,n=e.purchases??{},r=Wi.map(l=>YA(l,t?.[l],n)),o={seed:r[0],tool:r[1],egg:r[2],decor:r[3]},i=r.filter(l=>l.restockAt!==null);let a=null;if(i.length>0){const u=i.sort((f,p)=>(f.restockAt??0)-(p.restockAt??0))[0];a={shop:u.type,seconds:u.secondsUntilRestock,at:u.restockAt};}return {all:r,byType:o,nextRestock:a}}const ff={all:Wi.map(e=>({type:e,items:[],availableCount:0,totalCount:0,secondsUntilRestock:0,restockAt:null})),byType:{seed:{type:"seed",items:[],availableCount:0,totalCount:0,secondsUntilRestock:0,restockAt:null},tool:{type:"tool",items:[],availableCount:0,totalCount:0,secondsUntilRestock:0,restockAt:null},egg:{type:"egg",items:[],availableCount:0,totalCount:0,secondsUntilRestock:0,restockAt:null},decor:{type:"decor",items:[],availableCount:0,totalCount:0,secondsUntilRestock:0,restockAt:null}},nextRestock:null};function hf(e){return JSON.stringify({shops:e.all.map(t=>({type:t.type,itemCount:t.items.length,availableCount:t.availableCount}))})}function qA(e,t){const n=e.secondsUntilRestock,r=t.secondsUntilRestock;return n>0&&n<=5&&r>n||n>0&&r===0&&t.items.some(i=>i.purchased===0)?{shop:t,previousItems:e.items}:null}function XA(e,t){const n=[];for(const r of Wi){const o=e.byType[r],i=t.byType[r],a=new Map(o.items.map(l=>[l.id,l]));for(const l of i.items){const u=a.get(l.id);u&&l.purchased>u.purchased&&n.push({shopType:r,itemId:l.id,quantity:l.purchased-u.purchased,newPurchased:l.purchased,remaining:l.remaining});}}return n}function QA(e,t){const n=[];for(const r of Wi){const o=e.byType[r],i=t.byType[r],a=new Map(o.items.map(l=>[l.id,l]));for(const l of i.items){const u=a.get(l.id);u&&u.isAvailable!==l.isAvailable&&n.push({shopType:r,itemId:l.id,wasAvailable:u.isAvailable,isAvailable:l.isAvailable});}}return n}function JA(){let e=ff,t=ff,n=false;const r=[],o={all:new Set,stable:new Set,seedRestock:new Set,toolRestock:new Set,eggRestock:new Set,decorRestock:new Set,purchase:new Set,availability:new Set},i={},a=new Set,l=2;function u(){if(a.size<l)return;const p=pf(i);if(wn(e,p)||(t=e,e=p,!n))return;for(const b of o.all)b(e,t);if(hf(t)!==hf(e))for(const b of o.stable)b(e,t);const m={seed:o.seedRestock,tool:o.toolRestock,egg:o.eggRestock,decor:o.decorRestock};for(const b of Wi){const A=qA(t.byType[b],e.byType[b]);if(A)for(const P of m[b])P(A);}const v=XA(t,e);for(const b of v)for(const A of o.purchase)A(b);const y=QA(t,e);for(const b of y)for(const A of o.availability)A(b);}async function f(){if(n)return;const p=await ix.onChangeNow(v=>{i.shops=v,a.add("shops"),u();});r.push(p);const m=await ax.onChangeNow(v=>{i.purchases=v,a.add("purchases"),u();});r.push(m),n=true,a.size===l&&(e=pf(i));}return f(),{get(){return e},getShop(p){return e.byType[p]},getItem(p,m){return e.byType[p].items.find(y=>y.id===m)??null},subscribe(p,m){return o.all.add(p),m?.immediate!==false&&n&&a.size===l&&p(e,e),()=>o.all.delete(p)},subscribeStable(p,m){return o.stable.add(p),m?.immediate!==false&&n&&a.size===l&&p(e,e),()=>o.stable.delete(p)},subscribeSeedRestock(p,m){return o.seedRestock.add(p),m?.immediate&&n&&a.size===l&&p({shop:e.byType.seed,previousItems:[]}),()=>o.seedRestock.delete(p)},subscribeToolRestock(p,m){return o.toolRestock.add(p),m?.immediate&&n&&a.size===l&&p({shop:e.byType.tool,previousItems:[]}),()=>o.toolRestock.delete(p)},subscribeEggRestock(p,m){return o.eggRestock.add(p),m?.immediate&&n&&a.size===l&&p({shop:e.byType.egg,previousItems:[]}),()=>o.eggRestock.delete(p)},subscribeDecorRestock(p,m){return o.decorRestock.add(p),m?.immediate&&n&&a.size===l&&p({shop:e.byType.decor,previousItems:[]}),()=>o.decorRestock.delete(p)},subscribePurchase(p,m){if(o.purchase.add(p),m?.immediate&&n&&a.size===l)for(const v of e.all)for(const y of v.items)y.purchased>0&&p({shopType:v.type,itemId:y.id,quantity:y.purchased,newPurchased:y.purchased,remaining:y.remaining});return ()=>o.purchase.delete(p)},subscribeAvailability(p,m){if(o.availability.add(p),m?.immediate&&n&&a.size===l)for(const v of e.all)for(const y of v.items)p({shopType:v.type,itemId:y.id,wasAvailable:y.isAvailable,isAvailable:y.isAvailable});return ()=>o.availability.delete(p)},destroy(){for(const p of r)p();r.length=0,o.all.clear(),o.stable.clear(),o.seedRestock.clear(),o.toolRestock.clear(),o.eggRestock.clear(),o.decorRestock.clear(),o.purchase.clear(),o.availability.clear(),n=false;}}}let rc=null;function Mo(){return rc||(rc=JA()),rc}function lg(e){const t=e||"Sunny",o=Oe.get("weather")?.[t]?.name||t;return {id:t,name:o,isActive:t!=="Sunny",type:t,startTime:null,endTime:null,remainingSeconds:0}}function mf(){return lg(null)}function ZA(){let e=mf(),t=mf(),n=null,r=false,o=null;const i={all:new Set,stable:new Set};function a(u){const f=(u||"Sunny")!==(n||"Sunny");n=u;const p=lg(u),m=e.id!==p.id;if(t=e,e=p,!!r){if(f)for(const v of i.all)v(e,t);if(m){const v={current:e,previous:t};for(const y of i.stable)y(v);}}}async function l(){r||(o=await Xe.subscribe("weatherAtom",u=>{a(u);}),r=true);}return l(),{get(){return e},subscribe(u,f){return i.all.add(u),f?.immediate!==false&&r&&u(e,e),()=>i.all.delete(u)},subscribeStable(u,f){return i.stable.add(u),f?.immediate&&r&&u({current:e,previous:e}),()=>i.stable.delete(u)},destroy(){o?.(),o=null,i.all.clear(),i.stable.clear(),r=false;}}}let oc=null;function Hi(){return oc||(oc=ZA()),oc}let Dt=null;function cg(){return Dt||(Dt={currentTile:bt(),myPets:Wr(),gameMap:Kc(),myInventory:Lo(),players:ag(),shops:Mo(),weather:Hi(),myGarden:Ur()},Dt)}function Yn(){if(!Dt)throw new Error("[Globals] Not initialized. Call initGlobals() first.");return Dt}function eE(){Dt&&(Dt.currentTile.destroy(),Dt.myPets.destroy(),Dt.gameMap.destroy(),Dt.myInventory.destroy(),Dt.players.destroy(),Dt.shops.destroy(),Dt.weather.destroy(),Dt.myGarden.destroy(),Dt=null);}const Gt={get currentTile(){return Yn().currentTile},get myPets(){return Yn().myPets},get gameMap(){return Yn().gameMap},get myInventory(){return Yn().myInventory},get players(){return Yn().players},get shops(){return Yn().shops},get weather(){return Yn().weather},get myGarden(){return Yn().myGarden}};function tE(e){const t=Qd(e);return {ok:t.ok,itemId:e,reason:t.ok?void 0:t.reason}}function nE(e){const r=Gt.shops.getShop("seed").items.find(l=>l.id===e);if(!r)return {ok:false,itemId:e,totalPurchased:0,errors:[`Seed not found in shop: ${e}`]};const o=r.remaining,i=[];let a=0;for(let l=0;l<o;l++){const u=Qd(e);u.ok?a++:i.push(u.reason||`Failed to purchase seed ${l+1}`);}return {ok:a>0,itemId:e,totalPurchased:a,errors:i}}function rE(e){const t=qd(e);return {ok:t.ok,itemId:e,reason:t.ok?void 0:t.reason}}function oE(e){const r=Gt.shops.getShop("egg").items.find(l=>l.id===e);if(!r)return {ok:false,itemId:e,totalPurchased:0,errors:[`Egg not found in shop: ${e}`]};const o=r.remaining,i=[];let a=0;for(let l=0;l<o;l++){const u=qd(e);u.ok?a++:i.push(u.reason||`Failed to purchase egg ${l+1}`);}return {ok:a>0,itemId:e,totalPurchased:a,errors:i}}function iE(e){const t=Yd(e);return {ok:t.ok,itemId:e,reason:t.ok?void 0:t.reason}}function aE(e){const r=Gt.shops.getShop("decor").items.find(l=>l.id===e);if(!r)return {ok:false,itemId:e,totalPurchased:0,errors:[`Decor not found in shop: ${e}`]};const o=r.remaining,i=[];let a=0;for(let l=0;l<o;l++){const u=Yd(e);u.ok?a++:i.push(u.reason||`Failed to purchase decor ${l+1}`);}return {ok:a>0,itemId:e,totalPurchased:a,errors:i}}function sE(e){const t=Xd(e);return {ok:t.ok,itemId:e,reason:t.ok?void 0:t.reason}}function lE(e){const r=Gt.shops.getShop("tool").items.find(l=>l.id===e);if(!r)return {ok:false,itemId:e,totalPurchased:0,errors:[`Tool not found in shop: ${e}`]};const o=r.remaining,i=[];let a=0;for(let l=0;l<o;l++){const u=Xd(e);u.ok?a++:i.push(u.reason||`Failed to purchase tool ${l+1}`);}return {ok:a>0,itemId:e,totalPurchased:a,errors:i}}let ic=false;const Er={init(){ic||(ic=true,console.log("[MGShopActions] Initialized"));},isReady(){return ic},seed:{buy:tE,buyAll:nE},egg:{buy:rE,buyAll:oE},decor:{buy:iE,buyAll:aE},tool:{buy:sE,buyAll:lE}};async function dg(e){const t=[{name:"Data",init:()=>Oe.init()},{name:"CustomModal",init:()=>io.init()},{name:"Sprites",init:()=>Qe.init()},{name:"TileObjectSystem",init:()=>Zn.init()},{name:"Pixi",init:()=>Vs.init()},{name:"RiveLoader",init:()=>yo.init()},{name:"Audio",init:()=>xt.init()},{name:"Cosmetics",init:()=>Zd.init()},{name:"ShopActions",init:()=>Er.init()}];await Promise.all(t.map(async n=>{e?.({status:"start",name:n.name});try{await n.init(),e?.({status:"success",name:n.name});}catch(r){console.error(`[${n.name}] failed`,r),e?.({status:"error",name:n.name,error:r});}})),console.log("[Gemini] Modules ready. Access via Gemini.Modules in console.");}const ug=Object.freeze(Object.defineProperty({__proto__:null,MGAssets:Io,MGAudio:xt,MGCalculators:og,MGCosmetic:Zd,MGCustomModal:io,MGData:Oe,MGEnvironment:Rt,MGManifest:bo,MGPixi:Vs,MGPixiHooks:Mn,MGRiveLoader:yo,MGShopActions:Er,MGSprite:Qe,MGTile:Zn,MGVersion:Cd,PET_ABILITY_ACTIONS:Ah,filterPetAbilityLogs:_h,formatAbilityLog:Ih,initAllModules:dg,isPetAbilityAction:Eh},Symbol.toStringTag,{value:"Module"}));function cE(e){const t=String(e??"").trim().toLowerCase();return t?t==="common"?"Common":t==="uncommon"?"Uncommon":t==="rare"?"Rare":t==="legendary"?"Legendary":t==="mythical"||t==="mythic"?"Mythical":t==="divine"?"Divine":t==="celestial"?"Celestial":t==="unknown"||t==="unknow"?"Unknown":null:null}function dE(e){return e.toLowerCase()}function iu(e={}){const{id:t,label:n="",type:r="neutral",tone:o="soft",border:i,withBorder:a,pill:l=true,size:u="md",onClick:f,variant:p="default",rarity:m=null,abilityId:v="",abilityName:y=""}=e,b=w("span",{className:"badge",id:t});l&&b.classList.add("badge--pill"),u==="sm"?b.classList.add("badge--sm"):u==="lg"?b.classList.add("badge--lg"):b.classList.add("badge--md"),f&&b.addEventListener("click",f);let A=false,P=a;function I(){A||(P===false?b.style.border="none":b.style.border="");}function T(C,E=o){b.classList.remove("badge--neutral","badge--info","badge--success","badge--warning","badge--danger","badge--soft","badge--outline","badge--solid"),b.classList.add(`badge--${C}`,`badge--${E}`),I();}function N(C){const E=(C??"").trim();E?(b.style.border=E,A=true):(A=false,I());}function z(C){P=C,I();}function O(C){b.textContent=C;}function M(C,E=o){T(C,E);}function F(C){b.classList.remove("badge--rarity","badge--rarity-common","badge--rarity-uncommon","badge--rarity-rare","badge--rarity-legendary","badge--rarity-mythical","badge--rarity-divine","badge--rarity-celestial","badge--rarity-unknown"),b.style.background="",b.style.backgroundSize="",b.style.animation="",b.style.color="",b.style.webkitTextStroke="";const E=cE(C);if(!E){b.textContent=String(C??"—");return}b.textContent=E,b.classList.add("badge--rarity",`badge--rarity-${dE(E)}`);}function L(C,E){const j=Oe.get("abilities")?.[C],V=j?.color,U=V||"rgba(100, 100, 100, 0.9)",ce=V?`${V}`:"rgba(150, 150, 150, 1)";b.classList.remove("badge--neutral","badge--info","badge--success","badge--warning","badge--danger","badge--soft","badge--outline","badge--solid","badge--rarity","badge--rarity-common","badge--rarity-uncommon","badge--rarity-rare","badge--rarity-legendary","badge--rarity-mythical","badge--rarity-divine","badge--rarity-celestial","badge--rarity-unknown"),b.classList.add("badge--ability"),b.textContent=E||j?.name||C||"Unknown Ability",b.style.background=U,b.style.color="white",b.style.border="none",b.style.webkitTextStroke="",b.style.animation="",b.style.backgroundSize="";const Y=()=>{b.style.background=ce;},ie=()=>{b.style.background=U;};b.removeEventListener("mouseenter",Y),b.removeEventListener("mouseleave",ie),b.addEventListener("mouseenter",Y),b.addEventListener("mouseleave",ie);}return p==="rarity"?F(m):p==="ability"?L(v,y):(b.textContent=n,T(r,o),typeof a=="boolean"&&z(a),i&&N(i)),{root:b,setLabel:O,setType:M,setBorder:N,setWithBorder:z,setRarity:F,setAbility:L}}const uE={expanded:false,sort:{key:null,dir:null},search:""},pE={categories:{}};async function fE(){const e=await _o("tab-test",{version:2,defaults:pE,sanitize:i=>({categories:i.categories&&typeof i.categories=="object"?i.categories:{}})});function t(i){return e.get().categories[i]||{...uE}}function n(i,a){const l=e.get(),u=t(i);e.update({categories:{...l.categories,[i]:{...u,expanded:a}}});}function r(i,a,l){const u=e.get(),f=t(i);e.update({categories:{...u.categories,[i]:{...f,sort:{key:a,dir:l}}}});}function o(i,a){const l=e.get(),u=t(i);e.update({categories:{...l.categories,[i]:{...u,search:a}}});}return {get:e.get,set:e.set,save:e.save,getCategoryState:t,setCategoryExpanded:n,setCategorySort:r,setCategorySearch:o}}const hE={Common:1,Uncommon:2,Rare:3,Legendary:4,Mythical:5,Divine:6,Celestial:7};function Ta(e){return e?hE[e]??0:0}class mE extends Br{constructor(){super({id:"tab-test",label:"Test"});xe(this,"stateCtrl",null);}async build(n){this.stateCtrl=await fE();const r=this.createContainer("test-section");r.style.display="flex",r.style.flexDirection="column",r.style.gap="12px",n.appendChild(r),await this.buildSpriteTables(r);}renderSprite(n){const r=w("div",{style:"display:flex;align-items:center;justify-content:center;width:32px;height:32px;"});if(n.spriteId){const o=n.spriteId;requestAnimationFrame(async()=>{try{const i=await Qe.toCanvas(o,{scale:1});i.style.maxWidth="32px",i.style.maxHeight="32px",i.style.objectFit="contain",r.appendChild(i);}catch{r.textContent="-";}});}else r.textContent="-";return r}renderRarity(n){if(!n.rarity){const o=w("span",{style:"opacity:0.5;"});return o.textContent="—",o}return iu({variant:"rarity",rarity:n.rarity,size:"sm"}).root}createDataCard(n,r,o,i){const a=this.stateCtrl.getCategoryState(n),l=v=>{if(!v)return o;const y=v.toLowerCase();return o.filter(b=>b.name.toLowerCase().includes(y))},u=yd({columns:i,data:l(a.search),pageSize:0,compact:true,maxHeight:"calc(var(--lg-row-h, 40px) * 6)",getRowId:v=>v.spriteId,onSortChange:(v,y)=>{this.stateCtrl.setCategorySort(n,v,y);}});a.sort.key&&a.sort.dir&&u.sortBy(a.sort.key,a.sort.dir);const f=Gs({placeholder:"Search...",value:a.search,debounceMs:150,withClear:true,size:"sm",focusKey:"",onChange:v=>{const y=v.trim();this.stateCtrl.setCategorySearch(n,y),u.setData(l(y));}}),p=w("div",{style:"margin-bottom:8px;"});p.appendChild(f.root);const m=w("div");return m.appendChild(p),m.appendChild(u.root),pt({title:r,subtitle:`${o.length} entries`,variant:"soft",padding:"sm",expandable:true,defaultExpanded:a.expanded,onExpandChange:v=>{this.stateCtrl.setCategoryExpanded(n,v);}},m)}formatCategoryName(n){return n.split("-").map(r=>r.charAt(0).toUpperCase()+r.slice(1)).join(" ")}findPlantBySprite(n,r){const o=Oe.get("plants");if(!o)return null;for(const a of Object.values(o))if(a?.seed?.spriteId===n||a?.plant?.spriteId===n||a?.crop?.spriteId===n)return a;const i=r.toLowerCase();for(const a of Object.values(o)){const l=(a?.seed?.name||"").toLowerCase();if(l===i||l===`${i} seed`)return a}return null}findPetBySpriteId(n){const r=Oe.get("pets");if(!r)return null;for(const o of Object.values(r))if(o?.spriteId===n)return o;return null}findItemBySpriteId(n){const r=Oe.get("items");if(!r)return null;for(const o of Object.values(r))if(o?.spriteId===n)return o;return null}findDecorBySpriteId(n){const r=Oe.get("decor");if(!r)return null;for(const o of Object.values(r))if(o?.spriteId===n)return o;return null}findEggBySpriteId(n){const r=Oe.get("eggs");if(!r)return null;for(const o of Object.values(r))if(o?.spriteId===n)return o;return null}getRarityForSprite(n,r,o){const i=n.toLowerCase();if(i==="plant"||i==="seed"||i==="tallplant"){const a=this.findPlantBySprite(r,o);if(a?.seed?.rarity)return a.seed.rarity}if(i==="pet"){const a=this.findPetBySpriteId(r);if(a?.rarity)return a.rarity}if(i==="item"){const a=this.findItemBySpriteId(r);if(a?.rarity)return a.rarity}if(i==="decor"){const a=this.findDecorBySpriteId(r);if(a?.rarity)return a.rarity}if(i==="egg"){const a=this.findEggBySpriteId(r);if(a?.rarity)return a.rarity}return null}yieldToMain(n=0){return new Promise(r=>{n>0?setTimeout(r,n):typeof requestIdleCallback<"u"?requestIdleCallback(()=>r(),{timeout:50}):setTimeout(r,4);})}async buildSpriteTables(n){const r=[{key:"name",header:"Name",sortable:true,width:"1fr",sortFn:(i,a)=>i.name.localeCompare(a.name,void 0,{numeric:true,sensitivity:"base"})},{key:"rarity",header:"Rarity",sortable:true,width:"100px",align:"center",render:i=>this.renderRarity(i),sortFn:(i,a)=>Ta(i.rarity)-Ta(a.rarity)},{key:"sprite",header:"Sprite",width:"60px",align:"center",render:i=>this.renderSprite(i)}];if(!Qe.isReady())try{await Qe.init();}catch{return}const o=Qe.getCategories();for(let i=0;i<o.length;i++){await this.yieldToMain(8);const a=o[i],u=Qe.getCategoryId(a).map(f=>{const p=`sprite/${a}/${f}`;return {name:f,spriteId:p,rarity:this.getRarityForSprite(a,p,f)}});if(u.sort((f,p)=>Ta(f.rarity)-Ta(p.rarity)),u.length>0){const f=this.createDataCard(a,this.formatCategoryName(a),u,r);n.appendChild(f);}}}}function gE(){const e=document.createElementNS("http://www.w3.org/2000/svg","svg");e.setAttribute("viewBox","0 0 24 24"),e.setAttribute("width","24"),e.setAttribute("height","24"),e.setAttribute("fill","none"),e.setAttribute("stroke","currentColor"),e.setAttribute("stroke-width","2"),e.setAttribute("stroke-linecap","round"),e.style.color="var(--accent)";const t=document.createElementNS("http://www.w3.org/2000/svg","line");t.setAttribute("x1","12"),t.setAttribute("y1","5"),t.setAttribute("x2","12"),t.setAttribute("y2","19");const n=document.createElementNS("http://www.w3.org/2000/svg","line");return n.setAttribute("x1","5"),n.setAttribute("y1","12"),n.setAttribute("x2","19"),n.setAttribute("y2","12"),e.appendChild(t),e.appendChild(n),e}function bE(e,t){const n=e;let r=e;const o=js({value:e,placeholder:"Team name",mode:"alphanumeric",allowSpaces:true,maxLength:50,blockGameKeys:true,onChange:i=>{const a=i.trim();a&&a!==r&&(r=a,t?.(a));},onEnter:i=>{const a=i.trim()||n;a!==r&&(r=a,t?.(a));}});return o.root.className="team-list-item__name-input",o.input.addEventListener("blur",()=>{const i=o.getValue().trim()||n;i!==r&&(r=i,t?.(i));}),o.input.addEventListener("keydown",i=>{i.key==="Escape"&&(i.preventDefault(),o.input.blur());}),o.root}function vE(e){const t=w("div",{className:"team-list-item"}),n=e.customIndicator??w("div",{className:`team-list-item__indicator ${e.isActive?"team-list-item__indicator--active":"team-list-item__indicator--inactive"}`}),r=e.isNameEditable?bE(e.team.name,e.onNameChange):w("div",{textContent:e.team.name,className:`team-list-item__name ${e.isActive?"team-list-item__name--active":"team-list-item__name--inactive"}`}),o=w("div",{className:"team-list-item__sprites"});async function i(){const u=Gt.myPets.get();o.innerHTML="";for(let f=0;f<3;f++){const p=e.team.petIds[f],m=p&&p!=="",v=w("div",{className:`team-list-item__sprite-slot ${e.showSlotStyles&&!m?"team-list-item__sprite-slot--empty":""}`});if(e.onSlotClick&&(v.style.cursor="pointer",v.addEventListener("click",()=>{e.onSlotClick(f);})),m){let y=u.all.find(b=>b.id===p);if(!y){const b=window.__petDataCache;b&&b.has(p)&&(y=b.get(p));}if(y)try{const b=await Qe.toCanvas("pet",y.petSpecies,{mutations:y.mutations,scale:1}),A=document.createElement("canvas");A.width=b.width,A.height=b.height;const P=A.getContext("2d");if(P&&P.drawImage(b,0,0),A.style.width="100%",A.style.height="100%",A.style.objectFit="contain",v.appendChild(A),e.showSlotStyles){const I=w("div",{className:"team-list-item__sprite-slot-overlay"});v.appendChild(I),v.classList.add("team-list-item__sprite-slot--filled");}}catch(b){console.warn(`[TeamListItem] Failed to render sprite for pet ${y.petSpecies}:`,b);const A=w("div",{textContent:"🐾",className:"team-list-item__sprite-placeholder"});v.appendChild(A);}else {const b=w("div",{textContent:"⏳",className:"team-list-item__sprite-placeholder"});v.appendChild(b),console.warn(`[TeamListItem] Pet ${p} not found in myPets yet, waiting for update`);let A=false;const P=Gt.myPets.subscribe(async()=>{if(A)return;const T=Gt.myPets.get().all.find(N=>N.id===p);if(T){A=true,P();try{v.innerHTML="";const N=await Qe.toCanvas("pet",T.petSpecies,{mutations:T.mutations,scale:1}),z=document.createElement("canvas");z.width=N.width,z.height=N.height;const O=z.getContext("2d");if(O&&O.drawImage(N,0,0),z.style.width="100%",z.style.height="100%",z.style.objectFit="contain",v.appendChild(z),e.showSlotStyles){const M=w("div",{className:"team-list-item__sprite-slot-overlay"});v.appendChild(M),v.classList.add("team-list-item__sprite-slot--filled");}console.log(`[TeamListItem] Pet ${p} sprite updated`);}catch(N){console.warn(`[TeamListItem] Failed to render sprite for pet ${T.petSpecies}:`,N),v.innerHTML="<div class='team-list-item__sprite-placeholder'>🐾</div>";}}},{immediate:false});}}else if(e.showSlotStyles&&!m){const y=gE();v.appendChild(y);}o.appendChild(v);}}i();const a=Gt.myPets.subscribe(()=>{i();});if(!e.hideDragHandle){const u=w("div",{textContent:"⋮⋮",className:"team-list-item__drag-handle"});t.appendChild(u);}if(t.appendChild(n),t.appendChild(r),t.appendChild(o),e.onExpandClick){const u=w("button",{className:`team-list-item__expand ${e.isExpanded?"team-list-item__expand--open":""}`});u.innerHTML='<svg viewBox="0 0 24 24" width="20" height="20" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><polyline points="6 9 12 15 18 9"></polyline></svg>',u.addEventListener("click",f=>{f.stopPropagation(),e.onExpandClick?.();}),t.appendChild(u);}const l=new MutationObserver(()=>{document.contains(t)||(l.disconnect(),a());});return l.observe(document.body,{childList:true,subtree:true}),t}function yE(e){return e==null?null:typeof e=="string"?document.createTextNode(e):e}function Ro(e){const{segments:t,selected:n=t[0]?.id??"",size:r="md",fullWidth:o=false,disabled:i=false,onChange:a}=e,l=w("div",{className:"sg-root"});r!=="md"&&l.classList.add(`sg--${r}`),o&&(l.style.width="100%");const u=w("div",{className:"sg-container",role:"tablist"}),f=w("div",{className:"sg-indicator"}),p=t.map(F=>{const L=w("button",{className:"sg-btn",type:"button",role:"tab","aria-selected":"false",title:F.label});if(L.id=F.id,F.icon){const E=w("span",{className:"sg-icon"}),B=yE(F.icon);B&&E.appendChild(B),L.appendChild(E);}const C=w("span",{className:"sg-label"},F.label);return L.appendChild(C),L.disabled=!!F.disabled,L});u.appendChild(f),p.forEach(F=>u.appendChild(F)),l.appendChild(u);let m=n,v=i,y=null;function b(){const F=p.find(L=>L.id===m);F&&requestAnimationFrame(()=>{const L=f,C=F.offsetLeft,E=F.offsetWidth;L.style.width=`${E}px`,L.style.transform=`translateX(${C}px)`;});}function A(){p.forEach(F=>{const L=F.id===m;F.classList.toggle("active",L),F.setAttribute("aria-selected",String(L)),F.disabled=v||!!t.find(C=>C.id===F.id)?.disabled;}),b();}function P(F){const L=F.currentTarget;if(L.disabled)return;T(L.id);}function I(F){if(v)return;const L=p.findIndex(E=>E.id===m);let C=L;if(F.key==="ArrowLeft"||F.key==="ArrowUp"?(F.preventDefault(),C=(L-1+p.length)%p.length):F.key==="ArrowRight"||F.key==="ArrowDown"?(F.preventDefault(),C=(L+1)%p.length):F.key==="Home"?(F.preventDefault(),C=0):F.key==="End"&&(F.preventDefault(),C=p.length-1),C!==L){const E=p[C];E&&!E.disabled&&(T(E.id),E.focus());}}p.forEach(F=>{F.addEventListener("click",P),F.addEventListener("keydown",I);});function T(F){!t.some(C=>C.id===F)||m===F||(m=F,A(),a?.(m));}function N(){return m}function z(F){v=!!F,A();}function O(){p.forEach(F=>{F.removeEventListener("click",P),F.removeEventListener("keydown",I);}),y?.disconnect(),y=null;}A(),y=new ResizeObserver(()=>{const F=p.find(L=>L.id===m);if(F&&F.offsetWidth>0){const L=f;L.style.transition="none",L.style.width=`${F.offsetWidth}px`,L.style.transform=`translateX(${F.offsetLeft}px)`,requestAnimationFrame(()=>{L.style.removeProperty("transition");}),y?.disconnect(),y=null;}}),y.observe(u);const M=l;return M.select=T,M.getSelected=N,M.setDisabled=z,M.destroy=O,M}function rl(e={}){const{id:t,checked:n=false,disabled:r=false,size:o="md",label:i,labelSide:a="right",onChange:l}=e,u=w("div",{className:"lg-checkbox-wrap"}),f=w("input",{className:`lg-checkbox lg-checkbox--${o}`,id:t,type:"checkbox",checked:!!n,disabled:!!r});let p=null;i&&a!=="none"&&(p=w("label",{className:"lg-checkbox-label"},i),p.addEventListener("click",A)),p&&a==="left"?u.append(p,f):p&&a==="right"?u.append(f,p):u.append(f);let m=!!n,v=!!r;function y(){f.checked=m,f.disabled=v;}function b(F=false){v||(m=!m,y(),F||l?.(m));}function A(){v||b();}function P(F){v||(F.key===" "||F.key==="Enter")&&(F.preventDefault(),b());}f.addEventListener("click",A),f.addEventListener("keydown",P);function I(){return m}function T(F,L=false){m=!!F,y(),L||l?.(m);}function N(F){v=!!F,y();}function z(F){if(!F){p&&(p.remove(),p=null);return}p?p.textContent=F:(p=w("label",{className:"lg-checkbox-label"},F),p.addEventListener("click",A),u.append(p));}function O(){f.focus();}function M(){f.removeEventListener("click",A),f.removeEventListener("keydown",P),p&&p.removeEventListener("click",A);}return y(),{root:u,input:f,isChecked:I,setChecked:T,setDisabled:N,setLabel:z,focus:O,destroy:M}}const pg=At.PET_TEAM,xE={enabled:false,teams:[],activeTeamId:null},au=3,gf=50,St="";function Ft(){return at(pg,xE)}function ur(e){st(pg,e);}function wE(e){const n={...Ft(),...e};return ur(n),n}function CE(){return Ft().enabled}function kE(e){wE({enabled:e});}function SE(){return crypto.randomUUID()}function Xc(){return Date.now()}function fg(e=[]){const t=[...e];for(;t.length<au;)t.push(St);return [t[0]||St,t[1]||St,t[2]||St]}function hg(e,t){const n=Ft(),r=e.trim();return r?!n.teams.some(o=>o.name.trim()===r&&o.id!==t):false}function mg(e,t){const n=Ft();if(!e.some(i=>i!==St))return  true;const o=[...e].sort().join(",");return !n.teams.some(i=>i.id===t?false:[...i.petIds].sort().join(",")===o)}function gg(e){const n=Wr().get(),r=new Set(n.all.map(i=>i.id)),o=Ft();for(const i of o.teams)for(const a of i.petIds)a!==St&&r.add(a);for(const i of e)if(i!==St&&!r.has(i))return  false;return  true}function AE(e){const n=Wr().get(),r=new Map(n.all.map(i=>[i.id,i])),o=[];for(const i of e.petIds){if(i===St)continue;const a=r.get(i);a&&o.push(a);}return o}function EE(e){return e.petIds.every(t=>t!==St)}function _E(e){const t=[];for(let n=0;n<au;n++)e.petIds[n]===St&&t.push(n);return t}function IE(e){return e.petIds.filter(t=>t!==St).length}function TE(e){return e.petIds.every(t=>t===St)}function PE(e,t){return e.petIds.includes(t)}function LE(e,t){return e.petIds.indexOf(t)}function ME(e,t=[]){const n=Ft();if(n.teams.length>=gf)throw new Error(`Maximum number of teams (${gf}) reached`);if(!hg(e))throw new Error(`Team name "${e}" already exists`);const r=e.trim();if(!r)throw new Error("Team name cannot be empty");const o=fg(t);if(!gg(o))throw new Error("One or more pet IDs do not exist");if(!mg(o))throw new Error("A team with this exact composition already exists");const i={id:SE(),name:r,petIds:o,createdAt:Xc(),updatedAt:Xc()};return n.teams.push(i),ur(n),i}function bg(e,t){const n=Ft(),r=n.teams.findIndex(a=>a.id===e);if(r===-1)return null;const o=n.teams[r];if(t.name!==void 0){const a=t.name.trim();if(!a)throw new Error("Team name cannot be empty");if(!hg(a,e))throw new Error(`Team name "${a}" already exists`);t.name=a;}if(t.petIds!==void 0){const a=fg(t.petIds);if(!gg(a))throw new Error("One or more pet IDs do not exist");if(!mg(a,e))throw new Error("A team with this exact composition already exists");t.petIds=a;}const i={...o,...t,id:o.id,createdAt:o.createdAt,updatedAt:Xc()};return n.teams[r]=i,ur(n),i}function RE(e){const t=Ft(),n=t.teams.length;return t.teams=t.teams.filter(r=>r.id!==e),t.teams.length===n?false:(ur(t),true)}function FE(e){return Ft().teams.find(n=>n.id===e)??null}function OE(){return [...Ft().teams]}function NE(e){const t=Ft(),n=e.trim();return t.teams.find(r=>r.name.trim()===n)??null}function DE(e){const t=Ft(),n=new Map(t.teams.map(r=>[r.id,r]));if(e.length!==t.teams.length)return  false;for(const r of e)if(!n.has(r))return  false;return t.teams=e.map(r=>n.get(r)),ur(t),true}function $E(e,t){try{return bg(e,{name:t})!==null}catch(n){return console.warn(`[PetTeam] Failed to rename team ${e}:`,n),false}}function BE(){const n=Wr().get().byLocation.active.map(o=>o.id).sort(),r=Ft();for(const o of r.teams){const i=o.petIds.filter(a=>a!=="").sort();if(i.length===n.length&&i.every((a,l)=>a===n[l]))return o.id}return null}function vg(){const e=BE(),t=Ft();return e!==t.activeTeamId&&(t.activeTeamId=e,ur(t)),e}function yg(e){const t=Ft();t.activeTeamId=e,ur(t);}function zE(e){return vg()===e}function jE(e){const t=Wr(),n=Lo(),r=t.get();if(n.get().isFull)throw new Error("Cannot activate team: inventory is full");const i=r.byLocation.active,a=e.petIds.filter(p=>p!==St).sort(),l=i.map(p=>p.id).sort();if(JSON.stringify(a)===JSON.stringify(l)){console.log("[PetTeam] Team already active");return}const u=r.hutch,f=u.hasHutch?u.maxItems-u.currentItems:0;GE(e.petIds,f,r),yg(e.id),console.log("[PetTeam] Team activated successfully");}function GE(e,t,n){const r=n.byLocation.active;let o=t,i=0;console.log(`[PetTeam] Starting swap with ${t} hutch spaces available`);for(let a=0;a<au;a++){const l=e[a],u=r[a]??null;if(console.log(`[PetTeam] Slot ${a}: current=${u?.id.slice(0,8)??"empty"}, target=${l.slice(0,8)||"empty"}, hutchSpace=${o}`),u?.id===l){console.log(`[PetTeam] Slot ${a}: Same pet, skipping`);continue}if(l===St&&u){const f=o>0;console.log(`[PetTeam] Slot ${a}: Removing pet, storeInHutch=${f}`),UE(u.id,f),f&&o--;continue}if(!u&&l!==St){const p=n.all.find(m=>m.id===l)?.location==="hutch";console.log(`[PetTeam] Slot ${a}: Adding pet, fromHutch=${p}`),p&&o++,HE(l,n,i),i++;continue}if(u&&l!==St){const p=n.all.find(v=>v.id===l)?.location==="hutch";p&&o++;const m=o>0;console.log(`[PetTeam] Slot ${a}: Swapping pets, fromHutch=${p}, storeInHutch=${m}`),VE(u.id,l,n,m),m&&o--;continue}}console.log(`[PetTeam] Swap complete, ${o} hutch spaces remaining`);}function UE(e,t){Um(e),t&&Vd(e);}function WE(e){const t=Ur().get(),n=t.tiles.tileObjects[e]??t.tiles.tileObjects[0];return n?{position:n.position,tileType:"Dirt",localTileIndex:n.localIndex}:{position:{x:0,y:0},tileType:"Dirt",localTileIndex:0}}function HE(e,t,n){const r=t.all.find(l=>l.id===e);if(!r){console.warn(`[PetTeam] Pet ${e} not found`);return}r.location==="hutch"&&Kd(e);const{position:o,tileType:i,localTileIndex:a}=WE(n);jm(e,o,i,a);}function VE(e,t,n,r){const o=n.all.find(i=>i.id===t);if(!o){console.warn(`[PetTeam] Pet ${t} not found`);return}o.location==="hutch"&&Kd(t),Gm(e,t),r&&Vd(e);}function KE(){try{return localStorage.getItem("aries_mod")!==null}catch(e){return console.warn("[PetTeam] Failed to access localStorage:",e),false}}function YE(){try{const e=localStorage.getItem("aries_mod");if(!e)return [];const n=JSON.parse(e)?.pets?.teams;return Array.isArray(n)?n.filter(r=>r&&typeof r=="object"):[]}catch(e){return console.warn("[PetTeam] Failed to read Aries teams:",e),[]}}function qE(e){const t=Date.now(),n=e.slots||[],r=[typeof n[0]=="string"?n[0]:St,typeof n[1]=="string"?n[1]:St,typeof n[2]=="string"?n[2]:St];return {name:e.name?.trim()||"Imported Team",petIds:r,createdAt:t,updatedAt:t}}function XE(){const e={success:false,source:"none",imported:0,errors:[]};if(!KE())return e.errors.push("Aries mod not detected. Install Aries mod first."),e;const t=YE();if(t.length===0)return e.errors.push("No teams found in Aries mod. Create teams in Aries first."),e;const n=Ft();n.teams=[],n.activeTeamId=null;const r=new Set;for(const o of t)try{const i=qE(o);let a=i.name;if(r.has(a)){let u=1;for(;r.has(`${a} (${u})`);)u++;a=`${a} (${u})`;}r.add(a);const l={id:crypto.randomUUID(),name:a,petIds:i.petIds,createdAt:i.createdAt,updatedAt:i.updatedAt};n.teams.push(l),e.imported++;}catch(i){const a=i instanceof Error?i.message:String(i);e.errors.push(`Failed to import "${o.name}": ${a}`);}return e.imported>0&&(ur(n),e.success=true,e.source="aries"),e}let Pa=false;const dt={init(){if(Pa)return;if(!Ft().enabled){console.log("[PetTeam] Feature disabled");return}Pa=true,console.log("[PetTeam] Feature initialized");},destroy(){Pa&&(Pa=false,console.log("[PetTeam] Feature destroyed"));},isEnabled:CE,setEnabled:kE,createTeam:ME,updateTeam:bg,deleteTeam:RE,renameTeam:$E,getTeam:FE,getAllTeams:OE,getTeamByName:NE,reorderTeams:DE,getPetsForTeam:AE,isTeamFull:EE,getEmptySlots:_E,getFilledSlotCount:IE,isTeamEmpty:TE,isPetInTeam:PE,getPetSlotIndex:LE,getActiveTeamId:vg,setActiveTeamId:yg,isActiveTeam:zE,activateTeam:jE,importFromAries:XE};let qo=0,bf="",vf="";function QE(){return qo===0&&(bf=document.body.style.overflow,vf=document.body.style.touchAction,document.body.style.overflow="hidden",document.body.style.touchAction="none"),qo++,()=>{qo=Math.max(0,qo-1),qo===0&&(document.body.style.overflow=bf,document.body.style.touchAction=vf);}}class JE{constructor(t){xe(this,"dragState",null);xe(this,"longPressState",null);xe(this,"options");xe(this,"onPointerMove");xe(this,"onPointerUp");xe(this,"onPointerCancel");xe(this,"onLongPressPointerMove");xe(this,"onLongPressPointerUp");this.options=t,this.onPointerMove=this.handlePointerMove.bind(this),this.onPointerUp=this.handlePointerUp.bind(this),this.onPointerCancel=this.handlePointerCancel.bind(this),this.onLongPressPointerMove=this.handleLongPressPointerMove.bind(this),this.onLongPressPointerUp=this.handleLongPressPointerUp.bind(this);}startLongPress(t,n,r){if(this.cleanupLongPress(),dt.getAllTeams().findIndex(f=>f.id===r)===-1)return;const a=t.clientX,l=t.clientY,u=window.setTimeout(()=>{this.longPressState&&this.startDrag(t,n,r);},500);this.longPressState={pointerId:t.pointerId,startX:a,startY:l,timeout:u,target:n},window.addEventListener("pointermove",this.onLongPressPointerMove,{passive:false}),window.addEventListener("pointerup",this.onLongPressPointerUp,{passive:false});}startDrag(t,n,r){const o=this.options.getListContainer();if(this.dragState||!o)return;t.preventDefault();const a=dt.getAllTeams().findIndex(v=>v.id===r);if(a===-1)return;const l=n.getBoundingClientRect(),u=o.getBoundingClientRect(),f=n.cloneNode(true);f.classList.add("team-list-item--placeholder"),f.classList.remove("team-list-item--dragging");const p=n.style.touchAction;n.style.touchAction="none";const m=QE();if(this.dragState={itemEl:n,pointerId:t.pointerId,placeholder:f,offsetY:t.clientY-l.top,fromIndex:a,teamId:r,captureTarget:n,touchActionPrev:p,releaseScrollLock:m},n.classList.add("team-list-item--dragging"),n.style.width=`${l.width}px`,n.style.height=`${l.height}px`,n.style.left=`${l.left-u.left}px`,n.style.top=`${l.top-u.top}px`,n.style.position="absolute",n.style.zIndex="30",n.style.pointerEvents="none",o.style.position||(o.style.position="relative"),o.insertBefore(f,n.nextSibling),o.classList.add("is-reordering"),n.setPointerCapture)try{n.setPointerCapture(t.pointerId);}catch{}window.addEventListener("pointermove",this.onPointerMove,{passive:false}),window.addEventListener("pointerup",this.onPointerUp,{passive:false}),window.addEventListener("pointercancel",this.onPointerCancel,{passive:false});}cleanup(){this.cleanupDrag(),this.cleanupLongPress();}handleLongPressPointerMove(t){if(!this.longPressState||t.pointerId!==this.longPressState.pointerId)return;const n=Math.abs(t.clientX-this.longPressState.startX),r=Math.abs(t.clientY-this.longPressState.startY),o=10;(n>o||r>o)&&this.cleanupLongPress();}handleLongPressPointerUp(t){!this.longPressState||t.pointerId!==this.longPressState.pointerId||this.cleanupLongPress();}handlePointerMove(t){const n=this.options.getListContainer();if(!this.dragState||!n||t.pointerId!==this.dragState.pointerId)return;t.preventDefault();const r=n.getBoundingClientRect();let o=t.clientY-r.top-this.dragState.offsetY;const i=r.height-this.dragState.itemEl.offsetHeight;Number.isFinite(i)&&(o=Math.max(-8,Math.min(i+8,o))),this.dragState.itemEl.style.top=`${o}px`,this.updatePlaceholderPosition(t.clientY);}handlePointerUp(t){!this.dragState||t.pointerId!==this.dragState.pointerId||(t.preventDefault(),this.finishDrag());}handlePointerCancel(t){!this.dragState||t.pointerId!==this.dragState.pointerId||this.finishDrag({revert:true});}updatePlaceholderPosition(t){const n=this.options.getListContainer();if(!this.dragState||!n)return;const{placeholder:r,itemEl:o}=this.dragState,i=Array.from(n.children).filter(u=>u!==o&&u!==r&&u instanceof HTMLElement&&u.classList.contains("team-list-item")),a=new Map;i.forEach(u=>{a.set(u,u.getBoundingClientRect().top);});let l=false;for(const u of i){const f=u.getBoundingClientRect(),p=f.top+f.height/2;if(t<p){r.nextSibling!==u&&n.insertBefore(r,u),l=true;break}}l||n.appendChild(r),i.forEach(u=>{const f=a.get(u),p=u.getBoundingClientRect().top;if(f!==void 0&&f!==p){const m=f-p;u.style.transform=`translateY(${m}px)`,u.style.transition="none",u.offsetHeight,u.style.transition="transform 0.14s ease",u.style.transform="translateY(0)";}});}finishDrag(t={}){const n=this.options.getListContainer();if(!this.dragState||!n)return;const{revert:r=false}=t,{itemEl:o,placeholder:i,fromIndex:a,touchActionPrev:l,releaseScrollLock:u,pointerId:f}=this.dragState;if(n.classList.remove("is-reordering"),o.hasPointerCapture(f))try{o.releasePointerCapture(f);}catch{}if(window.removeEventListener("pointermove",this.onPointerMove),window.removeEventListener("pointerup",this.onPointerUp),window.removeEventListener("pointercancel",this.onPointerCancel),r){const v=Array.from(n.children).filter(y=>y!==o&&y!==i&&y instanceof HTMLElement&&y.classList.contains("team-list-item"))[a]||null;v?n.insertBefore(i,v):n.appendChild(i);}else {const m=Array.from(n.children).filter(y=>y!==o),v=m.indexOf(i);if(v!==-1){const y=m[v];y!==i&&n.insertBefore(i,y);}}if(i.replaceWith(o),i.remove(),o.classList.remove("team-list-item--dragging"),o.style.width="",o.style.height="",o.style.left="",o.style.top="",o.style.position="",o.style.zIndex="",o.style.pointerEvents="",o.style.touchAction=l??"",Array.from(n.children).filter(m=>m instanceof HTMLElement&&m.classList.contains("team-list-item")).forEach(m=>{m.style.transform="",m.style.transition="";}),u?.(),!r){const v=Array.from(n.children).filter(y=>y instanceof HTMLElement&&y.classList.contains("team-list-item")).indexOf(o);if(v!==-1&&v!==a){const b=dt.getAllTeams().slice(),[A]=b.splice(a,1);b.splice(v,0,A);const P=b.map(I=>I.id);dt.reorderTeams(P),this.options.onReorder(P);}}this.dragState=null;}cleanupDrag(){this.dragState&&(window.removeEventListener("pointermove",this.onPointerMove),window.removeEventListener("pointerup",this.onPointerUp),window.removeEventListener("pointercancel",this.onPointerCancel),this.dragState=null);}cleanupLongPress(){this.longPressState&&(window.clearTimeout(this.longPressState.timeout),window.removeEventListener("pointermove",this.onLongPressPointerMove),window.removeEventListener("pointerup",this.onLongPressPointerUp),this.longPressState=null);}}class ZE{constructor(t={}){xe(this,"card",null);xe(this,"modeControl",null);xe(this,"modeContainer",null);xe(this,"teamContent",null);xe(this,"listContainer",null);xe(this,"teamMode","overview");xe(this,"selectedTeamIds",new Set);xe(this,"teamCheckboxes",new Map);xe(this,"options");xe(this,"dragHandler");this.options=t,this.dragHandler=new JE({getListContainer:()=>this.listContainer,onReorder:n=>{this.options.onTeamReordered?.(n),this.options.onTeamsUpdated?.();}});}build(){return this.card?this.card:this.createTeamCard()}destroy(){this.dragHandler.cleanup(),this.modeControl&&(this.modeControl.destroy(),this.modeControl=null),this.teamCheckboxes.forEach(t=>t.destroy()),this.teamCheckboxes.clear(),this.selectedTeamIds.clear(),this.card=null,this.modeContainer=null,this.teamContent=null,this.listContainer=null;}render(){if(!this.card)return;if(!dt.isEnabled()){this.renderDisabledState();return}this.modeContainer&&(this.modeContainer.style.display="flex"),this.ensureModeControl(),this.renderTeamContent();}createTeamCard(){const t=w("div",{className:"team-card-wrapper"});this.modeContainer=w("div",{className:"team-card__mode-container"}),t.appendChild(this.modeContainer),this.teamContent=w("div",{className:"team-card__content"}),t.appendChild(this.teamContent);const n=pt({title:"Team",subtitle:"Organize and switch between pet teams",expandable:true,defaultExpanded:true},t);return this.card=n,n}ensureModeControl(){if(this.modeContainer){if(!this.modeControl){this.modeControl=Ro({segments:[{id:"overview",label:"Overview"},{id:"manage",label:"Manage"}],selected:this.teamMode,onChange:t=>{this.teamMode=t,this.renderTeamContent();}}),this.modeContainer.appendChild(this.modeControl);return}this.modeControl.getSelected()!==this.teamMode&&this.modeControl.select(this.teamMode);}}renderDisabledState(){if(!this.teamContent)return;this.dragHandler.cleanup(),this.listContainer=null,this.modeContainer&&(this.modeContainer.style.display="none");const t=w("div",{className:"team-card__disabled-state"}),n=w("div",{textContent:"Pet Team feature is disabled",className:"team-card__disabled-message"}),r=kt({label:"Enable Feature",onClick:()=>{dt.setEnabled(true),this.render();}});t.appendChild(n),t.appendChild(r),this.teamContent.replaceChildren(t);}renderTeamContent(){if(!this.teamContent)return;this.dragHandler.cleanup(),this.listContainer=null,this.teamContent.replaceChildren(),this.teamCheckboxes.forEach(r=>r.destroy()),this.teamCheckboxes.clear(),this.selectedTeamIds.clear();const t=dt.getAllTeams(),n=dt.getActiveTeamId();if(t.length===0){this.renderEmptyState();return}this.listContainer=w("div",{className:"team-card__list-container"}),t.forEach(r=>{const o=n===r.id;let i;this.teamMode==="manage"&&(i=this.createCheckboxIndicator(r.id));const a=vE({team:r,isActive:o,customIndicator:i?.root,hideDragHandle:this.teamMode==="manage",isNameEditable:this.teamMode==="manage",showSlotStyles:this.teamMode==="manage",onNameChange:l=>{this.handleRenameTeam(r.id,l);},onSlotClick:this.teamMode==="manage"?l=>{this.handleRemovePet(r.id,l);}:void 0});this.teamMode==="manage"&&a.classList.add("team-list-item--manage"),this.teamMode==="overview"&&(a.addEventListener("click",async l=>{if(!l.target.closest(".team-list-item__drag-handle")){a.classList.add("team-list-item--clicked"),setTimeout(()=>{a.classList.remove("team-list-item--clicked");},300);try{await dt.activateTeam(r),this.options.onTeamsUpdated?.();}catch(f){console.error("[TeamCard] Failed to activate team:",f);}}}),a.addEventListener("pointerdown",l=>{if(l.button!==0)return;l.target.closest(".team-list-item__drag-handle")?this.dragHandler.startDrag(l,a,r.id):this.dragHandler.startLongPress(l,a,r.id);})),this.listContainer.appendChild(a);}),this.teamContent.appendChild(this.listContainer),this.teamMode==="manage"&&this.renderManageActions();}renderEmptyState(){if(!this.teamContent)return;const t=w("div",{textContent:"No teams yet. Create your first team!",className:"team-card__empty-state"});if(this.teamContent.appendChild(t),this.teamMode==="manage"){const n=w("div",{className:"team-card__actions"}),r=kt({label:"New Team",variant:"primary",onClick:()=>{this.handleCreateTeam();}});n.appendChild(r),this.teamContent.appendChild(n);}}renderManageActions(){if(!this.teamContent)return;const t=w("div",{className:"team-card__actions"}),n=kt({label:"New Team",variant:"primary",onClick:()=>{this.handleCreateTeam();}}),r=kt({label:"Import from Aries",variant:"default",onClick:()=>{this.handleImportFromAries();}}),o=kt({label:"Delete Team",variant:"danger",disabled:this.selectedTeamIds.size===0,onClick:()=>{this.handleDeleteTeam();}});o.setAttribute("data-action","delete-team"),t.appendChild(n),t.appendChild(r),t.appendChild(o),this.teamContent.appendChild(t);}handleCreateTeam(){const t="New Team";let n=t,r=1;const o=dt.getAllTeams(),i=new Set(o.map(a=>a.name));for(;i.has(n);)n=`${t} (${r})`,r++;try{dt.createTeam(n,[])&&(this.render(),this.options.onTeamsUpdated?.());}catch{}}handleDeleteTeam(){if(this.selectedTeamIds.size===0)return;const t=Array.from(this.selectedTeamIds);for(const n of t)dt.deleteTeam(n);this.render(),this.options.onTeamsUpdated?.();}handleImportFromAries(){try{const t=dt.importFromAries();t.success?(console.log(`[PetTeam] Successfully imported ${t.imported} team${t.imported===1?"":"s"} from Aries mod`),this.render(),this.options.onTeamsUpdated?.()):console.error("[PetTeam] Import failed:",t.errors.join(", "));}catch(t){console.error("[PetTeam] Import error:",t);}}handleRenameTeam(t,n){dt.renameTeam(t,n),this.options.onTeamsUpdated?.();}handleRemovePet(t,n){const r=dt.getTeam(t);if(!r)return;const o=r.petIds[n];!o||o===""?this.handleAddPet(t,n):this.handleRemovePetFromSlot(t,n);}handleRemovePetFromSlot(t,n){const r=dt.getTeam(t);if(!r)return;const o=[...r.petIds];o[n]="",dt.updateTeam(t,{petIds:o}),this.render(),this.options.onTeamsUpdated?.();}async handleAddPet(t,n){const r=dt.getTeam(t);if(!r)return;const i=Gt.myPets.get().all.map(y=>({id:y.id,itemType:"Pet",petSpecies:y.petSpecies,name:y.name??null,xp:y.xp,hunger:y.hunger,mutations:y.mutations||[],targetScale:y.targetScale,abilities:y.abilities||[]})),a=new Set(r.petIds.filter(y=>y!=="")),l=i.filter(y=>!a.has(y.id));await Xe.set("mySelectedItemIdAtom",null);const u=Rt.detect();(u.platform==="mobile"||u.viewportWidth<768)&&this.options.setHUDOpen&&this.options.setHUDOpen(false);const p=Gt.myInventory.subscribeSelection(y=>{if(y.current&&y.current.item){const b=y.current.item,A=[...r.petIds];A[n]=b.id,dt.updateTeam(t,{petIds:A}),this.options.onTeamsUpdated?.(),Xe.set("mySelectedItemIdAtom",null),io.close().then(()=>{const P=Rt.detect();(P.platform==="mobile"||P.viewportWidth<768)&&this.options.setHUDOpen&&this.options.setHUDOpen(true),this.render(),this.options.onTeamsUpdated?.();});}});await io.show("inventory",{items:l,favoritedItemIds:[]}),await io.waitForClose();const m=Rt.detect();(m.platform==="mobile"||m.viewportWidth<768)&&this.options.setHUDOpen&&this.options.setHUDOpen(true),p();}createCheckboxIndicator(t){const n=rl({checked:this.selectedTeamIds.has(t),size:"md",onChange:r=>{r?this.selectedTeamIds.add(t):this.selectedTeamIds.delete(t),this.updateDeleteButtonState();}});return this.teamCheckboxes.set(t,n),n}updateDeleteButtonState(){const t=this.teamContent?.querySelector('[data-action="delete-team"]');t&&(t.disabled=this.selectedTeamIds.size===0);}}const e_=["PetXpBoost","PetXpBoostII","PetXpBoostIII","SnowyPetXpBoost"],xg=At.XP_TRACKER,t_={enabled:false,sortBy:"closestToMax",filterSpecies:[],filterHasXpBoost:false,updateIntervalMs:3e3,isPoppedOut:false,popOutPosition:null,collapsedSections:{activePets:false,allPets:false,xpBoostSummary:false}},co="XP Tracker",uo="[XpTracker]";function Fo(){return at(xg,t_)}function wg(e){st(xg,e);}function Cg(e){const n={...Fo(),...e};return wg(n),n}function kg(){return Fo().enabled}function n_(e){Cg({enabled:e});}function su(e){return e_.includes(e)}function r_(e){const t=Oe.get("abilities");if(!t)return null;const n=t[e];return !n||!su(e)?null:{id:e,name:n.name??"XP Boost",baseProbability:n.baseProbability??0,bonusXp:n.baseParameters?.bonusXp??0,requiredWeather:n.baseParameters?.requiredWeather??null}}function Sg(e){return e.filter(su)}function o_(e){return e.some(su)}function i_(e){switch(e){case "PetXpBoost":return "I";case "PetXpBoostII":return "II";case "PetXpBoostIII":return "III";case "SnowyPetXpBoost":return "Snowy";default:return "I"}}function Ag(e,t,n,r=100){const o=r_(e);if(!o)return null;const i=i_(e),a=o.requiredWeather,l=a===null||n===a,u=t/r,f=u*u,p=o.baseProbability,m=o.bonusXp,v=p,y=Math.floor(m*f),b=v/100*60,A=l?Math.floor(b*y):0;return {abilityId:e,abilityName:o.name,tier:i,baseChancePerMinute:p,actualChancePerMinute:v,baseXpPerProc:m,actualXpPerProc:y,expectedProcsPerHour:b,expectedXpPerHour:A,requiredWeather:a,isActive:l}}function a_(e,t){const n={totalBonusXpPerHour:0,totalProcsPerHour:0,activeBoosterCount:0,boosters:[]};for(const r of e){const o=Sg(r.abilities);for(const i of o){const a=Ag(i,r.strength,t,r.maxStrength||100);a&&(n.boosters.push({petId:r.petId,petName:r.petName,stats:a}),a.isActive&&(n.totalBonusXpPerHour+=a.expectedXpPerHour,n.totalProcsPerHour+=a.expectedProcsPerHour,n.activeBoosterCount++));}}return n}function s_(e,t,n,r=100){const o=Sg(e);return o.length===0?null:Ag(o[0],t,n,r)}function yf(e,t){return e.hoursToMaxStrength-t.hoursToMaxStrength}function l_(e,t){return t.hoursToMaxStrength-e.hoursToMaxStrength}function c_(e,t){return e.species.localeCompare(t.species)}function d_(e,t){return t.currentStrength-e.currentStrength}function u_(e,t){const n={active:0,inventory:1,hutch:2};return n[e.location]-n[t.location]}function p_(e,t){return e.name.localeCompare(t.name)}function f_(e){switch(e){case "closestToMax":return yf;case "furthestFromMax":return l_;case "species":return c_;case "strength":return d_;case "location":return u_;case "name":return p_;default:return yf}}function Eg(e,t){const n=f_(t);return [...e].sort(n)}function h_(e,t){return t.length===0?e:e.filter(n=>t.includes(n.species))}function m_(e,t){return t?e.filter(n=>n.xpBoostStats!==null):e}function _g(e,t){let n=e;return n=h_(n,t.filterSpecies),n=m_(n,t.filterHasXpBoost),n=Eg(n,t.sortBy),n}let Co=false,Qa=null,ol=[],lu=null;function g_(e,t,n){const r=Qm(e.petSpecies,e.targetScale),o=Jm(e.petSpecies,e.xp,r),i=o>=r,a=e.hunger<=0,l=a?0:Qn,u=s_(e.abilities,o,t);u?.isActive&&u.expectedXpPerHour;const f=e.location==="active"&&!a?l+n:0,p=tg(e.petSpecies,e.xp,o,r,f>0?f:Qn),m=eg(e.petSpecies,e.xp,r,f>0?f:Qn),v=ng(e.petSpecies,e.hunger,p),y=xs(e.petSpecies,e.hunger,m);return {id:e.id,species:e.petSpecies,name:e.name,xp:e.xp,hunger:e.hunger,location:e.location,isStarving:a,currentStrength:o,maxStrength:r,isMaxStrength:i,hoursToNextStrength:p,hoursToMaxStrength:m,feedsToNextStrength:v,feedsToMaxStrength:y,baseXpPerHour:l,totalXpPerHour:f,xpBoostStats:u,targetScale:e.targetScale,abilities:e.abilities,mutations:e.mutations}}function Ig(){const e=Gt.myPets.get(),t=Gt.weather.get(),n=t.isActive?t.type:null,o=e.byLocation.active.filter(u=>!u.isMature||o_(u.abilities)).filter(u=>u.hunger>0).map(u=>({petId:u.id,petName:u.name??"",abilities:u.abilities,strength:u.currentStrength})),i=a_(o,n);lu=i;const a=[];for(const u of e.all){const f=g_({id:u.id,petSpecies:u.petSpecies,name:u.name??"",xp:u.xp,hunger:u.hunger,targetScale:u.targetScale,abilities:u.abilities,mutations:u.mutations,location:u.location},n,i.totalBonusXpPerHour);a.push(f);}const l=Math.max(0,...a.map(u=>u.hoursToMaxStrength));for(const u of a)u.isMaxStrength&&u.xpBoostStats&&(u.feedsToMaxStrength=rg(true,true,u.species,u.hunger,0,l));return a}function Tg(){if(Co)return;if(!Fo().enabled){console.log(`${uo} ${co} disabled`);return}console.log(`${uo} Initializing ${co}...`),Oe.isReady()&&(ol=Ig()),Co=true,console.log(`${uo} ${co} initialized`);}function cu(){return Co&&Oe.isReady()}function du(){return cu()?ol:[]}function b_(){return du().filter(e=>e.location==="active")}function v_(){return lu}function uu(){cu()&&(ol=Ig());}function y_(e){pu();const t=Fo(),n=e??t.updateIntervalMs;Qa=setInterval(()=>{kg()&&uu();},n);}function pu(){Qa&&(clearInterval(Qa),Qa=null);}function Pg(){Co&&(pu(),Co=false,ol=[],lu=null,console.log(`${uo} ${co} destroyed`));}function x_(){const e=Fo();return _g(du(),{sortBy:e.sortBy,filterSpecies:e.filterSpecies,filterHasXpBoost:e.filterHasXpBoost})}function w_(e){n_(e),e?(Co=false,Tg(),Oe.isReady()&&uu(),console.log(`${uo} ${co} enabled`)):(Pg(),console.log(`${uo} ${co} disabled`));}const Qc={init:Tg,isReady:cu,destroy:Pg,loadConfig:Fo,saveConfig:wg,updateConfig:Cg,isEnabled:kg,setEnabled:w_,getAllPetsProgress:du,getActivePetsProgress:b_,getCombinedBoostStats:v_,getFilteredPets:x_,refresh:uu,startAutoUpdate:y_,stopAutoUpdate:pu,sortPets:Eg,filterAndSortPets:_g},C_={EggGrowthBoost:{procRate:.21,minutesPerProc:7},EggGrowthBoostII_NEW:{procRate:.24,minutesPerProc:9},EggGrowthBoostII:{procRate:.27,minutesPerProc:11},SnowyEggGrowthBoost:{procRate:.35,minutesPerProc:10}},k_={PlantGrowthBoost:{procRate:.24,minutesPerProc:3},PlantGrowthBoostII:{procRate:.27,minutesPerProc:5},PlantGrowthBoostIII:{procRate:.3,minutesPerProc:7},SnowyPlantGrowthBoost:{procRate:.4,minutesPerProc:6}};[...Object.keys(C_),...Object.keys(k_)];const S_=`
/* ═══════════════════════════════════════════════════════════════════════════
...
`;class T_ extends Br{constructor(n){super({id:"tab-pets",label:"Pets"});xe(this,"unsubscribeMyPets");xe(this,"lastActiveTeamId",null);xe(this,"teamCardPart",null);xe(this,"abilityLogsCardPart",null);xe(this,"deps");this.deps=n;}async build(n){this.container=n;const{MGSprite:r}=await xn(async()=>{const{MGSprite:a}=await Promise.resolve().then(()=>ug);return {MGSprite:a}},void 0);await r.init();const o=n.getRootNode();un(o,Lg,"team-card-styles"),un(o,E_,"base-pet-card-styles"),un(o,Mg,"badge-styles"),un(o,__,"arcade-button-styles"),un(o,S_,"gemini-icon-button-styles"),un(o,I_,"ability-logs-card-styles");const i=this.createGrid("12px");i.id="pets",n.appendChild(i),this.initializeTeamCardPart(i),this.initializeAbilityLogsCardPart(i),this.unsubscribeMyPets=Gt.myPets.subscribeStable(()=>{const a=dt.getActiveTeamId();a!==this.lastActiveTeamId&&(this.lastActiveTeamId=a,this.teamCardPart?.render());}),this.lastActiveTeamId=dt.getActiveTeamId();}async destroy(){this.unsubscribeMyPets&&(this.unsubscribeMyPets(),this.unsubscribeMyPets=void 0),this.teamCardPart&&(this.teamCardPart.destroy(),this.teamCardPart=null),this.abilityLogsCardPart&&(this.abilityLogsCardPart.destroy(),this.abilityLogsCardPart=null);}initializeTeamCardPart(n){this.teamCardPart||(this.teamCardPart=new ZE({onTeamReordered:o=>{console.log("[PetsSection] Teams reordered:",o);},setHUDOpen:this.deps?.setHUDOpen}));const r=this.teamCardPart.build();n.appendChild(r),this.teamCardPart.render();}initializeAbilityLogsCardPart(n){this.abilityLogsCardPart||(this.abilityLogsCardPart=new A_);const r=this.abilityLogsCardPart.build();n.appendChild(r),this.abilityLogsCardPart.render();}}const P_=`
  #alerts-section {
    display: flex;
    flex-direction: column;
    gap: 12px;
...
`,xf={ui:{expandedCards:{settings:true,shops:false,weather:false,pet:false}}};async function L_(){const e=await _o("tab-alerts",{version:1,defaults:xf,sanitize:o=>({ui:{expandedCards:go(xf.ui.expandedCards,o.ui?.expandedCards)}})});function t(o){const i=e.get();e.update({ui:{...i.ui,...o,expandedCards:go(i.ui.expandedCards,o.expandedCards)}});}function n(o,i){const a=e.get();e.update({ui:{...a.ui,expandedCards:{...a.ui.expandedCards,[o]:!!i}}});}function r(o){const i=e.get();n(o,!i.ui.expandedCards[o]);}return {get:e.get,set:e.set,save:e.save,setUI:t,setCardExpanded:n,toggleCard:r}}const Rg=At.SHOP_NOTIFIER,Fg={seed:[],tool:[],egg:[],decor:[]},M_={enabled:false,trackedItems:Fg},R_=["seed","tool","egg","decor"];function Og(e){return {seed:Array.isArray(e?.seed)?[...e.seed]:[],tool:Array.isArray(e?.tool)?[...e.tool]:[],egg:Array.isArray(e?.egg)?[...e.egg]:[],decor:Array.isArray(e?.decor)?[...e.decor]:[]}}function Vi(e){return {seed:[...e.seed],tool:[...e.tool],egg:[...e.egg],decor:[...e.decor]}}function Oo(){const e=at(Rg,M_);return {enabled:e?.enabled??false,trackedItems:Og(e?.trackedItems)}}function il(e){st(Rg,{enabled:e.enabled,trackedItems:Vi(e.trackedItems)});}function F_(e){const n={...Oo(),...e};return e.trackedItems&&(n.trackedItems=Og(e.trackedItems)),il(n),n}function fu(){return Oo().enabled}function O_(e){F_({enabled:e});}function Ng(){return Vi(Oo().trackedItems)}function Dg(){const e=Ng(),t=[];for(const n of R_)for(const r of e[n])t.push({shopType:n,itemId:r});return t}function N_(e,t){const n=Oo(),r=Vi(n.trackedItems),o=r[e];if(o.includes(t))return;o.push(t),il({...n,trackedItems:r});const i=new CustomEvent("gemini:tracked-items-changed",{detail:{shopType:e,itemId:t,action:"add"}});window.dispatchEvent(i);}function $g(e,t){const n=Oo(),r=Vi(n.trackedItems),o=r[e],i=o.filter(l=>l!==t);if(i.length===o.length)return;r[e]=i,il({...n,trackedItems:r});const a=new CustomEvent("gemini:tracked-items-changed",{detail:{shopType:e,itemId:t,action:"remove"}});window.dispatchEvent(a);}function D_(){const e=Oo();il({...e,trackedItems:Vi(Fg)});}let ws=false;const Jc=[];function $_(e,t){const n=Ng()[e];if(!n.length)return [];const r=new Set(n);return t.items.filter(o=>r.has(o.id)&&o.isAvailable).map(o=>({itemId:o.id,remaining:o.remaining}))}function La(e,t){const n=$_(e,t.shop);if(!n.length)return;console.log("[ShopNotifier] Tracked items restocked",{shopType:e,items:n});const r=new CustomEvent("gemini:shop-restock-tracked",{detail:{shopType:e,items:n}});window.dispatchEvent(r);}function B_(){if(ws)return;ws=true;const e=Mo();Jc.push(e.subscribeSeedRestock(t=>La("seed",t)),e.subscribeToolRestock(t=>La("tool",t)),e.subscribeEggRestock(t=>La("egg",t)),e.subscribeDecorRestock(t=>La("decor",t)));}function z_(){if(ws){ws=false;for(const e of Jc)e();Jc.length=0;}}const Bg={Shovel:{shopType:"tool",maxQuantity:1},WateringCan:{shopType:"tool",maxQuantity:99},PetHutch:{shopType:"decor",maxQuantity:1},DecorShed:{shopType:"decor",maxQuantity:1}};function j_(e,t,n){const r=n.find(i=>typeof i=="object"&&i!==null&&"toolId"in i&&i.toolId===e);return r?(r.quantity??0)>=t:false}function G_(e,t,n){const r=n.find(f=>typeof f=="object"&&f!==null&&"decorId"in f&&f.decorId===e),o=r?r.quantity??0:0,l=Ur().get().decors.all.filter(f=>typeof f=="object"&&f!==null&&"decorId"in f&&f.decorId===e).length;return o+l>=t}function zg(e,t,n,r){return t==="tool"?j_(e,n,r):t==="decor"?G_(e,n,r):false}function wf(e,t){const n=Bg[e];if(!n||n.shopType!==t)return  false;const o=Lo().get();return zg(e,t,n.maxQuantity,o.items)}function Cf(){const t=Lo().get(),n=Dg();for(const r of n){const o=Bg[r.itemId];o&&o.shopType===r.shopType&&zg(r.itemId,r.shopType,o.maxQuantity,t.items)&&(console.log(`[ShopNotifier] Auto-disabling tracking for ${r.itemId} (max quantity reached)`),$g(r.shopType,r.itemId));}}let Cs=false,Ja=null;function U_(){if(Cs)return;Cs=true,Ja=Lo().subscribeStable(()=>{Cf();}),Cf();}function W_(){Cs&&(Cs=false,Ja&&(Ja(),Ja=null));}let Ti=false;function jg(){if(Ti){console.log("[ShopNotifier] Already initialized");return}if(!fu()){console.log("[ShopNotifier] Disabled");return}Ti=true,B_(),U_(),console.log("[ShopNotifier] Initialized");}function Gg(){Ti&&(z_(),W_(),Ti=false,console.log("[ShopNotifier] Destroyed"));}function H_(){return Ti}function V_(){return fu()}function K_(e){if(fu()===e){console.log(`[ShopNotifier] Already ${e?"enabled":"disabled"}`);return}O_(e),e?jg():Gg(),console.log(`[ShopNotifier] ${e?"Enabled":"Disabled"}`);}const $r={init:jg,destroy:Gg,isReady:H_,isEnabled:V_,setEnabled:K_,addTrackedItem:N_,removeTrackedItem:$g,getTrackedItems:Dg,resetTrackedItems:D_},Y_={seed:"Seeds",tool:"Tools",egg:"Eggs",decor:"Decor"},ac={seed:"🌱",tool:"🔧",egg:"🥚",decor:"🎨"},q_={seed:"plants",tool:"items",egg:"eggs",decor:"decor"},X_={seed:"seed",tool:null,egg:null,decor:null},kf={common:0,uncommon:1,rare:2,legendary:3,mythical:4,divine:5,celestial:6};function hu(e,t,n){try{const r=q_[t],o=Oe.get(r);if(!o||typeof o!="object")return null;const i=o[e];if(!i||typeof i!="object")return null;const a=X_[t],l=a?i[a]:i;return !l||typeof l!="object"?null:l[n]??null}catch(r){return console.warn(`[Alerts] Failed to get ${n} for ${e}:`,r),null}}function Q_(e,t){return hu(e,t,"spriteId")}function J_(e,t){const n=hu(e,t,"rarity");return n?String(n).toLowerCase():null}function Z_(e,t){return hu(e,t,"name")??e}function eI(){const e=$r.getTrackedItems();return new Set(e.map(t=>`${t.shopType}:${t.itemId}`))}function Sf(e){const t=eI(),n=[],r=["seed","tool","egg","decor"];for(const o of r){const i=e.byType[o];if(i)for(const a of i.items){const l=`${o}:${a.id}`;n.push({...a,shopType:o,rarity:J_(a.id,o),spriteId:Q_(a.id,o),itemName:Z_(a.id,o),isTracked:t.has(l),hasCustomSound:Re.hasItemCustomSound("shop",a.id,o)});}}return n}const tI=`
  /* Container */
  .modal-container {
    position: fixed;
    top: 0;
...
`,rI={title:"Custom Sound",size:"md",closeOnBackdrop:true,closeOnEscape:true},Ef={"one-shot":"Play sound once when event occurs",loop:"Loop sound while event is active"},oI=220;function iI(){return (document.querySelector("#gemini-hud-root")||document.querySelector("#gemini-root")||document.querySelector("#gemini-hud-container"))?.shadowRoot??null}function aI(e){const t=iI();if(t){un(t,Af,"customSoundModal");return}const n=w("style");n.textContent=Af,e.appendChild(n);}function Ug(e){const t={...rI,...e};let n=null,r=null,o=null,i=null,a=null,l=null,u=null,f=null,p=null,m=false,v=false,y=null;function b(){p?.(),p=null,f&&(f.pause(),f.currentTime=0),f=null,o?.setLabel("Play");}async function A(){if(f){b();return}if(!u)return;const j=Re.getById(u.soundId);if(!j){console.error(`[CustomSoundModal] Sound not found: ${u.soundId}`);return}const V=new Audio(j.source);V.volume=u.volume/100,f=V;const U=()=>{b();},ce=()=>{b(),console.error(`[CustomSoundModal] Failed to play sound: ${j.name}`);};V.addEventListener("ended",U),V.addEventListener("error",ce),p=()=>{V.removeEventListener("ended",U),V.removeEventListener("error",ce);};try{await V.play(),o?.setLabel("Stop");}catch(Y){b(),console.error("[CustomSoundModal] Failed to play sound:",Y);}}function P(){l&&u&&(l.textContent=Ef[u.mode]);}function I(){m||y!==null||(y=window.setTimeout(()=>{z();},oI));}function T(){m||v||(v=true,b(),t.onClose?.(),I());}function N(){m||(n?.close(),T());}function z(){m||(m=true,v=true,y!==null&&(window.clearTimeout(y),y=null),b(),r&&(r.destroy(),r=null),a&&(a.destroy(),a=null),i=null,o=null,l=null,u=null,n&&(n.destroy(),n=null));}async function O(){const j=w("span",{className:"custom-sound-modal-title"});let V=false;if(e.spriteId)try{const ce=await Qe.toCanvas(e.spriteId);if(ce){const Y=w("span",{className:"custom-sound-modal-title-icon"});ce.className="custom-sound-modal-title-sprite",Y.appendChild(ce),j.appendChild(Y),V=!0;}}catch{}if(!V&&e.icon){const ce=w("span",{className:"custom-sound-modal-title-icon"},e.icon);j.appendChild(ce);}const U=w("span",{className:"custom-sound-modal-title-text"},e.entityName);return j.appendChild(U),j}function M(){const j=w("div",{className:"custom-sound-modal-body"}),V=Re.getItemCustomSound(e.entityType,e.entityId,e.shopType),U=Re.getNotificationConfig(e.entityType);u=V?{soundId:V.soundId,volume:V.volume,mode:V.mode}:{soundId:U.soundId,volume:U.volume,mode:U.mode};const ce=Re.getAll().map($=>({value:$.id,label:$.name})),Y=w("div",{className:"custom-sound-modal-row"}),ie=w("label",{className:"custom-sound-modal-label"},"Sound");Y.appendChild(ie);const se=w("div",{className:"custom-sound-modal-controls"});r=Fr({value:u.soundId,options:ce,size:"sm",onChange:$=>{u&&(u.soundId=$),b();}}),se.appendChild(r.root),o=kt({label:"Play",variant:"default",size:"sm",onClick:()=>A()}),se.appendChild(o),Y.appendChild(se),j.appendChild(Y);const ae=w("div",{className:"custom-sound-modal-row"}),ne=w("label",{className:"custom-sound-modal-label"},"Volume");ae.appendChild(ne),i=gu({min:0,max:100,step:1,value:u.volume,showValue:true,onChange:$=>{u&&(u.volume=$),f&&(f.volume=$/100);}}),ae.appendChild(i.root),j.appendChild(ae);const q=w("div",{className:"custom-sound-modal-row"}),Z=w("label",{className:"custom-sound-modal-label"},"Mode");q.appendChild(Z);const R=w("div",{className:"custom-sound-modal-mode-controls"});return a=Fr({value:u.mode,options:[{value:"one-shot",label:"One-shot"},{value:"loop",label:"Loop"}],size:"sm",onChange:$=>{u&&(u.mode=$),P();}}),R.appendChild(a.root),l=w("div",{className:"custom-sound-modal-mode-description"},Ef[u.mode]),R.appendChild(l),q.appendChild(R),j.appendChild(q),j}function F(){const j=w("div",{className:"custom-sound-modal-footer"}),V=kt({label:"Reset",variant:"danger",size:"sm",onClick:()=>{e.onSave(null),N();}});j.appendChild(V);const U=w("div",{style:"flex: 1"});j.appendChild(U);const ce=kt({label:"Cancel",variant:"default",size:"sm",onClick:()=>N()});j.appendChild(ce);const Y=kt({label:"Save",variant:"primary",size:"sm",onClick:()=>{u&&e.onSave({...u}),N();}});return j.appendChild(Y),j}const L=M(),C=F(),E=w("div");aI(E),E.appendChild(L),n=mu({title:e.entityName||t.title,content:E,footer:C,size:t.size,closeOnBackdrop:t.closeOnBackdrop,closeOnEscape:t.closeOnEscape,onClose:T}),n.root.classList.add("custom-sound-modal");const B=n.root.querySelector(".modal-title");return B&&O().then(j=>B.replaceChildren(j)),{root:n.root,close:N,destroy:z}}const sI=["seed","tool","egg","decor"],lI=new Set(sI);function sc(e){const[t,...n]=e.split(":");return !t||n.length===0||!lI.has(t)?null:{shopType:t,itemId:n.join(":")}}const cI=500,_f=10,dI=800;function uI(e){const{rows:t}=e,n=new Map;let r=null,o=false;const i=new Map;let a=null,l=null,u=null,f=null,p=null,m=false;function v(R,$){$?R.classList.add("has-custom-sound"):R.classList.remove("has-custom-sound");}function y(R){const $=sc(R);return $?Re.hasItemCustomSound("shop",$.itemId,$.shopType):false}function b(R){if(!r)return null;const $=r.root.querySelectorAll(".lg-tr-body");for(const Q of $)if(Q.dataset.id===R)return Q;return null}function A(R,$){const Q=b(R);if(!Q)return;const re=$??y(R);v(Q,re);}function P(){if(!r)return;r.root.querySelectorAll(".lg-tr-body").forEach($=>{const Q=$.dataset.id;Q&&v($,y(Q));});}function I(){o||(o=true,requestAnimationFrame(()=>{o=false,P();}));}function T(R){i.clear();for(const $ of R)i.set(`${$.shopType}:${$.id}`,$);}function N(R){const $=sc(R);return $?Re.hasItemCustomSound("shop",$.itemId,$.shopType):false}function z(R){const $=sc(R);if(!$||!Re.hasItemCustomSound("shop",$.itemId,$.shopType))return;Re.removeItemCustomSound("shop",$.itemId,$.shopType);const Q=i.get(R);Q&&(Q.hasCustomSound=false),A(R,false),I();}function O(){l!==null&&(window.clearTimeout(l),l=null),a=null;}function M(R){a=R,l!==null&&window.clearTimeout(l),l=window.setTimeout(()=>{l=null,a=null;},dI);}function F(){u!==null&&(window.clearTimeout(u),u=null),f=null,p=null,m=false;}if(r=yd({columns:[{key:"item",header:"Item",width:"1fr",align:"left",sortable:true,sortFn:(R,$)=>R.itemName.localeCompare($.itemName,void 0,{numeric:true,sensitivity:"base"}),render:R=>{const $=w("div",{className:"shop-item-cell"}),Q=w("div",{className:"shop-item-icon"});R.spriteId?Qe.toCanvas(R.spriteId).then(le=>{le?(le.className="shop-item-sprite",Q.appendChild(le)):Q.textContent=ac[R.shopType];}).catch(()=>{Q.textContent=ac[R.shopType];}):Q.textContent=ac[R.shopType];const re=w("div",{className:"shop-item-name"});return re.textContent=R.itemName,$.appendChild(Q),$.appendChild(re),$}},{key:"rarity",header:"Rarity",width:"120px",align:"center",sortable:true,sortFn:(R,$)=>{const Q=R.rarity?kf[R.rarity.toLowerCase()]??999:999,re=$.rarity?kf[$.rarity.toLowerCase()]??999:999;return Q-re},render:R=>{const $=w("div",{className:"shop-item-rarity"}),Q=iu({variant:"rarity",rarity:R.rarity});return $.appendChild(Q.root),$}},{key:"notify",header:"Notify",width:"60px",align:"center",sortable:false,render:R=>{const $=w("div",{className:"shop-item-notify"}),Q=wf(R.id,R.shopType),re=Or({checked:R.isTracked,disabled:Q,size:"sm",onChange:ve=>{R.isTracked=ve,ve?$r.addTrackedItem(R.shopType,R.id):$r.removeTrackedItem(R.shopType,R.id);}}),le=`${R.shopType}:${R.id}`;return n.set(le,re),$.appendChild(re.root),$}}],data:t,maxHeight:400,stickyHeader:true,zebra:true,compact:true,getRowId:R=>`${R.shopType}:${R.id}`,onSortChange:()=>{I();},onRowClick:(R,$,Q)=>{const re=`${R.shopType}:${R.id}`;if(a){if(a===re){O();return}O();}Q.target.closest(".shop-item-notify")||Ug({entityType:"shop",entityId:R.id,entityName:R.itemName,spriteId:R.spriteId,shopType:R.shopType,onSave:ve=>{ve===null?(Re.removeItemCustomSound("shop",R.id,R.shopType),R.hasCustomSound=false,A(re,false)):(Re.setItemCustomSound("shop",R.id,ve,R.shopType),R.hasCustomSound=true,A(re,true));}});}}),!r)throw new Error("[ShopsCard] Failed to create items table");T(t);const C=r.root,E=R=>{const $=R.target;if($.closest(".shop-item-notify"))return;const re=$.closest(".lg-tr-body")?.dataset.id;!re||!N(re)||(R.preventDefault(),R.stopPropagation(),M(re),z(re));},B=R=>{if(R.pointerType==="mouse"||R.button!==0)return;const $=R.target;if($.closest(".shop-item-notify"))return;const re=$.closest(".lg-tr-body")?.dataset.id;!re||!N(re)||(F(),f=re,p={x:R.clientX,y:R.clientY},u=window.setTimeout(()=>{u=null,f&&(m=true,M(f),z(f));},cI));},j=R=>{if(!p||!f||m)return;const $=R.clientX-p.x,Q=R.clientY-p.y;$*$+Q*Q>_f*_f&&F();},V=()=>{F();},U=()=>{F();};C.addEventListener("contextmenu",E),C.addEventListener("pointerdown",B),C.addEventListener("pointermove",j),C.addEventListener("pointerup",V),C.addEventListener("pointercancel",U);const ce=r.setData.bind(r);r.setData=R=>{T(R),ce(R),I();},I();const Y=R=>{for(const[$,Q]of n.entries()){const[re,le]=$.split(":");if(R&&re!==R)continue;const ve=wf(le,re);Q.setDisabled(ve);}},se=Lo().subscribeStable(()=>{Y();}),ae=Ur(),ne=ae.subscribeDecorPlaced(()=>{Y("decor");}),q=ae.subscribeDecorRemoved(()=>{Y("decor");}),Z=r.destroy.bind(r);return r.destroy=()=>{se(),ne(),q(),C.removeEventListener("contextmenu",E),C.removeEventListener("pointerdown",B),C.removeEventListener("pointermove",j),C.removeEventListener("pointerup",V),C.removeEventListener("pointercancel",U),F(),O(),n.clear(),i.clear(),Z();},r}function pI(e){let t="";for(const n of e)n.length>t.length&&(t=n);return t}function fI(e,t){const n=e.getRootNode(),r=n instanceof ShadowRoot?n:document.body||document.documentElement;if(!r)return 0;const o=w("div",{className:"select"});for(const p of Array.from(e.classList))p.startsWith("select--")&&o.classList.add(p);o.style.position="absolute",o.style.visibility="hidden",o.style.pointerEvents="none",o.style.left="-9999px",o.style.top="-9999px",o.style.minWidth="0";const i=w("button",{className:"select-trigger",type:"button"});i.style.width="auto",i.style.minWidth="0",i.style.whiteSpace="nowrap";const a=e.querySelector(".select-caret")?.textContent||"v",l=w("span",{className:"select-value"},t),u=w("span",{className:"select-caret"},a);i.append(l,u),o.appendChild(i),r.appendChild(o);const f=Math.ceil(i.getBoundingClientRect().width);return o.remove(),f}function hI(e,t){const n=pI(t);if(!n)return;let r=0;const o=6,i=()=>{if(r+=1,!e.isConnected){r<o&&requestAnimationFrame(i);return}const a=fI(e,n);a>0&&(e.style.width=`${a}px`,e.style.minWidth=`${a}px`);};requestAnimationFrame(i);}function mI(e){const t=Mo(),n=t.get();let r=null,o=[],i=[];const a={selectedShopType:"all",searchQuery:""},l={shopTypeSelect:null,searchInput:null,tableHandle:null};let u=0,f=new Set;function p(P,I){if(P.size!==I.size)return  false;for(const T of P)if(!I.has(T))return  false;return  true}function m(){if(!l.tableHandle)return;const P=o.filter(I=>!(a.selectedShopType!=="all"&&I.shopType!==a.selectedShopType||a.searchQuery&&!I.itemName.toLowerCase().includes(a.searchQuery.toLowerCase())));i=P,l.tableHandle.setData(P);}function v(){const P=w("div",{className:"shops-card-filters"}),T=[{value:"all",label:"All Shops"},...["seed","tool","egg","decor"].map(z=>({value:z,label:Y_[z]}))];l.shopTypeSelect=Fr({value:"all",options:T,size:"sm",onChange:z=>{a.selectedShopType=z,m();}});const N=l.shopTypeSelect.root;return N.style.minWidth="0",N.style.width="auto",hI(N,T.map(z=>z.label)),l.searchInput=Gs({placeholder:"Search items...",size:"sm",debounceMs:150,autoSearch:true,withClear:true,blockGameKeys:true,focusKey:"",onSearch:z=>{a.searchQuery=z.trim(),m();}}),P.appendChild(l.shopTypeSelect.root),P.appendChild(l.searchInput.root),P}function y(){o=Sf(n),i=[...o],u=o.length,f=new Set(o.map(O=>O.shopType));const P=w("div");l.tableHandle=uI({rows:i});const I=v();P.appendChild(I),P.appendChild(l.tableHandle.root);const T=w("div",{className:"shops-card-hint"}),N=w("span",{className:"shops-card-hint-desktop"},"Click an item to set a custom sound alert. Right-click to reset"),z=w("span",{className:"shops-card-hint-mobile"},"Tap an item to set a custom sound alert. Long-press to reset");return T.append(N,z),P.appendChild(T),r=pt({id:"shops-card",title:"Shops restock",subtitle:"Get notified when tracked items restock",expandable:true,defaultExpanded:e?.defaultExpanded??true,stateKey:"shops",variant:"soft",padding:"none",divider:false,onExpandChange:e?.onExpandChange},P),r}function b(){const P=t.get(),I=Sf(P),T=I.length,N=new Set(I.map(O=>O.shopType));(T!==u||!p(N,f))&&(u=T,f=N,o=I,m());}function A(){if(l.tableHandle&&(l.tableHandle.destroy(),l.tableHandle=null),l.shopTypeSelect&&(l.shopTypeSelect.destroy(),l.shopTypeSelect=null),l.searchInput){const P=l.searchInput.root.__cleanup;P&&P(),l.searchInput=null;}r=null;}return {root:y(),refresh:b,destroy:A}}const gI=".mp3,.wav,.ogg,audio/*",bI=250*1024,vI=3;function yI(){return typeof crypto<"u"&&"randomUUID"in crypto?crypto.randomUUID():`sound-${Date.now().toString(16)}-${Math.random().toString(16).slice(2)}`}function xI(e){const t=e.name||"Untitled",n=t.lastIndexOf(".");return n<=0?t:t.slice(0,n)||t}function wI(e){if(!Number.isFinite(e))return "0 B";if(e<1024)return `${e} B`;const t=e/1024;return t<1024?`${Math.round(t)} KB`:`${(t/1024).toFixed(1)} MB`}function Wg(e){return e.split(",").map(t=>t.trim()).filter(Boolean)}function CI(e,t){const n=Wg(t);if(!n.length)return  true;const r=e.name.toLowerCase(),o=e.type.toLowerCase();return n.some(i=>{const a=i.toLowerCase();if(a.startsWith("."))return r.endsWith(a);if(a.endsWith("/*")){const l=a.slice(0,-1);return o.startsWith(l)}return o===a})}function kI(e){const n=Wg(e).map(r=>r.startsWith(".")?r.slice(1).toUpperCase():r.endsWith("/*")?"Audio":r.includes("/")&&r.split("/")[1]?.toUpperCase()||r.toUpperCase()).filter(Boolean);return n.length?n.join(", "):"Audio"}function SI(e={}){const{id:t,className:n,label:r="Add sounds",hint:o,accept:i=gI,multiple:a=true,disabled:l=false,maxSizeBytes:u=bI,maxItems:f,emptyLabel:p="No sounds added yet",onItemsChange:m,onFilesAdded:v,onError:y}=e;let b=[],A=0,P=null,I=false,T=!!l,N=null,z=null,O=null;const M=new Map,F=new Map,L=Number.isFinite(f)?Math.max(1,Number(f)):a?Number.POSITIVE_INFINITY:1,C=w("div",{className:"sound-picker",id:t});n&&C.classList.add(...n.split(" ").filter(Boolean)),T&&C.classList.add("is-disabled");const E=w("div",{className:"sound-picker__header"}),B=w("div",{className:"sound-picker__label"},r),j=o??`${kI(i)} - Max ${wI(u)}`,V=w("div",{className:"sound-picker__hint"},j);E.append(B,V);const U=w("div",{className:"sound-picker__zone",role:"button",tabIndex:T?-1:0,"aria-disabled":String(T)}),ce=w("div",{className:"sound-picker__zone-text"}),Y=w("div",{className:"sound-picker__zone-title"},"Drop audio files here"),ie=w("div",{className:"sound-picker__zone-subtitle"},"or click to browse");ce.append(Y,ie);const se=kt({label:a?"Choose files":"Choose file",size:"sm",onClick:h=>{h.preventDefault(),T||ae.click();},disabled:T});se.classList.add("sound-picker__pick");const ae=w("input",{className:"sound-picker__input",type:"file",accept:i,multiple:a?true:void 0,disabled:T,tabIndex:-1});U.append(ce,se,ae);const ne=w("div",{className:"sound-picker__status",role:"status","aria-live":"polite"}),q=w("div",{className:"sound-picker__list",role:"list"});C.append(E,U,ne,q);function Z(h,S="info"){const G=h??"";ne.textContent=G,ne.classList.toggle("is-error",S==="error");}function R(h){y?.(h),Z(h.message,"error");}function $(){for(const h of M.values())try{h.destroy();}catch{}M.clear();}function Q(h){const S=F.get(h.id);if(S)return S;const G=h.file.__sourceUrl;if(G)return F.set(h.id,G),G;const W=URL.createObjectURL(h.file);return F.set(h.id,W),W}function re(h){const S=F.get(h);S&&(S.startsWith("blob:")&&URL.revokeObjectURL(S),F.delete(h));}function le(){O?.(),O=null,N&&(N.pause(),N.currentTime=0),N=null,z=null;}function ve(){q.querySelectorAll(".sound-picker__item").forEach(S=>{const G=S.dataset.id,W=S.querySelector(".sound-picker__item-btn--play");if(!G||!W)return;const J=!!N&&z===G&&!N.paused;W.textContent=J?"Stop":"Play",S.classList.toggle("is-playing",J);});}function _e(h){if(T)return;if(z===h.id){le(),ve();return}le();const S=Q(h),G=new Audio(S);N=G,z=h.id;const W=()=>{z===h.id&&(le(),ve());},J=()=>{z===h.id&&(le(),ve(),R({code:"type",file:h.file,message:`Unable to play ${h.name}`}));};G.addEventListener("ended",W),G.addEventListener("error",J),O=()=>{G.removeEventListener("ended",W),G.removeEventListener("error",J);},G.play().then(()=>{ve();}).catch(()=>{le(),ve(),R({code:"type",file:h.file,message:`Unable to play ${h.name}`});});}function $e(){if($(),q.classList.toggle("is-scrollable",b.length>vI),!b.length){const S=w("div",{className:"sound-picker__empty"});S.append(typeof p=="string"?document.createTextNode(p):p),q.replaceChildren(S);return}const h=b.map(S=>vt(S));if(q.replaceChildren(...h),P){const S=M.get(P);S&&requestAnimationFrame(()=>S.focus());}ve();}function vt(h){const S=P===h.id,G=w("div",{className:"sound-picker__item",role:"listitem","data-id":h.id}),W=w("div",{className:"sound-picker__item-top"});w("div",{className:"sound-picker__item-bottom"});const J=w("div",{className:"sound-picker__item-name"});if(S&&!T){const ye=js({value:h.name,blockGameKeys:true,onEnter:ge=>{Lt(h.id,ge);}});ye.root.classList.add("sound-picker__rename"),ye.input.classList.add("input--sm"),ye.input.setAttribute("aria-label","Rename sound"),ye.input.addEventListener("keydown",ge=>{ge.key==="Escape"&&(ge.preventDefault(),Ht());}),ye.input.addEventListener("blur",()=>{if(I){I=false;return}Lt(h.id,ye.getValue());}),M.set(h.id,ye),J.appendChild(ye.root);}else {const ye=w("div",{className:"sound-picker__item-label",title:h.name},h.name);J.appendChild(ye);}const de=w("div",{className:"sound-picker__item-actions","aria-label":"Sound actions"});if(S&&!T){const ye=w("button",{className:"sound-picker__item-btn",type:"button",disabled:T},"Save");ye.addEventListener("click",()=>{const we=M.get(h.id);Lt(h.id,we?.getValue()??h.name);});const ge=w("button",{className:"sound-picker__item-btn",type:"button",disabled:T},"Cancel");ge.addEventListener("pointerdown",()=>{I=true;}),ge.addEventListener("click",()=>Ht()),de.append(ye,ge);}else {const ye=w("button",{className:"sound-picker__item-btn sound-picker__item-btn--play",type:"button",disabled:T},z===h.id?"Stop":"Play");ye.addEventListener("click",()=>_e(h));const ge=w("button",{className:"sound-picker__item-btn",type:"button",disabled:T},"Rename");ge.addEventListener("click",()=>{T||(P=h.id,$e());});const we=w("button",{className:"sound-picker__item-btn sound-picker__item-btn--danger",type:"button",disabled:T},"Remove");we.addEventListener("click",()=>tt(h.id)),de.append(ye,ge,we);}return W.append(J,de),G.append(W),G}function Bt(){return b.slice()}function ct(h){const S=h.slice(),G=new Set(S.map(W=>W.id));for(const W of Array.from(F.keys()))G.has(W)||re(W);z&&!G.has(z)&&le(),b=S,P=null,$e(),m?.(Bt());}function Et(h){if(T)return;const S=Array.from(h??[]);if(!S.length)return;const G=[],W=[];for(const we of S){if(i&&!CI(we,i)){W.push({code:"type",file:we,message:`Unsupported file type: ${we.name}`});continue}if(Number.isFinite(u)&&we.size>u){W.push({code:"size",file:we,maxSizeBytes:u,message:`File too large: ${we.name}`});continue}G.push({id:yI(),file:we,name:xI(we),size:we.size,type:we.type});}if(!G.length){W.length&&R(W[0]);return}const J=a?b.slice():[],de=Number.isFinite(L)?Math.max(0,L-J.length):G.length;if(de<=0){R({code:"limit",message:`Maximum of ${Math.max(1,L)} files reached`});return}const ye=G.slice(0,de),ge=a?J.concat(ye):ye.slice(0,1);ct(ge),Z(null),v?.(ye.slice()),W.length&&R(W[0]);}function Wt(h,S){const G=S.trim();if(!G){R({code:"name",message:"Name cannot be empty"});return}const W=b.map(J=>J.id===h?{...J,name:G}:J);ct(W),Z(null);}function Lt(h,S){const G=S.trim();if(!G){R({code:"name",message:"Name cannot be empty"});return}Wt(h,G);}function Ht(){P=null,Z(null),$e();}function tt(h){const S=b.filter(G=>G.id!==h);ct(S),Z(null);}function Ne(){le(),ct([]),Z(null);}function mn(h){T=!!h,C.classList.toggle("is-disabled",T),U.setAttribute("aria-disabled",String(T)),U.tabIndex=T?-1:0,ae.disabled=T,se.setDisabled(T),T&&le(),$e();}function gn(){T||ae.click();}const ut=h=>{if(T)return;const S=h.target;S&&S.closest(".sound-picker__pick")||ae.click();},wt=h=>{T||(h.key==="Enter"||h.key===" ")&&(h.preventDefault(),ae.click());},Vt=h=>{T||!h.dataTransfer||!h.dataTransfer.types.includes("Files")||(h.preventDefault(),A+=1,U.classList.add("is-dragover"));},Sn=h=>{T||!h.dataTransfer||!h.dataTransfer.types.includes("Files")||(h.preventDefault(),h.dataTransfer.dropEffect="copy");},tn=h=>{T||U.classList.contains("is-dragover")&&(h.preventDefault(),A=Math.max(0,A-1),A<=0&&(A=0,U.classList.remove("is-dragover")));},k=h=>{T||!h.dataTransfer||!h.dataTransfer.files.length||(h.preventDefault(),A=0,U.classList.remove("is-dragover"),Et(h.dataTransfer.files));},d=()=>{if(T){ae.value="";return}ae.files&&Et(ae.files),ae.value="";};return U.addEventListener("click",ut),U.addEventListener("keydown",wt),U.addEventListener("dragenter",Vt),U.addEventListener("dragover",Sn),U.addEventListener("dragleave",tn),U.addEventListener("drop",k),ae.addEventListener("change",d),$e(),{root:C,getItems:Bt,setItems:ct,addFiles:Et,renameItem:Wt,removeItem:tt,clear:Ne,setDisabled:mn,openPicker:gn,setStatus:Z,destroy(){$(),le();for(const h of Array.from(F.keys()))re(h);U.removeEventListener("click",ut),U.removeEventListener("keydown",wt),U.removeEventListener("dragenter",Vt),U.removeEventListener("dragover",Sn),U.removeEventListener("dragleave",tn),U.removeEventListener("drop",k),ae.removeEventListener("change",d),C.remove();}}}const If={shop:{"one-shot":"Play sound once when item appears",loop:"Loop sound while item is available in shop"},pet:{"one-shot":"Play sound once when pet event occurs",loop:"Loop sound while pet event is active"},weather:{"one-shot":"Play sound once when weather occurs",loop:"Loop sound while weather is active"}};function AI(e){let t="";for(const n of e)n.length>t.length&&(t=n);return t}function EI(e,t){const n=e.getRootNode(),r=n instanceof ShadowRoot?n:document.body||document.documentElement;if(!r)return 0;const o=w("div",{className:"select"});for(const p of Array.from(e.classList))p.startsWith("select--")&&o.classList.add(p);o.style.position="absolute",o.style.visibility="hidden",o.style.pointerEvents="none",o.style.left="-9999px",o.style.top="-9999px",o.style.minWidth="0";const i=w("button",{className:"select-trigger",type:"button"});i.style.width="auto",i.style.minWidth="0",i.style.whiteSpace="nowrap";const a=e.querySelector(".select-caret")?.textContent||"v",l=w("span",{className:"select-value"},t),u=w("span",{className:"select-caret"},a);i.append(l,u),o.appendChild(i),r.appendChild(o);const f=Math.ceil(i.getBoundingClientRect().width);return o.remove(),f}function _I(e,t){const n=AI(t);if(!n)return;let r=0;const o=6,i=()=>{if(r+=1,!e.isConnected){r<o&&requestAnimationFrame(i);return}const a=EI(e,n);a>0&&(e.style.width=`${a}px`,e.style.minWidth=`${a}px`);};requestAnimationFrame(i);}function II(e){let t=null,n=null,r=null;const o=new Map,i=new Map,a=new Map;let l=null,u=null,f=null;function p(){f?.(),f=null,l&&(l.pause(),l.currentTime=0),l=null,u=null;}function m(){if(!r)return;r.querySelectorAll(".notification-item").forEach(M=>{const F=M.dataset.type,L=M.querySelector(".notification-item-play");if(!F||!L)return;const C=!!l&&u===F&&!l.paused;L.textContent=C?"Stop":"Play",M.classList.toggle("is-playing",C);});}async function v(O){if(u===O){p(),m();return}p();const M=Re.getNotificationConfig(O),F=Re.getById(M.soundId);if(!F){console.error(`[SettingCard] Sound not found: ${M.soundId}`);return}const L=new Audio(F.source);L.volume=M.volume/100,l=L,u=O;const C=()=>{u===O&&(p(),m());},E=()=>{u===O&&(p(),m(),console.error(`[SettingCard] Failed to play sound: ${F.name}`));};L.addEventListener("ended",C),L.addEventListener("error",E),f=()=>{L.removeEventListener("ended",C),L.removeEventListener("error",E);};try{await L.play(),m();}catch(B){p(),m(),console.error("[SettingCard] Failed to play sound:",B);}}function y(O,M){if(O.startsWith("data:"))try{const F=O.split(","),L=F[0].match(/:(.*?);/)?.[1]||"audio/mpeg",C=atob(F[1]),E=C.length,B=new Uint8Array(E);for(let j=0;j<E;j++)B[j]=C.charCodeAt(j);return new File([B],M,{type:L})}catch(F){return console.error("[SettingCard] Failed to convert data URL to File:",F),new File([],M,{type:"audio/mpeg"})}return new File([],M,{type:"audio/mpeg"})}function b(){const M=Re.getAll().map(F=>({value:F.id,label:F.name}));for(const[F,L]of o){const C=Re.getNotificationConfig(F);L.setOptions(M),L.setValue(C.soundId);}}function A(O,M,F){const L=w("div",{className:"notification-item","data-type":O}),C=w("div",{className:"notification-item-label"},M);L.appendChild(C);const E=w("div",{className:"notification-item-description"},F);L.appendChild(E);const B=w("div",{className:"notification-item-controls"}),j=Re.getNotificationConfig(O),U=Re.getAll().map(Z=>({value:Z.id,label:Z.name})),ce=Fr({value:j.soundId,options:U,size:"sm",onChange:Z=>{const R=Re.getNotificationConfig(O);Re.setNotificationConfig(O,{soundId:Z,volume:R.volume,mode:R.mode});}});o.set(O,ce);const Y=w("button",{className:"notification-item-play",type:"button",title:"Test sound"},"Play");Y.addEventListener("click",()=>{v(O);}),B.appendChild(ce.root),B.appendChild(Y),L.appendChild(B);const ie=gu({min:0,max:100,step:1,value:j.volume,showValue:true,onChange:Z=>{const R=Re.getNotificationConfig(O);Re.setNotificationConfig(O,{soundId:R.soundId,volume:Z,mode:R.mode});}});a.set(O,ie),L.appendChild(ie.root);const se=w("div",{className:"notification-mode-row"}),ae=[{value:"one-shot",label:"One-shot"},{value:"loop",label:"Loop"}],ne=Fr({value:j.mode,options:ae,size:"sm",onChange:Z=>{const R=Re.getNotificationConfig(O);Re.setNotificationConfig(O,{soundId:R.soundId,volume:R.volume,mode:Z}),P(O);}});i.set(O,ne),ne.root.classList.add("shrink"),_I(ne.root,ae.map(Z=>Z.label)),se.appendChild(ne.root);const q=w("div",{className:"notification-mode-description"},If[O][j.mode]);return se.appendChild(q),L.appendChild(se),L}function P(O){if(!r)return;const M=r.querySelector(`[data-type="${O}"]`);if(!M)return;const F=Re.getNotificationConfig(O),L=M.querySelector(".notification-mode-description");L&&(L.textContent=If[O][F.mode]);}function I(){const O=w("div",{className:"alerts-settings-body"});Re.init(),r=w("div",{className:"notification-settings"}),r.appendChild(A("shop","Shops restock","Default sound for shop restock alerts")),r.appendChild(A("pet","Pet events","Default sound for pet event alerts")),r.appendChild(A("weather","Weather events","Default sound for weather event alerts")),O.appendChild(r);const M=w("div",{className:"alerts-settings-divider"});O.appendChild(M);const F=Re.getAll().map(L=>{const C=y(L.source,L.name);return C.__sourceUrl=L.source,{id:L.id,file:C,name:L.name,size:0,type:L.type}});return n=SI({label:"Notification sounds",hint:"Upload or drop audio files for alerts",maxItems:xo.MAX_SOUNDS,maxSizeBytes:xo.MAX_SIZE_BYTES,multiple:true,onItemsChange:L=>{T(L),b();},onFilesAdded:L=>{N(L),setTimeout(()=>{b();},100);}}),n.setItems(F),O.appendChild(n.root),t=pt({id:"alerts-settings-card",title:"Settings",subtitle:"Manage notification sounds",expandable:true,defaultExpanded:e?.defaultExpanded??true,stateKey:"settings",variant:"soft",padding:"none",divider:false,onExpandChange:e?.onExpandChange},O),t}function T(O){const M=new Set(Re.getAll().map(C=>C.id)),F=new Set(O.map(C=>C.id)),L=[];for(const C of M)if(!F.has(C)){L.push(C);try{Re.remove(C);}catch(E){console.error(`[SettingCard] Failed to remove sound ${C}:`,E);}}if(L.length>0){const C=["shop","pet","weather"];for(const E of C){const B=Re.getNotificationConfig(E);if(L.includes(B.soundId)){Re.setNotificationConfig(E,{soundId:"default-notification",volume:B.volume,mode:B.mode});const j=a.get(E);j&&j.setValue(B.volume);}}}for(const C of O)if(M.has(C.id)){const E=Re.getById(C.id);if(E&&E.name!==C.name)try{Re.update(C.id,{name:C.name});}catch(B){console.error(`[SettingCard] Failed to rename sound ${C.id}:`,B);}}}function N(O){for(const M of O)if(!Re.getById(M.id)){const F=new FileReader;F.onload=L=>{const C=L.target?.result;try{const E=Re.add(M.name,C,"upload");if(n&&E.id!==M.id){const B=n.getItems().map(j=>j.id===M.id?{...j,id:E.id}:j);n.setItems(B);}}catch(E){console.error(`[SettingCard] Failed to add sound ${M.name}:`,E);}},F.onerror=()=>{console.error(`[SettingCard] Failed to read file ${M.name}`);},F.readAsDataURL(M.file);}}function z(){p(),n&&(n.destroy(),n=null);for(const O of o.values())O.destroy();o.clear();for(const O of i.values())O.destroy();i.clear(),a.clear(),t=null;}return {root:I(),destroy:z}}const Hg=At.WEATHER_NOTIFIER,TI={enabled:false,trackedWeathers:[]};function Vg(e){return Array.isArray(e)?[...e]:[]}function al(e){return [...e]}function Ki(){const e=at(Hg,TI);return {enabled:e?.enabled??false,trackedWeathers:Vg(e?.trackedWeathers)}}function bu(e){st(Hg,{enabled:e.enabled,trackedWeathers:al(e.trackedWeathers)});}function PI(e){const n={...Ki(),...e};return e.trackedWeathers&&(n.trackedWeathers=Vg(e.trackedWeathers)),bu(n),n}function Kg(){return Ki().enabled}function LI(e){PI({enabled:e});}function sl(){return al(Ki().trackedWeathers)}function MI(e){return sl().includes(e)}function RI(e){const t=Ki(),n=al(t.trackedWeathers);if(n.includes(e))return;n.push(e);const r=!t.enabled&&n.length>0,o={trackedWeathers:n,enabled:r?true:t.enabled};bu(o);const i=new CustomEvent("gemini:tracked-weathers-changed",{detail:{weatherId:e,action:"add",shouldReinit:r}});window.dispatchEvent(i);const a=new CustomEvent("gemini:weather-tracked-check",{detail:{weatherId:e}});window.dispatchEvent(a);}function FI(e){const t=Ki(),n=al(t.trackedWeathers),r=n.filter(l=>l!==e);if(r.length===n.length)return;const o=t.enabled&&r.length===0,i={trackedWeathers:r,enabled:o?false:t.enabled};bu(i);const a=new CustomEvent("gemini:tracked-weathers-changed",{detail:{weatherId:e,action:"remove",shouldReinit:o}});window.dispatchEvent(a);}let gi=null,Za="Sunny",qn=false,bi=null,ks="";function Yg(e){return `${e.soundId}:${e.volume}:${e.mode}`}function Ss(e){const t=Re.getItemCustomSound("weather",e);return t?{soundId:t.soundId,volume:t.volume,mode:t.mode}:xt.CustomSounds.getNotificationConfig("weather")}function OI(e){if(qn)return;const t=xt.CustomSounds.getById(e.soundId);if(t){bi=t.source,qn=true,ks=Yg(e);try{xt.CustomSounds.play(e.soundId,{volume:e.volume/100,loop:!0});}catch{qn=false,bi=null,ks="";}}}function es(){if(qn){try{const e=xt.getCustomHandle();(!bi||e&&e.url===bi)&&xt.CustomSounds.stop();}catch{}qn=false,bi=null,ks="";}}function Pi(e,t){const n=t??Ss(e);if(n.mode!=="loop"){qn&&es();return}if(!sl().includes(e)){qn&&es();return}const i=Yg(n);qn&&i!==ks&&es(),qn||OI(n);}function qg(e){const{weatherId:t}=e.detail||{};if(!t)return;const o=Hi().get().id,i=Ss(t);if(o===t){console.log("[WeatherNotifier] Manually tracked weather is currently active:",t),i.mode==="one-shot"&&Jg(i),Pi(o,i);const a=new CustomEvent("gemini:weather-appeared",{detail:{weatherId:t}});window.dispatchEvent(a);}}function Xg(){const t=Hi().get().id;Pi(t);}function Qg(e){if(e.detail?.entityType!=="weather")return;const r=Hi().get().id;Pi(r);}function NI(){if(gi){console.log("[WeatherNotifier] Already tracking");return}const e=Hi(),t=e.get();Za=t.id,console.log("[WeatherNotifier] Starting tracking, initial weather:",Za),window.addEventListener("gemini:weather-tracked-check",qg),window.addEventListener("gemini:tracked-weathers-changed",Xg),window.addEventListener(ft.CUSTOM_SOUND_CHANGE,Qg);const n=Ss(t.id);Pi(t.id,n),gi=e.subscribeStable(r=>{const o=r.current.id,i=r.previous.id,a=Ss(o);if(console.log("[WeatherNotifier] Weather changed:",{previous:i,current:o}),Pi(o,a),o!==i&&sl().includes(o)){console.log("[WeatherNotifier] Tracked weather detected:",o),a.mode==="one-shot"&&Jg(a);const u=new CustomEvent("gemini:weather-appeared",{detail:{weatherId:o}});window.dispatchEvent(u);}Za=o;}),console.log("[WeatherNotifier] Tracking initialized");}function DI(){window.removeEventListener("gemini:weather-tracked-check",qg),window.removeEventListener("gemini:tracked-weathers-changed",Xg),window.removeEventListener(ft.CUSTOM_SOUND_CHANGE,Qg),gi&&(gi(),gi=null,Za="Sunny",es(),console.log("[WeatherNotifier] Tracking stopped"));}function Jg(e){try{xt.CustomSounds.play(e.soundId,{volume:e.volume/100});}catch(t){console.warn("[WeatherNotifier] Failed to play notification sound:",t);}}let Li=false;function Zg(e){const{shouldReinit:t}=e.detail||{};t&&(console.log("[WeatherNotifier] Config changed, reinitializing..."),tb(),eb());}function eb(){if(Li){console.log("[WeatherNotifier] Already initialized");return}if(Li=true,window.addEventListener("gemini:tracked-weathers-changed",Zg),!Kg()){console.log("[WeatherNotifier] Disabled (waiting for tracked weathers)");return}console.log("[WeatherNotifier] Initializing"),NI(),console.log("[WeatherNotifier] Initialized");}function tb(){Li&&(console.log("[WeatherNotifier] Destroying"),window.removeEventListener("gemini:tracked-weathers-changed",Zg),DI(),Li=false,console.log("[WeatherNotifier] Destroyed"));}function $I(){return Li}const ko={init:eb,destroy:tb,isReady:$I,isEnabled:Kg,setEnabled:LI,getTrackedWeathers:sl,addTrackedWeather:RI,removeTrackedWeather:FI,isWeatherTracked:MI};function BI(e){try{const t=Oe.get("weather");if(!t||typeof t!="object")return e;const n=t[e];return !n||typeof n!="object"?e:n.name||e}catch{return e}}function zI(e){try{const t=Oe.get("weather");if(!t||typeof t!="object")return null;const n=t[e];return !n||typeof n!="object"?null:n.spriteId||null}catch{return null}}function jI(e){try{const t=Oe.get("weather");if(!t||typeof t!="object")return "No effects";const n=t[e];if(!n||typeof n!="object")return "No effects";const r=n.mutator;if(!r||typeof r!="object")return "No effects";const o=r.mutation;if(!o)return "No effects";const i=Oe.get("mutations");if(!i||typeof i!="object")return o;const a=i[o];return !a||typeof a!="object"?o:a.name||o}catch{return "No effects"}}function Tf(){const e=Oe.get("weather");if(!e||typeof e!="object")return [];const t=ko.getTrackedWeathers(),n=new Set(t),r=[];for(const o of Object.keys(e)){if(o==="Sunny")continue;const i={weatherId:o,weatherName:BI(o),spriteId:zI(o),effects:jI(o),isTracked:n.has(o),hasCustomSound:Re.hasItemCustomSound("weather",o)};r.push(i);}return r.sort((o,i)=>o.weatherName.localeCompare(i.weatherName)),r}const GI=500,Pf=10,UI=800;function WI(e){const{rows:t}=e;let n=null,r=false;const o=new Map;let i=null,a=null,l=null,u=null,f=null,p=false;function m(Y,ie){ie?Y.classList.add("has-custom-sound"):Y.classList.remove("has-custom-sound");}function v(Y){return Re.hasItemCustomSound("weather",Y)}function y(Y){if(!n)return null;const ie=n.root.querySelectorAll(".lg-tr-body");for(const se of ie)if(se.dataset.id===Y)return se;return null}function b(Y,ie){const se=y(Y);if(!se)return;const ae=ie??v(Y);m(se,ae);}function A(){if(!n)return;n.root.querySelectorAll(".lg-tr-body").forEach(ie=>{const se=ie.dataset.id;se&&m(ie,v(se));});}function P(){r||(r=true,requestAnimationFrame(()=>{r=false,A();}));}function I(Y){o.clear();for(const ie of Y)o.set(ie.weatherId,ie);}function T(Y){return Re.hasItemCustomSound("weather",Y)}function N(Y){if(!Re.hasItemCustomSound("weather",Y))return;Re.removeItemCustomSound("weather",Y);const ie=o.get(Y);ie&&(ie.hasCustomSound=false),b(Y,false),P();}function z(){a!==null&&(window.clearTimeout(a),a=null),i=null;}function O(Y){i=Y,a!==null&&window.clearTimeout(a),a=window.setTimeout(()=>{a=null,i=null;},UI);}function M(){l!==null&&(window.clearTimeout(l),l=null),u=null,f=null,p=false;}if(n=yd({columns:[{key:"weather",header:"Weather",width:"1fr",align:"left",sortable:true,sortFn:(Y,ie)=>Y.weatherName.localeCompare(ie.weatherName,void 0,{numeric:true,sensitivity:"base"}),render:Y=>{const ie=w("div",{className:"weather-item-cell"}),se=w("div",{className:"weather-item-icon"});Y.spriteId&&Qe.has(Y.spriteId)?Qe.toCanvas(Y.spriteId).then(ne=>{ne.className="weather-item-sprite",se.appendChild(ne);}).catch(()=>{se.textContent=Lf(Y.weatherId);}):se.textContent=Lf(Y.weatherId);const ae=w("div",{className:"weather-item-name"});return ae.textContent=Y.weatherName,ie.appendChild(se),ie.appendChild(ae),ie}},{key:"effects",header:"Effects",width:"120px",align:"center",sortable:false,render:Y=>{const ie=w("div",{className:"weather-item-effects"});return ie.textContent=Y.effects,ie}},{key:"notify",header:"Notify",width:"60px",align:"center",sortable:false,render:Y=>{const ie=w("div",{className:"weather-item-notify"}),se=Or({checked:Y.isTracked,disabled:false,size:"sm",onChange:ae=>{Y.isTracked=ae,ae?ko.addTrackedWeather(Y.weatherId):ko.removeTrackedWeather(Y.weatherId);}});return ie.appendChild(se.root),ie}}],data:t,maxHeight:280,stickyHeader:true,zebra:true,compact:true,getRowId:Y=>Y.weatherId,onSortChange:()=>{P();},onRowClick:(Y,ie,se)=>{const ae=Y.weatherId;if(i){if(i===ae){z();return}z();}se.target.closest(".weather-item-notify")||Ug({entityType:"weather",entityId:Y.weatherId,entityName:Y.weatherName,spriteId:Y.spriteId,onSave:q=>{q===null?(Re.removeItemCustomSound("weather",Y.weatherId),Y.hasCustomSound=false,b(ae,false)):(Re.setItemCustomSound("weather",Y.weatherId,q),Y.hasCustomSound=true,b(ae,true));}});}}),!n)throw new Error("[WeatherCard] Failed to create weather table");I(t);const L=n.root,C=Y=>{const ie=Y.target;if(ie.closest(".weather-item-notify"))return;const ae=ie.closest(".lg-tr-body")?.dataset.id;!ae||!T(ae)||(Y.preventDefault(),Y.stopPropagation(),O(ae),N(ae));},E=Y=>{if(Y.pointerType==="mouse"||Y.button!==0)return;const ie=Y.target;if(ie.closest(".weather-item-notify"))return;const ae=ie.closest(".lg-tr-body")?.dataset.id;!ae||!T(ae)||(M(),u=ae,f={x:Y.clientX,y:Y.clientY},l=window.setTimeout(()=>{l=null,u&&(p=true,O(u),N(u));},GI));},B=Y=>{if(!f||!u||p)return;const ie=Y.clientX-f.x,se=Y.clientY-f.y;ie*ie+se*se>Pf*Pf&&M();},j=()=>{M();},V=()=>{M();};L.addEventListener("contextmenu",C),L.addEventListener("pointerdown",E),L.addEventListener("pointermove",B),L.addEventListener("pointerup",j),L.addEventListener("pointercancel",V);const U=n.setData.bind(n);n.setData=Y=>{I(Y),U(Y),P();},P();const ce=n.destroy.bind(n);return n.destroy=()=>{L.removeEventListener("contextmenu",C),L.removeEventListener("pointerdown",E),L.removeEventListener("pointermove",B),L.removeEventListener("pointerup",j),L.removeEventListener("pointercancel",V),M(),z(),o.clear(),ce();},n}function Lf(e){return {Sunny:"☀️",Rain:"🌧️",Frost:"❄️",Dawn:"🌅",AmberMoon:"🌕"}[e]||"🌤️"}function HI(e){let t=null,n=[];const r={tableHandle:null};let o=0;function i(){n=Tf(),o=n.length;const u=w("div");r.tableHandle=WI({rows:n}),u.appendChild(r.tableHandle.root);const f=w("div",{className:"weather-card-hint"}),p=w("span",{className:"weather-card-hint-desktop"},"Click a weather to set a custom sound alert. Right-click to reset"),m=w("span",{className:"weather-card-hint-mobile"},"Tap a weather to set a custom sound alert. Long-press to reset");return f.append(p,m),u.appendChild(f),t=pt({id:"weather-card",title:"Weather events",subtitle:"Get notified when specific weather appears",expandable:true,defaultExpanded:e?.defaultExpanded??true,stateKey:"weather",variant:"soft",padding:"none",divider:false,onExpandChange:e?.onExpandChange},u),t}function a(){const u=Tf(),f=u.length;f!==o&&(o=f,n=u,r.tableHandle?.setData(u));}function l(){r.tableHandle&&(r.tableHandle.destroy(),r.tableHandle=null),t=null;}return {root:i(),refresh:a,destroy:l}}const VI={enabled:false,threshold:5};function ll(){return at(At.PET_HUNGER_NOTIFIER,VI)}function nb(e){st(At.PET_HUNGER_NOTIFIER,e);}function rb(){return ll().enabled}function KI(e){const t=ll();t.enabled=e,nb(t);const n=new CustomEvent("gemini:pet-hunger-config-changed",{detail:{shouldReinit:true}});window.dispatchEvent(n);}function ob(){return ll().threshold}function YI(e){const t=ll();t.threshold=e,nb(t);}let vi=null;const ts=new Set;let cr=false,yi=null;function qI(e){if(cr)return;const t=xt.CustomSounds.getById(e.soundId);if(t){yi=t.source,cr=true;try{xt.CustomSounds.play(e.soundId,{volume:e.volume/100,loop:!0});}catch{cr=false,yi=null;}}}function Zc(){if(cr){try{const e=xt.getCustomHandle();(!yi||e&&e.url===yi)&&xt.CustomSounds.stop();}catch{}cr=false,yi=null;}}function XI(e,t){if(t.mode!=="loop"){cr&&Zc();return}e?cr||qI(t):cr&&Zc();}function QI(){if(vi){console.log("[PetHungerNotifier] Already tracking");return}const e=Wr(),t=ob();console.log("[PetHungerNotifier] Starting tracking, threshold:",t+"%"),vi=e.subscribe(n=>{const r=n.byLocation.active,o=xt.CustomSounds.getNotificationConfig("pet"),i=o.mode==="loop";let a=false;for(const l of r)if(l.hungerPercent<t){if(a=true,!ts.has(l.id)){console.log("[PetHungerNotifier] Pet hunger low:",{name:l.name||l.petSpecies,species:l.petSpecies,hungerPercent:l.hungerPercent.toFixed(2)+"%"}),i||ZI(o);const u=new CustomEvent("gemini:pet-hunger-low",{detail:{pet:l}});window.dispatchEvent(u),ts.add(l.id);}}else ts.delete(l.id);XI(a,o);}),console.log("[PetHungerNotifier] Tracking initialized");}function JI(){vi&&(vi(),vi=null,ts.clear(),Zc(),console.log("[PetHungerNotifier] Tracking stopped"));}function ZI(e){try{xt.CustomSounds.play(e.soundId,{volume:e.volume/100});}catch(t){console.warn("[PetHungerNotifier] Failed to play notification sound:",t);}}let Mi=false;function ib(e){const{shouldReinit:t}=e.detail||{};t&&(console.log("[PetHungerNotifier] Config changed, reinitializing..."),sb(),ab());}function ab(){if(Mi){console.log("[PetHungerNotifier] Already initialized");return}if(Mi=true,window.addEventListener("gemini:pet-hunger-config-changed",ib),!rb()){console.log("[PetHungerNotifier] Disabled");return}console.log("[PetHungerNotifier] Initializing"),QI(),console.log("[PetHungerNotifier] Initialized");}function sb(){Mi&&(console.log("[PetHungerNotifier] Destroying"),window.removeEventListener("gemini:pet-hunger-config-changed",ib),JI(),Mi=false,console.log("[PetHungerNotifier] Destroyed"));}function eT(){return Mi}const Ri={init:ab,destroy:sb,isReady:eT,isEnabled:rb,setEnabled:KI,getThreshold:ob,setThreshold:YI};function tT(e){let t=null,n=null;function r(){const i=w("div",{className:"pet-card-body"}),a=w("div",{className:"pet-card-row"}),l=th({text:"Hunger alert",hint:"Notifies when active pets drop below 5% hunger",variant:"text"});return n=Or({checked:Ri.isEnabled(),onChange:u=>{Ri.setEnabled(u);}}),a.appendChild(l.root),a.appendChild(n.root),i.appendChild(a),t=pt({id:"pet-hunger-card",title:"Pet events",subtitle:"Get notified about pet-related events",expandable:true,defaultExpanded:e?.defaultExpanded??true,stateKey:"pet",variant:"soft",padding:"sm",divider:false,onExpandChange:e?.onExpandChange},i),t}function o(){n&&(n.destroy(),n=null),t=null;}return {root:r(),destroy:o}}class nT extends Br{constructor(){super({id:"tab-alerts",label:"Alerts"});xe(this,"sectionElement",null);xe(this,"state",null);xe(this,"settingCard",null);xe(this,"shopsCard",null);xe(this,"weatherCard",null);xe(this,"petCard",null);}async build(n){this.state=await L_();const r=n.getRootNode();un(r,P_,"alerts-styles");const o=this.createGrid("12px");o.id="alerts-section",this.sectionElement=o;const{MGData:i}=await xn(async()=>{const{MGData:f}=await Promise.resolve().then(()=>ug);return {MGData:f}},void 0),a=["plants","items","eggs","decor","weather","mutations"],l=await Promise.allSettled(a.map(f=>i.waitFor(f))),u=a.filter((f,p)=>l[p]?.status==="rejected");u.length>0&&console.warn("[AlertsSection] MGData incomplete, building with empty tables:",u.join(", ")),this.buildParts(),n.appendChild(o);}render(n){const r=this.shopsCard,o=this.weatherCard,i=this.petCard,a=this.settingCard;this.settingCard=null,this.shopsCard=null,this.weatherCard=null,this.petCard=null,super.render(n),this.shopsCard=r,this.weatherCard=o,this.petCard=i,this.settingCard=a;}buildParts(){if(!this.sectionElement||!this.state)return;const n=this.state.get();this.shopsCard=mI({defaultExpanded:n.ui.expandedCards.shops,onExpandChange:r=>this.state.setCardExpanded("shops",r)}),this.sectionElement.appendChild(this.shopsCard.root),this.petCard=tT({defaultExpanded:n.ui.expandedCards.pet,onExpandChange:r=>this.state.setCardExpanded("pet",r)}),this.sectionElement.appendChild(this.petCard.root),this.weatherCard=HI({defaultExpanded:n.ui.expandedCards.weather,onExpandChange:r=>this.state.setCardExpanded("weather",r)}),this.sectionElement.appendChild(this.weatherCard.root),this.settingCard=II({defaultExpanded:n.ui.expandedCards.settings,onExpandChange:r=>this.state.setCardExpanded("settings",r)}),this.sectionElement.appendChild(this.settingCard.root);}async destroy(){this.settingCard&&(this.settingCard.destroy(),this.settingCard=null),this.shopsCard&&(this.shopsCard.destroy(),this.shopsCard=null),this.petCard&&(this.petCard.destroy(),this.petCard=null),this.weatherCard&&(this.weatherCard.destroy(),this.weatherCard=null),this.sectionElement=null;}}const rT={enabled:true},lb=At.ANTI_AFK,oT=["visibilitychange","blur","focus","focusout","pagehide","freeze","resume"],iT=25e3,aT=1,sT=1e-5,je={listeners:[],savedProps:{hidden:void 0,visibilityState:void 0,hasFocus:null},audioCtx:null,oscillator:null,gainNode:null,heartbeatInterval:null};function lT(){const e=(t,n)=>{const r=o=>{o.stopImmediatePropagation(),o.preventDefault?.();};t.addEventListener(n,r,{capture:true}),je.listeners.push({type:n,handler:r,target:t});};for(const t of oT)e(document,t),e(window,t);}function cT(){for(const{type:e,handler:t,target:n}of je.listeners)try{n.removeEventListener(e,t,{capture:!0});}catch{}je.listeners.length=0;}function dT(){const e=Object.getPrototypeOf(document);je.savedProps.hidden=Object.getOwnPropertyDescriptor(e,"hidden"),je.savedProps.visibilityState=Object.getOwnPropertyDescriptor(e,"visibilityState"),je.savedProps.hasFocus=document.hasFocus?document.hasFocus.bind(document):null;try{Object.defineProperty(e,"hidden",{configurable:!0,get:()=>!1});}catch{}try{Object.defineProperty(e,"visibilityState",{configurable:!0,get:()=>"visible"});}catch{}try{document.hasFocus=()=>!0;}catch{}}function uT(){const e=Object.getPrototypeOf(document);try{je.savedProps.hidden&&Object.defineProperty(e,"hidden",je.savedProps.hidden);}catch{}try{je.savedProps.visibilityState&&Object.defineProperty(e,"visibilityState",je.savedProps.visibilityState);}catch{}try{je.savedProps.hasFocus&&(document.hasFocus=je.savedProps.hasFocus);}catch{}}function As(){je.audioCtx&&je.audioCtx.state!=="running"&&je.audioCtx.resume?.().catch(()=>{});}function pT(){try{const e=window.AudioContext||window.webkitAudioContext;je.audioCtx=new e({latencyHint:"interactive"}),je.gainNode=je.audioCtx.createGain(),je.gainNode.gain.value=sT,je.oscillator=je.audioCtx.createOscillator(),je.oscillator.frequency.value=aT,je.oscillator.connect(je.gainNode).connect(je.audioCtx.destination),je.oscillator.start(),document.addEventListener("visibilitychange",As,{capture:!0}),window.addEventListener("focus",As,{capture:!0});}catch{cb();}}function cb(){try{je.oscillator?.stop();}catch{}try{je.oscillator?.disconnect(),je.gainNode?.disconnect();}catch{}try{je.audioCtx?.close?.();}catch{}document.removeEventListener("visibilitychange",As,{capture:true}),window.removeEventListener("focus",As,{capture:true}),je.oscillator=null,je.gainNode=null,je.audioCtx=null;}function fT(){const e=document.querySelector("canvas")||document.body||document.documentElement;je.heartbeatInterval=window.setInterval(()=>{try{e.dispatchEvent(new MouseEvent("mousemove",{bubbles:!0,clientX:1,clientY:1}));}catch{}},iT);}function hT(){je.heartbeatInterval!==null&&(clearInterval(je.heartbeatInterval),je.heartbeatInterval=null);}function lc(){dT(),lT(),pT(),fT();}function cc(){hT(),cb(),cT(),uT();}let Ma=false,an=false;function Xr(){return at(lb,rT)}function dc(e){st(lb,e);}const po={init(){if(Ma)return;const e=Xr();Ma=true,e.enabled?(lc(),an=true,console.log("[MGAntiAfk] Initialized and started")):console.log("[MGAntiAfk] Initialized but disabled");},isReady(){return Ma},isRunning(){return an},isEnabled(){return Xr().enabled},enable(){const e=Xr();e.enabled=true,dc(e),an||(lc(),an=true,console.log("[MGAntiAfk] Enabled"));},disable(){const e=Xr();e.enabled=false,dc(e),an&&(cc(),an=false,console.log("[MGAntiAfk] Disabled"));},toggle(){po.isEnabled()?po.disable():po.enable();},getConfig(){return Xr()},updateConfig(e){const n={...Xr(),...e};dc(n),n.enabled&&!an?(lc(),an=true):!n.enabled&&an&&(cc(),an=false);},destroy(){an&&(cc(),an=false),Ma=false,console.log("[MGAntiAfk] Destroyed");}};class mT{constructor(){xe(this,"achievements",new Map);xe(this,"data");xe(this,"STORAGE_KEY",At.ACHIEVEMENTS);xe(this,"onUnlockCallbacks",[]);xe(this,"onProgressCallbacks",[]);this.data=this.loadData();}loadData(){return at(this.STORAGE_KEY,{unlocked:{},progress:{}})}saveData(){st(this.STORAGE_KEY,this.data);}register(t){this.achievements.set(t.id,t),this.data.progress[t.id]||(this.data.progress[t.id]={current:0,target:t.target,percentage:0});}registerMany(t){for(const n of t)this.register(n);}async checkAchievement(t){const n=this.achievements.get(t);if(!n)throw new Error(`Achievement not found: ${t}`);const r=this.isUnlocked(t),o=await n.checkProgress(),i={current:o,target:n.target,percentage:Math.min(100,Math.floor(o/n.target*100))},a=this.data.progress[t];this.data.progress[t]=i;const l=o>=n.target;return !r&&l?this.unlock(t,i):l||this.triggerProgressCallbacks({achievement:n,progress:i,previousProgress:a}),this.saveData(),{id:t,wasUnlocked:r,isUnlocked:l,progress:i}}async checkAllAchievements(){const t=[];for(const n of this.achievements.keys()){const r=await this.checkAchievement(n);t.push(r);}return t}unlock(t,n){const r=this.achievements.get(t);if(!r)return;const o={achievementId:t,unlockedAt:Date.now(),progress:n};this.data.unlocked[t]=o,this.saveData(),this.triggerUnlockCallbacks({achievement:r,unlockedAt:o.unlockedAt,progress:n});}isUnlocked(t){return !!this.data.unlocked[t]}getAchievement(t){return this.achievements.get(t)||null}getAllAchievements(){return Array.from(this.achievements.values())}getAchievementsByCategory(t){return Array.from(this.achievements.values()).filter(n=>n.category===t)}getAchievementsByRarity(t){return Array.from(this.achievements.values()).filter(n=>n.rarity===t)}getUnlockedAchievements(){return Object.values(this.data.unlocked)}getLockedAchievements(){return Array.from(this.achievements.values()).filter(t=>!this.isUnlocked(t.id)&&!t.hidden)}getProgress(t){return this.data.progress[t]||null}getCompletionPercentage(){const t=this.achievements.size,n=Object.keys(this.data.unlocked).length;return t>0?Math.floor(n/t*100):0}getCompletionStats(){const t=this.achievements.size,n=Object.keys(this.data.unlocked).length,r=t-n,o=this.getCompletionPercentage();return {total:t,unlocked:n,locked:r,percentage:o}}onUnlock(t){return this.onUnlockCallbacks.push(t),()=>{const n=this.onUnlockCallbacks.indexOf(t);n!==-1&&this.onUnlockCallbacks.splice(n,1);}}onProgress(t){return this.onProgressCallbacks.push(t),()=>{const n=this.onProgressCallbacks.indexOf(t);n!==-1&&this.onProgressCallbacks.splice(n,1);}}triggerUnlockCallbacks(t){for(const n of this.onUnlockCallbacks)try{n(t);}catch(r){console.warn("[Achievements] Unlock callback error:",r);}}triggerProgressCallbacks(t){for(const n of this.onProgressCallbacks)try{n(t);}catch(r){console.warn("[Achievements] Progress callback error:",r);}}reset(){this.data={unlocked:{},progress:{}};for(const t of this.achievements.values())this.data.progress[t.id]={current:0,target:t.target,percentage:0};this.saveData();}exportData(){return JSON.stringify(this.data,null,2)}importData(t){try{const n=JSON.parse(t);return this.data=n,this.saveData(),!0}catch(n){return console.warn("[Achievements] Failed to import data:",n),false}}}let xi=null;function vn(){return xi||(xi=new mT),xi}function gT(){xi&&(xi=null);}let Ra=false;const bT={init(){Ra||(vn(),Ra=true,console.log("✅ [MGAchievements] Initialized"));},isReady(){return Ra},getManager(){return vn()},register:(...e)=>vn().register(...e),registerMany:(...e)=>vn().registerMany(...e),isUnlocked:(...e)=>vn().isUnlocked(...e),getAll:()=>vn().getAllAchievements(),getUnlocked:()=>vn().getUnlockedAchievements(),getStats:()=>vn().getCompletionStats(),checkAll:()=>vn().checkAllAchievements(),onUnlock:(...e)=>vn().onUnlock(...e),onProgress:(...e)=>vn().onProgress(...e),destroy(){gT(),Ra=false;}};let wi=null;function db(){const t=bt().get().plant;if(!t)return;const n=t.currentSlotIndex!==null?t.slots[t.currentSlotIndex]:null;n&&Ii(n.species,n.targetScale,n.mutations||[]);}function vT(e){db();}function yT(){wi&&ub(),db(),wi=bt().subscribePlantInfo(vT,{immediate:true});}function ub(){wi&&(wi(),wi=null);}function cl(){const e=[];return {add(t){e.push(t);},run(){for(const t of e)try{t();}catch(n){console.warn("[CleanupTracker] Error during cleanup:",n);}},clear(){e.length=0;}}}function pb(e,t){e.add(()=>t.disconnect());}const ed="css-qnqsp4",Es="css-v439q6";let fo=cl(),td=false,Xo=false,ns=null,nd=null,_r=null;const xT=`
...
`;function wT(){if(td)return;const e=document.createElement("style");e.id="gemini-qol-cropPrice-styles",e.textContent=xT,document.head.appendChild(e),fo.add(()=>e.remove()),td=true;}async function CT(e){const t=document.createElement("div");t.className="gemini-qol-cropPrice";const n=document.createElement("div");n.className="gemini-qol-cropPrice-sprite";const r=document.createElement("canvas");r.width=20,r.height=20,n.appendChild(r);const o=document.createElement("div");o.className="gemini-qol-cropPrice-text",o.textContent=e>0?e.toLocaleString():"",t.appendChild(n),t.appendChild(o);try{const i=await Qe.toCanvas("ui","Coin");if(i&&r.parentElement){const a=r.getContext("2d");if(a){const l=Math.min(r.width/i.width,r.height/i.height),u=i.width*l,f=i.height*l,p=(r.width-u)/2,m=(r.height-f)/2;a.drawImage(i,p,m,u,f);}}}catch(i){console.warn("[CropValueIndicator.render] Failed to render coin sprite:",i);}return t}function kT(e){const t=[],n=e.querySelectorAll("span.chakra-text");for(const r of n){const o=r.textContent?.trim();if(!o)continue;["Gold","Rainbow","Wet","Chilled","Frozen","Dawnlit","Dawnbound","Amberlit","Amberbound"].includes(o)&&t.push(o);}return t}function ST(e){const t=e.querySelectorAll("p.chakra-text");for(const n of t){const r=n.textContent?.trim();if(!r)continue;const o=r.match(/^([\d.]+)\s*kg$/i);if(o)return parseFloat(o[1])}return 1}function AT(){const e=[],t=document.querySelectorAll(`.${ed}`);console.log(`[CropValueIndicator.debug] Found ${t.length} mature containers, ${document.querySelectorAll(`.${Es}`).length} growth containers`);for(const r of t){const o=r.getBoundingClientRect();if(console.log(`[CropValueIndicator.debug] Mature container rect: ${o.width}x${o.height}, offsetParent: ${r.offsetParent?.tagName??"null"}`),o.width===0&&o.height===0){console.log("[CropValueIndicator.debug] Skipping mature container (zero size)");continue}r.closest("button.chakra-button")||e.push({element:r});}const n=document.querySelectorAll(`.${Es}`);for(const r of n){const o=r.getBoundingClientRect();if(console.log(`[CropValueIndicator.debug] Growth container rect: ${o.width}x${o.height}, offsetParent: ${r.offsetParent?.tagName??"null"}`),o.width===0&&o.height===0){console.log("[CropValueIndicator.debug] Skipping growth container (zero size)");continue}if(r.closest("button.chakra-button"))continue;const i=r.querySelectorAll(":scope > .McFlex > .McFlex");if(i.length>0){const a=i[i.length-1];a.querySelector("p.chakra-text")&&e.push({element:a});}}return console.log(`[CropValueIndicator.debug] findCropTooltips → ${e.length} visible tooltips`),e}function ET(){const t=bt().get().plant;if(!t)return 0;const n=t.currentSlotIndex!==null?t.slots[t.currentSlotIndex]:null;return n?Ii(n.species,n.targetScale,n.mutations||[]):0}function _T(e,t){const n=document.querySelectorAll(".gemini-qol-cropPrice");for(const r of n){const o=r.getBoundingClientRect();if(o.width===0&&o.height===0||r.closest("button.chakra-button"))continue;const i=r.querySelector(".gemini-qol-cropPrice-text");i&&(i.textContent=e>0?e.toLocaleString():"");}}function IT(){_r!==null&&cancelAnimationFrame(_r),_r=requestAnimationFrame(()=>{_r=null;const e=ET();if(e===nd)return;nd=e;const n=bt().get().plant;!n||!(n.currentSlotIndex!==null&&n.slots[n.currentSlotIndex])||_T(e);});}async function Qo(e){if(e.element.querySelector(".gemini-qol-cropPrice")){console.log("[CropValueIndicator.debug] Already injected, skipping");return}console.log("[CropValueIndicator.debug] injectPriceToTooltip called",e.element.className);try{const t=e.element.querySelector("p.chakra-text");if(!t){console.log("[CropValueIndicator.debug] No p.chakra-text found in",e.element.className);return}const n=t.closest(".McFlex");if(!n)return;const o=bt().get().plant;let i=0,a=null;if(o&&o.currentSlotIndex!==null){const u=o.slots[o.currentSlotIndex];u&&(a=u.species,i=Ii(u.species,u.targetScale,u.mutations||[]));}if(i===0){const u=t.textContent?.trim();if(u){a=u;const f=ST(n),p=kT(n);i=Ii(u,f,p);}}const l=await CT(i);n.appendChild(l),fo.add(()=>l.remove());}catch(t){console.warn("[CropValueIndicator.render] Failed to inject price:",t);}}function TT(){console.log("[CropValueIndicator.debug] startObservingTooltips called");const e=AT();console.log(`[CropValueIndicator.debug] Existing tooltips at init: ${e.length}`);for(const n of e)Qo(n);ns=bt().subscribePlantInfo(()=>{console.log("[CropValueIndicator.debug] subscribePlantInfo fired → scheduleRender"),IT();});const t=new MutationObserver(n=>{for(const r of n)r.type==="childList"&&r.addedNodes.forEach(o=>{if(o instanceof HTMLElement){if(o.classList.contains(ed)&&(console.log("[CropValueIndicator.debug] MutationObserver: mature container added",o.className),o.closest("button.chakra-button")||Qo({element:o})),o.querySelectorAll(`.${ed}`).forEach(l=>{l.closest("button.chakra-button")||Qo({element:l});}),o.classList.contains(Es)&&!o.closest("button.chakra-button")){const l=o.querySelectorAll(":scope > .McFlex > .McFlex");if(l.length>0){const u=l[l.length-1];u.querySelector("p.chakra-text")&&!u.querySelector(".gemini-qol-cropPrice")&&Qo({element:u});}}o.querySelectorAll(`.${Es}`).forEach(l=>{if(!l.closest("button.chakra-button")){const u=l.querySelectorAll(":scope > .McFlex > .McFlex");if(u.length>0){const f=u[u.length-1];f.querySelector("p.chakra-text")&&!f.querySelector(".gemini-qol-cropPrice")&&Qo({element:f});}}});}});});t.observe(document.body,{childList:true,subtree:true}),pb(fo,t);}const PT={init(){Xo||(Xo=true,wT(),TT());},destroy(){Xo&&(Xo=false,_r!==null&&(cancelAnimationFrame(_r),_r=null),ns&&(ns(),ns=null),fo.run(),fo.clear(),fo=cl(),td=false,nd=null);},isEnabled(){return Xo}},fb=At.CROP_VALUE_INDICATOR,LT={enabled:false};function vu(){return at(fb,LT)}function MT(e){st(fb,e);}let Fi=false;function hb(){Fi||!vu().enabled||(Fi=true,yT());}function mb(){Fi&&(ub(),Fi=false);}function RT(){return Fi}function FT(){return vu().enabled}function OT(e){const t=vu();t.enabled!==e&&(t.enabled=e,MT(t),e?hb():mb());}const rs={init:hb,destroy:mb,isReady:RT,isEnabled:FT,setEnabled:OT,render:PT},Oi="css-qnqsp4",_s="css-1cdcuw7",yu='[role="tooltip"]';let os=cl(),Jo=false,is=null,rd=null,Ir=null;function NT(){const e=[],t=document.querySelectorAll(`.${Oi}`);console.log(`[CropSizeIndicator.debug] Found ${t.length} mature containers`);for(const n of t){const r=n.getBoundingClientRect();if(console.log(`[CropSizeIndicator.debug] Container rect: ${r.width}x${r.height}, offsetParent: ${n.offsetParent?.tagName??"null"}`),r.width===0&&r.height===0){console.log("[CropSizeIndicator.debug] Skipping container (zero size)");continue}if(n.closest("button.chakra-button"))continue;const o=n.querySelector(`.${_s}`);console.log(`[CropSizeIndicator.debug] Weight element (${_s}): ${o?"found":"NOT FOUND"}`),o&&e.push({element:n,weightElement:o});}return console.log(`[CropSizeIndicator.debug] findMatureCropTooltips → ${e.length} visible tooltips`),e}function DT(){const t=bt().get().plant;if(!t)return 0;const n=t.currentSlotIndex!==null?t.slots[t.currentSlotIndex]:null;return n?eu(n.species,n.targetScale):0}function $T(e,t){const n=document.querySelectorAll(`.${Oi}`);for(const r of n){const o=r.getBoundingClientRect();if(o.width===0&&o.height===0||r.closest("button.chakra-button"))continue;const i=r.querySelector(`.${_s}`);if(i){const a=i.querySelector("svg"),l=`${e}%`;i.textContent=l,a&&i.appendChild(a);}}Is(),console.log("[CropSizeIndicator.render] 🔄 Updated all sizes:",{species:t.species,scale:t.targetScale,size:e,count:n.length});}function BT(){Ir!==null&&cancelAnimationFrame(Ir),Ir=requestAnimationFrame(()=>{Ir=null;const e=DT();if(e===rd)return;rd=e;const n=bt().get().plant;if(!n)return;const r=n.currentSlotIndex!==null?n.slots[n.currentSlotIndex]:null;r&&$T(e,r);});}function gb(e,t){const n=Oe.get("plants");if(!n)return "";const r=n[e];return r?.crop?.baseWeight?`${(r.crop.baseWeight*t).toFixed(2)} kg`:""}function Is(){const e=document.querySelectorAll(yu),n=bt().get().plant;if(!n||n.currentSlotIndex===null)return;const r=n.slots[n.currentSlotIndex];if(!r)return;const o=gb(r.species,r.targetScale);for(const i of e){const a=i.getBoundingClientRect();if(a.width===0&&a.height===0)continue;const l=i.textContent?.trim();l&&l.startsWith("Size:")&&o&&(i.textContent=o);}}function uc(){const e=NT();for(const t of e)if(t.weightElement)try{const r=bt().get().plant;if(r&&r.currentSlotIndex!==null){const o=r.slots[r.currentSlotIndex];if(o){const i=eu(o.species,o.targetScale),a=t.weightElement.querySelector("svg");t.weightElement.textContent=`${i}%`,a&&t.weightElement.appendChild(a);}}}catch(n){console.warn("[CropSizeIndicator.render] Failed to update size:",n);}Is();}function zT(){const e=document.querySelectorAll(`.${Oi}`),n=bt().get().plant;if(!n||n.currentSlotIndex===null)return;const r=n.slots[n.currentSlotIndex];if(!r)return;const o=gb(r.species,r.targetScale);for(const a of e){const l=a.getBoundingClientRect();if(l.width===0&&l.height===0||a.closest("button.chakra-button"))continue;const u=a.querySelector(`.${_s}`);if(u){const f=u.querySelector("svg");u.textContent=o,f&&u.appendChild(f);}}const i=document.querySelectorAll(yu);for(const a of i){const l=a.getBoundingClientRect();if(l.width===0&&l.height===0)continue;const u=a.textContent?.trim();u&&!u.includes("kg")&&(a.textContent=o);}console.log("[CropSizeIndicator.render] Restored crop weights");}function jT(){console.log("[CropSizeIndicator.debug] startObservingTooltips called"),uc(),is=bt().subscribePlantInfo(()=>{console.log("[CropSizeIndicator.debug] subscribePlantInfo fired → scheduleRender"),BT();});const e=new MutationObserver(t=>{for(const n of t)n.type==="childList"&&n.addedNodes.forEach(r=>{if(r instanceof HTMLElement){if(r.className&&typeof r.className=="string"&&r.className.length>0&&console.log(`[CropSizeIndicator.debug] New node: <${r.tagName.toLowerCase()} class="${r.className}"> children=${r.children.length}`),r.hasAttribute("role")&&r.getAttribute("role")==="tooltip"){const a=r.textContent?.trim();a&&a.startsWith("Size:")&&Is();}r.classList.contains(Oi)&&(r.closest("button.chakra-button")||uc()),r.querySelectorAll(`.${Oi}`).length>0&&uc(),r.querySelectorAll(yu).forEach(a=>{const l=a.textContent?.trim();l&&l.startsWith("Size:")&&Is();});}});});e.observe(document.body,{childList:true,subtree:true}),pb(os,e),console.log("[CropSizeIndicator.render] Started observing crops");}const xu={init(){if(Jo){console.log("[CropSizeIndicator.render] Already initialized");return}Jo=true,jT(),console.log("✅ [CropSizeIndicator.render] Initialized");},destroy(){Jo&&(Jo=false,zT(),Ir!==null&&(cancelAnimationFrame(Ir),Ir=null),is&&(is(),is=null),os.run(),os.clear(),os=cl(),rd=null,console.log("🛑 [CropSizeIndicator.render] Destroyed"));},isEnabled(){return Jo}},bb=At.CROP_SIZE_INDICATOR,GT={enabled:false};function wu(){return at(bb,GT)}function UT(e){st(bb,e);}let Ni=false;function vb(){if(Ni){console.log("[CropSizeIndicator] Already initialized");return}if(!wu().enabled){console.log("[CropSizeIndicator] Disabled");return}Ni=true,console.log("[CropSizeIndicator] Initializing..."),xu.init(),console.log("[CropSizeIndicator] Initialized successfully");}function yb(){Ni&&(console.log("[CropSizeIndicator] Destroying..."),xu.destroy(),Ni=false,console.log("[CropSizeIndicator] Destroyed"));}function WT(){return Ni}function HT(){return wu().enabled}function VT(e){const t=wu();if(t.enabled===e){console.log(`[CropSizeIndicator] Already ${e?"enabled":"disabled"}`);return}t.enabled=e,UT(t),e?vb():yb(),console.log(`[CropSizeIndicator] ${e?"Enabled":"Disabled"}`);}const as={init:vb,destroy:yb,isReady:WT,isEnabled:HT,setEnabled:VT,render:xu},KT={apiBaseUrl:"https://ariesmod-api.ariedam.fr/"},xb=At.ARIES_API;function Cu(){return at(xb,KT)}function YT(e){st(xb,e);}function qT(e){const n={...Cu(),...e};return YT(n),n}let Ts=null,Ps=null;function Mf(e){Ts=e;}function Rf(e){Ps=e;}function XT(){return Ts?[...Ts]:[]}function QT(){return Ps?[...Ps]:[]}function Ff(){Ts=null,Ps=null;}function wb(e,t){const n=Cu(),r=new URL(e,n.apiBaseUrl);if(t)for(const[o,i]of Object.entries(t))i!==void 0&&r.searchParams.set(o,String(i));return r.toString()}function dl(e,t){return new Promise(n=>{const r=wb(e,t);GM_xmlhttpRequest({method:"GET",url:r,headers:{},onload:o=>{if(o.status>=200&&o.status<300)try{const i=o.responseText?JSON.parse(o.responseText):null;n({status:o.status,data:i});}catch(i){console.error("[AriesAPI] GET parse error:",i,o.responseText),n({status:o.status,data:null});}else console.error("[AriesAPI] GET error:",o.status,o.responseText),n({status:o.status,data:null});},onerror:o=>{console.error("[AriesAPI] GET request failed:",o),n({status:0,data:null});}});})}function ul(e,t){return new Promise(n=>{const r=wb(e);GM_xmlhttpRequest({method:"POST",url:r,headers:{"Content-Type":"application/json"},data:JSON.stringify(t),onload:o=>{if(o.status>=200&&o.status<300)try{const i=o.responseText?JSON.parse(o.responseText):null;n({status:o.status,data:i});}catch(i){console.error("[AriesAPI] POST parse error:",i,o.responseText),n({status:o.status,data:null});}else console.error("[AriesAPI] POST error:",o.status,o.responseText),n({status:o.status,data:null});},onerror:o=>{console.error("[AriesAPI] POST request failed:",o),n({status:0,data:null});}});})}async function ku(e=50){const{data:t}=await dl("rooms",{limit:e});return !t||!Array.isArray(t)?[]:t.map(n=>({id:n.id,isPrivate:n.is_private,playersCount:n.players_count??0,lastUpdatedAt:n.last_updated_at,lastUpdatedByPlayerId:n.last_updated_by_player_id,userSlots:Array.isArray(n.user_slots)?n.user_slots.map(r=>({name:r.name,avatarUrl:r.avatar_url??null})):void 0}))}async function JT(e,t){const n=e.trim(),r=t?.minQueryLength??2;if(n.length<r)return [];const o=t?.limitRooms??200,i=n.toLowerCase(),a=await ku(o),l=[];for(const u of a){if(!u.userSlots||u.userSlots.length===0)continue;const f=u.userSlots.filter(p=>p.name?p.name.toLowerCase().includes(i):false);f.length>0&&l.push({room:u,matchedSlots:f});}return l}async function ZT(e){if(!e)return null;const{status:t,data:n}=await dl("get-player-view",{playerId:e});return t===404?null:n}async function pl(e,t){const n=Array.from(new Set((e??[]).map(a=>String(a).trim()).filter(a=>a.length>=3)));if(n.length===0)return [];const r={playerIds:n};t?.sections&&(r.sections=Array.isArray(t.sections)?t.sections:[t.sections]);const{status:o,data:i}=await ul("get-players-view",r);return o!==200||!Array.isArray(i)?[]:i}async function e2(e,t){const n=e.trim(),r=t?.minQueryLength??2;if(n.length<r)return [];const o=t?.limitRooms??200,i=n.toLowerCase(),a=await ku(o),l=new Map;for(const u of a)if(!(!u.userSlots||u.userSlots.length===0))for(const f of u.userSlots){if(!f.name||!f.name.toLowerCase().includes(i))continue;const m=`${u.id}::${f.name}`;l.has(m)||l.set(m,{playerName:f.name,avatarUrl:f.avatarUrl,roomId:u.id,roomPlayersCount:u.playersCount});}return Array.from(l.values())}async function Cb(e){if(!e)return [];const{status:t,data:n}=await dl("list-friends",{playerId:e});return t!==200||!n||!Array.isArray(n.friends)?[]:n.friends}async function t2(e){const t=await Cb(e);if(t.length===0)return Mf([]),[];const n=await pl(t,{sections:["profile","room"]});return Mf(n),[...n]}async function Su(e){if(!e)return {playerId:"",incoming:[],outgoing:[]};const{status:t,data:n}=await dl("list-friend-requests",{playerId:e});return t!==200||!n?{playerId:e,incoming:[],outgoing:[]}:{playerId:n.playerId,incoming:Array.isArray(n.incoming)?n.incoming:[],outgoing:Array.isArray(n.outgoing)?n.outgoing:[]}}async function n2(e){const{incoming:t}=await Su(e),n=t.map(o=>o.fromPlayerId);if(n.length===0)return Rf([]),[];const r=await pl(n,{sections:["profile"]});return Rf(r),[...r]}async function r2(e){const{outgoing:t}=await Su(e),n=t.map(r=>r.toPlayerId);return n.length===0?[]:pl(n,{sections:["profile"]})}async function o2(e,t){if(!e||!t||e===t)return  false;const{status:n}=await ul("friend-request",{fromPlayerId:e,toPlayerId:t});return n===204?true:(n===409&&console.warn("[AriesAPI] friend-request conflict (already exists)"),false)}async function i2(e){const{playerId:t,otherPlayerId:n,action:r}=e;if(!t||!n||t===n)return  false;const{status:o}=await ul("friend-respond",{playerId:t,otherPlayerId:n,action:r});return o===204}async function a2(e,t){if(!e||!t||e===t)return  false;const{status:n}=await ul("friend-remove",{playerId:e,otherPlayerId:t});return n===204}let Zo=false;const Ls={init(){Zo||(Zo=true,console.log("[AriesAPI] Initialized"));},destroy(){Zo&&(Zo=false,Ff(),console.log("[AriesAPI] Destroyed"));},isReady(){return Zo},getConfig(){return Cu()},updateConfig(e){return qT(e)},fetchRooms:ku,searchRoomsByPlayerName:JT,fetchPlayerView:ZT,fetchPlayersView:pl,searchPlayersByName:e2,fetchFriendsIds:Cb,fetchFriendsWithViews:t2,fetchFriendRequests:Su,fetchIncomingRequestsWithViews:n2,fetchOutgoingRequestsWithViews:r2,sendFriendRequest:o2,respondFriendRequest:i2,removeFriend:a2,getCachedFriends:XT,getCachedIncomingRequests:QT,clearCache:Ff},Of={enabled:true,manualLocks:[],overallRules:[],speciesRules:{}};function Ms(){return `rule-${Date.now()}-${Math.random().toString(36).slice(2,9)}`}function s2(e){const t={enabled:e.enabled,manualLocks:e.manualLocks||[],overallRules:[],speciesRules:{}},n=e.globalCriteria?.lockByScale?.enabled,r=(e.globalCriteria?.lockedMutations?.length??0)>0;if(n||r){const o={id:Ms(),name:"Migrated Global Rule",enabled:true,mode:"lock",sizeCondition:n?{enabled:true,minPercentage:e.globalCriteria.lockByScale.minPercentage}:void 0,mutationCondition:r?{enabled:true,mutations:e.globalCriteria.lockedMutations,matchMode:"any"}:void 0};t.overallRules.push(o);}if(e.speciesOverrides)for(const[o,i]of Object.entries(e.speciesOverrides)){const a=i.lockByScale?.enabled,l=(i.lockedMutations?.length??0)>0;if(a||l){const u={id:Ms(),name:`Migrated ${o} Rule`,enabled:true,mode:"lock",sizeCondition:a?{enabled:true,minPercentage:i.lockByScale.minPercentage}:void 0,mutationCondition:l?{enabled:true,mutations:i.lockedMutations,matchMode:"any"}:void 0};t.speciesRules[o]=[u];}}return console.log("[HarvestLocker] Migrated legacy config to new format"),t}function l2(e){const t=e;return t!==null&&typeof t=="object"&&"globalCriteria"in t&&!("overallRules"in t)}function ht(){const e=at($t.FEATURE.HARVEST_LOCKER,Of);if(l2(e)){const t=s2(e);return hn(t),t}return {...Of,...e,manualLocks:e.manualLocks||[],overallRules:e.overallRules||[],speciesRules:e.speciesRules||{}}}function hn(e){st($t.FEATURE.HARVEST_LOCKER,e);}function kb(e,t,n,r){return {id:Ms(),name:e,enabled:true,mode:t,sizeCondition:n,mutationCondition:r}}function c2(e){const t=ht();t.overallRules.push(e),hn(t);}function d2(e,t){const n=ht();n.speciesRules[e]||(n.speciesRules[e]=[]),n.speciesRules[e].push(t),hn(n);}function Sb(e,t){const n=ht(),r=n.overallRules.findIndex(o=>o.id===e);if(r!==-1){n.overallRules[r]={...n.overallRules[r],...t},hn(n);return}for(const o of Object.keys(n.speciesRules)){const i=n.speciesRules[o].findIndex(a=>a.id===e);if(i!==-1){n.speciesRules[o][i]={...n.speciesRules[o][i],...t},hn(n);return}}console.warn(`[HarvestLocker] Rule ${e} not found`);}function u2(e){const t=ht(),n=t.overallRules.findIndex(r=>r.id===e);if(n!==-1){t.overallRules.splice(n,1),hn(t);return}for(const r of Object.keys(t.speciesRules)){const o=t.speciesRules[r].findIndex(i=>i.id===e);if(o!==-1){t.speciesRules[r].splice(o,1),t.speciesRules[r].length===0&&delete t.speciesRules[r],hn(t);return}}console.warn(`[HarvestLocker] Rule ${e} not found`);}function p2(e,t){const n=ht(),r=n.overallRules.find(i=>i.id===e);if(!r){console.warn(`[HarvestLocker] Rule ${e} not found`);return}const o={...r,id:Ms(),name:`${r.name} (${t})`};n.speciesRules[t]||(n.speciesRules[t]=[]),n.speciesRules[t].push(o),hn(n);}const Rr=new Set;let Xn=null;const Rs=[];function f2(e){if(Rs.length>0){console.warn("[HarvestLocker] Already started");return}Xn=e;const t=Ur().subscribeStable(n=>{if(!n){Rr.clear();return}Ab(n);});Rs.push(t);}function h2(){Rs.forEach(e=>e()),Rs.length=0,Rr.clear(),Xn=null,console.log("[HarvestLocker] Stopped");}function pr(e){Xn=e;const t=Ur().get();t&&Ab(t);}function Au(e,t){const n=`${e}-${t}`;return Rr.has(n)}function m2(){return Array.from(Rr)}function Ab(e){if(Xn){if(Rr.clear(),Xn.manualLocks.forEach(t=>Rr.add(t)),!x2(e)){console.warn("[HarvestLocker] Invalid garden structure"),window.dispatchEvent(new CustomEvent(ft.HARVEST_LOCKER_LOCKS_UPDATED));return}e.plants.all.forEach(t=>{t.slots.forEach((n,r)=>{const o=`${t.tileIndex}-${r}`,i=g2(n.species);b2(n,i)&&Rr.add(o);});}),window.dispatchEvent(new CustomEvent(ft.HARVEST_LOCKER_LOCKS_UPDATED));}}function g2(e){return Xn?Xn.speciesRules[e]?Xn.speciesRules[e].filter(t=>t.enabled):Xn.overallRules.filter(t=>t.enabled):[]}function b2(e,t){const n=t.filter(o=>o.mode==="lock"),r=t.filter(o=>o.mode==="allow");for(const o of n)if(Nf(e,o))return  true;return r.length>0&&!r.some(i=>Nf(e,i))}function Nf(e,t){const n=[];if(t.sizeCondition?.enabled){const r=y2(e),o=t.sizeCondition.sizeMode??"max";n.push(o==="max"?r>=t.sizeCondition.minPercentage:r<=t.sizeCondition.minPercentage);}if(t.mutationCondition?.enabled&&t.mutationCondition.mutations.length>0){const r=v2(e.mutations,t.mutationCondition.mutations,t.mutationCondition.matchMode);n.push(r);}return n.length>0&&n.every(r=>r)}function v2(e,t,n){const r=t.includes("none"),o=t.filter(a=>a!=="none"),i=r&&e.length===0;return n==="any"?i?true:o.some(a=>e.includes(a)):r&&e.length>0?false:o.length===0?i:o.every(a=>e.includes(a))}function y2(e){const n=Oe.get("plants")?.[e.species];if(!n||typeof n!="object"||!("crop"in n))return 0;const r=n.crop;if(typeof r!="object"||!r)return 0;const{baseTileScale:o,maxScale:i}=r,a=i-o;return a===0?100:(e.targetScale-o)/a*100}function x2(e){return typeof e=="object"&&e!==null&&"plants"in e&&typeof e.plants=="object"&&e.plants!==null&&"all"in e.plants&&Array.isArray(e.plants.all)}const Fs=new Set,Os=new Set;let ho=null;function Eb(){ho||(ho=new MutationObserver(e=>{for(const t of e){for(const n of t.addedNodes)if(n instanceof Element)for(const r of Fs){n.matches(r.selector)&&r.callback(n);const o=n.querySelectorAll(r.selector);for(const i of o)r.callback(i);}for(const n of t.removedNodes)if(n instanceof Element)for(const r of Os){n.matches(r.selector)&&r.callback(n);const o=n.querySelectorAll(r.selector);for(const i of o)r.callback(i);}}}),ho.observe(document.body,{childList:true,subtree:true}));}function _b(){Fs.size===0&&Os.size===0&&ho&&(ho.disconnect(),ho=null);}function Eu(e,t){Eb();const n={selector:e,callback:t};Fs.add(n);const r=document.querySelectorAll(e);for(const o of r)t(o);return {disconnect:()=>{Fs.delete(n),_b();}}}function _u(e,t){Eb();const n={selector:e,callback:t};return Os.add(n),{disconnect:()=>{Os.delete(n),_b();}}}const w2=`
...
`,Df="css-qnqsp4",Ib="gemini-qol-harvestLocker-locked",od="gemini-qol-harvestLocker-lock-icon",id="gemini-qol-harvestLocker-styles",C2='<svg xmlns="http://www.w3.org/2000/svg" width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2.5" stroke-linecap="round" stroke-linejoin="round" focusable="false"><rect x="3" y="11" width="18" height="11" rx="2" ry="2"></rect><path d="M7 11V7a5 5 0 0 1 10 0v4"></path></svg>';let On=null,ss=false;const ad=[];function Fa(e){ad.push(e);}function k2(){for(const e of ad)try{e();}catch(t){console.warn("[HarvestLocker Inject] Cleanup error:",t);}ad.length=0;}function S2(){if(ss)return;if(document.getElementById(id)){ss=true;return}const e=document.createElement("style");e.id=id,e.textContent=w2,document.head.appendChild(e),ss=true;}function A2(){document.getElementById(id)?.remove(),ss=false;}function E2(e){if(e.classList.add(Ib),!e.querySelector(`#${od}`)){const t=document.createElement("div");t.id=od,t.innerHTML=C2,e.appendChild(t);}}function Ns(e){e.classList.remove(Ib),e.querySelector(`#${od}`)?.remove();}function pc(){if(!On)return;const e=bt().get();if(!e.plant||e.position.localIndex===null||e.plant.nextHarvestSlotIndex===null){Ns(On);return}const t=String(e.position.localIndex),n=e.plant.nextHarvestSlotIndex;Au(t,n)?E2(On):Ns(On);}function _2(){S2();const e=Eu(`.${Df}`,o=>{On=o,pc();});Fa(()=>e.disconnect());const t=_u(`.${Df}`,o=>{On===o&&(Ns(o),On=null);});Fa(()=>t.disconnect());const n=bt().subscribePlantInfo(()=>{pc();});Fa(n);const r=()=>pc();window.addEventListener(ft.HARVEST_LOCKER_LOCKS_UPDATED,r),Fa(()=>window.removeEventListener(ft.HARVEST_LOCKER_LOCKS_UPDATED,r)),console.log("[HarvestLocker Inject] Started");}function I2(){On&&(Ns(On),On=null),k2(),A2(),console.log("[HarvestLocker Inject] Stopped");}let Oa=false;const Tb={init(){Oa||(_2(),Oa=true);},destroy(){Oa&&(I2(),Oa=false);},isEnabled(){return ht().enabled}},Pb=[];function T2(){return Pb.slice()}function P2(e){Pb.push(e);}function Lb(e){try{return JSON.parse(e)}catch{return}}function $f(e){if(typeof e=="string"){const t=Lb(e);return t!==void 0?t:e}return e}function Mb(e){if(e!=null){if(typeof e=="string"){const t=Lb(e);return t!==void 0?Mb(t):e}if(Array.isArray(e)&&typeof e[0]=="string")return e[0];if(typeof e=="object"){const t=e;return t.type??t.Type??t.kind??t.messageType}}}function L2(e){const t=e?.MagicCircle_RoomConnection?.currentWebSocket;return t&&typeof t=="object"?t:null}function Pe(e,t,n){const r=typeof t=="boolean"?t:true,o=typeof t=="function"?t:n,i=(a,l)=>{if(Mb(a)!==e)return;const f=o(a,l);return f&&typeof f=="object"&&"kind"in f?f:typeof f=="boolean"?f?void 0:{kind:"drop"}:r?void 0:{kind:"drop"}};return P2(i),i}const ei=new WeakSet,Bf=new WeakMap;function M2(e){const t=e.pageWindow,n=!!e.debug,r=e.middlewares&&e.middlewares.length?e.middlewares:T2();if(!r.length)return ()=>{};const o=v=>({ws:v,pageWindow:t,debug:n}),i=(v,y)=>{let b=v;for(const A of r){const P=A(b,o(y));if(P){if(P.kind==="drop")return {kind:"drop"};P.kind==="replace"&&(b=P.message);}}return b!==v?{kind:"replace",message:b}:void 0};let a=null,l=null,u=null;const f=()=>{const v=t?.MagicCircle_RoomConnection,y=v?.sendMessage;if(!v||typeof y!="function")return  false;if(ei.has(y))return  true;const b=y.bind(v);function A(...P){const I=P.length===1?P[0]:P,T=$f(I),N=i(T,L2(t));if(N?.kind==="drop"){n&&console.log("[WS] drop outgoing (RoomConnection.sendMessage)",T);return}if(N?.kind==="replace"){const z=N.message;return P.length>1&&Array.isArray(z)?(n&&console.log("[WS] replace outgoing (RoomConnection.sendMessage)",T,"=>",z),b(...z)):(n&&console.log("[WS] replace outgoing (RoomConnection.sendMessage)",T,"=>",z),b(z))}return b(...P)}ei.add(A),Bf.set(A,y);try{v.sendMessage=A,ei.add(v.sendMessage),n&&console.log("[WS] outgoing patched via MagicCircle_RoomConnection.sendMessage");}catch{return  false}return a=()=>{try{v.sendMessage===A&&(v.sendMessage=y);}catch{}},true};(()=>{const v=t?.WebSocket?.prototype,y=v?.send;if(typeof y!="function"||ei.has(y))return;function b(A){const P=$f(A),I=i(P,this);if(I?.kind==="drop"){n&&console.log("[WS] drop outgoing (ws.send)",P);return}if(I?.kind==="replace"){const T=I.message,N=typeof T=="string"||T instanceof ArrayBuffer||T instanceof Blob?T:JSON.stringify(T);return n&&console.log("[WS] replace outgoing (ws.send)",P,"=>",T),y.call(this,N)}return y.call(this,A)}ei.add(b),Bf.set(b,y);try{v.send=b,n&&console.log("[WS] outgoing patched via WebSocket.prototype.send");}catch{return}l=()=>{try{v.send===b&&(v.send=y);}catch{}};})();const m=e.waitForRoomConnectionMs??4e3;if(!f()&&m>0){const v=Date.now();u=setInterval(()=>{if(f()){clearInterval(u),u=null;return}Date.now()-v>m&&(clearInterval(u),u=null,n&&console.log("[WS] RoomConnection not found, only ws.send is patched"));},250);}return ()=>{if(u){try{clearInterval(u);}catch{}u=null;}if(a){try{a();}catch{}a=null;}if(l){try{l();}catch{}l=null;}}}(function(){try{const t=({ url: (_documentCurrentScript && _documentCurrentScript.tagName.toUpperCase() === 'SCRIPT' && _documentCurrentScript.src || new URL('__entry.js', document.baseURI).href) }),n=t.glob?.("./**/*.ts",{eager:!0})??t.glob?.("./**/*.js",{eager:!0});if(!n)return}catch{}})();Pe(he.HarvestCrop,(e,t)=>{if(!ht().enabled)return  true;const r=e,o=r.slot!==void 0?String(r.slot):void 0,i=r.slotsIndex;return o!==void 0&&typeof i=="number"&&Au(o,i)?(console.log(`[HarvestLocker] Blocked harvest for slot ${o}-${i}`),false):true});let So=false;function Rb(){if(So){console.warn("[HarvestLocker] Already initialized");return}const e=ht();if(!e.enabled){console.log("[HarvestLocker] Disabled");return}So=true,f2(e),Tb.init(),console.log("[HarvestLocker] Initialized");}function Fb(){So&&(Tb.destroy(),h2(),So=false,console.log("[HarvestLocker] Destroyed"));}function R2(){return ht().enabled}function F2(e){const t=ht();t.enabled=e,hn(t),e&&!So?Rb():!e&&So&&Fb();}function O2(e,t){return Au(e,t)}function N2(){return m2()}function D2(e,t){const n=ht(),r=`${e}-${t}`;n.manualLocks.includes(r)||(n.manualLocks.push(r),hn(n),pr(n));}function $2(e,t){const n=ht(),r=`${e}-${t}`;n.manualLocks=n.manualLocks.filter(o=>o!==r),hn(n),pr(n);}function B2(){const e=ht();e.manualLocks=[],hn(e),pr(e);}function z2(){return ht()}function j2(){return ht().overallRules}function G2(e){return ht().speciesRules[e]||[]}function U2(){const e=ht();return Object.keys(e.speciesRules)}function W2(e,t,n,r){const o=kb(e,t,n,r);return c2(o),pr(ht()),o}function H2(e,t,n,r,o){const i=kb(t,n,r,o);return d2(e,i),pr(ht()),i}function V2(e,t){Sb(e,t),pr(ht());}function K2(e){u2(e),pr(ht());}function Y2(e,t){Sb(e,{enabled:t}),pr(ht());}const zt={init:Rb,destroy:Fb,isEnabled:R2,setEnabled:F2,isLocked:O2,getAllLockedSlots:N2,lockSlot:D2,unlockSlot:$2,clearManualLocks:B2,getOverallRules:j2,getSpeciesRules:G2,getAllSpeciesWithRules:U2,addNewOverallRule:W2,addNewSpeciesRule:H2,modifyRule:V2,removeRule:K2,toggleRule:Y2,cloneRuleToSpecies:p2,getConfig:z2},zf={enabled:true,blockedEggs:[]};function tr(){const e=at($t.FEATURE.EGG_LOCKER,zf);return {...zf,...e,blockedEggs:e.blockedEggs||[]}}function fl(e){st($t.FEATURE.EGG_LOCKER,e);}function q2(e){const t=tr();t.blockedEggs.includes(e)||(t.blockedEggs.push(e),fl(t),window.dispatchEvent(new CustomEvent(ft.EGG_LOCKER_LOCKS_UPDATED)));}function X2(e){const t=tr();t.blockedEggs=t.blockedEggs.filter(n=>n!==e),fl(t),window.dispatchEvent(new CustomEvent(ft.EGG_LOCKER_LOCKS_UPDATED));}const Q2=`
...
`,jf="css-qnqsp4",Ob="gemini-qol-eggLocker-locked",sd="gemini-qol-eggLocker-lock-icon",ld="gemini-qol-eggLocker-styles",J2='<svg xmlns="http://www.w3.org/2000/svg" width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2.5" stroke-linecap="round" stroke-linejoin="round" focusable="false"><rect x="3" y="11" width="18" height="11" rx="2" ry="2"></rect><path d="M7 11V7a5 5 0 0 1 10 0v4"></path></svg>';let Nn=null,ls=false;const cd=[];function Na(e){cd.push(e);}function Z2(){for(const e of cd)try{e();}catch(t){console.warn("[EggLocker Inject] Cleanup error:",t);}cd.length=0;}function eP(){if(ls)return;if(document.getElementById(ld)){ls=true;return}const e=document.createElement("style");e.id=ld,e.textContent=Q2,document.head.appendChild(e),ls=true;}function tP(){document.getElementById(ld)?.remove(),ls=false;}function nP(e){if(e.classList.add(Ob),!e.querySelector(`#${sd}`)){const t=document.createElement("div");t.id=sd,t.innerHTML=J2,e.appendChild(t);}}function Ds(e){e.classList.remove(Ob),e.querySelector(`#${sd}`)?.remove();}function fc(){if(!Nn)return;const e=bt().get();if(e.object.type!=="egg"||!e.object.data){Ds(Nn);return}const t=e.object.data;ar.getBlockedEggs().includes(t.eggId)?nP(Nn):Ds(Nn);}function rP(){eP();const e=Eu(`.${jf}`,o=>{Nn=o,fc();});Na(()=>e.disconnect());const t=_u(`.${jf}`,o=>{Nn===o&&(Ds(o),Nn=null);});Na(()=>t.disconnect());const n=bt().subscribeObject(()=>{fc();});Na(n);const r=()=>fc();window.addEventListener(ft.EGG_LOCKER_LOCKS_UPDATED,r),Na(()=>window.removeEventListener(ft.EGG_LOCKER_LOCKS_UPDATED,r)),console.log("[EggLocker Inject] Started");}function oP(){Nn&&(Ds(Nn),Nn=null),Z2(),tP(),console.log("[EggLocker Inject] Stopped");}let Da=false;const Nb={init(){Da||(rP(),Da=true);},destroy(){Da&&(oP(),Da=false);},isEnabled(){return tr().enabled}};Pe(he.HatchEgg,()=>{const e=tr();if(!e.enabled)return  true;const t=bt().get();if(t.object.type!=="egg"||!t.object.data)return  true;const n=t.object.data.eggId;return e.blockedEggs.includes(n)?(console.log(`[EggLocker] Blocked hatch for ${n}`),false):(console.log(`[EggLocker] Allowed hatch for ${n}`),true)});let Ao=false;function Db(){if(Ao)return;if(!tr().enabled){console.log("[EggLocker] Disabled");return}Ao=true,Nb.init(),console.log("[EggLocker] Initialized");}function $b(){Ao&&(Nb.destroy(),Ao=false,console.log("[EggLocker] Destroyed"));}function iP(){return tr().enabled}function aP(e){const t=tr();t.enabled=e,fl(t),e&&!Ao?Db():!e&&Ao&&$b();}function sP(){const e=Oe.get("eggs");return e?Object.keys(e):[]}function lP(){return tr().blockedEggs}function cP(e){q2(e);}function dP(e){X2(e);}function uP(){const e=tr();e.blockedEggs=[],fl(e);}const ar={init:Db,destroy:$b,isEnabled:iP,setEnabled:aP,getAvailableEggs:sP,getBlockedEggs:lP,blockEgg:cP,unblockEgg:dP,clearBlocks:uP},Gf={enabled:true,blockedDecors:[]};function kn(){const e=at($t.FEATURE.DECOR_LOCKER,Gf);return {...Gf,...e,blockedDecors:e.blockedDecors||[]}}function Yi(e){st($t.FEATURE.DECOR_LOCKER,e);}function pP(e){const t=kn();t.blockedDecors.includes(e)||(t.blockedDecors.push(e),Yi(t),window.dispatchEvent(new CustomEvent(ft.DECOR_LOCKER_LOCKS_UPDATED)));}function fP(e){const t=kn();t.blockedDecors=t.blockedDecors.filter(n=>n!==e),Yi(t),window.dispatchEvent(new CustomEvent(ft.DECOR_LOCKER_LOCKS_UPDATED));}const hP=`
...
`,XP=500,Hf=10,QP=800;function Xb(e={}){const{onApply:t,layout:n="carousel"}=e;let r=null;function o(){if(!r)return;r.innerHTML="";const p=Mr.get();if(p.length===0){r.appendChild(w("div",{className:"outfits-loadout-empty"},"No saved outfits yet."));return}const m=Gr();if(n==="grid"){const v=w("div",{className:"outfits-loadout-grid"});p.forEach(y=>{v.appendChild(i(y,m));}),r.appendChild(v);}else {const v=w("div",{className:"outfits-loadout-carousel"});p.forEach(y=>{v.appendChild(i(y,m));}),a(v),r.appendChild(v);}}function i(p,m){const v=w("div",{className:"outfits-loadout-card"});let y=false,b=null;const A=()=>{y=true,b&&clearTimeout(b),b=setTimeout(()=>{y=false;},QP),Mr.delete(p.id);};v.addEventListener("click",()=>{y||(t?t(p):Vm.set({top:p.top,mid:p.mid,bottom:p.bottom,expression:p.expression}));}),v.addEventListener("contextmenu",M=>{M.preventDefault(),M.stopPropagation(),A();});let P=null,I=null,T=false;const N=()=>{P&&(clearTimeout(P),P=null),I=null,T=false;};v.addEventListener("pointerdown",M=>{M.pointerType!=="mouse"&&M.button===0&&(N(),I={x:M.clientX,y:M.clientY},P=setTimeout(()=>{P=null,I&&(T=true,A());},XP));}),v.addEventListener("pointermove",M=>{if(!I||T)return;const F=M.clientX-I.x,L=M.clientY-I.y;F*F+L*L>Hf*Hf&&N();}),v.addEventListener("pointerup",N),v.addEventListener("pointercancel",N);const z=w("div",{className:"outfits-loadout-preview"});return [p.bottom,p.mid,p.top,p.expression].forEach((M,F)=>{if(!M||M.includes("_Blank"))return;const L=w("img",{className:"outfits-loadout-layer",style:{zIndex:String(F+1)}});L.src=`${m}${M}`,L.onerror=()=>L.remove(),z.appendChild(L);}),v.appendChild(z),v}function a(p){let m=false,v=0,y=0;const b=I=>{m=true,v=("touches"in I?I.touches[0].clientX:I.clientX)-p.offsetLeft,y=p.scrollLeft;},A=I=>{if(!m)return;I.preventDefault();const T=("touches"in I?I.touches[0].clientX:I.clientX)-p.offsetLeft;p.scrollLeft=y-(T-v);},P=()=>{m=false;};p.addEventListener("mousedown",b),p.addEventListener("touchstart",b,{passive:true}),p.addEventListener("mousemove",A),p.addEventListener("touchmove",A,{passive:false}),p.addEventListener("mouseup",P),p.addEventListener("mouseleave",P),p.addEventListener("touchend",P);}const l=w("style");l.textContent=qP,r=w("div"),o();const u=w("div");u.appendChild(l),u.appendChild(r);const f=Mr.subscribe(()=>o());return {root:u,destroy(){f(),r=null;}}}function JP(e={}){const{title:t="Outfits",defaultExpanded:n=true,onExpandChange:r,onApply:o,layout:i,showHint:a=false}=e,l=Xb({onApply:o,layout:i}),u=pt({title:t,variant:"soft",expandable:true,defaultExpanded:n,onExpandChange:r}),f=u.querySelector(".card-body");if(f&&(f.appendChild(l.root),a)){const p=w("div",{className:"outfits-loadout-hint"});p.innerHTML=`
            ...
            `,f.appendChild(p);}return {root:u,destroy:()=>l.destroy()}}const ZP=`
...
`;class eL extends Br{constructor(){super({id:"tab-avatar",label:"Avatar"});xe(this,"avatarBuilder",null);xe(this,"uiState",null);}async build(n){Mr.init(),this.uiState=await YP();const r=await Ys().catch(()=>({top:"Top_DefaultGray.png",mid:"Mid_DefaultGray.png",bottom:"Bottom_DefaultGray.png",expression:"Expression_Default.png",color:"Red"})),o={top:r.top,mid:r.mid,bottom:r.bottom,expression:r.expression},i=this.createContainer("avatar-section");n.appendChild(i);const a=w("style");a.textContent=ZP,i.appendChild(a);const l=pt({title:"Avatar editor",variant:"glass",expandable:true,defaultExpanded:this.uiState.get().builderExpanded,onExpandChange:p=>{this.uiState?.update({builderExpanded:p});}});this.avatarBuilder=VP({initialOutfit:o,useRiveAnimation:true});const u=l.querySelector(".card-body");if(u){u.appendChild(this.avatarBuilder.root);const p=w("button",{className:"avatar-save-btn"});p.innerHTML='<svg width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2.5" stroke-linecap="round" stroke-linejoin="round"><path d="M19 21H5a2 2 0 0 1-2-2V5a2 2 0 0 1 2-2h11l5 5v11a2 2 0 0 1-2 2z"/><polyline points="17 21 17 13 7 13 7 21"/><polyline points="7 3 7 8 15 8"/></svg> Save this outfit',p.addEventListener("click",()=>this.handleSave()),u.appendChild(p),u.appendChild(w("hr",{className:"avatar-outfits-divider"}));const m=Xb({onApply:v=>this.avatarBuilder?.setOutfit(v)});u.appendChild(m.root),this.addCleanup(()=>m.destroy());}i.appendChild(l);const f=JP({title:"Outfits loadout",defaultExpanded:this.uiState.get().loadoutsExpanded,onExpandChange:p=>{this.uiState?.update({loadoutsExpanded:p});},layout:"grid",showHint:true});f.root.style.marginTop="12px",i.appendChild(f.root),this.addCleanup(()=>f.destroy());}async handleSave(){if(!this.avatarBuilder)return;const n=this.avatarBuilder.getOutfit(),o=`Outfit ${Mr.get().length+1}`;await Mr.save(o,n);}async destroy(){this.avatarBuilder&&(this.avatarBuilder.destroy(),this.avatarBuilder=null),super.destroy();}}const fd={ui:{expandedCards:{public:true}}};async function tL(){const e=await _o("tab-room",{version:1,defaults:fd,sanitize:o=>({ui:{expandedCards:go(fd.ui.expandedCards,o.ui?.expandedCards)}})});function t(o){const i=e.get();e.update({ui:{...i.ui,...o,expandedCards:go(i.ui.expandedCards,o.expandedCards)}});}function n(o,i){const a=e.get();e.update({ui:{...a.ui,expandedCards:{...a.ui.expandedCards,[o]:!!i}}});}function r(o){const i=e.get();n(o,!i.ui.expandedCards[o]);}return {get:e.get,set:e.set,save:e.save,setUI:t,setCardExpanded:n,toggleCard:r}}const nL=`
/* Container */
.rooms-list {
  width: 100%;
  display: flex;
  ...
  `,e}function dL(e={}){const{rooms:t=[],onJoinRoom:n,onCopyRoomId:r,onRefresh:o,emptyMessage:i="No rooms available",joinEnabled:a=false,initialFilter:l="5-6",onFilterChange:u}=e;let f=l,p=t;const m=w("div",{className:"rooms-list"}),v=w("style");v.textContent=nL,m.appendChild(v);const y=w("div",{className:"rooms-list__header-bar"}),A=Fr({options:[{value:"5-6",label:"5-6 players"},{value:"4",label:"4 players"},{value:"1-3",label:"1-3 players"},{value:"all",label:"All"}],value:l,onChange:V=>{f=V,u?.(f),B(p);}});y.appendChild(A.root);const P=kt({label:"Refresh rooms",variant:"default",size:"sm",iconLeft:"",onClick:()=>{o?.();}});y.appendChild(P),m.appendChild(y);const I=w("div",{style:"position: relative;"}),T=w("div",{className:"rooms-list__container"});I.appendChild(T);const N=w("div",{className:"rooms-list__loading-overlay"});N.style.display="none";const z=cL();N.appendChild(z),I.appendChild(N),m.appendChild(I);const O=w("div",{className:"rooms-list__footer"}),M=w("div",{className:"rooms-list__aries-badge"});M.textContent="Powered by Aries",O.appendChild(M);const F=w("div",{className:"rooms-list__timestamp"});F.style.display="none",O.appendChild(F),m.appendChild(O);const L=[A,{remove:()=>P.remove()}],C=[];function E(V){const U=rL(V.id),ce=w("div",{className:"rooms-list__item"}),Y=w("div",{className:"rooms-list__top-row"}),ie=oL(U);Y.appendChild(ie);const se=w("span",{className:"rooms-list__id"});se.textContent=iL(V.id,20),se.title=V.id,Y.appendChild(se);const ae=aL(),ne=w("button",{className:"rooms-list__copy-btn"});ne.type="button",ne.title="Copy room ID",ne.appendChild(ae),ne.addEventListener("click",le=>{le.stopPropagation(),r?.(V.id);}),Y.appendChild(ne),ce.appendChild(Y);const q=w("div",{className:"rooms-list__bottom-row"}),Z=w("div",{className:"rooms-list__bottom-left"}),R=w("div",{className:"rooms-list__avatars"});for(let le=0;le<V.maxPlayers;le++){const ve=w("div",{className:`rooms-list__avatar ${le<V.playerCount?"rooms-list__avatar--filled":"rooms-list__avatar--empty"}`});if(V.playerAvatars&&V.playerAvatars[le]){const _e=V.playerAvatars[le];if(_e.avatarUrl){const $e=w("img",{src:_e.avatarUrl,alt:_e.name});$e.style.width="100%",$e.style.height="100%",$e.style.objectFit="cover",ve.appendChild($e);}else ve.textContent="👤";ve.title=_e.name;}else le<V.playerCount&&(ve.textContent="👤");R.appendChild(ve);}Z.appendChild(R);const $=w("span",{className:"rooms-list__count"});$.textContent=`${V.playerCount}/${V.maxPlayers}`,Z.appendChild($),q.appendChild(Z);const Q=V.playerCount>=V.maxPlayers,re=kt({label:"Join",variant:"primary",size:"sm",disabled:!a||Q,onClick:()=>{n?.(V.id);}});return C.push(re),q.appendChild(re),ce.appendChild(q),ce}function B(V){T.innerHTML="",C.forEach(ce=>{ce.destroy?ce.destroy():ce.remove&&ce.remove();}),C.length=0;const U=sL(V,f);if(U.length===0){const ce=w("div",{className:"rooms-list__empty"});ce.textContent=i,T.appendChild(ce);}else U.forEach(ce=>{const Y=E(ce);T.appendChild(Y);});}return B(t),{root:m,setRooms(V){p=V,B(V);},setFilter(V){f=V,A.setValue(V),B(p);},setLastUpdated(V){F.textContent=lL(V),F.style.display="block";},setLoading(V){V?(N.style.display="flex",N.style.opacity="0",N.offsetWidth,N.style.opacity="1"):(N.style.opacity="0",setTimeout(()=>{N.style.display="none";},300));},destroy(){C.forEach(V=>{V.destroy?V.destroy():V.remove&&V.remove();}),C.length=0,L.forEach(V=>{V.destroy?V.destroy():V.remove&&V.remove();}),L.length=0,m.remove();}}}async function uL(e){const{state:t,defaultExpanded:n=true,onExpandChange:r}=e;let o=null,i=false;const a=!Rt.isDiscord(),l=Rt.isDiscord(),f=Rt.detect().origin;async function p(){try{return (await Ls.fetchRooms(1e3)).map(A=>({id:A.id,playerCount:A.playersCount,maxPlayers:6,playerAvatars:A.userSlots?.map(P=>({name:P.name,avatarUrl:P.avatarUrl}))}))}catch(b){return console.error("[Room] Failed to fetch rooms:",b),[]}}async function m(){if(!(i||!o)){i=true,o.setLoading(true);try{const b=await p(),A=new Date;o.setRooms(b),o.setLastUpdated(A),console.log(`[Room] Fetched ${b.length} rooms from Aries API`);}catch(b){console.error("[Room] Failed to refresh rooms:",b);}finally{i=false,o.setLoading(false);}}}const v=w("div",{style:"display: flex; flex-direction: column; gap: 12px;"});o=dL({rooms:[],joinEnabled:a,onJoinRoom:b=>{const A=`${f}/r/${b}`;window.open(A,"_blank"),console.log(`[Room] Opening room: ${A}`);},onCopyRoomId:b=>{navigator.clipboard.writeText(b).then(()=>{console.log(`[Room] Room ID copied to clipboard: ${b}`);}).catch(A=>{console.error("[Room] Failed to copy room ID:",A);});},onRefresh:()=>{m();},emptyMessage:"No public rooms available",initialFilter:"5-6"}),v.appendChild(o.root);const y=pt({title:"Public",subtitle:l?"List of available public rooms (view only on Discord)":"List of available public rooms",padding:"lg",expandable:true,defaultExpanded:n,onExpandChange:b=>{r?.(b),t.setCardExpanded("public",b),b&&!i&&m();}},v);return n&&m(),{root:y,destroy(){o&&(o.destroy(),o=null);}}}class pL extends Br{constructor(n){super({id:"tab-room",label:"Room"});xe(this,"publicCardHandle",null);this.deps=n;}destroy(){this.publicCardHandle&&(this.publicCardHandle.destroy(),this.publicCardHandle=null);}async build(n){const r=this.createGrid("12px");r.id="room",n.appendChild(r);let o;try{o=await tL();}catch{o={get:()=>fd,set:()=>{},save:()=>{},setUI:()=>{},setCardExpanded:()=>{},toggleCard:()=>{}};}const i=o.get();this.publicCardHandle=await uL({state:o,defaultExpanded:!!i.ui.expandedCards.public}),r.appendChild(this.publicCardHandle.root);}}const fL=10,hL=16;function mL(e){const{selectedSpecies:t,onChange:n,placeholder:r="Search plants...",speciesRuleCount:o={},onSearchChange:i}=e;let a=t??null,l=[],u=[];const f=[],p=new Map;let m=null;const v=w("div",{className:"plant-selector"}),y=Gs({placeholder:r,blockGameKeys:true,withClear:true,debounceMs:150,onChange:C=>N(C)});v.appendChild(y.root),f.push(()=>{const C=y.root.__cleanup;C&&C();});const b=w("div",{className:"plant-selector__grid"});v.appendChild(b),f.push(()=>{m!==null&&(cancelAnimationFrame(m),m=null),p.clear();});async function A(C,E){if(Qe.isReady())try{const B=await Qe.toCanvas(C,{boundsMode:"padded"});B&&(B.style.maxWidth="40px",B.style.maxHeight="40px",B.style.width="auto",B.style.height="auto",B.style.display="block",E.replaceChildren(B));}catch(B){console.warn("[PlantSelector] Failed to load sprite:",B);}}function P(){if(p.size===0){m=null;return}const C=[],E=p.entries();for(let B=0;B<fL;B++){const j=E.next();if(j.done)break;C.push(j.value);}for(const[B,j]of C)A(j,B),p.delete(B);p.size>0?m=requestAnimationFrame(()=>{setTimeout(P,hL);}):m=null;}function I(){m===null&&(m=requestAnimationFrame(()=>{P();}));}function T(){try{const C=Oe.get("plants");if(!C){console.warn("[PlantSelector] No plants data available");return}l=Object.entries(C).filter(([,E])=>E&&typeof E=="object"&&"crop"in E).map(([E,B])=>({name:E,spriteId:B.crop?.spriteId||null})),u=[...l],z();}catch(C){console.error("[PlantSelector] Failed to load plants:",C);}}function N(C){if(!C.trim())u=[...l];else {const E=C.toLowerCase();u=l.filter(B=>B.name.toLowerCase().includes(E));}i?.(C),z();}function z(){const C=b.scrollTop;if(m!==null&&(cancelAnimationFrame(m),m=null),p.clear(),b.replaceChildren(),u.length===0){const B=w("div",{className:"plant-selector__empty"},"No plants found");b.appendChild(B);return}const E=document.createDocumentFragment();u.forEach(B=>{const j=O(B);E.appendChild(j);}),b.appendChild(E),b.scrollTop=C,p.size>0&&I();}function O(C){const E=o[C.name]??0,B=w("div",{className:`plant-selector__item ${a===C.name?"plant-selector__item--selected":""}`});if(E>0){const ce=w("div",{className:"plant-selector__badge"},String(E));B.appendChild(ce);}B.addEventListener("click",()=>{a=C.name,n(C.name),z();});const j=w("div",{className:"plant-selector__sprite"}),V=w("div",{style:"width: 40px; height: 40px; background: color-mix(in oklab, var(--fg) 8%, transparent); border-radius: 4px;"});j.appendChild(V),C.spriteId&&Qe.isReady()&&p.set(j,C.spriteId),B.appendChild(j);const U=w("div",{className:"plant-selector__name"},C.name);return B.appendChild(U),B}T();function M(){return a}function F(C){a=C,z();}function L(){f.forEach(C=>C()),f.length=0;}return {root:v,getSelected:M,setSelected:F,destroy:L}}async function hl(e,t,n){const{size:r,mutations:o}=n;if(!Qe.isReady()){t.appendChild(li(r));return}try{const l=Oe.get("plants")?.[e]?.crop?.spriteId;if(!l){t.appendChild(li(r));return}const u=await Qe.toCanvas(l,{mutations:o&&o.length>0?o:void 0,boundsMode:"padded"});u?(Qb(u,r),t.appendChild(u)):t.appendChild(li(r));}catch(i){console.warn(`[SpriteRenderer] Failed to render plant sprite for ${e}:`,i),t.appendChild(li(r));}}async function gL(e,t,n){if(!Qe.isReady()){t.appendChild(za(e,n));return}try{const i=`sprite/ui/Mutation${{Ambershine:"Amberlit"}[e]??e}`;if(!Qe.has(i)){t.appendChild(za(e,n));return}const a=await Qe.toCanvas(i);a?(Qb(a,n),t.appendChild(a)):t.appendChild(za(e,n));}catch(r){console.warn(`[SpriteRenderer] Failed to render mutation sprite for ${e}:`,r),t.appendChild(za(e,n));}}function li(e){return w("div",{style:`
        ...
        `},"—")}function za(e,t){return e==="Gold"?w("div",{style:`
            ...
            `}):e==="Rainbow"?w("div",{style:`
                ...
                border-radius: 4px;
            `}):li(t)}function Qb(e,t){e.style.maxWidth=`${t}px`,e.style.maxHeight=`${t}px`,e.style.width="auto",e.style.height="auto",e.style.display="block";}const or=["none","Gold","Rainbow"],Bs={wet:["Wet","Chilled","Frozen"],lunar:["Dawnlit","Ambershine","Dawncharged","Ambercharged"]};function Jb(){if(!Qe.isReady())return console.warn("[MutationData] MGSprite not ready yet"),[];try{return Qe.getMutationNames().filter(t=>t!=="Gold"&&t!=="Rainbow")}catch(e){return console.error("[MutationData] Failed to get mutation names:",e),[]}}function Zb(e){if(e==="none")return "Normal";try{return Oe.get("mutations")?.[e]?.name||e}catch{return e}}function vL(e){return e.map(t=>t==="none"?"none":Zb(t).toLowerCase()).join(", ")}function yL(){return Jb()}function Qr(e){const n=yL().indexOf(e);return n===-1?1/0:n}function hd(e){return Bs.wet.includes(e)}function md(e){return Bs.lunar.includes(e)}function xL(e){const t=e.filter(o=>hd(o)),n=e.filter(o=>md(o)),r=[];return t.length>0&&r.push(t[0]),n.length>0&&r.length<2&&r.push(n[0]),r}function ja(e){const t=[e.mode];if(e.sizeCondition?.enabled&&t.push(`size:${e.sizeCondition.minPercentage}`),e.mutationCondition?.enabled){const n=[...e.mutationCondition.mutations].sort();t.push(`mut:${e.mutationCondition.matchMode}:${n.join(",")}`);}return t.join("|")}const wL=32;function ev(e){const{mutationId:t,isSelected:n,onToggle:r,size:o=wL}=e;let i=n,a=false;const l=w("div",{style:`
            display: flex;
            flex-direction: column;
            align-items: center;
            gap: 4px;
            ...
            border-radius: 6px;
            transition: all 0.15s ease;
        `});m(),l.addEventListener("click",r),l.addEventListener("mouseenter",()=>{!i&&!a&&(l.style.background="color-mix(in oklab, var(--fg) 10%, transparent)");}),l.addEventListener("mouseleave",()=>{!i&&!a&&(l.style.background="color-mix(in oklab, var(--fg) 5%, transparent)");});const u=w("div",{style:"display: flex; align-items: center; justify-content: center;"});t==="none"?u.appendChild(bL(o)):gL(t,u,o),l.appendChild(u);const f=e.label??Zb(t),p=w("div",{style:`
            font-size: 10px;
            color: var(--fg);
            text-align: center;
            font-weight: 500;
        ...
        `},"Enabled");P();const A=pt({title:"Color Mutation",subtitle:"Gold / Rainbow color variants",actions:[b],variant:"soft",padding:"md",expandable:true,defaultExpanded:a,onExpandChange:l},y);function P(){y.replaceChildren(),v.length=0,b.style.display=u?"":"none";const L=w("div",{style:"display: flex; align-items: center; gap: 12px;"}),C=rl({checked:u,label:"Enable",size:"md",onChange:j=>{u=j,o(j),P();}});L.appendChild(C.root),u&&(m=w("div",{style:"font-size: 12px; color: color-mix(in oklab, var(--fg) 70%, transparent); line-height: 1.4;"},z()),L.appendChild(m)),y.appendChild(L);const E=w("div",{style:u?"":"opacity: 0.4; pointer-events: none; transition: opacity 0.2s ease;"}),B=w("div",{style:`
            ...
            padding: 1px 6px;
            display: none;
        `},"Enabled");N();const T=pt({title:"Weather Mutation",subtitle:"Weather-based mutation variants",actions:[I],variant:"soft",padding:"md",expandable:true,defaultExpanded:u,onExpandChange:f},P);function N(){P.replaceChildren(),A.clear(),I.style.display=p?"":"none";const j=w("div",{style:"display: flex; align-items: center; gap: 12px;"}),V=rl({checked:p,label:"Enable",size:"md",onChange:ne=>{p=ne,i(ne),N();}});j.appendChild(V.root),p&&(b=w("div",{style:"font-size: 12px; color: color-mix(in oklab, var(--fg) 70%, transparent); line-height: 1.4;"}),m.length>0&&(b.textContent=F()),j.appendChild(b)),P.appendChild(j);const U=w("div",{style:(p?"":"opacity: 0.4; pointer-events: none;")+" display: flex; flex-direction: column; gap: 12px; transition: opacity 0.2s ease;"}),ce=w("div",{style:"display: flex; justify-content: center;"}),Y=Ro({segments:[{id:"any",label:"Any"},{id:"all",label:"All"}],selected:v,onChange:ne=>{v=ne,ne==="all"&&(m=xL(m),a(m)),l(v),N();}});ce.appendChild(Y),U.appendChild(ce);const se=["none",...Jb()],ae=w("div",{style:`
                display: grid;
                grid-template-columns: repeat(auto-fit, minmax(85px, 1fr));
                gap: 8px;
                max-height: 300px;
                overflow-y: auto;
            `});se.forEach(ne=>{const q=m.includes(ne),Z=ev({mutationId:ne,isSelected:q,onToggle:()=>z(ne),label:ne==="none"?"None":void 0});A.set(ne,Z),ae.appendChild(Z.root);}),U.appendChild(ae),P.appendChild(U);}function z(j){if(v==="all")if(j==="none")m.length===1&&m[0]==="none"?m=[]:m=["none"];else {if(m.includes("none"))return;m.includes(j)?m=m.filter(V=>V!==j):(hd(j)?m=m.filter(V=>!hd(V)):md(j)&&(m=m.filter(V=>!md(V))),m=[...m,j]);}else m.includes(j)?m=m.filter(V=>V!==j):m=[...m,j];a(m),O(),M();}function O(){b&&(b.textContent=m.length>0?F():"");}function M(){const j=v==="all"&&m.includes("none");A.forEach((V,U)=>{V.setSelected(m.includes(U)),V.setDisabled(j&&U!=="none");});}function F(){const j=vL(m),V=v==="all"?"AND":"OR";return y==="lock"?`Lock ${j} plants (${V})`:`Allow ${j} plants (${V})`}function L(j){y=j,O();}function C(){return [...m]}function E(){return v}function B(){b=null,A.clear();}return {root:T,setRuleMode:L,getSelection:C,getMatchMode:E,destroy:B}}const AL=60;function EL(e){let t={...e},n=null,r=null;const o=w("div",{style:"display: flex; flex-direction: column; gap: 8px;"}),i=w("div",{style:"display: flex; justify-content: center;"}),a=w("div",{className:"harvest-locker-preview-grid"});o.appendChild(i),o.appendChild(a);const l=w("div",{style:`
            font-size: 10px;
            font-weight: 600;
            color: var(--accent);
            background: color-mix(in oklab, var(--accent) 12%, transparent);
...
`;function WL(e={}){let t=null,n=null,r=null,o=null;const i=[];n=a();function a(){t=w("div",{className:"decor-locker-card__wrapper",style:"display: flex; flex-direction: column; gap: 16px;"}),l();const p=pt({title:"Decor Pickup",subtitle:"Prevent decor pickups",expandable:true,defaultExpanded:e.defaultExpanded??true,onExpandChange:e.onExpandChange},t),m=()=>u();return window.addEventListener(ft.DECOR_LOCKER_LOCKS_UPDATED,m),i.push(()=>window.removeEventListener(ft.DECOR_LOCKER_LOCKS_UPDATED,m)),p}function l(){if(!t)return;const p=sr.getAvailableDecors().length,v=sr.getBlockedDecors().length===p&&p>0;if(r)r.setChecked(v,true),o&&(o.textContent=v?"Decors Unpickable":"Decors Pickable");else {t.replaceChildren();const y=w("div",{style:`
                    ...
                    background: color-mix(in oklab, var(--accent) 10%, transparent);
                    border-radius: 8px;
                `});o=w("div",{style:"font-size: 14px; font-weight: 500;"},v?"Decors Unpickable":"Decors Pickable"),r=Or({checked:v,size:"md",onChange:b=>{b?sr.blockAllDecors():sr.unblockAllDecors();}}),i.push(()=>r?.destroy()),y.appendChild(o),y.appendChild(r.root),t.appendChild(y);}}function u(){l();}function f(){i.forEach(p=>p()),i.length=0,t=null,n=null;}return {root:n,render:u,destroy:f}}class HL{constructor(t={}){xe(this,"handle",null);xe(this,"options");this.options=t;}build(){return this.handle||(this.handle=WL(this.options)),this.handle.root}render(){this.handle?.render();}destroy(){this.handle?.destroy(),this.handle=null;}}const VL=`
.plant-selector {
    display: flex;
    flex-direction: column;
    gap: 8px;
...
`;class KL extends Br{constructor(){super({id:"tab-locker",label:"Locker"});xe(this,"harvestLockerCardPart",null);xe(this,"eggLockerCardPart",null);xe(this,"decorLockerCardPart",null);}async preload(){await TL();}build(n){const r=n.getRootNode();un(r,$L,"harvest-locker-card-styles"),un(r,VL,"plant-selector-styles"),un(r,UL,"egg-locker-card-styles");const o=this.createGrid("12px");o.id="locker",n.appendChild(o),this.initializeHarvestLockerCardPart(o),this.initializeEggLockerCardPart(o),this.initializeDecorLockerCardPart(o);}render(n){const r=this.harvestLockerCardPart,o=this.eggLockerCardPart,i=this.decorLockerCardPart;this.harvestLockerCardPart=null,this.eggLockerCardPart=null,this.decorLockerCardPart=null,super.render(n),this.harvestLockerCardPart=r,this.eggLockerCardPart=o,this.decorLockerCardPart=i;}destroy(){this.harvestLockerCardPart&&(this.harvestLockerCardPart.destroy(),this.harvestLockerCardPart=null),this.eggLockerCardPart&&(this.eggLockerCardPart.destroy(),this.eggLockerCardPart=null),this.decorLockerCardPart&&(this.decorLockerCardPart.destroy(),this.decorLockerCardPart=null);}initializeHarvestLockerCardPart(n){if(!this.harvestLockerCardPart){const o=Jn();this.harvestLockerCardPart=new DL({defaultExpanded:o.get().ui.harvestLockerExpanded,defaultMode:o.get().ui.harvestLockerMode,defaultSelectedSpecies:o.get().ui.selectedSpecies,defaultSearchQuery:o.get().ui.searchQuery,onExpandChange:RL});}const r=this.harvestLockerCardPart.build();n.appendChild(r),this.harvestLockerCardPart.render();}initializeEggLockerCardPart(n){if(!this.eggLockerCardPart){const o=Jn();this.eggLockerCardPart=new GL({defaultExpanded:o.get().ui.eggLockerExpanded,onExpandChange:FL});}const r=this.eggLockerCardPart.build();n.appendChild(r),this.eggLockerCardPart.render();}initializeDecorLockerCardPart(n){if(!this.decorLockerCardPart){const o=Jn();this.decorLockerCardPart=new HL({defaultExpanded:o.get().ui.decorLockerExpanded,onExpandChange:OL});}const r=this.decorLockerCardPart.build();n.appendChild(r),this.decorLockerCardPart.render();}}let gc=null,bc=null,vc=null;function YL(){return gc||(gc=new mE),gc}function tv(){return bc||(bc=new nT),bc}function nv(){return vc||(vc=new KL),vc}function qL(e){return [new Zy(e),tv(),new T_(e),new eL,new pL(e),nv()]}async function XL(){const e=tv(),t=nv(),n=YL();await Promise.all([e.preload(),t.preload(),n.preload()]);}function QL(e){const{shadow:t,initialOpen:n}=e,r=w("div",{className:"gemini-panel",id:"panel",ariaHidden:String(!n)}),o=w("div",{className:"gemini-tabbar"}),i=w("div",{className:"gemini-content",id:"content"}),a=w("div",{className:"gemini-resizer",title:"Resize"}),l=w("button",{className:"gemini-close",title:"Fermer",ariaLabel:"Fermer"},"✕");r.append(o,i,a);const u=w("div",{className:"gemini-wrapper"},r);return t.append(u),{panel:r,tabbar:o,content:i,resizer:a,closeButton:l,wrapper:u}}function JL(e){const{resizer:t,host:n,shadow:r,onWidthChange:o,initialWidth:i,minWidth:a,maxWidth:l}=e;let u=a,f=l;function p(){const z=Rt.detect(),O=Math.round(fe.visualViewport?.width??fe.innerWidth??0);if(z.platform==="mobile"||z.os==="ios"||z.os==="android"){const M=getComputedStyle(r.host),F=parseFloat(M.getPropertyValue("--inset-l"))||0,L=parseFloat(M.getPropertyValue("--inset-r"))||0,C=Math.max(280,O-Math.round(F+L));u=280,f=C;}else u=a,f=l;return {min:u,max:f}}function m(z){return Math.max(u,Math.min(f,Number(z)||i))}function v(z){const O=m(z);n.style.setProperty("--w",`${O}px`),o(O);}p();const y=Rt.detect(),b=!(y.platform==="mobile"||y.os==="ios"||y.os==="android");let A=false;const P=z=>{if(!A)return;z.preventDefault();const O=Math.round(fe.innerWidth-z.clientX);v(O);},I=()=>{A&&(A=false,document.body.style.cursor="",fe.removeEventListener("mousemove",P),fe.removeEventListener("mouseup",I));},T=z=>{b&&(z.preventDefault(),A=true,document.body.style.cursor="ew-resize",fe.addEventListener("mousemove",P),fe.addEventListener("mouseup",I));};t.addEventListener("mousedown",T);function N(){t.removeEventListener("mousedown",T),fe.removeEventListener("mousemove",P),fe.removeEventListener("mouseup",I);}return {calculateResponsiveBounds:p,constrainWidthToLimits:m,setHudWidth:v,destroy:N}}function ZL(e){const{panel:t,onToggle:n,onClose:r,toggleCombo:o=u=>u.ctrlKey&&u.shiftKey&&u.key.toLowerCase()==="u",closeOnEscape:i=true}=e;function a(u){const f=t.classList.contains("open");if(i&&u.key==="Escape"&&f){r();return}o(u)&&(u.preventDefault(),u.stopPropagation(),n());}document.addEventListener("keydown",a,{capture:true});function l(){document.removeEventListener("keydown",a,{capture:true});}return {destroy:l}}const eM=`
@layer hud {
  /* Root container */
  .gemini-wrapper {
    position: relative;
...
`;let Yf=false;function jM(){if(Yf)return;Yf=true;const e=document.createElement("style");e.textContent=zM,document.head.appendChild(e);}const qf=["Chat","Leaderboard","Stats","Open Activity Log","Open MGH"],Xf=e=>{try{return typeof CSS<"u"&&CSS&&typeof CSS.escape=="function"?CSS.escape(e):e.replace(/"/g,'\\"')}catch{return e}};function GM(){const e=document.querySelector(qf.map(n=>`button[aria-label="${Xf(n)}"]`).join(","));if(!e)return null;let t=e.parentElement;for(;t&&t!==document.body;){if(qf.reduce((r,o)=>r+t.querySelectorAll(`button[aria-label="${Xf(o)}"]`).length,0)>=2)return t;t=t.parentElement;}return null}function UM(e){const t=Array.from(e.querySelectorAll("button[aria-label]"));if(!t.length)return {refBtn:null,refWrapper:null};const n=t.filter(l=>l.dataset.alertBtn!=="true"&&(l.getAttribute("aria-label")||"")!=="Alerts"),r=n.length?n:t,o=r[r.length-1]||null,i=o?.parentElement,a=i&&i.parentElement===e&&i.tagName==="DIV"?i:null;return {refBtn:o,refWrapper:a}}function WM(e,t,n){const r=e.cloneNode(false);r.type="button",r.setAttribute("aria-label",t),r.title=t,r.dataset.alertBtn="true",r.style.pointerEvents="auto",r.style.position="relative",r.removeAttribute("id");const o=document.createElement("div");return o.innerHTML=n,o.dataset.alertIcon="true",o.style.pointerEvents="none",o.style.userSelect="none",o.style.width="76%",o.style.height="76%",o.style.display="flex",o.style.alignItems="center",o.style.justifyContent="center",o.style.margin="auto",r.appendChild(o),r}function HM(){const e=document.createElement("span");return e.className="alert-badge",e.style.position="absolute",e.style.top="-4px",e.style.right="-4px",e.style.minWidth="18px",e.style.height="18px",e.style.borderRadius="9px",e.style.backgroundColor="#EF4444",e.style.color="white",e.style.fontSize="10px",e.style.fontWeight="700",e.style.display="none",e.style.alignItems="center",e.style.justifyContent="center",e.style.padding="0 4px",e.style.pointerEvents="none",e.style.boxShadow="0 2px 4px rgba(0,0,0,0.2)",e.style.zIndex="1",e.textContent="0",e}function VM(e){jM();const t=e.iconUrl?`<img src="${e.iconUrl}" alt="Alert" style="width:100%;height:100%;object-fit:contain;"/>`:BM,n=e.ariaLabel||"Alerts";let r=null,o=null,i=null,a=null,l=false,u=null,f=null,p=null;function m(){if(l)return  false;l=true;let I=false;try{const T=GM();if(!T)return !1;u!==T&&(u=T);const{refBtn:N,refWrapper:z}=UM(T);if(!N)return !1;o=T.querySelector('div[data-alert-wrapper="true"]'),!o&&z&&(o=z.cloneNode(!1),o.dataset.alertWrapper="true",o.removeAttribute("id"),I=!0);const O=o?.querySelector('button[data-alert-btn="true"]')||null;r||(r=O),r||(r=WM(N,n,t),r.addEventListener("click",F=>{F.preventDefault(),F.stopPropagation();try{e.onClick?.();}catch{}}),i=HM(),r.appendChild(i),o?o.appendChild(r):r.parentElement!==T&&T.appendChild(r),I=!0),o&&o.parentElement!==T&&(T.appendChild(o),I=!0);const M=T;if(M&&M!==f){try{A.disconnect();}catch{}f=M,A.observe(f,{childList:!0,subtree:!0});}return I}finally{l=false;}}const v=document.getElementById("App")||document.body;let y=null,b=false;const A=new MutationObserver(()=>{b&&r&&document.contains(r)||(r&&!document.contains(r)&&(b=false,r=null,i=null,o=null),y===null&&(y=window.setTimeout(()=>{if(y=null,m()&&r&&document.contains(r)&&(b=true,o)){const T=o.parentElement;T&&T.lastElementChild!==o&&T.appendChild(o);}},100)));});return m()&&r&&document.contains(r)&&(b=true),A.observe(v,{childList:true,subtree:true}),a=()=>A.disconnect(),{get root(){return r},updateBadge(I){i&&(I>0?(i.textContent=String(I),i.style.display="flex"):i.style.display="none");},ring(){if(!r)return;const I=r.querySelector('[data-alert-icon="true"]');I&&(I.classList.add("alert-btn-ringing"),setTimeout(()=>{I?.classList.remove("alert-btn-ringing");},600));},startRinging(){r&&(p!==null&&clearInterval(p),this.ring(),p=window.setInterval(()=>{this.ring();},3e3));},stopRinging(){if(p!==null&&(clearInterval(p),p=null),r){const I=r.querySelector('[data-alert-icon="true"]');I&&I.classList.remove("alert-btn-ringing");}},destroy(){this.stopRinging();try{a?.();}catch{}try{o?.remove();}catch{}}}}const KM=`
  /* ============================================
...
`;async function YM(e,t){const n=w("div",{className:"alert-item-row"}),r=w("div",{className:"alert-item-sprite"});if(e.spriteId)try{const f=await Qe.toCanvas(e.spriteId,{scale:.35});f?r.appendChild(f):r.textContent="?";}catch{r.textContent="?";}else r.textContent="?";const o=w("div",{className:"alert-item-info"}),i=w("div",{className:"alert-item-name"},e.itemName),a=w("div",{className:"alert-item-remaining"},`${e.remaining} remaining`);o.appendChild(i),o.appendChild(a);const l=w("div",{className:"alert-item-actions"}),u=w("button",{className:"alert-item-btn alert-item-btn--buy-all",type:"button",title:`Buy all ${e.remaining} available`},"Buy All");return u.addEventListener("click",f=>{f.stopPropagation(),t?.(e);}),l.appendChild(u),n.appendChild(r),n.appendChild(o),n.appendChild(l),n}function qM(){const e=w("div",{className:"alert-overlay-empty"}),t=w("div",{className:"alert-overlay-empty-icon"},"🔔"),n=w("div",{className:"alert-overlay-empty-text"},"No items available"),r=w("div",{className:"alert-overlay-empty-subtext"},"Tracked items will appear here when in stock");return e.appendChild(t),e.appendChild(n),e.appendChild(r),e}function Qf(e,t){const n=t.getBoundingClientRect(),r=340,o=8;e.style.position="fixed",e.style.top="",e.style.bottom="",e.style.left="",e.style.right="";let i=n.bottom+o,a=window.innerWidth-n.right;const l=i+480>window.innerHeight,u=n.right-r<o;l?(e.style.bottom=`${window.innerHeight-n.top+o}px`,e.style.top="auto"):e.style.top=`${i}px`,e.style.right=`${a}px`,u&&(e.style.right="auto",e.style.left=`${o}px`);}function XM(e){const{items:t,anchorElement:n,onClose:r,onBuyAll:o}=e,i=w("div",{className:"alert-overlay"}),a=TM("theme",ci.theme),l=oo[a];let u="";l&&(u=`.alert-overlay {
    ${Object.entries(l).map(([T,N])=>`${T}: ${N};`).join(`
    `)}
  }

`);const f=document.createElement("style");f.textContent=u+KM,i.appendChild(f);const p=w("div",{className:"alert-overlay-header"}),m=w("div",{className:"alert-overlay-title"},"Available Items"),v=w("button",{className:"alert-overlay-close",type:"button",title:"Close"},"✕");v.addEventListener("click",I=>{I.stopPropagation(),r?.();}),p.appendChild(m),p.appendChild(v);const y=w("div",{className:"alert-overlay-list"});i.appendChild(p),i.appendChild(y);const b=async I=>{if(y.replaceChildren(),I.length===0)y.appendChild(qM());else for(const T of I){const N=await YM(T,o);y.appendChild(N);}};b(t),Qf(i,n);const A=()=>{Qf(i,n);};window.addEventListener("resize",A);const P=I=>{const T=I.target;!i.contains(T)&&!n.contains(T)&&r?.();};return document.addEventListener("click",P,{capture:true}),{root:i,updateItems:b,destroy(){window.removeEventListener("resize",A),document.removeEventListener("click",P,{capture:true}),i.remove();}}}const QM={seed:"plants",tool:"items",egg:"eggs",decor:"decor"},JM={seed:"seed",tool:null,egg:null,decor:null};function ov(e,t,n){try{const r=QM[t],o=Oe.get(r);if(!o||typeof o!="object")return null;const i=o[e];if(!i||typeof i!="object")return null;const a=JM[t],l=a?i[a]:i;return !l||typeof l!="object"?null:l[n]??null}catch{return null}}function ZM(e,t){return ov(e,t,"spriteId")}function eR(e,t){return ov(e,t,"name")??e}function tR(e,t){const n=$r.getTrackedItems(),r=new Set(n.filter(i=>i.shopType===e).map(i=>i.itemId));return r.size===0?[]:t.items.filter(i=>{const a=r.has(i.id),l=i.isAvailable;return a&&l}).map(i=>({shopType:e,itemId:i.id,itemName:eR(i.id,e),spriteId:ZM(i.id,e),remaining:i.remaining,price:i.price}))}function di(){const t=Mo().get(),n=["seed","tool","egg","decor"],r=[];for(const o of n){const i=t.byType[o];if(i){const a=tR(o,i);r.push(...a);}}return r}function nR(e){return Mo().subscribeStable(()=>{const r=di();e(r);})}function rR(){let e=null,t=null,n=null,r=false,o=[],i=[],a="",l=0,u=0,f=false,p=null,m=[],v=0,y=false;const b=()=>{try{return xt.CustomSounds.getNotificationConfig("shop")}catch{return null}},A=(q,Z)=>{try{const R=Re.getItemCustomSound("shop",q,Z);return R?{soundId:R.soundId,volume:R.volume,mode:R.mode}:null}catch{return null}},P=q=>`${q.soundId}:${q.volume}`,I=(q,Z,R,$)=>{Z.has(R)||(q.push({soundId:R,volume:$}),Z.add(R));},T=(q,Z)=>{const R=[],$=new Set;let Q=false;const re=[];for(const le of q){const ve=A(le.itemId,le.shopType);ve?ve.mode==="one-shot"&&re.push({soundId:ve.soundId,volume:ve.volume}):Z?.mode==="one-shot"&&(Q=true);}Q&&Z&&I(R,$,Z.soundId,Z.volume);for(const le of re)I(R,$,le.soundId,le.volume);return R},N=(q,Z)=>{const R=[],$=new Set;let Q=false;const re=[];for(const le of q){const ve=A(le.itemId,le.shopType);ve?ve.mode==="loop"&&re.push({soundId:ve.soundId,volume:ve.volume}):Z?.mode==="loop"&&(Q=true);}Q&&Z&&I(R,$,Z.soundId,Z.volume);for(const le of re)I(R,$,le.soundId,le.volume);return R},z=(q,Z,R,$=false)=>{if(!R())return;const Q=Re.getById(q.soundId);if(!Q){Z();return}$&&(p=Q.source),xt.playCustom(Q.source,{volume:q.volume/100}).then(re=>{if(!R())return;const le=re.audio,ve=()=>{R()&&Z();};le.addEventListener("ended",ve,{once:true});}).catch(()=>{R()&&Z();});},O=()=>{if(!f||i.length===0)return;const q=i[l];l=(l+1)%i.length;const Z=u,R=()=>f&&u===Z;z(q,()=>{R()&&O();},R,true);},M=()=>{f||i.length===0||(f=true,l>=i.length&&(l=0),O());},F=()=>{if(f){u+=1,f=false;try{const q=xt.getCustomHandle();(!p||q&&q.url===p)&&xt.CustomSounds.stop();}catch{}p=null;}},L=()=>{F(),i=[],a="",l=0,p=null;},C=()=>{if(m.length===0){y=false,M();return}y=true;const q=m.shift(),Z=v,R=()=>y&&v===Z;z(q,()=>{R()&&C();},R);},E=(q,Z)=>{const R=Z??b(),$=T(q,R);if($.length===0)return;const Q=new Set(m.map(re=>re.soundId));for(const re of $)Q.has(re.soundId)||(m.push(re),Q.add(re.soundId));y||(v+=1,F(),C());},B=(q,Z)=>{const R=Z??b(),$=N(q,R);if($.length===0){L();return}const Q=$.map(P).join("|"),re=Q!==a;i=$,a=Q,re&&(l=0,f&&F()),!y&&(f||M());},j=q=>{const Z=o.length>0,R=q.length>0;o=q,e?.updateBadge(q.length),R?Z||e?.startRinging():Z&&e?.stopRinging();},V=()=>{if(r||!e?.root)return;const q=di();t=XM({items:q,anchorElement:e.root,onClose:U,onBuyAll:Z=>{switch(Z.shopType){case "seed":Er.seed.buyAll(Z.itemId);break;case "egg":Er.egg.buyAll(Z.itemId);break;case "decor":Er.decor.buyAll(Z.itemId);break;case "tool":Er.tool.buyAll(Z.itemId);break}}}),document.body.appendChild(t.root),r=true;},U=()=>{!r||!t||(t.destroy(),t=null,r=false);},ce=()=>{r?U():V();},Y=q=>{if(j(q),r&&t&&t.updateItems(q),B(q),q.length>0){const Z=new CustomEvent("gemini:alert-available",{detail:{items:q}});window.dispatchEvent(Z);}},ie=()=>{const q=di(),Z=new Set(o.map(re=>`${re.shopType}:${re.itemId}`)),R=q.filter(re=>!Z.has(`${re.shopType}:${re.itemId}`)),$=R.length>0;j(q),r&&t&&t.updateItems(q);const Q=b();B(q,Q),$&&E(R,Q);};e=VM({onClick:ce,ariaLabel:"Alerts"}),n=nR(Y),window.addEventListener("gemini:tracked-items-changed",ie);const se=q=>{const Z=q,{shopType:R,items:$}=Z.detail;if(!$||$.length===0)return;const Q=$.map(re=>({itemId:re.itemId,shopType:R}));E(Q,b());};window.addEventListener("gemini:shop-restock-tracked",se);const ae=q=>{if(q.detail?.entityType!=="shop")return;const R=di();B(R,b());};window.addEventListener(ft.CUSTOM_SOUND_CHANGE,ae);const ne=(q=1,Z=10)=>{if(Mo().get().all.some(re=>re.items.length>0)||q>=Z){const re=di();j(re);const le=b();B(re,le),re.length>0&&E(re,le);}else setTimeout(()=>ne(q+1,Z),500);};return ne(),{destroy(){U(),n?.(),n=null,window.removeEventListener("gemini:tracked-items-changed",ie),window.removeEventListener("gemini:shop-restock-tracked",se),window.removeEventListener(ft.CUSTOM_SOUND_CHANGE,ae),e?.destroy(),e=null,m=[],v+=1,y=false,L();}}}function oR(e){e.logStep("WebSocket","Capturing WebSocket...");let t=null;return t=Dm(n=>{n.ws&&(e.logStep("WebSocket","WebSocket captured","success"),t?.(),t=null);},{intervalMs:250}),$M({debug:false}),()=>{t?.(),t=null;}}async function iR(e){e.logStep("Atoms","Prewarming Jotai store...");try{await Mh(),await Ad({timeoutMs:8e3,intervalMs:50}),e.logStep("Atoms","Jotai store ready","success");}catch(t){e.logStep("Atoms","Jotai store not captured yet","error"),console.warn("[Bootstrap] Jotai store wait failed",t);}}function aR(e){e.logStep("Globals","Initializing global variables...");try{cg(),e.logStep("Globals","Global variables ready","success");}catch(t){e.logStep("Globals","Failed to initialize global variables","error"),console.warn("[Bootstrap] Global variables init failed",t);}}function sR(e){e.logStep("API","Exposing Gemini API...");try{BP(),e.logStep("API","Gemini API ready","success");}catch(t){e.logStep("API","Failed to expose API","error"),console.warn("[Bootstrap] API init failed",t);}}function xc(){return new Promise(e=>{typeof requestIdleCallback<"u"?requestIdleCallback(()=>e(),{timeout:50}):setTimeout(e,0);})}async function lR(e){e.logStep("HUD","Loading HUD preferences..."),await xc();const t=IM();await xc();const n=await _M({hostId:"gemini-hud-root",initialWidth:t.width,initialOpen:t.isOpen,onWidthChange:r=>Ua("width",r),onOpenChange:r=>Ua("isOpen",r),themes:oo,initialTheme:t.theme,onThemeChange:r=>Ua("theme",r),buildSections:r=>qL({applyTheme:r.applyTheme,initialTheme:r.initialTheme,getCurrentTheme:r.getCurrentTheme,setHUDWidth:r.setHUDWidth,setHUDOpen:r.setHUDOpen}),initialTab:t.activeTab,onTabChange:r=>Ua("activeTab",r)});return await xc(),e.logStep("HUD","HUD ready","success"),n}async function cR(e){e.setSubtitle("Activating Gemini modules...");let t=0,n=0;await dg(r=>{r.status==="start"?n++:r.status==="success"?(t++,e.logStep("Modules",`Loading modules... (${t}/${n})`)):r.status==="error"&&e.logStep("Modules",`Loading modules... (${t}/${n}) - ${r.name} failed`,"error");}),e.logStep("Modules",`All modules loaded (${n}/${n})`,"success");}async function dR(e){try{Qe.isReady()||await Qe.init(),Oe.resolveSprites();}catch(t){console.warn("[Bootstrap] Sprite init failed",t);}}async function uR(e){e.logStep("Sections","Preloading UI sections...");try{await XL(),e.logStep("Sections","Sections preloaded","success");}catch(t){e.logStep("Sections","Sections preload failed","error"),console.warn("[Bootstrap] Sections preload failed",t);}}function pR(e){e.logStep("Features","Initializing features...");const t=[{name:"AntiAfk",init:po.init.bind(po)},{name:"PetTeam",init:dt.init.bind(dt)},{name:"XPTracker",init:Qc.init.bind(Qc)},{name:"CropValueIndicator",init:rs.init.bind(rs)},{name:"CropSizeIndicator",init:as.init.bind(as)},{name:"ShopNotifier",init:$r.init.bind($r)},{name:"WeatherNotifier",init:ko.init.bind(ko)},{name:"PetHungerNotifier",init:Ri.init.bind(Ri)},{name:"AriesAPI",init:Ls.init.bind(Ls)},{name:"HarvestLocker",init:zt.init.bind(zt)},{name:"EggLocker",init:ar.init.bind(ar)},{name:"DecorLocker",init:sr.init.bind(sr)}];let n=0;for(const r of t)try{r.init(),n++,e.logStep("Features",`Initializing features... (${n}/${t.length})`,"info");}catch(o){e.logStep("Features",`Initializing features... (${n}/${t.length}) - ${r.name} failed`,"error"),console.warn(`[Bootstrap] Feature ${r.name} init failed`,o);}e.logStep("Features",`All features initialized (${t.length}/${t.length})`,"success"),e.logStep("Injections","Initializing QOL injections...");try{const r=ch();r.register({id:"cropValueIndicator",name:"Crop Price",description:"Shows coin value in crop tooltips",injection:rs.render,storageKey:At.CROP_VALUE_INDICATOR,defaultEnabled:!1}),r.register({id:"cropSizeIndicator",name:"Crop Size",description:"Shows size percentage in crop tooltips",injection:as.render,storageKey:At.CROP_SIZE_INDICATOR,defaultEnabled:!1}),r.initAll(),e.logStep("Injections","QOL injections registered and initialized","success");}catch(r){e.logStep("Injections","QOL injections initialization failed","error"),console.warn("[Bootstrap] Injections init failed",r);}}H0();(async function(){ty();const e=Hv({title:"Gemini is loading",subtitle:"Connecting and preparing modules..."});let t=null;try{t=oR(e),await iR(e),aR(e),sR(e),await cR(e),await Promise.all([(async()=>{pR(e);})(),(async()=>{await dR(e);})()]),await uR(e),e.succeed("Gemini is ready!");}catch(r){e.fail("Failed to initialize the mod.",r);}finally{t?.();}const n=await lR(e);MM({onClick:()=>n.setOpen(true)}),rR();})();
