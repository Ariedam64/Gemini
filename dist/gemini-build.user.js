...
`;let ut=null,Yn=null,Ot=null,Bt=null;const vb=`
  ${hl}
...
`;function Fy(e,t,n){if(e.querySelector(`style[data-style-id="${n}"]`))return;const r=document.createElement("style");r.setAttribute("data-style-id",n),r.textContent=t,e.appendChild(r);}const zy=`
@layer components {
  /* ===== Card (base) ===== */
  .card{
    border:1px solid var(--border);
