...
`;function $(t,e,n){if(t.querySelector(`style[data-style-id="${n}"]`))return;let r=document.createElement("style");r.setAttribute("data-style-id",n),r.textContent=e,t.appendChild(r)}var Lt=`
@layer components {
  /* ===== Card (base) ===== */
  .card{
    border:1px solid var(--border);
