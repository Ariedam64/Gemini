...
`,xf={ui:{expandedCards:{settings:true,shops:false,weather:false,pet:false}}};async function L_(){const e=await _o("tab-alerts",{version:1,defaults:xf,sanitize:o=>({ui:{expandedCards:go(xf.ui.expandedCards,o.ui?.expandedCards)}})});function t(o){const i=e.get();e.update({ui:{...i.ui,...o,expandedCards:go(i.ui.expandedCards,o.expandedCards)}});}function n(o,i){const a=e.get();e.update({ui:{...a.ui,expandedCards:{...a.ui.expandedCards,[o]:!!i}}});}function r(o){const i=e.get();n(o,!i.ui.expandedCards[o]);}return {get:e.get,set:e.set,save:e.save,setUI:t,setCardExpanded:n,toggleCard:r}}const Rg=At.SHOP_NOTIFIER,Fg={seed:[],tool:[],egg:[],decor:[]},M_={enabled:false,trackedItems:Fg},R_=["seed","tool","egg","decor"];function Og(e){return {seed:Array.isArray(e?.seed)?[...e.seed]:[],tool:Array.isArray(e?.tool)?[...e.tool]:[],egg:Array.isArray(e?.egg)?[...e.egg]:[],decor:Array.isArray(e?.decor)?[...e.decor]:[]}}function Vi(e){return {seed:[...e.seed],tool:[...e.tool],egg:[...e.egg],decor:[...e.decor]}}function Oo(){const e=at(Rg,M_);return {enabled:e?.enabled??false,trackedItems:Og(e?.trackedItems)}}function rl(e){st(Rg,{enabled:e.enabled,trackedItems:Vi(e.trackedItems)});}function F_(e){const n={...Oo(),...e};return e.trackedItems&&(n.trackedItems=Og(e.trackedItems)),rl(n),n}function pu(){return Oo().enabled}function O_(e){F_({enabled:e});}function Ng(){return Vi(Oo().trackedItems)}function Dg(){const e=Ng(),t=[];for(const n of R_)for(const r of e[n])t.push({shopType:n,itemId:r});return t}function N_(e,t){const n=Oo(),r=Vi(n.trackedItems),o=r[e];if(o.includes(t))return;o.push(t),rl({...n,trackedItems:r});const i=new CustomEvent("gemini:tracked-items-changed",{detail:{shopType:e,itemId:t,action:"add"}});window.dispatchEvent(i);}function $g(e,t){const n=Oo(),r=Vi(n.trackedItems),o=r[e],i=o.filter(l=>l!==t);if(i.length===o.length)return;r[e]=i,rl({...n,trackedItems:r});const a=new CustomEvent("gemini:tracked-items-changed",{detail:{shopType:e,itemId:t,action:"remove"}});window.dispatchEvent(a);}function D_(){const e=Oo();rl({...e,trackedItems:Vi(Fg)});}let ws=false;const Xc=[];function $_(e,t){const n=Ng()[e];if(!n.length)return [];const r=new Set(n);return t.items.filter(o=>r.has(o.id)&&o.isAvailable).map(o=>({itemId:o.id,remaining:o.remaining}))}function La(e,t){const n=$_(e,t.shop);if(!n.length)return;console.log("[ShopNotifier] Tracked items restocked",{shopType:e,items:n});const r=new CustomEvent("gemini:shop-restock-tracked",{detail:{shopType:e,items:n}});window.dispatchEvent(r);}function B_(){if(ws)return;ws=true;const e=Mo();Xc.push(e.subscribeSeedRestock(t=>La("seed",t)),e.subscribeToolRestock(t=>La("tool",t)),e.subscribeEggRestock(t=>La("egg",t)),e.subscribeDecorRestock(t=>La("decor",t)));}function z_(){if(ws){ws=false;for(const e of Xc)e();Xc.length=0;}}const Bg={Shovel:{shopType:"tool",maxQuantity:1},WateringCan:{shopType:"tool",maxQuantity:99},PetHutch:{shopType:"decor",maxQuantity:1},DecorShed:{shopType:"decor",maxQuantity:1}};function j_(e,t,n){const r=n.find(i=>typeof i=="object"&&i!==null&&"toolId"in i&&i.toolId===e);return r?(r.quantity??0)>=t:false}function G_(e,t,n){const r=n.find(f=>typeof f=="object"&&f!==null&&"decorId"in f&&f.decorId===e),o=r?r.quantity??0:0,l=Ur().get().decors.all.filter(f=>typeof f=="object"&&f!==null&&"decorId"in f&&f.decorId===e).length;return o+l>=t}function zg(e,t,n,r){return t==="tool"?j_(e,n,r):t==="decor"?G_(e,n,r):false}function wf(e,t){const n=Bg[e];if(!n||n.shopType!==t)return  false;const o=Lo().get();return zg(e,t,n.maxQuantity,o.items)}function Cf(){const t=Lo().get(),n=Dg();for(const r of n){const o=Bg[r.itemId];o&&o.shopType===r.shopType&&zg(r.itemId,r.shopType,o.maxQuantity,t.items)&&(console.log(`[ShopNotifier] Auto-disabling tracking for ${r.itemId} (max quantity reached)`),$g(r.shopType,r.itemId));}}let Cs=false,Ja=null;function U_(){if(Cs)return;Cs=true,Ja=Lo().subscribeStable(()=>{Cf();}),Cf();}function W_(){Cs&&(Cs=false,Ja&&(Ja(),Ja=null));}let Ti=false;function jg(){if(Ti){console.log("[ShopNotifier] Already initialized");return}if(!pu()){console.log("[ShopNotifier] Disabled");return}Ti=true,B_(),U_(),console.log("[ShopNotifier] Initialized");}function Gg(){Ti&&(z_(),W_(),Ti=false,console.log("[ShopNotifier] Destroyed"));}function H_(){return Ti}function V_(){return pu()}function K_(e){if(pu()===e){console.log(`[ShopNotifier] Already ${e?"enabled":"disabled"}`);return}O_(e),e?jg():Gg(),console.log(`[ShopNotifier] ${e?"Enabled":"Disabled"}`);}const $r={init:jg,destroy:Gg,isReady:H_,isEnabled:V_,setEnabled:K_,addTrackedItem:N_,removeTrackedItem:$g,getTrackedItems:Dg,resetTrackedItems:D_},Y_={seed:"Seeds",tool:"Tools",egg:"Eggs",decor:"Decor"},oc={seed:"🌱",tool:"🔧",egg:"🥚",decor:"🎨"},q_={seed:"plants",tool:"items",egg:"eggs",decor:"decor"},X_={seed:"seed",tool:null,egg:null,decor:null},kf={common:0,uncommon:1,rare:2,legendary:3,mythical:4,divine:5,celestial:6};function fu(e,t,n){try{const r=q_[t],o=Oe.get(r);if(!o||typeof o!="object")return null;const i=o[e];if(!i||typeof i!="object")return null;const a=X_[t],l=a?i[a]:i;return !l||typeof l!="object"?null:l[n]??null}catch(r){return console.warn(`[Alerts] Failed to get ${n} for ${e}:`,r),null}}function Q_(e,t){return fu(e,t,"spriteId")}function J_(e,t){const n=fu(e,t,"rarity");return n?String(n).toLowerCase():null}function Z_(e,t){return fu(e,t,"name")??e}function eI(){const e=$r.getTrackedItems();return new Set(e.map(t=>`${t.shopType}:${t.itemId}`))}function Sf(e){const t=eI(),n=[],r=["seed","tool","egg","decor"];for(const o of r){const i=e.byType[o];if(i)for(const a of i.items){const l=`${o}:${a.id}`;n.push({...a,shopType:o,rarity:J_(a.id,o),spriteId:Q_(a.id,o),itemName:Z_(a.id,o),isTracked:t.has(l),hasCustomSound:Re.hasItemCustomSound("shop",a.id,o)});}}return n}const tI=`
  /* Container */
  .modal-container {
    position: fixed;
    top: 0;
...
`;function w2(){if(ed)return;const e=document.createElement("style");e.id="gemini-qol-cropPrice-styles",e.textContent=x2,document.head.appendChild(e),fo.add(()=>e.remove()),ed=true;}async function C2(e){const t=document.createElement("div");t.className="gemini-qol-cropPrice";const n=document.createElement("div");n.className="gemini-qol-cropPrice-sprite";const r=document.createElement("canvas");r.width=20,r.height=20,n.appendChild(r);const o=document.createElement("div");o.className="gemini-qol-cropPrice-text",o.textContent=e>0?e.toLocaleString():"",t.appendChild(n),t.appendChild(o);try{const i=await Qe.toCanvas("ui","Coin");if(i&&r.parentElement){const a=r.getContext("2d");if(a){const l=Math.min(r.width/i.width,r.height/i.height),u=i.width*l,f=i.height*l,p=(r.width-u)/2,m=(r.height-f)/2;a.drawImage(i,p,m,u,f);}}}catch(i){console.warn("[CropValueIndicator.render] Failed to render coin sprite:",i);}return t}function k2(e){const t=[],n=e.querySelectorAll("span.chakra-text");for(const r of n){const o=r.textContent?.trim();if(!o)continue;["Gold","Rainbow","Wet","Chilled","Frozen","Dawnlit","Dawnbound","Amberlit","Amberbound"].includes(o)&&t.push(o);}return t}function S2(e){const t=e.querySelectorAll("p.chakra-text");for(const n of t){const r=n.textContent?.trim();if(!r)continue;const o=r.match(/^([\d.]+)\s*kg$/i);if(o)return parseFloat(o[1])}return 1}function A2(){const e=[],t=document.querySelectorAll(`.${Jc}`);for(const r of t){const o=r.getBoundingClientRect();o.width===0&&o.height===0||r.closest("button.chakra-button")||e.push({element:r});}const n=document.querySelectorAll(`.${Zc}`);for(const r of n){const o=r.getBoundingClientRect();if(o.width===0&&o.height===0||r.closest("button.chakra-button"))continue;const i=r.querySelectorAll(":scope > .McFlex > .McFlex");if(i.length>0){const a=i[i.length-1];a.querySelector("p.chakra-text")&&e.push({element:a});}}return e}function E2(){const t=bt().get().plant;if(!t)return 0;const n=t.currentSlotIndex!==null?t.slots[t.currentSlotIndex]:null;return n?Ii(n.species,n.targetScale,n.mutations||[]):0}function _2(e,t){const n=document.querySelectorAll(".gemini-qol-cropPrice");for(const r of n){const o=r.getBoundingClientRect();if(o.width===0&&o.height===0||r.closest("button.chakra-button"))continue;const i=r.querySelector(".gemini-qol-cropPrice-text");i&&(i.textContent=e>0?e.toLocaleString():"");}}function I2(){_r!==null&&cancelAnimationFrame(_r),_r=requestAnimationFrame(()=>{_r=null;const e=E2();if(e===td)return;td=e;const n=bt().get().plant;!n||!(n.currentSlotIndex!==null&&n.slots[n.currentSlotIndex])||_2(e);});}async function Qo(e){if(!e.element.querySelector(".gemini-qol-cropPrice"))try{const t=e.element.querySelector("p.chakra-text");if(!t)return;const n=t.closest(".McFlex");if(!n)return;const o=bt().get().plant;let i=0,a=null;if(o&&o.currentSlotIndex!==null){const u=o.slots[o.currentSlotIndex];u&&(a=u.species,i=Ii(u.species,u.targetScale,u.mutations||[]));}if(i===0){const u=t.textContent?.trim();if(u){a=u;const f=S2(n),p=k2(n);i=Ii(u,f,p);}}const l=await C2(i);n.appendChild(l),fo.add(()=>l.remove());}catch(t){console.warn("[CropValueIndicator.render] Failed to inject price:",t);}}function T2(){const e=A2();for(const n of e)Qo(n);ns=bt().subscribePlantInfo(()=>{I2();});const t=new MutationObserver(n=>{for(const r of n)r.type==="childList"&&r.addedNodes.forEach(o=>{if(o instanceof HTMLElement){if(o.classList.contains(Jc)&&(o.closest("button.chakra-button")||Qo({element:o})),o.querySelectorAll(`.${Jc}`).forEach(l=>{l.closest("button.chakra-button")||Qo({element:l});}),o.classList.contains(Zc)&&!o.closest("button.chakra-button")){const l=o.querySelectorAll(":scope > .McFlex > .McFlex");if(l.length>0){const u=l[l.length-1];u.querySelector("p.chakra-text")&&!u.querySelector(".gemini-qol-cropPrice")&&Qo({element:u});}}o.querySelectorAll(`.${Zc}`).forEach(l=>{if(!l.closest("button.chakra-button")){const u=l.querySelectorAll(":scope > .McFlex > .McFlex");if(u.length>0){const f=u[u.length-1];f.querySelector("p.chakra-text")&&!f.querySelector(".gemini-qol-cropPrice")&&Qo({element:f});}}});}});});t.observe(document.body,{childList:true,subtree:true}),pb(fo,t);}const P2={init(){Xo||(Xo=true,w2(),T2());},destroy(){Xo&&(Xo=false,_r!==null&&(cancelAnimationFrame(_r),_r=null),ns&&(ns(),ns=null),fo.run(),fo.clear(),fo=sl(),ed=false,td=null);},isEnabled(){return Xo}},fb=At.CROP_VALUE_INDICATOR,L2={enabled:false};function bu(){return at(fb,L2)}function M2(e){st(fb,e);}let Fi=false;function hb(){Fi||!bu().enabled||(Fi=true,y2());}function mb(){Fi&&(ub(),Fi=false);}function R2(){return Fi}function F2(){return bu().enabled}function O2(e){const t=bu();t.enabled!==e&&(t.enabled=e,M2(t),e?hb():mb());}const rs={init:hb,destroy:mb,isReady:R2,isEnabled:F2,setEnabled:O2,render:P2},Oi="css-qnqsp4",vu="css-1cdcuw7",yu='[role="tooltip"]';let os=sl(),Jo=false,is=null,nd=null,Ir=null;function N2(){const e=[],t=document.querySelectorAll(`.${Oi}`);for(const n of t){const r=n.getBoundingClientRect();if(r.width===0&&r.height===0||n.closest("button.chakra-button"))continue;const o=n.querySelector(`.${vu}`);o&&e.push({element:n,weightElement:o});}return e}function D2(){const t=bt().get().plant;if(!t)return 0;const n=t.currentSlotIndex!==null?t.slots[t.currentSlotIndex]:null;return n?Zd(n.species,n.targetScale):0}function $2(e,t){const n=document.querySelectorAll(`.${Oi}`);for(const r of n){const o=r.getBoundingClientRect();if(o.width===0&&o.height===0||r.closest("button.chakra-button"))continue;const i=r.querySelector(`.${vu}`);if(i){const a=i.querySelector("svg"),l=`${e}%`;i.textContent=l,a&&i.appendChild(a);}}Es(),console.log("[CropSizeIndicator.render] 🔄 Updated all sizes:",{species:t.species,scale:t.targetScale,size:e,count:n.length});}function B2(){Ir!==null&&cancelAnimationFrame(Ir),Ir=requestAnimationFrame(()=>{Ir=null;const e=D2();if(e===nd)return;nd=e;const n=bt().get().plant;if(!n)return;const r=n.currentSlotIndex!==null?n.slots[n.currentSlotIndex]:null;r&&$2(e,r);});}function gb(e,t){const n=Oe.get("plants");if(!n)return "";const r=n[e];return r?.crop?.baseWeight?`${(r.crop.baseWeight*t).toFixed(2)} kg`:""}function Es(){const e=document.querySelectorAll(yu),n=bt().get().plant;if(!n||n.currentSlotIndex===null)return;const r=n.slots[n.currentSlotIndex];if(!r)return;const o=gb(r.species,r.targetScale);for(const i of e){const a=i.getBoundingClientRect();if(a.width===0&&a.height===0)continue;const l=i.textContent?.trim();l&&l.startsWith("Size:")&&o&&(i.textContent=o);}}function cc(){const e=N2();for(const t of e)if(t.weightElement)try{const r=bt().get().plant;if(r&&r.currentSlotIndex!==null){const o=r.slots[r.currentSlotIndex];if(o){const i=Zd(o.species,o.targetScale),a=t.weightElement.querySelector("svg");t.weightElement.textContent=`${i}%`,a&&t.weightElement.appendChild(a);}}}catch(n){console.warn("[CropSizeIndicator.render] Failed to update size:",n);}Es();}function z2(){const e=document.querySelectorAll(`.${Oi}`),n=bt().get().plant;if(!n||n.currentSlotIndex===null)return;const r=n.slots[n.currentSlotIndex];if(!r)return;const o=gb(r.species,r.targetScale);for(const a of e){const l=a.getBoundingClientRect();if(l.width===0&&l.height===0||a.closest("button.chakra-button"))continue;const u=a.querySelector(`.${vu}`);if(u){const f=u.querySelector("svg");u.textContent=o,f&&u.appendChild(f);}}const i=document.querySelectorAll(yu);for(const a of i){const l=a.getBoundingClientRect();if(l.width===0&&l.height===0)continue;const u=a.textContent?.trim();u&&!u.includes("kg")&&(a.textContent=o);}console.log("[CropSizeIndicator.render] Restored crop weights");}function j2(){cc(),is=bt().subscribePlantInfo(()=>{B2();});const e=new MutationObserver(t=>{for(const n of t)n.type==="childList"&&n.addedNodes.forEach(r=>{if(r instanceof HTMLElement){if(r.hasAttribute("role")&&r.getAttribute("role")==="tooltip"){const a=r.textContent?.trim();a&&a.startsWith("Size:")&&Es();}r.classList.contains(Oi)&&(r.closest("button.chakra-button")||cc()),r.querySelectorAll(`.${Oi}`).length>0&&cc(),r.querySelectorAll(yu).forEach(a=>{const l=a.textContent?.trim();l&&l.startsWith("Size:")&&Es();});}});});e.observe(document.body,{childList:true,subtree:true}),pb(os,e),console.log("[CropSizeIndicator.render] Started observing crops");}const xu={init(){if(Jo){console.log("[CropSizeIndicator.render] Already initialized");return}Jo=true,j2(),console.log("✅ [CropSizeIndicator.render] Initialized");},destroy(){Jo&&(Jo=false,z2(),Ir!==null&&(cancelAnimationFrame(Ir),Ir=null),is&&(is(),is=null),os.run(),os.clear(),os=sl(),nd=null,console.log("🛑 [CropSizeIndicator.render] Destroyed"));},isEnabled(){return Jo}},bb=At.CROP_SIZE_INDICATOR,G2={enabled:false};function wu(){return at(bb,G2)}function U2(e){st(bb,e);}let Ni=false;function vb(){if(Ni){console.log("[CropSizeIndicator] Already initialized");return}if(!wu().enabled){console.log("[CropSizeIndicator] Disabled");return}Ni=true,console.log("[CropSizeIndicator] Initializing..."),xu.init(),console.log("[CropSizeIndicator] Initialized successfully");}function yb(){Ni&&(console.log("[CropSizeIndicator] Destroying..."),xu.destroy(),Ni=false,console.log("[CropSizeIndicator] Destroyed"));}function W2(){return Ni}function H2(){return wu().enabled}function V2(e){const t=wu();if(t.enabled===e){console.log(`[CropSizeIndicator] Already ${e?"enabled":"disabled"}`);return}t.enabled=e,U2(t),e?vb():yb(),console.log(`[CropSizeIndicator] ${e?"Enabled":"Disabled"}`);}const as={init:vb,destroy:yb,isReady:W2,isEnabled:H2,setEnabled:V2,render:xu},K2={apiBaseUrl:"https://ariesmod-api.ariedam.fr/"},xb=At.ARIES_API;function Cu(){return at(xb,K2)}function Y2(e){st(xb,e);}function q2(e){const n={...Cu(),...e};return Y2(n),n}let _s=null,Is=null;function Mf(e){_s=e;}function Rf(e){Is=e;}function X2(){return _s?[..._s]:[]}function Q2(){return Is?[...Is]:[]}function Ff(){_s=null,Is=null;}function wb(e,t){const n=Cu(),r=new URL(e,n.apiBaseUrl);if(t)for(const[o,i]of Object.entries(t))i!==void 0&&r.searchParams.set(o,String(i));return r.toString()}function ll(e,t){return new Promise(n=>{const r=wb(e,t);GM_xmlhttpRequest({method:"GET",url:r,headers:{},onload:o=>{if(o.status>=200&&o.status<300)try{const i=o.responseText?JSON.parse(o.responseText):null;n({status:o.status,data:i});}catch(i){console.error("[AriesAPI] GET parse error:",i,o.responseText),n({status:o.status,data:null});}else console.error("[AriesAPI] GET error:",o.status,o.responseText),n({status:o.status,data:null});},onerror:o=>{console.error("[AriesAPI] GET request failed:",o),n({status:0,data:null});}});})}function cl(e,t){return new Promise(n=>{const r=wb(e);GM_xmlhttpRequest({method:"POST",url:r,headers:{"Content-Type":"application/json"},data:JSON.stringify(t),onload:o=>{if(o.status>=200&&o.status<300)try{const i=o.responseText?JSON.parse(o.responseText):null;n({status:o.status,data:i});}catch(i){console.error("[AriesAPI] POST parse error:",i,o.responseText),n({status:o.status,data:null});}else console.error("[AriesAPI] POST error:",o.status,o.responseText),n({status:o.status,data:null});},onerror:o=>{console.error("[AriesAPI] POST request failed:",o),n({status:0,data:null});}});})}async function ku(e=50){const{data:t}=await ll("rooms",{limit:e});return !t||!Array.isArray(t)?[]:t.map(n=>({id:n.id,isPrivate:n.is_private,playersCount:n.players_count??0,lastUpdatedAt:n.last_updated_at,lastUpdatedByPlayerId:n.last_updated_by_player_id,userSlots:Array.isArray(n.user_slots)?n.user_slots.map(r=>({name:r.name,avatarUrl:r.avatar_url??null})):void 0}))}async function J2(e,t){const n=e.trim(),r=t?.minQueryLength??2;if(n.length<r)return [];const o=t?.limitRooms??200,i=n.toLowerCase(),a=await ku(o),l=[];for(const u of a){if(!u.userSlots||u.userSlots.length===0)continue;const f=u.userSlots.filter(p=>p.name?p.name.toLowerCase().includes(i):false);f.length>0&&l.push({room:u,matchedSlots:f});}return l}async function Z2(e){if(!e)return null;const{status:t,data:n}=await ll("get-player-view",{playerId:e});return t===404?null:n}async function dl(e,t){const n=Array.from(new Set((e??[]).map(a=>String(a).trim()).filter(a=>a.length>=3)));if(n.length===0)return [];const r={playerIds:n};t?.sections&&(r.sections=Array.isArray(t.sections)?t.sections:[t.sections]);const{status:o,data:i}=await cl("get-players-view",r);return o!==200||!Array.isArray(i)?[]:i}async function eT(e,t){const n=e.trim(),r=t?.minQueryLength??2;if(n.length<r)return [];const o=t?.limitRooms??200,i=n.toLowerCase(),a=await ku(o),l=new Map;for(const u of a)if(!(!u.userSlots||u.userSlots.length===0))for(const f of u.userSlots){if(!f.name||!f.name.toLowerCase().includes(i))continue;const m=`${u.id}::${f.name}`;l.has(m)||l.set(m,{playerName:f.name,avatarUrl:f.avatarUrl,roomId:u.id,roomPlayersCount:u.playersCount});}return Array.from(l.values())}async function Cb(e){if(!e)return [];const{status:t,data:n}=await ll("list-friends",{playerId:e});return t!==200||!n||!Array.isArray(n.friends)?[]:n.friends}async function tT(e){const t=await Cb(e);if(t.length===0)return Mf([]),[];const n=await dl(t,{sections:["profile","room"]});return Mf(n),[...n]}async function Su(e){if(!e)return {playerId:"",incoming:[],outgoing:[]};const{status:t,data:n}=await ll("list-friend-requests",{playerId:e});return t!==200||!n?{playerId:e,incoming:[],outgoing:[]}:{playerId:n.playerId,incoming:Array.isArray(n.incoming)?n.incoming:[],outgoing:Array.isArray(n.outgoing)?n.outgoing:[]}}async function nT(e){const{incoming:t}=await Su(e),n=t.map(o=>o.fromPlayerId);if(n.length===0)return Rf([]),[];const r=await dl(n,{sections:["profile"]});return Rf(r),[...r]}async function rT(e){const{outgoing:t}=await Su(e),n=t.map(r=>r.toPlayerId);return n.length===0?[]:dl(n,{sections:["profile"]})}async function oT(e,t){if(!e||!t||e===t)return  false;const{status:n}=await cl("friend-request",{fromPlayerId:e,toPlayerId:t});return n===204?true:(n===409&&console.warn("[AriesAPI] friend-request conflict (already exists)"),false)}async function iT(e){const{playerId:t,otherPlayerId:n,action:r}=e;if(!t||!n||t===n)return  false;const{status:o}=await cl("friend-respond",{playerId:t,otherPlayerId:n,action:r});return o===204}async function aT(e,t){if(!e||!t||e===t)return  false;const{status:n}=await cl("friend-remove",{playerId:e,otherPlayerId:t});return n===204}let Zo=false;const Ts={init(){Zo||(Zo=true,console.log("[AriesAPI] Initialized"));},destroy(){Zo&&(Zo=false,Ff(),console.log("[AriesAPI] Destroyed"));},isReady(){return Zo},getConfig(){return Cu()},updateConfig(e){return q2(e)},fetchRooms:ku,searchRoomsByPlayerName:J2,fetchPlayerView:Z2,fetchPlayersView:dl,searchPlayersByName:eT,fetchFriendsIds:Cb,fetchFriendsWithViews:tT,fetchFriendRequests:Su,fetchIncomingRequestsWithViews:nT,fetchOutgoingRequestsWithViews:rT,sendFriendRequest:oT,respondFriendRequest:iT,removeFriend:aT,getCachedFriends:X2,getCachedIncomingRequests:Q2,clearCache:Ff},Of={enabled:true,manualLocks:[],overallRules:[],speciesRules:{}};function Ps(){return `rule-${Date.now()}-${Math.random().toString(36).slice(2,9)}`}function sT(e){const t={enabled:e.enabled,manualLocks:e.manualLocks||[],overallRules:[],speciesRules:{}},n=e.globalCriteria?.lockByScale?.enabled,r=(e.globalCriteria?.lockedMutations?.length??0)>0;if(n||r){const o={id:Ps(),name:"Migrated Global Rule",enabled:true,mode:"lock",sizeCondition:n?{enabled:true,minPercentage:e.globalCriteria.lockByScale.minPercentage}:void 0,mutationCondition:r?{enabled:true,mutations:e.globalCriteria.lockedMutations,matchMode:"any"}:void 0};t.overallRules.push(o);}if(e.speciesOverrides)for(const[o,i]of Object.entries(e.speciesOverrides)){const a=i.lockByScale?.enabled,l=(i.lockedMutations?.length??0)>0;if(a||l){const u={id:Ps(),name:`Migrated ${o} Rule`,enabled:true,mode:"lock",sizeCondition:a?{enabled:true,minPercentage:i.lockByScale.minPercentage}:void 0,mutationCondition:l?{enabled:true,mutations:i.lockedMutations,matchMode:"any"}:void 0};t.speciesRules[o]=[u];}}return console.log("[HarvestLocker] Migrated legacy config to new format"),t}function lT(e){const t=e;return t!==null&&typeof t=="object"&&"globalCriteria"in t&&!("overallRules"in t)}function ht(){const e=at($t.FEATURE.HARVEST_LOCKER,Of);if(lT(e)){const t=sT(e);return hn(t),t}return {...Of,...e,manualLocks:e.manualLocks||[],overallRules:e.overallRules||[],speciesRules:e.speciesRules||{}}}function hn(e){st($t.FEATURE.HARVEST_LOCKER,e);}function kb(e,t,n,r){return {id:Ps(),name:e,enabled:true,mode:t,sizeCondition:n,mutationCondition:r}}function cT(e){const t=ht();t.overallRules.push(e),hn(t);}function dT(e,t){const n=ht();n.speciesRules[e]||(n.speciesRules[e]=[]),n.speciesRules[e].push(t),hn(n);}function Sb(e,t){const n=ht(),r=n.overallRules.findIndex(o=>o.id===e);if(r!==-1){n.overallRules[r]={...n.overallRules[r],...t},hn(n);return}for(const o of Object.keys(n.speciesRules)){const i=n.speciesRules[o].findIndex(a=>a.id===e);if(i!==-1){n.speciesRules[o][i]={...n.speciesRules[o][i],...t},hn(n);return}}console.warn(`[HarvestLocker] Rule ${e} not found`);}function uT(e){const t=ht(),n=t.overallRules.findIndex(r=>r.id===e);if(n!==-1){t.overallRules.splice(n,1),hn(t);return}for(const r of Object.keys(t.speciesRules)){const o=t.speciesRules[r].findIndex(i=>i.id===e);if(o!==-1){t.speciesRules[r].splice(o,1),t.speciesRules[r].length===0&&delete t.speciesRules[r],hn(t);return}}console.warn(`[HarvestLocker] Rule ${e} not found`);}function pT(e,t){const n=ht(),r=n.overallRules.find(i=>i.id===e);if(!r){console.warn(`[HarvestLocker] Rule ${e} not found`);return}const o={...r,id:Ps(),name:`${r.name} (${t})`};n.speciesRules[t]||(n.speciesRules[t]=[]),n.speciesRules[t].push(o),hn(n);}const Rr=new Set;let Xn=null;const Ls=[];function fT(e){if(Ls.length>0){console.warn("[HarvestLocker] Already started");return}Xn=e;const t=Ur().subscribeStable(n=>{if(!n){Rr.clear();return}Ab(n);});Ls.push(t);}function hT(){Ls.forEach(e=>e()),Ls.length=0,Rr.clear(),Xn=null,console.log("[HarvestLocker] Stopped");}function pr(e){Xn=e;const t=Ur().get();t&&Ab(t);}function Au(e,t){const n=`${e}-${t}`;return Rr.has(n)}function mT(){return Array.from(Rr)}function Ab(e){if(Xn){if(Rr.clear(),Xn.manualLocks.forEach(t=>Rr.add(t)),!xT(e)){console.warn("[HarvestLocker] Invalid garden structure"),window.dispatchEvent(new CustomEvent(ft.HARVEST_LOCKER_LOCKS_UPDATED));return}e.plants.all.forEach(t=>{t.slots.forEach((n,r)=>{const o=`${t.tileIndex}-${r}`,i=gT(n.species);bT(n,i)&&Rr.add(o);});}),window.dispatchEvent(new CustomEvent(ft.HARVEST_LOCKER_LOCKS_UPDATED));}}function gT(e){return Xn?Xn.speciesRules[e]?Xn.speciesRules[e].filter(t=>t.enabled):Xn.overallRules.filter(t=>t.enabled):[]}function bT(e,t){const n=t.filter(o=>o.mode==="lock"),r=t.filter(o=>o.mode==="allow");for(const o of n)if(Nf(e,o))return  true;return r.length>0&&!r.some(i=>Nf(e,i))}function Nf(e,t){const n=[];if(t.sizeCondition?.enabled){const r=yT(e),o=t.sizeCondition.sizeMode??"max";n.push(o==="max"?r>=t.sizeCondition.minPercentage:r<=t.sizeCondition.minPercentage);}if(t.mutationCondition?.enabled&&t.mutationCondition.mutations.length>0){const r=vT(e.mutations,t.mutationCondition.mutations,t.mutationCondition.matchMode);n.push(r);}return n.length>0&&n.every(r=>r)}function vT(e,t,n){const r=t.includes("none"),o=t.filter(a=>a!=="none"),i=r&&e.length===0;return n==="any"?i?true:o.some(a=>e.includes(a)):r&&e.length>0?false:o.length===0?i:o.every(a=>e.includes(a))}function yT(e){const n=Oe.get("plants")?.[e.species];if(!n||typeof n!="object"||!("crop"in n))return 0;const r=n.crop;if(typeof r!="object"||!r)return 0;const{baseTileScale:o,maxScale:i}=r,a=i-o;return a===0?100:(e.targetScale-o)/a*100}function xT(e){return typeof e=="object"&&e!==null&&"plants"in e&&typeof e.plants=="object"&&e.plants!==null&&"all"in e.plants&&Array.isArray(e.plants.all)}const Ms=new Set,Rs=new Set;let ho=null;function Eb(){ho||(ho=new MutationObserver(e=>{for(const t of e){for(const n of t.addedNodes)if(n instanceof Element)for(const r of Ms){n.matches(r.selector)&&r.callback(n);const o=n.querySelectorAll(r.selector);for(const i of o)r.callback(i);}for(const n of t.removedNodes)if(n instanceof Element)for(const r of Rs){n.matches(r.selector)&&r.callback(n);const o=n.querySelectorAll(r.selector);for(const i of o)r.callback(i);}}}),ho.observe(document.body,{childList:true,subtree:true}));}function _b(){Ms.size===0&&Rs.size===0&&ho&&(ho.disconnect(),ho=null);}function Eu(e,t){Eb();const n={selector:e,callback:t};Ms.add(n);const r=document.querySelectorAll(e);for(const o of r)t(o);return {disconnect:()=>{Ms.delete(n),_b();}}}function _u(e,t){Eb();const n={selector:e,callback:t};return Rs.add(n),{disconnect:()=>{Rs.delete(n),_b();}}}const wT=`
...
`,Df="css-qnqsp4",Ib="gemini-qol-harvestLocker-locked",rd="gemini-qol-harvestLocker-lock-icon",od="gemini-qol-harvestLocker-styles",CT='<svg xmlns="http://www.w3.org/2000/svg" width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2.5" stroke-linecap="round" stroke-linejoin="round" focusable="false"><rect x="3" y="11" width="18" height="11" rx="2" ry="2"></rect><path d="M7 11V7a5 5 0 0 1 10 0v4"></path></svg>';let On=null,ss=false;const id=[];function Fa(e){id.push(e);}function kT(){for(const e of id)try{e();}catch(t){console.warn("[HarvestLocker Inject] Cleanup error:",t);}id.length=0;}function ST(){if(ss)return;if(document.getElementById(od)){ss=true;return}const e=document.createElement("style");e.id=od,e.textContent=wT,document.head.appendChild(e),ss=true;}function AT(){document.getElementById(od)?.remove(),ss=false;}function ET(e){if(e.classList.add(Ib),!e.querySelector(`#${rd}`)){const t=document.createElement("div");t.id=rd,t.innerHTML=CT,e.appendChild(t);}}function Fs(e){e.classList.remove(Ib),e.querySelector(`#${rd}`)?.remove();}function dc(){if(!On)return;const e=bt().get();if(!e.plant||e.position.localIndex===null||e.plant.nextHarvestSlotIndex===null){Fs(On);return}const t=String(e.position.localIndex),n=e.plant.nextHarvestSlotIndex;Au(t,n)?ET(On):Fs(On);}function _T(){ST();const e=Eu(`.${Df}`,o=>{On=o,dc();});Fa(()=>e.disconnect());const t=_u(`.${Df}`,o=>{On===o&&(Fs(o),On=null);});Fa(()=>t.disconnect());const n=bt().subscribePlantInfo(()=>{dc();});Fa(n);const r=()=>dc();window.addEventListener(ft.HARVEST_LOCKER_LOCKS_UPDATED,r),Fa(()=>window.removeEventListener(ft.HARVEST_LOCKER_LOCKS_UPDATED,r)),console.log("[HarvestLocker Inject] Started");}function IT(){On&&(Fs(On),On=null),kT(),AT(),console.log("[HarvestLocker Inject] Stopped");}let Oa=false;const Tb={init(){Oa||(_T(),Oa=true);},destroy(){Oa&&(IT(),Oa=false);},isEnabled(){return ht().enabled}},Pb=[];function TT(){return Pb.slice()}function PT(e){Pb.push(e);}function Lb(e){try{return JSON.parse(e)}catch{return}}function $f(e){if(typeof e=="string"){const t=Lb(e);return t!==void 0?t:e}return e}function Mb(e){if(e!=null){if(typeof e=="string"){const t=Lb(e);return t!==void 0?Mb(t):e}if(Array.isArray(e)&&typeof e[0]=="string")return e[0];if(typeof e=="object"){const t=e;return t.type??t.Type??t.kind??t.messageType}}}function LT(e){const t=e?.MagicCircle_RoomConnection?.currentWebSocket;return t&&typeof t=="object"?t:null}function Pe(e,t,n){const r=typeof t=="boolean"?t:true,o=typeof t=="function"?t:n,i=(a,l)=>{if(Mb(a)!==e)return;const f=o(a,l);return f&&typeof f=="object"&&"kind"in f?f:typeof f=="boolean"?f?void 0:{kind:"drop"}:r?void 0:{kind:"drop"}};return PT(i),i}const ei=new WeakSet,Bf=new WeakMap;function MT(e){const t=e.pageWindow,n=!!e.debug,r=e.middlewares&&e.middlewares.length?e.middlewares:TT();if(!r.length)return ()=>{};const o=v=>({ws:v,pageWindow:t,debug:n}),i=(v,y)=>{let b=v;for(const A of r){const P=A(b,o(y));if(P){if(P.kind==="drop")return {kind:"drop"};P.kind==="replace"&&(b=P.message);}}return b!==v?{kind:"replace",message:b}:void 0};let a=null,l=null,u=null;const f=()=>{const v=t?.MagicCircle_RoomConnection,y=v?.sendMessage;if(!v||typeof y!="function")return  false;if(ei.has(y))return  true;const b=y.bind(v);function A(...P){const I=P.length===1?P[0]:P,T=$f(I),N=i(T,LT(t));if(N?.kind==="drop"){n&&console.log("[WS] drop outgoing (RoomConnection.sendMessage)",T);return}if(N?.kind==="replace"){const z=N.message;return P.length>1&&Array.isArray(z)?(n&&console.log("[WS] replace outgoing (RoomConnection.sendMessage)",T,"=>",z),b(...z)):(n&&console.log("[WS] replace outgoing (RoomConnection.sendMessage)",T,"=>",z),b(z))}return b(...P)}ei.add(A),Bf.set(A,y);try{v.sendMessage=A,ei.add(v.sendMessage),n&&console.log("[WS] outgoing patched via MagicCircle_RoomConnection.sendMessage");}catch{return  false}return a=()=>{try{v.sendMessage===A&&(v.sendMessage=y);}catch{}},true};(()=>{const v=t?.WebSocket?.prototype,y=v?.send;if(typeof y!="function"||ei.has(y))return;function b(A){const P=$f(A),I=i(P,this);if(I?.kind==="drop"){n&&console.log("[WS] drop outgoing (ws.send)",P);return}if(I?.kind==="replace"){const T=I.message,N=typeof T=="string"||T instanceof ArrayBuffer||T instanceof Blob?T:JSON.stringify(T);return n&&console.log("[WS] replace outgoing (ws.send)",P,"=>",T),y.call(this,N)}return y.call(this,A)}ei.add(b),Bf.set(b,y);try{v.send=b,n&&console.log("[WS] outgoing patched via WebSocket.prototype.send");}catch{return}l=()=>{try{v.send===b&&(v.send=y);}catch{}};})();const m=e.waitForRoomConnectionMs??4e3;if(!f()&&m>0){const v=Date.now();u=setInterval(()=>{if(f()){clearInterval(u),u=null;return}Date.now()-v>m&&(clearInterval(u),u=null,n&&console.log("[WS] RoomConnection not found, only ws.send is patched"));},250);}return ()=>{if(u){try{clearInterval(u);}catch{}u=null;}if(a){try{a();}catch{}a=null;}if(l){try{l();}catch{}l=null;}}}(function(){try{const t=({ url: (_documentCurrentScript && _documentCurrentScript.tagName.toUpperCase() === 'SCRIPT' && _documentCurrentScript.src || new URL('__entry.js', document.baseURI).href) }),n=t.glob?.("./**/*.ts",{eager:!0})??t.glob?.("./**/*.js",{eager:!0});if(!n)return}catch{}})();Pe(he.HarvestCrop,(e,t)=>{if(!ht().enabled)return  true;const r=e,o=r.slot!==void 0?String(r.slot):void 0,i=r.slotsIndex;return o!==void 0&&typeof i=="number"&&Au(o,i)?(console.log(`[HarvestLocker] Blocked harvest for slot ${o}-${i}`),false):true});let So=false;function Rb(){if(So){console.warn("[HarvestLocker] Already initialized");return}const e=ht();if(!e.enabled){console.log("[HarvestLocker] Disabled");return}So=true,fT(e),Tb.init(),console.log("[HarvestLocker] Initialized");}function Fb(){So&&(Tb.destroy(),hT(),So=false,console.log("[HarvestLocker] Destroyed"));}function RT(){return ht().enabled}function FT(e){const t=ht();t.enabled=e,hn(t),e&&!So?Rb():!e&&So&&Fb();}function OT(e,t){return Au(e,t)}function NT(){return mT()}function DT(e,t){const n=ht(),r=`${e}-${t}`;n.manualLocks.includes(r)||(n.manualLocks.push(r),hn(n),pr(n));}function $T(e,t){const n=ht(),r=`${e}-${t}`;n.manualLocks=n.manualLocks.filter(o=>o!==r),hn(n),pr(n);}function BT(){const e=ht();e.manualLocks=[],hn(e),pr(e);}function zT(){return ht()}function jT(){return ht().overallRules}function GT(e){return ht().speciesRules[e]||[]}function UT(){const e=ht();return Object.keys(e.speciesRules)}function WT(e,t,n,r){const o=kb(e,t,n,r);return cT(o),pr(ht()),o}function HT(e,t,n,r,o){const i=kb(t,n,r,o);return dT(e,i),pr(ht()),i}function VT(e,t){Sb(e,t),pr(ht());}function KT(e){uT(e),pr(ht());}function YT(e,t){Sb(e,{enabled:t}),pr(ht());}const zt={init:Rb,destroy:Fb,isEnabled:RT,setEnabled:FT,isLocked:OT,getAllLockedSlots:NT,lockSlot:DT,unlockSlot:$T,clearManualLocks:BT,getOverallRules:jT,getSpeciesRules:GT,getAllSpeciesWithRules:UT,addNewOverallRule:WT,addNewSpeciesRule:HT,modifyRule:VT,removeRule:KT,toggleRule:YT,cloneRuleToSpecies:pT,getConfig:zT},zf={enabled:true,blockedEggs:[]};function tr(){const e=at($t.FEATURE.EGG_LOCKER,zf);return {...zf,...e,blockedEggs:e.blockedEggs||[]}}function ul(e){st($t.FEATURE.EGG_LOCKER,e);}function qT(e){const t=tr();t.blockedEggs.includes(e)||(t.blockedEggs.push(e),ul(t),window.dispatchEvent(new CustomEvent(ft.EGG_LOCKER_LOCKS_UPDATED)));}function XT(e){const t=tr();t.blockedEggs=t.blockedEggs.filter(n=>n!==e),ul(t),window.dispatchEvent(new CustomEvent(ft.EGG_LOCKER_LOCKS_UPDATED));}const QT=`
...
`,jf="css-qnqsp4",Ob="gemini-qol-eggLocker-locked",ad="gemini-qol-eggLocker-lock-icon",sd="gemini-qol-eggLocker-styles",JT='<svg xmlns="http://www.w3.org/2000/svg" width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2.5" stroke-linecap="round" stroke-linejoin="round" focusable="false"><rect x="3" y="11" width="18" height="11" rx="2" ry="2"></rect><path d="M7 11V7a5 5 0 0 1 10 0v4"></path></svg>';let Nn=null,ls=false;const ld=[];function Na(e){ld.push(e);}function ZT(){for(const e of ld)try{e();}catch(t){console.warn("[EggLocker Inject] Cleanup error:",t);}ld.length=0;}function eP(){if(ls)return;if(document.getElementById(sd)){ls=true;return}const e=document.createElement("style");e.id=sd,e.textContent=QT,document.head.appendChild(e),ls=true;}function tP(){document.getElementById(sd)?.remove(),ls=false;}function nP(e){if(e.classList.add(Ob),!e.querySelector(`#${ad}`)){const t=document.createElement("div");t.id=ad,t.innerHTML=JT,e.appendChild(t);}}function Os(e){e.classList.remove(Ob),e.querySelector(`#${ad}`)?.remove();}function uc(){if(!Nn)return;const e=bt().get();if(e.object.type!=="egg"||!e.object.data){Os(Nn);return}const t=e.object.data;ar.getBlockedEggs().includes(t.eggId)?nP(Nn):Os(Nn);}function rP(){eP();const e=Eu(`.${jf}`,o=>{Nn=o,uc();});Na(()=>e.disconnect());const t=_u(`.${jf}`,o=>{Nn===o&&(Os(o),Nn=null);});Na(()=>t.disconnect());const n=bt().subscribeObject(()=>{uc();});Na(n);const r=()=>uc();window.addEventListener(ft.EGG_LOCKER_LOCKS_UPDATED,r),Na(()=>window.removeEventListener(ft.EGG_LOCKER_LOCKS_UPDATED,r)),console.log("[EggLocker Inject] Started");}function oP(){Nn&&(Os(Nn),Nn=null),ZT(),tP(),console.log("[EggLocker Inject] Stopped");}let Da=false;const Nb={init(){Da||(rP(),Da=true);},destroy(){Da&&(oP(),Da=false);},isEnabled(){return tr().enabled}};Pe(he.HatchEgg,()=>{const e=tr();if(!e.enabled)return  true;const t=bt().get();if(t.object.type!=="egg"||!t.object.data)return  true;const n=t.object.data.eggId;return e.blockedEggs.includes(n)?(console.log(`[EggLocker] Blocked hatch for ${n}`),false):(console.log(`[EggLocker] Allowed hatch for ${n}`),true)});let Ao=false;function Db(){if(Ao)return;if(!tr().enabled){console.log("[EggLocker] Disabled");return}Ao=true,Nb.init(),console.log("[EggLocker] Initialized");}function $b(){Ao&&(Nb.destroy(),Ao=false,console.log("[EggLocker] Destroyed"));}function iP(){return tr().enabled}function aP(e){const t=tr();t.enabled=e,ul(t),e&&!Ao?Db():!e&&Ao&&$b();}function sP(){const e=Oe.get("eggs");return e?Object.keys(e):[]}function lP(){return tr().blockedEggs}function cP(e){qT(e);}function dP(e){XT(e);}function uP(){const e=tr();e.blockedEggs=[],ul(e);}const ar={init:Db,destroy:$b,isEnabled:iP,setEnabled:aP,getAvailableEggs:sP,getBlockedEggs:lP,blockEgg:cP,unblockEgg:dP,clearBlocks:uP},Gf={enabled:true,blockedDecors:[]};function kn(){const e=at($t.FEATURE.DECOR_LOCKER,Gf);return {...Gf,...e,blockedDecors:e.blockedDecors||[]}}function Yi(e){st($t.FEATURE.DECOR_LOCKER,e);}function pP(e){const t=kn();t.blockedDecors.includes(e)||(t.blockedDecors.push(e),Yi(t),window.dispatchEvent(new CustomEvent(ft.DECOR_LOCKER_LOCKS_UPDATED)));}function fP(e){const t=kn();t.blockedDecors=t.blockedDecors.filter(n=>n!==e),Yi(t),window.dispatchEvent(new CustomEvent(ft.DECOR_LOCKER_LOCKS_UPDATED));}const hP=`
  ...
  `,e}function dL(e={}){const{rooms:t=[],onJoinRoom:n,onCopyRoomId:r,onRefresh:o,emptyMessage:i="No rooms available",joinEnabled:a=false,initialFilter:l="5-6",onFilterChange:u}=e;let f=l,p=t;const m=w("div",{className:"rooms-list"}),v=w("style");v.textContent=nL,m.appendChild(v);const y=w("div",{className:"rooms-list__header-bar"}),A=Fr({options:[{value:"5-6",label:"5-6 players"},{value:"4",label:"4 players"},{value:"1-3",label:"1-3 players"},{value:"all",label:"All"}],value:l,onChange:V=>{f=V,u?.(f),B(p);}});y.appendChild(A.root);const P=kt({label:"Refresh rooms",variant:"default",size:"sm",iconLeft:"",onClick:()=>{o?.();}});y.appendChild(P),m.appendChild(y);const I=w("div",{style:"position: relative;"}),T=w("div",{className:"rooms-list__container"});I.appendChild(T);const N=w("div",{className:"rooms-list__loading-overlay"});N.style.display="none";const z=cL();N.appendChild(z),I.appendChild(N),m.appendChild(I);const O=w("div",{className:"rooms-list__footer"}),M=w("div",{className:"rooms-list__aries-badge"});M.textContent="Powered by Aries",O.appendChild(M);const F=w("div",{className:"rooms-list__timestamp"});F.style.display="none",O.appendChild(F),m.appendChild(O);const L=[A,{remove:()=>P.remove()}],C=[];function E(V){const U=rL(V.id),ce=w("div",{className:"rooms-list__item"}),Y=w("div",{className:"rooms-list__top-row"}),ie=oL(U);Y.appendChild(ie);const se=w("span",{className:"rooms-list__id"});se.textContent=iL(V.id,20),se.title=V.id,Y.appendChild(se);const ae=aL(),ne=w("button",{className:"rooms-list__copy-btn"});ne.type="button",ne.title="Copy room ID",ne.appendChild(ae),ne.addEventListener("click",le=>{le.stopPropagation(),r?.(V.id);}),Y.appendChild(ne),ce.appendChild(Y);const q=w("div",{className:"rooms-list__bottom-row"}),Z=w("div",{className:"rooms-list__bottom-left"}),R=w("div",{className:"rooms-list__avatars"});for(let le=0;le<V.maxPlayers;le++){const ve=w("div",{className:`rooms-list__avatar ${le<V.playerCount?"rooms-list__avatar--filled":"rooms-list__avatar--empty"}`});if(V.playerAvatars&&V.playerAvatars[le]){const _e=V.playerAvatars[le];if(_e.avatarUrl){const $e=w("img",{src:_e.avatarUrl,alt:_e.name});$e.style.width="100%",$e.style.height="100%",$e.style.objectFit="cover",ve.appendChild($e);}else ve.textContent="👤";ve.title=_e.name;}else le<V.playerCount&&(ve.textContent="👤");R.appendChild(ve);}Z.appendChild(R);const $=w("span",{className:"rooms-list__count"});$.textContent=`${V.playerCount}/${V.maxPlayers}`,Z.appendChild($),q.appendChild(Z);const Q=V.playerCount>=V.maxPlayers,re=kt({label:"Join",variant:"primary",size:"sm",disabled:!a||Q,onClick:()=>{n?.(V.id);}});return C.push(re),q.appendChild(re),ce.appendChild(q),ce}function B(V){T.innerHTML="",C.forEach(ce=>{ce.destroy?ce.destroy():ce.remove&&ce.remove();}),C.length=0;const U=sL(V,f);if(U.length===0){const ce=w("div",{className:"rooms-list__empty"});ce.textContent=i,T.appendChild(ce);}else U.forEach(ce=>{const Y=E(ce);T.appendChild(Y);});}return B(t),{root:m,setRooms(V){p=V,B(V);},setFilter(V){f=V,A.setValue(V),B(p);},setLastUpdated(V){F.textContent=lL(V),F.style.display="block";},setLoading(V){V?(N.style.display="flex",N.style.opacity="0",N.offsetWidth,N.style.opacity="1"):(N.style.opacity="0",setTimeout(()=>{N.style.display="none";},300));},destroy(){C.forEach(V=>{V.destroy?V.destroy():V.remove&&V.remove();}),C.length=0,L.forEach(V=>{V.destroy?V.destroy():V.remove&&V.remove();}),L.length=0,m.remove();}}}async function uL(e){const{state:t,defaultExpanded:n=true,onExpandChange:r}=e;let o=null,i=false;const a=!Rt.isDiscord(),l=Rt.isDiscord(),f=Rt.detect().origin;async function p(){try{return (await Ts.fetchRooms(1e3)).map(A=>({id:A.id,playerCount:A.playersCount,maxPlayers:6,playerAvatars:A.userSlots?.map(P=>({name:P.name,avatarUrl:P.avatarUrl}))}))}catch(b){return console.error("[Room] Failed to fetch rooms:",b),[]}}async function m(){if(!(i||!o)){i=true,o.setLoading(true);try{const b=await p(),A=new Date;o.setRooms(b),o.setLastUpdated(A),console.log(`[Room] Fetched ${b.length} rooms from Aries API`);}catch(b){console.error("[Room] Failed to refresh rooms:",b);}finally{i=false,o.setLoading(false);}}}const v=w("div",{style:"display: flex; flex-direction: column; gap: 12px;"});o=dL({rooms:[],joinEnabled:a,onJoinRoom:b=>{const A=`${f}/r/${b}`;window.open(A,"_blank"),console.log(`[Room] Opening room: ${A}`);},onCopyRoomId:b=>{navigator.clipboard.writeText(b).then(()=>{console.log(`[Room] Room ID copied to clipboard: ${b}`);}).catch(A=>{console.error("[Room] Failed to copy room ID:",A);});},onRefresh:()=>{m();},emptyMessage:"No public rooms available",initialFilter:"5-6"}),v.appendChild(o.root);const y=pt({title:"Public",subtitle:l?"List of available public rooms (view only on Discord)":"List of available public rooms",padding:"lg",expandable:true,defaultExpanded:n,onExpandChange:b=>{r?.(b),t.setCardExpanded("public",b),b&&!i&&m();}},v);return n&&m(),{root:y,destroy(){o&&(o.destroy(),o=null);}}}class pL extends Br{constructor(n){super({id:"tab-room",label:"Room"});xe(this,"publicCardHandle",null);this.deps=n;}destroy(){this.publicCardHandle&&(this.publicCardHandle.destroy(),this.publicCardHandle=null);}async build(n){const r=this.createGrid("12px");r.id="room",n.appendChild(r);let o;try{o=await tL();}catch{o={get:()=>pd,set:()=>{},save:()=>{},setUI:()=>{},setCardExpanded:()=>{},toggleCard:()=>{}};}const i=o.get();this.publicCardHandle=await uL({state:o,defaultExpanded:!!i.ui.expandedCards.public}),r.appendChild(this.publicCardHandle.root);}}const fL=10,hL=16;function mL(e){const{selectedSpecies:t,onChange:n,placeholder:r="Search plants...",speciesRuleCount:o={},onSearchChange:i}=e;let a=t??null,l=[],u=[];const f=[],p=new Map;let m=null;const v=w("div",{className:"plant-selector"}),y=zs({placeholder:r,blockGameKeys:true,withClear:true,debounceMs:150,onChange:C=>N(C)});v.appendChild(y.root),f.push(()=>{const C=y.root.__cleanup;C&&C();});const b=w("div",{className:"plant-selector__grid"});v.appendChild(b),f.push(()=>{m!==null&&(cancelAnimationFrame(m),m=null),p.clear();});async function A(C,E){if(Qe.isReady())try{const B=await Qe.toCanvas(C,{boundsMode:"padded"});B&&(B.style.maxWidth="40px",B.style.maxHeight="40px",B.style.width="auto",B.style.height="auto",B.style.display="block",E.replaceChildren(B));}catch(B){console.warn("[PlantSelector] Failed to load sprite:",B);}}function P(){if(p.size===0){m=null;return}const C=[],E=p.entries();for(let B=0;B<fL;B++){const j=E.next();if(j.done)break;C.push(j.value);}for(const[B,j]of C)A(j,B),p.delete(B);p.size>0?m=requestAnimationFrame(()=>{setTimeout(P,hL);}):m=null;}function I(){m===null&&(m=requestAnimationFrame(()=>{P();}));}function T(){try{const C=Oe.get("plants");if(!C){console.warn("[PlantSelector] No plants data available");return}l=Object.entries(C).filter(([,E])=>E&&typeof E=="object"&&"crop"in E).map(([E,B])=>({name:E,spriteId:B.crop?.spriteId||null})),u=[...l],z();}catch(C){console.error("[PlantSelector] Failed to load plants:",C);}}function N(C){if(!C.trim())u=[...l];else {const E=C.toLowerCase();u=l.filter(B=>B.name.toLowerCase().includes(E));}i?.(C),z();}function z(){const C=b.scrollTop;if(m!==null&&(cancelAnimationFrame(m),m=null),p.clear(),b.replaceChildren(),u.length===0){const B=w("div",{className:"plant-selector__empty"},"No plants found");b.appendChild(B);return}const E=document.createDocumentFragment();u.forEach(B=>{const j=O(B);E.appendChild(j);}),b.appendChild(E),b.scrollTop=C,p.size>0&&I();}function O(C){const E=o[C.name]??0,B=w("div",{className:`plant-selector__item ${a===C.name?"plant-selector__item--selected":""}`});if(E>0){const ce=w("div",{className:"plant-selector__badge"},String(E));B.appendChild(ce);}B.addEventListener("click",()=>{a=C.name,n(C.name),z();});const j=w("div",{className:"plant-selector__sprite"}),V=w("div",{style:"width: 40px; height: 40px; background: color-mix(in oklab, var(--fg) 8%, transparent); border-radius: 4px;"});j.appendChild(V),C.spriteId&&Qe.isReady()&&p.set(j,C.spriteId),B.appendChild(j);const U=w("div",{className:"plant-selector__name"},C.name);return B.appendChild(U),B}T();function M(){return a}function F(C){a=C,z();}function L(){f.forEach(C=>C()),f.length=0;}return {root:v,getSelected:M,setSelected:F,destroy:L}}async function pl(e,t,n){const{size:r,mutations:o}=n;if(!Qe.isReady()){t.appendChild(li(r));return}try{const l=Oe.get("plants")?.[e]?.crop?.spriteId;if(!l){t.appendChild(li(r));return}const u=await Qe.toCanvas(l,{mutations:o&&o.length>0?o:void 0,boundsMode:"padded"});u?(Qb(u,r),t.appendChild(u)):t.appendChild(li(r));}catch(i){console.warn(`[SpriteRenderer] Failed to render plant sprite for ${e}:`,i),t.appendChild(li(r));}}async function gL(e,t,n){if(!Qe.isReady()){t.appendChild(za(e,n));return}try{const i=`sprite/ui/Mutation${{Ambershine:"Amberlit"}[e]??e}`;if(!Qe.has(i)){t.appendChild(za(e,n));return}const a=await Qe.toCanvas(i);a?(Qb(a,n),t.appendChild(a)):t.appendChild(za(e,n));}catch(r){console.warn(`[SpriteRenderer] Failed to render mutation sprite for ${e}:`,r),t.appendChild(za(e,n));}}function li(e){return w("div",{style:`
        ...
        `},"—")}function za(e,t){return e==="Gold"?w("div",{style:`
            ...
            `}):e==="Rainbow"?w("div",{style:`
                ...
                border-radius: 4px;
            `}):li(t)}function Qb(e,t){e.style.maxWidth=`${t}px`,e.style.maxHeight=`${t}px`,e.style.width="auto",e.style.height="auto",e.style.display="block";}const or=["none","Gold","Rainbow"],Ds={wet:["Wet","Chilled","Frozen"],lunar:["Dawnlit","Ambershine","Dawncharged","Ambercharged"]};function Jb(){if(!Qe.isReady())return console.warn("[MutationData] MGSprite not ready yet"),[];try{return Qe.getMutationNames().filter(t=>t!=="Gold"&&t!=="Rainbow")}catch(e){return console.error("[MutationData] Failed to get mutation names:",e),[]}}function Zb(e){if(e==="none")return "Normal";try{return Oe.get("mutations")?.[e]?.name||e}catch{return e}}function vL(e){return e.map(t=>t==="none"?"none":Zb(t).toLowerCase()).join(", ")}function yL(){return Jb()}function Qr(e){const n=yL().indexOf(e);return n===-1?1/0:n}function fd(e){return Ds.wet.includes(e)}function hd(e){return Ds.lunar.includes(e)}function xL(e){const t=e.filter(o=>fd(o)),n=e.filter(o=>hd(o)),r=[];return t.length>0&&r.push(t[0]),n.length>0&&r.length<2&&r.push(n[0]),r}function ja(e){const t=[e.mode];if(e.sizeCondition?.enabled&&t.push(`size:${e.sizeCondition.minPercentage}`),e.mutationCondition?.enabled){const n=[...e.mutationCondition.mutations].sort();t.push(`mut:${e.mutationCondition.matchMode}:${n.join(",")}`);}return t.join("|")}const wL=32;function ev(e){const{mutationId:t,isSelected:n,onToggle:r,size:o=wL}=e;let i=n,a=false;const l=w("div",{style:`
            display: flex;
            flex-direction: column;
            align-items: center;
            gap: 4px;
