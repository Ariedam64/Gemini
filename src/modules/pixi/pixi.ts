...
// ----- Overlays -----
function drawOverlayBox(tx: number, ty: number, opts: { key: string; tint?: number; alpha?: number }): void {
  ensure();
  ...
  // Use the public getTransform method
...
function stopOverlay(key: string): boolean {
