...
export interface FeaturePanelDefinition {
    ...
    /**
     * Render content for a pet slot in expanded team view
     * Called for individual pet rows
     */
    renderPetSlot?: (
        pet: UnifiedPet,
        team: PetTeam,
    ...
    /**
     * Render content for grouped pets (2-3 with identical abilities)
     * Shows team-aggregated stats instead of individual pet stats
     * Falls back to renderPetSlot if not implemented
     */
    renderGroupedSlot?: (
        pets: UnifiedPet[],
        team: PetTeam,
