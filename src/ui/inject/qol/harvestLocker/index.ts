/**
 * HarvestLocker Crop Card Injection — Public API
 *
 * Per ui/ui.inject.md: each injection feature exports init(), destroy(), isEnabled()
 */

import { startWatching, stopWatching } from './inject';
import { loadConfig } from '../../../../features/harvestLocker/state';

let initialized = false;

export const HarvestLockerInject = {
    /**
    ...
    /**
     * Check if the parent feature (HarvestLocker) is enabled.
     */
    isEnabled(): boolean {
