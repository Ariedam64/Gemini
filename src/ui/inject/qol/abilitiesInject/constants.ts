...
export const JOURNAL_COLORS = {
  // Text colors
  headerText: 'var(--fg)',              // Species name, section headers
  bodyText: 'var(--muted, var(--fg))',                // Stats, counts (Brown.Light approximation)

  // Dividers and borders
  divider: 'var(--border, currentColor)',                 // Separator lines (Brown.Pastel approximation)
  ...
  // Stamp backgrounds
  stampBackground: 'var(--soft, var(--paper))',         // Uncollected stamp bg
  stampBackgroundLogged: 'linear-gradient(135deg, var(--soft, var(--paper)) 0%, var(--soft, var(--paper)) 100%)', // Logged ability

  // Logged ability colors
  loggedBorder: 'var(--complete, var(--accent))',
  loggedCheckmark: 'var(--complete, var(--accent))',
